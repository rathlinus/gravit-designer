      ...
      (function () {
        ...
        !(function () {
          ...
          var n = 0,
            CryptoJSCore = 0;
          for (t = 0; t < 256; t++) {
            var h = CryptoJSCore ^ (CryptoJSCore << 1) ^ (CryptoJSCore << 2) ^ (CryptoJSCore << 3) ^ (CryptoJSCore << 4);
            ...
            (r[n] = (v << 24) | (v >>> 8)),
              ...
              (p[h] = (v << 8) | (v >>> 24)),
              (g[h] = v),
              n ? ((n = f ^ e[e[e[y ^ f]]]), (CryptoJSCore ^= e[e[CryptoJSCore]])) : (n = CryptoJSCore = 1);
          }
        })();
        var h = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
          f = (n.AES = t.extend({
              ...
              if (!this._nRounds || this._keyPriorReset !== this._key) {
                for (
                  var e = (this._keyPriorReset = this._key),
                    t = e.words,
                    n = e.sigBytes / 4,
                    CryptoJSCore = 4 * ((this._nRounds = n + 6) + 1),
                    a = (this._keySchedule = []),
                    r = 0;
                  r < CryptoJSCore;
                  r++
                ...
                for (var l = (this._invKeySchedule = []), c = 0; c < CryptoJSCore; c++)
                  (r = CryptoJSCore - c),
                    (s = c % 4 ? a[r] : a[r - 4]),
                    (l[c] =
                      c < 4 || r <= 4
            ...
            _doCryptBlock: function (e, t, n, CryptoJSCore, i, a, r, s) {
              for (
                var l = this._nRounds,
                  c = e[t] ^ n[0],
                  d = e[t + 1] ^ n[1],
