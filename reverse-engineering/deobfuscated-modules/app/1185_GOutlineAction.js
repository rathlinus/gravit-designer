...
function (exports, module, require) {
    "use strict";
    require(19) /* polyfill_Array_iterator */, require(193) /* polyfill_Object_keys */, require(3) /* polyfill_RegExp_toString */, require(26) /* polyfill_DOMCollection_iterator */;
    ...
    GCore.GObject.inherit(c, GElementAction),
      (c.ID = "modify.ouline"),
      (c.TITLE = new GCore.GLocaleKey("GOutlineAction", "title")),
          ...
          GSystemDialog.prompt(
            ...
            (e) => {
              if (e) {
                ...
                if (isNaN(GElementAction) || !isFinite(GElementAction) || GCore.GMath.isEqualEps(GElementAction, 0))
                  GSystemDialog.alert(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey("GOutlineAction", "text.invalid-value")
                    )
                  );
                else {
                  t.beginTransaction();
