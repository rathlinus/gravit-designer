...
function (exports, module, require) {
    ...
    function l(e, t, n, GCore, GVirtualList) {
      (this._elem = e),
    ...
    (a._Change = { ExpandedSet: 1, ExpandedRemoved: 2 }),
      ...
      (r.prototype.id = null),
      (r.prototype.expanded = undefined),
      ...
      (s.prototype._animatedDragEnabled = false),
      (s.prototype._dragByMouse = false),
      ...
      (s.prototype._putLastChildWhenInside = false),
      ...
      (s.prototype._separatorRenderer = function (e, t) {
        ...
        e.id == s.UPPER_SEP_ID
          ? (GCore.classList.add(this._upSeparatorSpan1Style),
            (GVirtualList = this._upSeparatorSpan2Style
              ? this._upSeparatorSpan2Style
              : null),
            (e.style.top = "0px"))
          : (GCore.classList.add(this._downSeparatorSpan1Style),
            (GVirtualList = this._downSeparatorSpan2Style
      ...
      (l.prototype._aScrollEnabled = false),
