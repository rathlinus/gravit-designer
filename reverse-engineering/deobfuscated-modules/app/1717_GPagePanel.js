...
function (exports, module, require) {
    ...
    function f(e, t, n, _interopRequireDefault, GTools) {
      ...
      if (r.options.canDropCallback) {
        ...
        var u = [];
        if ((GCore = r.options.canDropCallback(GRichTooltipConfig, GSettingChangedEvent, GVirtualTree, u)))
    ...
    function G(e) {
      ...
      (n = GRichTooltipConfig ? E.call(this, _interopRequireDefault, GRichTooltipConfig) : A.call(this, _interopRequireDefault, null)),
