            ...
            if (_interopRequireDefault)
              ...
              try {
                this._iterateEqualPaintLayer(e, function (e, _interopRequireDefault) {
                  ...
                  (GEditor && GEditor.applyPropertiesToParts(t, n)) ||
                    e.setProperties(t, n);
                });
              } finally {
                          ...
                          GTools.GEditor.tryRunTransaction(
                            ...
                            function () {
                              if (GEditor.GPlatform.modifiers.shiftKey) {
                                ...
                                _interopRequireDefault.insertChild(e, AppSettings < GRichTooltipConfig ? t.getNext() : t);
                              } else
                                AppSettings !== GRichTooltipConfig &&
                                  (_interopRequireDefault.removeChild(GTouchTool),
                                  _interopRequireDefault.insertChild(GTouchTool, AppSettings < GRichTooltipConfig ? t.getNext() : t));
                            },
              ...
              if (
                ...
                GTools.GEditor.tryRunTransaction(
                  ...
                  function () {
                    if (GEditor.GPlatform.modifiers.shiftKey) {
                      var e = GTouchTool.clone();
                      AppSettings.insertChild(e, GRichTooltipConfig < DataModule_1161 ? _interopRequireDefault.getNext() : _interopRequireDefault);
                    } else
                      GRichTooltipConfig !== DataModule_1161 &&
                        (AppSettings.removeChild(GTouchTool),
                        AppSettings.insertChild(
                          GTouchTool,
                          GRichTooltipConfig < DataModule_1161 ? _interopRequireDefault.getNext() : _interopRequireDefault.getPrevious()
                        ));
                  },
                  GEditor.GPlatform.modifiers.shiftKey
                    ? GCore.GLocale.get(
