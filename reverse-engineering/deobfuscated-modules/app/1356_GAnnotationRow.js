...
function (exports, module, require) {
    ...
    v.inherit(T, DataModule_1191),
      ...
      (T.prototype._init = function () {
        ...
        const DataModule_883 =
            this._isCommentingEditingEnable && (this._hasResolveAccess || GRegex),
        ...
        var k = (e) => {
            ((e = (
              (e = GCollaborationMentionsUtils.replaceAdditionalCollabShowTextBeforeSend.call(this, e)) ||
              ""
            ).trim()) ||
      ...
      (T.prototype._startEditMode = function (e, t, n, _interopRequireDefault, AppSettings) {
        let GCollaborationMentionsUtils =
          ...
          r =
            arguments.length > 6 && undefined !== arguments[6] ? arguments[6] : [];
        if (!e.hasClass("g-edit-mode")) {
          ...
          let _interopRequireDefault = GAnnotationsUtils.mentioned.map((e) => e.id),
            AppSettings = GCollaborationMentionsUtils
              .concat(r)
