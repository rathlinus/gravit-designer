    ...
    fixRegExpWKS("match", function (e, t, n) {
      return [
        ...
        function (e) {
          ...
          for (var getSubstitution, g = [], h = 0; null !== (getSubstitution = DataModule_279(isCallable, fixRegExpWKS)); ) {
            var f = requireObjectCoercible(getSubstitution[0]);
            (g[h] = f),
              "" === f && (isCallable.lastIndex = regExpFlags(fixRegExpWKS, toStringTagSupport(isCallable.lastIndex), classof)),
              h++;
          }
          return 0 === h ? null : g;
        },
