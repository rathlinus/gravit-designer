        ...
        function (e, t, n) {
            ...
            "id" in e.data && "number" == typeof e.data.id
              ? ((n = e.data),
                (t = l.callbacks[n.id]) &&
                  (t.apply(
                    null,
                    o(o([], n.args, true), [n.isPartialResponse], false)
                  ),
                  (function (e) {
          ...
          (t.initializeCommunication = function (e, t) {
            (l.messageListener = function (e) {
              ...
              s.parentWindow ||
                ((a.GlobalVars.isFramelessWindow = true),
        ...
        function (e, t, n) {
          ...
          e.exports = function (e, t, n) {
            ...
            var g = undefined !== e.msecs ? e.msecs : new Date().getTime(),
              h =
                ((n = undefined !== e.nsecs ? e.nsecs : l + 1),
                g - s + (n - l) / 1e4);
            if (
          ...
          (t.initialize = f),
            ...
            (t._uninitialize = function () {
              i.GlobalVars.initializeCalled &&
                ...
                ((i.GlobalVars.isFramelessWindow = false),
