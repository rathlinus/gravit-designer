...
function (exports, module, require) {
    ...
    var core_export = require(25) /* core_export */,
      ...
      h = l(function () {
        for (
          var exports, module, require = this.iterator, core_export = this.predicate, DataModule_65 = this.next;
          ;

        ) {
          if (((exports = toString_default(isCallable(DataModule_65, require))), (this.done = !!exports.done))) return;
          if (((module = exports.value), DataModule_323(require, core_export, [module, this.counter++], true))) return module;
        }
      });
    core_export(
