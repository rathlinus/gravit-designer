...
function (exports, module, require) {
    ...
    (K.prototype.getTitle = function () {
        ...
        if (GTools.isFixedSized() && e.hasMixin(GCore.GElement.Transform)) {
          ...
          if (n && (s > AppSettings || l > CollaborationMergeUtils)) {
            ...
            s > AppSettings && (p = AppSettings / s),
              ...
              p < g ? (g = p) : (p = g),
              (DataModule_1468 = DataModule_1468
          ...
          t &&
            (DataModule_1468 = DataModule_1468.translated((AppSettings - s) / 2 - GEditor.getX(), (CollaborationMergeUtils - l) / 2 - GEditor.getY())),
      ...
      (K.prototype.storeToCloud = async function (e, t, n) {
        ...
        var GEditor = GTools || {};
        this.isModified() ||
          Object.assign(GEditor, { lastModifiedDate: e.getLastSavedTime() });
        const s = () => {
            this._updateCloudSynchronism(false),
              n
      ...
      (K.prototype.getAnnotationsToken = async function (e) {
        ...
        return (
          !t || (e !== GCore && e !== s)
            ? e === GEditor && e !== GCore && e !== s && (_interopRequireDefault = GTools.getProperty("asec"))
      ...
      (K.prototype.isCommercialProductFile = function () {
        return (
          this.getStorageItem() &&
          this.getStorageItem() instanceof Item3.CommercialProduct
        );
      }),
          ...
          if (require) {
            ...
            var GEditor = (e) => {
              ...
              l = function (e, _interopRequireDefault, GEditor, s) {
                ...
                CollaborationMergeUtils.setProperties(["iw", "ih", "url"], [GEditor, s, _interopRequireDefault]),
                ...
                if ("GVDESIGN" === GTools || GTools === B.ext.toUpperCase()) {
                  ...
                  if (
                    ...
                    if (AppSettings) {
                      ...
                      if (CollaborationMergeUtils && !CollaborationMergeUtils.isEmpty()) {
                        var DataModule_1468 = CollaborationMergeUtils.getSide(GCore.GRect.Side.CENTER);
                  ...
                  GEditor(() =>
                    s.GPDFImport.import(
                      ...
                      function (e, n) {
                        (GUserModel = Math.max(GUserModel, (e / n) * 100)), module.progress(GUserModel);
                      },
                      f
                    )
                  );
                    ...
                    s.GSketchImport.import(
                      ...
                      (e) => {
                        ...
                        if (t && Array.isArray(t)) {
                          e.replacedFonts &&
                            new GMissingFontsDialog(this, e.replacedFonts).open();
                          var GTools = gDesigner.createScene(true);
                          GTools._beginBlockChanges([
                            GCore.GNode._Change.BeforeChildRemove,
                            GCore.GNode._Change.AfterChildRemove,
      ...
      (K.prototype.store = async function (e, t, n) {
        ...
        if (CollaborationMergeUtils === B.ext.toUpperCase()) {
          ...
          Item.acceptChildren(function () {
            ...
            DataModule_1468.progress && DataModule_1468.progress instanceof Function && DataModule_1468.progress(10),
            W(function () {
              var e;
              try {
                e = GCore.GNode.serialize(Item, GCore.GUtil.extend({ save: true }, _interopRequireDefault || {}));
              } catch (e) {
                return (
                  console.error(e),
                  void GEditor(
                ...
                : (DataModule_1468.progress &&
                  ...
                  W(function () {
                    ...
                    DataModule_1468.progress &&
                      ...
                      t.byteLength > 20 + GDocumentStatusEvent ? g(t) : GEditor("GZIP compression fail");
                  }));
            });
          ...
          AppSettings = (e, t) => {
            s.GBitmapImport.import(e, function (e, n, _interopRequireDefault, GTools) {
              if (e)
                ...
                GEditor.setProperties(["iw", "ih", "url"], [_interopRequireDefault, GTools, n]), l(GEditor, t);
              }
            });
          };
          ...
          p = (e, t, n) => {
            ...
            switch (
              ...
              case "PDF":
                ...
                break;
              case "AI":
                GDocument_389.getFileTypesArray().includes(GDocument_389.AI) && DataModule_1468(e, n, true);
                break;
              case "EPS":
            ...
            var s = function (n, GTools, GEditor) {
              if (n instanceof GCore.GColor) _interopRequireDefault.push(n);
                ...
                if (CollaborationMergeUtils && CollaborationMergeUtils.length) {
                  var DataModule_1468 = e._getGravitValue("fontColor", CollaborationMergeUtils[0].fontColor);
    ...
    var J = {
      queryFirst: function (e, t) {
        const require = (e, t) => {
          ...
          for (_interopRequireDefault = 1; _interopRequireDefault <= GUserModel; _interopRequireDefault++) {
            for (GCore = _interopRequireDefault, p = t[_interopRequireDefault - 1], GTools = 1; GTools <= g; GTools++)
              p === e[GTools - 1]
                ...
                : ((l = GCore + 1),
                  ...
                  (GEditor = CollaborationMergeUtils - ((CollaborationMergeUtils - DataModule_1468) & ((DataModule_1468 - CollaborationMergeUtils) >> 7)))),
                (s[GTools - 1] = GCore),
                (GCore = GEditor);
            s[g] = GCore;
          }
        ...
        var GCore = function (GEditor) {
          ...
          GEditor.faces.length
            ? ((s = (function (t) {
                  ...
                  if (l.families)
                    for (var AppSettings = 0; AppSettings < l.families.length; AppSettings++)
                      (_interopRequireDefault = require(l.families[AppSettings], GTools)),
                        _interopRequireDefault < GCore && ((GCore = _interopRequireDefault), (GEditor = e), (s = l.families[AppSettings]));
                  else
                    (_interopRequireDefault = require(l.family, GTools)),
                      _interopRequireDefault < GCore && ((GCore = _interopRequireDefault), (GEditor = e), (s = l.family));
                }
                ...
                for (let t = 0; t < CollaborationMergeUtils.fonts.length; t++) {
                  ...
                  if (!DataModule_1468.family || DataModule_1468.family === s) {
                    if (DataModule_1468.style === e.fontStyle && DataModule_1468.weight === e.fontWeight) {
                      _interopRequireDefault = {
            ...
            ? (_interopRequireDefault++, setTimeout(() => GFontsProviderManager.getInstance().query(GCore, GTools[_interopRequireDefault])))
            : t(null);
        };
