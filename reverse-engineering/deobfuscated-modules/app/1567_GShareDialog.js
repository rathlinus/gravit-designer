    ...
    class I {
                ...
                .append(
                  $("<div/>")
                    ...
                    .append(
                      $("<span/>")
                        .addClass("icon")
                        .addClass(barrel_panels["gravit-icon-share-copy"])
                    )
                    .append(
                      $("<span/>").text(
                        GCore.GLocale.get(
        ...
        return (
          exports.on("click", (e) => {
            ...
            if (module && module.trim().length) {
              ...
              gContainer
                .nativeShareLink(GEditor, a, module)
            ...
            c
              ...
              .on("rolechange", (t) => {
                ...
                r
                  ...
                  : GSystemDialog.alert(
                      GCore.GLocale.get(
                        new GCore.GLocaleKey("GShareDialog", "text.role-required")
                      )
                    );
              }),
            c
      ...
      _updateProperties() {
        ...
        if (0 === module.getPrivateShareQuota())
          ...
          this._dialog
            ...
            .text(
              GCore.GLocale.get(
                new GCore.GLocaleKey("GShareDialog", "text.projects-left")
              ).replace("%number", GEditor)
            );
      ...
      _buildShareByLink() {
        const exports = this._createShareSetting({
            icon: $("<span/>")
              ...
              .addClass("icon"),
            label: GCore.GLocale.get(
              new GCore.GLocaleKey("GShareDialog", "text.public-share-link")
            ),
      ...
      async _tryPrivateShareWithUser(e, t, n) {
        ...
        try {
          let t = await r
            ...
            .then((e) =>
              e.filter((e) => e.id !== this._user.getUID()).map((e) => new GUserModel(e))
            );
      ...
      _createShareSetting(e) {
        ...
        return $("<div/>")
          ...
          .append(
            GEditor ? $("<div/>").addClass("gravit-icon-x-delete").on("click", GEditor) : ""
          );
      }
      _getAvatar(e) {
