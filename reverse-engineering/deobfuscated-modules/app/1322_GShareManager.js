    ...
    (k.prototype._states = null),
      ...
      (k.prototype._setState = function (e, t) {
        this._states.set(e, t),
          gDesigner.hasEventListeners(GEvent_document_1323) && gDesigner.trigger(new GEvent_document_1323(e, t));
      }),
        ...
        return (
          this.isPermissionRequestEnabled() &&
            GDocumentEvent.push({
              ...
              onclick: (t) => {
                gDesigner.stats(
                  "permission-dialog_".concat(GEvent_user, "_request-access")
                );
          ...
          module.forEach((t) => {
            ...
            if (GCore) {
              ...
              _interopRequireDefault.some((n) => {
                ...
                if (GCore && GCore === _interopRequireDefault && e.rolesMatch(AppError, GOfflineDialog)) return (t = true), t;
              }),
