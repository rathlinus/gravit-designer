...
function (exports, module, require) {
    ...
    GCore.GObject.inherit(D, Item),
      ...
      (D.Item.prototype.getId = function () {
        ...
        return exports ? GCloudStorageItem.getCollaborativeFileId(exports, GCloudStorageItem.Storage.GoogleDrive) : null;
      }),
      ...
      (D.Item.prototype.write = async function (e, t, n, _interopRequireDefault, CollaborationMergeUtils) {
        ...
        try {
          ...
          try {
            ...
            if (
              ...
              GEvent_storageItem = await this._exportDocumentToCDR(e, AppSettings, CollaborationMergeUtils);
            } else {
              var GoogleToCloudRoleMap = e.getScene(),
                NoAccessId = GCore.GNode.serialize(GoogleToCloudRoleMap, GCore.GUtil.extend({ save: true }, CollaborationMergeUtils));
            ...
            await this._getOrCreateClient()
              .upload(Item, GEvent_storageItem, GCloudStorageItem, GoogleDriveException.default.DefaultUploadType, GDocument_389)
              .then(async (n) => {
          ...
          try {
            ...
            if (
              ...
              const e =
                ...
                GCore.GLocale.get(
                  new GCore.GLocaleKey("GGoogleDrive", "error.google-api-error")
                );
