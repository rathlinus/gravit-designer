                  ...
                  n.append(
                    Object.keys(this._translation.translations[e]).map((_interopRequireDefault) => {
                      let GCore = $("<div></div>").addClass("row"),
                        GTranslationManager = this._translation.translations[e][_interopRequireDefault];
                      const GSystemDialog =
                      ...
                      let CollaborationMergeUtils = !(!GSystemDialog || (GTranslationManager && GTranslationManager.trim()));
                      if (
                        ((GTranslationManager = CollaborationMergeUtils ? GSystemDialog : GTranslationManager),
                        $("<input></input>")
                          .addClass("key")
                          .attr("disabled", true)
