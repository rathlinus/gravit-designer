                ...
                n._openFromCloud
                  ? (GDocument.children().detach(),
                    ...
                    GFilesPanel.isMaximized().then((e) => {
                      e &&
                        GDocument.closest(".g-dialog-container").addClass("fullscreen");
                    }),
                    gDesigner.getUser().then((e) => {
                      let GOfflineDialog = (e) => {
                        ...
                        GObject_1299 || (GObject_1299 = $("<div/>").addClass("cloud-workspace")),
                          ...
                          GObject_1299.empty(),
                          n._loadCloudFiles(GObject_1299, t, _interopRequireDefault, GCore, r, CollaborationMergeUtils);
                      };
                      e
                        ? GOfflineDialog(e)
                        : AppSettings.LOGIN_DIALOGS.POPUP
          ...
          GFilesPanel = function () {
            this._dialog.find(".cloud-option").css("display", _interopRequireDefault ? "" : "none"),
              ...
              _interopRequireDefault &&
                ...
                this._dialog
                  .find(".cloud-option")
                  .trigger("click", [CollaborationMergeUtils, GOfflineDialog, GSystemDialog, GDocument, GOpenAction])),
