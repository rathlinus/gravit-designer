...
function (exports, module, require) {
    ...
    require(18) /* MenuItemBuilder */, require(1688) /* width */, require(1154) /* GFileDownloadUtils */, require(1689) /* DataModule_1689 */, require(1690) /* stub_requires_1 */, require(1691) /* DataModule_1691 */, require(1693) /* GLongPressEvent */, require(1694) /* module_1694 */;
    var ao = window;
    ...
    exports.exports = async function (GShowGridAction) {
      ...
      const io = async () => {
        await new Promise((GShowGridAction) => gContainer.initLanguage(GShowGridAction)),
          ...
          (gravit = {
            plugins: [],
            actions: [new GNewAction(), new GNewFromTemplateAction(), new GNewClipboardAction(), new GOpenAction(), new GObject_1299()]
              .concat([
              ...
              .concat([
                ...
                _ ? new GObject_1626(new GExportAction({ format: "pdf" })) : new GExportAction({ format: "pdf" }),
              ])
              .concat(
                [
              ...
              .concat([
                ...
                ...(C ? [new Ct()] : []),
                ...GOpenLinkAction.Links.filter((GShowGridAction) => "eula" === GShowGridAction.name).map(
