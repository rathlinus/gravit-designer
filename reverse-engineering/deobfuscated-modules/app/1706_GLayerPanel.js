...
function (exports, module, require) {
    ...
    function _(e, t, n, _interopRequireDefault, GTools) {
      ...
      if (GEditor.options.canDropCallback) {
        ...
        if ((GCore = GEditor.options.canDropCallback(CollaborationMergeUtils, GRichTooltipConfig, GLayerItemUtils, GSettingChangedEvent)))
    ...
    function b(e, t, n, _interopRequireDefault) {
      ...
      for (var GEditor = true, GRichTooltipConfig = 0; GRichTooltipConfig < n.length && GEditor; ++GRichTooltipConfig)
        (GEditor =
          !e.isLocked() &&
          n[GRichTooltipConfig].validateInsertion(e, t) &&
          GTools.GEditor.validateBlockInsertion(e, n[GRichTooltipConfig], t)) && _interopRequireDefault.push[GRichTooltipConfig];
      return GEditor;
    }
    ...
    function M(e, t) {
      ...
      if (GRichTooltipConfig) CollaborationMergeUtils = k.call(this, n, GRichTooltipConfig, e.hasFlag(GCore.GNode.Flag.Expanded));
      else {
        var GLayerItemUtils = e.getParent(),
          d =
            !GLayerItemUtils || GLayerItemUtils instanceof GCore.GScene || GLayerItemUtils instanceof GCore.GPage
              ? null
    ...
    function Q(e) {
      ...
      if (e.hasMixin(GCore.GNode.Container))
        for (var CollaborationMergeUtils = e.getFirstChild(); null !== CollaborationMergeUtils && !GEditor; CollaborationMergeUtils = CollaborationMergeUtils.getNext())
          CollaborationMergeUtils instanceof GCore.GItem && CollaborationMergeUtils.hasFlag(GCore.GNode.Flag.Selected) && (GEditor = true);
