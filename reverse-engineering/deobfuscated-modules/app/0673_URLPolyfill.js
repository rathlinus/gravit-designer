...
function (exports, module, require) {
    ...
    var o,
      ...
      Oe = function (e, t, n) {
        ...
        if (t) {
          ...
          if (
            (undefined !== n && (o = new Oe(n, true)), (core_export = this.parse(DataModule_423, null, o)))
          )
        ...
        for (
          ...
          switch (((hasOwnProperty_wrapper = core_export[u]), defineBuiltIn)) {
            ...
            case _e:
              ...
              break;
            case be:
              if (((defineBuiltIn = we), "/" !== hasOwnProperty_wrapper || "/" !== k(DataModule_146, u + 1))) continue;
              u++;
              break;
            case we:
            ...
            case Ce:
              if ("@" === hasOwnProperty_wrapper) {
                objectAssignPolyfill && (DataModule_146 = "%40" + DataModule_146), (objectAssignPolyfill = true), (DataModule_423 = f(DataModule_146));
                for (var setToStringTag = 0; setToStringTag < DataModule_423.length; setToStringTag++) {
            ...
            case Se:
              ...
              if (":" !== hasOwnProperty_wrapper || DataModule_309) {
                ...
                "[" === hasOwnProperty_wrapper ? (DataModule_309 = true) : "]" === hasOwnProperty_wrapper && (DataModule_309 = false), (DataModule_146 += hasOwnProperty_wrapper);
              } else {
                ...
                if (
                  ...
                  "%2e%2e" === l
                    ...
                    : ("file" === uncurryThis.scheme &&
                        !uncurryThis.path.length &&
                        de(DataModule_146) &&
                        (uncurryThis.host && (uncurryThis.host = ""), (DataModule_146 = k(DataModule_146, 0) + ":")),
          ...
          if (
            !(t = (function (e) {
                  ...
                  if ("." === DataModule_146()) {
                    ...
                    for (o = 0; DataModule_146(); ) {
                      ...
                      for (; O(z, DataModule_146()); ) {
                        if (((hasOwnProperty_wrapper = D(DataModule_146(), 10)), null === core_export)) core_export = hasOwnProperty_wrapper;
                        else {
              ...
              if (null !== defineBuiltIn)
                for (DataModule_423 = uncurryThis - defineBuiltIn, uncurryThis = 7; 0 !== uncurryThis && DataModule_423 > 0; )
                  (globalThis = l[uncurryThis]), (l[uncurryThis--] = l[defineBuiltIn + DataModule_423 - 1]), (l[defineBuiltIn + --DataModule_423] = globalThis);
      ...
      serialize: function () {
        ...
        return (
          null !== core_export
            ...
            : "file" === t && (uncurryThis += "//"),
          (uncurryThis += e.cannotBeABaseURL ? DataModule_423[0] : DataModule_423.length ? "/" + F(DataModule_423, "/") : ""),
    ...
    setToStringTag(Fe, "URL"),
      core_export({ global: true, constructor: true, forced: !DataModule_423, sham: !hasOwnProperty_wrapper }, { URL: Fe });
  }