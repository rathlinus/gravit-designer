...
function (exports, module, require) {
  ...
  r.ActionType = {
  ...
  }, r.prototype._transactionActions = null, r.prototype._debugOn = false, r.prototype._debugBugged = false, r.prototype.getDebugBugged = function () {
    ...
    !o && this._transactionActions && (this._transactionActions.push({
      ...
      action: function () {
        var t = false;
        e.isRecordedTransaction && "function" == typeof e.isRecordedTransaction && !e.isRecordedTransaction() && (e.recordedTransaction = true, t = true), e.setProperties(this.properties, this.values, this.custom), t && (e.recordedTransaction = false);
      },
      revert: function () {
        var t = false;
        e.isRecordedTransaction && "function" == typeof e.isRecordedTransaction && !e.isRecordedTransaction() && (e.recordedTransaction = true, t = true), e.setProperties(this.properties, this.oldValues, this.custom), t && (e.recordedTransaction = false);
      }
    }), this._addDebugData(r.ActionType.PropertyChange, e));
  }, r.prototype.afterChildInsert = function (e, t, i) {
    this._transactionActions && (this._transactionActions.push({
      action: function () {
        t.insertChild(e, i);
      },
      revert: function () {
    ...
    this._transactionActions && t === n.Flag.Active && (this._transactionActions.push({
      action: function () {
      ...
      this._transactionActions.push({
        ...
        action: function () {
          if (this.withInvalidation) {
            var t = false;
            e.isRecordedTransaction && "function" == typeof e.isRecordedTransaction && !e.isRecordedTransaction() && (e.recordedTransaction = true, t = true), e._notifyChange(o._Change.PrepareGeometryUpdate), t && (e.recordedTransaction = false);
          }
        ...
        revert: function () {
          if (e._endBlockChanges(this.changes), this.withInvalidation) {
            var t = false;
            e.isRecordedTransaction && "function" == typeof e.isRecordedTransaction && !e.isRecordedTransaction() && (e.recordedTransaction = true, t = true), e._notifyChange(o._Change.FinishGeometryUpdate, this.noGeometryInvalidation ? -1 : 0), e.hasMixin(o.Accelerated) && e._updateQTree(), t && (e.recordedTransaction = false);
          }
        }
    ...
    this._transactionActions && e.getTransactionAction && "function" == typeof e.getTransactionAction && e.getTransactionRevertAction && "function" == typeof e.getTransactionRevertAction && (this._transactionActions.push({
  ...
  r.prototype._getSeqId = function (e) {
    for (var module = e; !module.getScene;)
    ...
    if (this._debugOn) {
      if (this._debugBugged)
        return;
      o = null;
      try {
        var l = this._transactionActions[this._transactionActions.length - 1];
        e === r.ActionType.BeginSelectionUpdate || e === r.ActionType.FinishSelectionUpdate || (e === r.ActionType.Insert ? (l.action.node = t, l.action.nodeStored = n.store(t)) : l.action.node = this._getSeqId(t)), l.action.parent = i ? this._getSeqId(i) : null, l.action.next = a ? this._getSeqId(t) : null, l.action.type = e, l.node && (l.node = l.action.node), s && (l.action.data = t.getTransactionActionSerialized(s));
      } catch (e) {
