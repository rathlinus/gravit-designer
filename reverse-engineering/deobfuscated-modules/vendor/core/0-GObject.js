  ...
  i.getTypeId = function (e) {
    ...
    if (e) {
      if ("object" == typeof e && (e = e.constructor), e && "function" == typeof e) {
        ...
        return module && module.length > 1 ? module[1].trim() : "anonymous";
      }
      return e.toString();
    }
    return "<null>";
        ...
        for (var s in a)
          if (s && "constructor" !== s && "toString" != s && "__gmixins__" != s && "__gtype_id__" != s && "hasMixin" != s)
            if (s in e.prototype) {
              ...
              e.prototype[s] = a[s];
        if (a.__gtype_id__ || (a.__gtype_id__ = i._internalTypeIdCounter++), e.prototype.__gmixins__[a.__gtype_id__] = true, a.__gmixins__)
          for (var l in a.__gmixins__)
            e.prototype.__gmixins__[l] = true;
        for (var h = Object.getPrototypeOf(a); null != h && h !== Object.prototype; h = Object.getPrototypeOf(h))
          h.__gtype_id__ || (h.__gtype_id__ = i._internalTypeIdCounter++), e.prototype.__gmixins__[h.__gtype_id__] = true;
      }
    }
