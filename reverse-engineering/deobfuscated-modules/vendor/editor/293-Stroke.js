...
function (exports, module, require) {
  var n = require(1220) /* module */, r = require(0) /* GObject */, o = require(11) /* GUtil */, a = require(602) /* module */, s = require(90) /* Container */, l = require(560) /* module */, h = require(564) /* module */, A = require(1221) /* module */, c = require(1222) /* module */, p = require(1223) /* module */, u = require(1412) /* module */, d = function (e) {
  ...
  d.OPERATIONFLAG_STROKE = 2, d.OPERATIONFLAG_FILL = 1, r.inheritAndMix(d, s, [s.Container]), d.prototype._pageSize = null, d.Fill = function () {
    ...
    if (this._workaroundStroke) {
      var require = new d.Stroke();
      require.lineWidth = this._lineWidth, require.strokeStyle = this._fillStyle, t.add(require), t.add(this._path);
    }
    ...
    for (var module = this.pdfObjects.slice(), require = 0; require < module.length && false !== e(module[require], require); require++);
