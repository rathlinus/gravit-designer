...
function (exports, module, require) {
  var n = require(50) /* GPattern */, r = require(2) /* GNode */, o = require(17) /* GRGBColor */, a = require(112) /* module */, s = require(69) /* GBlock */, l = require(133) /* GScenePaintConfiguration */, h = require(22) /* GElement */, A = require(6) /* GRect */, c = require(73) /* GRectangle */, p = require(7) /* GTransform */, u = require(14) /* GPaintCanvas */, d = require(9) /* GLocale */;
  function g() {
  ...
  r.inheritAndMix("layer", g, s, [
  ...
  }, g.GeometryProperties = { frm: false }, g.prototype.validateInsertion = function (e, t) {
    ...
    var t = this.getProperty("frm");
    if (t) {
      var require = e.inverted().mapQuadrilateral(t);
      return A.fromPoints.apply(null, require);
    }
    ...
    return !!s.prototype._preparePaint.call(this, e) && !(!this.$prt && !e.configuration.isAnnotationsVisible(e)) && (e.configuration.paintMode !== l.PaintMode.Outline && this.$otl && e.outlineColors.push(this.$cls), true);
    ...
    if (a && this.getFirstChild()) {
      ...
      if (e.canvas.hasClip()) {
        ...
        try {
          this._paintChildren(e), undefined !== e.canvas.putVertices(s) && e.canvas.fillVertices(o.BLACK, 1, u.CompositeOperator.DestinationIn), h.drawCanvas(e.canvas), e.canvas.finish();
        } finally {
          e.popCanvas();
        }
      }
    ...
    }), this.hasFlag(r.Flag.Active) && (t.blob.__active = true)) : e === r._Change.Restore && (this.restoreProperties(t.blob, g.VisualProperties, function (e, t) {
    ...
    var i = false;
    if (e == h._Change.ChildGeometryUpdate && t && t[0] && t[0].getParent() === this && (this._notifyChange(h._Change.PrepareGeometryUpdate), i = true), s.prototype._handleChange.call(this, e, t), this._handleAnchorChange.call(this, e, t), e == h._Change.ChildGeometryUpdate && i) {
      var o = t[2];
      ...
      e != h._Change.PrepareChildAnchoring || this.getProperty("frm") || this.setFrame(true);
  }, g.prototype.setFrame = function (e) {
    if (e && !this.getProperty("frm")) {
      var module = this.getGeometryBBox();
      if (module) {
        this.setProperties(["frm"], [module]);
        for (var require = this.getFirstChild(); null != require; require = require.getNext())
          require.hasMixin(h.Anchor) && (require.getProperty("hacr") || require.setProperty("hacr", require.oldHacr ? require.oldHacr : h.Anchor.AnchorType.Start), require.getProperty("vacr") || require.setProperty("vacr", require.oldVacr ? require.oldVacr : h.Anchor.AnchorType.Start));
      }
    } else if (!e && this.getProperty("frm")) {
      for (require = this.getFirstChild(); null != require; require = require.getNext())
        require.hasMixin(h.Anchor) && (require.getProperty("hacr") || require.getProperty("vacr")) && require.resetAnchorProperties();
    ...
    if (h.Anchor.prototype._handleAnchorChange.call(this, e, t), e === r._Change.AfterPropertiesChange && !this.isRecordedTransaction() && t.properties.indexOf("frm") >= 0 && (this.getProperty("hacr") || this.getProperty("vacr")) && !this.isRestoring())
      if (this.dependentUpdate) {
        if (!this._noAnchoringPropsUpdate) {
          var require = t.properties.indexOf("frm"), n = this.getProperty("frm"), o = t.values[require], a = o.getWidth() > h.Transform.MinimalDimention ? o.getWidth() : h.Transform.MinimalDimention, s = o.getHeight() > h.Transform.MinimalDimention ? o.getHeight() : h.Transform.MinimalDimention, l = n.getWidth() > h.Transform.MinimalDimention ? n.getWidth() : h.Transform.MinimalDimention, A = n.getHeight() > h.Transform.MinimalDimention ? n.getHeight() : h.Transform.MinimalDimention, c = new p().translated(-o.getX(), -o.getY()).scaled(l / a, A / s).translated(n.getX(), n.getY());
