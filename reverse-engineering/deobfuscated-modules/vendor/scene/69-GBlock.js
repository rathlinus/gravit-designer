...
function (exports, module, require) {
  var n = require(28) /* GStylable */, r = require(22) /* GElement */, o = require(2) /* GNode */, a = require(0) /* GObject */, s = require(6) /* GRect */, l = require(112) /* module */, h = require(207) /* GSceneOptions */, A = require(14) /* GPaintCanvas */, c = require(11) /* GUtil */;
  function p() {
  ...
  a.inheritAndMix(p, r, [
    ...
    NoSelect: 512
  }, p.VisualProperties = { vis: true }, p.MetaProperties = {
    name: null,
    lkt: null,
    ...
    var o = this._getLabelGeometryBBox(), a = 1;
    if (o || (o = new s(0, 0, 0, 0)), !this._scene)
      return null;
    !r || 0 === r.getX() && 0 === r.getY() || (o = o.translated(r.getX(), r.getY())), i && (o = i.mapRect(o), a = i.getScaleFactor());
    var A = h.scaleLabel ? a : this.getScaleLabelFactor(), c = this._scene.getLabelBBox(n ? 1 : A).getHeight();
    return new s(o.getX() - t, o.getY() - c - t, o.getWidth() + 2 * t, c + 2 * t).containsPoint(e) ? new l(this, { label: true }) : null;
    ...
    e instanceof p && this.transferProperties(e, [
      p.VisualProperties,
      p.MetaProperties
    ...
    if (e === o._Change.Store)
      this.storeProperties(t.blob, p.VisualProperties), this.storeProperties(t.blob, p.MetaProperties, function (e, t) {
        return "name" === e && t ? c.xss(t) : t;
      });
    else if (e === o._Change.Restore)
      this.restoreProperties(t.blob, p.VisualProperties), this.restoreProperties(t.blob, p.MetaProperties, function (e, t) {
        return "name" === e && t ? c.xss(t) : t;
      });
    else if (e == o._Change.AfterPropertiesChange) {
      var require = t, n = require.properties.indexOf("vis") >= 0, a = require.properties.indexOf("lkt") >= 0;
      (n || a) && (a && this.accept(function (e) {
        e instanceof r && this._updateElementLock(e);
      }.bind(this)), n && (this.accept(function (e) {
        e instanceof r && e._beforeVisibilityUpdate();
      }.bind(this)), this.accept(function (e) {
    ...
    var i = undefined !== t ? t : this.getProperty("vis");
    i && e instanceof p && (i = e.getProperty("vis"));
    var o = e.getParent() && e.getParent().hasMixin(n) && !("[GCompoundShape]" === e.getParent().toString()) && null !== e.getParent().getEffects().getFirstChild();
    i ? (e.removeFlag(r.Flag.Hidden), e.getParent() && e.getParent()._notifyChange(r._Change.ChildGeometryUpdate, [
      e,
      true
    ]), o ? e.getParent()._requestInvalidation() : e._requestInvalidation()) : (o ? e.getParent()._requestInvalidation() : e._requestInvalidation(), e.setFlag(r.Flag.Hidden), e.getParent() && e.getParent()._notifyChange(r._Change.ChildGeometryUpdate, [
      e,
      false
    ]));
    ...
    if (this.hasMixin(p.LabelHolder) && this._scene && e === this) {
      if (this.isPaintable()) {
        var module = e.getPaintBBox(null, true);
        if (module) {
          var require = this.getScene().getLabelBBox(this.getScaleLabelFactor()).getHeight();
          this._requestInvalidationArea(module.expanded(0, require, 0, 0));
        }
      }
    } else
      r.prototype._requestInvalidateNode.call(this, e);
    ...
    if (this.hasMixin(p.LabelHolder) && this._scene) {
      if (this._savedPaintBBox && !this._savedPaintBBox.isEmpty()) {
        var exports = this.getScene().getLabelBBox(this.getScaleLabelFactor()).getHeight();
        this._requestInvalidationArea(this._savedPaintBBox.expanded(0, exports, 0, 0));
      }
    } else
      r.prototype._invalidateOldPaintBBox.call(this);
  }, p.prototype._updateElementLock = function (e, t) {
    var i = undefined !== t ? t : this.getProperty("lkt");
