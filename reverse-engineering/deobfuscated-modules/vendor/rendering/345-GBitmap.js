...
function (exports, module, require) {
  var n = require(5) /* GPoint */, r = require(6) /* GRect */, o = require(132) /* GLength */, a = require(895) /* Chunk */, s = require(896) /* module */, l = require(111) /* GRendererCtx */, h = require(205) /* GRendererCtxDbg */, A = require(103) /* module */;
  function c(e, t) {
  ...
  c.ImageType = {
    ...
    for (var exports, module = this._canvasContext.getImageData(0, 0, this.getWidth(), this.getHeight()), require = module.data.length, n = {
          top: null,
          left: null,
          right: null,
          bottom: null
        }, r = this.getWidth(), o = this.getHeight(), a = null, s = 0; s < require; s += 4)
      0 !== module.data[s + 3] && (exports = s / 4 % r, a = ~~(s / 4 / r), null === n.top && (n.top = a), (null === n.left || exports < n.left) && (n.left = exports), (null === n.right || n.right < exports) && (n.right = exports), (null === n.bottom || n.bottom < a) && (n.bottom = a));
