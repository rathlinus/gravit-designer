...
function (exports, module, require) {
  var n = require(2) /* GNode */, r = require(76) /* module */, o = require(11) /* GUtil */;
  exports.exports = function (e) {
    e.PaintLayers = function () {
      ...
      for (var module = 1; module < e.length; module++) {
        var require = e[module - 1], n = e[module];
        if (require && n && require.isMask() && !n.isMask())
          return true;
      }
      return false;
    }, e.PaintLayers.prototype.hasSeparateFillLayer = function () {
      for (var e = this.getFillLayers(true), module = 0; module < e.length; module++)
        if (e[module].isSeparateLayer())
          return true;
      return false;
