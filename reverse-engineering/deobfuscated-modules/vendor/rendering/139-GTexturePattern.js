...
function (exports, module, require) {
  var n = require(50) /* GPattern */, r = require(7) /* GTransform */, o = require(11) /* GUtil */, a = require(6) /* GRect */, s = require(345) /* GBitmap */, l = require(2) /* GNode */, h = require(280) /* GWorkspace */, A = require(75) /* GEventTarget */, c = require(227) /* GDictionary */, p = require(111) /* GRendererCtx */, u = require(205) /* GRendererCtxDbg */;
  function d(e, t, i) {
    this._sizeMode = d.SizeMode.Auto, this._repeatMode = t || d.RepeatMode.None, this._angle = 0, this._tileSize = 1, this._mask = false, this._invalidate = false, this.setTexture(e);
  }
  d.UpdateEvent = function (e) {
  ...
  }, n.inheritAndMix("T", d, n, [A]), d.prototype._transform = undefined, d.prototype._url = null, d.prototype._image = null, d.prototype._node = null, d.prototype._repeatMode = d.RepeatMode.None, d.prototype._sizeMode = d.SizeMode.Auto, d.prototype._scaleMode = d.ScaleMode.Tile, d.prototype._width = null, d.prototype._height = null, d.prototype._position = d.PositionMode.Auto, d.prototype._tileSize = 1, d.prototype._mask = false, d.prototype._angle = 0, d.prototype._scaleX = 1, d.prototype._scaleY = 1, d.prototype._cloned = false, d.prototype._scene = null, d.prototype._storedUrl = null, d.prototype._cachedBitmap = null, d.prototype._invalidate = false, d.equals = function (e, t) {
    if (!e && e === t)
      return true;
    var i = true;
    return [
    ...
    if ("image" === l.getName(t) && i.push(t), t.hasMixin(l.Container) && t.acceptChildren(function (e) {
      ...
      if (A.addEventListener(n.StatusEvent, function (e) {
          e.status !== n.ImageStatus.Loaded && e.status !== n.ImageStatus.Error || (i.pop(), i.length || (this._invalidate = false, this._cachedBitmap = t.toBitmap(), this.requestInvalidation()));
      ...
      this._invalidate = false, this._cachedBitmap = t.toBitmap(), this._scene && this._cachedBitmap && this._cachedBitmap._canvasContext instanceof p && this._scene.addDestroyable(this._cachedBitmap._canvasContext);
    return this._cachedBitmap;
    ...
    if (this._scene = e, this._scene && this._url) {
      var module = this._scene.getDictionary().getValue(this._url);
      if ((!module || this._storedUrl && module !== this._storedUrl) && (this._url = this._storedUrl), !this._url || !this._initializeImage()) {
        var n = require(14) /* GPaintCanvas */.createChessboard(8, "#fcc", "#cfc"), r = new s(n);
    ...
    if (e)
      ...
      if (this._image = new Image(), this._scene) {
        if (!c.isDictionary(this._url)) {
          var require = this._scene.getDictionary().putValueIfAbsent(this._url);
          require && (this._url = require.getUrl());
        }
        this._scene.getWorkspace().resolveUrl(this._url, this._resolvedImage.bind(this), this._scene);
      } else
        c.isDictionary(this._url) ? t = false : this._resolvedImage(this._url);
    else
      t = false;
    return t;
    ...
    this._image && 0 !== this._image.naturalWidth && 0 !== this._image.naturalHeight && (this._invalidate = true, this._cachedBitmap = null, this.requestInvalidation());
    ...
    A = p(A, o.getWidth()), c = p(c, o.getHeight()), A && c && (this._image && (n = n.scaled(A, c)), l *= A, h *= c), A = (A || 1) * Math.max(1, i || 1), c = (c || 1) * Math.max(1, i || 1), A === this._scaleX && c === this._scaleY || (this._invalidate = true), this._scaleX = A, this._scaleY = c;
    ...
    return t.deserialize(e), t._cachedBitmap = this._cachedBitmap, this._cachedBitmap && (this._cloned = true), t._invalidate = true, t.setScene(this._scene), t;
