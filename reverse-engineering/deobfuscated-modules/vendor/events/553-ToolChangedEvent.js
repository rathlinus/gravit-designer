...
function (exports, module, require) {
  var n = require(64) /* GPlatform */, r = require(150) /* GModifiersChangedEvent */, o = require(75) /* GEventTarget */, a = require(0) /* GObject */, s = require(72) /* GEvent */, l = require(5) /* GPoint */, h = require(211) /* GTool */, A = require(761) /* GBezigonTool */, c = require(551) /* GEllipseTool */, p = require(758) /* GFillTool */, u = require(335) /* SmoothingManager */, d = require(764) /* GMagicTool */, g = require(756) /* GHandTool */, f = require(757) /* GKnifeTool */, m = require(748) /* AreaSelector */, y = require(759) /* GLayerTool */, _ = require(550) /* GLineTool */, v = require(753) /* GPathsGraphTool */, b = require(539) /* GPenTool */, C = require(548) /* GPointerTool */, w = require(384) /* GPolygonTool */, E = require(549) /* GRectangleTool */, B = require(762) /* GSimpleShapeTool */, x = require(763) /* GSliceTool */, P = require(754) /* GStarTool */, S = require(386) /* GSubSelectTool */, T = require(547) /* GTextTool */, I = require(746) /* GTriangleTool */, F = require(755) /* GZoomTool */, R = require(738) /* GConnectorTool */, D = require(77) /* Wheel */, k = require(765) /* GEllipseAnnotationTool */, G = require(767) /* GRectangleAnnotationTool */, Q = require(769) /* GArrowAnnotationTool */, M = require(771) /* GCommentAnnotationTool */, N = require(773) /* GPencilAnnotationTool */, U = require(775) /* GHighlighterAnnotationTool */;
  function V() {
  ...
  a.inheritAndMix(V, a, [o]), V.ToolChangedEvent = function (e, t, i) {
  ...
  }, a.inherit(V.ToolChangedEvent, s), V.ToolChangedEvent.prototype.previousTool = null, V.ToolChangedEvent.prototype.newTool = null, V.ToolChangedEvent.prototype.light = false, V.ToolChangedEvent.prototype.toString = function () {
  ...
  }, V.prototype._tools = null, V.prototype._typeIdToIndexMap = null, V.prototype._activeTool = null, V.prototype._oldTool = null, V.prototype._view = null, V.prototype._temporaryActiveTool = null, V.prototype._tempActivationTime = null, V.prototype._lightDeactivation = false, V.prototype.addTool = function (e) {
    if (e._manager)
      throw new Error("Tool is already registered");
    this._tools.push(e), e._manager = this, this._typeIdToIndexMap = {};
    for (var module = 0; module < this._tools.length; ++module) {
      e = this._tools[module];
      this._typeIdToIndexMap[a.getTypeId(e)] = module;
    }
    ...
    if (e && this.getTool(e) !== this._activeTool) {
      var module = this._activeTool, require = e == g || e == F || (module instanceof b || module instanceof A) && (e == b || e == A || e == C || e == S || e == m);
      if (this._activateTool(e, null, require))
        return this._lightDeactivation = require, this._temporaryActiveTool || (this._temporaryActiveTool = module), this._tempActivationTime || (this._tempActivationTime = new Date().getTime()), true;
    }
    return false;
  }, V.prototype.tempToolKeyRelease = function (e, t) {
    return !!(e && this.getTool(e) == this._activeTool && this._temporaryActiveTool && this._tempActivationTime) && (this._tempActivationTime + t <= new Date().getTime() ? this._activateTool(this._temporaryActiveTool) : this._lightDeactivation && (this._temporaryActiveTool.deactivate(this._view), this._activeTool.activate(this._view, true), this.hasEventListeners(V.ToolChangedEvent) && this.trigger(new V.ToolChangedEvent(this._temporaryActiveTool, this._activeTool, false)), this._lightDeactivation = false), this._temporaryActiveTool = null, this._tempActivationTime = null, true);
    ...
    if (!this._view.getEditor().isInlineEditing()) {
      var module = this.getTool(this.indexOf(g)), require = this.getTool(this.indexOf(F)), r = null;
      if ((n.modifiers.spaceKey || n.modifiers.middleButton) && this._temporaryActiveTool !== module ? r = module : this._temporaryActiveTool && this._tempActivationTime && !((e.spaceKey || e.middleButton) && this._activeTool == module || !n.modifiers.metaKey && e.metaKey && this._activeTool == require) && (r = this._activeTool), r || !module || module.isDeactivatable() || this._view.trigger(new D.DragEnd()), n.modifiers.metaKey && (r === module || this._activeTool instanceof g) && !this._tempActivationTime && (r = require), !r && this._temporaryActiveTool)
