...
function (exports, module, require) {
  var n = require(0) /* GObject */, r = require(6) /* GRect */, o = require(5) /* GPoint */, a = require(24) /* GEditorOptions */, s = require(75) /* GEventTarget */, l = require(72) /* GEvent */, h = require(14) /* GPaintCanvas */, A = require(7) /* GTransform */;
  function c(e) {
  ...
  c.VALUE_MARGIN = 5 * p, c.FONT_SIZE = 10 * p, c.InvalidationRequestEvent = function (e) {
  ...
  }, c.prototype._scene = null, c.prototype._view = null, c.prototype._activated = false, c.prototype._visuals = null, c.prototype._baseRect = null, c.prototype._targetRect = null, c.prototype._area = null, c.prototype.setView = function (e) {
    this._view = e;
    ...
    if (this._activated) {
      ...
      if (a.x || a.y)
        if (a.x && !a.y) {
          ...
          (G = this.correctValuePoint(b, g, R, k, null, null, true)).valuePt ? (this._visuals.push({
            line: G.line,
            value: l,
            valueBoxView: g,
            valuePt: G.valuePt,
          ...
          (G = this.correctValuePoint(E, f, R, k, null, null, true)).valuePt ? (this._visuals.push({
            line: G.line,
            value: u,
            valueBoxView: f,
            valuePt: G.valuePt,
    ...
    if (this._visuals && this._visuals.length) {
      var exports, module = null, require = null, n = null, o = null;
      this._area = null;
      for (var a = 0; a < this._visuals.length; ++a) {
        ...
        for (var l = 0; l < 2; ++l) {
          var h = exports[l];
          (null === module || module > h.getX()) && (module = h.getX()), (null === require || require > h.getY()) && (require = h.getY()), (null === n || n < h.getX()) && (n = h.getX()), (null === o || o < h.getY()) && (o = h.getY());
        }
        if (s.valueBoxView) {
      ...
      var p = Math.ceil(1 / this._view.getZoom()), u = new r(module -= p, require -= p, (n += p) - module, (o += p) - require);
      ...
      if (this._area && this._view.getViewConfiguration().multiPageView) {
        var f = this._scene.getActivePage().getPosition(true), m = new A(1, 0, 0, 1, f.getX(), f.getY());
    ...
    if (this._activated) {
      ...
      if (t.configuration.multiPageView) {
        var require = this._scene.getActivePage().getPosition(true);
        e = e.preMultiplied(new A(1, 0, 0, 1, require.getX(), require.getY()));
      }
      if (this._baseRect) {
