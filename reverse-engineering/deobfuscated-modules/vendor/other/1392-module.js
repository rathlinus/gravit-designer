...
function (exports, module, require) {
  ...
  r._slicedToArray = function (e, t) {
    ...
    if (Symbol.iterator in Object(e))
      return function (e, t) {
        var i = [], n = true, r = false, o = undefined;
        try {
          for (var a, s = e[Symbol.iterator](); !(n = (a = s.next()).done) && (i.push(a.value), !t || i.length !== t); n = true);
        } catch (e) {
          r = true, o = e;
        } finally {
          try {
    ...
    var t = e.px, i = e.py, o = e.cx, a = e.cy, s = e.rx, l = e.ry, h = e.xAxisRotation, A = undefined === h ? 0 : h, c = e.largeArcFlag, p = undefined === c ? 0 : c, u = e.sweepFlag, d = undefined === u ? 0 : u, g = [];
    if (0 === s || 0 === l)
      return [];
