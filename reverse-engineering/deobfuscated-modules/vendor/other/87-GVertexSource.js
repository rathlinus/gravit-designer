...
function (exports, module, require) {
  var n = require(48) /* GVertex */, r = require(12) /* GMath */;
  function o() {
  }
  o.prototype.rewindVertices = function (e) {
    ...
    var e, t, i = 0, o = null, a = null, s = null, l = new n(), h = [];
    e:
      for (; this.readVertex(l);) {
        switch (l.command) {
        case n.Command.Move:
          if (h.length > 0)
            break e;
        ...
        case n.Command.Curve2:
          e = new n(), this.readVertex(e), t = new n(), this.readVertex(t), h.push(e), h.push(t), h.push(l);
          break;
    ...
    for (var A = 2; A < h.length; A++) {
      o = a, a = s, s = h[A];
      var c = Math.atan2(a.y - o.y, a.x - o.x) - Math.atan2(s.y - a.y, s.x - a.x);
      c <= -Math.PI ? c = r.PI2 + c : c > Math.PI && (c = -r.PI2 + c), i += c;
    }
    return i <= 0;
  }, o.prototype.toSVGPath = function (e) {
    var t = "", i = new n(), r = false;
    this.rewindVertices(0);
    for (var o = function (e) {
      ...
      case n.Command.Curve:
        var s = new n();
        this.readVertex(s) ? o(i) && o(s) && (a(s), t += " Q " + s.x + " " + s.y + " " + i.x + " " + i.y) : r = true;
        break;
      case n.Command.Curve2:
        s = new n();
        var l = new n();
        this.readVertex(s) && this.readVertex(l) ? o(i) && o(s) && o(l) && (a(s), a(l), t += " C " + s.x + " " + s.y + " " + l.x + " " + l.y + " " + i.x + " " + i.y) : r = true;
        break;
      case n.Command.Close:
        t += " Z ";
      }
