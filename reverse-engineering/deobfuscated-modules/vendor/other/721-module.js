...
function (exports, module, require) {
  "use strict";
  var n = require(105) /* module */, r = require(89) /* module */.Parser, o = new Array(9), a = require(115) /* module */;
  o[1] = function () {
  ...
  o[5] = function () {
    ...
    if (3 === t) {
      var require = this.parseUShort(), o = this.parseUShort();
      return {
        substFormat: t,
        coverages: this.parseList(require, r.pointer(r.coverage)),
