...
function (exports, module, require) {
  ...
  const n = require(171) /* module_171 */, r = require(375) /* module */, o = require(170) /* GLocale */, a = require(526) /* module */;
  exports.exports = class {
    constructor(e) {
      ...
      if ("object" == typeof require) {
        n("<span></span>").addClass("title").html(require.title).appendTo(p), n("<div></div>").addClass("topics").appendTo(p).append(require.data.map(e => n("<div></div>").addClass("topic").append(n("<span></span>").addClass("g-cloud-icon-v").text(e))));
      } else
        "string" == typeof require && n("<span></span>").addClass("title no-bold").html(require).appendTo(p);
      ...
      n("<button></button>").addClass("g-cloud-ui-btn-pro highlighted").text(this._getFooterInfo().buy).on("click", () => {
        r("".concat(module || "offer", "_click_buybutton")), h && h();
