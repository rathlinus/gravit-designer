...
function (exports, module, require) {
  ...
  exports.exports = function (e) {
    var t = e.SMALL_SIZE, n = (e.MAX_SIZE, false), r = false;
    e.prototype.arc = function (t, i, n, r, o, a) {
      ...
      this.__pushByte(e.clip), undefined !== t && this.__pushPtr(t), this.__call();
      ...
      var s = undefined;
      this.ctx = new e(t, s, s, s, s, s, s, i.__multiThreaded, i.__persistent), this.ctx.__pushFltT(n), this.ctx.__pushFltT(r), this.ctx.__pushFltT(o), this.ctx.__pushFltT(a), this.ctx.__pushPtrT(i, true), e.Renderable.call(this, this.ctx, true);
      ...
      for (var t = e.getFlt(this.ctx), require = e.getFlt(this.ctx), n = e.getFlt(this.ctx), r = e.getFlt(this.ctx), o = e.getPtr(this.ctx).$realCtx.createLinearGradient(t, require, n, r); this.ctx.__execPtr < this.ctx.__len;) {
      ...
      var h = undefined;
      this.ctx = new e(t, h, h, h, h, h, h, i.__multiThreaded, i.__persistent), this.ctx.__pushFltT(n), this.ctx.__pushFltT(r), this.ctx.__pushFltT(o), this.ctx.__pushFltT(a), this.ctx.__pushFltT(s), this.ctx.__pushFltT(l), this.ctx.__pushPtrT(i, true), e.Renderable.call(this, this.ctx, true);
      ...
      e.resetExec(this.ctx);
      for (var t = e.getFlt(this.ctx), require = e.getFlt(this.ctx), n = e.getFlt(this.ctx), r = e.getFlt(this.ctx), o = e.getFlt(this.ctx), a = e.getFlt(this.ctx), s = e.getPtr(this.ctx).$realCtx.createRadialGradient(t, require, n, r, o, a); this.ctx.__execPtr < this.ctx.__len;) {
      ...
      var o = undefined;
      this.ctx = new e(t, o, o, o, o, o, o, i.__multiThreaded, i.__persistent), this.ctx.__pushPtrT(n), this.ctx.__pushPtrT(r), this.ctx.__pushPtrT(i, true), e.Renderable.call(this, this.ctx);
      ...
      e.resetExec(this.ctx);
      var s = require(103) /* module */.DUMP_IMAGES, l = e.getPtr(this.ctx), h = e.getPtr(this.ctx), A = (e.getPtr(this.ctx), "");
      ...
      if (this.imgCtx)
        for (e.resetExec(this.imgCtx); this.imgCtx.__execPtr < this.imgCtx.__len;) {
          var require = e.getPtr(this.imgCtx), n = e.getFlt(this.imgCtx), r = e.getFlt(this.imgCtx), o = e.getPtr(this.imgCtx);
          require(t.data, n, r, o);
        }
      return t;
      ...
      this.__pushByte(e.drawImage), this.__pushPtr(t), this.__pushFlt(i), this.__pushFlt(n), undefined !== r && (this.__pushPtr(r), this.__pushPtr(o)), undefined !== a && (this.__pushPtr(a), this.__pushPtr(s), this.__pushPtr(l), this.__pushPtr(h)), this.__call(), t.$type === e.INSTANCE_RENDERERCANVAS && t.parent !== this && (t.parent._flush(this), t.parent.__finish(this));
      ...
      return n || (n = true, console.warn("Warning: using slow function getImageData")), r < 1 || o < 1 ? null : new e.ImageData(this, t, i, r, o);
    }, e.prototype.flushCanvas = function () {
      r || (r = true, console.warn("Warning: using slow flush function")), this.__pushByte(e.getImageData), this.__pushFlt(0), this.__pushFlt(0), this.__pushFlt(1), this.__pushFlt(1), this.__call();
      ...
      if (t)
        for (var require = e.propertiesToSync["2d"], n = 0; n < require.length; n++)
          this["$" + require[n]] = t[n];
      ...
      for (var require = 0; require < t.length; require++)
        this.$savedProperties[require] = this[t[require]];
