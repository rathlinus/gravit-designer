...
function (exports, module, require) {
  var n = require(0) /* GObject */, r = require(69) /* GBlock */, o = require(22) /* GElement */, a = require(127) /* GPathEditor */, s = require(36) /* PartsPropertyVals */, l = require(39) /* PartInfo */, h = require(285) /* GCommentAnnotation */, A = require(172) /* GAnnotationEditor */, c = require(54) /* GVertexContainer */, p = require(63) /* GVertexTransformer */, u = require(141) /* module */, d = require(59) /* GVertexInfo */, g = require(7) /* GTransform */, f = require(153) /* GBBoxGuide */;
  function m(e, t) {
  ...
  m.prototype._showEditor = function (e) {
    ...
    if (!i && !this._element.hasFlag(o.Flag.Hidden)) {
      ...
      d && f && (t.canvas.putVertices(d, false), t.canvas.fillVertices("#fff", 1, 0, true), t.canvas.putVertices(f, false), t.canvas.fillVertices(n || (this.hasFlag(l.Flag.Highlighted) ? t.highlightOutlineColor : t.selectionOutlineColor), 1, 0, true));
    }
