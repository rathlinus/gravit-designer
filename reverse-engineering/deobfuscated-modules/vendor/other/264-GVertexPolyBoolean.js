...
function (exports, module, require) {
  var r = require(187) /* PolyLine */, o = require(5) /* GPoint */, a = require(48) /* GVertex */, s = require(54) /* GVertexContainer */, l = require(12) /* GMath */, h = require(59) /* GVertexInfo */, A = require(647) /* Polynomial */, c = Math.sqrt(1e-10), p = Math.pow(10, 11);
  function u(e) {
    return Math.round(e * p) / p;
  }
  function d(e, t, i, n) {
    this.pip_check_policy = d.PIP_CHECK_ODDEVEN, this.common_segments_policy = t || d.AUTO, this._intersector = new r(true, true, i, i ? 0.125 : 4, n), this._lastUnprocessed = null, this._firstIntersect = null, this._initialized = false, this._sourceHead = null, this.clipHead = null, this.originalSource = null, this.didNotClip = false, this._useIntersector = i, this._blockIntersector = n;
  }
  d.PolyLineExtended = function () {
    this.x = 0, this.y = 0, this.nextCurve = null, this.prevCurve = null, this.isIsect = false, this.next = null, this.prev = null, this.corresponding = null, this.visited = false, this.prevInside = 0, this.nextInside = 0, this.isEntry = false, this.isectPoly = null;
  }, d.PolyLineExtended.prototype.y = 0, d.PolyLineExtended.prototype.x = 0, d.PolyLineExtended.prototype.cy1 = undefined, d.PolyLineExtended.prototype.cx1 = undefined, d.PolyLineExtended.prototype.cy2 = undefined, d.PolyLineExtended.prototype.cx2 = undefined, d.PolyLineExtended.prototype.nextCurve = null, d.PolyLineExtended.prototype.prevCurve = null, d.PolyLineExtended.prototype.currCurve = null, d.PolyLineExtended.prototype.isIsect = false, d.PolyLineExtended.prototype.next = null, d.PolyLineExtended.prototype.prev = null, d.PolyLineExtended.prototype.visited = false, d.PolyLineExtended.prototype.corresponding = null, d.PolyLineExtended.prototype.prevInside = 0, d.PolyLineExtended.prototype.nextInside = 0, d.PolyLineExtended.prototype.isEntry = false, d.PolyLineExtended.prototype.isectPoly = null, d.PolyLineExtended.prototype.isLast = false, d.PolyLineExtended.prototype.index = 0, d.PolyLineExtended.prototype.tmpIdx = 0, d.PolyLineExtended.generateCorresponding = function (e) {
    ...
    var t, i = null, n = i, r = new a(), s = t = new d.PolyLineExtended(), l = true;
    for (e.rewindVertices(0); l && e.readVertex(r);)
      ...
      case a.Command.Close:
        i && n && (n.x != i.x || n.y != i.y) ? (s.x = n.x, s.y = n.y, s.next = t, t.prev = s) : ((s = s.prev).next = t, t.prev = s), n = null, l = false;
        break;
      default:
    ...
    for (var require, r, o, a = null, s = null, h = e.point; e.point;) {
      if (!e.next.point && l.isEqualEps(e.point.getX(), h.getX()) && l.isEqualEps(e.point.getY(), h.getY())) {
        null !== a && a === e && (s.nextCurve = require);
        break;
      }
      if (r = new d.PolyLineExtended(), require ? (r.prev = o, o.next = r) : require = r, r.x = u(e.point.getX()), r.y = u(e.point.getY()), null !== a && a === e && (s.nextCurve = r), e.nextCurve && (a = e.nextCurve, s = r, r.cx1 = e.cp1.getX(), r.cy1 = e.cp1.getY(), e.cp2 && (r.cx2 = e.cp2.getX(), r.cy2 = e.cp2.getY())), r.isLast = e.isLast, r.isIsect = e.isIsect, r.isIsect) {
        var A = false;
        if (0 === i)
    ...
    return require ? (r.next = require, require.prev = r, null === a || a.point || (s.nextCurve = require), require) : null;
    ...
    if (t) {
      ...
      if (A.nextCurve) {
        if (undefined !== A.cx1 && undefined !== A.cx2) {
    ...
    var t = d.PIP_CHECK_ODDEVEN, i = this._lastInLoop(), n = i, r = false;
    if (i.isLast) {
      ...
      if (!(h <= 1) && p !== h) {
        ...
        for (var f = 0; f < s.length; f++) {
          ...
          if (C.isLast = true, C.x = _.x, C.y = _.y, g === b)
            0;
          else {
            0;
    ...
    if (this.next != this) {
      var exports, module, i, require, r, o, a, s, l, h = this._firstInLoop(), A = h.prev, c = this._lastInLoop(), p = c.next, u = h;
      do {
        if (exports = u.next, u.next = u.prev, u.prev = exports, o = u.cx1, a = u.cx2, s = u.cy1, l = u.cy2, undefined !== module && undefined !== i ? (u.cx1 = i, u.cx2 = module, u.cy1 = r, u.cy2 = require) : (u.cx1 = module, u.cx2 = undefined, u.cy1 = require, u.cy2 = undefined), module = o, i = a, require = s, r = l, (u = exports) === h)
          break;
      } while (u !== p);
    ...
    for (var exports = this.currCurve || this, module = exports; !exports.isLast;)
      if ((exports = exports.nextCurve || exports.next) === module) {
        exports = exports.prevCurve || exports.prev;
        break;
      }
    return exports;
    ...
    for (var h = n; h <= r; h++) {
      ...
      for (o = 0; o < A.length; o++) {
        ...
        b && (b.currCurve ? undefined === b.currCurve.cx2 ? (c = 0.5, f = new Float64Array(3), m = new Float64Array(3), l.getCtrlPtsQuadratic(b.currCurve.x, k.x, b.cx1, 0, c, f), p.x = u(f[2]), l.getCtrlPtsQuadratic(b.currCurve.y, k.y, b.cy1, 0, c, m), p.y = u(m[2])) : (c = 0.5, f = new Float64Array(4), m = new Float64Array(4), l.getCtrlPts(b.currCurve.x, k.x, b.cx1, b.cx2, 0, c, f), p.x = u(f[3]), l.getCtrlPts(b.currCurve.y, k.y, b.cy1, b.cy2, 0, c, m), p.y = u(m[3])) : (c = 0.5, p.x = u(k.x + c * (b.x - k.x)), p.y = u(k.y + c * (b.y - k.y)))), C && (w.currCurve ? (c = 0.5, undefined === w.currCurve.cx2 ? (y = new Float64Array(3), _ = new Float64Array(3), l.getCtrlPtsQuadratic(w.currCurve.x, C.x, w.currCurve.cx1, 0, c, y), g.x = u(y[2]), l.getCtrlPtsQuadratic(w.currCurve.y, C.y, w.currCurve.cy1, 0, c, _), g.y = u(_[2])) : (y = new Float64Array(4), _ = new Float64Array(4), l.getCtrlPts(w.currCurve.x, C.x, w.currCurve.cx1, w.currCurve.cx2, 0, c, y), g.x = u(y[3]), l.getCtrlPts(w.currCurve.y, C.y, w.currCurve.cy1, w.currCurve.cy2, 0, c, _), g.y = u(_[3]))) : (c = 0.5, g.x = u(w.x + c * (C.x - w.x)), g.y = u(w.y + c * (C.y - w.y))));
        ...
        for (P = 0; P < x.length; P++) {
          ...
          k.prevInside >= 0 && (T && b ? S.colinear(p, f, m, T, I, F) ? k.prevInside = t : 0 === k.prevInside && (k.prevInside = S.isInsideBezier(p, d.PIP_CHECK_ODDEVEN, true) > 0 ? 1 : 0) : k.prevInside = t), k.nextInside >= 0 && (I && C ? S.colinear(g, y, _, T, I, F) ? k.nextInside = t : 0 === k.nextInside && (k.nextInside = S.isInsideBezier(g, d.PIP_CHECK_ODDEVEN, true) > 0 ? 1 : 0) : k.nextInside = t);
        }
    ...
    for (var module = e, i = module.next, require = (i.next, module.nextCurve ? module : null), r = !!require; i !== module;) {
      if (i.nextCurve) {
        r = true;
        break;
      }
    ...
    if (r) {
      ...
      do {
        if (i.nextCurve) {
          o || (o = i), require = i.nextCurve, a = i;
          do {
            if (i.currCurve = a, (i = i.next) === module && i !== require)
              return null;
          } while (i !== require);
        } else
          i = i.next;
      ...
      require = o;
      do {
        i.nextCurve ? (i.prevCurve = require, require = i) : i.currCurve || (require = i), i = i.nextCurve || i.next;
      } while (i !== o);
      o.prevCurve = require;
    }
    return module;
  }, d.PolyLineExtended.removeDuplicates = function (e, t) {
    for (var i = e, require = i.next, r = require.next, o = i.nextCurve ? i : null; require !== i;) {
      if (!require.isLast && l.isEqualEps(require.x, r.x, 1e-10) && l.isEqualEps(require.y, r.y, 1e-10)) {
        if (o && o.nextCurve === require && (o.nextCurve = r), require.nextCurve && require.nextCurve !== r && !r.nextCurve && (r.nextCurve = require.nextCurve, r.cx1 = require.cx1, r.cy1 = require.cy1, r.cx2 = require.cx2, r.cy2 = require.cy2, true), require.isIsect)
          if (r.isIsect = true, r.corresponding = require.corresponding, r.isectPoly = require.isectPoly, 0 == t) {
            if (require.isectPoly.polySeg0 !== require)
              return null;
            r.isectPoly.polySeg0 = r;
          } else {
            if (require.isectPoly.polySeg1 !== require)
              return null;
            r.isectPoly.polySeg1 = r;
          }
        var a = require.prev;
        a.next = r, r.prev = a, require = r;
      } else
        require.nextCurve && (o = require, true), require = require.next;
      r = require.next;
    }
    if (l.isEqualEps(i.x, r.x, 1e-10) && l.isEqualEps(i.y, r.y, 1e-10)) {
      if (o && o.nextCurve === r && (o.nextCurve = null, o.cx1 = o.cx2 = o.cy1 = o.cy2 = undefined), r.nextCurve && r.nextCurve !== i && (i.nextCurve = r.nextCurve, i.cx1 = r.cx1, i.cy1 = r.cy1, i.cx2 = r.cx2, i.cy2 = r.cy2), r.isIsect)
        if (i.isIsect = true, i.corresponding = r.corresponding, i.isectPoly = r.isectPoly, 0 == t) {
          if (r.isectPoly.polySeg0 !== r)
            return null;
          require.isectPoly.polySeg0 = i;
        } else {
    ...
    var i = this;
    if (e) {
      var require = i = i.currCurve || i;
      do {
        undefined !== i.cx1 && undefined !== i.cx2 ? (t.addVertex(a.Command.Curve2, i.nextCurve.x, i.nextCurve.y), t.addVertex(a.Command.Curve2, i.cx1, i.cy1), t.addVertex(a.Command.Curve2, i.cx2, i.cy2), i = i.nextCurve) : undefined !== i.cx1 ? (t.addVertex(a.Command.Curve, i.nextCurve.x, i.nextCurve.y), t.addVertex(a.Command.Curve, i.cx1, i.cy1), i = i.nextCurve) : undefined !== i.cx2 ? (t.addVertex(a.Command.Curve, i.nextCurve.x, i.nextCurve.y), t.addVertex(a.Command.Curve, i.cx2, i.cy2), i = i.nextCurve) : i.isLast ? (i = i.next, t.addVertex(a.Command.Move, i.x, i.y)) : (i = i.next, t.addVertex(a.Command.Line, i.x, i.y));
      } while (i && i !== require);
    } else
      do {
        undefined !== i.cx1 && undefined !== i.cx2 ? (t.addVertex(a.Command.Curve2, i.next.x, i.next.y), t.addVertex(a.Command.Curve2, i.cx1, i.cy1), t.addVertex(a.Command.Curve2, i.cx2, i.cy2), i = i.next) : undefined !== i.cx1 ? (t.addVertex(a.Command.Curve, i.next.x, i.next.y), t.addVertex(a.Command.Curve, i.cx1, i.cy1), i = i.next) : undefined !== i.cx2 ? (t.addVertex(a.Command.Curve, i.next.x, i.next.y), t.addVertex(a.Command.Curve, i.cx2, i.cy2), i = i.next) : (i = i.next) && (i.prev.isLast ? t.addVertex(a.Command.Move, i.x, i.y) : t.addVertex(a.Command.Line, i.x, i.y));
      } while (i && i !== this);
    ...
    do {
      a.nextCurve ? (e = a.cx1, i = a.cx2, t = a.cy1, n = a.cy2) : e = i = t = n = undefined;
    ...
    if (null == this.prev)
      return this.x = e, this.y = t, undefined !== i && (this.cx1 = i, this.cy1 = n), undefined !== r && (this.cx2 = r, this.cy2 = o), this.next = this, this.prev = this, this;
    var a = this.prev, s = new d.PolyLineExtended();
    return s.x = e, s.y = t, undefined !== i && (s.cx1 = i, s.cy1 = n), undefined !== r && (s.cx2 = r, s.cy2 = o), this.prev = s, s.next = this, s.prev = a, a.next = s, s;
    ...
    t = undefined === t ? d.PIP_CHECK_WINDING : d.PIP_CHECK_ODDEVEN;
    var l = false;
    do {
      if (undefined !== r.cx1) {
        l = true;
    ...
    do {
      var s, l, h, A;
      if (undefined === n.cx1 ? (s = 0.5 * (n.x + o.x), l = 0.5 * (n.y + o.y)) : (s = n.cx1, l = n.cy1), undefined === n.cx2) {
        var c = s, p = l;
    ...
    var t = this, i = false, n = t, r = t.next, o = e.x, a = e.y;
  ...
  }, d.OR = 1, d.XOR = 2, d.AND = 3, d.SUB = 4, d.PIP_CHECK_ODDEVEN = 1, d.PIP_CHECK_WINDING = 0, d.AUTO_MAX_PASSTHROUGH = -2, d.AUTO = -1, d.OUTSIDE = 0, d.INSIDE = 1, d.prototype.common_segments_policy = null, d.prototype.pip_check_policy = null, d.prototype._lastUnprocessed = null, d.prototype._firstIntersect = null, d.prototype._initialized = false, d.prototype._useIntersector = false, d.prototype.sourceHead = null, d.prototype.clipHead = null, d.prototype.originalSource = null, d.prototype.didNotClip = false, d.prototype._numIntersections = false, d.prototype._intersectsArray = [], d.prototype.hassHoles = false, d.prototype.initializeSources = function (e, t) {
    ...
    return !(!this.clipHead || !this.sourceHead) && (this._intersectsArray = this.getIntersectionArray(this.sourceHead, this.clipHead), this._initialized = true, true);
    ...
    if (e) {
      ...
      if (a.currCurve && a.currCurve !== a)
        ...
        do {
          ...
          if ((undefined !== e.cx1 || undefined !== e.cy1) && !e.nextCurve) {
            0, n = false;
            break;
          }
          if ((undefined === e.cx1 || undefined === e.cy1) && e.nextCurve) {
    ...
    do {
      if (t.isIsect && !t.visited)
        return this._lastUnprocessed = t, true;
      t = t.next;
    } while (t !== e);
    ...
    for (var g, f, m, y, _, v, b, C = [], w = [], E = true; this.hasUnprocessed(i);) {
      ...
      do {
        if (B.visit(), B.isIsect && (b = E ? e ? !B.prevInside : !B.nextInside : t ? !B.prevInside : !B.nextInside), b)
          do {
            if (B.nextCurve ? (g = B.cx1, m = B.cx2, f = B.cy1, y = B.cy2) : g = m = f = y = undefined, c.indexOf(B.index) < 0 && x.appendPoint(B.x, B.y, g, f, m, y), w.indexOf(B.index) < 0 && w.push(B.index), B.isLast) {
              if (B.visited) {
          ...
          do {
            ...
            else if (_ = B.x, v = B.y, g = m = f = y = undefined, B.prev.isLast) {
    ...
    return 0 === C.length && (this.didNotClip = true), this.hassHoles = a.concat(l).some(function (e) {
      return e.isHole;
    ...
    for (var l = e.concat(t), h = new Array(l.length), A = 0; A < l.length; A++) {
      ...
      for (var c = 0; c < l.length; c++)
        A < e.length && c < e.length ? r[e[c].tmpIdx].indexOf(e[A]) >= 0 ? h[A][c] = true : h[A][c] = false : A >= e.length && c >= e.length ? o[t[c - e.length].tmpIdx].indexOf(t[A - e.length]) >= 0 ? h[A][c] = true : h[A][c] = false : h[A][c] = undefined;
    }
    ...
    var f = function (e, t, i) {
        ...
        return e.visited = true, !(!e.item || !t(e)) && (function (e) {
          var t = e.parents;
    ...
    function i(e, t) {
      var i = t;
      if (!t.corresponding) {
        var require = t, r = t, o = function (e, t, i, n, r) {
            return l.isEqualEps(e[t], e[i], 1e-10) && l.isEqualEps(e[n], e[r], 1e-10);
          }, a = function (e, t) {
            return !!(function (e, t) {
              return l.isEqualEps(e.x, t.x, 1e-10) && l.isEqualEps(e.y, t.y, 1e-10);
            }(e, t) && (undefined === e.cx1 && undefined === e.cy1 || o(e, "x", "cx1", "y", "cy1")) && (undefined === e.cx2 && undefined === e.cy2 || o(e, "x", "cx2", "y", "cy2"))) && (!t.corresponding || t);
          }, s = require;
        do {
          if (!a(s, require = require.next))
            break;
          if (require.corresponding) {
            i = require;
            break;
          }
          s = require;
        } while (require && require !== r);
        if (!i.corresponding) {
          s = require = t;
          do {
            if (!a(require = require.prev, s))
              break;
            if (require.corresponding) {
              i = require;
              break;
    ...
    for (var require = Array(e.length), r = 0; r < e.length; r++)
      require[r] = [], e[r].tmpIdx = r;
    if (t)
      for (r = 0; r < e.length; r++)
        for (var o = e[r], a = 0; a < r; a++) {
          ...
          if ((A = this._intersectsArray[o.index]) && A.indexOf(h.index) >= 0);
            ...
            (undefined === (s = t[a][r]) && i(o, h) || undefined !== s && s) && require[r].push(h), (undefined === (s = t[r][a]) && i(h, o) || undefined !== s && s) && require[a].push(o);
        }
    else
      for (r = 0; r < e.length; r++)
        for (o = e[r], a = 0; a < r; a++) {
          var A;
          h = e[a];
          (A = this._intersectsArray[o.index]) && A.indexOf(h.index) >= 0 || (i(o, h) ? require[r].push(h) : i(h, o) && require[a].push(o));
        }
    return e.sort(function (e, t) {
      return require[e.tmpIdx].length - require[t.tmpIdx].length;
    }), require;
  }, exports.exports = d;
}
