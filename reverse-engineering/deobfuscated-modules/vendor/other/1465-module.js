...
function (exports, module, require) {
  var n = require(147) /* GLinearGradient */, r = require(7) /* GTransform */, o = require(5) /* GPoint */, a = require(6) /* GRect */, s = require(158) /* GRadialGradient */, l = require(801) /* module */;
  function h(e, t) {
  ...
  h.prototype._options = null, h.prototype._duplicateLastPath = function () {
    ...
    if (!e) {
      var require = this._origin.getX(), n = this._origin.getY(), o = this._scale;
      t = t.multiplied(new r().scaled(o, o).translated(-require, -n));
    }
    return t;
