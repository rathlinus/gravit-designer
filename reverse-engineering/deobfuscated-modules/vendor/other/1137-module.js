...
function (exports, module, require) {
  var n = require(1138) /* module */, r = require(250) /* module_250 */;
  function o(e) {
    this._bplist = e;
  }
  o.from = function (e) {
    ...
    for (var module = e["NS.keys"].map(function (e) {
          return this.getByRef(e);
        }.bind(this)), require = e["NS.objects"].map(function (e) {
          return this.getByRef(e);
        }.bind(this)), n = {}, r = 0; r < module.length; r++)
      n[module[r]] = require[r];
    return n;
  }, o.toByte = function (e) {
