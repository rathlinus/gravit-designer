...
function (exports, module, require) {
  var n = require(11) /* GUtil */, r = require(438) /* module */, o = function () {
    };
  o.createMask = function (e, t, i, o, a) {
    ...
    if (s.removeChild(i), n.each(s.childNodes, function (e, t) {
      ...
      }), s.appendChild(a), a.appendChild(i), r.isMask = true, "destination-out" === t) {
      r.isInverse = true;
    ...
    o.setAttribute("id", r), n.each(t.childNodes, function (e, t) {
      if ("path" === t.tagName) {
        var i = t.cloneNode(true), n = i.getAttribute("style");
