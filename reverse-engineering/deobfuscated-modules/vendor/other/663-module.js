...
function (exports, module, require) {
  var n = require(14) /* GPaintCanvas */, r = require(0) /* GObject */, o = require(5) /* GPoint */, a = require(6) /* GRect */, s = require(7) /* GTransform */, l = require(103) /* module */, h = require(118) /* module */, A = require(166) /* GRendererConfig */, c = require(934) /* CacheEntry */, p = require(937) /* module */;
  function u(e, t) {
    this._paintCanvases = [], this._numHorizontal = e, this._numVertical = t;
    for (var require = this.isThreaded(), r = 0; r < e; r++)
      for (var o = 0; o < t; o++)
        this._paintCanvases.push(new n(true, false, true, require));
    this._panHelper = new n(false, true), this._panHelper.setRenderAlgorithm(n.RenderAlgorithm.Crisp), this._panHelper.setImageSmoothingQuality(n.SmoothingQuality.High), this._panHelper.prepare(), this._paintCanvasCache = new c();
  }
  r.inheritAndMix(u, r, [h]), u.prototype._paintCanvases = null, u.prototype._paintCanvasCache = null, u.prototype._panHelper = null, u.prototype._numHorizontal = 0, u.prototype._numVertical = 0, u.prototype._consolidatedCanvas = null, u.prototype._renderQueue = null, u.prototype._iterateGrid = function (e, t) {
    for (var require, n = 0, r = 0, o = 0; o < this._numHorizontal; o++) {
      r = 0;
      for (var a = 0; a < this._numVertical; a++) {
        if (require = this._paintCanvases[o * this._numVertical + a], !t || t && !require.$renderedBitmap) {
          var s = e(require, n, r);
          if (false === s)
            return s;
        }
    ...
    for (var exports = 0, module = 0; module < this._numHorizontal; module++)
      exports += this._paintCanvases[module * this._numVertical].getWidth();
    return exports;
  }, u.prototype.getHeight = function () {
    for (var exports = 0, module = 0; module < this._numVertical; module++)
      exports += this._paintCanvases[module].getHeight();
    return exports;
  }, u.prototype.resize = function (e, t) {
    if (e != this.getWidth() || t != this.getHeight()) {
      for (var require, n, r = e / this._numHorizontal, o = t / this._numVertical, a = Math.floor(r), s = Math.floor(o), l = e - a * (this._numHorizontal - 1), h = t - s * (this._numVertical - 1), A = 1, c = 1, p = 0; p < this._numHorizontal; p++) {
        require = p === this._numHorizontal - 1 ? l : a, A = Math.max(A, require);
        for (var u = 0; u < this._numVertical; u++)
          n = u === this._numVertical - 1 ? h : s, c = Math.max(c, n), this._paintCanvases[p * this._numVertical + u].resize(require, n);
      }
    ...
    return 1 === this._renderQueue.length ? (this._renderQueue = [], false) : (this._renderQueue = [this._renderQueue[this._renderQueue.length - 1]], this._scheduleRender(), true);
  }, u.prototype._scheduleRender = function () {
    if (!(0 === this._renderQueue.length || this._renderQueue.length > 1)) {
      var exports = this._renderQueue[0];
      l.isRenderPhase() || this._paintCanvases.some(function (e) {
        return l.isRenderPhase(e.getRendererContext());
      }) ? console.log("SCHEDULERENDER: ERROR: render phase render, waiting") : this._paintAndRenderInternal(exports.scene, exports.paintContext, exports.viewTransform, exports.origin, exports.scale, exports.screen, exports.panRepaint, exports.callback);
    }
  }, u.prototype._paintAndRenderInternal = function (e, t, i, n, r, h, c, p) {
    var u, d, g = 0, f = 0, m = this, y = this.isThreaded(), _ = t.dirtyMatcher, v = false, b = [], C = [], w = [], E = [], B = function (e, i, n, o) {
        if (i && f++, i && !n) {
          var a = m._getGridIndexForNativeCanvas(e);
          if (!(!A.ENABLE_CACHE || false === w[a]) && b[a] && (!o || !o.quickRender && !o.noWebGL) && Date.now() - w[a] > A.CACHE_WHEN_DRAWING_LONGER_THAN) {
            var s = m._paintCanvases[a];
            m._paintCanvasCache.setCache(s, b[a], r, C[a]);
          }
        }
        if (n && (v = true), f === g)
          t.dirtyMatcher = _, m._renderNext() || p(e, true, v);
    ...
    (d = c || 1 === m._paintCanvases.length || m.isThreaded() ? m._iterateGrid : m._iterateGridAsync).call(m, function (c, u, d) {
      ...
      if (v) {
        ...
        try {
          ...
          }.bind({ idx: x }))) : (w[x] = !!S && Date.now(), T ? B(T._canvasContext.canvas, true, false) : l.render(c.getRendererContext(), 0, B));
        } catch (e) {
          return console.error("Render error at canvas " + x + ":" + e), m.cleanup(), p(null, true, false), m._renderNext(), false;
        } finally {
    ...
    for (var module = 0; module < this._paintCanvases.length; module++)
      if (this._paintCanvases[module].getRendererContext()) {
        if (this._paintCanvases[module].getRendererContext().$realCtx.canvas === e)
          return module;
      } else if (e instanceof n) {
        if (self._paintCanvases[module] === e)
          return module;
      } else if (self._paintCanvases[module]._canvasContext.canvas === e)
        return module;
    return -1;
  }, u.prototype.cleanup = function () {
    for (var exports = 0; exports < this._paintCanvases.length; exports++)
      l.forceCleanup(this._paintCanvases[exports].getRendererContext());
      ...
      n = this._iterateGrid(function (t, n, r) {
        if (i) {
          ...
          if (o.$realCanvas === i || o.$renderedBitmap === i || o === i)
            return e.drawImage(t, n, r), false;
        } else
          e.drawImage(t, n, r);
    ...
    for (var exports = 0; exports < this._paintCanvases.length; exports++)
      this._paintCanvases[exports].destroy();
    ...
    for (var module = 0; module < this._paintCanvases.length; module++)
      this._paintCanvases[module].setImageSmoothingQuality(e);
  }, u.prototype.setRenderAlgorithm = function (e) {
    for (var module = 0; module < this._paintCanvases.length; module++)
      this._paintCanvases[module].setRenderAlgorithm(e);
  }, exports.exports = u;
}
