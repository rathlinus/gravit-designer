...
function (exports, module, require) {
  var n = require(723) /* module */;
  function r(e) {
    n.call(this, e, "gpos");
  }
  r.prototype = n.prototype, r.prototype.init = function () {
    ...
    for (var n = 0; n < e.length; n++)
      for (var r = e[n].subtables, o = 0; o < r.length; o++) {
        var a = r[o], s = this.getCoverageIndex(a.coverage, t);
        if (!(s < 0))
          switch (a.posFormat) {
          case 1:
            ...
            break;
          case 2:
            var A, c = this.getGlyphClass(a.classDef1, t), p = this.getGlyphClass(a.classDef2, i);
            return (A = a.classRecords[c][p]).value1 && A.value1.xAdvance || 0;
          }
      }
    return 0;
