...
function (exports, module, require) {
  var n = require(195) /* module */, r = require(508) /* module */;
  function o(e, t) {
    var i, a, s, l, h;
    if ("string" == typeof e.text ? (1 === e.text.length && ("\n" === e.text[0] || e.text[0] === n.LS ? (a = true, h = e.text[0] === n.LS) : a = false, s = " " === e.text[0]), i = o.DoMeasure ? n.measure(a ? n.NBSP : e.text, e) : new r()) : i = (l = t(e.text) || o.DefaultInline).measure ? l.measure(e) : new r(), !i)
  ...
  o.prototype.run = null, o.prototype.isNewLine = false, o.prototype.isSoftBreak = false, o.prototype.width = 0, o.prototype.ascent = 0, o.prototype.descent = 0, o.prototype.minY = 0, o.prototype.maxY = 0, o.prototype.minX = 0, o.prototype.maxX = 0, o.prototype.code = null, o.prototype.lastGlyphWidth = 0, o.prototype.lastGlyphAdvance = 0, o.prototype.draw = function (e, t, i) {
  ...
  }, o.DoMeasure = true, o.DefaultInline.measure = function (e) {
    var t = n.measure("?", e);
    return {
      width: t.width + 4,
      ascent: t.width + 2,
