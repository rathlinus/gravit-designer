...
function (exports, module, require) {
  var n = require(1210) /* JDataView */;
  function r(e, t) {
    for (var require = 0, n = t = t || 0; n < e.byteLength; n++)
      require <<= 8, require |= 255 & e.getUint8(n);
    return require;
  }
  function o() {
  }
    ...
    return function e(i) {
      ...
      case 2:
        return function () {
          ...
          if (4 === e)
            return i.getFloat32(0, false);
          if (8 === e)
            return i.getFloat64(0, false);
        }();
      case 3:
        return function () {
          3 != h && console.error("Unknown date type :" + h + ". Parsing anyway...");
          var e = t.slice(o + 1, o + 9);
          return new Date(978307200000 + 1000 * e.getFloat64(0, false));
        }();
      case 4:
        return function () {
          var e = 1, i = h;
