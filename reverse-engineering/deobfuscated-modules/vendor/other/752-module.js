...
function (exports, module, require) {
  var n = require(82) /* SavePoint */, r = require(0) /* GObject */, o = require(108) /* GFont */, a = require(52) /* module */, s = require(77) /* Wheel */, l = require(5) /* GPoint */, h = require(24) /* GEditorOptions */, A = require(6) /* GRect */, c = require(167) /* module */, p = require(7) /* GTransform */, u = require(164) /* GKey */, d = require(64) /* GPlatform */, g = require(11) /* GUtil */, f = require(215) /* GTLPathTextTransformer */, m = require(266) /* GTLDirectionTextTransformer */, y = require(195) /* module */, _ = require(9) /* GLocale */, v = require(47) /* GLocaleKey */;
  function b(e) {
    this._toggles = {
      B: "fontWeight",
      I: "fontStyle",
  ...
  r.inherit(b, r), b.HANDLECOPYPASTE = false, b.prototype._editor = null, b.prototype._view = null, b.prototype._textUnderMouse = false, b.prototype._activated = false, b.prototype._keyboardSelect = 0, b.prototype._keyboardX = null, b.prototype._nextKeyboardX = null, b.prototype._selectDragStart = null, b.prototype._focusChar = null, b.prototype._richClipboard = null, b.prototype._plainClipboard = null, b.prototype._toggles = null, b.prototype._caretInterval = 0, b.prototype._lastSelect = undefined, b.prototype._lastTimeStamp = -1, b.prototype._lastResult = false, b.prototype._keyDownHandled = null, b.prototype._compositionOn = false, b.prototype._lastCompositedTextLength = 0, b.prototype._compositionSelectionDelta = 0, b.IS_NON_PRINTABLE_REG = /^[\u0000-\u001f\u0080-\u009f\u2029]*$/, b.prototype.isActivated = function () {
    return this._activated;
  }, b.prototype.activate = function (e) {
    var t = this._editor.getElement().getTLCore();
    t && t.setInlineEdit(true), this._activated = true, this._view = e, this._textUnderMouse = true, this.showCaretAndSelection(), this._view.setCursor(a.Text), e.addEventListener(s.Move, this._mouseMove, this), e.addEventListener(s.Down, this._mouseDown, this), e.addEventListener(s.Release, this._mouseRelease, this), e.addEventListener(s.DblClick, this._mouseDblClick, this), e.addEventListener(c.Down, this._keyDown, this), e.addEventListener(c.Release, this._keyUp, this), this._view.startCaptureInput(this._boxInput.bind(this), this._compStart.bind(this), this._compEnd.bind(this)), this._view.isCapturingInput() || e.addEventListener(c.Press, this._keyPress, this);
  }, b.prototype.deactivate = function () {
    var e = this._editor.getElement().getTLCore();
    e && e.setInlineEdit(false), this.hideCaretAndSelection(), this._view.setCursor(null), this._activated = false, this._view.isCapturingInput() ? this._view.endCaptureInput() : this._view.removeEventListener(c.Press, this._keyPress, this), this._view.removeEventListener(s.Move, this._mouseMove, this), this._view.removeEventListener(s.Down, this._mouseDown, this), this._view.removeEventListener(s.Release, this._mouseRelease, this), this._view.removeEventListener(s.DblClick, this._mouseDblClick, this), this._view.removeEventListener(c.Down, this._keyDown, this), this._view.removeEventListener(c.Release, this._keyUp, this), this._view = null;
  }, b.prototype.showCaretAndSelection = function () {
    if (0 === this._caretInterval) {
      var exports = this._editor.getElement().getTLCore();
      if (exports)
        if (undefined === this._lastSelect) {
          var module = exports.getLength() - 1;
          exports.select(0, module), this._lastSelect = g.extend({}, exports.getSelection());
        } else
          exports.select(this._lastSelect.start, this._lastSelect.end);
    ...
    if (0 !== this._caretInterval) {
      var exports = this._editor.getElement().getTLCore();
      exports && (this._lastSelect = g.extend({}, exports.getSelection()), exports.select(0, 0)), clearInterval(this._caretInterval), this._caretInterval = 0;
    }
    ...
    if (t.end === t.start && this.hasFocus() && (e.isSelectionChanged() || e.isCaretVisible())) {
      var require, n = e.getCaretCoords(t.start), r = null;
      if (e.getTransformer()) {
        var o = e.getTransformer(f.TYPE) ? n.h : 0;
        require = new A(n.l, n.t - e.getVShift() - o, n.w, n.h);
        ...
        require = new A(n.l, n.t - e.getVShift(), n.w, n.h);
      return {
        box: require,
        transform: r
      };
    ...
    if (0 === e) {
      var module = this._editor.getElement().getTLCore();
      if (module) {
        var require = module.wordContainingOrdinal(e), n = require && require.word;
    ...
    if (this._view.isCapturingInput()) {
      var module = this._editor.getElement().getTLCore();
      if (module) {
        var require = module.byOrdinal(this._focusChar);
        if (require) {
          var n = this._editor.getElement().getGeometryBBox(), r = require.bounds();
    ...
    if (a) {
      ...
      if (l) {
        ...
        var h = l.getSelection().start, A = l.getSelection().end, c = l.getLength() - 1, p = false;
        ...
        var d = 1 === this._keyboardSelect ? A : h, g = false;
        switch (this._editor.contentSetEnabled(0), e) {
        case u.Constant.LEFT:
          if (this._compositionOn)
            r > 0 && (d--, this._compositionSelectionDelta++, this._lastCompositedTextLength > this._compositionSelectionDelta && d > 0 && "'" === l.getRange(d - 1, d).plainText() && (d--, this._compositionSelectionDelta++), this._isSelectable(d) && (g = true));
          else {
            if (t || h == A) {
              if (d > 0)
                if (i)
        ...
        case u.Constant.RIGHT:
          if (this._compositionOn)
            r < this._lastCompositedTextLength && ("'" === l.getRange(d, d + 1).plainText() && (d++, this._compositionSelectionDelta--), this._compositionSelectionDelta > 0 && (d++, this._compositionSelectionDelta--), g = true);
          else {
            var f;
            if (t || h == A) {
              if (d < c)
        ...
        case u.Constant.UP:
          ...
          break;
        case u.Constant.HOME:
          this._compositionOn ? r > 0 && (d -= r, this._compositionSelectionDelta = this._lastCompositedTextLength, g = true) : (d = this._endOfline(d, -1), g = true);
          break;
        case u.Constant.END:
          this._compositionOn ? r < this._lastCompositedTextLength && (d += this._lastCompositedTextLength - r, this._compositionSelectionDelta = 0, g = true) : (d = this._endOfline(d, 1), g = true);
          break;
        case u.Constant.PAGE_UP:
          d = 0, g = true;
          break;
        ...
        case u.Constant.BACKSPACE:
          h > 0 && h === A ? (l.getRange(h - 1, h).clear(), this._focusChar = h - 1, l.select(this._focusChar, this._focusChar)) : h !== A && (l.getRange(h, A).clear(), this._focusChar = h, l.select(this._focusChar, this._focusChar)), p = true;
          break;
        case u.Constant.DELETE:
          h < c && (h === A ? l.getRange(h, h + 1).clear() : (l.getRange(h, A).clear(), this._focusChar = h, l.select(this._focusChar, this._focusChar))), p = true;
          break;
        case u.Constant.SPACE:
          "lorem" === l.getDocumentRange().plainText().toLowerCase() ? (l.getDocumentRange().clear(), l.select(0, 0), l.insert("Lorem ipsum dolor sit amet, consectetur adipiscing elit,sed do eiusmod tempor incididunt ut labore et dolore magnaaliqua. Ut enim ad minim veniam, quis nostrud exercitationullamco laboris nisi ut aliquip ex ea commodo consequat.Duis aute irure dolor in reprehenderit in voluptate velitesse cillum dolore eu fugiat nulla pariatur. Excepteur sintoccaecat cupidatat non proident, sunt in culpa qui officiadeserunt mollit anim id est laborum.".replace(/\t/g, " ")), this._editor.invalidateTextWidth()) : l.insert(" "), p = true;
          break;
        case u.Constant.ENTER:
          (m = l.selectedRange()) && m.isList() && !this._shiftKeyDown && (m.canInsertListItem() ? (l.insert(m.createListItem()), p = true) : p = m.unlistify(true)), p || l.insert(this._shiftKeyDown ? y.LS : "\n"), p = true;
          break;
        case u.Constant.TAB:
          var m;
          (m = l.selectedRange()) && m.canChangeListDepth() && (p = this._shiftKeyDown ? m.decreaseList() : m.increaseList()), p || (l.insert("   "), p = true);
          break;
        case "Z":
          i && (p = true, !this._compositionOn && s.hasUndoState() && (s.undoState(), this._lastCompositedTextLength = 0, this._view && this._view.resetInputBoxContent()));
          break;
        case "Y":
        ...
        case "A":
          ...
          break;
        case "C":
          b.HANDLECOPYPASTE && i && (this._richClipboard = l.selectedRange().save(), this._plainClipboard = l.selectedRange().plainText(), p = true);
          break;
        case "X":
          b.HANDLECOPYPASTE && i && (this._richClipboard = l.selectedRange().save(), this._plainClipboard = l.selectedRange().plainText(), l.getRange(h, A).clear(), this._focusChar = h, l.select(this._focusChar, this._focusChar), p = true);
          break;
        case "V":
        ...
        if (!this._shiftKeyDown && i && C) {
          ...
          "fontWeight" === C ? (w = this._editor.getProperty("_tfs"), ((B = E = parseInt(P) == o.Weight.Bold ? o.Weight.Regular : o.Weight.Bold) === o.Weight.Normal || undefined === I || I.filter(function (e) {
            return e.style === w && e.weight === E;
          }).length > 0) && (s.beginTransaction(), this._editor.setProperties(["_tfw"], [B]), s.commitTransaction(_.get(new v("GInlineTextEditor", "action.modify-text-properties"))))) : "fontStyle" === C ? (E = this._editor.getProperty("_tfw"), ((B = w = "italic" == P ? o.Style.Normal : o.Style.Italic) === o.Style.Normal || undefined === I || I.filter(function (e) {
            return e.style === w && e.weight === E;
          }).length > 0) && (s.beginTransaction(), this._editor.setProperties(["_tfs"], [B]), s.commitTransaction(_.get(new v("GInlineTextEditor", "action.modify-text-properties"))))) : (this._editor.contentSetEnabled(0), x.setFormatting(C, true !== P), this._editor.contentSetEnabled(1)), p = true, this._editor.triggerHotkeyEvent([
            u.Constant.CONTROL,
            e
          ]);
        }
    ...
    var e = this._editor.getElement().getTLCore();
    if (e) {
      var module = e.getSelection().start, require = e.getSelection().end;
      this._editor.requestInvalidation(), this._editor.contentSetEnabled(0), e.getRange(module, require).clear(), this._editor.contentSetEnabled(1), this._focusChar = module, e.select(this._focusChar, this._focusChar), this._keyboardX = null;
    }
    ...
    if (this._editor.getElement().getTLCore()) {
      ...
      return r || ("string" == typeof e || e instanceof String) && 1 === e.length && (r = e, o = e.toLowerCase().charCodeAt(0), n = null), n && r && r.length ? l = true : !i && r && (t ? ((a = s.indexOf(o)) >= 0 && (r = ")!@#$%^&*(:+<_>?~{|}\"~{|}\"".charAt(a)), l = r && r.length) : l = (r = (a = s.indexOf(o)) >= 0 ? "0123456789;=,-./`[\\]'`[\\]'".charAt(a) : r.toLowerCase()) && r.length), l;
    }
    ...
    this._compositionOn && this._view && this._view.resetInputBoxContent(), this._compositionOn = true, this._lastCompositedTextLength = 0, this._compositionSelectionDelta = 0;
    ...
    if (n)
      if (this.hasFocus()) {
        if (!b.IS_NON_PRINTABLE_REG.test(i) && !this._keyDownHandled) {
          ...
          return this._updateTextArea(e), this._editor.contentSetEnabled(1), this._lastResult = true, e.preventDefault(), e.stopPropagation(), false;
        }
      } else
    ...
    return this._checkTimeStamp(r) ? !this._lastResult && undefined : (this._lastTimeStamp = r, this._lastResult = false, this.hasFocus() ? (this._editor.requestInvalidation(), this._handleKey(t, i, n) ? (this._lastResult = true, this._keyDownHandled = t, e.preventDefault(), e.stopPropagation(), false) : this._canHandleInput(t, i, n) ? (this._lastResult = true, false) : undefined) : (console.log("inlineTextEditor: didn't have focus"), void (this._lastResult = false)));
    ...
    e.keyIdentifier;
    return this._handleKey(i, n, r) ? (e.preventDefault(), e.stopPropagation(), this._lastResult = true, this._keyDownHandled = i, true) : !!this._canHandleInput(i, n, r) && (this._lastResult = true, true);
    ...
    var t = this._editor.getElement().getTLCore();
    if (t) {
      var require = this._convertToObjectSpace(e), n = t.byCoordinate(require.getX(), require.getY() - this._editor._getVerticalOffset());
    ...
    if (e.button === s.BUTTON_LEFT && this._textUnderMouse) {
      if (this._shiftKeyDown) {
        var module = this._editor.getElement().getTLCore();
        if (this._view.setCursor(a.Text), module) {
          var require = module.selectedRange().start, n = this._convertToObjectSpace(e.client), r = module.byCoordinate(n.getX(), n.getY() - this._editor._getVerticalOffset());
          return r && (this._focusChar = r.ordinal, require > r.ordinal ? module.select(r.ordinal, require) : module.select(require, r.ordinal)), void (this._selectDragStart = require);
        }
      }
      if (3 === e.clickCount) {
        if (!(module = this._editor.getElement().getTLCore()))
          return;
        var o = module.selectedRange();
        return o = o.doc.paragraphRange(o.start, o.end), module.select(o.start, o.end), void (this._selectDragStart = o.start);
      }
    ...
    if (this._activated) {
      var module = this._editor.getElement().getTLCore();
      if (module) {
        var require = this._convertToObjectSpace(e), n = module.byCoordinate(require.getX(), require.getY() - this._editor._getVerticalOffset());
        return module.select(n.ordinal, n.ordinal), this._keyboardX = null, n.ordinal;
      }
      return null;
    }
    ...
    if (t && !t.isEmpty()) {
      ...
      var require = h.pickDistance;
      t.expanded(require, require, require, require).containsPoint(e.client) ? this._textUnderMouse = true : this._textUnderMouse = false;
    }
