...
function (exports, module, require) {
  var n = require(59) /* GVertexInfo */, r = require(17) /* GRGBColor */, o = require(11) /* GUtil */, a = require(141) /* module */, s = require(5) /* GPoint */, l = require(24) /* GEditorOptions */, h = require(48) /* GVertex */, A = require(6) /* GRect */, c = require(54) /* GVertexContainer */, p = require(7) /* GTransform */, u = require(12) /* GMath */, d = require(39) /* PartInfo */, g = require(81) /* GEditorAnnotation */, f = require(229) /* GHitResult */, m = require(36) /* PartsPropertyVals */, y = require(542) /* GRotateAnnotation */, _ = require(749) /* GSkewHorizontalAnnotation */, v = require(750) /* GSkewVerticalAnnotation */, b = require(543) /* GPreserveAspectRatioAnnotation */;
  ...
  C.TRANSFORM_MARGIN = 0, C.Handles = {
    ...
    return (null == this._vertices || this._verticesDirty || 0 == this._vertices.getCount()) && (this._vertices.clearVertices(), this._generateVertices(), this._verticesDirty = false), this._vertices.rewindVertices(e);
    ...
    if (e) {
      if (this._tBoxFlags & C.TBoxFlag.Resize) {
        var module = l.annotationHandles.tranformBox, require = g.getAnnotationPaintMargin(module.size);
        e = e.expanded(require, require, require, require);
      }
      return e;
    }
    return null;
    ...
    var c = new f();
    if (!o && (this._tBoxFlags & C.TBoxFlag.Skew || this._tBoxFlags & C.TBoxFlag.Move) && n.hitTest(e.getX(), e.getY(), this, 2 * i, true, c))
    ...
    return !o && !this._isRotateAnnotationEnabled() && this._tBoxFlags & C.TBoxFlag.Rotate && n.hitTest(e.getX(), e.getY(), this, 2 * C.OUTSIDE_TOLERANCE, true, c) && (o = u()), o || (o = new d.PartInfo(r, C.FAR_OUTSIDE)), this._extTransform = null, o;
    ...
    if (e.id < 8) {
      ...
      return g(_.getX(), _.getY(), true, true), l.isPreserveAspectRatioEnabledForSide(y) && (a = true), p.getResizeTransform(m, y, u, d, a, o);
    }
    if (e.id == C.Handles.ROTATION_CENTER)
      return g(this.cx, this.cy, true, true), new p(1, 0, 0, 1, u, d);
    if (!C.isRotating(e.id)) {
      ...
      return i.getX() <= this.tlx + B ? P = this.tlx : i.getX() >= this.tlx + 2 * B && (P = this.brx), i.getY() <= this.tly + x ? S = this.tly : i.getY() >= this.tly + 2 * x && (S = this.bry), g(P, S, true, true), new p(1, 0, 0, 1, u, d);
    }
    if (!a && !l.snapRotate)
    ...
    if (this.trf || this.cTrf) {
      var exports = this.cx, module = this.cy, require = this.trf ? this.trf : this.cTrf;
      this.applyCenterTransformAction(require);
      var n = this._scene.getWorkspace() ? this._scene.getWorkspace().getTransactionRecorder() : null;
      n && n.afterTBoxCenterTransform(this._scene, exports, module, this.cx, this.cy);
    }
  }, C.prototype.applyCenterTransformAction = function (e) {
    if (e) {
      var module = e.mapPoint(new s(this.cx, this.cy));
      this.setCenter(module.getX(), module.getY()), this.cTrf = null, this.trf = null;
    }
    ...
    var t = [];
    if (this._tBoxFlags & C.TBoxFlag.Resize) {
      var require = new A(this.tlx, this.tly, this.brx - this.tlx, this.bry - this.tly);
      require = this.trf ? this.trf.mapRect(require) : require;
      var n = e ? e.mapRect(require) : require, r = l.annotationHandles.tranformBox, o = g.getAnnotationPaintMargin(r.size);
