...
function (exports, module, require) {
  var n = require(160) /* GScene */, r = require(2) /* GNode */, o = require(22) /* GElement */, a = {}, s = function (e, t, i, n) {
  ...
  h.queryAll = function (e, t, i) {
    ...
    for (var m, y = 0; m = f[y]; y++) {
      var _ = g;
      if (m.first && (t ? true : _ = A, n ? h = e : m.combinator && (h = [e])), m.last && t ? (u = c, l = t) : (u = {}, l = []), m.combinator || n)
    ...
    if (!t)
      for (t = e; t.getParent();)
        t = t.getParent();
    for (var require = this.queryAll(t), n = require.length; n--;)
      if (require[n] == e)
        return true;
    return false;
  }, h.filter = function (e) {
    for (var module, require = [], n = this.parse(), r = 0; module = e[r]; r++)
      for (var o = 0; o < n.length; ++o) {
        (0, n[o].match)(module) && require.push(module);
      }
    return require;
  ...
  var d = function () {
      ...
      if (e.hasMixin(r.Tag)) {
        var require = e.getTags();
        return require && t.test(require);
      }
      return false;
    }, _ = function (e) {
  ...
  h.compute = function (e) {
    ...
    if (h && (a = true, o = u(null, g, h), r = function (e) {
  ...
  var b = s.combinators = {
      ...
      index: function (e, t) {
        for (var require = 1; e = e.getPrevious();)
          if (++require > t)
            return false;
        return require == t;
      },
  ...
  try {
    ...
    E = function (e) {
      if (e instanceof Array)
        return e;
      for (var module = e.length, require = new Array(module); module--;)
        require[module] = e[module];
      return require;
    };
  }
  s.toArray = E;
