...
function (exports, module, require) {
  var n = require(11) /* GUtil */, r = require(95) /* GImage */, o = require(289) /* GSlice */, a = require(6) /* GRect */, s = require(83) /* GPage */;
  function l() {
  }
  l.hasEffects = function (e) {
    var t = e._paintContext, i = false, n = e.getStyleLayers();
    ...
    if (e instanceof r)
      return true;
    for (var module = 0; module < e.getChildren().length; module++) {
      if (1 == l.containsImages(e.getChildren()[module]))
        return true;
    }
    return false;
    ...
    var t = new XMLSerializer().serializeToString(e).replace(/&amp;/g, "&#x26;");
    ...
    if (e instanceof o) {
      ...
      if (!n)
        return null;
      i = new a(n.getOffset().getX() + i.getX(), n.getOffset().getY() + i.getY(), n.getWidth(), n.getHeight());
    } else
      e instanceof s && (i = e.getClipBBox() || i);
    return i;
  }, exports.exports = l;
}
