...
function (exports, module, require) {
  var n = require(0) /* GObject */, r = require(147) /* GLinearGradient */, o = require(68) /* GColor */, a = require(48) /* GVertex */, s = require(179) /* GPathUtil */, l = require(158) /* GRadialGradient */, h = (require(139) /* GTexturePattern */, require(108) /* GFont */), A = (require(281) /* GFontManager */, require(568) /* module */, require(587) /* GOpenTypeFont */), c = require(17) /* GRGBColor */, p = require(70) /* GText */, u = require(54) /* GVertexContainer */, d = require(7) /* GTransform */, g = require(122) /* GGroup */, f = require(95) /* GImage */, m = require(73) /* GRectangle */, y = require(188) /* GCMYKColor */, _ = require(214) /* GEllipse */, v = require(28) /* GStylable */, b = require(47) /* GLocaleKey */, C = require(9) /* GLocale */, w = require(14) /* GPaintCanvas */;
  require(22) /* GElement */;
  function E(e, t, i, n) {
    this.done = false, this.inputArray = e, this.drawCallback = t, this.fontManager = i, this.errorCallback = n, this.pointer = 0, this.worker = null, this.ggroup = new g(), this.background = null, this.clipGPathes = [], this.fontsCache = {}, this._finished = false, this._errorDone = {}, this._errorQueue = null, this.appendItem = function (e, t) {
      ...
      error: function (e) {
        this.errorCallback && e && !this._errorDone[e] && (this._errorQueue = this._errorQueue ? this._errorQueue : [], this._errorQueue.push(C.get(new b("GEPSParser", e))), this._errorDone[e] = true);
      }
    };
  }
