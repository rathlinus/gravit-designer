...
function (exports, module, require) {
  var n = require(226) /* module */, r = require(42) /* module */, o = require(14) /* GPaintCanvas */, a = require(5) /* GPoint */, s = require(17) /* GRGBColor */;
  require(103) /* module */;
  function l() {
  }
  l.RENDERMETHOD = {
  ...
  l.prototype.draw = function (e, t, i) {
    ...
    return this.texture.drawTo(function () {
      r.getDefaultShader().drawRect(undefined, undefined, undefined, undefined, [
        0,
        0,
        n,
        o
  ...
  }, l.prototype._isAffectedByGLBug = false, l.prototype.update = function () {
    return this.texture.use(), this.flippedShader.drawRect(undefined, undefined, undefined, undefined, [
      0,
      0,
      this.width,
      this.height
    ...
    if (this.shaderInstance && this.shaderInstance instanceof this.getShaderClass() ? this.currentGL || (this.currentGL = e) : (this.shaderInstance && this.shaderInstance.destroy(), this.shaderInstance = new (this.getShaderClass())(this), this.currentGL = e), this.currentGL !== e) {
      if (this.backupShaderData)
        if (this.backupShaderData.currentGL === e)
          for (var module in this.backupShaderData) {
            var require = this[module];
            this[module] = this.backupShaderData[module], this.backupShaderData[module] = require;
          }
        else {
          for (var module in (console.warn("third webgl type created"), this.backupShaderData))
            "function" == typeof this.backupShaderData[module].destroy && this.backupShaderData[module].destroy(), this.backupShaderData[module] = this[module];
    ...
    if (this.isAffectedByGLBug()) {
      if (undefined === h) {
        if ("undefined" != typeof navigator && navigator && 0 == navigator.userAgent.indexOf("Mozilla") && 0 == navigator.platform.indexOf("Linux") && navigator.userAgent.indexOf("Chrome") < 0 && navigator.userAgent.indexOf("Safari") < 0 && (h = true, console.warn("Firefox on Linux has problems using fast webgl render method. Slower method will be used")), !h) {
          (_ = new o(false, true)).resize(16, 16), _.prepare(), _.setOffset(new a(0, 0)), _.setOrigin(new a(0, 0)), _.strokeRect(0, 0, 16, 16, 4, s.RED);
          var f = new o(false, true);
          f.resize(16, 16), f.prepare(), f.setOffset(new a(0, 0)), f.setOrigin(new a(0, 0));
          var m = new (require(282) /* GGLBlurEffect */)();
          if (!m.prepareShader())
            return h = false, null;
          var y = {
            properties: { radius: 1 },
          ...
          r.apply(f, 16, 16, y, null, false, u, d), _.drawCanvas(f), 255 === (v = _.getBitmap().getPixelValue(0, 0))[1] || 255 === v[2] ? (h = true, console.warn("This browser has a WebGL drawing bug. Some effects will be rendered with slower method.")) : h = false;
        }
        if (!h && "undefined" != typeof document) {
          var _;
          (_ = new o(false, true)).resize(128, 128), _.prepare(), _.setOffset(new a(0, 0)), _.setOrigin(new a(0, 0)), _.fillRect(0, 0, 128, 128, s.BLACK);
          var v, b = document.createElement("canvas"), C = b.getContext("webgl", {
              premultipliedAlpha: false,
              alpha: true
            });
          if (b.width = 16, b.height = 16, C.clearColor(1, 0, 0, 0), C.clear(C.COLOR_BUFFER_BIT), _.drawImage(b, 0, 0), 0 !== (v = _.getBitmap().getPixelValue(0, 0))[0] || 255 !== v[3] ? (h = true, console.warn("This browser has a WebGL bug with transparency. Most effects will be rendered with slower method.")) : h = false, false === h)
            C.clearColor(1, 0, 0, 0.1), C.clear(C.COLOR_BUFFER_BIT), _.drawImage(b, 0, 0), 255 === (v = _.getBitmap().getPixelValue(0, 0))[0] && 255 === v[3] ? (h = true, console.warn("This browser has a WebGL bug with transparency. Most effects will be rendered with slower method.")) : h = false;
        }
      }
      h && (this.renderMethod = l.RENDERMETHOD.BYTES);
    }
    return this.renderMethod === l.RENDERMETHOD.BYTES ? e.getBitmap().modifyPixels(r.apply, g, null, false) : r.apply(e, A || e.getWidth(), c || e.getHeight(), g, p, u, d);
