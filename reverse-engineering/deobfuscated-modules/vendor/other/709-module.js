...
function (exports, module, require) {
  ...
  function n(e, t, i, n, r) {
    return Math.pow(1 - r, 3) * e + 3 * Math.pow(1 - r, 2) * r * t + 3 * (1 - r) * Math.pow(r, 2) * i + Math.pow(r, 3) * n;
  }
  function r() {
  ...
  r.prototype.isEmpty = function () {
    ...
    for (var u = 0; u <= 1; u++) {
      var d = 6 * h[u] - 12 * A[u] + 6 * c[u], g = -3 * h[u] + 9 * A[u] - 9 * c[u] + 3 * p[u], f = 3 * A[u] - 3 * h[u];
      if (0 !== g) {
        var m = Math.pow(d, 2) - 4 * f * g;
        if (!(m < 0)) {
          var y = (-d + Math.sqrt(m)) / (2 * g);
          0 < y && y < 1 && (0 === u && this.addX(n(h[u], A[u], c[u], p[u], y)), 1 === u && this.addY(n(h[u], A[u], c[u], p[u], y)));
          var _ = (-d - Math.sqrt(m)) / (2 * g);
          0 < _ && _ < 1 && (0 === u && this.addX(n(h[u], A[u], c[u], p[u], _)), 1 === u && this.addY(n(h[u], A[u], c[u], p[u], _)));
        }
      } else {
        if (0 === d)
          continue;
        var v = -f / d;
        0 < v && v < 1 && (0 === u && this.addX(n(h[u], A[u], c[u], p[u], v)), 1 === u && this.addY(n(h[u], A[u], c[u], p[u], v)));
      }
    }
  }, r.prototype.addQuad = function (e, t, i, n, r, o) {
    var a = e + 2 / 3 * (i - e), s = t + 2 / 3 * (n - t), l = a + 1 / 3 * (r - e), h = s + 1 / 3 * (o - t);
    this.addBezier(e, t, a, s, l, h, r, o);
  }, module.BoundingBox = r;
}
