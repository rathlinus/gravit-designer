...
function (exports, module, require) {
  ...
  r.prototype._lineBuffer = null, r.prototype._lineWidth = 0, r.prototype._maxAscent = 0, r.prototype._maxDescent = 0, r.prototype._quit = false, r.prototype._lastNewLineHeight = 0, r.prototype._tempLastAscent = 0, r.prototype._tempLastDescent = 0, r.prototype._y = 0, r.prototype._top = 0, r.prototype._consumer = null, r.prototype._parent = null, r.prototype._ordinal = 0, r.prototype._width = 0, r.prototype._noWrap = false, r.prototype._left = 0, r.prototype._includeTerminator = undefined, r.prototype._lastInputWord = null, r.prototype._lastParagraphSpacing = 0, r.prototype._store = function (e, t, i) {
    ...
    if (this._consumer) {
      ...
      if (n) {
        ...
        this._lastParagraphSpacing = "number" == typeof r ? (this._tempLastAscent + this._tempLastDescent) * r : Math.max(parseFloat(r), 0), this._y += this._lastParagraphSpacing, Object.defineProperty(n, "block", { value: true }), e(n);
      }
    } else {
      var o = t.code();
      if (o && o.block) {
        ...
        (!o || this._includeTerminator && this._includeTerminator(o)) && this._store(t, e, i), this._lineBuffer.length ? (this._send(e, i, !!o && !!o.eof), e(this._y - this._top)) : e(this._y + this._lastNewLineHeight - this._top), this._quit = true;
