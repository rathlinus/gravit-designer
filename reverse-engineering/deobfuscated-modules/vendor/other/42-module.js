...
function (exports, module, require) {
  var n = require(11) /* GUtil */, r = require(14) /* GPaintCanvas */, o = require(226) /* module */, a = require(6) /* GRect */, s = (require(5) /* GPoint */, require(12) /* GMath */), l = require(103) /* module */, h = require(111) /* GRendererCtx */, A = require(205) /* GRendererCtxDbg */;
  function c(e, t, i) {
  ...
  c.shaderCache = {}, c.linkedShaderCache = {}, c.shaderCacheNoRender = {}, c.linkedShaderCacheNoRender = {}, c.cannotReadUINT = false;
  function p(e) {
    var t = [], i = e.length;
    if (!i)
      return e;
  ...
  c.warpShader = function (e, t) {
    ...
    (t || this.glEffect.texture).use(), this.glEffect.spareTexture.drawTo(function () {
      this.uniforms(e).drawRect(undefined, undefined, undefined, undefined, [
        0,
        0,
    ...
    if (!t)
      return this;
    for (var require in (t.useProgram(this.program), e))
      e.hasOwnProperty(require) && t.uniform1i(t.getUniformLocation(this.program, require), e[require]);
    return this;
  }, c.prototype.drawRect = function (e, t, i, n, r) {
    var a = o.getGLContext();
    a && (t = undefined !== t ? (t - r[1]) / r[3] : 0, e = undefined !== e ? (e - r[0]) / r[2] : 0, i = undefined !== i ? (i - r[0]) / r[2] : 1, n = undefined !== n ? (n - r[1]) / r[3] : 1, null == a.vertexBuffer && (a.vertexBuffer = a.createBuffer()), a.bindBuffer(a.ARRAY_BUFFER, a.vertexBuffer), a.bufferData(a.ARRAY_BUFFER, new Float32Array([
      e,
      t,
      e,
      n,
    ...
    if (P.draw(S), E.render(B, x, v, b, C, w), P.update(), S.destroy(), t) {
      var T = t.getTransform(false), I = t.getTransform(true);
  ...
  c.shouldEnableTiles = function (e, t) {
    ...
    if (e instanceof r) {
      ...
      if (C) {
        ...
        var M;
        n.scale *= B, M = 1 !== B ? this._copyCanvas(e, s, b, u, d, false) : e, c._renderTile(M, null, null, d, u, d, w, n), n.scale = y;
      }
      var N, U, V, O, L, Y, X, H, W = e.getTransform(true), Z = e.getTransform(false);
      ...
      var z = 1;
      n.properties.opacity && "object" == typeof n.properties.opacity && "opacity" === n.properties.opacity.type && (z = n.properties.opacity.value), e.drawImageFragment(v || p.canvas, L, Y, N, U, X, H, false, z, r.CompositeOperator.Copy, V, O), e.setTransform(W);
    } else {
    ...
    if (l.prepare(c, false), h)
      for (var p = new a(0, 0, e.getWidth(), e.getHeight()), u = new a(0, 0, l.getWidth(), l.getHeight()), d = 0; d < h.length; d++) {
        ...
        g.isEmpty() || f.isEmpty() || l.drawImageFragment(e, g.getX(), g.getY(), f.getX(), f.getY(), g.getWidth(), g.getHeight(), false, 1, r.CompositeOperator.SourceOver, f.getWidth(), f.getHeight());
      }
    else
      l.drawImageFragment(e, 0, 0, 0, 0, e.getWidth(), e.getHeight(), false, 1, r.CompositeOperator.Copy, l.getWidth(), o.getHeight());
