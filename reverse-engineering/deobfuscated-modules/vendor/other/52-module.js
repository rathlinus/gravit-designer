      ...
      if (!this._styleElement && document && document.createElement) {
        ...
        function i(i) {
          ...
          if ("!" === i.charAt(0))
            ...
            switch (i) {
            case module.CrossEllipse:
            case module.CrossArrow:
            case module.CrossRectangle:
            case module.CrossHighlight:
            case module.CrossFreehand:
            case module.Comment:
          ...
          exports.push(".g-cursor-" + i + " {cursor: " + n + " !important;}");
        }
        for (var n in this) {
          var r = this[n];
