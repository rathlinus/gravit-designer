...
function (exports, module, require) {
  var n = require(0) /* GObject */, r = require(108) /* GFont */;
  function o() {
  }
  function a() {
  }
  ...
  }, a.prototype._size = -1, a.prototype.parent = null, a.prototype._position = 0, a.prototype._parse = function (e, t, i, n, r) {
    this._position = t, r[0] = this._size;
  }, n.inherit(s, a), n.inherit(l, a), l.prototype.__size = 0, l.prototype._parse = function (e, t, i, n, r) {
  ...
  var h = new l(1), A = new l(2), c = new l(3), p = new l(4), u = new l(-2);
  function d(e) {
    this._data = e;
  }
  function g(e, t, i) {
  ...
  n.inherit(d, a), d.prototype._data = null, d.prototype._parse = function (e, t, i, n, r) {
    var o = Object.keys(this._data), a = {}, s = [0], l = 0;
    this._position = t;
    for (var h = {
          parent: this,
          one_up: i
        }, A = 0; A < o.length; A++) {
      var c = o[A], p = this._data[c];
      a[c] = p._parse(e, t, h, a, s), l += s[0], t += s[0];
    }
    return this._size = l, r[0] = l, a;
  }, n.inherit(g, a), g.prototype._numField = null, g.prototype._snode = null, g.prototype._sizeTrf = null, g.prototype._parse = function (e, t, i, n, r) {
    this._position = t;
    ...
    return r[0] = l, a;
  }, n.inherit(f, a), f.prototype._pascalString = false, f.prototype._parse = function (e, t, i, n, r) {
    this._position = t;
    var o, a = "", s = null;
    this._pascalString ? (s = [0], o = this._size._parse(e, t, i, n, s), t += s[0]) : o = this._size < 0 ? 512 : this._size;
  ...
  }, n.inherit(m, a), m.prototype._parse = function (e, t, i, n, r) {
    this._position = t, r[0] = n[this._sizeField] || 0;
    var o = r[0];
    return function () {
      return e.slice(t, o);
    };
  }, n.inherit(m, a), m.prototype._sizeField = null, n.inherit(y, a), y.prototype._type = null, y.prototype._primitive = null, y.prototype._snode = null, y.prototype._parse = function (e, t, i, n, r) {
    ...
    if (this._type && this._type.startsWith("parent")) {
      ...
      "absolute" === this._type ? t = o : "immediate" === this._type ? t += o : t = i.parent._position + o;
    return "string" == typeof this._snode ? t : this._snode._parse(e, t, i, n, [0]);
  }, o.Parser = function (e) {
    if (e) {
  ...
  }, o.Parser.prototype._buffer = null, o.Parser.prototype._type = null, o.Parser.prototype._pos = 0, o.Parser.prototype._parsedStruct = null, o.Parser.prototype.getFont = function (e, t, i, n, a) {
    var s = [];
    ...
    case _:
      ...
      for (var h = 0; h < l.length; h++) {
        var A = l[h];
        if (m = a ? new DataView(this._buffer.buffer, A) : this._buffer.buffer.slice(A), w = o.getOpenTypeInfo(m, A), a || o.patchOffsets(m, A), w && (n || w.name === e && parseInt(w.weight) === parseInt(i) && w.style === t) && (s.push({
            buffer: a ? null : m,
            family: w.name,
            weight: w.weight,
            style: w.style,
      ...
      break;
    case v:
      var c = this._parsedStruct.map.typeList.types, p = null;
      for (h = 0; h < c.length; h++) {
        for (var u = c[h].refList, d = 0; d < u.length; d++) {
          var g = u[d];
          g.nameOffset >= 0 ? g.name = C._parse(this._buffer, g.nameOffset + this._parsedStruct.map.nameListOffset, null, null, [0]) : g.name = null;
        }
        "sfnt" === c[h].name && (p = c[h]);
      }
      if (p) {
        ...
        for (h = 0; h < f.length; h++) {
          var m, y = this._parsedStruct.dataOffset + f[h] + 4, w = null;
          if (m = new DataView(this._buffer.buffer, y), (w = o.getOpenTypeInfo(m, 0)) && (n || w.name === e && parseInt(w.weight) === parseInt(i) && w.style === t) && (s.push({
              buffer: a ? null : m,
              family: w.name,
              weight: w.weight,
              style: w.style,
      ...
      break;
    case b:
      (w = o.getOpenTypeInfo(this._buffer)) && (n || w.name === e && parseInt(w.weight) === parseInt(i) && w.style === t) && s.push({
  ...
  var _ = 0, v = 1, b = 2, C = new f(h), w = (new d({
      len: p,
      buf: new m("len")
    }), new d({
      id: A,
      ...
      name: new f(4),
      maxTypeIndex: A,
      refList: new y(A, new g(w, "maxTypeIndex", function (e) {
        return e + 1;
      }), "parent.parent")
    }), B = new d({
      length: A,
  ...
  o.Parser.prototype._checkType = function () {
    if (o._getOpenTypeInfo(this._buffer, 0, true))
      this._type = b;
    else {
      var exports;
      try {
        exports = this._parse(S);
      } catch (e) {
      }
      if (exports && "ttcf" === exports.name)
        return this._type = _, void (this._parsedStruct = exports);
      try {
        if (exports = this._parse(P))
          for (var module = exports.map.typeList.types, require = 0; require < module.length; require++)
            if ("sfnt" === module[require].name)
              return this._type = v, void (this._parsedStruct = exports);
      } catch (e) {
      }
      this._type = -1;
    }
    ...
    var i, n = o._getOpenTypeInfo(e, t || 0), a = n ? n[0] : null;
    if (a && (i = a[o.nameId.FAMILY] || a[o.nameId.NAME])) {
      n[1];
      var s = null, l = null, h = a[o.nameId.SUBFAMILY];
      return h && (h = h.toLowerCase(), l || (h.indexOf("italic") >= 0 || h.indexOf("oblique") >= 0 || h.indexOf("italique") >= 0) && (l = r.Style.Italic), s || (h.indexOf("bold") >= 0 || h.indexOf("gras") >= 0 ? s = h.indexOf("extra") >= 0 || h.indexOf("ultra") >= 0 ? 800 : h.indexOf("semi") >= 0 || h.indexOf("demi") >= 0 ? 600 : 700 : h.indexOf("black") >= 0 || h.indexOf("heavy") >= 0 ? s = 900 : h.indexOf("medium") >= 0 ? s = 500 : h.indexOf("regular") >= 0 || h.indexOf("normal") >= 0 ? s = 400 : h.indexOf("light") >= 0 ? s = h.indexOf("extra") >= 0 || h.indexOf("ultra") >= 0 ? 200 : 300 : h.indexOf("thin") >= 0 && (s = 100))), {
        name: i,
        weight: s = s || 400,
    ...
    return (String.fromCharCode(e.getUint8(t)) + String.fromCharCode(e.getUint8(t + 1)) + String.fromCharCode(e.getUint8(t + 2)) + String.fromCharCode(e.getUint8(t + 3))).toLowerCase();
    ...
    if (t) {
      ...
      if (e instanceof DataView)
        ...
        try {
          require = new DataView(e.buffer || e);
        } catch (e) {
          return retArr;
        }
      var n = require.byteLength;
      try {
        var r = 4, a = require.getUint16(r);
        r = 12;
        for (var s = 0; s < a && n - r >= 16; s++) {
          o._readTag(require, r), r += 4, r += 4;
          var l = require.getUint32(r) - t;
          require.setUint32(r, l), r += 8;
        }
      } catch (e) {
      }
    }
  ...
  o._getOpenTypeInfo = function (e, t, i) {
    var n, r, a = null, s = null, l = null, h = 0, A = e.length || e.byteLength;
    if (e instanceof DataView)
      r = e;
    else
      try {
    ...
    try {
      ...
      h = 12;
      var p = 0, u = 0, d = 0, g = -1, f = -1, m = null;
      for (n = 0; n < c && A - h >= 16; n++) {
        if (m = o._readTag(r, h), h += 4, h += 4, "name" === m)
          ...
          if (i && "cmap" === m) {
            ...
            if (0 === r.getUint16(y)) {
              var _ = r.getUint16(y + 4), v = r.getUint16(y + 6);
              if (0 === _) {
                if (v <= 6)
                  return true;
              } else if (1 === _) {
      ...
      if (u > 0) {
        ...
        var R = [], D = [];
        for (n = 0; n < T; n++)
          R[n] = r.getUint16(h), h += 2;
        for (n = 0; n < T; n++) {
          h = u + I + R[n] + 2;
          var Q = r.getUint16(h);
          h += 2, h += 4, D[Q] = (Number(r.getUint32(h)) / 65536).toFixed(0), h += 4;
        }
        for (h = u + S, n = 0; n < P; n++)
          m = o._readTag(r, h), h += 4, "wght" == m ? s = String(D[n]) : "ital" == m && (l = String(D[n])), h = u + S + n * x;
      }
      if (p > 0) {
        h = p + 2, f = Math.min(255, r.getUint16(h)), h += 2, g = r.getUint16(h), h += 2;
        var M = [];
        for (n = 0; n < f && h < A; n++) {
          _ = r.getUint16(h);
          h += 2;
          ...
          h += 2;
          var V = r.getUint16(h);
          if (h += 2, V <= 7 || V === o.nameId.TYPO_FAMILY || V === o.nameId.TYPO_SUBFAMILY) {
            var O = r.getUint16(h);
            h += 2;
            var L = r.getUint16(h);
            if (h += 2, O > 0) {
              var Y = M[V], X = G(_, U, b, Y), H = k(_, N, U);
              0, undefined !== H && undefined !== X && (Y || (M[V] = []), M[V][X] = {
                encoding: H,
                stringLen: O,
                stringOff: L
              });
        ...
        for (n = 0; n < M.length; n++) {
          ...
          if ((W = M[n]) && ((W = W.en) || (W = W.oth))) {
            ...
            var Z = "", z = W.encoding;
            if ("utf16" === z) {
              for (var j = [], J = Math.min(W.stringLen / 2, 255), q = 0; q < J && h < A; q++)
              ...
              for (var q = 0; q < J && h < A; q++) {
                var $ = r.getUint8(h + q);
                0 !== $ && (Z += $ <= 127 ? String.fromCharCode($) : K[127 & $]);
              }
            }
            a || (a = [
              0,
