...
function (exports, module, require) {
  "use strict";
  var n = require(105) /* module */, r = {}, o = {}, a = {};
  function s(e) {
    return function () {
      return e;
    };
  ...
  o.BYTE = function (e) {
    ...
    for (var module = [], require = 0; require < e.length; require += 1) {
      var n = e.charCodeAt(require);
      module[module.length] = n >> 8 & 255, module[module.length] = 255 & n;
    }
    return module;
  }, a.UTF16 = function (e) {
    return 2 * e.length;
  ...
  o.MACSTRING = function (e, t) {
    ...
    return undefined !== i ? i.length : 0;
  }, o.VARDELTAS = function (e) {
    for (var module = 0, require = []; module < e.length;) {
      var n = e[module];
      module = 0 === n ? p(e, module, require) : n >= -128 && n <= 127 ? u(e, module, require) : d(e, module, require);
    }
    return require;
  }, o.INDEX = function (e) {
    var t, i = 1, n = [i], r = [];
    ...
    for (var module = [], require = Object.keys(e), n = require.length, r = 0; r < n; r += 1) {
      var a = parseInt(require[r], 0), s = e[a];
      module = (module = module.concat(o.OPERAND(s.value, s.type))).concat(o.OPERATOR(a));
    }
    return module;
  }, a.DICT = function (e) {
  ...
  o.CHARSTRING = function (e) {
    ...
    for (var require = [], n = e.length, r = 0; r < n; r += 1) {
      var a = e[r];
      require = require.concat(o[a.type](a.value));
    }
    return g && g.set(e, require), require;
  }, a.CHARSTRING = function (e) {
    return o.CHARSTRING(e).length;
  }, o.OBJECT = function (e) {
    var t = o[e.type];
    return n.argument(undefined !== t, "No encoding function for type " + e.type), t(e.value);
  }, a.OBJECT = function (e) {
    var t = a[e.type];
    return n.argument(undefined !== t, "No sizeOf function for type " + e.type), t(e.value);
  }, o.TABLE = function (e) {
    var t, i = [], r = e.fields.length, a = [], s = [];
    for (t = 0; t < r; t += 1) {
      var l = e.fields[t], h = o[l.type];
      n.argument(undefined !== h, "No encoding function for field type " + l.type + " (" + l.name + ")");
      var A = e[l.name];
      undefined === A && (A = l.value);
      var c = h(A);
    ...
    for (var module = 0, require = e.fields.length, r = 0; r < require; r += 1) {
      var o = e.fields[r], s = a[o.type];
      n.argument(undefined !== s, "No sizeOf function for field type " + o.type + " (" + o.name + ")");
      var l = e[o.name];
      undefined === l && (l = o.value), module += s(l), "TABLE" === o.type && (module += 2);
    }
    return module;
    ...
    return e.length;
  }, module.decode = r, module.encode = o, module.sizeOf = a;
}
