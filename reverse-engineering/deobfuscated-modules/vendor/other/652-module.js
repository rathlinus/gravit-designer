...
function (exports, module, require) {
  var n = require(161) /* GTLUtil */, r = require(0) /* GObject */, o = require(916) /* module */, a = require(230) /* module */, s = require(917) /* module */, l = require(653) /* module */, h = require(920) /* InlineNode */, A = require(926) /* Character */, c = require(148) /* module */, p = require(509) /* module */, u = require(927) /* module */, d = require(267) /* module */, g = require(368) /* module */;
  function f() {
    this._width = 0, this.selection = {
      start: 0,
      end: 0
    }, this.nextInsertFormatting = {}, this.caretVisible = true, this._noWrap = false, this.customCodes = function (e, t, i) {
  ...
  r.inherit(f, d), f.prototype.type = "document", f.prototype._width = 0, f.prototype._noWrap = false, f.prototype._wordOrdinals = null, f.prototype.selection = null, f.prototype.caretVisible = true, f.prototype.customCodes = null, f.prototype.codes = null, f.prototype.selectionChanged = null, f.prototype.contentChanged = null, f.prototype.editFilters = null, f.prototype.nextInsertFormatting = {}, f.prototype.emptyFormatting = null, f.prototype._nextSelection = null, f.prototype.words = null, f.prototype.undo = null, f.prototype.redo = null, f.prototype.frame = null, f.prototype.selectionJustChanged = false, f.prototype._currentTransaction = null, f.prototype._lastSpacingPadding = null, f.prototype.makeEditCommand = function (e, t, i) {
    ...
    this.frame = null;
    try {
      var exports = new l(0, 0, this._width, 0, this, undefined, undefined, undefined, this._noWrap, this._lastSpacingPadding);
      this.frame = p.create(this.words).per(exports.frame, exports).first(), this._lastSpacingPadding = this.frame && this.frame.getBBoxSpacing();
    } catch (e) {
      console.error(e);
    }
    if (this.frame) {
      if (this._nextSelection) {
        var module = this._nextSelection;
        delete this._nextSelection, this.select(module.start, module.end);
      }
    } else
    ...
    if (this.frame && this.frame.length <= 1 && this.emptyFormatting) {
      ...
      if (t = this.emptyFormatting, this.nextInsertFormatting)
        for (var require in this.nextInsertFormatting)
          t[require] = this.nextInsertFormatting[require];
    } else
    ...
    if (e < this.words.length) {
      var module = this._wordOrdinals.length;
      if (module < e + 1)
        for (var require = module > 0 ? this._wordOrdinals[module - 1] + this.words[module - 1].length : 0, n = module; n <= e; n++)
          this._wordOrdinals[n] = require, require += this.words[n].length;
    ...
    return this.selection.start === this.selection.end && (this.selectionJustChanged ? this.selectionJustChanged = false : this.caretVisible = !this.caretVisible), this.caretVisible !== e;
    ...
    if (!this.frame)
      return null;
    e < 0 && (e = 0);
    for (var require = this.frame.byCoordinate(e, t).ordinal, n = this.getCaretCoords(require); n.b <= t && require < this.frame.length - 1;)
      require++, n = this.getCaretCoords(require);
    for (; n.t >= t && require > 0;)
      require--, n = this.getCaretCoords(require);
    return this.byOrdinal(require);
  }, f.prototype.drawSelection = function (e, t) {
    if (this.selection.end === this.selection.start) {
      if (t && (this.selectionJustChanged || this.caretVisible)) {
        var require = this.getCaretCoords(this.selection.start);
        require && (e.save(), e.fillStyle = "black", require.fill(e), e.restore());
      }
    } else
    ...
    this.frame && (this.selection.start = Math.max(0, e), this.selection.end = Math.min("number" == typeof t ? t : this.selection.start, this.frame.length - 1), this.selectionJustChanged = true, this.caretVisible = true, this.nextInsertFormatting = {}, this.notifySelectionChanged(i));
    ...
    if (this._currentTransaction)
      ...
      this.undo.push(this._makeTransaction(function (i) {
        ...
        try {
          ...
          module = i.cmdLen > 0, this._currentTransaction = null;
        }
      }.bind(this))), module && (this.layout(), this.contentChanged.fire());
    }
  }, exports.exports = f;
}
