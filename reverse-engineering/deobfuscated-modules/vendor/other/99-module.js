...
function (exports, module, require) {
  var n = require(210) /* InvalidationRequestEvent */, r = require(0) /* GObject */, o = require(64) /* GPlatform */, a = require(6) /* GRect */;
  function s(e) {
    this._guides = e, this._scene = e._scene, this._allowedZones = [
      a.Side.TOP_LEFT,
      a.Side.CENTER,
      a.Side.BOTTOM_RIGHT
    ];
  }
  r.inherit(s, r), s.Visual = function () {
    ...
    var t = true;
    return e === s.DetailMap.Mode.DetailOnFilterOn ? t = this.hasMixin(s.DetailMap) : e === s.DetailMap.Mode.DetailOffFilterOn && (t = false), t && (!n.options.disabled && o.modifiers.metaKey && (t = false), n.options.disabled && !o.modifiers.metaKey && (t = false)), t;
  }, s.Map.prototype.mapTopLeftOnly = function () {
    return 1 === this._allowedZones.length && 0 === this._allowedZones.indexOf(a.Side.TOP_LEFT);
  }, s.Map.prototype.toString = function () {
    return "[Mixin GGuide.Map]";
  }, s.prototype._guides = null, s.prototype._scene = null, s.prototype._exclusions = null, s.prototype._allowedZones = null, s.prototype.getId = function () {
