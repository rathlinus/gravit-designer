...
function (exports, module, require) {
  var n = require(50) /* GPattern */, r = require(2) /* GNode */, o = require(28) /* GStylable */, a = require(17) /* GRGBColor */, s = require(14) /* GPaintCanvas */, l = require(6) /* GRect */, h = require(1030) /* module */, A = require(315) /* module */, c = require(7) /* GTransform */, p = require(12) /* GMath */, u = require(5) /* GPoint */, d = require(9) /* GLocale */;
  function g() {
  ...
  r.inherit("curvedShadowEffect", g, o.Effect), g.prototype._bend = null, g.equals = function (e, t) {
    ...
    if (this.$pat && this.$opc > 0) {
      var a, h = t.getTransform(false).inverted().mapRect(new l(0, 0, t.getWidth(), t.getHeight())), d = t.createPatternPaint(this.$pat, h);
      d && (d.transform ? (a = t.setTransform(t.getTransform(true).preMultiplied(d.transform)), t.fillRect(0, 0, 1, 1, d.paint, this.$opc), t.setTransform(a)) : t.fillRect(h.getX(), h.getY(), h.getWidth(), h.getHeight(), d.paint, this.$opc));
      var g = this.$l * A.RADIUS_TO_BLUR, f = new u(g, 0), m = p.toRadians(this.$a);
      f = f.rotated(m);
      var y = new c().translated(f.getX(), f.getY());
      t.drawCanvas(e, 0, 0, 1, s.CompositeOperator.DestinationIn, false), this._updateGLProperties(), a = t.setTransform(t.getTransform(true).preMultiplied(y)), this._bend.render(t, null, null, n, r, o), t.setTransform(a), t.drawCanvas(e, 0, 0, 1, s.CompositeOperator.DestinationOut);
    }
