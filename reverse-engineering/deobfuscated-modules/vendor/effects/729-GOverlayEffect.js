...
function (exports, module, require) {
  var n = require(147) /* GLinearGradient */, r = require(50) /* GPattern */, o = require(2) /* GNode */, a = require(28) /* GStylable */, s = require(17) /* GRGBColor */, l = require(14) /* GPaintCanvas */, h = require(6) /* GRect */, A = require(9) /* GLocale */;
  function c() {
    a.Effect.call(this), this._setDefaultProperties(c.VisualProperties);
  }
  o.inherit("overlayEffect", c, a.Effect), c.equals = function (e, t) {
    ...
    if (this.$pat && this.$opc > 0) {
      var r = e.getTransform(false).inverted().mapRect(new h(0, 0, e.getWidth(), e.getHeight())), o = e.createPatternPaint(this.$pat, r);
      if (o) {
        ...
        if (o.transform) {
          ...
          e.fillRect(r.getX(), r.getY(), r.getWidth(), r.getHeight(), o.paint, this.$opc, a);
      }
    }
  }, c.prototype._handleChange = function (e, t) {
    e === o._Change.Store ? this.storeProperties(t.blob, c.VisualProperties, function (e, t) {
      return t && "pat" === e ? r.serialize(t) : t;
    }) : e === o._Change.Restore && this.restoreProperties(t.blob, c.VisualProperties, function (e, t) {
      return t && "pat" === e ? r.deserialize(t) : t;
    }), this._handleVisualChangeForProperties(e, t, c.VisualProperties), a.Effect.prototype._handleChange.call(this, e, t);
