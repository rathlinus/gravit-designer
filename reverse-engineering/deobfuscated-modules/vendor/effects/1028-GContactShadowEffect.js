...
function (exports, module, require) {
  var n = require(50) /* GPattern */, r = require(68) /* GColor */, o = require(2) /* GNode */, a = require(28) /* GStylable */, s = require(7) /* GTransform */, l = require(17) /* GRGBColor */, h = require(158) /* GRadialGradient */, A = require(14) /* GPaintCanvas */, c = require(6) /* GRect */, p = require(12) /* GMath */, u = require(249) /* GBlurEffect */, d = require(9) /* GLocale */;
  function g() {
  ...
  o.inherit("contactShadowEffect", g, a.Effect), g.prototype._savedBBox = null, g.prototype._padding = null, g.prototype._blur = null, g.equals = function (e, t) {
    ...
    if (this.$pat && this.$opc > 0) {
      ...
      var B = new h([
        ...
        ]), x = t.getTransform(false).inverted().mapRect(new c(0, v - u.getY(), t.getWidth(), f)), P = t.createPatternPaint(B, x);
      if (P)
        if (P.transform) {
