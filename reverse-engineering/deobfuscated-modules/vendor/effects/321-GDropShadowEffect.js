...
function (exports, module, require) {
  var n = require(50) /* GPattern */, r = require(2) /* GNode */, o = require(28) /* GStylable */, a = require(17) /* GRGBColor */, s = require(68) /* GColor */, l = require(14) /* GPaintCanvas */, h = require(6) /* GRect */, A = require(249) /* GBlurEffect */, c = require(9) /* GLocale */;
  function p() {
  ...
  r.inherit("dropShadowEffect", p, o.Effect), p.prototype._blur = null, p.equals = function (e, t) {
    ...
    if (this.$pat && this.$opc > 0)
      if (this.canApplyNativeEffect())
        ...
        var a = this.$x * n, s = this.$y * n, A = this.$r * n, c = t.getTransform(false).inverted().mapRect(new h(0, 0, t.getWidth(), t.getHeight())), p = t.createPatternPaint(this.$pat, c);
        if (p)
          if (p.transform) {
