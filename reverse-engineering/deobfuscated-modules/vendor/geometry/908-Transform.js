...
function (exports, module, require) {
  ...
  exports.exports = function (e) {
    e.Transform = function () {
      ...
      return t || n || (undefined === n || null == n) && this.getProperty("scc", false, true);
      ...
      if (this.hasMixin(n.Container))
        for (var o = this.getFirstChild(true); null != o; o = o.getNext(true))
          o instanceof e && o.hasMixin(e.Transform) && (!r || r.indexOf(o) < 0) && (o.dependentUpdate = true, o.transform(t, i, r), o.dependentUpdate = false);
