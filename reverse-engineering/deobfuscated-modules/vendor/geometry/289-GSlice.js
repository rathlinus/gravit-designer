...
function (exports, module, require) {
  var n = require(50) /* GPattern */, r = require(2) /* GNode */, o = require(112) /* module */, a = require(104) /* GItem */, s = require(6) /* GRect */, l = require(83) /* GPage */, h = require(159) /* GLayer */, A = require(9) /* GLocale */;
  function c() {
  ...
  r.inheritAndMix("slice", c, a), c.MetaProperties = {
    ...
    if (e.configuration.isSlicesVisible(e)) {
      var module = this.getGeometryBBox().toAlignedRect();
      e.configuration.isOutline(e) ? e.canvas.strokeRect(module.getX(), module.getY(), module.getWidth(), module.getHeight(), 1, e.getOutlineColor()) : e.canvas.fillRect(module.getX(), module.getY(), module.getWidth(), module.getHeight(), e.sliceColor, 0.25);
    }
