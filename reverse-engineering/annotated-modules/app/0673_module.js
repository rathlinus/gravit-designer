...
function (e, t, n) {
    ...
    var o,
      ...
      l = n(124) /* module_124 */,
      c = n(27) /* uncurryThis */,
      d = n(79) /* defineBuiltIn */,
      u = n(120) /* module_120 */,
      p = n(146) /* module_146 */,
      g = n(61) /* module_61 */,
      h = n(415) /* objectAssignPolyfill */,
      f = n(675) /* module_675 */,
      m = n(157) /* stub_requires_27 */,
      y = n(309) /* module_309 */.codeAt,
      v = n(676) /* module_676 */,
      _ = n(62) /* requireObjectCoercible */,
      b = n(137) /* setToStringTag */,
      w = n(303) /* module_303 */,
      C = n(424) /* polyfill_Array_isArray */,
      x = n(80) /* internalState */,
      S = x.set,
      E = x.getterFor("URL"),
      A = C.URLSearchParams,
      T = C.getState,
