...
function (e, t, n) {
    ...
    n(19) /* polyfill_Array_iterator */, n(57) /* polyfill_parseInt */, n(91) /* polyfill_String_trim */, n(4) /* stub_requires_668 */, n(13) /* stub_requires_679 */, n(26) /* polyfill_DOMCollection_iterator */;
    var i = n(53) /* module */,
      a = n(1) /* module */,
      r = (n(15) /* module */, o(n(565) /* module_565 */)),
      s = n(67) /* GRichTooltipConfig */,
      l = o(n(135) /* GSettingChangedEvent */),
      c = n(451) /* IdxIterator */.GVirtualTree,
      d = (n(451) /* IdxIterator */.GVirtualTreeNode, n(451) /* IdxIterator */.GVirtualTreeNodeNamed),
      { VTREE_FREE_HEIGHT: u, VTREE_FREE_HEIGHT_TOUCH: p } = n(10) /* AppSettings */,
      g = (n(173) /* stub_requires_1 */, n(450) /* module_450 */);
    function h() {}
