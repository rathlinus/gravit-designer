...
function (e, t, i) {
  var n = i(0), r = i(11), o = i(233), a = i(264), s = i(70), l = i(28), h = i(17), A = i(87), c = i(122), p = i(2), u = i(796), d = i(795), g = i(439), f = [
      a.OR,
      a.SUB,
      a.AND,
      a.XOR
  ...
  n.inherit(m, u), m.prototype.parse = function () {
    ...
    if (t.forEach(function (e) {
        r = r.concat(this._getValidItems(e)), e.hasMixin(A) && e.validateInsertion(n) && e.getParent() instanceof o ? i ? i !== e.getParent() && (p = !1) : i = e.getParent() : p = !1;
