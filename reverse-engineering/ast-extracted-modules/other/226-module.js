...
function (e, t, i) {
  var n, r, o, a = i(0), s = i(103), l = i(111), h = i(205), A = i(470);
  function c() {
  ...
  var p, u, d = function () {
      ...
      return e.prototype.id = -1, e.prototype.width = -1, e.prototype.height = -1, e.prototype.format = 0, e.prototype.type = 0, e.fromBytes = function (t, i, n) {
        var r = c.getGLContext();
        if (r) {
        ...
        if (t) {
          ...
          return t.framebuffer = t.framebuffer || t.createFramebuffer(), t.bindFramebuffer(t.FRAMEBUFFER, t.framebuffer), t.framebufferTexture2D(t.FRAMEBUFFER, t.COLOR_ATTACHMENT0, t.TEXTURE_2D, this.id, 0), t.bindTexture(t.TEXTURE_2D, i.id), t.copyTexImage2D(t.TEXTURE_2D, 0, this.format, 0, 0, this.width, this.height, 0), t.bindFramebuffer(t.FRAMEBUFFER, null), i.width = this.width, i.height = this.height, i;
        }
        ...
        var n = c.getGLContext();
        if (n) {
          if (this.width = t || e.width, this.height = i || e.height, this.format = n.RGBA, this.type = n.UNSIGNED_BYTE, n.bindTexture(n.TEXTURE_2D, this.id), void 0 === t || void 0 === t || e.width === t && e.height === i)
      ...
      }, e.prototype.initFromCanvasCropped = function (e, t, i, n, r, o, a, s, l) {
  ...
  function g() {
    return s.isRenderPhase() ? (o || (o = s.getRenderer(void 0, void 0, void 0, !0)), o) : (r || (r = s.getRenderer(void 0, void 0, void 0, !0)), r);
  }
  function f() {
    var e = s.getRenderer(!0, "webgl", { premultipliedAlpha: !1 }, !0) || s.getRenderer(!0, "experimental-webgl", { premultipliedAlpha: !1 }, !0), t = !1;
    return s.isRenderPhase() || s.isMultiThreaded(e) || (t = !0), e.SUPPORTED_TEXTURE_FORMAT === e.FLOAT ? (e.getExtension("OES_texture_float", t), e.getExtension("OES_texture_float_linear", t)) : e.SUPPORTED_TEXTURE_FORMAT === e.HALF_FLOAT && (e.getExtension("OES_texture_half_float", t), e.getExtension("OES_texture_half_float_linear", t)), e;
  }
