...
function (e, t, i) {
  ...
  function a(e, t, i, s) {
    ...
    if (i && (w = i.charSpacing, p = i.transformation, u = i.script, g = i.langScript && "auto" !== i.langScript ? i.langScript : null, f = i.variant || o.defaultFormatting.variant, d = i.fontSize, E = void 0 === i.ligatures ? o.defaultFormatting.ligatures : i.ligatures, B = void 0 === i.fractions ? o.defaultFormatting.fractions : i.fractions, x = void 0 === i.stylisticSet ? o.defaultFormatting.stylisticSet : i.stylisticSet, P = void 0 === i.localizedForm ? o.defaultFormatting.localizedForm : i.localizedForm), p && (e = n.transformText(e, p, c)), l.ascent = c._openTypeFont.ascender * y, l.height = c.getMaxFontHeight(m), l.descent = -c._openTypeFont.descender * y, u && d)
      switch (u) {
      case "sub":
      case "super":
    ...
    for (var I = c.stringToGlyphs(e, 0, 0, m, T), F = I.length - 1, R = 0; R < F; R++) {
      var D = I[R], k = c.getGlyphBoundingRect(m, D.glyph, !0);
