...
function (e, t, i) {
  var n = i(22), r = i(82), o = i(2), a = i(0), s = i(60), l = i(56), h = i(39), A = i(36), c = i(5), p = i(24), u = i(66), d = i(155), g = i(113), f = i(7), m = i(45), y = i(12), _ = i(81), v = i(64), b = i(59), C = i(17), w = i(52), E = i(6), B = i(28), x = i(207);
  function P(e) {
    d.call(this, e), this._flags = this.filterFlags(this._flags);
    for (var t = e.getAnchorPoints().queryAll(":selected"), i = 0; i < t.length; ++i)
  ...
  a.inherit(P, d), A.exports(P, s), P.PartType = {
    ...
    HitRes: 1,
    Handles: 2
  }, P.prototype._sourceIndexToPreviewIndex = null, P.prototype._constrainPair = null, P.prototype._constrainPainted = !1, P.prototype._activeExtedingMode = !1, P.prototype.getActiveExtendingMode = function () {
    ...
    return this._constrainPair && i(_.getAnnotationBBox(null, this._constrainPair[0], p.annotationHandles.path.constrain.size, !0)), this._showAnnotations() && !this.hasFlag(u.Flag.ResizeAll) ? (this._transform && (e = this._transform.multiplied(e)), this._iteratePoints(!0, function (t) {
      t.leftHandlePosition && i(_.getAnnotationBBox(e, t.leftHandlePosition, p.annotationHandles.path.control.size, !0)), t.rightHandlePosition && i(_.getAnnotationBBox(e, t.rightHandlePosition, p.annotationHandles.path.control.size, !0)), t.leftShoulderPosition && i(_.getAnnotationBBox(e, t.leftShoulderPosition, p.annotationHandles.path.corner.size, !0)), t.rightShoulderPosition && i(_.getAnnotationBBox(e, t.rightShoulderPosition, p.annotationHandles.path.corner.size, !0)), i(_.getAnnotationBBox(e, t.position, p.annotationHandles.path.node.size, !0));
    }.bind(this))) : this.hasFlag(h.Flag.HideEditor) || this.hasFlag(h.Flag.Outline) || this.hasFlag(u.Flag.ResizeAll) && this.hasFlag(h.Flag.Selected) || this._iteratePoints(!0, function (t) {
      t.anchorPoint.hasFlag(o.Flag.Highlighted) && i(_.getAnnotationBBox(e, t.position, p.annotationHandles.path.node.size, !0));
    }.bind(this)), t;
    ...
    if (this._partSelection && this._partSelection.length)
      for (var t = 0; t < this._partSelection.length; ++t) {
        ...
        if (i.type == P.PartType.Point) {
          ...
          var r;
          (r = this.getPointCoord(i.apLeft)) && (n = new E(r.getX(), r.getY(), 0, 0), e = e ? e.united(n) : n), (r = this.getPointCoord(i.apRight)) && (n = new E(r.getX(), r.getY(), 0, 0), e = e.united(n));
        }
      }
    ...
    if (e === u.RESIZE_HANDLE_PART_ID || e === u.ROTATION_HANDLE_PART_ID)
      ...
      case P.PartType.RightShoulder:
        ...
        break;
      case P.PartType.Segment:
        this._element._beginBlockEvents([n.GeometryChangeEvent]), this._element.beginUpdate(), this._element.getAnchorPoints()._beginBlockCompositeEvents(!1, !0, !1), this._assignPreviewPointPropertiesToSourcePoint(e.apLeft, [
          "hrx",
          "hry",
          "ah",
          "tp"
        ]), this._element._endBlockEvents([n.GeometryChangeEvent]), this._element.getAnchorPoints()._endBlockCompositeEvents(!1, !0, !1), this._assignPreviewPointPropertiesToSourcePoint(e.apRight, [
          "hlx",
          "hly",
          "ah",
          "tp"
    ...
    if (this._partSelection && this._partSelection.length > 0 && !this.hasFlag(u.Flag.ResizeAll)) {
      e._beginBlockEvents([n.GeometryChangeEvent]), e.beginUpdate(), e.getAnchorPoints()._beginBlockCompositeEvents(!1, !0, !1);
      for (var o = [], a = 0; a < this._partSelection.length; ++a) {
        var s = this._partSelection[a];
        s.type === P.PartType.Point ? (a == this._partSelection.length - 1 && (e._endBlockEvents([n.GeometryChangeEvent]), e.getAnchorPoints()._endBlockCompositeEvents(!1, !0, !1)), this._transferPreviewProperties(s.point, e), o.push(s)) : s.type === P.PartType.Segment && (this._transferPreviewProperties(s.apLeft, e), a == this._partSelection.length - 1 && (e._endBlockEvents([n.GeometryChangeEvent]), e.getAnchorPoints()._endBlockCompositeEvents(!1, !0, !1)), this._transferPreviewProperties(s.apRight, e), (s.apLeft.getParent().getPreviousPoint(s.apLeft) || s.apRight.getParent().getNextPoint(s.apRight)) && (o.push({
          type: P.PartType.Point,
          point: s.apLeft
        }), o.push({
          type: P.PartType.Point,
              ...
              if (null !== s.getProperty("hrx") && null !== s.getProperty("hry") || null !== l.getProperty("hlx") && null !== l.getProperty("hly"))
                if (null === s.getProperty("hrx") || null === s.getProperty("hry")) {
                  ...
                  W = f + 2 / 3 * (E - f), Z = _ + 2 / 3 * (B - _), d = b + 2 / 3 * (E - b), g = C + 2 / 3 * (B - C), A.setProperties([
                    ...
                    d,
                    g
                  ]), this.requestInvalidation(), (T = this._elementPreview.pathHitTest(new c(a.x, a.y), null, !1)) && T.data && !y.isEqualEps(T.data.slope, 0, 0.001) && !y.isEqualEps(T.data.slope, 1, 0.001) && (w = T.data);
                  ...
                  a && (A.setProperty("ah", !1), u.setProperty("ah", !1), this.requestInvalidation(), W = A.getProperty("hrx"), Z = A.getProperty("hry"), d = u.getProperty("hlx"), g = u.getProperty("hly"));
              else {
        ...
        if (m.isCornerType(V))
          ...
          if (v.modifiers.optionKey) {
            ...
            null === W || null === Z ? (H = P.PartType.RightHandle, X.setProperties([
              ...
              type: H,
              point: N
            }, { apSelected: !0 }, n, r), this.updatePartSelection(!0, [i.id]);
          } else {
    ...
    this.requestInvalidation();
    for (var e = this._element.getAnchorPoints().getFirstChild(); null != e; e = e.getNext())
    ...
    if (e.getPath() == this._element || this._elementPreview && e.getPath() == this._elementPreview) {
      var i = this._element;
      this._elementPreview && e.getPath() == this._elementPreview && (i = this._elementPreview);
    ...
    if (this._showAnnotations() && !this.hasFlag(u.Flag.ResizeAll)) {
      ...
      if (this._iteratePoints(!1, function (e) {
          var t = null, i = !0, a = !1;
          if (n(e.position, p.annotationHandles.path.node.size) ? (t = P.PartType.Point, i = !1, a = !0) : n(e.rightHandlePosition, p.annotationHandles.path.control.size) ? t = P.PartType.RightHandle : n(e.leftHandlePosition, p.annotationHandles.path.control.size) ? t = P.PartType.LeftHandle : n(e.rightShoulderPosition, p.annotationHandles.path.corner.size) ? t = P.PartType.RightShoulder : n(e.leftShoulderPosition, p.annotationHandles.path.corner.size) && (t = P.PartType.LeftShoulder), t)
            return r = new h.PartInfo(this, {
              type: t,
              point: e.anchorPoint
            }, { apSelected: e.anchorPoint.hasFlag(o.Flag.Selected) }, i, a), !0;
        }.bind(this)), r)
        return r;
    ...
    if (d.prototype._postPaint.call(this, e, t), this._constrainPair && !this._constrainPainted) {
      ...
      t.canvas.strokeLine(this._constrainPair[0].getX(), this._constrainPair[0].getY(), this._constrainPair[1].getX(), this._constrainPair[1].getY(), 2 * p.outlineWidth, t.highlightOutlineColor, !1), _.paintAnnotation(t, null, this._constrainPair[0], i.type, !1, i.size, C.WHITE, t.highlightOutlineColor), this._constrainPainted = !0;
    }
    this._showAnnotations() && !this.hasFlag(u.Flag.ResizeAll) ? this._iteratePoints(!0, function (i) {
      if (i.leftHandlePosition && this._paintControlHandle(e, t, i.position, i.leftHandlePosition), i.rightHandlePosition && this._paintControlHandle(e, t, i.position, i.rightHandlePosition), i.leftShoulderPosition || i.rightShoulderPosition) {
        ...
        i.leftShoulderPosition && _.paintAnnotation(t, e, i.leftShoulderPosition, n.type, !1, n.size, C.WHITE, t.annotationColor), i.rightShoulderPosition && _.paintAnnotation(t, e, i.rightShoulderPosition, n.type, !1, n.size, C.WHITE, t.annotationColor);
      }
      var r = (n = p.annotationHandles.path.node).color || t.selectionOutlineColor;
      _.paintAnnotation(t, e, i.position, i.annotation, i.anchorPoint.hasFlag(o.Flag.Selected), n.size, r, C.WHITE, n.outlineWidth), i.anchorPoint.hasFlag(o.Flag.Highlighted) && _.paintAnnotation(t, e, i.position, i.annotation, !0, n.size, t.highlightOutlineColor, C.WHITE, n.outlineWidth);
    }.bind(this)) : this.hasFlag(h.Flag.HideEditor) || this.hasFlag(h.Flag.Outline) || !this._element.hasFlag(o.Flag.Highlighted) || this.hasFlag(u.Flag.ResizeAll) && this.hasFlag(h.Flag.Selected) || this._iteratePoints(!0, function (i) {
    ...
    if (!this.hasFlag(u.Flag.ResizeAll)) {
      this.requestInvalidation();
      var t = this._filterSelection(e), i = this._partSelection;
      if (this._partSelection = t, i)
        for (var n = 0; n < i.length; ++n) {
          var r = i[n], a = !1;
          if (t)
            for (var s = 0; s < t.length; ++s)
              if (t[s].point === r.point && r.point || r.type == P.PartType.Segment && r.type == t[s].type && r.apLeft == t[s].apLeft && r.apRight == t[s].apRight) {
                a = !0;
                break;
              }
      ...
      if (t)
        for (n = 0; n < t.length; ++n) {
          (r = t[n]).point ? r.point.setFlag(o.Flag.Selected) : r.type == P.PartType.Segment && (r.apLeft.setFlag(o.Flag.Selected), r.apRight.setFlag(o.Flag.Selected));
        }
      this.requestInvalidation();
    }
    ...
    t.canvas.strokeLine(r.getX(), r.getY(), o.getX(), o.getY(), p.outlineWidth, s), _.paintAnnotation(t, e, n, a.type, !1, a.size, s, s);
  }, P.prototype._iteratePoints = function (e, t) {
    for (var i = e ? this.getPaintElement() : this._element, n = i.getAnchorPoints(), r = i.getTransform(), a = n.getFirstChild(); null != a; a = a.getNext()) {
    ...
    if (this._partSelection && !this.hasFlag(u.Flag.ResizeAll))
      if (this._partSelection.length > 1)
        ...
        e = t === this._element.getAnchorPoints().getLastChild() ? P.PointsSelectionType.Last : t === this._element.getAnchorPoints().getFirstChild() ? P.PointsSelectionType.First : P.PointsSelectionType.Middle;
      }
    return e;
    ...
    for (var h = n.getFirstChild(); null != h; h = h.getNext()) {
      ...
      A = r ? r.mapPoint(A) : A, b.hitTest(A.getX(), A.getY(), t, 0, !0) ? i ? h.hasFlag(o.Flag.Highlighted) || e && h.hasFlag(o.Flag.Selected) ? h.hasFlag(o.Flag.Highlighted) && e && h.hasFlag(o.Flag.Selected) && l.push({
        type: P.PartType.Point,
        point: h
      }) : s.push({
        type: P.PartType.Point,
    ...
    if (this._partSelection && !this.hasFlag(u.Flag.ResizeAll)) {
      for (var e = this._element.getAnchorPoints(), t = this._element.getParent(); t && ("symbol" !== o.getName(t) || t.isMaster());)
        t = t.getParent();
      for (var i = 0; i < this._partSelection.length; ++i)
        if (this._partSelection[i].type == P.PartType.Point) {
          var n = this._partSelection[i].point, r = n.getParent();
    ...
    if (this._partSelection && this._partSelection.length && !this.hasFlag(u.Flag.ResizeAll)) {
      var r = this._element.getTransform();
      this.requestInvalidation(), this._element._beginBlockEvents([n.GeometryChangeEvent]), this._element.getAnchorPoints()._beginBlockCompositeEvents(!1, !0, !1);
      for (var o = 0; o < this._partSelection.length; ++o)
        if (o == this._partSelection.length - 1 && (this._element.getAnchorPoints()._endBlockCompositeEvents(!1, !0, !1), this._element._endBlockEvents([n.GeometryChangeEvent])), this._partSelection[o].type === P.PartType.Point) {
    ...
    if (!this._elementPreview) {
      ...
      for (var t, i, n, r = function (t) {
        ...
        t = a.getPreviousPoint(p), i = a.getNextPoint(p), A || (!t && r(p) ? A = p : !r(p) && i && r(i) && (r(n = a.getFirstRelatedPoint(i)) || a.getPreviousPoint(n) && r(a.getPreviousPoint(n)) || (A = n))), c || (!i && r(p) ? c = p : !r(p) && t && r(t) && (r(n = a.getLastRelatedPoint(t)) || a.getNextPoint(n) && r(a.getNextPoint(n)) || (c = n)));
      ...
      try {
        for (; !d;) {
          ...
          this._sourceIndexToPreviewIndex[f] = y, p == c && (d = !0), (p = a.getNextPoint(p)) && p != A || (d = !0);
        }
      } finally {
        h._endBlockChanges([
          o._Change.BeforeChildInsert,
      ...
      this._elementPreview.transferProperties(this._element, [
        ...
        s.GeometryProperties,
        m.MetaProperties
      ]), A.getProperty("ah") || c && c.getProperty("ah") ? this.extendPreviewToFull() : this._elementPreview.getProperty("closed") && c && this._elementPreview.setProperty("closed", !1);
    }
    ...
    var a = y.getVectorProjection(o.getX(), o.getY(), n.getX(), n.getY(), t.getX(), t.getY(), !0), s = y.ptDist(a.getX(), a.getY(), o.getX(), o.getY()), l = this.getPathPointPreview(e.point);
    if (i) {
