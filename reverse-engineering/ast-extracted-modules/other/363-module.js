...
function (e, t, i) {
  var n = i(893), r = i(133), o = i(2), a = i(83), s = i(160), l = i(0), h = i(72), A = i(5), c = i(77), p = i(6), u = i(7), d = i(644), g = i(64), f = i(14), m = i(663), y = i(228), _ = i(664), v = i(207), b = i(103), C = i(12), w = (m = i(663), i(166)), E = i(176), B = i(470), x = !1;
  function P(e) {
    d.apply(this, arguments.length > 1 ? Array.prototype.slice.call(arguments, 1) : null), this._inputHtmlElement = this._createHTMLElement(!0), this._htmlElement.appendChild(this._inputHtmlElement), this._htmlElement.className += " g-scene-widget", this._scene = e, e.increaseReferenceCounter(), this._viewOffset = [
      0,
      0,
      0,
      0
      ...
      0,
      0
    ], this._logicalPixels = !0, this._viewConfiguration || (this._viewConfiguration = new r(), this._viewConfiguration.enableFxCache = !w.WORKER_RENDERING_ENABLED), P.options.panOrZoomOnWheel && this.addEventListener(c.Wheel, this._wheelListener, this), this.addEventListener(c.Leave, this._leaveListener, this), this.addEventListener(c.Enter, this._enterListener, this), this._dirtyElementList = new _(), this._dirtySceneList = new _(), this._elementCanvas = new f(), this._elementCanvas.setRenderAlgorithm(f.RenderAlgorithm.Pixelated), this._elementCanvas.setImageSmoothingQuality(f.SmoothingQuality.Low), this._elementPaintContext = new y(), this._elementPaintContext.configuration = this._viewConfiguration, this._elementPaintContext.canvas = this._elementCanvas, this._elementCanvas._canvasContext.canvas.style.position = "absolute", this._elementCanvas._canvasContext.canvas.style.left = "0px", this._elementCanvas._canvasContext.canvas.style.top = "0px", this._htmlElement.insertBefore(this._elementCanvas._canvasContext.canvas, this._htmlElement.firstChild), w.DEBUG_AREAS !== w.DBG_AREAS_INFO.None && (this._debugCanvas = new f(), this._debugCanvas._canvasContext.canvas.style.position = "absolute", this._debugCanvas._canvasContext.canvas.style.left = "0px", this._debugCanvas._canvasContext.canvas.style.top = "0px", this._htmlElement.appendChild(this._debugCanvas._canvasContext.canvas)), E.hardware !== E.Hardware.Desktop && (w.DELETE_EFFECT_TEXTURES_AFTER_DRAW = !0, w.DELETE_BLEND_AND_GRADIENT_TEXTURES_AFTER_DRAW = !0), this._panHelperCanvas = new f(), this._panHelperCanvas.setRenderAlgorithm(f.RenderAlgorithm.Crisp), this._panHelperCanvas.setImageSmoothingQuality(f.SmoothingQuality.High), this._panHelperCanvas.prepare(), this._sceneCanvas = new m(w.CANVAS_GRID_HORIZONTAL, w.CANVAS_GRID_VERTICAL), this._sceneCanvas.setRenderAlgorithm(f.RenderAlgorithm.Crisp), this._sceneCanvas.setImageSmoothingQuality(f.SmoothingQuality.High), this._scenePaintContext = new y(), this._scenePaintContext.configuration = this._viewConfiguration, this._watermarkHelperCanvas = new f(), this._watermarkHelperCanvas.setRenderAlgorithm(f.RenderAlgorithm.Crisp), this._watermarkHelperCanvas.setImageSmoothingQuality(f.SmoothingQuality.High), this._watermarkHelperCanvas.prepare(), this._inlineHintDiv = document.createElement("div"), this._inlineHintDiv.className = "inline-hint", this._inlineHintDiv.style.position = "absolute", this._inlineHintDiv.style.display = "none", this._htmlElement.appendChild(this._inlineHintDiv), this._fakeTextDiv = document.createElement("div"), this._fakeTextDiv.style.overflow = "hidden", this._fakeTextDiv.style.position = "absolute", this._fakeTextDiv.style.height = "0px", this._fakeTextDiv.style.display = "none", this._fakeTextBox = document.createElement("textarea"), this._fakeTextBox.setAttribute("autocorrect", "off"), this._fakeTextBox.setAttribute("autocapitalize", "off"), this._fakeTextBox.setAttribute("spellcheck", "false"), this._fakeTextBox.setAttribute("tabindex", "0"), this._fakeTextBox.className = P.GRAVIT_IME, this._fakeTextBox.style.position = "absolute", this._fakeTextBox.style.padding = "0px", this._fakeTextBox.style.width = "1000px", this._fakeTextBox.style.height = "1em", this._fakeTextBox.style.outline = "none", this._fakeTextBox.style.fontSize = "4px", this._fakeTextDiv.appendChild(this._fakeTextBox), this._htmlElement.appendChild(this._fakeTextDiv), e.addEventListener(o.AfterFlagChangeEvent, this._afterFlagChange, this, void 0, void 0, !0), e.addEventListener(s.InvalidationRequestEvent, this._sceneInvalidationRequest, this, void 0, void 0, !0), e.addEventListener(s.RecordedTransactionStartedEvent, this._recordedTransactionStarted, this, void 0, void 0, !0), e.addEventListener(s.RecordedTransactionFinishedEvent, this._recordedTranactionFinished, this, void 0, void 0, !0), this._updateViewTransforms(!0, !0);
  }
  b.init(w.ENABLE_RENDERER, w.ENABLE_DEBUG), b.setRenderParameters({ offscreen: w.USE_OFFSCREEN_ALWAYS }), l.inherit(P, d), P.UPDATEHEIGHT = 50, P.GRAVIT_IME = "gravit-ime-textarea-608209", P.options = {
    ...
    64,
    128
  ], P.prototype._wheelScrollingOrZooming = !1, P.prototype._isPanning = !1, P.prototype._isZooming = !1, P.prototype.hasRulers = function () {
    ...
    e && !this._horizontalRuler ? (this._horizontalRuler = new n(n.Orientation.Horizontal, this._scene), this._verticalRuler = new n(n.Orientation.Vertical, this._scene), this._unitRuler = new n(null, this._scene, void 0, !0, this._viewConfiguration), this._htmlElement.insertBefore(this._horizontalRuler._htmlElement, this._inlineHintDiv), this._htmlElement.insertBefore(this._verticalRuler._htmlElement, this._inlineHintDiv), this._htmlElement.insertBefore(this._unitRuler._htmlElement, this._inlineHintDiv), this._relayoutRulers(), this.addEventListener(c.Move, this._rulerMouseMoveListener, this)) : !e && this._horizontalRuler && (this._htmlElement.removeChild(this._horizontalRuler._htmlElement), this._htmlElement.removeChild(this._verticalRuler._htmlElement), this._htmlElement.removeChild(this._unitRuler._htmlElement), this._horizontalRuler.release(), this._verticalRuler.release(), this._unitRuler.release(), this._horizontalRuler = null, this._verticalRuler = null, this._unitRuler = null, this.removeEventListener(c.Move, this._rulerMouseMoveListener, this));
    ...
    if (e = Math.round(e), t = Math.round(t), e !== this._width || t !== this._height || i) {
      ...
      var r = function () {
        ...
        this._dirtyElementList.setArea(r), this._dirtySceneList.setArea(o), this.invalidate(null, !0), this._relayoutRulers(), n && n();
      }.bind(this);
    ...
    var n = this, r = function () {
        x ? t ? null !== n._resizeRequestFrameId && (n._resizeRequestFrameId = g.scheduleFrame(r)) : i ? null !== n._finishPanRequestFrameId && (n._finishPanRequestFrameId = g.scheduleFrame(r)) : null !== n._repaintRequestFrameId && (n._repaintRequestFrameId = g.scheduleFrame(r)) : (w.DEBUG_AREAS !== w.DBG_AREAS_INFO.None && void 0 !== typeof window && window.setTimeout(function () {
    ...
    if (this._viewOffset = [
      ...
      for (var t = 0; t < Math.min(4, e.length); ++t)
        this._viewOffset[t] = e[t];
    ...
    if (this._viewMargin = [
      ...
      for (var t = 0; t < Math.min(4, e.length); ++t)
        this._viewMargin[t] = e[t], this.invalidate();
    ...
    e || (e = this._dirtySceneList.getArea()), e && !e.isEmpty() && (this._sceneCanvas.setDirtyCache(e, this.getLogicalZoom(), this._scrollX, this._scrollY), this.invalidate(e, !0));
    ...
    if (e) {
      ...
      n.reset(), e = n.getArea();
    return e && n.dirty(e.getX(), e.getY(), e.getWidth(), e.getHeight()) ? (t ? (w.DEBUG_AREAS & w.DBG_AREAS_INFO.Scene && this._debugCanvas.fillRect(e.getX(), e.getY(), e.getWidth(), e.getHeight(), "#f00", 0.2), null === i ? (this._dirtyElementList.reset(), i = this._dirtyElementList.getArea()) : void 0 === i && (i = e), this._dirtyElementList.dirty(i.getX(), i.getY(), i.getWidth(), i.getHeight())) : w.DEBUG_AREAS & w.DBG_AREAS_INFO.Editor && this._debugCanvas.fillRect(e.getX(), e.getY(), e.getWidth(), e.getHeight(), "#0f0", 0.05), null == this._repaintRequestFrameId && this._scheduleRendering(this._repaint.bind(this)), !0) : (null === this._repaintRequestFrameId && null === this._finishPanRequestFrameId && (this._duringRecordedTransaction ? this._pendingInvalidationEvent = !0 : this._scene.trigger(new s.InvalidationFinishedEvent(this._scene, this._viewConfiguration, !1))), !1);
    ...
    this._duringRecordedTransaction = !1, this._scene && null === this._repaintRequestFrameId && this._pendingInvalidationEvent && this._scene.trigger(new s.InvalidationFinishedEvent(this._scene, this._viewConfiguration, !1)), this._pendingInvalidationEvent = !1;
  }, P.prototype.release = function () {
    this.setRulers(!1), this.removeAllEventListeners(!0), this._scene.removeAllEventListeners(!0), this._scene.getDictionary().removeAllEventListeners(!0), this._scene.getSymbolDictionary().removeAllEventListeners(!0), this._scene.__graphic_editor__ && this._scene.__graphic_editor__.removeAllEventListeners(!0), this._scene.iteratePages(function (e) {
      e.removeAllEventListeners(!0);
    }, !0), this._scene.decreaseReferenceCounter(), this._sceneCanvas.destroy(), this._debugCanvas && this._debugCanvas.destroy(), this._panHelperCanvas.destroy(), this._watermarkHelperCanvas.destroy(), this._elementCanvas.destroy(), this._scenePaintContext.destroy(), this._elementPaintContext.destroy(), this._scene.releaseDictionaries(), B.destroyTextures(), this._pendingInvalidationEvent = !1, this._duringRecordedTransaction = !1, this._repaintRequestFrameId && (g.cancelFrame(this._repaintRequestFrameId), this._repaintRequestFrameId = null), this._resizeRequestFrameId && (g.cancelFrame(this._resizeRequestFrameId), this._resizeRequestFrameId = null), this._finishPanRequestFrameId && (g.cancelFrame(this._finishPanRequestFrameId), this._finishPanRequestFrameId = null);
    ...
    if ((i !== e || n !== t) && (this._scrollDX = e - i, this._scrollDY = t - n, this._scrollX = e, this._scrollY = t, P.options.limitScrollingToView)) {
      ...
      B = this._viewConfiguration.paintMode === r.PaintMode.Output ? this._scene.getGeometryBBox(!1, this._viewConfiguration.multiPageView).scaled(this.getLogicalZoom(), this.getLogicalZoom()) : this._scene.getPaintBBox(this._viewConfiguration.multiPageView).scaled(this.getLogicalZoom(), this.getLogicalZoom());
    ...
    w.ENABLE_TIMING && console.time("Compositing time"), x = !0, this._sceneCanvas.paintAndRender(this._scene, this._scenePaintContext, this.getViewTransform(), new A(this._scrollX, this._scrollY), this.getLogicalZoom(), e, t, i);
    ...
    if (this._viewConfiguration.watermark) {
      var e = this._elementCanvas.createTexture(this._viewConfiguration.watermark);
      this._watermarkHelperCanvas.clearRect(0, 0, this._watermarkHelperCanvas.getWidth(), this._watermarkHelperCanvas.getHeight()), this._watermarkHelperCanvas.drawImage(this._elementCanvas, 0, 0), this._elementCanvas.fillRect(0, 0, this._elementCanvas.getWidth(), this._elementCanvas.getHeight(), e);
    }
  }, P.prototype.getScreenBox = function () {
    var e = null;
    if (!this._scene.isFixedSized()) {
      var t = f.getScreenDPI(), i = this.getViewBox().scaled(t, t), n = i.getWidth(), r = i.getHeight();
      i = i.expanded(n, r, n, r), e = this.getViewTransform(this._scene).mapRect(i);
    }
    return e;
  }, P.prototype._repaint = function () {
    try {
      var e = this._dirtyElementList.flush(), t = this._dirtySceneList.flush(), i = this.getWorldTransform(), n = this.getViewTransform();
      if (this._panSubAreas) {
        if (null !== e && null !== t) {
          ...
          r = r.intersected(a), o = o.intersected(a), this._viewConfiguration.watermark && (this._elementCanvas.clearRect(0, 0, this._elementCanvas.getWidth(), this._elementCanvas.getHeight()), this._elementCanvas.drawImage(this._watermarkHelperCanvas, 0, 0)), this._panHelperCanvas.clearRect(0, 0, this._panHelperCanvas.getWidth(), this._panHelperCanvas.getHeight()), this._panHelperCanvas.drawImageFragment(this._elementCanvas, o.getX(), o.getY(), o.getX(), o.getY(), o.getWidth(), o.getHeight()), this._elementCanvas.clearRect(0, 0, this._elementCanvas.getWidth(), this._elementCanvas.getHeight()), this._elementCanvas.drawImageFragment(this._panHelperCanvas, o.getX(), o.getY(), r.getX(), r.getY(), r.getWidth(), r.getHeight()), this._sceneCanvas.moveContent(o, r), this._scenePaintContext.dirtyMatcher = t;
          ...
          }).concat(h) : l._cumulativeInvalidationArea = h, this._paintScene(this.getScreenBox(), !0, function (t, r, o) {
            (r || w.DRAW_DURING_RENDERING || w.SHOW_LOWRES_GIMMICK) && (w.ENABLE_TIMING && console.time("post render"), l._finishPaint(e, !1, i, n, r, t), w.ENABLE_TIMING && console.timeEnd("post render"), r && (l._scenePaintContext.configuration.noWebGL = s, l._scenePaintContext.dirtyMatcher = null, x = !1, w.ENABLE_TIMING && console.timeEnd("rendering")));
          });
        }
      } else if (null !== t) {
        ...
        this._paintScene(this.getScreenBox(), !1, function (t, r, o) {
          (r || w.DRAW_DURING_RENDERING || w.SHOW_LOWRES_GIMMICK) && (w.ENABLE_TIMING && console.time("post render"), l._finishPaint(e, !0, i, n, r, t), w.ENABLE_TIMING && console.timeEnd("post render"), r && (l._scenePaintContext.configuration.noWebGL = s, l._scenePaintContext.dirtyMatcher = null, x = !1, w.ENABLE_TIMING && console.timeEnd("rendering"), !o && l._finishPanRequestFrameId && (l._cumulativeInvalidationArea = null, l._finishPanRequestFrameId = null)));
        });
      } else
        this._finishPaint(e, !0, i, n, !0);
    ...
    this._isZooming = !0, null !== this._repaintRequestFrameId && (g.cancelFrame(this._repaintRequestFrameId), this._repaintRequestFrameId = null), b.setRenderParameters(e || {
    ...
    this._isPanning = !0, null !== this._finishPanRequestFrameId ? (g.cancelFrame(this._finishPanRequestFrameId), this._finishPanRequestFrameId = null, b.setRenderParameters({
    ...
    if (this._isPanning) {
      this._isZooming && ("number" == typeof this._wheelScrollingOrZooming && (clearTimeout(this._wheelScrollingOrZooming), this._wheelScrollingOrZooming = null), this._isZooming = !1, this._cumulativeInvalidationArea = [this._getSceneRect()]), this._isPanning = !1;
      var t = this;
      this._scheduleRendering(function () {
        b.setRenderParameters({
          quickRender: !1,
    ...
    if (!u.equals(r, this._worldToViewTransform)) {
      if (this._worldToViewTransform = r, this._viewToWorldTransform = r.inverted(), v.scaleLabelFactor = this._viewToWorldTransform.getScaleFactor(), !t) {
        ...
        g = g.expanded(m, y, m, y), this._scene.setScreenBox(this.getViewTransform(this._scene).mapRect(g)), o || this.invalidate(null, !0);
      }
    ...
    if (this._horizontalRuler && this._verticalRuler && this._unitRuler) {
      var e = f.getScreenDPI(), t = new A(0, 0), i = this._scene.getActivePage();
      if (i) {
        var n = i.getGeometryBBox();
        if (n) {
          var r = this.getWorldTransform().mapPoint(t);
          t = (t = this.getWorldTransform(i).mapPoint(new A(n.getX(), n.getY()))).subtract(r);
        }
      }
      ...
      this._horizontalRuler.resize(this.getWidth() - h - o - (p ? 0 : s), h), this._verticalRuler.resize(h + (c ? o : 0), this.getHeight() - h - a - (p ? 0 : l)), this._unitRuler.resize(h + (c ? o : 0), h), this._horizontalRuler.move(h + o, a), this._verticalRuler.move(c ? 0 : o, h + a), this._unitRuler.move(c ? 0 : o, a), this._horizontalRuler.updateView(-this._scrollX - o * e - h * e + t.getX(), this.getLogicalZoom()), this._verticalRuler.updateView(-this._scrollY - a * e - h * e + t.getY(), this.getLogicalZoom());
    }
    ...
    if (g.modifiers.metaKey || g.modifiers.ctrlKey || e.zoom) {
      "number" == typeof this._wheelScrollingOrZooming && (clearTimeout(this._wheelScrollingOrZooming), this._cumulativeInvalidationArea = null, this._isPanning = !1, this._wheelScrollingOrZooming = null), this._wheelScrollingOrZooming = setTimeout(function () {
        this._wheelScrollingOrZooming = null, this.finishZoom();
      }.bind(this), w.RERENDER_ZOOM_AFTER_MS), this.beginZoom();
      var t = 0 !== e.deltaX ? e.deltaX : e.deltaY, i = this.getZoom(), n = 1.6, r = null;
      if (Math.abs(t) > 20 && (t = 20 * (t < 0 ? -1 : 1)), t < 0) {
        var o = i / n;
        (r = i + -1 * t / w.ZOOM_STEP * o) >= P.options.maxZoomFactor && (r = P.options.maxZoomFactor);
      } else {
        o = i / n;
        (r = i - t / w.ZOOM_STEP * o) <= P.options.minZoomFactor && (r = P.options.minZoomFactor);
      }
      for (var a = 0; a < this._zoomSteps.length; ++a) {
        (r > (n = this._zoomSteps[a]) && i < n || r < n && i > n) && (r = this._zoomSteps[a]);
      }
      if (null !== r && r !== i) {
      ...
      "number" == typeof this._wheelScrollingOrZooming && (clearTimeout(this._wheelScrollingOrZooming), this._isZooming && (this._isZooming = !1, this._cumulativeInvalidationArea = [this._getSceneRect()]), this._wheelScrollingOrZooming = null), this._wheelScrollingOrZooming = setTimeout(function () {
