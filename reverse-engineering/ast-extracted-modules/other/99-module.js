...
function (e, t, i) {
  var n = i(210), r = i(0), o = i(64), a = i(6);
  function s(e) {
  ...
  r.inherit(s, r), s.Visual = function () {
    ...
    var t = !0;
    return e === s.DetailMap.Mode.DetailOnFilterOn ? t = this.hasMixin(s.DetailMap) : e === s.DetailMap.Mode.DetailOffFilterOn && (t = !1), t && (!n.options.disabled && o.modifiers.metaKey && (t = !1), n.options.disabled && !o.modifiers.metaKey && (t = !1)), t;
