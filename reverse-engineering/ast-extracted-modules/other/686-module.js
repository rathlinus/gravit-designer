...
function (e, t, i) {
  ...
  var r;
  i(19), i(180), i(181), i(20), i(151), i(692), i(189), i(190), i(191), i(192), n.OperatingSystem = {
    Unix: 0,
    Windows: 1,
    OSX_IOS: 2
  }, n.Hardware = {
    ...
    Tablet: 20,
    Phone: 30
  }, n.littleEndian = !0, n.operatingSystem = null, n.hardware = null, n.language = null, n.littleEndian = (r = new ArrayBuffer(8), new Uint32Array(r)[1] = 168496141, !(10 === r[4] && 11 === r[5] && 12 === r[6] && 13 === r[7])), n.hardware = function () {
    ...
    for (var e = [
      ...
      if (-1 != e[t].string.indexOf(e[t].subString))
        return e[t].identity;
    }
