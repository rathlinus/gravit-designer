...
function (e, t, i) {
  var n = i(378).Tokenizer, r = i(989), o = i(990), a = i(991), s = i(992);
  function l(e) {
  ...
  function u() {
    if (this.features.hasOwnProperty("arab")) {
      p.call(this);
      var e = this.tokenizer.getContextRanges("arabicWord"), t = this;
  ...
  l.prototype.setText = function (e) {
    ...
    for (var t = 0; t < e.length; t++) {
      ...
      if (i) {
        var n = i.script;
        this.features[n] || (this.features[n] = {}), this.features[n][i.tag] = i;
      }
    }
