...
function (e, t, i) {
  var n = i(0), r = i(11), o = i(7), a = i(70), s = i(17), l = i(5), h = i(6), A = (i(22), i(28)), c = i(1204);
  function p() {
  }
  function u() {
  ...
  n.inherit(p, c), u.prototype.lines = null, u.prototype.defaultFill = null, u.prototype.defaultBorder = null, u.prototype.canMerge = function (e) {
    ...
    if (g._$itext = this, g.setProperty("sc", !0), g.transform(r), g.setProperties([
        "_tfi",
        "_aw",
        "_ah",
        "_fc"
    ...
    for (var t, i, n = []; e.length;) {
      ...
      if (t || (t = new u(), n.push(t)), i) {
        ...
        if (a.isSameLine(s) && a.isSameTransformation(s) && a.canMergeColor(s) && a.getHStartPoint() > s.getHStartPoint()) {
          ...
          i = new d(), (t = new u()).add(i), n.push(t);
      } else
        i = new d(), t.add(i);
      i.add(o);
    }
    ...
    var t = e._$itext, i = t.getGeometryBBox(), n = !1;
    t.acceptLines(function (e) {
      if (!e.isBreakLine() && e.startPoint.getX() != i.getX()) {
        ...
        if (Math.abs(t - o) <= 2 && (a.align = "center", n = !0), !a.align) {
          var s = r.extend({}, a);
          s.text = " ", s.wordSpacing = parseInt(e.startPoint.getX() - i.getX()), e.startPoint = new l(i.getX(), e.startPoint.getY()), e.words.unshift(s), n = !0;
        }
      }
