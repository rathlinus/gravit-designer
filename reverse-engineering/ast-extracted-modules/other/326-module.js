...
function (e, t, i) {
  ...
  r.prototype.moveTo = function (e, t) {
    ...
    for (var e = new n.BoundingBox(), t = 0, i = 0, r = 0, o = 0, a = 0; a < this.commands.length; a++) {
      ...
      case "Q":
        ...
        break;
      case "C":
        e.addBezier(r, o, s.x1, s.y1, s.x2, s.y2, s.x, s.y), r = s.x, o = s.y;
        break;
      case "Z":
        r = t, o = i;
        break;
    ...
    for (var t = 0; t < this.commands.length; t += 1) {
      ...
      "M" === i.type ? e.moveTo(i.x, i.y) : "L" === i.type ? e.lineTo(i.x, i.y) : "C" === i.type ? e.bezierCurveTo(i.x1, i.y1, i.x2, i.y2, i.x, i.y) : "Q" === i.type ? e.quadraticCurveTo(i.x1, i.y1, i.x, i.y) : "Z" === i.type && e.closePath();
    }
    ...
    for (var n = "", r = 0; r < this.commands.length; r += 1) {
      ...
      "M" === o.type ? n += "M" + i(o.x, o.y) : "L" === o.type ? n += "L" + i(o.x, o.y) : "C" === o.type ? n += "C" + i(o.x1, o.y1, o.x2, o.y2, o.x, o.y) : "Q" === o.type ? n += "Q" + i(o.x1, o.y1, o.x, o.y) : "Z" === o.type && (n += "Z");
    }
    return n;
