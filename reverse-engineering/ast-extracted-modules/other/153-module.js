...
function (e, t, i) {
  var n = i(0), r = i(99), o = i(5), a = i(6), s = i(104), l = i(22), h = i(210), A = i(24), c = i(12), p = i(2), u = i(69), d = i(159), g = i(83), f = i(140);
  i(11);
  function m(e) {
  ...
  n.inheritAndMix(m, r, [r.Map]), m.ID = "guide.bbox", m.GUIDE_MARGIN = 20, m.PRIORITY = {
    DISTANCE_FIRST: 1,
    BBOX_FIRST: 2
  }, m.prototype._priority = null, m.prototype._snapElems = null, m.prototype._scoped = !1, m.prototype._snapMainPage = null, m.prototype._eSnapElems = null, m.prototype.getId = function () {
    return m.ID;
    ...
    this._guides.isMultiPageEnabled() ? (E && (A = E.getPosition(!0), s ? B = B.subtract(A) : x = B.add(A)), this._scene.iteratePages(function (e) {
      var t = e.getGeometryBBox(), i = e.getPosition(!0);
      return t ? (t = t.translated(i.getX(), i.getY())).containsPoint(x) ? (b = e, C = A ? t.translated(-A.getX(), -A.getY()) : t, w = i, !1) : void 0 : (b = e, C = null, w = i, !1);
    }.bind(this))) : E && (A = (b = E).getPosition(!1), C = b.getGeometryBBox(), w = A, s && (B = B.subtract(A)));
    var P = function (e) {
    ...
    if (e && e.length) {
      ...
      for (var i = 0; i < e.length; ++i)
        ((t = e[i]) instanceof s || t instanceof d) && this._exclusions.push(t);
    }
    ...
    if (this._guides.isMultiPageEnabled()) {
      y && !n && (l = y.getPosition(!0), g = g.map(function (e) {
        return e.add(l);
      ...
      (m = y) && n && (l = m.getPosition(!1), g = g.map(function (e) {
        return e.subtract(l);
      }), f = f.translated(-l.getX(), -l.getY()));
    if (!m)
      return null;
    ...
    var C = function (e) {
        ...
        for (var h = null, A = 0; A < o.length; ++A) {
          ...
          if (i ? (n = f.getXYOffset(c, !1, !0).y, r = f.getXYOffset(p, !1, !0).y) : (n = f.getXYOffset(c, !0, !1).x, r = f.getXYOffset(p, !0, !1).x), n && r) {
    ...
    if (h.length > 1) {
      ...
      if (E.length > 1 || B.length > 1) {
        var x = null, P = null;
        E.length > 1 && (x = w(E, !0)), B.length > 1 && (P = w(B, !0)), x && (!P || x.absDeltaY <= P.absDeltaY) ? u = x : P && (u = P);
      }
    }
    if (A.length > 1) {
      ...
      if (T.length > 1 || I.length > 1) {
        var F = null, R = null;
        T.length > 1 && (F = w(T, !1)), I.length > 1 && (R = w(I, !1)), F && (!R || F.absDeltaX <= R.absDeltaX) ? d = F : R && (d = R);
      }
    }
    if (u || d)
        ...
        for (var C = y[b], w = 0; w < _.length; ++w) {
          ...
          if (n && c.isEqualEps(C.getX(), E.getX()) || !n && c.isEqualEps(C.getY(), E.getY())) {
            ...
            v ? (n ? (B.orient = h.Orientation.V, B.valueSegments = [{
              ...
              }]), v = !1) : (B.freeSegments = B.freeSegments ? B.freeSegments : [], B.freeSegmentsColor = A.distanceHelperColor, n ? (B.orient = h.Orientation.V, B.freeSegments.push([
              C.getY(),
              E.getY()
    ...
    if (e && e.length) {
      ...
      for (var t = null, i = !1, n = this._scene.getActivePage(), r = 0; r < e.length; ++r) {
        ...
        i || (t = o instanceof g ? o : o.findParent(function (e) {
