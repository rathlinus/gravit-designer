...
function (e, t, i) {
  ...
  const n = i(171), r = i(373), o = e => new Promise(t => setTimeout(t, e)), a = i(526), s = i(976), l = i(354), h = i(170);
  e.exports = class {
    static get __i18n__() {
    ...
    constructor(e) {
      ...
      ], f = a.DEFAULT_CONTENT, t = l.Campaign.UpgradeIntermintent);
      let m = new s({
        campaign: u(),
        page: d,
        title: g,
      ...
      c = c || r.now(), Promise.all([this._impl.getLicense()]).then(e => {
        ...
        if ("subscribe" !== i) {
          ...
          if (o = h.getValue("GPaywallDialog", 1 === e ? "text.remaining-day" : "text.remaining-days").replace("%days", e).replace("%day", e), e >= 0)
            0 === e && (o = h.getValue("GPaywallDialog", "text.expires-today")), A = h.getValue("GPaywallDialog", "text.access-message1"), t = l.StoreCampaign.TrialSeries;
          else {
