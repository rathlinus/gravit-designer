...
function (e, t, i) {
  var n = i(854), r = i(293), o = i(853), a = i(855), s = i(359), l = i(602), h = i(60), A = i(28), c = i(14);
  function p(e) {
    this._shape = e;
  }
  p.prototype._shape = null, p.prototype.paint = function (e, t, i, n, r) {
    if (this._shape.hasStyleBorder()) {
      ...
      h && h.paint && void 0 !== o.putVertices(a) && (this._stroke(e, r, h), r.$_ba === A.BorderAlignment.Inside ? this._makeInsideBorder(e) : r.$_ba === A.BorderAlignment.Outside && this._makeOutsideBorder(e), i && this._paintBorderMarkers(e, h, r));
    }
    ...
    s && s.invertible() && (l = o.setTransform(o.getTransform(!0).multiplied(s))), r || !1 === a ? o.strokeVertices(i.paint, n.$_bw) : o.fillVertices(i.paint), l && o.setTransform(l);
    ...
    s && s.invertible() && (a = o.setTransform(o.getTransform(!0).multiplied(s))), o.strokeVertices(i.paint, n, t.$_bds, t.$_blc, t.$_blj, r, t.$_op, t.$_bl !== c.BlendMode ? t.$_bl : null), a && o.setTransform(a);
