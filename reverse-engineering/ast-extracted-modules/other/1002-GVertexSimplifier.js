...
function (e, t, i) {
  var n = i(264), r = i(187), o = i(380), a = i(5), s = i(87), l = i(54), h = i(12);
  function A(e) {
  ...
  A.prototype.polys = null, A.prototype.fitter = null, A.prototype.force = !1, A.prototype.simplify = function (e, t, i) {
    var n = [];
    this.fitter = new o(e);
    ...
    if (m) {
      ...
      do {
        for (; m && m.next && (i || void 0 !== m.cx1);) {
          if (_ || (_ = [new a(m.x, m.y)], y = m === e ? null : m.prev, m.cx1 && !i && (s = new a(m.cx1 - m.x, m.cy1 - m.y))), void 0 !== m.cx2)
            if (o) {
          ...
          if (m.next || i || (void 0 !== m.cx2 ? l = new a(m.prev.cx2 - m.x, m.prev.cy2 - m.y) : void 0 !== m.cx1 && (l = new a(m.prev.cx1 - m.x, m.prev.cy1 - m.y))), v++, (m = m.next) === e)
            break;
        }
        if (_) {
          var B = null;
          if (_.length > 1 ? (m && !i && (void 0 !== m.prev.cx2 ? l = new a(m.prev.cx2 - m.x, m.prev.cy2 - m.y) : void 0 !== m.prev.cx1 && (l = new a(m.prev.cx1 - m.x, m.prev.cy1 - m.y))), i || (s && (s = s.scale(1 / Math.sqrt(s.dot(s)))), l && (l = l.scale(1 / Math.sqrt(l.dot(l))))), B = this.fitter.fitCurve(_, i ? Math.max(Math.min(v, 666), 200) : v, s, l)) : B = [], this.force || B) {
            var x = null, P = null;
