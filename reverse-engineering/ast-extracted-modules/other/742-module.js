...
function (e, t, i) {
  var n = i(99), r = i(5), o = i(6), a = i(0), s = i(210);
  function l(e) {
    n.call(this, e);
  }
  a.inheritAndMix(l, n, [n.Map]), l.ID = "guide.scene", l.prototype.getId = function () {
    ...
    if (this._scene.isFixedSized()) {
      ...
      if (this._guides.isMultiPageEnabled())
        v && (y = v.getPosition(!0), l || (b = b.add(y))), this._scene.iteratePages(function (e) {
          var t = !0, i = e.getGeometryBBox(), r = e.getPosition(!0), o = i ? i.translated(r.getX(), r.getY()) : null;
          (o = o && o.expanded(n, n, n, n)) && o.containsPoint(b) && (_.push(i), t = !1);
          var a = e.getMarginBBox(), s = a ? a.translated(r.getX(), r.getY()) : null;
          return (s = s && s.expanded(n, n, n, n)) && s.containsPoint(b) && (_.push(a), t = !1), t || (m = e, b = b.subtract(r)), t;
        }.bind(this));
      else if (v) {
        m = v;
