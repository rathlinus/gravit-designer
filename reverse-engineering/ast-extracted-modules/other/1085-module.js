...
function (e, t, i) {
  var n = i(0), r = i(11), o = i(56), a = (i(22), i(530)), s = i(128), l = i(36), h = i(24), A = i(39), c = i(81), p = i(17);
  function u(e) {
    s.call(this, e);
  }
  n.inherit(u, s), l.exports(u, a), u.ANNOTATION_PART_ID = r.uuid(), u.prototype.getCustomBBox = function (e, t) {
    ...
    if (this._showSegmentDetails()) {
      ...
      this.getPaintElement().iterateAnnotations(function (e, t) {
        var r;
        (r = c.getAnnotationBBox(n, e, h.annotationHandles.simpleShape.size, !0)) && !r.isEmpty() && (i = i ? i.united(r) : r);
      }.bind(this), !0);
    }
    return i;
    ...
    if (this._showSegmentDetails()) {
      ...
      if (this._element.iterateAnnotations(function (i, r) {
          if (c.getAnnotationBBox(t, i, h.annotationHandles.simpleShape.size, !1).expanded(h.annotPickDistance, h.annotPickDistance, h.annotPickDistance, h.annotPickDistance).containsPoint(e))
            return n = new A.PartInfo(this, u.ANNOTATION_PART_ID, { annotationIdx: r }, !0, !1), !0;
        }.bind(this), !0), n)
        return n;
    }
