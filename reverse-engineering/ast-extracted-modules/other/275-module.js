...
function (e, t, i) {
  var n = i(2), r = i(187), o = i(5), a = i(39), s = i(24), l = i(154), h = i(0), A = i(128), c = i(141), p = i(22), u = i(28), d = i(162), g = i(7), f = i(45), m = i(82), y = i(347), _ = i(63), v = i(36), b = i(66), C = i(155), w = i(12), E = i(14), B = i(81), x = i(59), P = i(17), S = i(52), T = i(64), I = i(6);
  function F(e) {
  ...
  h.inherit(F, A), v.exports(F, d), F.PartType = {
    ...
    Edge: 2,
    Facets: 3
  }, F.prototype._pathBaseInEdit = null, F.prototype._startAnchor = null, F.prototype._selectionMode = null, F.prototype._editMode = !1, F.prototype._highlightPart = null, F.prototype._moveEdgesLinks = null, F.prototype._updateFirstPtELinks = null, F.prototype._updateLastPtELinks = null, F.prototype._transformSubType = null, F.prototype._constrainPair = null, F.prototype._constrainPainted = !1, F.prototype._activeExtendingMode = !1, F.prototype.getActiveExtendingMode = function () {
    ...
    if (this._startAnchor) {
      ...
      this._closePBEditor(!0), this.updatePartSelection(!1, null), this._element.addGraphLine(t, new d.GraphPosition(d.GraphPosition.PosType.Anchor, new d.GraphPosition.AnchorSpec(this._startAnchor)), e ? new d.GraphPosition(d.GraphPosition.PosType.Anchor, new d.GraphPosition.AnchorSpec(e)) : null, null, !0), this._startAnchor = null;
    }
    ...
    if (this.hasFlag(a.Flag.Selected) || this.hasFlag(a.Flag.Highlighted)) {
      var i = this._transform ? this._transform.multiplied(e) : e, n = (this.getPaintElement(), function (e) {
          e && !e.isEmpty() && (t = t ? t.united(e) : e);
        });
      if (this._constrainPair && n(B.getAnnotationBBox(null, this._constrainPair[0], s.annotationHandles.path.constrain.size, !0)), this._pbEditor) {
        ...
        this._showAnnotations() && !this.hasFlag(b.Flag.ResizeAll) && this._iteratePoints(this._pbEditor.getPaintElement(), r, function (e) {
          e.leftHandlePosition && n(B.getAnnotationBBox(i, e.leftHandlePosition, s.annotationHandles.path.control.size, !0)), e.rightHandlePosition && n(B.getAnnotationBBox(i, e.rightHandlePosition, s.annotationHandles.path.control.size, !0)), n(B.getAnnotationBBox(i, e.position, s.annotationHandles.path.node.size, !0));
        }.bind(this));
    ...
    if (this._partSelection && this._partSelection.length)
      for (var t = 0; t < this._partSelection.length; ++t) {
        ...
        if (i.type == F.PartType.Point || i.type == F.PartType.Anchor) {
          var n = this.getPointCoord(i.point), r = new I(n.getX(), n.getY(), 0, 0);
          e = e ? e.united(r) : r;
        } else if (i.type == F.PartType.Segment) {
          n = this.getPointCoord(i.apLeft), r = new I(n.getX(), n.getY(), 0, 0);
          e = e ? e.united(r) : r, n = this.getPointCoord(i.apRight), r = new I(n.getX(), n.getY(), 0, 0), e = e.united(r);
        }
      }
    ...
    if (e instanceof f && this._partSelection && this._partSelection.length > 0 && !this.hasFlag(b.Flag.ResizeAll)) {
      ...
      for (var r = [], o = 0; o < this._partSelection.length; ++o) {
        (s = this._partSelection[o]).type === F.PartType.Point ? (o == this._partSelection.length - 1 && (e._endBlockEvents([p.GeometryChangeEvent]), e.getAnchorPoints()._endBlockCompositeEvents(!1, !0, !1)), this._transferPreviewProperties(s.point, e), r.push(s)) : s.type === F.PartType.Segment && (this._transferPreviewProperties(s.apLeft, e), o == this._partSelection.length - 1 && (e._endBlockEvents([p.GeometryChangeEvent]), e.getAnchorPoints()._endBlockCompositeEvents(!1, !0, !1)), this._transferPreviewProperties(s.apRight, e), (s.apLeft.getParent().getPreviousPoint(s.apLeft) || s.apRight.getParent().getNextPoint(s.apRight)) && (r.push({
    ...
    if (e.id.type == F.PartType.Segment)
      if (t) {
        ...
        if (h) {
          ...
          this.updatePartSelection(!1, A), i.isolated = e.data.rightButton.isolated, i.selectable = e.data.rightButton.selectable;
        }
      } else {
              ...
              if (null !== p.getProperty("hrx") && null !== p.getProperty("hry") || null !== u.getProperty("hlx") && null !== u.getProperty("hly"))
                if (null === p.getProperty("hrx") || null === p.getProperty("hry")) {
                  ...
                  H = v + 2 / 3 * (x - v), W = b + 2 / 3 * (P - b), y = C + 2 / 3 * (x - C), _ = E + 2 / 3 * (P - E), g.setProperties([
                    ...
                    y,
                    _
                  ]), this.requestInvalidation(), (R = d.pathHitTest(new o(c.x, c.y), null, !1, s.pickDistance)) && R.data && (B = R.data);
                  ...
                  c && (g.setProperty("ah", !1), m.setProperty("ah", !1), this.requestInvalidation(), H = g.getProperty("hrx"), W = g.getProperty("hry"), y = m.getProperty("hlx"), _ = m.getProperty("hly"));
              else {
        ...
        if (Y) {
          ...
          if (r = !0, l = !1, T.modifiers.optionKey) {
            ...
            null === H || null === W ? (X = F.PartType.RightHandle, Y.setProperties([
              ...
              edge: e.id.edge,
              point: O
            }, { apSelected: !0 }, r, l), this.updatePartSelection(!0, [i.id]);
          } else {
    ...
    if (e && e.type == F.PartType.Point && this.hasFlag(a.Flag.Detail) && !this._editMode) {
      ...
      if (i)
        return e.point.getProperty("tp") === f.AnchorPoint.Type.Asymmetric ? (i.setProperties([
          "tp",
          "ah"
        ], [
          f.AnchorPoint.Type.Symmetric,
          !0
        ]), i.setProperties(["ah"], [!1])) : i.setProperties([
          "tp",
          "ah"
        ], [
          f.AnchorPoint.Type.Asymmetric,
          !1
        ]), this._partsGeometryChanged([e]), this.requestInvalidation(), !0;
    }
    return !1;
    ...
    if (this._partSelection && this._partSelection.length && !this.hasFlag(b.Flag.ResizeAll) && (this._selectionMode == F.SelectionMode.Edge || this._selectionMode == F.SelectionMode.Facets)) {
      for (var e = [], t = 0; t < this._partSelection.length; ++t) {
        var i = this._selectionMode == F.SelectionMode.Edge ? this._partSelection[t].edge : this._partSelection[t].facet;
        if (i)
          if (this._selectionMode == F.SelectionMode.Facets)
            for (var n = i.getDirectedEdges().getFirstChild(); null != n; n = n.getNext()) {
              var r = n.getEdge();
              e.push(r);
            }
          else
    ...
    this.requestInvalidation();
    for (var e = this._element.getAnchors().getFirstChild(); null != e; e = e.getNext())
    ...
    if (this._showAnnotations() && !this.hasFlag(b.Flag.ResizeAll)) {
      var r = this.getGraphPaintElement(), o = r.getTransform(), h = function (i, n) {
          ...
          var t = null, i = !0, r = !1;
          if (h(e.rightHandlePosition, s.annotationHandles.path.control.size) ? t = F.PartType.RightHandle : h(e.leftHandlePosition, s.annotationHandles.path.control.size) ? t = F.PartType.LeftHandle : h(e.position, s.annotationHandles.path.graph.size) && (t = F.PartType.Point, i = !1, r = !0), t)
            return d = new a.PartInfo(this, {
              type: t,
              edge: c,
              point: e.anchorPoint
            }, { apSelected: e.anchorPoint.hasFlag(n.Flag.Selected) }, i, r), !0;
        }.bind(this);
      ...
      for (var p = r.getAnchors().getFirstChild(); p; p = p.getNext())
        if (h(p.getPoint(), s.annotationHandles.path.graph.size))
          return new a.PartInfo(this, {
            type: F.PartType.Anchor,
            point: p
          }, { apSelected: p.hasFlag(n.Flag.Selected) }, !1, !0);
      for (c = r.getEdges().getFirstChild(); c; c = c.getNext()) {
        var u = c.getPathBase(), d = null;
        if (this._iteratePoints(u, null, A), d)
          return d;
        if ((_ = u.pathHitTest(e, o ? o.multiplied(t) : t, !1, s.pickDistance)) && !w.isEqualEps(_.data.slope, 0) && !w.isEqualEps(_.data.slope, 1)) {
    ...
    if (e && e.editor == this)
      if (e.id.type == F.PartType.Segment || e.id.type == F.PartType.Point) {
        ...
        t && this._element._beginBlockEvents([p.GeometryChangeEvent]), this._element.splitEdge(e.id.edge, r, !0, [], n), t && this._element._endBlockEvents([p.GeometryChangeEvent]), n.length && (i = n[0]);
      } else
    ...
    if (this._constrainPair && !this._constrainPainted) {
      ...
      t.canvas.strokeLine(this._constrainPair[0].getX(), this._constrainPair[0].getY(), this._constrainPair[1].getX(), this._constrainPair[1].getY(), 2 * s.outlineWidth, t.highlightOutlineColor, !1), B.paintAnnotation(t, null, this._constrainPair[0], i.type, !1, i.size, P.WHITE, t.highlightOutlineColor), this._constrainPair = null, this._constrainPainted = !0;
    }
    if (this._showAnnotations() && !this.hasFlag(b.Flag.ResizeAll))
      for (var r = (h = this.getGraphPaintElement()).getTransform(), o = (i = s.annotationHandles.path.graph, h.getAnchors().getFirstChild()); o; o = o.getNext()) {
        var l = r ? r.mapPoint(o.getPoint()) : o.getPoint();
        B.paintAnnotation(t, e, l, i.type, o.hasFlag(n.Flag.Selected), i.size, t.selectionOutlineColor, P.WHITE), o.hasFlag(n.Flag.Highlighted) && B.paintAnnotation(t, e, l, i.type, !0, i.size, t.highlightOutlineColor, P.WHITE);
      }
      ...
      var h;
      for (r = (h = this.getGraphPaintElement()).getTransform(), i = s.annotationHandles.path.graph, o = h.getAnchors().getFirstChild(); o; o = o.getNext())
    ...
    if (!this.hasFlag(b.Flag.ResizeAll)) {
      this.requestInvalidation();
      var t = this._selectionMode, i = F.SelectionMode.None;
      e = e ? e.slice() : null;
      if (i = this._filterForSelMode(e), !this._startAnchor) {
        ...
        if (this._partSelection = e, this._selectionMode = i, r && r.length)
          for (var a = 0; a < r.length; ++a) {
            ...
            l || (s.point ? (s.point.removeFlag(n.Flag.Selected), s.type == F.PartType.Point && this._closePBEditor(!1)) : s.type == F.PartType.Segment ? (s.edge.removeFlag(n.Flag.Selected), s.apLeft && s.apLeft.removeFlag(n.Flag.Selected), s.apRight && s.apRight.removeFlag(n.Flag.Selected), this._closePBEditor(!1)) : s.type == F.PartType.Facet && s.facet.removeFlag(n.Flag.Selected));
          }
        if (e && e.length)
      ...
      if (this._startAnchor || this._selectionMode == F.SelectionMode.Edge && t == F.SelectionMode.Edge && this._pathBaseInEdit && o == this._pathBaseInEdit && !this._editMode) {
    ...
    if (l instanceof d)
      ...
      (m = new c(p)) && (t.canvas.putVertices(m, !1), t.canvas.strokeVertices(r || (this.hasFlag(a.Flag.Highlighted) ? t.highlightOutlineColor : t.selectionOutlineColor), s.outlineWidth));
    }
    if (this._highlightPart && !i) {
      ...
      if (this._highlightPart.edge ? this._highlightPart.edge.hasFlag(n.Flag.Selected) ? this._highlightPart = null : u = this._highlightPart.edge.getPathBase() : this._highlightPart.facet && (this._highlightPart.facet.hasFlag(n.Flag.Selected) ? this._highlightPart = null : u = this._highlightPart.facet.getPath()), u) {
        ...
        (m = new c(p)) && (t.canvas.putVertices(m, !1), t.canvas.strokeVertices(t.highlightOutlineColor, s.outlineWidth)), this._highlightPart = null;
      }
    }
    if (l instanceof d) {
        ...
        for (var g = 0; g < this._partSelection.length; ++g) {
          ...
          if (f)
            if (u = f.getPath()) {
              var m;
              p = new _(u, h ? h.multiplied(e) : e);
              (m = new c(p)) && (t.canvas.putVertices(m, !1), t.canvas.strokeVertices(r || t.selectionSecondOutlineColor, s.outlineWidth));
            }
        }
    ...
    for (var l = r.getFirstChild(); null != l; l = l.getNext()) {
      ...
      if (t && (d.position = t.mapPoint(d.position), d.leftHandlePosition && (d.leftHandlePosition = t.mapPoint(d.leftHandlePosition)), d.rightHandlePosition && (d.rightHandlePosition = t.mapPoint(d.rightHandlePosition))), !0 === i(d))
        break;
    }
    ...
    if (this._partSelection && !this.hasFlag(b.Flag.ResizeAll))
      if (this._partSelection.length > 1)
        ...
        e = t === this._element.getAnchorPoints().getLastChild() ? F.PointsSelectionType.Last : t === this._element.getAnchorPoints().getFirstChild() ? F.PointsSelectionType.First : F.PointsSelectionType.Middle;
      }
    return e;
    ...
    for (var l = r.getFirstChild(); null != l; l = l.getNext()) {
      ...
      var h = l.getPoint();
      h = o ? o.mapPoint(h) : h, !x.hitTest(h.getX(), h.getY(), t, 0, !0) || !i && e && l.hasFlag(n.Flag.Selected) ? !i || !l.hasFlag(n.Flag.Highlighted) || e && l.hasFlag(n.Flag.Selected) || s.push({
        type: F.PartType.Anchor,
        point: l
      }) : a.push({
        type: F.PartType.Anchor,
      ...
      if (this.requestInvalidation(), this._selectionMode == F.SelectionMode.Edge)
        ...
        try {
          ...
          for (e = 0; e < this._partSelection.length; ++e)
            this._partSelection[e].type == F.PartType.Anchor && this._element.removeAnchor(this._partSelection[e].point);
          this._partSelection = null;
        } finally {
          this._element.finishFacetsUpdate();
        }
    ...
    if (t instanceof f) {
      var i = this._pathBaseInEdit.getAnchorPoints().getIndexOfChild(e), n = t.getAnchorPoints().getChildByIndex(i), r = this.getPathPointPreview(n);
      ...
      if (t)
        for (var i = 0; i < t.length; i++)
          if (t[i] === e.node.getOwnerStylable()) {
            t[i].setProperty("cSt", !!t[i].getPaintLayers().getBorderLayers().length);
            break;
          }
    }
              ...
              if (i != h.getId()) {
                ...
                if (A && A.length)
                  for (var c = 0; c < A.length && !r; ++c) {
                    var p = A[c];
                    1 == p.polySeg0.seg && w.isEqualEps(p.slope0, 0) || p.polySeg0.seg == s && w.isEqualEps(p.slope0, 1) || (r = !0);
                  }
              }
          } else
            r = !0;
      ...
      if (this._selectionMode == F.SelectionMode.Edge || 1 == e.length && e[0].type == F.PartType.Segment && this._transformSubType == F.SegmentData.Handles)
        for (var n = 0; n < e.length; ++n) {
          ...
          if ((o.type == F.PartType.LeftHandle || o.type == F.PartType.RightHandle || o.type == F.PartType.Point || o.type == F.PartType.Segment) && this._pbEditor) {
            var a = !1, s = o.edge, l = !0, h = !0;
            if (o.type == F.PartType.Segment && this._transformSubType != F.SegmentData.Handles) {
              var A = s.getPathBase().getAnchorPoints();
              A.getFirstChild() == o.apLeft && (l = !1, a = !0), A.getLastChild() == o.apRight && (h = !1, a = !0);
            } else
              o.type == F.PartType.Point && (s.getPathBase().getAnchorPoints().getFirstChild() == o.point ? (l = !1, a = !0) : s.getPathBase().getAnchorPoints().getLastChild() == o.point && (h = !1, a = !0));
            var c = this._pbEditor.getPaintElement();
            ...
            if (a) {
              ...
              this._element.removeEdge(s), this._element.addGraphLine(u, g, m, s), this.requestInvalidation(), this._closePBEditor(!0), this.updatePartSelection(!1, null);
            } else
              s.setPathBase(u), this.requestInvalidation(), this._closePBEditor(!1), this._initPBEditor(s.getPathBase()), this.requestInvalidation();
          }
        }
        ...
        for (var C in this._updateFirstPtELinks) {
          ...
          (T = v.getEdges().getById(E.getId())) && (i(v, C, T.getPathBase()) ? (b[C] = E, this._element.removeEdge(E)) : B(E, !0));
        }
        for (var C in this._updateLastPtELinks) {
          E = this._updateLastPtELinks[C];
          (T = v.getEdges().getById(E.getId())) && (i(v, C, T.getPathBase()) ? (b[C] = E, this._element.removeEdge(E)) : B(E, !1));
        }
        var x = Object.keys(b);
        ...
        for (n = 0; n < x.length; ++n) {
          ...
          E = b[x[n]];
          if (T = v.getEdges().getById(E.getId())) {
            c = new f(!1, T.getPathBase().cloneAnchorPoints()), y = this._element.getAnchors().getById(E.getSourceId()), _ = this._element.getAnchors().getById(E.getDestinationId());
    ...
    for (var e = [], t = this._element.getAnchors().getFirstChild(); null != t; t = t.getNext())
      t.hasFlag(n.Flag.Selected) && e.push(new a.PartInfo(this, {
        type: F.PartType.Anchor,
        point: t
      }, null, !1, !0));
    for (var i = this._element.getEdges().getFirstChild(); null != i; i = i.getNext())
      i.hasFlag(n.Flag.Selected) && e.push(new a.PartInfo(this, {
        type: F.PartType.Segment,
        edge: i,
        apLeft: null,
        apRight: null
    ...
    for (var r = this._element.getFacets().getFirstChild(); null != r; r = r.getNext())
      r.hasFlag(n.Flag.Selected) && e.push(new a.PartInfo(this, {
        type: F.PartType.Facet,
        facet: r
      }, {}, !1, !1));
    this.updatePartSelection(!1, e);
  }, F.prototype._initPBEditor = function (e) {
    this._pathBaseInEdit = e, this._pbEditor = v.openEditor(this._pathBaseInEdit, !0), this._pbEditor.setFlag(a.Flag.Selected), this._pbEditor.removeFlag(b.Flag.ResizeAll), this._pbEditor.setCatchHandle(!1), this._pbEditor.setFlag(a.Flag.HideEditor);
  }, F.prototype._closePBEditor = function (e) {
    this._pbEditor && this._pathBaseInEdit && (this.requestInvalidation(), this._pbEditor.requestInvalidation(), e && this._pbEditor.updatePartSelection(!1, null), this._pbEditor = null, v.closeElementEditor(this._pathBaseInEdit), this._pathBaseInEdit = null, this.requestInvalidation());
