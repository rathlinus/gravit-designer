...
function (e, t, i) {
  var n = i(0), r = i(5), o = i(87), a = i(48), s = i(14), l = i(54), h = i(12);
  ...
  n.inherit(A, o), A.MAX_RECURS = 100, A.PolySegment = function (e, t, i, n, r) {
  ...
  }, A.PolySegment.prototype.point = null, A.PolySegment.prototype.bulge = null, A.PolySegment.prototype.center = null, A.PolySegment.prototype.radius = null, A.PolySegment.prototype.isCap = !1, A.PolySegment.prototype.next = null, A.PolySegment.prototype.previous = null, A.PolyOffsetSegment = function (e, t, i, n, r, o, a) {
  ...
  }, A.IntersectionType.prototype.TIP = !1, A.IntersectionType.prototype.FIP = !1, A.IntersectionType.prototype.PFIP = !1, A.IntersectionResult = function () {
    this.intTypes = [
    ...
    this.point = null, this.intTypes[0].TIP = !1, this.intTypes[0].FIP = !1, this.intTypes[0].PFIP = !1, this.intTypes[1].TIP = !1, this.intTypes[1].FIP = !1, this.intTypes[1].PFIP = !1;
    ...
    for (var i, n = null, o = t, s = o, l = new a(), c = !0; c && this._source.readVertex(l);)
      ...
      case a.Command.Move:
        ...
        break;
      case a.Command.Line:
        s ? (i = new A.PolySegment(new r(s.x, s.y), 0), this._polyline.insertSegment(i), s = l, l = new a()) : (s = l, l = new a());
        break;
      ...
      case a.Command.Close:
        this._polyline && (s && (i = new A.PolySegment(new r(s.x, s.y), 0), this._polyline.insertSegment(i), s = null), this._polyline.closed = !0, i = new A.PolySegment(this._polyline.head.point, 0), this._polyline.insertSegment(i), (n = new a()).command = a.Command.Move, n.x = this._polyline.head.point.getX(), n.y = this._polyline.head.point.getY(), c = !1);
        break;
      default:
        throw new Error("Unknown vertex command: " + vertex.command.toString());
      }
    return s && this._polyline.count && (i = new A.PolySegment(new r(s.x, s.y), 0), this._polyline.insertSegment(i), h.isEqualEps(s.x, this._polyline.head.point.getX()) && h.isEqualEps(s.y, this._polyline.head.point.getY()) && (this._polyline.closed = !0)), n;
    ...
    if (i && t && !this._polyline.closed) {
      this._genCap(a.head.point, o.head.point, this._polyline.head.point, this._polyline.head.next ? this._polyline.head.next.point : null, !0, e, o, this._cap, n), this._genCap(a.end.point2, o.end.point2, this._polyline.end.point, this._polyline.end.previous ? this._polyline.end.previous.point : null, !1, e, a, this._cap, n), this.makeInset = !1, t = !1, l = !0;
    ...
    for (var t = []; e.length > 0;) {
      ...
      for (var n = i.stPt.getX() != i.endPt.getX() || i.stPt.getY() != i.endPt.getY(); n;) {
        ...
        for (var r = null, o = e.length - 1; o >= 0; --o)
          (r = e[o]).stPt.getX() == i.endPt.getX() && r.stPt.getY() == i.endPt.getY() ? (i.endPt = r.endPt, i.vrt.push.apply(i.vrt, r.vrt), n = !0, e.splice(o, 1)) : i.stPt.getX() == r.endPt.getX() && i.stPt.getY() == r.endPt.getY() && (r.endPt = i.endPt, r.vrt.push.apply(r.vrt, i.vrt), i = r, n = !0, e.splice(o, 1));
      }
      var s = new l();
    ...
    for (var n, r = e.head, o = 0; o < e.count - 2; ++o) {
      ...
      for (var a = o + 1; a < e.count - 1; ++a)
        0 != o || a != e.count - 2 || !i && !this._polyline.closed ? this._calcSegmIntersectionPoints(r, n, o, a, t, t, a == o + 1) : this._calcSegmIntersectionPoints(n, r, a, o, t, t, !0), n = n.next;
      r = r.next;
    }
    ...
    for (var i, n, o = 0.0001, a = 0, s = e.head, l = s, c = [], p = 0; p < t.length; ++p) {
    ...
    if (n = n || i, e = e || i.add(new r(0, o ? -a : a)), t = t || i.add(new r(0, o ? a : -a)), c === s.LineCap.Square) {
      ...
      c === s.LineCap.Butt ? u.insertSegment(new A.PolyOffsetSegment(i, e, t, 0)).isCap = !0 : u.insertSegment(new A.PolyOffsetSegment(i, e, t, -1, i, a));
