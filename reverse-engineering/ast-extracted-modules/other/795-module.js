...
function (e, t, i) {
  var n = i(0), r = i(22), o = (i(70), i(73), i(284), i(45)), a = i(2), s = i(796);
  function l(e, t, i, n) {
  ...
  n.inherit(l, s), l.transformStyledCorners = function (e, t) {
    ...
    if (this._node.hasMixin(r.Transform)) {
      ...
      try {
        t || this._node.setProperty("vis", !0), this._node.getGeometryBBox() && this._node.setBounds(e.getX(), e.getY(), e.getWidth(), e.getHeight());
      } finally {
