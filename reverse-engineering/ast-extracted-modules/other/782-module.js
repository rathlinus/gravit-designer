...
function (e, t, i) {
  var n = i(147), r = i(2), o = i(0), a = i(17), s = i(5), l = i(24), h = i(48), A = i(276), c = i(54), p = i(7), u = i(12), d = i(39), g = i(81), f = i(64), m = i(14);
  function y() {
    A.call(this);
  }
  o.inherit(y, A), y.prototype.activate = function (e) {
    if (e.propName && e.propHolder instanceof r && e.propHolder.getProperty(e.propName, !1, null, e.propTemporary) instanceof n)
    ...
    if (i) {
      ...
      for (n = 0; n < i.length; ++n) {
        this._partSelection && this._partSelection.length && this._partSelection[0].idx == n ? d = n : g.paintAnnotation(t, null, i[n], r.type, !1, r.size, a.WHITE, a.WHITE, r.outlineWidth, r.shadowColor);
      }
      null !== d && g.paintAnnotation(t, null, i[d], r.type, !1, r.sizeBig, a.WHITE, u[d].color, r.outlineWidth, r.shadowColor);
    }
    A.prototype.paint.call(this, e, t);
  }, y.prototype.getPartInfoAt = function (e, t, i, n) {
    var r = null;
    if (this._iterateAnnotations(function (i, n) {
        if (g.getAnnotationBBox(t, i, l.annotationHandles.gradient.size, !1).expanded(l.annotPickDistance, l.annotPickDistance, l.annotPickDistance, l.annotPickDistance).containsPoint(e) && (r = new d.PartInfo(this, {
    ...
    if (A.prototype.movePart.call(this, e, t, i, n, r, o, a), e && e.type === A.STOP_HANDLE_PART_ID) {
      var l = i, h = this._getCompositeTransform(!1).inverted(), c = this._getGradientPoints(), d = e.idx, g = this._getAnnotationPoints();
      if (g)
      ...
      if (0 == d || d == c.length - 1) {
        ...
        P = P ? P.multiplied(N) : N, this._angleDelta = k, this._scaleDelta = R, this._gradient.setTransform(P), this._propHolder.setProperty(this._propName, this._gradient.clone(), !1, !1, !0);
      } else if (d > 0 && d < c.length - 1 && m && y) {
        var U = n ? n.inverted() : null;
        U && (m = U.mapPoint(m), y = U.mapPoint(y)), l = u.getVectorProjection(m.getX(), m.getY(), y.getX(), y.getY(), l.getX(), l.getY(), !0, !0), l = n ? n.mapPoint(l) : l, l = h.mapPoint(l);
        var V = u.ptDist(l.getX(), l.getY(), this._gradient._fx, this._gradient._fy), O = _ ? V / _ : V, L = this._gradient.getStops();
        O < L[0].position ? O = L[0].position : O > L[L.length - 1].position && (O = L[L.length - 1].position), L[d].position = O, this._synchIdx(e), this._propHolder.setProperty(this._propName, this._gradient.clone(), !1, !1, !0);
      }
    }
    ...
    for (var e = this._gradient.getScale(), t = this._gradient.getAngle(), i = Math.cos(t) * e, n = Math.sin(t) * e, r = this._gradient.getStops(), o = [], a = 0; a < r.length; ++a) {
      var l = new s(this._gradient._fx + i * r[a].position, this._gradient._fy + n * r[a].position);
      o.push(l);
    }
    return o;
