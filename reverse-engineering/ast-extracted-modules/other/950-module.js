...
function (e, t, i) {
  ...
  const n = i(287), r = i(352);
  class o {
    static get ALL_PERMISSIONS_DENIED() {
      return Object.values(r).reduce((e, t) => Object.assign(e, { [t]: !1 }), {});
    }
    static newFromPermissions() {
      ...
      if (!e[r.ACCESS])
        return n.NoAccess;
      const t = Object.assign({}, o.ALL_PERMISSIONS_DENIED, Object.entries(e).reduce((e, t) => {
          let [i, n] = t;
          return Object.assign(e, { [i]: n || !1 });
        }, {})), i = Object.keys(t).length, a = Object.values(n).find(e => {
          let {permissions: n} = e;
