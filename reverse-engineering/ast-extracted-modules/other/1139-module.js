...
function (e, t, i) {
  var n = i(0), r = i(7), o = i(11), a = i(122), s = i(95), l = i(6), h = i(561), A = i(796), c = i(795), p = i(1136), u = i(601);
  function d() {
  ...
  n.inheritAndMix(d, A), d._parseShape = function (e) {
        ...
        if ("string" == typeof i) {
          ...
          if (r)
            if ("string" == typeof t[n] && r instanceof p)
              ...
              var A;
              if ((A = o.extend({}, r.getData())).overrides = o.extend(A.overrides || {}, t[i]), void 0 !== A.overrides.symbolID && (A.symbolID = A.overrides.symbolID, delete A.overrides.symbolID), A.symbolID && A.symbolID.trim().length) {
    ...
    if (this._symbol.getGeometryBBox()) {
      var e = this._symbolMaster._getGeometryBBox(), t = u.getTransformation(e, this._getGeometryBBox()), i = this._symbol.getTransform(), n = i ? i.multiplied(t) : t;
      this._symbol.transform(n), this._symbol.transform(this._getTransformation()), 1 !== t._sy && this._symbolMaster.accept(function (e) {
        if (e instanceof c && e.getResizingType() === A.ResizingType.PinToCorner) {
          var i = e._getGeometryBBox().getY() - e.getParent()._getGeometryBBox().getY(), n = i - i * t._sy;
