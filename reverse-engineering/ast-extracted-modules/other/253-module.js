    ...
    providers: {
      cb: {
        getPrice() {
          ...
          return e ? (o.set("product_id", e), t && o.set("coupon", t), i && o.set("currency", i), n && o.set("country", n), o.set("price_rule", e), fetch("".concat(r, "/pricesystem/cb?").concat(o.toString())).then(e => e.ok ? e.json() : Promise.reject()).then(e => {
            const {
              price: {
                gross: {value: t}
              },
