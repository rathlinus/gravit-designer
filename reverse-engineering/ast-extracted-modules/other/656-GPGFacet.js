...
function (e, t, i) {
  var n = i(68), r = i(59), o = i(2), a = i(0), s = i(28), l = i(60), h = i(513), A = i(347), c = i(5), p = i(930), u = i(14), d = i(17), g = i(113), f = i(45), m = i(229), y = i(11), _ = i(22);
  function v() {
  ...
  o.inheritAndMix("GPGFacet", v, o, [
    ...
    for (var t, i = null, n = null, r = 0; r < e.length; ++r) {
      ...
      if (this._directedEdges.appendChild(o), n) {
        if ((t = o.getStartPoint()).getX() != n.getX() && t.getY() != n.getY())
          return this._init(), !1;
      } else
        i = o.getStartPoint();
      n = o.getEndPoint();
    ...
    return this._path = new l(!0, !1, a), this._path.assignStyleFrom(this), !0;
    ...
    for (var i = this._directedEdges.getFirstChild(), n = e._directedEdges.getFirstChild(); null != i && null != n && t; i = i.getNext(), n = n.getNext())
      t = i.getProperty("direction") == n.getProperty("direction") && i.getEdge().getId().toString() == n.getEdge().getId().toString();
    return t && (null == i && null != n || null != i && null == n) && (t = !1), t;
    ...
    if (this._path._scene = this._scene, i && this._path.setTransform(i), !e.configuration.isOutline(e) && this.hasStyleFill()) {
      ...
      y.each(this.getPaintLayers().getFillLayers(!0), function (t, s) {
          ...
          if (void 0 !== A.putVertices(h)) {
            if (l.transform && (i && (l.transform = l.transform.multiplied(i)), s.$_px && !s.$_px.isIdentity() && (l.transform = l.transform.preMultiplied(s.$_px))), r)
              if (A.strokeVertices(d.Black, 1, null, null, null, 1, 1, u.CompositeOperator.DestinationOut), s.$_pt instanceof n)
                ...
                A.strokeVertices(d.White, 1, null, null, null, 1, s.$_op, u.CompositeOperator.SourceOver), l.transform && (g = A.setTransform(A.getTransform(!0).preMultiplied(l.transform)));
              ...
              l.transform && (g = A.setTransform(A.getTransform(!0).preMultiplied(l.transform))), o && A.fillVertices(d.Black, 1, u.CompositeOperator.DestinationOut, this._path._isEvenOddFill()), A.fillVertices(l.paint, o ? c : p, s.getBlendingForContext(e), this._path._isEvenOddFill());
            g && A.setTransform(g);
          }
        }
      }.bind(this));
