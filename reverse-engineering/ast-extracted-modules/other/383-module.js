...
function (e, t, i) {
  i(5);
  var n = i(24), r = i(81), o = i(17), a = i(95), s = i(6), l = i(7), h = i(14);
  function A() {
  }
  A.prototype._icon = null, A.prototype._iconVisible = !1, A.prototype.getAnnotationOptions = function () {
    ...
    if (r.paintAnnotation(e, t, i, A.type, A.inverted, A.size, a || e.selectionOutlineColor, o.WHITE, A.outlineWidth, A.shadowColor, A.outsideStroke), this.isIconVisible()) {
      ...
      if (c) {
        t && (i = t.mapPoint(i));
        var p, u = e.canvas.getTransform(!0), d = new l(), g = this._icon.getGeometryBBox(), f = g.getSide(s.Side.CENTER), m = Math.floor(i.getX() - f.getX()), y = Math.floor(i.getY() - f.getY());
        n && (d = new l().translated(-f.getX(), -f.getY()).rotated(-n).translated(f.getX(), f.getY())), A.iconDynamicColor && ((p = e.canvas.createCanvas(g)).fillCanvas(a || e.selectionOutlineColor, 1), p.drawImage(c, 0, 0, !0, 1, h.CompositeOperator.DestinationIn, !0, g.getWidth(), g.getHeight()), c = p), d = d.translated(m, y), e.canvas.setTransform(u.preMultiplied(d)), e.canvas.drawImage(c, 0, 0, !1, 1, null, !1, g.getWidth(), g.getHeight()), e.canvas.setTransform(u), p && p.destroy();
      }
    }
    ...
    if (e) {
      ...
      t.addEventListener("load", function () {
        if (200 == t.status && t.response) {
          var e = new Blob([t.response], { type: "image/png" }), i = new FileReader();
          i.onload = function (e) {
          ...
          }.bind(this), i.readAsDataURL(e);
        }
      }.bind(this)), t.responseType = "blob", t.open("GET", e, !0), t.send(null);
    } else
      this._icon = null;
    ...
    if (this._icon) {
      var e = this.getAnnotationOptions().iconSize, t = e, i = e;
