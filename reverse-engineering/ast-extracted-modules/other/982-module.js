...
function (e, t, i) {
  "use strict";
  var n = i(326), r = i(983), o = i(376), a = i(529), s = i(985), l = i(986), h = i(724), A = i(987), c = i(988), p = i(993).FeatureQuery, u = String.fromCharCode(47), d = String.fromCharCode(8725), g = String.fromCharCode(8260);
  function f(e) {
    ...
    }), this.supported = !0, this.glyphs = new a.GlyphSet(this, e.glyphs || []), this.encoding = new o.DefaultEncoding(this), this.position = new s(this), this.substitution = new l(this), this.tables = this.tables || {}, Object.defineProperty(this, "hinting", {
      get: function () {
        return this._hinting ? this._hinting : "truetype" === this.outlinesFormat ? this._hinting = new A(this) : void 0;
      }
    });
  }
  f.prototype.hasChar = function (e) {
    ...
    if (e)
      for (var i = e.reduce(function (e, t) {
            return e[t.sub] = t, e;
    ...
    t = void 0 !== t ? t : 0, i = void 0 !== i ? i : 0, n = void 0 !== n ? n : 72, r = r || this.defaultRenderOptions;
    ...
    n("fontFamily"), n("weightName"), n("manufacturer"), n("copyright"), n("version"), i(this.unitsPerEm > 0, "No unitsPerEm specified.");
  }, f.prototype.toTables = function () {
    return r.fontToTable(this);
  }, f.prototype.toBuffer = function () {
    return console.warn("Font.toBuffer is deprecated. Use Font.toArrayBuffer instead."), this.toArrayBuffer();
  }, f.prototype.toArrayBuffer = function () {
    for (var e = this.toTables().encode(), t = new ArrayBuffer(e.length), i = new Uint8Array(t), n = 0; n < e.length; n++)
      i[n] = e[n];
    return t;
    ...
    if (h.isBrowser())
      ...
      var A = i(178), c = h.arrayBufferToNodeBuffer(r);
      A.writeFileSync(e, c);
    }
