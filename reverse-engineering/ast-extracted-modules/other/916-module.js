...
function (e, t, i) {
  ...
  a.unlistifyFilter = function (e) {
    ...
    var t, i = this.doc, s = this.start, l = this.end, h = null, A = r.create(this.blocks, this).map(function (t) {
        ...
        var A = t.prev, c = !1;
        return null == h && (A && A.isList() ? (h = n.format([{ text: { $: o.List.Close } }], t.getFormatting(), !0), c = !0) : h = []), r.create(t.runs, t).map(function (t, n) {
        ...
        return Object.create(e, { listMarker: { value: void 0 } });
      });
    ...
    var i = this.start, s = this.end, l = this.doc, h = null, A = null, c = r.create(this.blocks, this).map(function (c) {
        ...
        return f.unshift(n.format({ text: { $: o.List.Item } }, m, !0)), f;
      }).all().reduce(function (e, t) {
        return e.concat(t);
      }, []).map(function (t) {
    ...
    for (var e = !1, t = this.start; t < this.end; t++) {
      var i = this.doc.wordContainingOrdinal(t), n = i && i.word;
      if (n) {
        if (!n.eof) {
          e = !1;
          break;
    ...
    return (isNaN(t.listDepth) || "string" != typeof t.listMarker) && e.save().some(function (e) {
      if (e.text && e.text.$ && 0 === e.text.$.indexOf("List"))
        return isNaN(t.listDepth) && !isNaN(e.listDepth) && (t.listDepth = e.listDepth), "string" != typeof t.listMarker && (t.listMarker = e.listMarker), !0;
    }), n.format([{ text: { $: o.List.Item } }], t, !0);
    ...
    if (this.isList()) {
      ...
      if (this.start === this.end) {
        ...
        if (t.end === this.doc.frame.length - 1)
          if (!r.create(t.runs, t).filter(a.unlistifyFilter).map(n.getPlainText).all().join("") && t.save().some(function (e) {
