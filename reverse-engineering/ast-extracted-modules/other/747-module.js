...
function (e, t, i) {
  var n = i(284), r = i(0), o = i(11), a = i(56), s = (i(22), i(45)), l = i(128), h = i(36), A = i(5), c = i(24), p = i(155), u = i(39), d = i(12), g = i(81), f = i(17);
  i(7);
  function m(e) {
    p.call(this, e);
  }
  r.inherit(m, p), h.exports(m, n), m.INSIDE_PART_ID = o.uuid(), m.OUTSIDE_PART_ID = o.uuid(), m.prototype.getBBoxMargin = function () {
    ...
    if (this._showSegmentDetails()) {
      ...
      this.getPaintElement().iterateSegments(function (e, t, r) {
        var o;
        (o = g.getAnnotationBBox(n, e, c.annotationHandles.polygon.size, !0)) && !o.isEmpty() && (i = i ? i.united(o) : o);
      }.bind(this), !0);
    }
    return i;
    ...
    if (this._showSegmentDetails()) {
      ...
      if (this._element.iterateSegments(function (i, r, o) {
          if (g.getAnnotationBBox(t, i, c.annotationHandles.polygon.size, !1).expanded(c.annotPickDistance, c.annotPickDistance, c.annotPickDistance, c.annotPickDistance).containsPoint(e)) {
