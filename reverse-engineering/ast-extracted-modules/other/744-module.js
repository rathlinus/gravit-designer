...
function (e, t, i) {
  var n = i(0), r = i(99), o = i(17), a = i(14);
  function s(e) {
    r.call(this, e);
  }
  n.inheritAndMix(s, r, [r.Visual]), s.SCALE = !0, s.GATHER_ALL = !1, s.LabelItem = function (e, t, i, n, r) {
    this._position = e, this._label = i, this._color = n || null, this._isScaleLabel = !!r, this._width = t;
  }, s.LabelItem._position = null, s.LabelItem._label = null, s.LabelItem._isScaleLabel = !1, s.LabelItem.prototype.getLabel = function () {
    return this._label;
