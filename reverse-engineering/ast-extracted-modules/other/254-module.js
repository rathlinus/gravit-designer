...
function (e, t, i) {
  ...
  const {
      GLocale: n,
      GLocaleKey: r
    } = i(209), o = Object.values(i(287)).filter(e => !!e.mentionName).map(e => e.mentionName), {
      externalApps: a,
      supportedApps: s,
  ...
  t.isSharePointFileId = d, t.isGoogleDriveFileId = g, t.isSharePointFile = f, t.isGoogleDriveFile = e => e.app && e.app === s.GoogleDrive, t.isExternalFile = e => f(e) || g(e), t.isExternalFileId = e => g(e) || d(e), t.sanitizeName = u, t.sameDomain = (e, t) => e && t && e.email && t.email && e.email.split("@")[1] === t.email.split("@")[1], t.getExternalAppCodes = () => a.map(e => e.code), t.getAppFromFileId = e => d(e) ? s.SharePoint : g(e) ? s.GoogleDrive : null, t.coalesceString = function () {
