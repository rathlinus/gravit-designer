...
function (e, t, i) {
  var n = i(68), r = function () {
      ...
      function i(e, t) {
        for (var i, n, r = 0, o = [], a = 16; a > 0 && !e[a - 1];)
          a--;
        o.push({
          children: [],
          index: 0
      ...
      return t.prototype = {
        ...
        getData: function (e, t) {
          ...
          case 2:
            ...
            break;
          case 3:
            for (w = !0, this.adobe && this.adobe.transformCode ? w = !0 : void 0 !== this.colorTransform && (w = !!this.colorTransform), i = this.components[0], n = this.components[1], r = this.components[2], p = 0; p < t; p++)
          ...
          case 4:
            ...
            for (w = !1, this.adobe && this.adobe.transformCode ? w = !0 : void 0 !== this.colorTransform && (w = !!this.colorTransform), i = this.components[0], n = this.components[1], r = this.components[2], o = this.components[3], p = 0; p < t; p++)
