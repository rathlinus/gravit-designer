...
function (e, t, i) {
  var n = i(230), r = i(919), o = i(0), a = i(267);
  ...
  o.inherit(s, a), s.prototype.bounds = function (e, t) {
    ...
    if (t) {
      var i = this.first().bounds(), r = this.last().bounds();
      return new n(i.l, this.baseline - this.ascent, r.l + r.w - i.l, this.ascent + this.descent);
    }
