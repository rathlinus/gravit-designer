...
function (e, t, i) {
  ...
  for (var n = i(685), r = i(686), o = i(699), a = i(700), s = i(701), l = i(945), h = i(703), A = i(704), c = i(705), p = new o().getMapped(), u = new l(), d = 0; d < p.length; d++) {
          ...
          if (b.translations) {
            ...
            for (var C = Object.keys(b.translations), w = 0; w < C.length; w++) {
              ...
              if (Object.keys(B).forEach(function (e) {
                  B[e] || delete B[e];
                }), u.setValues(new a(E), s[b.language], Object.keys(B), Object.values(B), !0), b.translationsExtended && b.translationsExtended[E]) {
