...
function (e, t, i) {
  var n = i(75), r = i(0), o = i(14), a = i(77), s = i(5), l = i(505), h = i(167), A = i(164), c = (i(645), i(52));
  i(72);
  function p(e) {
  ...
  r.inheritAndMix(p, r, [n]), p.ButtonsFlag = {
    ...
    var e = !1;
    try {
      (this._inputHtmlElement && document.activeElement === this._inputHtmlElement || document.activeElement === this._htmlElement) && (e = !0);
    } catch (e) {
    }
    return e;
    ...
    if (this._dragStartPosition && !this._dragIsDragging) {
      ...
      if ((Math.abs(t.getX() - e.client.getX()) >= 1 || Math.abs(t.getY() - e.client.getY()) >= 1) && (this._dragIsDragging = !0, this._dragPreviousPosition = this._dragStartPosition, this.hasEventListeners(a.DragStart))) {
    ...
    if (this._dragIsDragging && this.hasEventListeners(a.Drag)) {
      ...
      this._dragAssignMouseEvent(e, i), this._dragAssignDragEvent(i, e), this.trigger(i), this._dragPreviousPosition = e.client;
    }
  ...
  p.prototype._setCapture = function () {
    ...
    function t(t) {
      ...
      }.bind(e), document.addEventListener(i, e._savedDocumentListeners[i], !0));
    }
    ...
    if (this._savedDocumentListeners) {
      for (var e in this._savedDocumentListeners)
        document.removeEventListener(e, this._savedDocumentListeners[e], !0);
