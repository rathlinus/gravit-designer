...
function (e, t, i) {
  var n = i(0), r = i(2), o = i(280), a = i(11), s = i(5), l = i(1143), h = i(28), A = i(798), c = i(132), p = i(1216), u = i(1422), d = i(70), g = i(1444), f = i(22), m = i(7), y = i(1446), _ = i(289), v = i(95), b = i(160), C = i(83), w = i(359), E = i(56), B = i(162), x = i(347), P = i(569), S = i(818), T = i(321), I = i(432), F = i(1448), R = i(1449), D = i(1451), k = i(64), G = i(9), Q = i(47), M = i(1453), N = i(1235), U = i(1454);
  function V() {
  }
  function O(e, t, i, n) {
  ...
  n.inherit(V, n), V.isSupported = function (e, t, i) {
      ...
      var E = new u({
          ...
          if (!E.isAbort())
            if (i || (i = e._getBitmapPaintArea())) {
              ...
              h.configuration.sceneBackground = void 0 !== x.sceneBackground ? x.sceneBackground : h.configuration.sceneBackground, h.canvas.resize(a, l), h.canvas.prepare(), h.canvas.setOrigin(new s(i.getX() * S, i.getY() * S));
                      ...
                      if (!E.isAbort()) {
                        ...
                        try {
                          ...
                          if (N.isAffectedByBackground(t)) {
                            if (_ || (_ = A.export(t.getPage(), B + "dpi", null, null, null, null, !0)), _ && _.getWidth() && _.getHeight()) {
    ...
    if (e) {
      var t = this, i = Object.create(Object.getPrototypeOf(e));
      ...
      if (i instanceof o)
        ...
        if (t._instanceof(i, r) && (i.getNext = function () {
          ...
          i._paint = function (e) {
            ...
            this.__proto__._finishPaint.call(this, e), e.endNode(this.__source__), t._instanceof(this, d) && (this.__source__._runsDirty = !0);
          };
        }
        if (t._instanceof(i, r.Container) && (i.getFirstChild = function () {
          ...
          }), t._instanceof(i, S) && (i.depthFirstSearch = function (e, i, n, r, o) {
            this.__source__.depthFirstSearch(e, i, t.proxy(n), r, o);
          }), t._instanceof(i, P) && (i.getOutEdges = function () {
          ...
          var l = i.getPaintLayers(), A = l.getFillLayers(!0), c = l.getBorderLayers(!0);
          A.length > 1 || c.length > 1 || i.getProperty("dir") || t._options && t._options.convertTextToPath ? i._paint = function (e) {
          ...
          t._instanceof(i, B) ? i._edges && (i._edges = t.proxy(i._edges)) : t._instanceof(i, x) ? (a.each(Object.getOwnPropertyNames(i.__source__), function (e, t) {
          ...
          }.bind(i)), i._paintBorder = function (e, t, i, n, r) {
          ...
          }) : t._instanceof(i, C) ? i._scene = t.proxy(i._scene) : t._instanceof(i, b) && (i._workspace = t.proxy(i._workspace));
      }
      return i;
    }
    return null;
