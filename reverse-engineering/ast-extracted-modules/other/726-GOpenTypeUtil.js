...
function (e, t, i) {
  ...
  n.inherit(d, a), d.prototype._data = null, d.prototype._parse = function (e, t, i, n, r) {
    ...
    return r[0] = l, a;
  }, n.inherit(f, a), f.prototype._pascalString = !1, f.prototype._parse = function (e, t, i, n, r) {
    this._position = t;
    var o, a = "", s = null;
  ...
  o.Parser.prototype._checkType = function () {
    if (o._getOpenTypeInfo(this._buffer, 0, !0))
      this._type = b;
    else {
      var e;
      try {
        ...
        for (n = 0; n < f && h < A; n++) {
          ...
          if (h += 2, V <= 7 || V === o.nameId.TYPO_FAMILY || V === o.nameId.TYPO_SUBFAMILY) {
            ...
            if (h += 2, O > 0) {
              ...
              0, void 0 !== H && void 0 !== X && (Y || (M[V] = []), M[V][X] = {
                encoding: H,
                stringLen: O,
                stringOff: L
              });
