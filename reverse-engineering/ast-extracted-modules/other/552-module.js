...
function (e, t, i) {
  var n = i(0), r = i(11), o = i(56), a = (i(22), i(45)), s = i(214), l = i(28), h = i(128), A = i(36), c = i(5), p = i(24), u = i(155), d = i(7), g = i(6), f = i(12), m = i(39), y = i(81), _ = i(17), v = i(14);
  function b(e) {
    u.call(this, e);
  }
  n.inherit(b, u), A.exports(b, s), b.START_ANGLE_PART_ID = r.uuid(), b.END_ANGLE_PART_ID = r.uuid(), b.prototype.getBBoxMargin = function () {
    ...
    u.prototype._postPaint.call(this, e, t), this._showSegmentDetails() && this._iterateArcEnds(!0, function (i) {
      ...
      return y.paintAnnotation(t, e, i.position, o, n, r.size, _.WHITE, t.annotationColor, r.outlineWidth, r.shadowColor, r.outsideStroke), !1;
    }.bind(this));
  }, b.prototype._getPartInfoAt = function (e, t, i) {
    if (this._showSegmentDetails()) {
      var n = null;
      if (this._iterateArcEnds(!1, function (i) {
          return !!y.getAnnotationBBox(t, i.position, p.annotationHandles.ellipse.size, !1).expanded(p.annotPickDistance, p.annotPickDistance, p.annotPickDistance, p.annotPickDistance).containsPoint(e) && (n = new m.PartInfo(this, i.id, null, !0, !0), !0);
        }.bind(this)), n)
        return n;
    }
