...
function (e, t, i) {
  ...
  function a(e, t) {
    var i = JSON.stringify(e), n = 256;
    for (var r in t) {
      var o = parseInt(r);
      if (o && !(o < 256)) {
        if (JSON.stringify(t[r]) === i)
          return o;
        n <= o && (n = o + 1);
      }
    }
  ...
  function l(e, t, i) {
    var n = {}, o = new r.Parser(e, t);
    return n.tag = o.parseTag(), n.minValue = o.parseFixed(), n.defaultValue = o.parseFixed(), n.maxValue = o.parseFixed(), o.skip("uShort", 1), n.name = i[o.parseUShort()] || {}, n;
  }
  function h(e, t, i, n) {
    for (var r = [
          {
  ...
  t.make = function (e, t) {
    ...
    var o = new r.Parser(e, t), a = o.parseULong();
    n.argument(65536 === a, "Unsupported fvar table version.");
    var s = o.parseOffset16();
    o.skip("uShort", 1);
    for (var h = o.parseUShort(), c = o.parseUShort(), p = o.parseUShort(), u = o.parseUShort(), d = [], g = 0; g < h; g++)
