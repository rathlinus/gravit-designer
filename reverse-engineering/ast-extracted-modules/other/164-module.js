...
function (e, t, i) {
  ...
  n.inherit(a, n), a.Constant = {
    ...
    for (var i = t.isWordMode, n = "", o = 0; o < e.length; ++o)
      o > 0 && (i ? n += r.operatingSystem === r.OperatingSystem.OSX_IOS ? " " : " + " : r.operatingSystem !== r.OperatingSystem.OSX_IOS && (n += "+")), "number" == typeof e[o] ? n += a.toLocalizedShort(e[o]) : n += a.toSystemShortcut(e[o]);
    return n;
  }, e.exports = a;
}
