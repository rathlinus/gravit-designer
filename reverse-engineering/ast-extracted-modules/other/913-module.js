...
function (e, t, i) {
  ...
  !function (r) {
    ...
    function p(e, t, i, n) {
      var r = e.c;
      if (void 0 === i && (i = e.constructor.RM), 0 !== i && 1 !== i && 2 !== i && 3 !== i)
        throw Error("[big.js] Invalid rounding mode");
      if (t < 1)
        n = 3 === i && (n || !!r[0]) || 0 === t && (1 === i && r[0] >= 5 || 2 === i && (r[0] > 5 || 5 === r[0] && (n || void 0 !== r[1]))), r.length = 1, n ? (e.e = e.e - t + 1, r[0] = 1) : r[0] = e.e = 0;
      else if (t < r.length) {
        if (n = 1 === i && r[t] >= 5 || 2 === i && (r[t] > 5 || 5 === r[t] && (n || void 0 !== r[t + 1] || 1 & r[t - 1])) || 3 === i && (n || !!r[0]), r.length = t, n)
          for (; ++r[--t] > 9;)
            if (r[t] = 0, 0 === t) {
              ++e.e, r.unshift(1);
              break;
    ...
    h.abs = function () {
      ...
      return v[0] || 1 == b || (v.shift(), _.e--, C--), b > C && p(_, C, i.RM, void 0 !== m[0]), _;
    }, h.eq = function (e) {
      return 0 === this.cmp(e);
    }, h.gt = function (e) {
      return this.cmp(e) > 0;
      ...
      0 === (o = Math.sqrt(+u(n, !0, !0))) || o === 1 / 0 ? ((t = n.c.join("")).length + s & 1 || (t += "0"), s = ((s + 1) / 2 | 0) - (s < 0 || 1 & s), e = new r(((o = Math.sqrt(t)) == 1 / 0 ? "5e" : (o = o.toExponential()).slice(0, o.indexOf("e") + 1)) + s)) : e = new r(o + ""), s = e.e + (r.DP += 4);
      do {
    ...
    }()).default = o.Big = o, void 0 === (n = function () {
      return o;
