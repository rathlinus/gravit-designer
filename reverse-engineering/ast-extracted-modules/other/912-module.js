...
function (e, t, i) {
  ...
  e.exports = function (e) {
    ...
    }, e.Accelerated.PAINT_QTREES = !1, e.Accelerated.prototype._childrenPaintQTree = null, e.Accelerated.prototype._childrenGeometryQTree = null, e.Accelerated.prototype._dirtyIndex = !1;
    e.Accelerated.prototype._updateQTree = function () {
      ...
      for (var t = 0, i = this.getFirstChild(); null !== i; i = i.getNext())
        i instanceof e && (i._elementIndex = t++, i._containingPaintQTreeElement || i._containingGeometryQTreeElement ? (this._removeAccelElement(i), this._insertAccelElement(i)) : this._insertAccelElement(i));
      ...
      if (!t) {
        ...
        if (a && (a.getWidth() > 0 || a.getHeight() > 0)) {
          ...
          s && (a = a && a.united(s) || s), o = !0, (n = this._getAccelElementOffset(e)) && (a = a.translated(n.getX(), n.getY()));
      ...
      if (t === n._Change.Restore) {
        ...
        i instanceof e && (this._removeAccelElement(i), i._dirtyIndex = !0);
