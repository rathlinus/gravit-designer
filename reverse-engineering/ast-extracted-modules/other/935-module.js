...
function (e, t, i) {
  ...
  r.prototype._yStrips = null, r.prototype._intervals = null, r.prototype.reset = function () {
    ...
    if (this._yStrips.length) {
      var t = e.getX(), i = e.getX() + e.getWidth(), n = e.getY(), r = e.getY() + e.getHeight(), o = this._locate(this._yStrips, n);
      if (o.idx !== this._yStrips.length) {
        ...
        if (A[0] = n, o.outside || (l = this._yStrips[c][1], this._yStrips[c][1] = n, A[0] = n, A[1] = Math.min(l, r), c += 1, h.outside || (p += 1), this._yStrips.splice(c, 0, A), this._intervals.splice(c, 0, C(this._intervals[c - 1]))), A = new Array(2), h.outside);
          ...
          this._yStrips[p][0] = r, void 0 !== l && (this._yStrips[p][1] = Math.max(l, this._yStrips[p][1])), A[0] = Math.max(u, n), A[1] = r, this._yStrips.splice(p, 0, A), this._intervals.splice(p, 0, C(this._intervals[p]));
        }
        if (c !== p || !o.outside || !h.outside) {
          p = Math.min(p, this._yStrips.length - 1), a = Math.max(0, c - 2), s = Math.min(p + 1, this._yStrips.length - 1);
          for (var d = c; d <= p; d++) {
            var g = this._intervals[d], f = this._locate(g, t), m = this._locate(g, i), y = void 0, _ = void 0, v = void 0, b = void 0;
            f.outside ? _ = f.idx : (b = g[f.idx][1], g[f.idx][1] = t, _ = f.idx + 1), m.outside || (void 0 !== b && f.idx == m.idx ? y = [
              i,
              b
            ] : g[m.idx][0] = i), v = m.idx, y ? g.splice(_, v - _, y) : g.splice(_, v - _);
          }
        }
    ...
    if (p[0] = s, h.outside ? (p[0] = s, p[1] = Math.min(this._yStrips[u][0], l), this._yStrips.splice(u, 0, p), this._intervals.splice(u, 0, [[
          o,
          a
        ]]), u += 1, d += 1) : (A = this._yStrips[u][1], this._yStrips[u][1] = s, p[0] = s, p[1] = Math.min(A, l), u += 1, d += 1, this._yStrips.splice(u, 0, p), this._intervals.splice(u, 0, i(this._intervals[u - 1]))), p = new Array(2), c.outside)
      ...
      this._yStrips[d][0] = l, void 0 !== A && (this._yStrips[d][1] = Math.max(A, this._yStrips[d][1])), p[0] = Math.max(g, s), p[1] = l, this._yStrips.splice(d, 0, p), this._intervals.splice(d, 0, i(this._intervals[d]));
    }
    ...
    for (var i = t; i >= e; i--) {
      ...
      if (n[0] !== n[1]) {
        ...
        if (r.length) {
          ...
          if (i < this._intervals.length - 1 && this._yStrips[i][1] === this._yStrips[i + 1][0]) {
            var l = this._intervals[i + 1];
            a = this._intervals[i];
            if (l.length === a.length) {
              for (o = 0; o < a.length && a[o][0] == l[o][0] && a[o][1] == l[o][1]; o++);
              o == a.length && (this._yStrips[i][1] = this._yStrips[i + 1][1], this._yStrips.splice(i + 1, 1), this._intervals.splice(i + 1, 1));
            }
          }
        } else
          this._yStrips.splice(i, 1), this._intervals.splice(i, 1);
      } else
        this._yStrips.splice(i, 1), this._intervals.splice(i, 1);
    }
    ...
    for (var t = [], i = 0; i < this._yStrips.length; i++)
      for (var r = this._intervals[i], o = this._yStrips[i], a = 0; a < r.length; a++) {
        var s = r[a];
