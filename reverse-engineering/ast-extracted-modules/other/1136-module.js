...
function (e, t, i) {
  var n = i(0), r = i(439), o = i(70), a = i(17), s = i(188), l = i(1137), h = i(28), A = i(108), c = i(416), p = i(7), u = {
  ...
  n.inherit(g, r), g.composeQuery = function (e) {
    ...
    this._promise.then(function () {
      ...
      if (t && t.length) {
        var i = t[0];
        i.text = e, this._node.setText(t), 0 === this._data.textBehaviour && "center" === i.align && this._promise && this._file.getFontSearch().getFont(i.fontFamily, "normal" !== i.fontStyle ? A.Style.Italic : A.Style.Normal, i.fontWeight || A.Weight.Regular).then(function (e) {
    ...
    if (t) {
      var i = [];
      i.push("font:"), i.push(e.getStyle() === A.Style.Normal ? "normal" : "italic"), i.push(e.getWeight()), i.push(t.fontSize + "px"), i.push(e.getFamily());
    ...
    if (this._data.attributedString && this._data.attributedString.archivedAttributedString) {
      ...
      if (u) {
        ...
        for (var _ = [], v = 0, b = 0; b < y.length; b += 2) {
          var C = y[b], w = m[y[b + 1]], E = i, B = n, x = d(t || 0, !0).toLowerCase();
          if (w && (w.MSAttributedStringFontAttribute && (E = h.toMap(h.getByRef(w.MSAttributedStringFontAttribute.NSFontDescriptorAttributes))), w.NSColor && (B = f(w.NSColor)), w.NSParagraphStyle && (x = d(w.NSParagraphStyle.NSAlignment || 0, !0).toLowerCase())), E && B && x) {
    ...
    var F = [], R = [];
    c && "string" == typeof c && (n && (F.push("_fc"), R.push(n)), t && (F.push("_pal"), R.push(d(t))), i && (F.push("_tfi", "_tff"), R.push(E.NSFontSizeAttribute, E.NSFontNameAttribute))), 0 === this._data.textBehaviour && (this._node._geometryBBox ? (F.push("ah"), R.push(!0)) : (F.push("aw", "ah"), R.push(!0, !0))), this._node.setProperties(F, R), this._node._geometryBBox = this._getGeometryBBox();
