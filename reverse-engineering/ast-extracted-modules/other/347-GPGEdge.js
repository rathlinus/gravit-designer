...
function (e, t, i) {
  var n = i(2), r = i(512), o = i(513), a = i(929), s = i(14), l = i(28), h = i(17), A = i(12), c = i(45), p = i(22), u = i(11);
  function d() {
  ...
  n.inheritAndMix("GPGEdge", d, n, [
    ...
    uid: null,
    cSt: !1
  }, d.prototype.painted = !1, d.prototype._pathBase = null, d.prototype._facets = null, d.SplitPoint = function (e, t, i) {
    ...
    if (e.length >= 5) {
      ...
      var t = new r(new o(e[2])), i = new r(new o(e[3]));
      this.setAnchors([
        t,
        i
      ]);
    ...
    t && ((o = new c(!1, this._pathBase.cloneAnchorPoints())).setProperty("trf", t), o.assignStyleFrom(this)), u.each(o.getPaintLayers().getBorderLayers(), function (e, t) {
    ...
    if (n)
      void 0 !== a.putVertices(A) && (a.strokeVertices(h.BLACK, p, r.$_bds, _, r.$_blj, r.$_bml, 1), o._paintBorderMarkers(e, h.BLACK, r));
    else {
