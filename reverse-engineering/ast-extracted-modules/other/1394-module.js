...
function (e, t, i) {
  var n = i(147), r = i(2), o = i(11), a = i(5), s = i(87), l = i(14), h = i(179), A = i(1395), c = i(195), p = i(158), u = i(108), d = i(138), g = i(0), f = i(17), m = i(367), y = i(1203), _ = i(73), v = i(70), b = i(1396), C = i(6), w = i(54), E = (i(63), i(7)), B = i(122), x = i(161), P = i(416), S = i(48), T = i(95), I = i(1204), F = i(188), R = i(12), D = i(1120), k = i(28), G = i(139), Q = i(50), M = i(345), N = i(22), U = 0, V = 1, O = 2, L = 3;
  function Y() {
    this._map = [];
  }
  function X() {
  ...
  H.prototype.gfx = null, H.prototype.canvas = null, H.prototype._stackState = null, H.prototype._root = null, H.prototype._transform = null, H.prototype._clipping = null, H.prototype._path = null, H.prototype._dashArray = null, H.prototype._fontManager = null, H.prototype._words = null, H.prototype._fontCache = null, H.prototype._missingFonts = null, H.prototype._currentClip = null, H.prototype._embeddedFonts = null, H.prototype._bitmap = null, H.prototype.createContext = function (e) {
    ...
    return new Promise(function (e) {
      if (this._root && this._root instanceof N) {
        var t = 0, i = function () {
            if (t <= 0) {
              var i = this.canvas.getHTMLElement(), n = this._root.toBitmap();
              n && i.getContext("2d").drawImage(n.getHTMLElement(), 0, 0), this._bitmap = new M(i), e();
            }
          }.bind(this), n = function (e) {
            return e.getStatus() === T.ImageStatus.Loaded || e.getStatus() === T.ImageStatus.Error;
          }, r = function (e) {
            n(e.image) && (t--, e.image.removeEventListener(T.StatusEvent, r), i());
          };
        this._root.accept(function (e) {
          e instanceof T && (n(e) || (t++, e.addEventListener(T.StatusEvent, r)));
        }), i();
      } else
        e();
    }.bind(this));
    ...
    if (!this._bitmap) {
      var e = this.canvas.getHTMLElement(), t = this._root.toBitmap();
      if (t) {
    ...
    var t = this._bitmap;
    if (e) {
      var i = this._bitmap.getHTMLElement(), n = document.createElement("canvas");
      n.width = i.width, n.height = i.height;
      var r = n.getContext("2d");
      r.setTransform(1, 0, 0, -1, 0, 0), r.drawImage(i, 0, -n.height), t = new M(n);
    }
    ...
    if (this.isSingleVertexSource() && e.isSingleVertexSource()) {
      var t = this._root.getFirstChild(), i = e._root.getFirstChild();
      if (new W(t).equals(new W(i))) {
        var n = t.getPaintLayers(), r = i.getPaintLayers();
        if (n && r) {
          var a = n.getFillLayers(!0)[0], s = r.getFillLayers(!0)[0];
    ...
    if (this._consumePath()) {
      var e = this._clipping.getLastChild(), t = e.getPrevious(), i = e;
      t && H.VertexSource.equals(e, t) && (this._clipping.removeChild(e), i = t), this._clipping = i, this._currentClip = i;
    }
    ...
    if (e instanceof HTMLCanvasElement) {
      ...
      if (e.context._bitmap) {
        ...
        (f = new T()).transform(A), f.setProperty("_bvs", !1), f.setProperty("_fvs", !1), f.setProperty("url", e.context.toImage()), this._clipping.appendChild(f);
      } else
    ...
    if (this._consumePath() || e) {
      ...
      var i = new k.BorderPaintLayer(), n = this._transform.getScaleFactor();
      i.setProperty("_bw", this.lineWidth * n), i.setProperty("_bds", this._dashArray.map(function (e) {
        return e * n;
      })), i.setProperty("_blc", this.lineCap), i.setProperty("_bl", this.globalCompositeOperation || "normal");
      var r = this.strokeStyle;
      this.lineWidth && (r = r || "rgb(0,0,0)");
      var o = this._getPattern(r);
      o instanceof Z && (o = o.createGPattern(this._transform, t.getGeometryBBox())), o instanceof Q && i.setProperty("_pt", o), t.getPaintLayers().appendChild(i);
    }
  }, H.prototype.fill = function (e, t) {
    if (this._consumePath() || t) {
      var i = t || this._clipping.getLastChild();
      i.setProperty("evenodd", "evenodd" === e), i.setProperty("_sfop", this.globalAlpha || 1);
      var n = this._getPattern(this.fillStyle);
      if (n instanceof Z && (n = n.createGPattern(this._transform, i.getGeometryBBox())), n instanceof Q && i.hasMixin(k)) {
    ...
    if (!e) {
      var t, i = I.Font.getWeight(this.gfx.current.font.name), n = I.Font.getStyle(this.gfx.current.font.name);
      if ((e = this.gfx.current.font).data)
        try {
          var r = new A(null, null, null, e.data.buffer);
          if (r) {
            t = r._openTypeFont.names.fontFamily ? r._openTypeFont.names.fontFamily.en : r._openTypeFont.names.postScriptName.en, n = I.Font.getStyle(r._openTypeFont.names.fontSubfamily.en), i = I.Font.getWeight(r._openTypeFont.names.fontSubfamily.en);
            var a = y.contains(t);
            if (!a) {
              ...
              }), s = s.trim(), (a = y.contains(s)) && (t = a, i = I.Font.getWeight(r._openTypeFont.names.fullName.en));
            }
            if (a)
              e.otf = this._fontManager.getFont(t, n, i), e.supported = !0;
            else {
              var l = r._openTypeFont.names.postScriptName ? r._openTypeFont.names.postScriptName.en : r._openTypeFont.names.fullName.en;
              if (r._family = l, r._weight = i, r._style = n, e.otf = r, !r._openTypeFont.charToGlyphIndex(c.NBSP)) {
    ...
    readVertices: function (e) {
      ...
      if (e.rewindVertices(0))
        for (var i = new S(); e.readVertex(i);)
          t.push(i);
      return t;
    }
    ...
    return o;
  }, H.Gradient = Z, g.inherit(z, Z), g.inherit(j, Z), e.exports = H;
}
