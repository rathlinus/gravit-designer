...
function (e, t, i) {
  var n = i(0), r = i(36), o = i(154), a = i(83), s = (i(2), i(82)), l = i(6), h = i(7), A = i(39), c = (i(11), i(66)), p = i(24), u = i(12), d = (i(5), i(14), i(9), i(47), i(64));
  function g(e) {
    o.call(this, e), this._flags = c.Flag.ResizeAll;
  }
  n.inheritAndMix(g, o, [o.LabelHolder]), r.exports(g, a), g.FIRST_PAGE = 57005, g.SWITCH_ORDER = !1, g.MOVE_MASTER = !0, g.prototype._collisionlessTransform = p.pageCollisionTransform, g.prototype.setCollisionlessTransform = function (e) {
    ...
    if (t._layoutTransform = null, this._transform && !this._transform.isIdentity()) {
      var i = this._transform.getMatrix(), n = i[0], r = i[3];
    ...
    if (e && this._element && this._element !== e) {
      var r = this._element.getPosition(!0).subtract(e.getPosition(!0)), o = this._transform.getTranslation().translated(r.getX(), r.getY()), a = this._element.getProperty("off") || new h();
    ...
    if (e === o.LabelHolder.LABEL_PART_ID) {
      ...
      if (g.SWITCH_ORDER && a.iteratePages(function (e) {
        ...
        a.startBlockReferenceChanges(), a.beginUpdate(), a.removeChild(this.getElement()), m < y ? d.getNext() ? a.insertChild(this.getElement(), d.getNext()) : a.appendChild(this.getElement()) : a.insertChild(this.getElement(), d), p.updateSelection(!1, [this.getElement()]), a.endBlockReferenceChanges(), a.endUpdate();
