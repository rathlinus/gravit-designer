...
function (e, t, i) {
  var n = i(0), r = i(2), o = i(11), a = i(75), s = i(472);
  function l() {
    this.$refs = [];
  }
  n.inheritAndMix(l, r, [
    ...
    for (var e = this; e && "page" !== r.getName(e);)
      e = e.getParent();
    ...
    if (e.target === this && this.hasMixin(r.Properties)) {
      var t = e.linked, i = e.reference;
      if (t) {
        var n = o.unique(this.$refs.concat([i.getReferenceId()]).filter(function (e) {
          return e;
        }));
        this.setProperty("refs", n);
      } else {
        (n = this.$refs.slice()).splice(this.$refs.indexOf(i.getReferenceId()), 1), n = n.filter(function (e) {
          return e;
        }), this.setProperty("refs", n);
      }
    }
