...
function (e, t, i) {
  var n = i(7), r = i(14), o = i(228), a = i(133), s = i(6), l = i(5), h = i(95), A = i(113), c = i(233), p = i(293), u = i(440), d = i(249), g = i(602), f = i(855), m = i(853), y = i(359), _ = i(564), v = i(87), b = i(1450), C = i(68);
  function w() {
  }
  w.prototype.render = function (e, t, i) {
    ...
    var h = e.canvas.getScale(), A = i.getAbsoluteEffectPadding().map(function (e) {
      ...
      }), c = t.getPaintBBox(), g = e.canvas.getPaintExtents(c, !0, A), f = e.canvas.getFinalExtents(g), m = e.canvas.getTransform().getTranslation(), y = new l(-f.getX(), -f.getY()), _ = e.canvas.getTranslateCorrection(m, y), v = 1 / h, C = _.getX() * v, w = _.getY() * v, E = c.translated(C, w).expanded(v, v, v, v);
    ...
    S.canvas = P;
    var T = new a();
    T.paintMode = a.PaintMode.Full, T.paintSharp = !1, T.annotations = !1, S.configuration = T, T.clipDirty = !1, T.enableFxCache = !1, T.defaultEffectDetailLevel = 1, T.ignoreEffects = !0, P.prepare(), P.setOrigin(x), P.setOffset(x), P.setScale(h);
    var I, F = new r();
    F.resize(B.getWidth(), B.getHeight()), F.prepare(), F.setOrigin(x), F.setOffset(x), F.setScale(h);
    try {
      t.paint(S);
      var R = F.getTransform(!1).inverted().mapRect(new s(0, 0, F.getWidth(), F.getHeight())), D = F.createPatternPaint(i.$pat, R);
      if (D)
        if (D.transform) {
    ...
    try {
      ...
      var u = i.$opc, d = t.getPaintLayers().getFillLayers(!0)[0];
      d && (u *= d.$_op);
      var f = l.createSMaskGStateResource(p);
      a.setGStateResource(f), a.add(h);
      var m = r.getTransform(!1).inverted().mapRect(new s(0, 0, r.getWidth(), r.getHeight())), y = r.createPatternPaint(i.$pat, m);
