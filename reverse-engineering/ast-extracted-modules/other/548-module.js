...
function (e, t, i) {
  var n = i(334), r = i(2), o = i(0), a = i(24), s = i(39), l = i(386), h = (i(167), i(276));
  function A() {
    n.call(this);
  }
  o.inherit(A, n), A.prototype.activate = function (e, t) {
    n.prototype.activate.call(this, e, t), this._editor.setSelectionDetail(!1, !0), a.styleEditors && (this._styleEdManager = e.getScene().getWorkspace().getStyleEdManager(), this._styleEdManager.activate(e)), this._allowDistanceHelper = a.showDistance;
