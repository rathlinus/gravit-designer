...
function (e, t, i) {
  var n = i(2), r = i(0), o = i(39), a = i(128), s = i(36), l = (i(22), i(45));
  i(24);
  function h(e) {
  ...
  r.inherit(h, a), s.exports(h, l), h.ExtendingMode = {
    ...
    Beginning: 1,
    End: 2
  }, h.prototype._catchHandle = !0, h.prototype.transformBox = function (e, t) {
    ...
    if (!this._elementPreview) {
      ...
      for (var i = e.getFirstChild(); null != i; i = i.getNext()) {
        ...
        r.transferProperties(i, [l.AnchorPoint.GeometryProperties]), i.hasFlag(n.Flag.Selected) && r.setFlag(n.Flag.Selected), t.appendChild(r);
      }
      t._endBlockChanges([
        n._Change.BeforeChildInsert,
        n._Change.AfterChildInsert
