...
function (e, t, i) {
  var n = i(5), r = i(87), o = i(48), a = i(12);
  function s(e, t, i, r) {
    if (this._source = e, this._transform = t || null, this._alignX = this._alignY = i ? 0 : 0.5, this._bbox = r, this._transform && (this._invTrf = this._transform.inverted()), r) {
      var o = this._transform.mapQuadrilateral(this._bbox), s = new n(a.round(o[0].getX() + l, !0, 2) + this._alignX, a.round(o[0].getY() + l, !0, 2) + this._alignY), h = new n(a.round(o[1].getX() + l, !0, 2) + this._alignX, a.round(o[1].getY() + l, !0, 2) + this._alignY), A = new n(a.round(o[2].getX() + l, !1, 2) + this._alignX, a.round(o[2].getY() + l, !1, 2) + this._alignY), c = new n(a.round(o[3].getX() + l, !1, 2) + this._alignX, a.round(o[3].getY() + l, !1, 2) + this._alignY), p = o[0].getX(), u = o[0].getY(), d = o[1].getX(), g = o[1].getY(), f = o[2].getX(), m = o[2].getY();
    ...
    if (this._source.readVertex(e)) {
      if (e.command >= o.Command.Move && e.command < o.Command.Close && this._invTrf)
        if (0 !== this._bDiv1 || 0 !== this._bDiv2) {
          ...
          var t = this._bbox, i = t[0].getX(), n = t[0].getY(), r = t[1].getX(), a = t[1].getY(), s = t[2].getX(), h = t[2].getY(), A = (a - h) * (e.x - s) + (s - r) * (e.y - h), c = (h - n) * (e.x - s) + (i - s) * (e.y - h), p = 1 - (A /= this._bDiv1) - (c /= this._bDiv1);
          if (A >= 0 && A <= 1 && c >= 0 && c <= 1 && p >= 0) {
            ...
            var f = (a - (h = t[3].getY())) * (e.x - s) + (s - r) * (e.y - h), m = (h - n) * (e.x - s) + (i - s) * (e.y - h), y = 1 - (f /= this._bDiv2) - (m /= this._bDiv2), _ = (u = this._alignedBBox[0], g = this._alignedBBox[2], this._alignedBBox[3]);
