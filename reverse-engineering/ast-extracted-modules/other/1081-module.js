...
function (e, t, i) {
  var n = i(50), r = i(2), o = i(77), a = i(363), s = i(64), l = i(150), h = i(777), A = i(133), c = i(24), p = i(153), u = i(0), d = i(6), g = i(22), f = i(7), m = i(82), y = i(544), _ = i(36), v = i(5), b = i(83), C = i(553), w = i(14), E = i(210), B = i(540), x = i(11), P = i(17), S = i(138), T = i(216), I = i(9), F = i(47), R = i(207);
  function D(e) {
  ...
  u.inherit(D, a), D.prototype._editor = null, D.prototype._guideLineDiv = null, D.prototype._guideLineViewPoint = null, D.prototype._guideLinePosition = null, D.prototype._guideLineInfo = null, D.prototype._lastFocus = null, D.prototype._inputListener = null, D.prototype._inputListenerCompStart = null, D.prototype._inputListenerCompEnd = null, D.prototype._inputListenerCompUpd = null, D.prototype.setRulers = function (e) {
    ...
    if (this._guideLineInfo) {
      ...
      this._editor.getGuides().beginMap(), t = this._editor.getGuides().mapPoint(t, null, [
        p.ID,
        y.ID
      ]), this._editor.getGuides().finishMap(), e = this.getWorldTransform().mapPoint(t), this._guideLinePosition = t;
      ...
      if (this._guideLineInfo.isVertical) {
        ...
        this.updateInlineHint(this._editor.getScene().pointToString(t.getX(), 1) + this._editor.getScene().getProperty("ut"), new v(e.getX(), i * n + 3), d.Side.TOP_CENTER);
      } else {
        ...
        this.updateInlineHint(this._editor.getScene().pointToString(t.getY(), 1) + this._editor.getScene().getProperty("ut"), new v(i * r + 3, e.getY()), d.Side.LEFT_CENTER);
      }
    ...
    if (this._guideLineInfo) {
      ...
      var e = this._guideLineInfo.isVertical, t = this._guideLineInfo.guideIndex, i = e ? "vgl" : "hgl", n = this._editor.getScene().getProperty(i);
      n = n ? n.slice() : [];
      ...
      if (!e && this._guideLineDiv.offsetTop >= h && this._guideLineDiv.offsetTop <= o || e && this._guideLineDiv.offsetLeft >= a && this._guideLineDiv.offsetLeft <= r) {
        if (t >= 0) {
        ...
        var A = e ? this._guideLinePosition.getX() : this._guideLinePosition.getY();
        if (t < 0 || t >= 0 && n[t] !== A) {
          t >= 0 ? n[t] = A : n.push(A), this._editor.beginTransaction();
          try {
            this._editor.getScene().setProperties([i], [n]);
          } finally {
            this._editor.commitTransaction(t >= 0 ? I.get(new F("GEditorWidget", "action.change-guide-line")) : I.get(new F("GEditorWidget", "action.add-guide-line")));
          }
        }
      }
    ...
    if (!isNaN(e) && !isNaN(t)) {
      var i = new v(e, t), n = this.getWorldTransform().mapPoint(i), r = w.getScreenDPI();
    ...
    if (e.editor) {
      ...
      if (e.args && e.args.pageTransform && this.getViewConfiguration().multiPageView) {
        var i = this.getWorldTransform(this.getScene()).preMultiplied(e.args.pageTransform);
        t = e.editor.invalidate(i, null);
      } else if (this.getViewConfiguration().multiPageView)
        t = e.editor.invalidate(this.getWorldTransform(e.getEditorPage() || this.getScene()), e.args);
      else {
        var n = this.getScene(), r = e.getEditorPage(), o = n ? n.getActivePage() : null;
        r && r !== n && r !== o || (t = e.editor.invalidate(this.getWorldTransform(r || n), e.args));
      }
      t && this.invalidate(t);
    }
    ...
    if (!(t && e.client.getX() <= 2 * w.getScreenDPI())) {
      ...
      var i = function (e) {
          ...
          this.removeEventListener(o.Move, i, this), this.removeEventListener(o.Release, n, this), this.finishMoveGuideLine();
        };
      this.addEventListener(o.Move, i, this), this.addEventListener(o.Release, n, this);
    }
  ...
  D.prototype._renderPageBackground = function (e, t) {
    var i = this._viewConfiguration.pageDecoration, n = e.getPosition(this._viewConfiguration.multiPageView), r = t.preMultiplied(new f(1, 0, 0, 1, n.getX(), n.getY())), o = e.isFixedSized() ? e.getGeometryBBox() : e.getPaintBBox(null, !0);
    if (o) {
      ...
      u && i.shadow > 0 && !G && (G = !0, console.warn("Due to browser bug (Firefox), shadow under canvas isn't displayed."));
    ...
    if (t) {
      ...
      if (!i) {
        ...
        i ? console.log("inserting:found") : (e._master = !0, e.getProperty("masterRef") === e.getReferenceId() && e.getProperty("masterMultiRef") === e.getMultireferenceId() || console.log("inserting: making non master a master"), e.setProperties([
          "masterRef",
          "masterMultiRef"
        ], [
          e.getReferenceId(),
      ...
      for (a = 0; a < t.types.length; ++a) {
        ...
        if (A) {
          ...
          if (s.push({
            ...
            var d = this._scene.hitTest(e, this.getWorldTransform(this._scene), null, !0, -1, c.pickDistance, !0, this._dropHitFilter, !1, !1, this._viewConfiguration.multiPageView);
            if (d && d.length > 0)
        ...
        for (a = 0; a < s.length; ++a) {
          ...
          if (p === _.DropType.Node && u instanceof g) {
            if (u instanceof T) {
              ...
              u.transform(new f(1, 0, 0, 1, o.getX(), o.getY()), !0);
            this._editor.updateByMousePosition(i, null, !1, this._viewConfiguration);
            var S = [], R = [], D = u.accept(function (e) {
                return !!(e instanceof T && e.isMaster()) && (S.push(e.getMultireferenceId()), R.push(e), !0);
              }, !1, !0);
            D && this._editor.beginTransaction(), this._editor.insertElements([u], !0, D, !0), D && (this._scene.acceptChildren(function (e) {
            ...
            }.bind(this)), this._editor.commitTransaction(I.get(new F("GEditorWidget", "action.insert-master-symbol")))), l = !0;
          }
        }
    }
