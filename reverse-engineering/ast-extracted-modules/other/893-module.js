...
function (e, t, i) {
  var n = i(2), r = i(0), o = i(132), a = i(12), s = i(14), l = i(644);
  ...
  r.inherit(h, l), h.Orientation = {
    ...
    if (this._isUnitRuler)
      ...
      this._orientation == h.Orientation.Horizontal && (e = window.screen.availWidth), this._canvas.width = e * i, this._canvas.height = t * i, this._canvas.style.width = e + "px", this._canvas.style.height = t + "px", this._orientation === h.Orientation.Vertical && (this._verticalWidth = e), this._paint();
    }
  }, h.prototype._paint = function () {
    if (this.isDisplayed()) {
      var e = s.getScreenDPI(), t = this.getWidth() * e, i = this.getHeight() * e, n = this._context, r = window.getComputedStyle(this._htmlElement, null).getPropertyValue("color");
      n.clearRect(0, 0, t, i), n.fillStyle = r, n.strokeStyle = r, n.lineWidth = 1;
      var l = 9 * e;
      n.font = l + "px Verdana", n.save(), this._orientation === h.Orientation.Vertical && (n.translate(t, 0), n.rotate(Math.PI / 180 * 90)), n.beginPath();
      var A = 0, c = l, p = 19 * e / 1.5, u = this._orientation === h.Orientation.Vertical ? i : t, d = 1 / this._scale, g = new o(1, this._scene.getProperty("ut")).toPoint(), f = 1, m = 0, y = !1, _ = 50 * d / g;
      if (g > 1)
      ...
      for (var b = -this._offset * d / g, C = Math.ceil(b / v) * v, w = Math.ceil(b / _) * _, E = (u - this._offset) * d / g, B = "", x = C, P = -9; x < E; x += v, ++P) {
        ...
        a.isEqualEps(x, w, 0.01 / f) && (P = Math.floor(10 * e)), P % Math.floor(10 * e) == 0 ? (B = a.round(x, !1, y ? m : 0), A = c) : (B = "", A = p), n.moveTo(S + 0.5, 19.5 * e), n.lineTo(S + 0.5, A + 0.5);
    ...
    if (!this._htmlElement.firstChild) {
      ...
      t.style.font = "9px Verdana", t.style.alignSelf = "center", e.rulerLeftFill && (t.style.marginRight = "5px"), t.style.color = window.getComputedStyle(this._htmlElement, null).getPropertyValue("color"), this._htmlElement.appendChild(t);
    }
