...
function (e, t, i) {
  var n = i(0), r = i(227), o = i(2), a = i(216), s = i(345), l = (i(472), i(14));
  function h(e) {
    r.call(this), this.EntryClass = h.Entry, this._scene = e, this._scene.addEventListener(o.AfterInsertEvent, this._afterInsert, this, void 0, void 0, !0), this._scene.addEventListener(o.BeforeRemoveEvent, this._beforeRemove, this, void 0, void 0, !0);
  }
  function A(e) {
  ...
  n.inherit(h, r), h.prototype._scene = null, h.prototype._updateThumbnail = function (e) {
    ...
    e.node.accept(function (e) {
      if (e instanceof a && e.isMaster()) {
        var i = e.getMultireferenceId(), n = t.getEntry(i), r = !1;
        if (n ? n.value ? (r = n.value.symbol !== e, n.value.symbol = e) : (r = !0, n.value = {
            image: null,
            symbol: e
          }) : (r = !0, n = new t.EntryClass({
            image: null,
            symbol: e
          }, i), t.addEntry(n)), r) {
          var s = {
    ...
    e.node.accept(function (e) {
      if (e instanceof a && e.isMaster()) {
        ...
        t.removeEntry(i), e.removeEventListener(a.AfterThumbnailUpdate, t._updateThumbnail.bind(t));
      }
    });
    ...
    if (this.uuid = e.uuid, this.value = e.value, this.references = e.references, this.value) {
      if (A(this.value.image)) {
        var t = new Image(), i = this.value;
        t.src = i.image, i.image = null, t.onload = function () {
          if (0 !== t.naturalWidth && 0 !== t.naturalHeight && !i.image) {
            var e = new l();
            e.resize(t.naturalWidth, t.naturalHeight), e.prepare(), e.drawImage(t), i.image = e, i.symbol && i.symbol.trigger(new a.AfterThumbnailUpdate(i.symbol, e));
          }
        };
      }
