...
function (e, t, i) {
  var n = i(391), r = i(0), o = i(11), a = i(182), s = i(1146), l = i(1416), h = i(1417), A = function (e, t) {
      if (t && t.transform && t.doc) {
        var i = t.doc, r = t.transform._ty, A = t.transform._tx;
        if (this.transform = t.transform, this.transform = this.transform.translated(-A, -r).scaled(1, -1).translated(A, i.relativeY(r)), this.isValid()) {
          ...
          var y = new a();
          y.push(!0), y.push(!0), this.put("/Coords", t.coords), this.put("/Extend", y), this.put("/Function", new n(m));
        }
      }
    };
