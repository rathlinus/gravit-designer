...
function (e, t, i) {
  var n = i(82), r = i(0), o = i(52), a = i(128), s = i(751), l = i(545), h = i(331), A = i(39);
  function c() {
  }
  r.inherit(c, A), c.options = { snapDistance: 5 }, c.prototype._manager = null, c.prototype.getCursor = function (e, t) {
    ...
    return (t instanceof a || t instanceof h || t instanceof l || t instanceof s) && (t.insertEditor(this), this.setFlag(A.Flag.Selected), this.requestInvalidation(), !0);
  }, c.prototype.deactivate = function () {
    this._parentEditor && (this.updatePartSelection(!1, null, !0), this.removeFlag(A.Flag.Selected), this.requestInvalidation(), this._parentEditor.removeEditor(this, !0)), this._manager.notifyDeactivated(this);
