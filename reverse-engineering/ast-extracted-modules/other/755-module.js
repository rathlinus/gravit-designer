...
function (e, t, i) {
  var n = i(64), r = i(150), o = i(0), a = i(52), s = i(6), l = i(77), h = i(363), A = i(211), c = i(24);
  function p() {
    A.call(this);
  }
  o.inherit(p, A), p.options = {
    ...
    if (this._hasDragArea()) {
      var t = Math.floor(this._dragArea.getX()), i = Math.floor(this._dragArea.getY()), n = Math.ceil(this._dragArea.getWidth()), r = Math.ceil(this._dragArea.getHeight());
      c.outlineWidth % 2 != 0 && (t += 0.5, i += 0.5, n -= 1, r -= 1), e.canvas.strokeRect(t, i, n, r, c.outlineWidth);
    }
    ...
    if (!this._dragArea || this._dragArea && this._dragArea.isEmpty()) {
      ...
      if (2 === this._zoomMode)
        t = h.options.maxZoomFactor;
      else if (-2 === this._zoomMode)
        t = h.options.minZoomFactor;
        ...
        if (p.options.zoomLevels)
          for (var r = p.options.zoomLevels, o = this._view.getZoom(), a = r.length - 1, s = 0; s < r.length; s++)
            if (o > r[s] && (i = r[s]), o < r[a - s] && (n = r[a - s]), o === r[s]) {
              i = s > 0 ? r[s - 1] : h.options.minZoomFactor, n = a > 0 ? r[s + 1] : h.options.maxZoomFactor;
              break;
            }
        t = 1 === this._zoomMode ? n || this._view.getZoom() * p.options.zoomStep : i || this._view.getZoom() / p.options.zoomStep;
      }
      if (null !== t) {
