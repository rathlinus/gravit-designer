...
function (e, t, i) {
  ...
  o.ColorSpace = {
    ...
    for (var e = 0; e < this._info._numberOfComponents; e++)
      this._writeByte(this._info._componentsId[e]), this._writeByte((this._info._hsampFactor[e] << 4) + this._info._vsampFactor[e]), this._writeByte(this._info._qtableNumber[e]);
    ...
    for (var e = 0; e < this._info._numberOfComponents; e++)
      this._writeByte(this._info._componentsId[e]), this._writeByte((this._info._dctableNumber[e] << 4) + this._info._actableNumber[e]);
  ...
  h.N = 8, h.prototype._divisors = null, h.prototype._quantum = null, h.prototype._divisorsLuminance = null, h.prototype._divisorsChrominance = null, h.prototype._YQT = null, h.prototype._UVQT = null, h.prototype._initMatrix = function (e) {
    ...
    for (t = 0; t < 8; t++)
      for (var r = 0; r < 8; r++)
        this._divisorsLuminance[n] = 1 / (this._YQT[n] * a[t] * a[r] * 8), n++;
    for (r = 0; r < 64; r++) {
    ...
    for (n = 0, t = 0; t < 8; t++)
      for (r = 0; r < 8; r++)
        this._divisorsChrominance[n] = 1 / (this._UVQT[n] * a[t] * a[r] * 8), n++;
    ...
    for (var t = this._bufferPutBuffer, i = this._bufferPutBits; i >= 8;) {
      var n = t >> 16 & 255;
    ...
    for (e = 0; e < this._numberOfComponents; e++)
      this._compWidth[e] = (this._imageWidth % 8 != 0 ? 8 * Math.ceil(this._imageWidth / 8) : this._imageWidth) / this._maxHsampFactor * this._hsampFactor[e], this._compWidth[e] != this._imageWidth / this._maxHsampFactor * this._hsampFactor[e] && (this._lastColumnIsDummy[e] = !0), this._blockWidth[e] = Math.ceil(this._compWidth[e] / 8), this._compHeight[e] = (this._imageHeight % 8 != 0 ? 8 * Math.ceil(this._imageHeight / 8) : this._imageHeight) / this._maxVsampFactor * this._vsampFactor[e], this._compHeight[e] != this._imageHeight / this._maxVsampFactor * this._vsampFactor[e] && (this._lastRowIsDummy[e] = !0), this._blockHeight[e] = Math.ceil(this._compHeight[e] / 8);
