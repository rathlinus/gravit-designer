...
function (e, t, i) {
  var n = i(5), r = i(75), o = i(0), a = i(72), s = i(363), l = i(24), h = i(6), A = i(11), c = i(7), p = i(540), u = i(12), d = i(81);
  function g(e) {
  ...
  o.inherit(g, r), g.options = {
    ...
    if (this._counter > 0 && (--this._counter, 0 == this._counter)) {
      if (this._visuals.length) {
        for (var e, t = null, i = null, r = null, o = null, a = null, s = function (e, n) {
              if (e && 2 == e.length)
                for (var a = 0; a < 2; ++a) {
                  ...
                  (null === t || t > A.getX()) && (t = A.getX()), (null === i || i > A.getY()) && (i = A.getY()), (null === r || r < A.getX() + A.getWidth()) && (r = A.getX() + A.getWidth()), (null === o || o < A.getY() + A.getHeight()) && (o = A.getY() + A.getHeight());
                }
        ...
        t -= d, i -= d, r += d, o += d, this._area = new h(t, i, r - t, o - i), a && (this._area = this._area.united(a)), this.invalidate(this._area);
      }
    ...
    for (var o, a = null, s = null, l = null, h = [], A = [], c = this._view.getScene().getActivePage(), p = this._isGuideEnabled(this._fullPixelsGuide), u = 0; u < this._guides.length && (null === a || null === s); ++u)
      if (o = this._guides[u], this.canMapGuide(o, i, t, p)) {
        ...
        (l = o.map(e.getX(), e.getY(), !0, g.options.snapDistance, this._view ? this._view.getLogicalZoom() : null, r)) && (l.x && null === a && (a = l.x.value, this._visuals && l.x.guide && (l.x.guide instanceof n ? (h.push(l.x.guide), A.push(d ? l.x.page ? l.x.page : c : null)) : this._visuals.push({
          guide: l.x.guide,
      ...
      if (x = this._guides[T], !(t && t.indexOf(x.getId()) < 0) && this.canMapGuide(x, t, null, E)) {
        for (var I = 0; I < p.length; ++I)
          if (x.snapZoneIsAllowed(c[I])) {
            var F = p[I];
            (S = x.map(F.getX(), F.getY(), !1, g.options.snapDistance, this._view ? this._view.getLogicalZoom() : null, i)) && (S.x && (d.length ? d[0].idx === T && null !== d[0].delta && null !== S.x.delta && S.x.delta < d[0].delta && (d[0] = A.extend({}, S.x, {
              idx: T,
              pivotIdx: I
            })) : d.push(A.extend({}, S.x, {
              idx: T,
        ...
        for (T = 0; T < this._guides.length && (!d.length || !f.length); ++T)
          if (x = this._guides[T], !(t && t.indexOf(x.getId()) < 0) && this.canMapGuide(x, t, null, E))
            for (I = 0; I < p.length; ++I)
              if (x.snapZoneIsAllowed(c[I])) {
                F = p[I];
                if (S = x.map(F.getX(), F.getY(), !1, g.options.snapDistance, this._view ? this._view.getLogicalZoom() : null, i)) {
    ...
    var p = function (i, n, r, o) {
        ...
        t.canvas.strokeLine(Math.floor(a.getX()) + A, Math.floor(a.getY()) + A, Math.floor(s.getX()) + A, Math.floor(s.getY()) + A, l.outlineWidth, h, !1), i[0].pt && d.paintAnnotation(t, null, a, i[0].annot, !1, i[0].size, h, h), i[1].pt && d.paintAnnotation(t, null, s, i[1].annot, !1, i[1].size, h, h);
      ...
      if (r = this._visuals[h].guide, o = this._visuals[h].page, r instanceof Array)
        ...
        if (r.valueSegments && r.valueSegments.length) {
          ...
          for (y = 0; y < r.valueSegments.length; ++y) {
            ...
            ], o, !1), null != v.value && u && u.paintDistanceHint(v.value, v.valuePt, v.valueDir, _, t, l.distanceHelperColor);
          }
        }
      }
    this._visuals = [];
