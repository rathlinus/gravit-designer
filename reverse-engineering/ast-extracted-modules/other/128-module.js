...
function (e, t, i) {
  var n = i(82), r = i(50), o = i(0), a = i(28), s = i(56), l = i(36), h = i(70), A = i(268), c = i(95), p = i(274), u = i(7), d = i(39), g = i(24), f = (i(11), i(9)), m = i(47);
  function y(e) {
    p.call(this, e);
  }
  o.inherit(y, p), y.prototype.initialSetup = function (e) {
    ...
    if (!(e && e instanceof s) || e instanceof c || this.getElement() instanceof A && !(e instanceof A) || !(this.getElement() instanceof h) && e instanceof h || (t = e), t) {
      var i, n, r, o, l, p, u = this.getElement(), d = [], g = [], f = t.getProperty("ps") || [a.PropertySet.Style], m = [
          "geometryProperties",
          "visualProperties"
        ];
    ...
    if (this.hasFlag(d.Flag.Selected) && this.hasFlag(d.Flag.Detail) && this._hasCenterCross() && g.centerCrossSize > 0) {
      var i = this.getPaintElement(), n = i.getTransform(), r = n || new u(1, 0, 0, 1, 0, 0);
    ...
    if (this._elementPreview) {
      var t = this._element.getTransform(), i = this._elementPreview.getTransform();
