...
function (e, t, i) {
  var n = i(179), r = i(2), o = i(236), a = i(0), s = i(60), l = i(162), h = i(56), A = i(52), c = (i(73), i(70)), p = i(5), u = i(24), d = i(6), g = i(215), f = i(113), m = i(7), y = i(45), _ = i(548), v = i(95), b = i(9), C = i(47), w = i(416), E = i(108);
  function B() {
    o.call(this, !0, !0);
  }
  i(387), a.inherit(B, o), B.prototype._textUnderMouse = null, B.prototype._pathUnderMouse = null, B.prototype._pathHit = null, B.prototype._justCreatedText = null, B.prototype._defaultMeasure = null, B.prototype.deactivate = function (e, t) {
    ...
    if (this._textUnderMouse && (this._textUnderMouse = null, this.updateCursor()), this._pathUnderMouse && (this._pathUnderMouse.removeFlag(r.Flag.Highlighted), this._pathUnderMouse = null), !this._shape) {
      var t = this._scene.hitTest(e.client, this._view.getWorldTransform(this._scene), null, !1, -1, 0, !1, null, !1, !1, this._view.getViewConfiguration().multiPageView);
      t && t.length && t[0].element instanceof c && t[0].element instanceof s || (t = this._scene.hitTest(e.client, this._view.getWorldTransform(this._scene), null, !1, -1, u.pickDistance, !1, null, !1, !1, this._view.getViewConfiguration().multiPageView)), t && t.length && (t[0].element instanceof c ? (this._textUnderMouse = t[0].element, this.updateCursor()) : !(t[0].element instanceof h) || t[0].element instanceof v || t[0].element instanceof f || t[0].element instanceof l || null === t[0].data.vertex.x || (this._pathUnderMouse = t[0].element, this._pathHit = new p(t[0].data.vertex.x, t[0].data.vertex.y), this._pathUnderMouse.setFlag(r.Flag.Highlighted)));
    }
    ...
    return !!t && (n ? e.setProperty("trf", new m(t.getWidth(), 0, 0, t.getHeight(), t.getX(), t.getY())) : e.setProperty("trf", new m(t.getWidth() / 2, 0, 0, t.getHeight() / 2, t.getX() + t.getWidth() / 2, t.getY() + t.getHeight() / 2)), !0);
  }, B.prototype._insertShape = function (e, t) {
    var i = !1;
    if (t)
      e && (this._fakeShape = e, o.prototype._insertShape.call(this, e, !1, !0));
    else {
      if (this._fakeShape) {
    ...
    try {
      if (this._editor.beginTransaction(), this._insertText(t, !0), this._pathUnderMouse) {
        ...
        if (this._pathUnderMouse instanceof y)
          ...
          var l = o.getParent(), h = o.getNext(!0);
    ...
    if (!this._defaultMeasure) {
      var t = this._scene && this._scene.getWorkspace(), i = t && t.getFontManager();
      if (i) {
        var n = [];
