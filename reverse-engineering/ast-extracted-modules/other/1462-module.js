...
function (e, t, i) {
  ...
  r.Type = {
    ...
    if (0 != this.filters.length || 0 != this.fill_opacity) {
      var t = e.ownerDocument.createElementNS("http://www.w3.org/2000/svg", "filter");
      e.appendChild(t), this.id && t.setAttribute("id", this.id), t.setAttribute("x", this._x), t.setAttribute("y", this._y), t.setAttribute("width", this._width), t.setAttribute("height", this._height), t.setAttribute("filterUnits", this._filterUnits), t.setAttribute("color-interpolation-filters", "sRGB");
