...
function (e, t, i) {
  ...
  s.createFontFromArrayBuffer = function (e) {
    ...
    for (var t = Object.keys(e), i = Object.values(e), n = o._malloc(8 * e.length), r = 0; r < t.length; r++) {
      var s = a.apply(null, t[r].split("")), l = i[r];
    ...
    for (var i = o._hb_buffer_get_length(e._hbBuffer), n = o._hb_buffer_get_glyph_infos(e._hbBuffer, 0), r = o._hb_buffer_get_glyph_positions(e._hbBuffer, 0), a = [], l = 0; l < i; l++) {
