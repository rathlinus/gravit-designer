...
function (e, t, i) {
  ...
  o.inheritAndMix(C, p, [b]), C.prototype._isDragging = !1, C.prototype._dragStart = null, C.prototype._dragStartOrig = null, C.prototype._dragCurrent = null, C.prototype._dragCurrentOrig = null, C.prototype._keepRatio = !1, C.prototype._fromCenter = !1, C.prototype._shape = null, C.prototype._dragArea = null, C.prototype._dragLine = null, C.prototype._movePosition = null, C.prototype._hasCreatedShape = !1, C.prototype.getCursor = function () {
    ...
    if (!this._hasCreatedShape) {
      ...
      this._editor.getGuides().beginMap(this._editor.getMappingScopes()), t = this._editor.getGuides().mapPoint(t, null, this._getExclusions()), this._editor.getGuides().finishMap(), this._createShapeManually(t);
    }
    this._hasCreatedShape = !1, this._manager.notifyJobDone(this);
  }, C.prototype._mouseDragStart = function (e) {
    this._hasCreatedShape = !1, this._isDragging = !0, this.beginPan(), this._dragStart = this._view.getViewTransform(this._view.getScene().getActivePage()).mapPoint(e.client), this._editor.getGuides().beginMap(this._editor.getMappingScopes()), this._dragStart = this._editor.getGuides().mapPoint(this._dragStart, null, this._getExclusions()), this._editor.getGuides().finishMap(), this._shape = this._createShape(), this._invalidateShape(), this._hasCreatedShape = this._insertShape(this._shape, !0);
    ...
    var t = this._shape;
    if (this._shape = null, this._dragStart = null, this._dragCurrent = null, this._shape = null, this._dragArea = null, this._dragLine = null, this._dragStartOrig = null, this._dragCurrentOrig = null, this._isDragging = !1, this.updateCursor(), this.updateInlineHint(null), !this._hasCreatedShape && t)
      ...
      var i = g.getEditor(t);
      i && i.removeOutlineTmpFlag(), t._notifyChange(f._Change.FinishGeometryUpdate, 1);
    }
    ...
    if (this._movePosition) {
      ...
      var e = this._editor.getGuides().mapPoint(this._movePosition, null, this._getExclusions());
      if (this._editor.getGuides().finishMap(), c.showTooltips && c.coordinatesTooltip && this._showMousePositionInlineHint()) {
        var t = this._scene.pointToString(e.getX(), c.tooltipDecimalPlaces) + ", " + this._scene.pointToString(e.getY(), c.tooltipDecimalPlaces);
    ...
    if (this._dragStart && this._dragCurrent) {
      ...
      var e = this._editor.getGuides().mapPoint(this._dragCurrent, null, this._getExclusions());
      if (this._editor.getGuides().finishMap(), !A.equals(this._dragStart, e)) {
        var t = this._dragStart.getX(), i = this._dragStart.getY(), r = e.getX(), o = e.getY(), s = r, l = o;
        if (this._keepRatio && n.modifiers.shiftKey) {
          var h = r < t ? -1 : 1, p = o < i ? -1 : 1;
          (m = Math.abs(r - t)) >= (y = Math.abs(o - i)) ? (r = t + m * h, o = i + m * p, l = m < 2 * y ? o : i) : (r = t + y * h, o = i + y * p, s = y < 2 * m ? r : t);
        }
        var d = null, g = null;
        if (this._fromCenter && n.modifiers.optionKey ? (d = u.fromPoints(new A(t - (r - t), i - (o - i)), new A(t + (r - t), i + (o - i))), g = [
            new A(t - (s - t), i - (l - i)),
            new A(t + (s - t), i + (l - i))
          ]) : (d = u.fromPoints(new A(t, i), new A(r, o)), g = [
            new A(t, i),
            new A(s, l)
          ]), this._dragArea = d, this._dragLine = g, this._updateShape(this._shape, d, g, !0), c.showTooltips && c.sizeTooltip && this._showAreaInlineHint()) {
          var f = null;
          if (this._dragArea) {
    ...
    if (e && e.getParent())
      return !1;
    if (i)
      this._editor.insertElements([e], !1, !!i, !0);
    else
      try {
