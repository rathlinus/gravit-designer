...
function (e, t, i) {
  var n = i(166), r = n.MAX_TIME_PER_JOB, o = i(111), a = i(205), s = i(898), l = i(470), h = 0;
  ...
  d._enabled = !0, d._debugEnabled = !1, d._debugPhase = !1, d._multiThreading = !1, d.DUMP_IMAGES = !0, d._renderPhase = !1, d._toInitialize = [], d._toInitializeWorkers = new Array(h), d._renderParameters = {}, d._renderJobs = [], d._scheduledRenderings = null, d.begin = function (e) {
    o.getPreservedContexts().forEach(function (e) {
      o.syncContext(e);
    }), this._renderPhase = !0, this._debugEnabled ? this._debugPhase = !0 : n.WORKER_RENDERING_ENABLED && e && "undefined" != typeof OffscreenCanvas ? this._multiThreading = !!e : this._multiThreading = !1;
  }, d.finish = function () {
    ...
    if (e.__multiThreaded) {
      ...
      }), o.dispose(e), this._toInitializeWorkers[t] = [], this._toInitialize = [];
    }
    ...
    var c, u, g, f, m, v, b, C = o.getLen(e), w = 0, E = (t = t || 0, new Array(15)), B = !1, x = !0, P = a && a.resuming;
    if (!this._enabled) {
    ...
    if (P)
      w = (m = a.popSave()).execPtr, C = m.len, u = m.op, E = m.params || new Array(15), g = m.funcName, f = m.funcOp, c = m.realCtx, v = m.numParams, a.hasSave() || (a.reset(), P = !1, m = null);
    else {
      if (!(c = o.initializeContext(e, 0 === t)))
        return 0 === t ? (a.exiting = !1, delete this._renderJobs[a.getId()], i && i(e.canvas.$realCanvas, !0), e.canvas.$realCanvas) : null;
    ...
    for (; w < C;) {
      ...
      for (;;) {
        ...
        if (m)
          ...
          return _("Renderer: invalid value in stack", 2), a.exiting = !1, o.forceRestore(e), 0 === t && i && i(e.canvas.$realCanvas, !0, !0), e.canvas.$realCanvas;
        if ("number" == typeof M);
        else {
          if (M === o.EXEC_TYPE) {
            u = o.EXEC;
          ...
          if (M && M.$type === o.INSTANCE_RENDERERCANVAS) {
            ...
            if (!M.rendered && !M.rendering || P) {
              if (a.parameters.quickRender && t > 0 || a.parameters.noWebGL && "webgl" === M.parent.__contextType ? B = !0 : (M = this.render(M.parent, t + 1, null, a), "_flush" !== g && (M ? M instanceof HTMLCanvasElement && M.width * M.height == 0 && (B = !0, x = !1, _("Error: canvas was empty, skipping draw", 2)) : (B = !0, x = !1))), a.exiting)
                return w = e.__execPtr, o.clearPrevious(e), a.pushSave({
                  ...
                  funcOp: f,
                  val: N
                }), 0 === t && (a.exiting = !1, i && i(e.canvas.$realCanvas, !1, B || a.skipped, a.parameters)), null;
            } else
              M = M.$realCanvas || M.$renderedBitmap, "_flush" !== g && (M ? M instanceof HTMLCanvasElement && M.width * M.height == 0 && (B = !0, x = !1, _("Error: canvas was empty, skipping draw", 2)) : (B = !0, x = !1, _("Error: canvas is null", 2)));
          } else
            M && M.$type === o.INSTANCE_RENDERABLE && (a.lock(), M = M.render(this, t + 1, a), a.unlock(), void 0 === M && (B = !0));
        }
        E[v++] = M;
      }
      if (u === o.EXEC)
      ...
      if (w = e.__execPtr, !P && a.isExpired()) {
        ...
        return o.clearPrevious(e), a.hasSave() && _("Renderer: exiting render loop without reaching save location", 2), a.pushSave({
          ...
          execPtr: w,
          resumeLocation: 2
        }), d._scheduleRender(a), 0 === t && i && i(e.canvas.$realCanvas, !1, a.skipped, a.parameters), a.exiting = !0, null;
      }
    }
    e.canvas.rendering = !1;
    var U = e.canvas.$realCanvas;
    if (o.finished(e) ? (e.canvas.rendered = !0, o.dispose(e)) : o.clearPrevious(e), 0 === t && (a.disposeRenderables(), a.exiting = !1, delete this._renderJobs[a.getId()], n.AGGRESIVE_MEMORY_SWEEPER && l.destroyTextures(), i && (i(e.canvas.$realCanvas, !0, a.skipped, a.parameters), d._scheduledRenderings && d._scheduledRenderings.length))) {
    ...
    var t = this._renderJobs[e.__contextId];
    t && null !== t.timeout && (u(t.timeout), t.timeout = null), o.forceRestore(e), o.dispose(e), t && (t.disposeRenderables(), t.exiting = !1, delete this._renderJobs[t.getId()]), n.AGGRESIVE_MEMORY_SWEEPER && l.destroyTextures();
  ...
  d.dumpCode = function (e, t, i, n) {
    ...
    0 !== (i = e.canvas.renderingName || e.canvas.renderedName ? parseInt((e.canvas.renderingName || e.canvas.renderedName).match(/[0-9]+$/)[0]) : null === i ? ++m : i || 0) || e.canvas.rendering || f > 0 && (g = !0);
    ...
    return e.canvas.rendering = !1, o.finished(e) && (e.canvas.renderedName = e.canvas.renderingName, e.canvas.renderingName = null), h;
