...
function (e, t, i) {
  var n = i(0), r = i(36), o = i(66), a = i(39), s = i(274), l = i(22), h = i(122), A = i(70), c = i(7), p = i(24);
  function u(e) {
    s.call(this, e);
  }
  n.inherit(u, s), r.exports(u, h), u.prototype._paintOutline = function (e, t, i, n, r) {
    ...
    if (!this._transform.isIdentity()) {
      ...
      for (var a = e.getProperty("frm"), s = e.getFirstChild(); null != s; s = s.getNext())
        if (s instanceof l && (!i || i.indexOf(s) < 0) && (!a || t || s.hasMixin(l.Transform) && !s.getProperty("hacr") && !s.getProperty("vacr"))) {
          ...
          A.fullContentsTransform = !!t, s.dependentUpdate = !0, h.edTransform(this._transform, null, null, A), h.applyTransform(s, t, i, n), s.dependentUpdate = !1;
        }
      e.endUpdate();
    }
    ...
    for (var i = o.prototype._getBBox.call(this, e, t), n = this.getElement().getFirstChild(); null != n; n = n.getNext())
      if (n instanceof A) {
        var a = r.getEditor(n);
        if (a) {
