...
function (e, t, i) {
  i(561);
  var n = i(1135), r = i(1141), o = i(160), a = i(70), s = i(280), l = i(1140), h = i(1139), A = i(1142), c = i(640), p = i(0), u = i(75), d = i(794), g = i(1401).Inflater, f = i(1402).zip;
  function m(e) {
  ...
  f.Inflater = g, f.useWebWorkers = !1, p.inherit(m, u), m.prototype._promise = null, m.prototype._promiseCapability = null, m.prototype._data = null, m.prototype._pages = null, m.prototype._document = null, m.prototype._symbolsMaster = null, m.prototype._symbolsInstance = null, m.prototype._objects = null, m.prototype._reader = null, m.prototype._entries = null, m.prototype._fontSearch = null, m.prototype._progress = null, m.prototype._objectsTotal = 0, m.prototype._objectsProcessed = 0, m.prototype._ignoreSymbolPage = !1, m.prototype._progressStage = 0, m.prototype._progressValue = 0, m.prototype._blockedEvents = null, m.prototype.canEventBeSent = function (e) {
    ...
    if (e.layers)
      for (var t = 0; t < e.layers.length; t++)
        if (this._isSymbolPage(e.layers[t]))
          return !0;
    return !1;
    ...
    if (!this._promise) {
      ...
      try {
        ...
        var e = [], t = [], i = new o(this._workspace, !0), r = new c();
