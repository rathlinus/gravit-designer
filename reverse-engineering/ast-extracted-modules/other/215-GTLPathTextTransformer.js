...
function (e, t, i) {
  var n = i(0), r = i(140), o = i(650), a = i(5), s = i(6), l = i(48), h = i(651), A = i(187), c = i(7), p = i(12);
  function u(e, t, i) {
  ...
  n.inherit(u, o), u.TYPE = "path", u.OUTSIDE = 1, u.INSIDE = -1, u.DIRECTION_OUTWARDS = 0, u.DIRECTION_INWARDS = 1, u.MIN_SPATH_LEN = 1, u.TransformerParams = {
    ...
    var i, n = 8, s = e.getX(), l = e.getY(), h = {}, c = !1, u = -1, d = this._basePath._calculateGeometryBBox();
    for (s += d.getX(), l += d.getY(); n < 1 << 20 && !c;) {
      for (var g in ((i = new A.PolyLine()).x = s - n / 2, i.y = l - n / 2, i.width = n, i.height = n, this._qtrees)) {
        ...
        if (m && m.length && (c = !0, h[g] ? Array.prototype.push.apply(h[g], m) : h[g] = m), t)
          break;
      }
      n <<= 1;
    }
    ...
    if (0 !== e) {
      ...
      r = this._basePath;
    return this._polys[e] = A.polyFromVertexSource(r, !1, !1), o = this._generateDistancesFilterSubpaths(e), this._qtrees[e] = A.quadTreeFromPolygon(o), o;
