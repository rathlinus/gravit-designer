...
function (e, t, i) {
  ...
  r.options = {
    ...
    for (var t = null, i = [], n = null, o = 0; o < this._rects.length; o++) {
      var a = e.intersected(this._rects[o]);
      a.isEmpty() || (i.push(a), n = null === n ? a : n.united(a));
    }
    if (n && !n.isEmpty()) {
      (t = new r.Matcher())._unitedArea = n, t._rects = new Array(i.length);
    ...
    if (this._rects && this._rects.length > 0)
      for (var t = 0; t < this._rects.length; ++t) {
        if (this._rects[t].intersectsRect(e))
          return !0;
      }
    return !1;
    ...
    if (this._numDirties > 0) {
      ...
      for (var t = 0, i = 0; i < this._numDirties; ++i) {
        ...
        if (o && o[2] > 0 && o[3] > 0) {
          ...
          e._rects[t++] = a, null == e._unitedArea ? e._unitedArea = a : e._unitedArea = e._unitedArea.united(a);
        }
      }
