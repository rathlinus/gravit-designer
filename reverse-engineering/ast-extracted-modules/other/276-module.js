...
function (e, t, i) {
  var n = i(82), r = i(138), o = i(2), a = i(83), s = i(0), l = i(28), h = i(11), A = i(56), c = i(122), p = i(24), u = i(6), d = i(160), g = i(7), f = i(385), m = i(12), y = i(64), _ = i(81), v = i(5), b = i(52), C = i(39), w = i(17), E = i(14), B = i(9), x = i(47);
  function P() {
    f.call(this);
  }
  s.inherit(P, f), P.DEFAULT_EPS = 0.000001, P.STOP_HANDLE_PART_ID = h.uuid(), P.PLUS_STOP_PART_ID = h.uuid(), P.alignHandlePoint = function (e, t) {
  ...
  }, P.prototype._gradient = null, P.prototype._componentOfEffect = !1, P.prototype._propName = null, P.prototype._propHolder = null, P.prototype._snapPoints = null, P.prototype.activate = function (e) {
    if (e.propName && e.propHolder instanceof o) {
      var t = e.propHolder.getProperty(e.propName, !1, null, e.propTemporary);
      if (t instanceof r)
        return this._propName = e.propName, this._propHolder = e.propHolder, this._gradient = t.clone(), this._componentOfEffect = e.propHolder instanceof l.Effect, this._snapPoints = null, f.prototype.activate.call(this, e);
    }
    return !1;
  }, P.prototype.deactivate = function () {
    f.prototype.deactivate.call(this), this._gradient = null, this._propName = null, this._propHolder = null, this._componentOfEffect = !1, this._snapPoints = null;
    ...
    this._manager.preparePermanentChange(), this._snapPoints = null, this._propHolder.setProperty(this._propName, this._gradient.clone(), !1, !1, !1), f.prototype._applyPartMove.call(this, e, t, i, n);
    ...
    if (n && n.type === P.PLUS_STOP_PART_ID) {
      ...
      n = (r = new C.PartInfo(this, {
        ...
        idx: l
      }, { noEditorSelectionChangedEvent: !0 }, !0, !0)).id, P.prototype.updatePartSelection.call(this, !1, [r.id], i);
    } else
      f.prototype.updatePartSelection.call(this, !1, n ? [n] : null);
    ...
    var o = i.size / 2;
    t.canvas.strokeLine(n - o, r - o, n + o, r + o, i.outlineWidth + 2 * E.getScreenDPI(), new w(w.parseCSSColor(i.lineShadowColor)), !1, 0.6), t.canvas.strokeLine(n + o, r - o, n - o, r + o, i.outlineWidth + 2 * E.getScreenDPI(), new w(w.parseCSSColor(i.lineShadowColor)), !1, 0.6), t.canvas.strokeLine(n - o, r - o, n + o, r + o, i.outlineWidth, w.WHITE), t.canvas.strokeLine(n + o, r - o, n - o, r + o, i.outlineWidth, w.WHITE);
    ...
    var a = new w(t[0].color.getValue()), s = t[0].opacity;
    if (i && n) {
      var l = n.position - i.position, h = l ? (e - i.position) / l : 1, A = l ? (n.position - e) / l : 0, c = i.color.getValue(), p = n.color.getValue(), u = i.opacity, d = n.opacity;
      a = new w([
      ...
      n || (a = new w(t[t.length - 1].color.getValue()), s = t[t.length - 1].opacity);
    return {
      position: e,
      color: a,
      opacity: s
    ...
    if (t && t.length && e && e.type == P.STOP_HANDLE_PART_ID && null != e.idx && e.idx < t.length && this._partSelection && this._partSelection.length && this._partIdAreEqual(e, this._partSelection[0])) {
      ...
      for (var n = 0; n < t.length; ++n)
        t[n] == i && n != e.idx && (e.idx = n, this._partSelection[0].idx = n);
    }
