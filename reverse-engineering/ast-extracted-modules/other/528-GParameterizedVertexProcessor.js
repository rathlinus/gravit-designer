...
function (e, t, i) {
  var n = i(48), r = i(54), o = i(5), a = i(11);
  function s(e, t, i, n) {
    t && t.length && i && i.length ? (this._annotationsName = e, this._initAnnotationsFuncs(t), this._initParametersFuncs(i), this._parametersFuncs && this._parametersFuncs.length && (this._initAnnotationsList = a.extend(!0, [], t), this._initParametersList = a.extend(!0, [], i))) : (this._annotationsName = null, this._annotationsFuncs = null, this._parametersFuncs = null), this._initVertices(n), this._initVerticesList = a.extend(!0, [], n);
  }
  s.CoordType = {
    Direct: 1,
    Expression: 2
    ...
    if (e) {
      ...
      if (i && i instanceof Array && i.length > 1) {
        var n = i[0], r = i[1], o = null, a = null;
        4 == i.length && (o = i[2], a = i[3]), t = new s(n, o, a, r);
      }
    }
    return t;
    ...
    try {
      ...
      for (l = 0; l < this._vertices.length; ++l) {
        ...
        if (u != n.Command.Close) {
          var d = p.tx == s.CoordType.Direct ? p.x : p.x.apply(null, i), g = p.ty == s.CoordType.Direct ? p.y : p.y.apply(null, i);
          t.addVertex(u, d, g);
        } else
    ...
    if (e && e.length)
      for (var t = [
        ...
        var n = e[i], r = null, o = null;
        if (r = "number" == typeof n.X ? function (e, t, i) {
            return e;
          }.bind(null, n.X) : this._getExprFunction(n.X, t, n.minX, n.maxX), o = "number" == typeof n.Y ? function (e, t, i) {
            return e;
          }.bind(null, n.Y) : this._getExprFunction(n.Y, t, n.minY, n.maxY), null === r || null === o)
    ...
    if (t) {
      ...
      t = t.replace(new RegExp(i, "g"), "Math.$1("), i = "(" + s.SUPPORTED_MATH_FUNCS2 + ")\\(", t = t.replace(new RegExp(i, "g"), "Math.$1(");
    }
    return t;
    ...
    if (e) {
      ...
      for (this._vertices = []; t < e.length;) {
        ...
        case n.Command.Curve2:
          if (t + 4 < e.length) {
            var r = e[t + 1], o = e[t + 2], a = e[t + 3], s = e[t + 4], l = this._getCoordVal(o, r), h = this._getCoordVal(s, a);
