...
function (e, t, i) {
  ...
  function a(e) {
    ...
    case 2:
      for (this.names = new Array(e.numberOfGlyphs), i = 0; i < e.numberOfGlyphs; i++)
        e.glyphNameIndex[i] < t.standardNames.length ? this.names[i] = t.standardNames[e.glyphNameIndex[i]] : this.names[i] = e.names[e.glyphNameIndex[i] - t.standardNames.length];
      break;
    case 2.5:
      for (this.names = new Array(e.numberOfGlyphs), i = 0; i < e.numberOfGlyphs; i++)
  ...
  n.prototype.charToGlyphIndex = function (e) {
    ...
    "ccaron",
    "dcroat"
  ], t.DefaultEncoding = n, t.CmapEncoding = r, t.CffEncoding = o, t.GlyphNames = a, t.addGlyphNames = function (e) {
    ...
    for (r = 0; r < e.glyphs.length; r += 1)
      t = e.glyphs.get(r), e.cffEncoding ? e.isCIDFont ? t.name = "gid" + r : t.name = e.cffEncoding.charset[r] : e.glyphNames.names && (t.name = e.glyphNames.glyphIndexToName(r));
  };
}
