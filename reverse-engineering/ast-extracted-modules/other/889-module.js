...
function (e, t, i) {
  var n = i(633), r = i(261), o = i(636), a = i(637), s = i(634), l = i(455), h = i(635), A = i(890), c = i(638), p = i(639), u = i(632);
  function d() {
  ...
  r.inheritAndMix(d, r), d.prototype._language = 0, d.prototype._project = null, d.prototype._extensionEnabled = !1, d.prototype._checkStrict = !1, d.prototype._supportedISO6391Locales = [
    "en",
    "de",
    "zh",
    "pt",
    ...
    for (var i = this.getAvailableKeys(e), n = {}, r = 0; r < i.length; r++) {
      var o = i[r];
    ...
    if (e && this._project) {
      var t = this._translationInstance.getByProject(this._project).find(function (t) {
        return t.keyValue == e;
      });
      if (t && t.abbreviation)
        return t.abbreviation.toLowerCase();
    }
    switch (e) {
    case o.English:
      return "en";
