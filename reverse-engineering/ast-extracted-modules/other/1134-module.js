...
function (e, t, i) {
  var n = i(60), r = i(113), o = i(45), a = i(2), s = i(5), l = i(12), h = i(1127), A = {
      Straight: 1,
      Mirror: 2,
      Symmetric: 3,
      Asymmetric: 4
  ...
  c.generatePath = function (e, t, i, s, l) {
    ...
    if (e.points.forEach(function (e, i) {
        ...
        case A.Straight:
          p || (p = new n(), u = p.getAnchorPoints(), p.setSketchPath(!0), f(p), f(u)), (d = new o.AnchorPoint()).setProperties([
            "x",
            "y",
            "tp"
          ], [
      ...
      }), p && i && p.setProperty("closed", !0), p && u && u.getFirstChild() != u.getLastChild() && (p.correctClosedAttribute(), g.push(p)), g.forEach(function (e) {
