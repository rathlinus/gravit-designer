...
function (e, t, i) {
  var n = i(267), r = i(230), o = i(0), a = i(918);
  ...
  o.inherit(s, n), s.prototype.frame = function (e, t) {
  ...
  }, s.prototype._currLength = 0, s.prototype._currHeight = 0, s.prototype.lines = null, s.prototype.wrapper = null, s.prototype._parent = null, s.prototype.ordinal = 0, s.prototype.height = void 0, s.prototype.length = void 0, s.prototype._realBounds = null, s.prototype._bboxSpacing = null, s.prototype._topMargin = void 0, s.prototype._bottomMargin = void 0, s.prototype.realBounds = function () {
    if (null === this._realBounds) {
      for (var e = Number.MAX_VALUE, t = Number.MAX_VALUE, i = -Number.MAX_VALUE, n = -Number.MAX_VALUE, o = 0; o < this.lines.length; o++) {
        var a = this.lines[o];
        if ("line" === a.type)
          t = Math.min(t, a.baseline + a.minY), e = Math.min(e, a.minX), n = Math.max(n, a.baseline + a.maxY), i = Math.max(i, a.maxX);
        else {
          var s = a.bounds(!0);
          t = Math.min(t, s.t), e = Math.min(e, s.l), n = Math.max(n, s.b), i = Math.max(i, s.r);
        }
      }
      e === Number.MAX_VALUE || t === Number.MAX_VALUE || i === -Number.MAX_VALUE || n === -Number.MAX_VALUE ? this._realBounds = new r(0, 0, 0, 0) : this._realBounds = new r(e, t, i - e, n - t);
    }
    ...
    if (void 0 === this._bottomMargin && (this._bottomMargin = NaN, this.lines.length))
      for (var e = this.bounds(), t = e.t + e.h, i = this.lines.length - 1; i >= 0; i--) {
        var n = this.lines[i], r = n.maxY;
        if (Number.isNaN(r))
          console.log();
    ...
    if (!this._bounds || e) {
      for (var t = 0, i = 0, n = 0, o = 0, a = 0; a < this.lines.length; ++a) {
        var s = this.lines[a].bounds(e);
        0 === a ? (t = s.l, i = s.t, n = s.l + s.w, o = s.t + s.h) : (e && (t = Math.min(t, s.l), i = Math.min(i, s.t)), n = Math.max(n, s.l + s.w), o = Math.max(o, s.t + s.h));
      }
      var l = o - i;
      l || e || (l = this.height);
    ...
    if (!this._actualWidth) {
      ...
      this.lines.forEach(function (t) {
        "number" == typeof t.actualWidth && (e = Math.max(e, t.actualWidth));
      }), this._actualWidth = e;
    }
    ...
    if (t && t.length) {
      ...
      t.forEach(function (t) {
        if (i || (i = t), i.actualWidth < t.actualWidth)
          i = t;
        else if (i.actualWidth === t.actualWidth) {
          var n = i.getLastValidCharSpacing(), r = t.getLastValidCharSpacing();
          r > n && (i = t, e = r);
        }
  ...
  }, s.prototype.type = "frame", e.exports = s;
}
