...
function (e, t, i) {
  ...
  r.ActionType = {
  ...
  }, r.prototype._transactionActions = null, r.prototype._debugOn = !1, r.prototype._debugBugged = !1, r.prototype.getDebugBugged = function () {
    ...
    !o && this._transactionActions && (this._transactionActions.push({
      ...
      action: function () {
        var t = !1;
        e.isRecordedTransaction && "function" == typeof e.isRecordedTransaction && !e.isRecordedTransaction() && (e.recordedTransaction = !0, t = !0), e.setProperties(this.properties, this.values, this.custom), t && (e.recordedTransaction = !1);
      },
      revert: function () {
        var t = !1;
        e.isRecordedTransaction && "function" == typeof e.isRecordedTransaction && !e.isRecordedTransaction() && (e.recordedTransaction = !0, t = !0), e.setProperties(this.properties, this.oldValues, this.custom), t && (e.recordedTransaction = !1);
      }
      ...
      this._transactionActions.push({
        ...
        action: function () {
          if (this.withInvalidation) {
            var t = !1;
            e.isRecordedTransaction && "function" == typeof e.isRecordedTransaction && !e.isRecordedTransaction() && (e.recordedTransaction = !0, t = !0), e._notifyChange(o._Change.PrepareGeometryUpdate), t && (e.recordedTransaction = !1);
          }
        ...
        revert: function () {
          if (e._endBlockChanges(this.changes), this.withInvalidation) {
            var t = !1;
            e.isRecordedTransaction && "function" == typeof e.isRecordedTransaction && !e.isRecordedTransaction() && (e.recordedTransaction = !0, t = !0), e._notifyChange(o._Change.FinishGeometryUpdate, this.noGeometryInvalidation ? -1 : 0), e.hasMixin(o.Accelerated) && e._updateQTree(), t && (e.recordedTransaction = !1);
          }
        }
