...
function (e, t, i) {
  ...
  o.SortOperators = {
    ...
    var i = !1, n = null, r = 1;
    "boolean" == typeof e ? (i = e, n = t || {}, r = 2) : (i = !1, n = e || {}), "object" != typeof n && "function" != typeof n && (n = {});
  ...
  o.uuid = function (e) {
    ...
    for (var e = new Float32Array(arguments.length), t = new Uint8Array(e.buffer), i = 0; i < arguments.length; i++) {
      var n = arguments[i];
      e[i] = n;
    }
    return btoa(String.fromCharCode.apply(null, t));
  }, o.unpackNumbers = function (e) {
    for (var t = [], i = new Float32Array(1), n = new Uint8Array(i.buffer), r = atob(e), o = 0; o < e.length; o += 4)
      n[0] = r.charCodeAt(o), n[1] = r.charCodeAt(o + 1), n[2] = r.charCodeAt(o + 2), n[3] = r.charCodeAt(o + 3), t.push(i[0]);
    return t;
  };
  ...
  o.packPoint = function (e, t) {
    ...
    if ("function" == typeof TextEncoder) {
      for (var i = [], n = new TextEncoder("utf-8").encode(e), r = 0, o = n.byteLength; r < o; r++)
