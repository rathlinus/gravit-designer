...
function (e, t, i) {
  ...
  o.OperatingSystem = {
    ...
    Tablet: 20,
    Phone: 30
  }, o.littleEndian = !0, o.operatingSystem = null, o.hardware = null, o.language = null, o.littleEndian = (n = new ArrayBuffer(8), new Uint32Array(n)[1] = 168496141, !(10 === n[4] && 11 === n[5] && 12 === n[6] && 13 === n[7])), o.hardware = function () {
    ...
    try {
      var e = [
        ...
        ], t = new r({ device: e }).getResult(), i = t && t.device, n = i && i.type;
      if (n) {
        if ("tablet" === n)
