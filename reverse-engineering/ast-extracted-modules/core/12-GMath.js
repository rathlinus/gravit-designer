...
function (e, t, i) {
  ...
  r.PI2 = 2 * Math.PI, r.PIHALF = 0.5 * Math.PI, r.defaultEps = 1e-14, r.toRadians = function (e) {
    ...
    if (g = e, f = t, 3 == a)
      ...
      if (b = !1, C = !1, i < 0 && n > 0 || i > 0 && n < 0 ? C = !0 : A && c && (b = !0), _ = !0, !1, r.getCubicRoots(l, e, t, D, !1, h), P = 0, 0 == D.length)
        g = e, F[0] = i, f = t, F[1] = n, b && (I[0] = c[0], I[1] = c[1]);
      else
        for (r.uSortSegment(e, t, D, R), g = e, F[0] = i, b && (I[0] = c[0]); P <= R.length && (P > 0 && (g = f, F[0] = F[1], b && (I[0] = I[1])), P < R.length ? (f = R[P], F[1] = null, b && (I[1] = null)) : (f = t, F[1] = n, b && (I[1] = c[1])), !(C && (null == F[1] && (F[1] = r.evalPoly(o, a, f)), r.isEqualEps(F[1], 0, h) && (w = f, S = F[1], _ = !1), F[0] > 0 && F[1] < 0 || F[0] < 0 && F[1] > 0))) && (!b || 0 == r.countRootsNSturm(o, a, s, g, f, A, I, F));)
          ++P;
      if (_ && 0 == P && ((u = r.evalPoly(l, l.length - 1, e)) > 0 && i > 0 || u < 0 && i < 0) && (w = e, S = i, _ = !1), _ && P == R.length && ((u = r.evalPoly(l, l.length - 1, t)) > 0 && n > 0 || u < 0 && n < 0) && (w = t, S = n, _ = !1), _) {
        for (m = F[0], y = F[1], b && (T = I), w = (g + f) / 2, u = r.evalPoly(l, l.length - 1, w); f - g > h && _;)
          w = (g + f) / 2, B <= (S = r.evalPoly(o, a, w)) && S <= h || u > 0 && S > 0 || u < 0 && S < 0 ? _ = !1 : S > 0 && m < 0 || S < 0 && m > 0 ? (f = w, y = S, b && (T[1] = null)) : S > 0 && y < 0 || S < 0 && y > 0 ? (g = w, m = S, b && (T[0] = null)) : C || !b ? (_ = !1, w = null) : (F = [
            m,
            S
          ], I = [
            T[0],
            null
          ], r.countRootsNSturm(o, a, s, g, w, A, I, F) > 0 ? (f = w, y = S, T[0] = I[0], T[1] = I[1]) : null != T[1] && I[1] == T[1] ? _ = !1 : (g = w, m = S, T[0] = I[0]));
