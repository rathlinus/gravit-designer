...
function (e, t, i) {
  var n = i(2), r = i(11), o = i(99), a = i(5), s = i(87), l = i(104), h = i(159), A = i(84), c = i(366), p = i(506), u = i(179), d = i(739), g = i(60), f = i(72), m = i(24), y = i(113), _ = i(153), v = i(740), b = i(1076), C = i(741), w = i(75), E = i(0), B = i(70), x = i(268), P = i(6), S = i(22), T = i(162), I = i(7), F = i(122), R = i(45), D = i(233), k = i(544), G = i(36), Q = i(210), M = i(742), N = i(743), U = i(12), V = i(160), O = i(83), L = i(216), Y = i(69), X = i(63), H = i(28), W = i(66), Z = i(540), z = i(1077), j = i(9), J = i(47), q = (i(56), i(531)), K = i(471), ee = i(140);
  function te(e) {
    ...
    t.setPriority(_.PRIORITY.DISTANCE_FIRST), this._guides.addGuide(t, !0), this._guides.addGuide(new v(this._guides)), this._guides.addGuide(new d(this._guides)), this._guides.addGuide(new C(this._guides)), this._guides.addGuide(new M(this._guides)), this._guides.addGuide(new k(this._guides)), this._guides.addGuide(new N(this._guides)), this._guides.addGuide(new z(this._guides)), this._guides.addGuide(new b(this._guides)), this._distanceHelper = new Z(this._scene), this._scene.addEventListener(n.AfterInsertEvent, this._afterNodeInsert, this, void 0, void 0, !0), this._scene.addEventListener(n.BeforeRemoveEvent, this._beforeNodeRemove, this, void 0, void 0, !0), this._scene.addEventListener(n.BeforeFlagChangeEvent, this._beforeFlagChange, this, void 0, void 0, !0), this._scene.addEventListener(n.AfterFlagChangeEvent, this._afterFlagChange, this, void 0, void 0, !0), this._scene.addEventListener(S.GeometryChangeEvent, this._geometryChange, this, void 0, void 0, !0);
  ...
  E.inherit(te, w), te._SavePoint = function (e, t, i) {
    ...
    return i && (i.getWidth() || i.getHeight()) ? i : te.getGroupGeometryBBox(e, t);
    ...
    if (this.hasSelection()) {
      for (var t = null, i = 0; i < this._selection.length; ++i) {
        var n = e ? this._selection[i].getGeometryBBox() : this._selection[i].getPaintBBox();
        n && n.getWidth() + n.getHeight() > 0 && (t = t ? t.united(n) : new P(n.getX(), n.getY(), n.getWidth(), n.getHeight()));
      }
      return t;
    }
    return null;
        ...
        for (var o = 0; o < this._selection.length; ++o) {
          ...
          if (a) {
            ...
            if (this._selectionDetail)
              a.setFlag(r.Flag.Detail), a instanceof s && "subselect" == m.selectDoubleClickBehavior && a.setEditMode(!0, t, !0, n ? n.getWorldTransform().getScaleFactor() : null);
            else {
              var l = i(235);
              (a.getPartSelection() || a instanceof l && a.hasPathPartSelection()) && a.updatePartSelection(!1, null), a instanceof s && "subselect" == m.selectDoubleClickBehavior && a.setEditMode(!1, t), a.removeFlag(r.Flag.Detail);
            }
          }
        }
    ...
    if (e !== this._selectionEdit || t) {
      ...
      var r = i(66), o = i(127), a = i(235), s = i(275);
      if (this._selection)
        for (var l = 0; l < this._selection.length; ++l) {
          var h = G.getEditor(this._selection[l]);
          h && (h.hasSelectionEditing() ? h.setEditMode(e, t, !0, n ? n.getWorldTransform().getScaleFactor() : null) : h instanceof o || h instanceof a || h instanceof s || (e ? h.removeFlag(r.Flag.ResizeAll) : h.setFlag(r.Flag.ResizeAll)));
        }
    }
    ...
    e = t ? t.isFixedSized() ? t.getGeometryBBox() : t.getPaintBBox() : this._scene.getPaintBBox(), this.arrangeAlign(te.ArrangeAlignType.AlignCenter, null, !0, e, !0), this.arrangeAlign(te.ArrangeAlignType.AlignMiddle, null, !0, e, !0);
    ...
    if (this._selection && this._selection.length > 0) {
      for (var i = this.getIndividualSelection(), r = [], o = [], a = 0; a < i.length; ++a) {
        var s = i[a];
        o = o.concat(this.getLinkedElementsInSelection(s, i)), s.hasMixin(n.Store) && r.push({
          element: s,
      ...
      if (l.length > 0) {
        ...
        this.updateSelection(!1, l), l[0] instanceof O && this._scene.setActivePage(l[0]), (_ = G.getEditor(this._scene)) && v && _.setTransformBoxActive(!0);
      }
    ...
    if (t && (t = t.slice().filter(function (e) {
      ...
      try {
        for (var i = n.order(t, !0), r = 0; r < i.length; ++r) {
          for (var o = i[r], a = o.getParent(); a && (!(a instanceof L) || a.isMaster());)
            a = a.getParent();
          if (a && o.hasMixin(n.Multireference))
            !!a._getMasterSibling(o.getMultireferenceId(), !1, !0) || (a = null);
        ...
        if (t && t.length)
          for (r = 0; r < t.length; ++r)
            if (t[r].hasFlag(n.Flag.Selected)) {
              var i = t[r].hasMixin(n.Container) ? t[r].getInternalSelectedNodes() : null;
              t[r].removeFlag(n.Flag.Selected), i && i.length && i.forEach(function (e) {
    ...
    if (this._scene.acceptChildren(function (t) {
        if ((a = A.indexOf(t)) >= 0) {
          l = !1, A.splice(a, 1);
          var i = t;
          o ? p._selectionDetail && (!e && t.hasFlag(n.Flag.Highlighted) || (s = G.openEditor(i)) && s.isPartSelectionUnderCollisionAllowed() && (r && (h = u(i)), s.updatePartSelectionUnderCollision(e, h, !0))) : t.hasFlag(n.Flag.Highlighted) && !e || (p._selectionDetail && (s = G.openEditor(i)), p._selectionDetail && s && s.isPartSelectionUnderCollisionAllowed() ? (p._selectionDetail || (s = G.openEditor(i)), s && (r && (h = u(i)), s.updatePartSelectionUnderCollision(e, h, !0))) : (p._selectionDetail && r && (h = u(i)), p._selectionDetail && !i.isFullUnderCollision(h) || (e && i.hasFlag(n.Flag.Selected) ? e && i.hasFlag(n.Flag.Selected) && (l = !0, i.hasFlag(n.Flag.Highlighted) && (i.removeFlag(n.Flag.Highlighted), removeFlag++)) : i.setFlag(n.Flag.Highlighted)))), e && !o && (l || i.hasFlag(n.Flag.Highlighted) || c.push(i));
        } else
    ...
    if (!r.equals(e, this._selection)) {
      ...
      try {
        for (var t = 0; this._selection && t < this._selection.length;)
          if (e && e.indexOf(this._selection[t]) >= 0)
            t++;
          else {
            var i = this._selection[t].hasMixin(n.Container) ? this._selection[t].getInternalSelectedNodes() : null;
            this._selection[t].removeFlag(n.Flag.Selected), i && i.length && i.forEach(function (e) {
              e.setFlag(n.Flag.Selected);
            });
          }
      } finally {
    ...
    for (var t = [], i = function (e) {
      ...
      e[r].hasMixin(n.Container) ? e[r].acceptChildren(i) && t.push(e[r]) : t.push(e[r]);
    return t;
    ...
    var E = null;
    return l && ((E = new W.EdTransformOptions()).isMultiPage = !0, E.doCollisionlessTransform = h), this.transformSelection(new I(1, 0, 0, 1, p.getX(), p.getY()), i, n, E), new a(p.getX(), p.getY());
    ...
    if (this._selection && this._selection.length) {
      ...
      for (var r = this.filterIndividualElements(this._selection), o = this._scene ? this._scene.getActivePage() : null, a = o ? o.getPosition(!0) : null, s = 0; s < r.length; ++s) {
    ...
    if (this._selection && this._selection.length)
      for (var e = 0; e < this._selection.length; ++e) {
        var t = this._selection[e], i = G.getEditor(t);
        i && i.resetTransform();
      }
    ...
    if (this._selection && this._selection.length) {
      ...
      if (a && a.length > 0) {
        ...
        try {
          ...
          this._selEditor && this._selEditor.resetTransform(), !i && p.length > 0 && this.updateSelection(!1, p), e && (this._lastCloneSelection = A.slice());
        } finally {
    ...
    if (!l || !l.isLocked()) {
      ...
      var p = s || null, u = null, d = null, g = !1;
        ...
        e.forEach(function (e) {
          e.accept(function (e) {
            e instanceof L && (e.getProperty("masterRef") !== e.getReferenceId() && e.getProperty("masterRef") !== e.getOldReferenceId() || C.concat(v).some(function (t) {
              ...
              return !1;
            }) || (e._master = !0, v.push(e)), e._master || C.some(function (t) {
              if (t.getMultireferenceId() === e.getMultireferenceId())
                return e.getProperty("masterRef") !== t.getProperty("masterRef") && e.setProperty("masterRef", t.getProperty("masterRef")), !0;
            }));
          });
        });
      }
    ...
    if (t.length) {
      ...
      try {
        ...
        for (r = 0; r < t.length; ++r) {
          ...
          var l = a.getParent(), h = a.getNext(!0), A = null;
          if (a instanceof R) {
            l.removeChild(a);
    ...
    var e = null;
    if (this._selection && this._selection.length) {
      for (var t = n.order(this.getSelection().slice()), i = [], r = 0; r < t.length; ++r) {
        ((l = t[r]) instanceof g || l instanceof y) && i.push(l);
      }
      if (i.length > 1) {
        e = new y();
        var o = i[i.length - 1], a = o.getParent(), s = o.getNext();
    ...
    if (e instanceof y) {
      t = [];
      var i = e.getParent(), n = e.getNext();
      i && i.removeChild(e);
      for (var r, o = e.cloneSubPaths(), a = o.getFirstChild(); null !== a; a = r)
        r = a.getNext(), o.removeChild(a), i && i.insertChild(a, n), t.push(a);
    }
    return t;
    ...
    t = e === te.ArrangeOrderType.SendToFront || e === te.ArrangeOrderType.SendBackward ? n.order(t) : n.order(t, !0), i || this.beginTransaction();
    try {
    ...
    try {
      for (h = 0; h < t.length; ++h) {
        ...
        case te.ArrangeAlignType.AlignLeft:
          u && u.isAlignPartsAllowed() ? u.alignParts(te.ArrangeAlignType.AlignLeft, d.getX(), null) : d.getX() !== c.getX() && p.transform(new I(1, 0, 0, 1, d.getX() - c.getX(), 0), !0);
          break;
        case te.ArrangeAlignType.AlignCenter:
          var g = d.getX() + d.getWidth() / 2;
          u && u.isAlignPartsAllowed() ? u.alignParts(te.ArrangeAlignType.AlignCenter, g, null) : g !== c.getX() + c.getWidth() / 2 && p.transform(new I(1, 0, 0, 1, g - c.getX() - c.getWidth() / 2, 0), !0);
          break;
        case te.ArrangeAlignType.AlignRight:
          var f = d.getX() + d.getWidth();
          u && u.isAlignPartsAllowed() ? u.alignParts(te.ArrangeAlignType.AlignRight, f, null) : f !== c.getX() + c.getWidth() && p.transform(new I(1, 0, 0, 1, f - c.getWidth() - c.getX(), 0), !0);
          break;
        case te.ArrangeAlignType.AlignTop:
          u && u.isAlignPartsAllowed() ? u.alignParts(te.ArrangeAlignType.AlignTop, null, d.getY()) : d.getY() !== c.getY() && p.transform(new I(1, 0, 0, 1, 0, d.getY() - c.getY()), !0);
          break;
        case te.ArrangeAlignType.AlignMiddle:
          g = d.getY() + d.getHeight() / 2;
          u && u.isAlignPartsAllowed() ? u.alignParts(te.ArrangeAlignType.AlignMiddle, null, g) : g !== c.getY() + c.getHeight() / 2 && p.transform(new I(1, 0, 0, 1, 0, g - c.getY() - c.getHeight() / 2), !0);
          break;
        case te.ArrangeAlignType.AlignBottom:
          var m = d.getY() + d.getHeight();
          u && u.isAlignPartsAllowed() ? u.alignParts(te.ArrangeAlignType.AlignBottom, null, m) : m !== c.getY() + c.getHeight() && p.transform(new I(1, 0, 0, 1, 0, m - c.getHeight() - c.getY()), !0);
          break;
    ...
    if (o.multiPageView) {
      ...
      if (s && !s.isEmpty()) {
        ...
        if (d && !r && (a.getActivePage() !== d.element && a.setActivePage(d.element), d.data.label && this.updateSelection(!1, [d.element])), m.pageSelectable) {
          ...
          if ("action" === i) {
            ...
            case K.ActionType.Insert:
              t.node = r.node, t.parentSeq = r.parent, t.nextSeq = r.next, t.makeRecorded = r.makeRecorded, t.action = function () {
                ...
                t.makeRecorded && (this.insertedNode = e, e.recordedTransaction = !0), r.insertChild(e, i);
              };
              break;
            case K.ActionType.PropertyChange:
              null !== r.node && (t.nodeSeq = r.node, Object.defineProperty(t, "node", {
                ...
                var e = !1, t = this.node;
                t instanceof S && !t.isRecordedTransaction() && (t.recordedTransaction = !0, e = !0), t.setProperties(this.properties, this.values, this.custom), e && (t.recordedTransaction = !1);
              };
              break;
            ...
            case K.ActionType.BeginBlock:
              null !== r.node && (t.nodeSeq = r.node), t.action = function () {
                var e = o._seqIdToNode(this.nodeSeq), t = !1;
                this.withInvalidation && (e instanceof S && !e.isRecordedTransaction() && (e.recordedTransaction = !0, t = !0), e._notifyChange(S._Change.PrepareGeometryUpdate), t && (e.recordedTransaction = !1)), e._beginBlockChanges(this.changes);
              };
              break;
            case K.ActionType.EndBlock:
              null !== r.node && (t.nodeSeq = r.node), t.action = function () {
                var e = o._seqIdToNode(this.nodeSeq);
                e._endBlockChanges(this.changes), this.withInvalidation && (e instanceof S && !e.isRecordedTransaction() && (e.recordedTransaction = !0, recordedSet = !0), e._notifyChange(S._Change.FinishGeometryUpdate), recordedSet && (e.recordedTransaction = !1));
              };
              break;
    ...
    if (t) {
      if (this._transactionStack.length) {
        ...
        i && i.length && (this._transactionStack[this._transactionStack.length - 1].actions = i);
      }
    ...
    for (t = e.actions.length - 1; t >= 0; --t)
      e.actions[t].revert();
    ...
    if (this._undoStates.length > 0) {
      ...
      this._redoStates.push(e), this._scene.trigger(new V.RecordedTransactionStartedEvent(this._scene)), e.revert(e.data), this._scene.trigger(new V.RecordedTransactionFinishedEvent(this._scene)), this.hasEventListeners(te.ModifiedEvent) && (e.data.relatedData ? this.trigger(new te.ModifiedEvent(e.data.relatedData, te.ModifiedEvent.Type.Undo)) : this.trigger(te.MODIFIED_EVENT));
    }
  }, te.prototype.redoState = function () {
    if (this._redoStates.length > 0) {
      var e = this._redoStates.pop();
      this._undoStates.push(e), this._scene.trigger(new V.RecordedTransactionStartedEvent(this._scene)), e.action(e.data), this._scene.trigger(new V.RecordedTransactionFinishedEvent(this._scene)), this.hasEventListeners(te.ModifiedEvent) && (e.data.relatedData ? this.trigger(new te.ModifiedEvent(e.data.relatedData, te.ModifiedEvent.Type.Redo)) : this.trigger(te.MODIFIED_EVENT));
    }
      ...
      if ("function" == typeof e) {
        for (var t, i = this._undoStates.length - 1; i >= 0; i--) {
          if ((t = this._undoStates[i]).id === this._savePointId)
            return !1;
          if (t.data) {
            if (t.data.newSelection && t.data.newSelection.some(function (t) {
                return !e(t.element);
              }))
              return !0;
            if (t.data.selection && t.data.selection.some(function (t) {
                return !e(t.element);
              }))
              return !0;
            if (!t.data.newSelection && !t.data.selection && t.data.actions && t.data.actions.some(function (t) {
    ...
    if (e.node instanceof S) {
      ...
      if (e.flag === n.Flag.Selected)
        ...
        var r;
        if (e.set)
          (r = G.openEditor(e.node, !1, !0)) && r.setFlag(t.Flag.Highlighted);
        else
          (r = G.openEditor(e.node, !1, !0)) && r.removeFlag(t.Flag.Highlighted), this._tryCloseEditor(e.node);
      }
    }
    ...
    if (0 === this._selectionUpdateCounter) {
      ...
      e.isActivated() && e.deactivateEditor(), this.updateSelectionEditors();
    }
  }, te.prototype.updateSelectionEditors = function () {
    var e = i(39), t = this.getIndividualSelection();
    ...
    if (e instanceof S && e.hasFlag(n.Flag.Selected)) {
      var t = G.openEditor(e), r = i(39);
      if (t) {
        t.setFlag(r.Flag.Selected), this._selectionDetail && t.setFlag(r.Flag.Detail);
        var o = i(235), a = i(275), s = i(127), l = i(66), h = i(329);
        t instanceof s && y.isOwnedPath(t.getElement()) && t.setCatchHandle(!1), t instanceof s && !y.isOwnedPath(t.getElement()) || t instanceof o || t instanceof a ? (this._pathResize || t.removeFlag(l.Flag.ResizeAll), t instanceof a && this._selectionEdit && t.setEditMode(!0)) : this._selectionEdit ? t instanceof h ? t.setEditMode(!0) : t.removeFlag(l.Flag.ResizeAll) : this._selectionDetail && t instanceof h && "subselect" == m.selectDoubleClickBehavior && t.setEditMode(!0), t.validateSelectionChange() && (this._selection || (this._selection = []), this._selection.push(e), this._updatedSelection());
      }
    }
  }, te.prototype._tryRemoveFromSelection = function (e) {
    if (e instanceof S) {
      var t = G.getEditor(e), n = i(39);
      if (t && t.hasFlag(n.Flag.Selected) && (t.removeFlag(n.Flag.Selected), this._tryCloseEditor(e, !0)), this._selection) {
    ...
    if (t && t.isInlineEdit()) {
      ...
      return e === this._currentInlineEditorNode && (this._currentInlineEditorNode = null), this.hasEventListeners(te.InlineEditorEvent) && this.trigger(new te.InlineEditorEvent(t, te.InlineEditorEvent.Type.AfterClose)), !0;
    }
    return !1;
    ...
    for (var e = [], t = 0; t < this._selection.length; ++t) {
      var i = this._selection[t], n = G.getEditor(i), r = n && n.getPartSelection(), o = n && n.getEditorStateData();
      o ? e.push({
        element: i,
    ...
    if (e && 0 !== e.length) {
      ...
      for (i = 0; i < e.length; ++i)
        if (e[i].parts || e[i].data) {
          ...
          n && (e[i].data && n.restoreEditorStateData(e[i].data), e[i].parts && n.updatePartSelection(!1, e[i].parts));
        }
    } else
      this.clearSelection();
    ...
    }, !1, !0), i.length > 0 && (t || this.updateSelection(!1, i), i);
  }, te.prototype.blinkSelection = function (e, t) {
    if (this._selection && this._selection.length) {
      var i = this._selection.slice(), r = function () {
  ...
  te.prototype._getSeqId = function (e) {
    for (var t = e; !(t instanceof S);)
      t = t.getParent();
    if ("function" != typeof t.getScene)
      return -1;
    var i = t.getScene();
    if (!i)
      return -1;
    ...
    return ie[e];
  }, te.prototype._debugBugged = !1, te.prototype._fixDebugData = function (e, t) {
          ...
          if (i)
            for (var a = 0; a < i.length; a++)
              if (i[a].action.type === K.ActionType.Insert && i[a].action.node === t[r].element) {
                i[a].action.makeRecorded = !0, o = !0, t[r].elementInserted = !0, t[r].elementAction = a;
                break;
              }
          if (!o) {
