...
function (e, t, i) {
  var n = i(0), r = i(108), o = i(63), a = i(48), s = i(6), l = i(54), h = i(59), A = i(7), c = i(708), p = i(726), u = i(11), d = i(838), g = i(9), f = i(457), m = i(266), y = [
      [
        69632,
        69759,
        "BRAHMI"
  ...
  function _(e, t, i, n, r) {
    this._family = e, this._style = t, this._weight = i, this._buffer = n, this._openTypeFont = r, this._outlinesCache = {}, this._boundsCache = [], this._smallCaps = void 0, this._fractions = void 0, this._stylisticSets = void 0, this._localizedForms = void 0;
  }
  n.inherit(_, r), _.prototype._smallCaps = void 0, _.prototype._fractions = void 0, _.prototype._stylisticSets = void 0, _.prototype._localizedForms = void 0, _.create = function (e, t, i, n) {
    ...
    for (var e = "", t = new Uint8Array(this._buffer), i = t.byteLength, n = 0; n < i; n++)
      e += String.fromCharCode(t[n]);
    return "url(data:font/ttf;base64," + window.btoa(e) + ") format(\"truetype\")";
    ...
    if (!r) {
      var h = "string" == typeof n ? this._openTypeFont.stringToGlyphs(n)[0] : n, c = h.getPath(0, 0, this._openTypeFont.unitsPerEm, { hinting: !0 }, this._openTypeFont);
    ...
    for (var t = [], i = 1; i <= 20; i++) {
      var n = "ss" + "00".substr(String(i).length) + i, r = this._openTypeFont.substitution.getFeature(n, e);
    ...
    for (var t = this._openTypeFont.position.getScriptNames(), i = this._openTypeFont.substitution.getScriptNames(), n = t.length - 1; n >= 0; n--)
    ...
    if (i = i.map(function (e) {
      ...
      for (var h in r)
        i.indexOf(h) < 0 && i.push(h);
    }
    return i;
  }, _.prototype.getAvailableVariants = function () {
    if (this.hasFeature(r.Features.Variants)) {
      var e = this._openTypeFont.tables.fvar, t = [];
      if (e)
        for (var i = g.getLanguage(), n = 0; n < e.instances.length; n++) {
          var o = e.instances[n].name, a = {};
          if (o[i])
            a.name = o[i];
          else if (o[f.English])
            a.name = o[f.English];
    ...
    case r.Features.Fractions:
      if (null == this._fractions) {
        var t = this._openTypeFont.substitution.getDefaultScriptName(), i = this._openTypeFont.charToGlyphIndex(String.fromCharCode(8260)), n = this._openTypeFont.substitution.getFeature("numr", t), o = this._openTypeFont.substitution.getFeature("dnom", t);
    ...
    if (void 0 === this._stylisticSets) {
      ...
      this._stylisticSets = e.some(function (e) {
    ...
    if (void 0 === this._localizedForms) {
      var e = this._openTypeFont.substitution.getScriptNames();
      this._localizedForms = e.some(function (e) {
