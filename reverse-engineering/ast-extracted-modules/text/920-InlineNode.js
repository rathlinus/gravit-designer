...
function (e, t, i) {
  var n = i(0), r = i(230), o = i(921), a = i(653), s = i(267), l = i(161), h = i(368), A = i(654);
  function c() {
  ...
  c.codeFactory = function (e, t, i) {
  ...
  }, c.ListEnd.prototype.eof = !0, c.ListEnd.prototype.measure = function () {
    return {
      width: 0,
      ascent: 0,
      descent: 0,
    ...
    var p, u, d, g, f = [], m = {}, y = new o("list", r, e, t), _ = 0, v = 10, b = isNaN(s.listDepth) ? 0 : s.listDepth, C = function (r) {
        ...
        _ = 25 * s / 20 * (b + 1), v = 10 * s / 20, p = new o("item", y, void 0, void 0, b);
        ...
        g || (g = B.obj), (d = new c.InlineNode(B, p, n, 1, r, v)).block = !0, u = new a(e + _ + v + d.measured.width, t, i, n + 1, p, function (e) {
          return e.$ === h.List.Close;
        }, d.measured.ascent, void 0, l);
      }.bind(this);
    return C(s), function (r) {
      if (u ? u.frame(function (o) {
          ...
          if (h)
            g = s.baseline || 0, f = Math.max(o.height, f), c = s.bounds(!1, !0).l;
          else {
            var m = e + _ + v + d.measured.width, b = new A(null, m, i, g, d.measured.ascent, d.measured.descent, [r], n, l).bounds(!1, !0), C = r.lineSpacing();
    ...
    if (!e.words.some(function (n, r) {
        ...
        if (o)
          ...
          case h.List.Item:
            if (0 === t)
              return e.spliceWordsWithRuns(r, 1, [l.derive(n.codeFormatting(), { text: { $: h.List.Open } })]), !0;
            break;
          case h.List.Close:
  ...
  }, i(922)(c), i(923)(c), i(924)(c), i(925)(c), e.exports = c;
}
