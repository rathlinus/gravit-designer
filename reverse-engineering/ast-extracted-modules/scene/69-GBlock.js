...
function (e, t, i) {
  var n = i(28), r = i(22), o = i(2), a = i(0), s = i(6), l = i(112), h = i(207), A = i(14), c = i(11);
  function p() {
  ...
  a.inheritAndMix(p, r, [
    ...
    NoSelect: 512
  }, p.VisualProperties = { vis: !0 }, p.MetaProperties = {
    name: null,
    lkt: null,
    ...
    return new s(o.getX() - t, o.getY() - c - t, o.getWidth() + 2 * t, c + 2 * t).containsPoint(e) ? new l(this, { label: !0 }) : null;
    ...
    if (e === o._Change.Store)
      ...
      var i = t, n = i.properties.indexOf("vis") >= 0, a = i.properties.indexOf("lkt") >= 0;
