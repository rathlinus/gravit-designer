...
function (e, t, i) {
  var n = i(2), r = i(76), o = i(0), a = i(28), s = i(14), l = i(133), h = i(5), A = i(6), c = i(11), p = i(42);
  e.exports = function (e) {
    e.Stylable = function () {
    }, o.inherit(e.Stylable, a), e.Stylable.GeometryProperties = { sref: null }, e.Stylable._ENABLE_PARTIAL_RESET = !0, e.Stylable.prototype._fxCache = [], e.Stylable.prototype.assignStyleFrom = function (e, t) {
      this.beginUpdate();
      try {
      ...
      if (e.configuration.isOutline(e))
        ...
        var n;
        n = e.configuration.ignoreEffects || e.configuration.noWebGL || e.getRootCanvas().getScale() > 6 && e.configuration.enableFxCache && !e.configuration.forceEffectsWhenZoomed ? null : this._effects ? this._effects.getLayersEffects(i, !0) : null;
          ...
          for (var c = 0; c < n.length && !l; ++c)
            if (n[c])
              for (var p = 0; p < n[c].length && !l; ++p)
                r = !0, o(n[c][p]) && (l = this._createStyleCanvas(e, t, A));
        }
      ...
      if ("m" === this.$_sbl || "!m" === this.$_sbl) {
        var i = !1, n = this._getStyleMaskClipArea();
        n && e.hasClip() && (e.clipRect(n.getX(), n.getY(), n.getWidth(), n.getHeight()), i = !0);
        try {
        ...
        for (var a = e.configuration.isOutline(e), s = null, l = [null], h = 0; h < i.length; ++h) {
          ...
          if (a)
            ...
            if (c || this._isSeparateStylePaintLayer(e, A)) {
              ...
              try {
                this._paintStyleLayer(e, A, !0), c ? this._paintWithEffects(s, e.getRootCanvas(), u, 1, c, r, null, e.configuration.enableFxCache, l[0], p[0]) : u.drawCanvas(s);
              } finally {
                e.popCanvas();
              }
            } else
        ...
        if (a && h) {
          ...
          if (c !== p) {
            if (c > p || e.getWidth() * e.getHeight() > 16777216) {
              ...
              var d = e.getTransform(!1), g = e.getTransform(!0), f = d.inverted();
              ...
              return x.isEmpty() || (e._canvasContext.globalAlpha = 1, e._canvasContext.globalCompositeOperation = "source-over", e._canvasContext.drawImage(l._canvasContext.canvas, x.getX(), x.getY(), x.getWidth(), x.getHeight(), 0, 0, P, S)), e.setTransform(g), !0;
            }
            return this._resetFxCacheAndState(t, !0), !1;
          }
          return !i && (Math.abs(l.getWidth() - e.getWidth()) > 1 || Math.abs(l.getHeight() - e.getHeight()) > 1) ? (console.log("fx cache: size misfit"), this._resetFxCacheAndState(t, !0), !1) : (n || (i ? l.setOffset(i.getSide(A.Side.TOP_LEFT)) : l.setOffset(e.getOffset()), e.drawCanvas(l, 0, 0, 1, s.CompositeOperator.Copy)), !0);
        }
      ...
      for (var i = e.length - 1; i >= 0; i--) {
        ...
        if (n >= 0 && this._fxCache[n]) {
          var r = e.slice(0, i).concat(t), o = this._fxCache[n].deps;
      ...
      var n = !1, r = this._scene;
      if (e.Stylable._ENABLE_PARTIAL_RESET && t) {
        var o = this._getFxIdx(t);
        if (o >= 0) {
          var a = this._fxCache[o];
          a && r.destroy([a.bmp]), this._fxCache.splice(o, 1), n = !0, i && this._reinvalidateRemovedFx(t);
        }
      } else
      ...
      var u, d, g = !1;
      h || (h = []), this._reinvalidateFxDeps(r, h), (e.getWidth() < c.getWidth() - 1 || e.getHeight() < c.getHeight() - 1) && (d = !0);
      var f, m = {};
      for (r.some(function (e) {
        ...
        if (m[v] = !0, _ === a.Effect.Type.Filter)
          ...
          _ === a.Effect.Type.PostEffect && !g && n > 0 && (i.drawCanvas(e, 0, 0, n), g = !0), l.clear();
          var b, C = e;
      ...
      if (e.configuration.paintMode === l.PaintMode.Fast) {
        var a = new s();
        if (o > 1) {
          var c = e.canvas.getScaleBoxCorrection(t.getX(), t.getY(), t.getWidth(), t.getHeight(), o, !0);
      ...
      var d = e.canvas.getPaintExtents(t, !1, i), g = e.canvas.getFinalExtents(d), f = e.canvas.getTransform().getTranslation(), m = new h(-g.getX(), -g.getY()), y = e.canvas.getTranslateCorrection(f, m), _ = 1 / o;
      if (i) {
      ...
      return n && (d = e.canvas.getPaintExtents(t, !0, i), g = e.canvas.getFinalExtents(d), m = new h(-g.getX(), -g.getY()), b = (y = e.canvas.getTranslateCorrection(f, m)).getX() * _, C = y.getY() * _, w = t.translated(b, C).expanded(_, _, _, _), d = e.canvas.getPaintExtents(w, !0, i), g = e.canvas.getFinalExtents(d).toRoundedPrecision(), n[0] = new A(g.getX(), g.getY(), Math.ceil(g.getWidth()), Math.ceil(g.getHeight()))), E;
      ...
      if (this._notifyChange(e._Change.PrepareGeometryUpdate), t && this.hasMixin(n.Container))
        for (var i = this.getFirstChild(); null !== i; i = i.getNext())
          i instanceof e && i.hasMixin(e.Stylable) && i._stylePrepareGeometryChange(t);
      ...
      if (this._notifyChange(e._Change.FinishGeometryUpdate, 1), t) {
        if (t instanceof a.Effect ? this._resetFxCacheAndState(t) : this._resetFxCacheAndState(), this.hasMixin(n.Container))
          for (var i = this.getFirstChild(); null !== i; i = i.getNext())
            i instanceof e && i.hasMixin(e.Stylable) && i._styleFinishGeometryChange(t);
      } else
        ...
        if ((e === n._Change.BeforePropertiesChange || e === n._Change.AfterPropertiesChange) && t.properties.indexOf("sref") >= 0 || e === r._Change.SceneAttached || e === r._Change.SceneDetached) {
          ...
          if (i)
            ...
            case r._Change.SceneAttached:
              this._scene.link(i, this), e === n._Change.AfterPropertiesChange && this.assignStyleFrom(i, !0);
            }
        }
