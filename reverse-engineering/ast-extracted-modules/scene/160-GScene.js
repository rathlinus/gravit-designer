...
function (e, t, i) {
  var n = i(50), r = i(2), o = i(76), a = i(915), s = i(0), l = i(11), h = i(72), A = i(132), c = i(69), p = i(104), u = i(22), d = i(45), g = i(83), f = i(472), m = i(6), y = i(7), _ = i(63), v = i(511), b = i(658), C = i(933), w = i(9), E = i(47), B = i(207), x = i(662), P = i(517), S = i(14), T = i(12), I = i(118), F = i(111), R = i(103), D = i(140), k = i(59), G = i(68);
  function Q(e, t) {
  ...
  i(507), r.inheritAndMix("scene", Q, u, [
    r.Container,
    r.Properties,
    r.Store,
    u.Accelerated
  ...
  }, Q.prototype._activePage = null, Q.prototype._linksLookup = null, Q.prototype._temporarilyDisabledLinks = null, Q.prototype._linksAreSane = !0, Q.prototype._invalidateFrom = 0, Q.prototype._pendingActions = null, Q.prototype._callingPendingActions = !1, Q.prototype._styles = null, Q.prototype._swatches = null, Q.prototype._duringRecordedTransaction = !1, Q.prototype._lastInvalidationFinishedEvent = null, Q.prototype._pre310 = !1, Q.prototype._trfSettings = null, Q.prototype._dictionary = null, Q.prototype._symbolDictionary = null, Q.prototype._destroyables = null, Q.prototype._savedScreenBBox = null, Q.prototype._referenceCounter = 0, Q.prototype._released = !1, Q.prototype._lastTimeAnnotationsFromCloudModified = 0, Q.prototype.getDictionary = function () {
    ...
    this._released = !0, this._dictionary.release(), this._symbolDictionary.release(), this.getWorkspace().cleanReferences(this);
    ...
    this._symbolDictionary.removeEntry(e.getMultireferenceId(), !0), this.visitLinks(e, function (e) {
    ...
    for (var e, t = this._dictionary.getEntries(), i = !1, n = 0, r = t.length; n < r && !(i = (e = t[n].value) && 0 === e.indexOf("file://") && t[n].hasReferences()); n++);
    return i;
          ...
          if (i.hasMixin(r.Reference) && i.getOldReferenceId() && this.$_links.hasOwnProperty(i.getOldReferenceId()))
            ...
            this.acceptChildren(function (t) {
              if (t.hasMixin(r.Reference) && (t.getOldReferenceId() || t._referenceId) && i.$rtxt.indexOf(t.getOldReferenceId() || t._referenceId) >= 0) {
                ...
                if (s || (s = []), s.push(i), e[t._referenceId] = s, ++n === i.$rtxt.length)
                  return !1;
              }
            }.bind(this)), delete i.$rtxt;
          }
          i instanceof d && i.getAnchorPoints() && i.getAnchorPoints().accept(t);
        }.bind(this), i = this.getProperty("mpg");
      i && i.accept(t), (i = this.getProperty("empg")) && i.accept(t), (i = this.getProperty("ompg")) && i.accept(t), this.acceptChildren(t);
      var n = this.$__ids, a = [];
          ...
          if (A) {
            if (A instanceof v) {
              ...
              for (var c = 0; c < a.length; c++) {
                (_ = a[c]) instanceof u && _.hasProperty("sref") && _.getProperty("sref") && (A.getOldReferenceId() === _.getProperty("sref") && (_.$sref = A.getReferenceId()), A.getReferenceId() === _.getProperty("sref") && (l.push(_), h.push(_.getSceneId()), _.hasEventListeners(f) && _.trigger(new f(A, _, !0))));
              }
            } else {
                ...
                for (c = 0; c < a.length; c++) {
                  ...
                  if (n[c] === h[y])
                    if ((_ = a[c]).getWorkspace()) {
                      l.push(_), h[y] = _.getSceneId(), _.hasEventListeners(f) && _.trigger(new f(A, _, !0)), p = !0;
                      break;
                    }
                }
                p || m.push(y);
    ...
    if (!this._isRestoring && !this.$rb) {
      ...
      if (this._refreshLinks(), this.isLinked(t, e))
        ...
        this._linksLookup || (this._linksLookup = {}), n.hasOwnProperty(i) || (n[i] = [], this._linksLookup[i] = []), n[i].push(t.getSceneId()), this.setProperty("_links", n), t instanceof g && (t._invalidatePaintBoxForChildUpdate(), this._invalidateArea(null, t));
      }
    }
  }, Q.prototype.unlink = function (e, t) {
    if (!this._isRestoring && !this.$rb && e) {
      var i = null;
      this._refreshLinks(), i = "string" != typeof e ? e.getReferenceId() : e;
      var n = JSON.parse(JSON.stringify(this.$_links || {}));
      ...
      if (!a && this._temporarilyDisabledLinks)
        if (this._temporarilyDisabledLinks.hasOwnProperty(i))
          if (r = n[i])
            (o = r.indexOf(t.getSceneId())) >= 0 && (r.splice(o, 1), 0 === r.length && delete n[i]);
      ...
      if (this._linksLookup)
        if ("string" == typeof e)
          for (var i in this._linksLookup) {
            this.$_links[i].indexOf(e) >= 0 && t(this._workspace.getReference(i));
          }
        else if (e)
          for (var i in this._linksLookup)
            this._linkLookupHasSceneNode(i, e) && t(this._workspace.getReference(i));
    } else
    ...
    if ("string" == typeof e) {
      for (var t in this.$_links)
        if (this.$_links[t].indexOf(e) >= 0)
          return !0;
    } else if (this._linksLookup)
      for (var t in this.$_links)
        if (this._linkLookupHasSceneNode(t, e))
          return !0;
    return !1;
    ...
    try {
      ...
      for (var t = this.getFirstChild(); null !== t; t = t.getNext(), e++)
        t._paintBBox = null, t._childrenPaintBBox = null, t._geometryBBox = null, t._preTransformRect = null, this._isRestoring || t.refreshPosition();
    } finally {
      this.endUpdate();
    }
    ...
    if (i) {
      for (var n = this.getLastChild(); null !== n; n = n.getPrevious())
        if (n instanceof g && (t || n.$vis) && !1 === e(n))
          return;
    } else
    ...
    if (t !== e && (t && (t.removeFlag(r.Flag.Active), t.setActiveLayer(null)), e && e instanceof g)) {
      var i = t ? this.getIndexOfChild(t) : 0, n = this.getIndexOfChild(e);
    ...
    this.hasEventListeners(Q.InvalidationFinishedEvent) && this.trigger(new Q.InvalidationFinishedEvent(this, e.configuration, !0));
    ...
    if (e.configuration.multiPageView) {
      ...
      for (var c = 0; c < A.length; c++)
        node = A[c], node instanceof g && (h = node.getPosition(!0), e.canvas.setOrigin(o.subtract(h.scale(a))), e.dirtyMatcher && (l = new y(1, 0, 0, 1, -h.getX(), -h.getY()), s ? e.dirtyMatcher.transform(l.preMultiplied(s.inverted())) : e.dirtyMatcher.transform(l), s = l), node.paint(e));
    } else
    ...
    if (o) {
      var h = t & u.CollisionFlag.PaintBBox, A = D.RETRIEVE_MODE_INTERSECT, c = k.calculateBounds(e, !0), p = h ? this.retrieveChildrenInPaintBBox(c, A) : this.retrieveChildrenInGeometryBBox(c, A);
    ...
    if (e instanceof g && t instanceof g) {
      var i, n = e.getProperty("name") || "", r = /\s([0-9]+)(?:\.([0-9]+))?(?:\.([0-9]+))?$/, o = n.match(r), a = [], s = n.slice(0, o ? o.index : n.length);
      a = o ? o[3] ? [
        parseInt(o[1]),
        parseInt(o[2]),
        parseInt(o[3]) + 1
      ...
      }, !0), i = s + " " + a.join("."), t.setProperty("name", i);
    }
    ...
    if (!this.$rb && this._linksLookup) {
      ...
      var n = null, r = this;
      for (var t in this.$_links) {
        var a = this._workspace.getReference(t), s = [], l = [], h = [];
        this._linksLookup.hasOwnProperty(t) && (h = this._linksLookup[t], l = h.map(function (e) {
          return e.getSceneId();
        })), (s = this.$_links[t]).forEach(function (e) {
          if (l.indexOf(e) < 0) {
            var t = c()[e];
            t && a && t.hasEventListeners(f) && t.trigger(new f(a, t, !0));
          }
        }.bind(this)), h.forEach(function (e) {
          (!e._scene || s.indexOf(e.getSceneId()) < 0) && a && e.hasEventListeners(f) && e.trigger(new f(a, e, !1));
        }.bind(this)), this._linksLookup[t] = s.map(function (e) {
          var t = c()[e];
          if (null === t && a) {
            var i = h[l.indexOf(e)];
      ...
      for (var t in this._linksLookup)
        if (this.$_links.hasOwnProperty(t)) {
          (A = this._linksLookup[t]) && A.length || delete this._linksLookup[t];
        } else {
          var A = this._linksLookup[t];
          (a = this._workspace.getReference(t)) && A.forEach(function (e) {
            e.hasEventListeners(f) && e.trigger(new f(a, e, !1));
          }.bind(this)), delete this._linksLookup[t];
        }
    ...
    if (e === r._Change.PrepareRestore) {
      this._activePage && (this.removeChild(this.getActivePage()), this._activePage = null), t.blob.hasOwnProperty("dictionary") ? this._dictionary.deserialize(t.blob.dictionary) : this._pre310 = !0, this._symbolDictionary.deserialize(t.blob.symbolDictionary);
      var a = t.blob.cst;
      ...
      t && t[0] instanceof g && (t[1] = !0, this._invalidateArea(t[2] || this._getInvalidationArea(this.getIndexOfChild(t[0]))));
    ...
    if (!this._isRestoring && !this.$rb && (this._refreshLinks(), !this._callingPendingActions)) {
      ...
      this._linksAreSane = this._checkLinksSanity(), this._linksAreSane ? (this._callingPendingActions = !0, this._pendingActions.forEach(function (e) {
        e.call(this);
      }.bind(this)), this._pendingActions = [], this._callingPendingActions = !1, e || console.log("Links became sane.")) : console.warn("links are not sane!");
    }
    ...
    }.bind(this), !1), r.forEach(function (e) {
