...
function (e, t, i) {
  i(75);
  var n = i(50), r = i(2), o = i(0), a = i(72), s = i(5), l = i(69), h = i(104), A = i(6), c = i(7), p = i(22), u = i(159), d = i(112), g = i(139), f = i(68), m = i(207), y = i(14), _ = i(9), v = i(133), b = i(228), C = i(103), w = i(506);
  function E() {
  ...
  r.inheritAndMix("page", E, l, [
  ...
  }, E.prototype._cachedPosition = null, E.prototype._isInvalidating = !1, E.prototype._cachedImage = null, E.prototype._shouldRepaintThumbnail = !0, E.prototype._annotations = null, E.prototype.getNodeNameTranslated = function () {
    ...
    for (var e = null, t = this.getLastChild(); null !== t; t = t.getPrevious())
      if (t instanceof w) {
        e = t;
        break;
      }
    ...
    for (var e = null, t = this.getFirstChild(); null != t; t = t.getNext())
      if (t instanceof p) {
        if ("symbol" === r.getName(t)) {
          var i = t.getChildrenPaintBBox();
          i = t.getEffects() && i && t.getEffects().getEffectsBBox(i, null, i) || i;
          var n = t.getFrame();
    ...
    var b = new A(p, u, this.$w, this.$h), C = function (i) {
        this._scene.iteratePages(function (n) {
          if (n === this)
            return !1;
          var a = n.getPosition(e, !0, t), s = new A(a.getX(), a.getY(), n.$w, n.$h).expanded(o, r, o, r);
    ...
    if (e instanceof h) {
      ...
      t && !t.hasFlag(r.Flag.Active) ? this.setActiveLayer(t) : t || this.setActiveLayer(null);
    } else
    ...
    if (this.isFixedSized()) {
      var e = this.getGeometryBBox();
      return e && !e.isEmpty() ? e.expanded(-this.$ml, -this.$mt, -this.$mr, -this.$mb) : e;
    }
    return null;
    ...
    return t && (s = t.mapRect(s)), s.expanded(i, i, i, i).containsPoint(e) ? new d(this, { label: !1 }) : this._hitTestLabel(e, i, t, !this.isScaleLabel(), l);
      ...
      this.acceptChildren(function (t) {
        if (t.hasMixin(p.Accelerated)) {
          for (var i = 1, n = t; n.getParent() !== r;)
            n = n.getParent(), i++;
          var o = 16711935 >>> (31 & i) | 16711935 << (24 - i & 31) & 16777215;
    ...
    if (!this._scene)
      return !1;
    var e = !1, t = null, i = this._scene.getProperty("mpg");
    ...
    var o = i.resetTransform(), a = e.isIncludingInvisible();
    if (this.isFixedSized()) {
      var l = !1, h = new A(this.$x, this.$y, this.$w, this.$h), u = (F = o.mapRect(h).toAlignedRect()).getX(), d = F.getY(), y = F.getWidth(), _ = F.getHeight();
          ...
          if (R.transform) {
            ...
            if (e.configuration.multiPageView && m.pagesCanOverlap)
              if ("undefined" != typeof navigator && navigator && 0 == navigator.userAgent.indexOf("Mozilla") && 0 == navigator.platform.indexOf("Win") && navigator.userAgent.indexOf("Edge") < 0 && navigator.userAgent.indexOf("Chrome") < 0 && navigator.userAgent.indexOf("Safari") < 0)
                i.strokeRect(u - 0.5, d - 0.5, y + 1, _ + 1, null, 1, 0.4);
              else {
                var B = e.configuration.pageDecoration, x = (B.shadow, B.shadowOffsetX || 0), P = B.shadowOffsetY || 0;
                i._canvasContext.shadowColor = B.shadowBackground || "rgba(0,0,0,0.5)", i._canvasContext.shadowBlur = B.shadow, i._canvasContext.shadowOffsetX = x, i._canvasContext.shadowOffsetY = P;
              }
            i.fillRect(u, d, y, _, R.paint, this.$bop), e.configuration.multiPageView && m.pagesCanOverlap && (i._canvasContext.shadowColor = "rgba(0,0,0,0)");
          }
      }
            ...
            if (t instanceof E) {
              if (i.hasClip() && !l)
                if (l = !0, e.configuration.isClipToPage()) {
                  ...
                  i.clipRect(T.getX(), T.getY(), T.getWidth(), T.getHeight());
              t.$bck && i.fillRect(u, d, y, _, t.$bck, t.$bop), t._paintChildren(e);
            }
          }.bind(this));
        }
      }
    ...
    if (e === r._Change.Store)
      ...
      var i = !1, o = t.properties.indexOf("w"), a = t.properties.indexOf("h");
      if (o >= 0 ? t.values[o] > 0 ? 0 == t.values[a] && (i = !0) : i = !0 : 0 == t.values[a] && (i = !0), this._scene)
      ...
      if (this._scene) {
        ...
        if (!m.pagesCanOverlap && (o >= 0 || a >= 0)) {
          var h = this.doCollisionlessTransform(new c(), null, !0).getTranslation(), A = this.getProperty("off") || new c();
    ...
    if (this._handleGeometryChangeForProperties(e, t, E.GeometryProperties), this._handleVisualChangeForProperties(e, t, E.VisualProperties), l.prototype._handleChange.call(this, e, t), e !== p._Change.InvalidationRequested || this._isInvalidating) {
      ...
      this._isInvalidating = !0, this._scene && (this.isPaintable() && (this._shouldRepaintThumbnail = !0), this._scene.visitLinks(this, function (e) {
        e instanceof E && e._requestInvalidation();
      }.bind(this))), this._isInvalidating = !1;
    ...
    var d = this.getPosition(!0), g = new c(1, 0, 0, 1, d.getX(), d.getY()), f = e.multiplied(g).mapRect(h), m = f.getX(), _ = f.getX() + f.getWidth(), v = f.getY(), b = f.getY() + f.getHeight(), C = f.getSide(A.Side.CENTER);
    do {
      o = !1, n.iteratePages(function (i) {
        if (t || i !== this) {
          var n = i.getGeometryBBox();
          if (n) {
            var l = i.getPosition(!0), p = (n = n.translated(l.getX(), l.getY()).expanded(s, a, a, a)).getX(), u = n.getX() + n.getWidth(), d = n.getY(), y = n.getY() + n.getHeight();
            if (n.intersectsRect(f)) {
              ...
              var E = 0, B = 0;
              return E = r.getX() > 0 ? u - m : p - _, B = r.getY() > 0 ? y - v : d - b, Math.abs(E) < Math.abs(B) ? B = 0 : E = 0, e = e.multiplied(new c(1, 0, 0, 1, E, B)), f = e.multiplied(g).mapRect(h), m = f.getX(), _ = f.getX() + f.getWidth(), v = f.getY(), b = f.getY() + f.getHeight(), C = f.getSide(A.Side.CENTER), o = !0, !1;
            }
          }
        }
      }.bind(this)), u++;
    ...
    if (this._preparePaint(e, t) && (this._paint(e, t), this._finishPaint(e), this._shouldRepaintThumbnail && e.configuration.pageThumbnails)) {
      ...
      i._getPageThumbnail(e.configuration.pageThumbnailSize, e.configuration.pageThumbnailSize, function (e) {
        e && (i._cachedImage = e, setTimeout(function () {
    ...
    g.canvas = d;
    var f = new v();
    if (f.paintMode = v.PaintMode.Full, f.paintSharp = !1, f.annotations = !1, g.configuration = f, f.clipArea = n.scaled(1, 1), f.clipDirty = !1, f.enableFxCache = !1, f.defaultEffectDetailLevel = 1, d.prepare(), d.setOrigin(new s(n.getX() * c, n.getY() * c)), d.setScale(c), C.isRenderPhase()) {
      var m = this;
