...
function (e, t, i) {
  var n = i(0), r = i(227), o = i(2), a = i(72), s = i(95), l = i(517), h = i(139), A = i(28), c = i(280);
  function p(e) {
    r.call(this), this._scene = e, this._scene.addEventListener(o.AfterInsertEvent, this._afterInsertEvent, this, void 0, void 0, !0), this._scene.addEventListener(o.AfterRemoveEvent, this._afterRemoveEvent, this, void 0, void 0, !0), e.getWorkspace() && (this._workspace = e.getWorkspace(), this._workspace.addEventListener(c.ResolveUrlEvent, this._resolveUrlEvent, this));
  }
  n.inherit(p, r), p.ResolvedMissingEntryEvent = function (e, t) {
    ...
    if (r.isDictionary(e.url) && e.scene === this._scene) {
      ...
      t && (/^(file|http|data|\/\/)/i.test(t) ? e.resolved(t) : this._workspace.trigger(new c.ResolveUrlEvent(t, e.scene, e.resolved)));
    }
    ...
    if (t && this.removeEntry(t), e.node.hasMixin(A)) {
      ...
      i && i.getLayers().forEach(function (e) {
    ...
    this._scene.accept(function (t) {
      if (t instanceof s) {
        var i = t.getProperty("url"), n = t.getProperty("storedUrl");
        e(i, n);
      }
      if (t.hasMixin(A)) {
