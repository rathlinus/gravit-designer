...
function (e, t, i) {
  var n = i(2), r = i(76), o = i(84), a = i(22), s = i(6), l = i(59), h = i(7), A = i(142);
  function c() {
  ...
  n.inheritAndMix("annlst", c, r, [
    ...
    rmd: !1,
    sid: null
  }, c.prototype.restored = !1, c.prototype._geometryBBox = null, c.prototype._paintBBox = null, c.prototype._savedPaintBBox = null, c.prototype._savedGeometryBBox = null, c.prototype._preTransformRect = null, c.prototype._preTransformRectTrf = null, c.prototype.appendAnnotation = function (e, t, i, n, r) {
    ...
    if (e && e.invertible()) {
      var i = null;
      (t = this.getGeometryBBox()) ? (i = e.inverted().mapQuadrilateral(t), t = s.fromPoints.apply(null, i)) : t = null;
    } else
    ...
    for (var i = null, n = this.getFirstChild(); null != n; n = n.getNext())
      if (n instanceof a) {
        ...
        r && (r.getHeight() > 0 || r.getWidth() > 0) && (i = i ? i.united(r) : r);
      }
    ...
    if (0 != (t & a.CollisionFlag.GeometryBBox) || 0 != (t & a.CollisionFlag.PaintBBox)) {
      ...
      s && (o = o && o.united(s) || s), o && (0 != (t & a.CollisionFlag.Partial) ? this._checkPartialCollision(r, o, e, !0, t, n) : r.containsRect(o, !0) && n(this));
    }
    return !0;
    ...
    if (e === n._Change.PrepareRestore)
      ...
      var i, o = 0, l = !1;
      t && Array.isArray(t) && (i = t[1], t = t[0]), "number" == typeof t && (o = t), 2 === o && (o = 0, l = !0), 1 === o ? this._paintBBox = null : 0 === o && (this._geometryBBox = null, this._preTransformRect = null, this._paintBBox = null);
