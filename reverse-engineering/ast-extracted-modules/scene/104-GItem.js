...
function (e, t, i) {
  var n = i(6), r = i(2), o = i(0), a = i(69), s = i(22), l = i(28), h = i(11), A = i(12);
  function c() {
    a.call(this), this._setDefaultProperties(c.MetaProperties), this._setDefaultProperties(s.Anchor.MetaProperties);
  }
  o.inheritAndMix(c, a, [s.Anchor]), c.MetaProperties = { clk: !1 }, c.prototype.skipBorderUpdate = !1, c.prototype.validateInsertion = function (e, t) {
    ...
    if (this.hasMixin(l) && (!t || !1 !== t.borderScale)) {
      ...
      if (i) {
        var a, s = i.decomposed().scale.getMatrix();
