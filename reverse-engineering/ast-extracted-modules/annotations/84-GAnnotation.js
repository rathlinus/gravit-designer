...
function (e, t, i) {
  ...
  a.Flag = { Hidden: 1 << 21 }, a.MetaProperties = {
    ...
    return l.setProperties([
      ...
      s || n.Type.User,
      !0
    ]), this.appendChild(l), l.setProperty("rmd", !1), l;
    ...
    if (!e.custom && !e.temporary && !this.isPropertiesIgnorable(e.properties)) {
      if (!this.isRestoring()) {
        ...
        t < 0 ? (e.properties.push("mtime"), e.values.push(o.now())) : this.recordedTransaction && (e.values[t] = o.now());
      }
