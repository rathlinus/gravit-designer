...
function (e, t, i) {
  var n = i(1423), r = i(293), o = i(338), a = i(359), s = i(1442), l = i(1443), h = i(640), A = i(11), c = i(7), p = i(791), u = function (e) {
      this.compress = e.compress, e.jpegQuality && (this._jpegQuality = e.jpegQuality), this._downsampleImages = !!e.downsampleImages, this.colorSpace = e.colorSpace, this.header = new s(e.version), this.body = new n(this, e.user, e.title), this._promises = [], this._executors = [], this._workers = e.workers, this._stackGraphics = [], this._jobs = [], this._tasksAreSubmitted = !1, this._promiseCapability = {}, this._promise = new p(function (e, t) {
        this._promiseCapability.resolve = e, this._promiseCapability.reject = t;
      }.bind(this));
    };
  u.prototype._workers = null, u.prototype._jobs = null, u.prototype._lastJob = null, u.prototype._promise = null, u.prototype._promiseCapability = null, u.prototype._tasksAreSubmitted = !1, u.prototype._abort = null, u.prototype._writer = null, u.prototype._executors = null, u.prototype._promises = null, u.prototype._jpegQuality = 85, u.prototype._downsampleImages = !1, u.prototype._resetPromise = function () {
    ...
    if (this._lastJob = e, e._status !== u.Job.Status.FAILED) {
      for (var t = 0; t < this._jobs.length; t++)
        if (this._jobs[t]._id === e._id) {
          this._jobs.splice(t, 1);
          break;
        }
    ...
    this._abort = !0, this._promiseCapability.reject(e), this._writer && this._writer.abort(), this._executors && this._executors.forEach(function (e) {
      e.abort();
    ...
    var t = this, i = function (e) {
        t._promises && t._promises.some(function (i, n) {
          if (i === e && t._promises)
            return t._promises.splice(n, 1), !0;
        });
    ...
    var i = this, n = new h(e, t, function () {
        i._executors && i._executors.some(function (e, t) {
          if (e === n && i._executors)
            return i._executors.splice(t, 1), !0;
        });
      });
