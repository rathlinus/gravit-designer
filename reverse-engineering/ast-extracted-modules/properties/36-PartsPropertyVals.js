...
function (e, t, i) {
  var n = i(39), r = i(22), o = i(84), a = i(66), s = i(0), l = i(6), h = i(12), A = i(56), c = i(7), p = i(87), u = i(63), d = i(59), g = i(5);
  i(9), i(47);
  function f(e) {
  ...
  s.inherit(f, a), f._Editors = {}, f.exports = function (e, t) {
    ...
    if (this.hasFlag(n.Flag.Selected) || this.hasFlag(n.Flag.Highlighted) || this.hasFlag(n.Flag.Outline)) {
      var t, i = this.getPaintElement(), r = this.getElement(), o = null;
      if (i && i != r)
        t = i;
      else {
      ...
      if (t.hasMixin(p)) {
        ...
        e = t.getGeometryBBox(), o && (e = o.mapRect(e));
    }
    return e;
    ...
    this._element.hasMixin(r.Layout) && (this._element._layoutTransform = null, t && t.noRelayout || (this._oldBBox = this._element.getGeometryBBox()), this._element._relayout = !0);
    ...
    if (t.hasMixin(r.Layout))
      if (t._layoutTransform = null, this._partSelection && this._partSelection.length || this._elementPreview)
        ...
        t._layoutTransform = i && i.invertible() ? i.inverted().multiplied(this._preTransform).multiplied(i) : this._preTransform, t._relayout = !0;
      }
    ...
    if ((this._transform || this._preTransform) && r) {
      ...
      if (!(l = this._transform && !this._transform.isIdentity() ? this._transform : null) && this._preTransform && !this._preTransform.isIdentity()) {
        ...
        l = s && s.invertible() ? s.inverted().multiplied(this._preTransform).multiplied(s) : this._preTransform, o = !0;
      }
    ...
    if (t.hasMixin(r.Layout) && t._relayout) {
      if (t._layoutTransform)
        ...
        l.equals(this._oldBBox, i) || !this._oldBBox || !i || h.isEqualEps(this._oldBBox.getWidth(), i.getWidth(), 1e-10) && h.isEqualEps(this._oldBBox.getHeight(), i.getHeight(), 1e-10) || t._layoutAnchorContents(i, this._oldBBox, null), this._oldBBox = null;
      }
      t._relayout = !1;
    }
    ...
    if (this._editors)
      for (var r = 0; r < this._editors.length; ++r)
        if (this._editors[r] instanceof f && !0 === this._editors[r].acceptDrop(e, t, i, n))
          return !0;
    return !1;
