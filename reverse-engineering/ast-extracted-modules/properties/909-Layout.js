...
function (e, t, i) {
  ...
  e.exports = function (e) {
    e.Layout = function () {
    }, e.Layout.prototype._relayout = !1, e.Layout.prototype._layoutTransform = null, e.Layout.prototype._relayoutNow = !1, e.Layout.prototype._handleLayoutChange = function (t, i) {
      ...
      for (var A = this.getFirstChild(); null !== A; A = A.getNext())
        A.hasMixin(e.Transform) && A.hasMixin(e.Anchor) && (A.getProperty("hacr") || A.getProperty("vacr")) && (A.dependentUpdate = !0, A.relayoutAnchored(o), A.dependentUpdate = !1);
      this._relayout = !1;
