...
function (e, t, i) {
  var n = i(11), r = i(7), o = i(0), a = i(17), s = i(28);
  function l() {
  }
  o.inherit(l, o), l._Editors = {}, l.exports = function (e, t) {
  ...
  }, l.PartInfo.prototype.id = null, l.PartInfo.prototype.data = null, l.PartInfo.prototype.editor = null, l.PartInfo.prototype.isolated = null, l.PartInfo.prototype.selectable = null, l.prototype._flags = 0, l.prototype._temporalOutlineFlag = !1, l.prototype._transform = null, l.prototype._parentEditor = null, l.prototype._editors = null, l.prototype._partSelection = null, l.prototype._blockDeletion = !1, l.prototype._color = null, l.prototype.hasFlag = function (e) {
    ...
    if (!1 === e.call(null, this))
      return !1;
    if (this._editors)
      for (var t = 0; t < this._editors.length; ++t)
        if (!1 === this._editors[t].accept(e))
          return !1;
    return !0;
      ...
      if (e && this._partSelection) {
        if (t) {
          ...
          for (var r = 0; r < this._partSelection.length; ++r)
            this._indexOfPartId(t, this._partSelection[r]) < 0 && i.push(this._partSelection[r]);
          for (r = 0; r < t.length; ++r)
            this._indexOfPartId(this._partSelection, t[r]) < 0 && i.push(t[r]);
          0 === i.length && (i = null);
        }
      } else
        i = t && t.length > 0 ? t.slice() : null;
