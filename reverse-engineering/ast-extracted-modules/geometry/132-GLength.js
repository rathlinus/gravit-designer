...
function (e, t, i) {
  ...
  s.Lexer = function () {
    ...
    function n(t) {
      ...
      if (i(e.peek(), ")") || (n = function () {
          for (var t, n = []; void 0 !== (t = l()) && (n.push(t), i(e.peek(), ","));)
            e.next();
          return n;
        }()), !i(e.next(), ")"))
        throw new SyntaxError("Expecting ) in a function call \"" + t + "\"");
    ...
    function r() {
      var o, s;
      return i(o = e.peek(), "-") || i(o, "+") ? (o = e.next(), s = r(), {
        Unary: {
          operator: o.value,
          expression: s
        }
        ...
        if (r.unit === t.Identifier)
          return r = e.next(), i(e.peek(), "(") ? n(r.value) : { Identifier: r.value };
        if (r.unit === t.Number)
