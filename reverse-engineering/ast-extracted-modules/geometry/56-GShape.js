...
function (e, t, i) {
  var n = i(264), r = i(2), o = i(187), a = i(11), s = i(265), l = i(139), h = i(141), A = i(69), c = i(5), p = i(87), u = i(14), d = i(104), g = i(28), f = i(132), m = i(68), y = i(59), _ = i(0), v = i(17), b = i(6), C = i(54), w = i(22), E = i(7), B = i(63), x = i(112), P = i(48), S = i(12), T = i(229), I = i(283), F = i(9);
  function R() {
  ...
  _.inheritAndMix(R, d, [
    ...
    trf: null,
    bool: n.OR
  }, R.VisualProperties = {}, R.MetaProperties = { scc: !0 }, R.MARKER_CACHE = {}, R.MARKER_SIZE = 10, R.HitResult = function (e, t) {
  ...
  }, R.prototype._paintSharp = !1, R.prototype.assignFrom = function (e) {
    ...
    if (t && !t.isEmpty()) {
      var i = t.getSide(b.Side.BOTTOM_LEFT), n = t.getSide(b.Side.BOTTOM_RIGHT);
      this.$trf && (i = this.$trf.mapPoint(i), n = this.$trf.mapPoint(n)), (e = S.normalizeAngleRadians(-Math.atan2(n.getY() - i.getY(), n.getX() - i.getX()))) > Math.PI && (e -= S.PI2);
    }
    return e;
  }, R.prototype.setTransform = function (e) {
    this.setProperty("trf", e);
  }, R.prototype.transform = function (e, t, i) {
    e && !e.isIdentity() && (this._layoutTransform = e, this._relayoutNow = !this._relayout, this._relayout = !0, this.setProperty("trf", this.$trf ? this.$trf.multiplied(e) : e), w.Transform.prototype.transform.call(this, e, t, i), this._relayoutNow && (this._layoutAnchorContents(null, null, this._layoutTransform), this._layoutTransform = null));
  }, R.prototype.preTransform = function (e, t, i) {
    e && !e.isIdentity() && (this._layoutTransform = this.$trf && this.$trf.invertible() ? this.$trf.inverted().multiplied(e).multiplied(this.$trf) : e, this._relayoutNow = !this._relayout, this._relayout = !0, this.setProperty("trf", this.$trf ? e.multiplied(this.$trf) : e), w.Transform.prototype.preTransform.call(this, e, t, i), this._relayoutNow && (this._layoutAnchorContents(null, null, this._layoutTransform), this._layoutTransform = null));
    ...
    if (t === g.StyleLayer.Fill) {
      ...
      t === g.StyleLayer.Border && (e.configuration.isOutline(e) ? this._paintBorder(e, i, null) : a.each(this.getPaintLayers().getBorderLayers(!0), function (t, n) {
    ...
    if (w.Stylable.prototype._isSeparateStylePaintLayer.call(this, e, t))
      return !0;
    var i = this.getPaintLayers().getBorderLayers(!0), n = function (e, t) {
    ...
    var l = null;
    return this.hasStyleBorder() && a.each(this.getPaintLayers().getBorderLayers(!0), function (e, t) {
    ...
    return i && (e = e.united(y.calculateBounds(i, !0).expanded(r, r, r, r))), n && (e = e.united(y.calculateBounds(n, !0).expanded(r, r, r, r))), e;
    ...
    if (this._paintSharp && (!e.configuration || e.configuration.paintSharp) && t instanceof u && this._scene && this._scene.getProperty("ut") === f.Unit.PX) {
      var r = 0;
      n ? r = 1 : this.hasStyleBorder() && (r = 0, a.each(this.getPaintLayers().getBorderLayers(!0), function (e, t) {
        var i = t.$_bw;
    ...
    var r = e.getTransform(), o = (n = n.multiplied(r)).mapRect(i).toAlignedRect(), s = n.inverted(), l = s ? s.mapRect(o) : i, h = E.getResizeTransform(i, b.Side.TOP_LEFT, l.getX() - i.getX(), l.getY() - i.getY(), !1, !1), A = h.mapRect(i);
    return h = h.multiplied(E.getResizeTransform(A, b.Side.BOTTOM_RIGHT, l.getX() + l.getWidth() - i.getX() - i.getWidth(), l.getY() + l.getHeight() - i.getY() - i.getHeight(), !1, !1));
      ...
      if (r) {
        ...
        if (r.transform && (this.$trf && (r.transform = r.transform.multiplied(this.$trf)), i.$_px && !i.$_px.isIdentity() && (r.transform = r.transform.preMultiplied(i.$_px))), s.hasClip() && (i.isSeparateLayer() && s.isClipped() || t && this.hasStyleFill() && this.hasStyleBorder() && this.$_ba === g.BorderAlignment.Outside)) {
          if (void 0 !== s.putVertices(o)) {
            s.clipVertices();
            var l = this.getPaintBBox(!1, null, n), h = this._createStyleCanvas(e, l);
            e.pushCanvas(h);
            try {
    ...
    if (this.getFirstChild()) {
      var i = this.getChildrenPaintBBox(), n = this.getGeometryBBox(e.isIncludingInvisible());
      if (!i || i.isEmpty())
        return;
      if (n.containsRect(i)) {
        if (void 0 === this._collidesWithChildren) {
          var r = new C();
          r.addVertex(P.Command.Move, i.getX(), i.getY()), r.addVertex(P.Command.Line, i.getX(), i.getY() + i.getHeight()), r.addVertex(P.Command.Line, i.getX() + i.getWidth(), i.getY() + i.getHeight()), r.addVertex(P.Command.Line, i.getX() + i.getWidth(), i.getY()), r.addVertex(P.Command.Close, 0, 0);
          var o = [], a = [];
      ...
      if (e.canvas.hasClip()) {
        ...
        try {
          void 0 !== h.putVertices(this) && h.clipVertices(this._isEvenOddFill());
          try {
        ...
        c && (void 0 !== e.canvas.putVertices(this) && (e.canvas.fillVertices(v.BLACK, 1, u.CompositeOperator.DestinationIn), c.drawCanvas(e.canvas)), e.canvas.finish(), e.popCanvas());
      }
    }
    ...
    if (this.hasStyleBorder()) {
      ...
      if (i.$_ba !== g.BorderAlignment.Center && (A *= 2), t && this.hasStyleFill() && i.$_ba === g.BorderAlignment.Outside && e.canvas.hasClip()) {
        var c = e.canvas, p = this._createStyleCanvas(e, this.getPaintBBox(!1, null, s));
        e.pushCanvas(p);
        try {
          var d = this.getGeometryBBox(s), f = this.getStyleBorderPadding(i);
          f && (d = d.expanded(f, f, f, f));
          var m = d = this._calculateMarkersBorderBBox(d, i), y = this, _ = e.canvas, b = this.getPaintLayers().getFillLayers(!0);
          ...
          p.putVertices(y), p.clipVertices(!0), p.clear(), p.resetClip(), c.drawCanvas(p, null, null, i.$_op, i.getBlendingForContext(e)), p.finish();
        } finally {
          e.popCanvas();
        }
      } else if (t) {
        ...
        try {
          this._paintBorderSeparate(e, !0, !0, !0, i), c.drawCanvas(C, null, null, 1, i.getBlendingForContext(e)), C.finish();
        } finally {
          e.popCanvas();
        }
      } else {
    ...
    if (this.hasStyleBorder()) {
      ...
      if (A && A.paint && void 0 !== o.putVertices(a)) {
        ...
        if (o.strokeVertices(v.BLACK, c, r.$_bds, r.$_blc, r.$_blj, y, 1), r.$_ba === g.BorderAlignment.Inside ? o.fillVertices(v.BLACK, 1, u.CompositeOperator.DestinationIn, !0) : r.$_ba === g.BorderAlignment.Outside && o.fillVertices(v.BLACK, 1, u.CompositeOperator.DestinationOut, !0), i && this._paintBorderMarkers(e, v.BLACK, r), m && m.invertible()) {
    ...
    if (i instanceof C) {
      if (l = i, !s) {
        ...
        for (var d = new P(); l.readVertex(d);)
          d.command !== P.Command.Close || l.hasVertexForRead() || (p = !0);
    ...
    if (this._handleGeometryChangeForProperties(e, t, R.GeometryProperties), e === r._Change.Store)
      ...
      for (var i = this.getFirstChild(); null !== i; i = i.getNext())
        i.hasMixin(w.Anchor) && (i.getProperty("vacr") || i.setProperty("vacr", w.Anchor.AnchorType.Start), i.getProperty("hacr") || i.setProperty("hacr", w.Anchor.AnchorType.Start));
    d.prototype._handleChange.call(this, e, t);
  }, R.prototype._invalidateGeometryForChildUpdate = function (e) {
    e && (this._childrenPaintBBox = null, this._collidesWithChildren = void 0, this._collidesWithChildrenSeparate = void 0);
  }, R.prototype._invalidatePaintBoxForChildUpdate = function () {
    this._childrenPaintBBox = null, this._collidesWithChildren = void 0, this._collidesWithChildrenSeparate = void 0;
  }, R.prototype._styleFinishGeometryChange = function (e) {
    if (w.Stylable.prototype._styleFinishGeometryChange.call(this, e), e) {
      var t = null;
      if (this.getParent() instanceof R && this.getParent().isFakeContainer() && (t = this.getParent()), t) {
        var i = t, n = this.getEffects(), o = i.getEffects(), s = [], l = !1;
          ...
          for (var h = 0, A = n.getFirstChild(); null !== A; A = A.getNext()) {
            if (m = o.getChildByIndex(h))
              if (A.constructor.equals(m, A)) {
                ...
                if (A.constructor.GeometryProperties && c.push(A.constructor.GeometryProperties), A.constructor.VisualProperties && c.push(A.constructor.VisualProperties), c)
                  e:
                    for (var p = 0; p < c.length; p++)
                      for (var u in c[p]) {
                        var d = A.getProperty(c[p][u]), f = i.getProperty(c[p][u]);
                        if (a.equals(d, f, !0)) {
                          s.push(m), m._beginBlockChanges([
                            r._Change.BeforePropertiesChange,
                            r._Change.AfterPropertiesChange
                          ]), m.transferProperties(A, c, !0), m._endBlockChanges([
                            r._Change.BeforePropertiesChange,
                            r._Change.AfterPropertiesChange
                          ]);
                          break e;
                ...
                l || (i._notifyChange(w._Change.PrepareGeometryUpdate), l = !0), o.insertChild(A.clone(), m), o.removeChild(m);
            else
