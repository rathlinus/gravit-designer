...
function (e, t, i) {
  var n = i(5), r = i(2), o = i(12), a = i(45), s = i(9);
  function l() {
  ...
  r.inherit("polygon", l, a), l.GeometryProperties = {
    ...
    for (var i = this.$oa + o.PI2, r = o.PI2 / this.$pts, a = this.$ia - this.$oa, s = t ? this.$trf : null, l = this.$oa; l < i - 0.000001; l += r) {
      var h = new n(this.$or * Math.cos(l) + this.$cx, this.$or * Math.sin(l) + this.$cy);
      if (s && (h = s.mapPoint(h)), !0 === e(h, !1, l))
        break;
      if (h = new n(this.$ir * Math.cos(l + a) + this.$cx, this.$ir * Math.sin(l + a) + this.$cy), s && (h = s.mapPoint(h)), !0 === e(h, !0, l + a))
        break;
    }
    ...
    return this.iterateSegments(function (r, o, a) {
      if (0 !== n || o)
        ...
        e = r;
      return ++n, !1;
    }, !0), e && t && i && (r = Math.min(o.ptDist(t.getX(), t.getY(), e.getX(), e.getY()), o.ptDist(t.getX(), t.getY(), i.getX(), i.getY()))), r;
