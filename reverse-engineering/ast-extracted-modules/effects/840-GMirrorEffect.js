...
function (e, t, i) {
  var n = i(50), r = i(2), o = i(28), a = i(7), s = i(17), l = i(147), h = i(14), A = i(6), c = i(12), p = i(9);
  function u() {
  ...
  r.inherit("mirrorEffect", u, o.Effect), u.prototype._theirsPadding = null, u.prototype._oursPadding = null, u.equals = function (e, t) {
    ...
    if (this.$pat && this.$opc > 0) {
      ...
      var v = t.getTransform(!1).inverted().mapRect(new A(0, u + c, t.getWidth(), p + d)), b = t.createPatternPaint(this.$pat, v);
      if (b)
        if (b.transform) {
