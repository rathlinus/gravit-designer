...
function (e, t, i) {
  var n = i(50), r = i(2), o = i(28), a = i(17), s = i(14), l = i(6), h = i(249), A = i(9);
  function c() {
  ...
  r.inherit("innerShadowEffect", c, o.Effect), c.prototype._blur = null, c.equals = function (e, t) {
    ...
    if (this.$pat && this.$opc > 0 && this.$r >= 0) {
      var a = t.getTransform(!1).inverted().mapRect(new l(0, 0, t.getWidth(), t.getHeight())), h = t.createPatternPaint(this.$pat, a);
      if (h)
        if (h.transform) {
      ...
      t.drawCanvas(e, c, p, 1, s.CompositeOperator.DestinationOut), u > 0 && (s.disableFilters(), !s.hasFilters() && this._blur._glblur && (this._blur._glblur._isAffectedByGLBug = !0), this._blur.$r = this.$r, this._blur.render(t, null, null, n, r, o), s.enableFilters()), t.drawCanvas(e, 0, 0, 1, s.CompositeOperator.DestinationIn);
    }
