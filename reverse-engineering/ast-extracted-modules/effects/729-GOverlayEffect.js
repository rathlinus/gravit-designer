...
function (e, t, i) {
  var n = i(147), r = i(50), o = i(2), a = i(28), s = i(17), l = i(14), h = i(6), A = i(9);
  function c() {
  ...
  o.inherit("overlayEffect", c, a.Effect), c.equals = function (e, t) {
    ...
    if (this.$pat && this.$opc > 0) {
      var r = e.getTransform(!1).inverted().mapRect(new h(0, 0, e.getWidth(), e.getHeight())), o = e.createPatternPaint(this.$pat, r);
      if (o) {
