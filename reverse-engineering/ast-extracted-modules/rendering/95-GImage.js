...
function (e, t, i) {
  var n = i(2), r = i(76), o = i(0), a = i(17), s = i(68), l = i(56), h = i(72), A = i(6), c = i(12), p = i(73), u = i(14), d = i(22), g = i(7), f = i(45), m = i(112), y = i(11), _ = i(932), v = i(659), b = i(227), C = i(9), w = i(64), E = i(103), B = i(118);
  i(111);
  function x() {
    p.call(this), this._convertStatus = x.ConvertStatus.None, this._paintSharp = !1, this._setDefaultProperties(x.MetaProperties, x.VisualProperties, x.GeometryProperties), this.setProperty("csc", !0), this._updateImage();
  }
  n.inheritAndMix("image", x, p, [B]), x.options = { renderBox: !0 }, x.MetaProperties = {
    iw: null,
    ih: null,
    tmpUrl: null,
    storedUrl: null
  ...
  }, x.prototype._convertStatus = x.ConvertStatus.None, x.prototype._type = null, x.prototype._image = null, x.prototype._imageCanvas = null, x.prototype._imageCanvasOffscreen = null, x.prototype._vertexIterator = 0, x.prototype._updatingUrl = !1, x.prototype.getStatus = function () {
    return this._status;
    ...
    if (!this._imageCanvas && this._image) {
      ...
      return e.width = this._image.naturalWidth, e.height = this._image.naturalHeight, e.getContext("2d").drawImage(this._image, 0, 0), e;
    }
    ...
    if (this._status === x.ImageStatus.Loaded)
      ...
      var i = new A(this.$px, this.$py, this.$pw ? this.$pw : this.getWidth(), this.$ph ? this.$ph : this.getHeight());
      t = this.$trf ? this.$trf.mapRect(i) : i;
    }
    if (this.$dblMode) {
    ...
    this.$dblMode ? p.prototype.transform.call(this, e, t) : e && !e.isIdentity() && (this._layoutTransform = e, this._relayoutNow = !this._relayout, this._relayout = !0, this.transformStyledCorners(this, e), this.setProperties([
      "trf",
      "itrf"
    ], [
    ...
    if (t instanceof x) {
      var i = t.getTransform() || new g(), n = t.getImageTransform() || new g();
      this.setProperties([
        "trf",
        "itrf"
      ], [
    ...
    if (this.$dblMode)
      p.prototype.preTransform.call(this, e, !1);
    else if (e && !e.isIdentity()) {
      var n = this.$trf && this.$trf.invertible() ? this.$trf.inverted().multiplied(e.multiplied(this.$trf)) : e;
      this.transformStyledCorners(this, n), this._layoutTransform = n, this._relayoutNow = !this._relayout, this._relayout = !0, this.setProperties([
        "trf",
        "itrf"
      ], [
        this.$trf ? e.multiplied(this.$trf) : e,
        this.$itrf ? this.$itrf.multiplied(n) : n
      ]), d.Transform.prototype.preTransform.call(this, e, t, i), this._relayoutNow && (this._layoutAnchorContents(null, null, this._layoutTransform), this._layoutTransform = null, this._relayoutNow = !1);
    }
    ...
    }), this.$ipfc && (t.blob.ipfc = !0)) : e == n._Change.BeforePropertiesChange ? t.properties.indexOf("url") >= 0 && this._scene && this._scene.getDictionary().removeEntry(this.$url) : e == n._Change.AfterPropertiesChange ? (t.properties.indexOf("tmpUrl") >= 0 && this._updateTemporaryImage(), t.properties.indexOf("url") >= 0 && !this._updatingUrl && (this._updatingUrl = !0, this.$storedUrl = null, this._updateUrl(), this._updateImage(), this._updatingUrl = !1), (t.properties.indexOf("px") >= 0 || t.properties.indexOf("py") >= 0 || t.properties.indexOf("pw") >= 0 || t.properties.indexOf("ph") >= 0) && this._updateImageRect(this.$px, this.$py, this.$pw ? this.$pw : this.getWidth(), this.$ph ? this.$ph : this.getHeight())) : e !== r._Change.SceneAttached && e !== n._Change.WorkspaceAttached || (this._updatingUrl = !0, this._updateUrl(), this._scene && this._scene.addDestroyable(this), this._workspace && this._scene && this._status === x.ImageStatus.Delayed && this._updateImage(), this._updatingUrl = !1), p.prototype._handleChange.call(this, e, t), this._handleGeometryChangeForProperties(e, t, x.GeometryProperties), this._handleGeometryChangeForProperties(e, t, x.VisualProperties), e === n._Change.Restore && (this.restoreProperties(t.blob, x.VisualProperties), this.restoreProperties(t.blob, x.GeometryProperties, function (e, t) {
      return "itrf" === e && t ? g.deserialize(t) : t;
    }), this.restoreProperties(t.blob, x.MetaProperties), this.setProperty("csc", !0), t.blob.hasOwnProperty("ipfc") || this.setProperty("ipfc", !1), !this.$trf || this.$itrf || this.$pw || this.$ph || this.setProperties(["itrf"], [this.$trf]), this._updatingUrl = !0, this._updateUrl(), this._updateImage(), this._updatingUrl = !1);
  }, x.prototype._updateUrl = function () {
    if (this._scene) {
      var e = this._scene.getDictionary().getValue(this.$url);
      if (this.$storedUrl ? e ? e !== this.$storedUrl && (b.isDictionary(e) ? this.$storedUrl = e : e = this.$storedUrl) : this.$url = this.$storedUrl : this.$storedUrl = e, !b.isDictionary(this.$url)) {
        var t = this.$url;
        if (this._scene.getDictionary().getEntries().some(function (e) {
            return e.value === t;
          }))
          return;
        var i = this._scene.getDictionary().putValueIfAbsent(t);
        i && (null === e && (this._status !== x.ImageStatus.Loaded || this._imageCanvas ? (this._imageCanvas = null, this._imageCanvasOffscreen = null) : (this._image = null, this._imageCanvasOffscreen = null)), this.setProperty("url", i.getUrl()));
      }
    }
    ...
    if (E.isMultiThreaded(e.canvas.parent)) {
      ...
      var t, i, n = this._imageCanvas || this._image;
      this._imageCanvas ? (t = this._imageCanvas.width, i = this._imageCanvas.height) : (t = this._image.naturalWidth, i = this._image.naturalHeight);
      var r = new OffscreenCanvas(t, i), o = r.getContext("2d");
      o.globalCompositeOperation = "copy", o.drawImage(n, 0, 0);
      var a = E.getRenderer(!0, "2d", void 0, !0, !0);
      return this._imageCanvasOffscreen = a.canvas, a.canvas.$renderedBitmapSource = r, a.canvas.width = t, a.canvas.height = i, this._imageCanvasOffscreen;
    }
    ...
    if (this._imageCanvas || this._status === x.ImageStatus.Loaded && this._image) {
      var r = !1, o = null;
      t.hasClip() && (this.$dblMode || this.$uf && (this.$tl_ct !== f.CornerType.Rounded || 0 === this.$tl_sx)) ? (t.putVertices(this), t.clipVertices(), r = !0) : o = e.pushCanvas(e.canvas.createCanvas(this.getGeometryBBox(e.isIncludingInvisible())));
      var s = e.canvas.getTransform(!0);
      this.$itrf && e.canvas.setTransform(s.preMultiplied(this.$itrf)), e.canvas.drawImage(this._getProperImageCanvas(e), 0, 0, !1, i, n), e.canvas.setTransform(s), r ? t.resetClip() : (void 0 !== e.canvas.putVertices(this) && (e.canvas.fillVertices(a.BLACK, 1, u.CompositeOperator.DestinationIn), o.drawCanvas(e.canvas)), e.canvas.finish(), e.popCanvas()), this.$dblMode && (s = t.getTransform(!0), this.$itrf && t.setTransform(s.preMultiplied(this.$itrf)), t.drawImage(this._imageCanvas || this._image, 0, 0, !1, i ? i / 2 : 0.5, n), t.setTransform(s));
    ...
    if (this.$tmpUrl && this._status !== x.ImageStatus.Loaded) {
      var e = new Image();
      e.width = this.getWidth(), e.height = this.getHeight(), this.$tmpUrl && this.$tmpUrl.match(/^(http|https|\/\/)/) ? e.crossOrigin = "Anonymous" : e.crossOrigin = null, e.onload = function () {
        this._status !== x.ImageStatus.Loaded && 0 !== e.naturalWidth && 0 !== e.naturalHeight && (this._notifyChange(d._Change.PrepareGeometryUpdate), this._initImageCanvas(e), this._updateImageRect(0, 0, e.naturalWidth, e.naturalHeight), this._notifyChange(d._Change.FinishGeometryUpdate));
      }.bind(this), e.src = this.$tmpUrl;
    }
    ...
    for (var t = new Uint8ClampedArray(e), i = Object.keys(x.Type).map(function (e) {
          return x.Type[e];
        }), n = 0; n < i.length; n++) {
      var r = x._BOM[i[n]], o = Array.from(t.slice(0, r.length));
      if (y.equals(o, r))
        return i[n];
    }
    ...
    if (t && t.cachedCanvas)
      ...
      if (this._image && this._image.url === e)
        ...
        if (n && e.length > w.maxImgDataUrlLength)
          ...
          var p, u = this;
          if (p = "undefined" == typeof navigator ? i(819).XMLHttpRequest : window.XMLHttpRequest ? XMLHttpRequest : ActiveXObject("Microsoft.XMLHTTP"), 0 === e.indexOf("file://") && -1 !== e.indexOf("\\")) {
            var d = e.substr("file://".length).replace(/\\/g, "/");
            0 !== d.indexOf("/") && (d = "/" + d), e = "file://" + d;
          }
          var g = new p();
          g.responseType = "arraybuffer", g.open("GET", e, !0), g.onreadystatechange = function (t) {
            if (this.readyState == this.DONE) {
              var i = t.target.response;
              u._type = u._getType(i), u._image.src = e;
            }
          }, g.send();
        }
      }
    ...
    if (this._scene && this.$url) {
      var e = this._scene.getDictionary();
      if (e)
        return e.getEntry(this.$url);
    }
    return null;
    ...
    if ("undefined" != typeof HTMLCanvasElement && e instanceof HTMLCanvasElement) {
      ...
      var t = this._getDictImageEntry();
      if (t) {
        if ("undefined" != typeof HTMLImageElement && t.cachedCanvas instanceof HTMLImageElement && !E.usingOffscreenCanvas())
          return this._imageCanvas = null, this._imageCanvasOffscreen = null, this._image = t.cachedCanvas, void this._resetFxCacheAndState();
        if (!this._scene.getDictionary().setCachedCanvas(t, this._imageCanvas))
          return this._scene.getDictionary().setCachedCanvas(t, e), this._imageCanvas = null, this._imageCanvasOffscreen = null, this._image = e, void this._resetFxCacheAndState();
      }
