...
function (e, t, i) {
  var n = i(50), r = i(0), o = i(641), a = i(11);
  function s(e) {
    ...
    if (e in s.IccProfileNames)
      if (e in s.IccProfiles)
        ...
        if (t && 0 === t.indexOf("file"))
          ...
          }), n && l.addEventListener("loadend", n, !1), l.open("GET", (t || "assets/data/icc/") + s.IccProfileNames[e]), l.responseType = "arraybuffer", l.send(null);
        }
      }
