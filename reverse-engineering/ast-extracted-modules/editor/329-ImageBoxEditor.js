...
function (e, t, i) {
  var n = i(11), r = i(5), o = i(39), a = i(52), s = i(24), l = i(59), h = i(0), A = i(17), c = i(330), p = i(56), u = (i(22), i(45)), d = i(73), g = i(6), f = i(54), m = i(7), y = i(82), _ = i(63), v = i(36), b = i(66), C = i(48), w = i(95), E = i(12), B = i(229), x = i(14), P = i(9), S = i(47);
  function T(e) {
    c.call(this, e);
  }
  ...
  T.Annots = {
  ...
  }, T.prototype._editMode = !1, T.prototype.initialSetup = function (e) {
  }, T.prototype.createElementPreview = function () {
    if (!this._elementPreview) {
      var e = this._element.getSourceBBox();
      this._setElementPreview(new d(e.getX(), e.getY(), e.getWidth(), e.getHeight())), this._elementPreview.transferProperties(this._element, [
    ...
    e === T.CROPFRAME_PART_ID ? this.canApplyTransform() ? (this._prepareApplyTransform(this._element), this._applyTransform(this._element)) : this.resetTransform() : e === T.IMAGEINTERNAL_PART_ID && (this._element.setImageTransform(this._element.getImageTransform(), !0), this._imgBoxEditor && o.prototype.resetTransform.call(this._imgBoxEditor)), c.prototype._applyPartMove.call(this, e, t, i, n);
    ...
    var s = new B();
    return l.hitTest(e.getX(), e.getY(), r, 2 * i, !1, s) ? new o.PartInfo(this, T.CROPFRAME_PART_ID, { point: e }, !0, !1) : null;
    ...
    if (i && !i.isEmpty()) {
      ...
      if (o >= h && a >= h && s >= A && l >= A) {
        ...
        for (var d = E.getRotationSegment(n.c, n.tc), y = E.getRotationSegment(n.c, n.rc), v = (y >= 3 ? y : d - y >= 4 ? y + 8 : y) > (d >= 3 ? d : y - d >= 4 ? d + 8 : d), C = 0; C < u.length; ++C) {
          ...
          if (!0 === t(w.vertices, w.point, w.side, B))
            break;
        }
      }
    }
    ...
    if (n > 0 && o > 0) {
      ...
      v ? (a.addVertex(C.Command.Move, l.getX(), l.getY()), a.addVertex(C.Command.Line, t.getX(), t.getY()), a.addVertex(C.Command.Line, h.getX(), h.getY()), a.addVertex(C.Command.Line, y.getX(), y.getY()), a.addVertex(C.Command.Line, v.getX(), v.getY()), a.addVertex(C.Command.Line, u.getX(), u.getY()), a.addVertex(C.Command.Close), s = !0) : (v = E.getIntersectionPoint(l.getX(), l.getY(), u.getX(), u.getY(), h.getX(), h.getY(), y.getX(), y.getY())) ? (a.addVertex(C.Command.Move, l.getX(), l.getY()), a.addVertex(C.Command.Line, t.getX(), t.getY()), a.addVertex(C.Command.Line, h.getX(), h.getY()), a.addVertex(C.Command.Line, v.getX(), v.getY()), a.addVertex(C.Command.Close), s = !0) : (a.addVertex(C.Command.Move, l.getX(), l.getY()), a.addVertex(C.Command.Line, t.getX(), t.getY()), a.addVertex(C.Command.Line, h.getX(), h.getY()), a.addVertex(C.Command.Close), s = !0);
    }
    return s;
    ...
    if (n > 0) {
      ...
      o.addVertex(C.Command.Move, A.getX(), A.getY()), o.addVertex(C.Command.Line, p.getX(), p.getY()), o.addVertex(C.Command.Line, u.getX(), u.getY()), o.addVertex(C.Command.Line, c.getX(), c.getY()), o.addVertex(C.Command.Close), a = !0;
    }
    return a;
