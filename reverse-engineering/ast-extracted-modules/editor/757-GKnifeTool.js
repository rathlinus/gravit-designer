...
function (e, t, i) {
  var n = i(2), r = i(69), o = i(187), a = i(77), s = i(5), l = i(87), h = i(104), A = i(179), c = i(60), p = i(52), u = i(24), d = i(113), g = i(59), f = i(0), m = i(56), y = i(70), _ = i(541), v = i(141), b = i(54), C = i(22), w = i(7), E = i(122), B = i(45), x = i(82), P = i(99), S = i(233), T = i(63), I = i(112), F = i(229), R = i(48), D = i(95), k = i(1079), G = i(12), Q = i(81), M = i(64), N = i(17), U = i(9), V = i(47);
  function O() {
    _.call(this);
  }
  f.inherit(O, _), O.prototype.activate = function (e, t) {
    ...
    if (t - this._mDownTime < _.DBLCLICKTM)
      ...
      var i = null;
      if (this._lastMouseEvent = e, this._dragStarted = !1, this._dragStartPt = null, this._mouseMove(e), this._mDownTime = t, this._released = !1, M.modifiers.optionKey && (this._firstAlt = !0), this._blockDeactivation(), this._checkMode(), this._renewPreviewLink(), this._newPoint && this._pathEditor) {
        ...
        this._editor.getGuides().beginMap(this._editor.getMappingScopes()), o = this._editor.getGuides().mapPoint(o, P.DetailMap.Mode.DetailOnFilterOn), this._editor.getGuides().finishMap(), i = this._constructNewPoint(e, o), e.button == a.BUTTON_RIGHT && (M.modifiers.optionKey ? i.setProperty("tp", B.AnchorPoint.Type.Connector) : i.setProperties([
          "tp",
          "cu"
        ], [
          B.CornerType.Rounded,
    ...
    if (this._pathEditor) {
      var e, t = this._pathEditor.getPathPreview();
      if (this._editPt)
    ...
    if (this._released || !this._firstAlt) {
      ...
      if (!this._newPoint && this._pathEditor) {
        i = this._constrainIfNeeded(e.client, this._view.getWorldTransform(this._view.getScene().getActivePage()), this._pathRef);
        var n = this._view.getViewTransform(this._view.getScene().getActivePage()).mapPoint(i);
        this._editor.getGuides().beginMap(this._editor.getMappingScopes()), n = this._editor.getGuides().mapPoint(n, P.DetailMap.Mode.DetailOnFilterOn), this._editor.getGuides().finishMap(), i = this._view.getWorldTransform(this._view.getScene().getActivePage()).mapPoint(n), t = this._constructNewPoint(e, n), this._addPoint(t, !0, !1, !0);
      } else
        this._editPt && (this._invalidate(), i = this._updatePoint(e.client), this._invalidate());
      if (this._editPt)
    ...
    if (this._pathEditor.hitAnchorPoint(this._editPt, e, this._view.getWorldTransform(this._view.getScene().getActivePage()), 0) && !this._firstAlt)
      ...
      if (this._newPoint || !M.modifiers.optionKey || !this._firstAlt || n == B.AnchorPoint.Type.Connector || null == this._editPt.getPrevious() && null == this._editPt.getNext())
        ...
        i = null != v ? v + y : a.getY(), this._editPt.setProperty("ah", !1), this._editPt.setProperties([
          "tp",
          "hrx",
          "hry"
        ], [
    ...
    this._pathEditor ? (this._invalidate(), r || this._dpathRef.getAnchorPoints().getLastChild().removeFlag(n.Flag.Selected), this._dpathRef.getAnchorPoints().appendChild(e), this._editPt = this._dpathRef.getAnchorPoints().getLastChild(), this._newPoint = !0, this._invalidate()) : (this._knifePath = new c(), this._knifePath.getAnchorPoints().appendChild(e), e.setFlag(n.Flag.Selected), this._knifePath.setFlag(n.Flag.Selected), this._checkPathEditor(), this._checkMode(), this._renewPreviewLink(), this._editPt = this._dpathRef.getAnchorPoints().getLastChild(), this._invalidate());
    ...
    this._dragStarted = !1, this._dragStartPt = null, this._lastMouseEvent = e, this._firstAlt = !1, this._reset(), this._editor.getGuides().invalidate(), this._allowDeactivation();
  }, O.prototype._reset = function () {
    if (this._invalidate(), this._dpathRef = null, this._pathRef = null, this._pathEditor = null, this._newPoint = !1, this._editPt = null, this._dragStartPt = null, this._refPt = null, this._compoundPathEditor = null, this._cached) {
    ...
    if (this._invalidate(), M.modifiers.spaceKey) {
      if (this._lastMouseEvent && this._lastMouseEvent.clientDelta && this._editPt) {
        var i = this._editPt.getProperty("x"), n = this._editPt.getProperty("y"), r = new s(i + this._lastMouseEvent.clientDelta._x, n + this._lastMouseEvent.clientDelta._y);
        r = this._updatePoint(r), this._invalidate(), t = t.add(new s(r.getX() - i, r.getY() - n));
      }
    } else
    ...
    for (var i = e, r = i.getAnchorPoints(), o = i.getTransform(), a = r.getFirstChild(); null != a; a = a.getNext()) {
    ...
    return this._iteratePoints(this._dpathRef, function (t) {
      t.leftHandlePosition && i(Q.getAnnotationBBox(e, t.leftHandlePosition, u.annotationHandles.path.control.size, !0)), t.rightHandlePosition && i(Q.getAnnotationBBox(e, t.rightHandlePosition, u.annotationHandles.path.control.size, !0)), i(Q.getAnnotationBBox(e, t.position, u.annotationHandles.path.node.size, !0));
    }.bind(this)), t;
  }, O.prototype.getPathPreview = function () {
    if (!this._elementPreview) {
      this._invalidate();
      var e = this._knifePath.getAnchorPoints().getFirstChild(), t = new c.AnchorPoint();
      t.setProperties([
        "x",
        "y"
      ], [
        e.getProperty("x"),
        e.getProperty("y")
      ]), this._elementPreview = new c(), this._elementPreview.getAnchorPoints().appendChild(t), e.setFlag(n.Flag.Selected), t.setFlag(n.Flag.Selected), this._elementPreview.setFlag(n.Flag.Selected), this._invalidate();
    }
    ...
    if (e) {
      ...
      return i && (r = r ? r.multiplied(i) : i), Q.getAnnotationBBox(r, new s(e.getProperty("x"), e.getProperty("y")), u.annotationHandles.path.node.size, !1).expanded(n, n, n, n).containsPoint(t);
    }
    return !1;
    ...
    var e = !1, t = this._dpathRef, i = new o(), n = [], r = null;
    ...
    for (v = 0; v < g.length; v++) {
      ...
      if (P.getParent() && (h = P.getParent(), p = P.getNext(!0)), x !== this._dpathRef && x !== this._pathRef) {
        for (var T, I, F, D = [
              ...
              [],
              []
            ], G = this.convertToPath(x), Q = x.getProperty("evenodd"), M = "boolean" == typeof Q && !Q, N = [], U = !1, V = 0; V < G.length; V++) {
          I = [], F = [], T = G[V];
        ...
        for (V = 0; V < G.length; V++) {
          var Y = [
              ...
              [],
              []
            ], X = [], H = [], W = [], Z = !1, z = !1, j = t.clone();
          T = G[V];
          for (O = 0; O < T.length; O++) {
            var J = T[O], q = i.intersect(j, J), K = c.addIntersectionPoints(j, J, q, !0);
          ...
          if ($ && $ !== k.UNCHANGED && (U = !0, Y[0] = Y[0].concat($[0]), Y[1] = Y[1].concat($[1]), Y[2] = Y[2].concat($[2])), !$) {
            D = null;
            break;
          }
          ...
          for (var te = 0; te < 3; te++) {
            ...
            for (B = 0; B < ie.length; B++) {
              var re = ie[B];
              re && (re instanceof c || (re = A.createPathFromVertexSource(re, !1, !1, !0)), ne && re ? ne.getPaths().appendChild(re) : re && (M && re.setProperty("evenodd", !1), D[te].push(re)));
            }
    ...
    var i = new F();
    if (g.hitTest(e.getX(), e.getY(), t, 2, !1, i) && (elemHitRes = new I(this, i), i.outline && 0 != i.slope && 1 != i.slope)) {
