...
function (exports, module, require) {
  ...
  (function (e) {
    ...
    var c = function (e, t) {
      ...
      try {
        for (
          var a = s(['string', 'number', 'boolean', 'undefined']), r = a.next();
          !r.done;
          r = a.next()
        ) {
    ...
    Object.entries ||
      (Object.entries = function (e) {
        for (
          var module = Object.keys(e), require = module.length, o = new Array(require);
          require--;
        )
    ...
    var d = (function () {
            ...
            return {
              ...
              updateUserProperties: function (e) {
                var t,
                  ...
                  d = n.userProperties || {};
                try {
                  for (var u = s(Object.entries(e)), p = u.next(); !p.done; p = u.next()) {
                    var g = l(p.value, 2),
                      h = g[0],
                      f = g[1];
                    switch (h) {
                      case '$set':
                        try {
                          for (
                            var m = ((i = undefined), s(Object.entries(f))), y = m.next();
                            !y.done;
                            y = m.next()
                          ) {
                            var v = l(y.value, 2),
                      ...
                      case '$unset':
                        try {
                          for (
                            var w = ((r = undefined), s(Object.keys(f))), C = w.next();
                            !C.done;
                            C = w.next()
                          ) {
                            delete d[(_ = C.value)];
      ...
      u = 'undefined' != typeof globalThis ? globalThis : undefined !== e ? e : self,
      p = (function () {
        function e() {
        ...
        return (
          (e.getInstance = function (t) {
            return (
              u.analyticsConnectorInstances || (u.analyticsConnectorInstances = {}),
              u.analyticsConnectorInstances[t] || (u.analyticsConnectorInstances[t] = new e()),
