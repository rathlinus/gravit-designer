  ...
  (Object.defineProperty(module, '__esModule', { value: true }),
    ...
    (module.handleCollabsData = async function (e) {
      ...
      let _interopRequireDefault,
        ...
        u = [];
      if (module.length) {
        ((_interopRequireDefault = module.filter((e) =>
          e.getRole().is(AppSettings.ShareRoles.Reviewer)
        )),
          ...
          n.id === module.MENTION_ALL.id
            ...
            : n.id === module.MENTION_OWNER.id
              ...
              : n.id === module.MENTION_ALL_REVIEWERS.id
                ? e.replace(module.MENTION_ALL_REVIEWERS.showText, module.MENTION_ALL_REVIEWERS.id)
