...
function (exports, module, require) {
  ...
  (require(328) /* polyfill_Array_sort */,
    ...
    require(865) /* polyfill_Number_toFixed */,
  ...
  var v = null,
    ...
    x = null,
    S = null;
  class E extends GProperties {
    constructor() {
      super();
      ((this._elements = []),
      (v = GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.most-used'))),
      (_ = GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.blur'))),
      (b = GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.artistic'))),
      (w = GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.adjust'))),
      (C = GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.distortion'))),
      (x = GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.other'))),
      (S = GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.shadow'))),
      V || (V = H()));
    }
            ...
            .gRichTooltip(
              s.GRichTooltipConfig.from({
                ...
                description: GCore.GLocale.get(
                  new GCore.GLocaleKey('GEffectProperties', 'text.add-effect-tooltip-description')
                ),
                learnMore: '',
              })
            )
        ...
        var _interopRequireDefault = function (e, t) {
            ...
            (function () {
              (gDesigner.stats(
                ...
                (e && GCore.GLocale.getValue((t && t.i18n) || e, 'name', 'unknown', 0)) || 'unkn'
              ),
    ...
    _insertEffect(e, t) {
      var n = this,
        ...
        v = function () {
          GTools.GEditor.tryRunTransaction(
            ...
            GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'action.toggle-collapse'))
          );
        }.bind(this),
        _ = function (t) {
          (t.stopPropagation(),
            GTools.GEditor.tryRunTransaction(
              ...
              GCore.GLocale.get(
                new GCore.GLocaleKey('GEffectProperties', 'action.toggle-visibility')
              )
            ));
        }.bind(this),
        b = function (t) {
          ...
          (gDesigner.stats(
            ...
            GCore.GLocale.getValue((n && n.i18n) || e, 'name', e.getNodeName(), 666)
          ),
            t.stopPropagation(),
            GTools.GEditor.tryRunTransaction(
              e,
              ...
              GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'action.remove'))
            ));
        ...
        P = $('<div></div>')
          ...
          .on('mousedown', function (e) {
            ((A =
              ...
              $(e.target).closest('.effect-block').toggleClass('g-draggable-disabled', !A));
          })
          .on('click', function (e) {
                ...
                $(t).append(
                  $('<div></div>')
                    ...
                    .on('dragleave', function () {
                      G(this.parentNode) && $(this).parent().find('.g-drop-indicator').remove();
                    })
                      ...
                      if (
                        ...
                        GTools.GEditor.tryRunTransaction(
                          ...
                          r.GPlatform.modifiers.shiftKey
                            ...
                            : GCore.GLocale.get(
                                new GCore.GLocaleKey('GEffectProperties', 'action.move')
                              )
                        );
                      }
                      T = null;
            ...
            E.append(
              ...
              .append(
                $('<div></div>')
                  ...
                  .append(
                    $('<label></label>').append($('<span></span>').text(e.getNodeNameTranslated()))
                  )
              )
              .append(
                $('<div></div>')
                  ...
                  .append(
                    $('<span></span>').addClass(
                      'gravit-icon-' + (e.getProperty('vs') ? 'display' : 'hide')
                    )
                  )
              )
              .append(
              ...
              .append(
                $('<div></div>')
                  ...
                  .append(
                    $('<span></span>').addClass(
                      'gravit-icon-touch-' + (e.getProperty('vs') ? 'show' : 'hide')
                    )
                  )
              )
          );
      ...
      (w && w.length > 0 ? P.insertBefore(w) : P.appendTo(this._effectsPanel.find('.effects')),
        ...
        P.on('mouseenter', (t) => {
          (this._document && this._document.updateActiveStylesList('Effect', e),
        ...
        if (r.data('effect') === e) {
          ...
          return (
            ...
            r
              ...
              .toggleClass('gravit-icon-fill', GTouchTool === GCore.GStylable.StyleLayer.Fill)
              .toggleClass('gravit-icon-stroke', GTouchTool === GCore.GStylable.StyleLayer.Border),
            false
          );
        }
      });
    ...
    _removeEffect(e) {
      this._effectsPanel.find('.effect-block').each(function (t, n) {
        ...
        if (_interopRequireDefault.data('effect') === e)
          return (_interopRequireDefault.remove(), false);
      });
    }

    _invalidateEffects(e) {
    ...
    _createAddEffectMenu() {
      ...
      GTouchTool.sort(function (e, t) {
        return $(e).attr('value') ===
          GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.other')) ||
    ...
    _createDefaultEffect(e, t, n) {
      var _interopRequireDefault = function (_interopRequireDefault) {
        ...
        GTools = $('<span></span>')
          .text(
            e
              ? GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.more'))
      ...
      if (-1 !== ['contrast', 'brightness', 'hue', 'saturation'].indexOf(u)) {
            ...
            columns: [
              {
                ...
                content: $('<div/>')
                  ...
                  .gInputSlider(
                    'value',
                    Number(
                      _interopRequireDefault.propertyInverseTransform(u, GProperties).toFixed(3)
                    )
                  )
                  .on('input', function (e) {
                    var n = $(e.target),
        ...
        for (
          ...
          $('<option></option>')
            .attr('value', S)
            .text(
              GEffectsPanel[S] instanceof GCore.GLocaleKey
                ? GCore.GLocale.get(GEffectsPanel[S])
                : GEffectsPanel[S]
            )
            .appendTo(x);
            ...
            columns: [
              ...
              },
              {
                ...
                content: $('<input>')
                  ...
                  .on('change', function (e) {
                    var n = GCore.GLength.parseEquationValue($(e.target).gInputBox('value')) / 100;
                    (t(['opc'], [n]),
                      $(e.target)
                        .parents('.effect-settings')
                        .find('[data-property="pat"]')
      ...
      var u,
        DataModule_1263 = $('<input>')
          ...
          .on('change', function (e) {
            ...
            GTools &&
              (_interopRequireDefault = $(this).gUnitBox('value').toUnit(GCore.GLength.Unit.PT));
            var GTouchTool = $(this)
              .parents('.effect-settings')
              .find('[data-property="' + n + '"].g-input-slider');
      ...
      return 'r' === e
        ...
        : 'a' === e
          ? $('<input>')
              ...
              .on('change', function (e) {
                t(['a'], [GCore.GLength.parseEquationValue($(e.target).gInputBox('value'))]);
              })
          : 'o' === e
            ? $('<input>')
                .attr('type', 'text')
      ...
      .append(
        $('<div></div>').gPropertyRow({
          columns: [
            ...
            {
              width: '33%',
              label: GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.length')),
              content: GProperties('l'),
            },
            {
              width: '33%',
              label: GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.density')),
      ...
      .append(
        $('<div></div>').gPropertyRow({
          columns: [
            ...
            {
              width: '33%',
              label: GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.fade')),
    ...
    return (
      $('<div></div>')
        .gPropertyRow({
          columns: [
            {
              label: GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.radius')),
              width: '75%',
              content: $('<div>')
                .gInputSlider({
                  maxDecimal: 1,
      ...
      $('<div></div>')
        ...
        .gPropertyRow({
          columns: [
            ...
            {
              width: '20%',
              label: GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.blend')),
              content: $('<div/>')
  ...
  function R(e, t) {
    return $('<div></div>')
          ...
          .append(
            $(
              '<optgroup label="'.concat(
                GCore.GLocale.get(
                  new GCore.GLocaleKey('GEffectProperties', 'text.color.gradient.grp.instagram')
                ),
                '"></optgroup>'
              )
            )
              .append(
                $('<option></option>')
                  ...
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GEffectProperties', 'text.color.gradient.opt.1977')
                    )
                  )
              )
              .append(
                $('<option></option>')
                  .attr(
                    'value',
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GEffectProperties', 'text.color.gradient.opt.brannan')
                    )
                  )
                  .text('Brannan')
              )
              .append(
                $('<option></option>')
                  ...
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GEffectProperties', 'text.color.gradient.opt.gotham')
                    )
                  )
              )
              .append(
                $('<option></option>')
                  ...
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GEffectProperties', 'text.color.gradient.opt.hefe')
                    )
                  )
              )
              .append(
              ...
              .append(
                $('<option></option>')
                  ...
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GEffectProperties', 'text.color.gradient.opt.nashville')
                    )
                  )
              )
              .append(
                $('<option></option>')
                  ...
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GEffectProperties', 'text.color.gradient.opt.x-pro-ii')
                    )
                  )
              )
          )
      ...
      .append(
        $('<button></button>')
          .text(
            GCore.GLocale.get(new GCore.GLocaleKey('GEffectProperties', 'text.load-acv')) + '...'
          )
          .on('click', function (e) {
          ...
          ? $('<input>')
              ...
              .on('change', function (n) {
                var _interopRequireDefault =
                  GCore.GLength.parseEquationValue($(n.target).gInputBox('value')) / 100;
  ...
  function U(e) {
    ...
    for (var require = 0; require < V.length; ++require)
      if (V[require].clazz === t) return V[require];
