...
function (exports, module, require) {
  ...
  class c {
    ...
    static adler = r(c.adler, d, g, u);

    static adler = s(c.adler, d, g, u);
  ...
  function m(e, t) {
    var n,
      ...
      g = c[ZlibTrees + r - 1],
      h = c[ZlibTrees + r];
    (e.prev_length >= e.good_match && (Buf >>= 2), s > e.lookahead && (s = e.lookahead));
    do {
      if (
        c[(n = t) + r] === h &&
        c[n + r - 1] === g &&
  ...
  function y(e) {
    var t,
      ...
      h = e.w_size;
    do {
      if (((ZlibTrees = e.window_size - e.lookahead - e.strstart), e.strstart >= h + (h - 262))) {
  ...
  function v(e, t) {
    for (var require, o; ; ) {
      ...
      if (
        ...
        0 !== require && e.strstart - require <= e.w_size - 262 && (e.match_length = m(e, require)),
        e.match_length >= 3)
      )
        if (
          ((o = ZlibTrees._tr_tally(e, e.strstart - e.match_start, e.match_length - 3)),
      ...
      else ((o = ZlibTrees._tr_tally(e, 0, e.window[e.strstart])), e.lookahead--, e.strstart++);
  ...
  function _(e, t) {
    for (var require, o, Buf; ; ) {
      ...
      if (
        ...
        ((Buf = e.strstart + e.lookahead - 3),
          (o = ZlibTrees._tr_tally(e, e.strstart - 1 - e.prev_match, e.prev_length - 3)),
    ...
    return (
      e.match_available &&
        ((o = ZlibTrees._tr_tally(e, 0, e.window[e.strstart - 1])), (e.match_available = 0)),
      (e.insert = e.strstart < 2 ? e.strstart : 2),
      4 === t
        ? (g(e, true), 0 === e.strm.avail_out ? 3 : 4)
        : e.last_lit && (g(e, false), 0 === e.strm.avail_out)
  ...
  ((o = [
    new b(0, 0, 0, 0, function (e, t) {
      ...
      for (n > e.pending_buf_size - 5 && (n = e.pending_buf_size - 5); ; ) {
        ...
        if (
          ...
          return 1;
        if (e.strstart - e.block_start >= e.w_size - 262 && (g(e, false), 0 === e.strm.avail_out))
          return 1;
      }
      return (
        (e.insert = 0),
    ...
    (module.deflate = function (e, t) {
      ...
      if (
        ((Buf = e.state),
        !e.output || (!e.input && 0 !== e.avail_in) || (666 === Buf.status && 4 !== t))
      )
        return c(e, 0 === e.avail_out ? -5 : -2);
      if (((Buf.strm = e), (n = Buf.last_flush), (Buf.last_flush = t), 42 === Buf.status))
        if (2 === Buf.wrap)
          ((e.adler = 0),
            h(Buf, 31),
            h(Buf, 139),
      ...
      if (69 === Buf.status)
        if (Buf.gzhead.extra) {
          ...
          (Buf.gzhead.hcrc &&
            Buf.pending > r &&
            (e.adler = s(e.adler, Buf.pending_buf, Buf.pending - r, r)),
            Buf.gzindex === Buf.gzhead.extra.length && ((Buf.gzindex = 0), (Buf.status = 73)));
        } else Buf.status = 73;
      if (73 === Buf.status)
        if (Buf.gzhead.name) {
          r = Buf.pending;
      ...
      if (0 !== e.avail_in || 0 !== Buf.lookahead || (0 !== t && 666 !== Buf.status)) {
        var v =
          2 === Buf.strategy
            ? (function (e, t) {
                for (var n; ; ) {
    ...
    (module.deflateSetDictionary = function (e, t) {
      ...
      for (
        1 === s && (e.adler = r(e.adler, t, g, 0)),
          n.wrap = 0,
          g >= n.w_size &&
            (0 === s && (u(n.head), (n.strstart = 0), (n.block_start = 0), (n.insert = 0)),
        ...
        do {
          ((n.ins_h = ((n.ins_h << n.hash_shift) ^ n.window[o + 3 - 1]) & n.hash_mask),
