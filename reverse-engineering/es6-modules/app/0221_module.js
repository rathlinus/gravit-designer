...
function (exports, module, require) {
  ...
  (function (e) {
          ...
          : (function (e, t) {
              ...
              if (t) {
                if (
                  ...
                  return 'number' != typeof t.length || (o = t.length) != o ? s(e, 0) : p(e, t);
    ...
    function S(e, t, n, o) {
      return j(
        (function (e, t) {
          for (var n, o, i, a = [], r = 0; r < e.length && !((t -= 2) < 0); ++r)
            ((n = e.charCodeAt(r)), (o = n >> 8), (i = n % 256), a.push(i), a.push(o));
          return a;
        })(t, e.length - n),
        e,
        n,
        ...
        if (i + u <= n)
          switch (u) {
            case 1:
              ...
              break;
            case 2:
              128 == (192 & (a = e[i + 1])) && (l = ((31 & c) << 6) | (63 & a)) > 127 && (d = l);
              break;
            case 3:
              ((a = e[i + 1]),
                (r = e[i + 2]),
            ...
            case 4:
              ((a = e[i + 1]),
                ...
                128 == (192 & a) &&
                  128 == (192 & r) &&
                  128 == (192 & s) &&
                  (l = ((15 & c) << 18) | ((63 & a) << 12) | ((63 & r) << 6) | (63 & s)) > 65535 &&
                  l < 1114112 &&
                  (d = l));
          }
        (null === d
          ? ((d = 65533), (u = 1))
          : d > 65535 &&
            ((d -= 65536), o.push(((d >>> 10) & 1023) | 55296), (d = 56320 | (1023 & d))),
          o.push(d),
          (i += u));
      }
      return (function (e) {
        ...
        var n = '',
          o = 0;
        for (; o < t; ) n += String.fromCharCode.apply(String, e.slice(o, (o += 4096)));
        return n;
      })(o);
    }
    ((module.Buffer = l),
      ...
      (l.compare = function (e, t) {
        ...
        if (e === t) return 0;
        for (var require = e.length, o = t.length, i = 0, a = Math.min(require, o); i < a; ++i)
          if (e[i] !== t[i]) {
            ((require = e[i]), (o = t[i]));
            break;
          }
      ...
      (l.prototype.toString = function () {
        var e = 0 | this.length;
        return 0 === e ? '' : 0 === arguments.length ? A(this, 0, e) : f.apply(this, arguments);
      }),
      ...
      (l.prototype.compare = function (e, t, n, o, i) {
        ...
        if (
          (undefined === t && (t = 0),
          undefined === n && (n = e ? e.length : 0),
          undefined === o && (o = 0),
          undefined === i && (i = this.length),
      ...
      (l.prototype.write = function (e, t, n, o) {
        if (undefined === t) ((o = 'utf8'), (n = this.length), (t = 0));
        else if (undefined === n && 'string' == typeof t) ((o = t), (n = this.length), (t = 0));
        else {
          if (!isFinite(t))
            throw new Error(
          ...
          ((t |= 0),
            isFinite(n) ? ((n |= 0), undefined === o && (o = 'utf8')) : ((o = n), (n = undefined)));
        }
        var i = this.length - t;
        if (
          ((undefined === n || n > i) && (n = i),
    ...
    function k(e, t, n, o) {
      ...
      for (var i = 0, a = Math.min(e.length - n, 2); i < a; ++i)
        e[n + i] = (t & (255 << (8 * (o ? i : 1 - i)))) >>> (8 * (o ? i : 1 - i));
    }
    function O(e, t, n, o) {
    ...
    ((l.prototype.slice = function (e, t) {
      ...
      if (
        ...
        (t = undefined === t ? o : ~~t) < 0 ? (t += o) < 0 && (t = 0) : t > o && (t = o),
        t < e && (t = e),
        l.TYPED_ARRAY_SUPPORT)
      )
      ...
      (l.prototype.readUIntLE = function (e, t, n) {
        ...
        for (var o = this[e], i = 1, a = 0; ++a < t && (i *= 256); ) o += this[e + a] * i;
        return o;
      }),
      ...
      (l.prototype.readIntBE = function (e, t, n) {
        ((e |= 0), (t |= 0), n || L(e, t, this.length));
        for (var o = t, i = 1, a = this[e + --o]; o > 0 && (i *= 256); ) a += this[e + --o] * i;
      ...
      (l.prototype.copy = function (e, t, n, o) {
        ...
        var i,
          a = o - n;
        if (this === e && n < t && t < o) for (i = a - 1; i >= 0; --i) e[i + t] = this[i + n];
        else if (a < 1e3 || !l.TYPED_ARRAY_SUPPORT) for (i = 0; i < a; ++i) e[i + t] = this[i + n];
      ...
      (l.prototype.fill = function (e, t, n, o) {
        if ('string' == typeof e) {
          ...
          if (undefined !== o && 'string' != typeof o)
