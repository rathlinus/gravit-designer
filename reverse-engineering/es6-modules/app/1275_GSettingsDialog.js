...
function (exports, module, require) {
  ...
  class u extends GCore.GObject {
    constructor() {
      ...
      {
      name:
      GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'text.light-theme')) +
      ' (' +
      GCore.GLocale.get(
      new GCore.GLocaleKey('GCommonNames', 'text.default')
      ).toLowerCase() +
      ')',
      localeClass: new GCore.GLocaleKey('GSettingsDialog', 'text.light-theme'),
      key: 'light',
      },
      {
      name: GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'text.dark-theme')),
      localeClass: new GCore.GLocaleKey('GSettingsDialog', 'text.dark-theme'),
      key: 'dark',
      },
      ]),
      new Promise((e, t) => {
    ...
    async _buildDialog() {
      let exports = (
        await AppSettings.gApi.getUserSettings().catch(() => ({ notifications_disabled: false }))
      ).notifications_disabled;
      ((this._dialog = $('<div></div>')
        .append(
          this._createSetting(
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.highlight-on-hover')
            ),
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.highlight-on-hover-description')
            ),
            $('<label></label>')
              .addClass('g-switch')
              .append(
        ...
        .append(
          this._createSetting(
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.auto-expand-layers')
            ),
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.auto-expand-layers-description')
            ),
            $('<label></label>')
              .addClass('g-switch')
              .append(
        ...
        AppSettings.AUTO_SAVE_ENABLED &&
          (this._dialog.append(
            this._createSetting(
              GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'setting.auto-save')),
              GCore.GLocale.get(
                new GCore.GLocaleKey('GSettingsDialog', 'setting.auto-save-description')
              ),
          ...
          this._dialog.append(
            this._createSetting(
              GCore.GLocale.get(
                new GCore.GLocaleKey('GSettingsDialog', 'setting.auto-save-warning')
              ),
              GCore.GLocale.get(
                new GCore.GLocaleKey('GSettingsDialog', 'setting.auto-save-warning-description')
              ),
              $('<label/>')
                .addClass('g-switch')
                .append(
                  $('<input>')
                    .attr('type', 'checkbox')
                    .attr('data-setting', GAutoSaveManager.DISABLE_WARNING_SETTING_NAME)
                    .on('change', function () {
                      const exports = !!this.checked;
                      gDesigner.stats('settings_toggle_auto-save-warning-enabled', exports);
                    })
                    .prop(
                      'checked',
                      !gDesigner.getSetting(GAutoSaveManager.DISABLE_WARNING_SETTING_NAME, false)
                    )
                )
                .append($('<div/>'))
            )
        ...
        'production' === gDesigner.getEnv() ||
          ...
          (this._dialog.append(
            this._createSetting(
              GCore.GLocale.get(
                new GCore.GLocaleKey('GSettingsDialog', 'setting.enable_steps_debug')
              ),
              null,
              $('<label></label>')
                .addClass('g-switch')
              ...
              $('<label></label>')
                ...
                .append(
                  $('<input>')
                    ...
                    .prop(
                      'checked',
                      gDesigner.getSetting('enable_cache', GCore.GRendererConfig.ENABLE_CACHE)
                    )
                )
                .append($('<div></div>'))
            )
        ...
        this._dialog.append(
          this._createSetting(
            GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'setting.change-theme')),
            null,
            ...
            this._createSetting(
              null,
              GCore.GLocale.get(
                new GCore.GLocaleKey('GSettingsDialog', 'setting.ui-toolbar-alignment')
              ),
              $('<label></label>')
                .addClass('g-switch')
                .append(
        ...
        this._dialog.append(
          this._createSetting(
            GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'setting.store-textpath')),
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.store-textpath-description')
            ),
            $('<label></label>')
              .addClass('g-switch')
              .append(
                $('<input>')
                  ...
                  .prop(
                    'checked',
                    !gDesigner.getSetting('dont_store_textpath', GCore.GText.dontStorePaths)
                  )
              )
              .append($('<div></div>'))
          )
        ...
        this._dialog.append(
          this._createSetting(
            GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'setting.decimals-num')),
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.decimals-num-description')
            ),
        ...
        this._dialog.append(
          this._createSetting(
            GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'setting.eps-outline-fonts')),
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.eps-outline-fonts-description')
            ),
            $('<label></label>')
              .addClass('g-switch')
              .append(
        ...
        this._dialog.append(
          this._createSetting(
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.disable-notifications')
            ),
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSettingsDialog', 'setting.disable-notifications-description')
            ),
            $('<label></label>')
        ...
        this._dialog.append(
          this._createSetting(
            GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'setting.disable-scrubbing')),
            null,
            $('<label></label>')
              .addClass('g-switch')
              .append(
        ...
        gContainer.getRuntime() === GContainer.Runtime.Electron &&
          this._dialog.append(
            this._createSetting(
              GCore.GLocale.get(
                new GCore.GLocaleKey('GSettingsDialog', 'setting.create-backup-copy-of-file')
              ),
              GCore.GLocale.get(
                new GCore.GLocaleKey(
                  'GSettingsDialog',
        ...
        this._dialog.gDialog({
          ...
          buttons: [
            ...
            $(
              '<button class="settings-button">' +
                GCore.GLocale.get(new GCore.GLocaleKey('GSettingsDialog', 'action.save-changes')) +
                '</button>'
            ).on('click', () => {
    ...
    async _saveNotificationSetting() {
    ...
    _saveBasicSettings() {
      var e =
          AppSettings.AUTOSAVE_INTERVALS[
            parseInt(
              this._dialog
                .find('[data-setting="'.concat(GAutoSaveManager.AUTO_SAVE_INTERVAL_SETTING, '"]'))
                .val()
            )
          ],
        t = null;
      if (this._dialog.find('[data-setting="decimals-num-onoff"]').prop('checked')) {
        var require = this._dialog.find('[data-setting="decimals-num-val"]').gInputBox('value'),
      ...
      gDesigner.setSetting(
        [
          'highlight_on_hover',
          'auto_expand_layers',
          GAutoSaveManager.AUTO_SAVE_SETTING,
          GAutoSaveManager.DISABLE_WARNING_SETTING_NAME,
          ...
          'decimals_num',
          GAutoSaveManager.AUTO_SAVE_INTERVAL_SETTING,
          'create_backup_copy',
        ...
        [
          ...
          this._dialog
            .find('[data-setting="'.concat(GAutoSaveManager.AUTO_SAVE_SETTING, '"]'))
            .prop('checked'),
          !this._dialog
            .find('[data-setting="'.concat(GAutoSaveManager.DISABLE_WARNING_SETTING_NAME, '"]'))
            .prop('checked'),
    ...
    _createSetting(e, t, n) {
      var _interopRequireDefault = $('<div></div>')
        .addClass('text-description')
        .append($('<div></div>').text(e).addClass('label'));
      return (
        t
          ? (_interopRequireDefault = _interopRequireDefault.append(
              $('<div></div>').addClass('description').html(t)
            ))
              .find('a')
              .attr('target', '_blank')
            ...
            return $('<div/>')
              ...
              .on('click', function () {
                (gDesigner.stats(
                  ...
                  GCore.GLocale.get(e.localeClass, null, GCore.GLocaleLanguage.English)
                ),
      ...
      var e = gDesigner.getSetting('decimals_num', GCore.GScene.decimalsNum),
        t = $('<div/>').append(
          $('<input>')
            ...
            .css(
              'display',
              null !== gDesigner.getSetting('decimals_num', GCore.GScene.decimalsNum) ? '' : 'none'
            )
          ...
          $('<label></label>')
            ...
            .append(
              $('<input>')
                ...
                .prop(
                  'checked',
                  null !== gDesigner.getSetting('decimals_num', GCore.GScene.decimalsNum)
                )
            )
            .on(
              'change',
              function (e) {
                gDesigner.stats('settings_change_decimals-num');
                var t = gDesigner.getSetting('decimals_num', GCore.GScene.decimalsNum),
                  n = '2';
    ...
    _createAutoSaveSetting() {
      var e = $('<label/>')
          ...
          .append($('<div/>')),
        t = $('<select/>')
          .attr('data-setting', GAutoSaveManager.AUTO_SAVE_INTERVAL_SETTING)
          .on('change', function () {
