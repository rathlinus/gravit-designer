...
function (exports, module, require) {
  ...
  class l extends GElementAction {
      ...
      if (e) {
        ...
        if (module && module.length)
          for (var GEditor = 0; GEditor < module.length; ++GEditor) {
            if ((module[GEditor] instanceof GCore.GCompoundShape && require++, require >= 2))
              return true;
          }
      }
      return false;
    ...
    execute() {
      ...
      try {
        for (
          var require, GEditor = [], MenuItemBuilder = new Set(), GElementAction = 0;
          GElementAction < t.length;
          ++GElementAction
        ) {
    ...
    static ID = 'modify.createnestedcompound';

    static TITLE = new GCore.GLocaleKey('GCreateNestedCompoundAction', 'title');
