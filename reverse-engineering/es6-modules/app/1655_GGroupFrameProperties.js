                ...
                content: $('<select></select>')
                    ...
                    function (e) {
                      ...
                      (gDesigner.stats(
                        ...
                        this._assignProperty(
                          ...
                          t
                            ? GCore.GLocale.get(
                                new GCore.GLocaleKey('GGroupFrameProperties', 'text.switch-frame')
                              )
                            : GCore.GLocale.get(
                                new GCore.GLocaleKey('GGroupFrameProperties', 'text.switch-group')
                              )
                        ));
                    }.bind(this)
                  )
                  .append(
                    $('<option></option>')
                      ...
                      .text(
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GGroupFrameProperties', 'text.group')
                        )
                      )
                  )
                  .append(
                    $('<option></option>')
                      ...
                      .text(
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GGroupFrameProperties', 'text.frame')
                        )
                      )
                  ),
              },
