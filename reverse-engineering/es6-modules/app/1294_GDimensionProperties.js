...
function (exports, module, require) {
  ...
  class h extends GProperties {
    ...
    _panel = null;
    _toolbar = null;
    _transformButton = null;
    _document = null;
    _elements = null;
    _elementsBBox = null;
    _anchorsPanel = null;
    _firstElementsBBox = null;
    ...
    init(e, t) {
      ...
      var n = function (e, t) {
        ...
        if ('keep-ratio' == e)
          return $('<span></span>')
            ...
            .attr(
              'data-title',
              GCore.GLocale.get(new GCore.GLocaleKey('GDimensionProperties', 'action.keep-ratio'))
            )
            .attr('data-ratio', GTools.GEditorOptions.preserveAspectRatio ? 'yes' : 'no')
            .gRichTooltip(t);
        if ('x' === e || 'y' === e || 'w' === e || 'h' === e) {
                ...
                .on(
                  ...
                  function (t) {
                    (gDesigner.stats('dimension_set_positionOrSize'),
                      this._assignDimension(e, $(t.target).gInputBox('value')));
                  }.bind(this)
                )
      ...
      function _interopRequireDefault(e) {
        ...
        return (
          ...
          $('<button></button>')
            ...
            .append($('<span/>').addClass('gravit-icon-touch-'.concat(e, ' touch')))
            .on('click', function () {
          ...
          $('<button></button>')
            ...
            .on('click', function () {
              ...
              ((n = 'Auto' == n ? undefined : parseInt(n)),
                gDesigner.executeAction(t, [undefined, undefined, n], 'dimensionproperties'));
            })
        );
      }
      function u(e) {
      ...
      (t
        ...
        .append(
          _interopRequireDefault(GTools.GEditor.ArrangeAlignType.AlignLeft).addClass('secondary')
        )
        .append(
        ...
        .append(
          _interopRequireDefault(GTools.GEditor.ArrangeAlignType.AlignTop).addClass('secondary')
        )
        .append(
            ...
            columns: [
              {
                ...
                content: $('<div></div>')
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GDimensionProperties', 'text.sameHeight')
                    )
                  )
            ...
            columns: [
              {
                ...
                content: $('<div></div>')
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GDimensionProperties', 'text.sameWidth')
                    )
                  )
            ...
            columns: [
              {
                ...
                content: $('<div></div>')
                  .text(
                    GCore.GLocale.get(new GCore.GLocaleKey('GDimensionProperties', 'text.fullUnit'))
                  )
            ...
            columns: [
              {
                ...
                content: $('<div></div>')
                  .text(
                    GCore.GLocale.get(new GCore.GLocaleKey('GDimensionProperties', 'text.halfUnit'))
                  )
        ...
        $('<button></button>')
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GDimensionProperties', 'text.setting'))
          )
      ...
      const h = r.GRichTooltipConfig.from({
          ...
          description: GCore.GLocale.get(
            new GCore.GLocaleKey('GDimensionProperties', 'text.property-x-y-tooltip-description')
          ),
          middle: false,
          learnMore: '',
        }),
        f = r.GRichTooltipConfig.from({
          ...
          description: GCore.GLocale.get(
            new GCore.GLocaleKey('GDimensionProperties', 'text.property-w-h-tooltip-description')
          ),
          middle: false,
          learnMore: '',
        }),
        ...
        v = r.GRichTooltipConfig.from({
          ...
          description: GCore.GLocale.get(
            new GCore.GLocaleKey('GDimensionProperties', 'text.rotate-angle-tooltip-description')
          ),
          middle: false,
          learnMore: '',
        });
      ($('<div/>')
        ...
        .text(
          GCore.GLocale.get(new GCore.GLocaleKey('GDimensionProperties', 'text.transform-title'))
        )
        ...
        (this._transformButton = $(
          '<button>' +
            GCore.GLocale.get(new GCore.GLocaleKey('GDimensionProperties', 'text.transform')) +
            '</button>'
        )
        ...
        (this._anchorsPanel = $('<div></div>')
          .gPropertyRow({
            label: GCore.GLocale.get(new GCore.GLocaleKey('GDimensionProperties', 'text.anchors')),
            columns: [
              {
                width: '44%',
                content: $('<div/>')
                  ...
                  .append(
                    $('<div/>')
                      ...
                      .attr(
                        'data-title',
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GDimensionProperties', 'action.anchor-left')
                        )
                      )
                      .on(
                        'click',
                  ...
                  .append(
                    $('<div/>')
                      ...
                      .attr(
                        'data-title',
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GDimensionProperties', 'action.anchor-center')
                        )
                      )
                      .on(
                        'click',
                  ...
                  .append(
                    $('<div/>')
                      ...
                      .attr(
                        'data-title',
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GDimensionProperties', 'action.anchor-right')
                        )
                      )
                      .on(
                        'click',
                  ...
                  .append(
                    $('<div/>')
                      ...
                      .attr(
                        'data-title',
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GDimensionProperties', 'action.anchor-top')
                        )
                      )
                      .on(
                        'click',
                  ...
                  .append(
                    $('<div/>')
                      ...
                      .attr(
                        'data-title',
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GDimensionProperties', 'action.anchor-middle')
                        )
                      )
                      .on(
                        'click',
                  ...
                  .append(
                    $('<div/>')
                      ...
                      .attr(
                        'data-title',
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GDimensionProperties', 'action.anchor-bottom')
                        )
                      )
                      .on(
                        'click',
          ...
          (e
            ? (this._transformButton.text(
              ...
              $('.advanced-transform-toolbar > label').text(
                GCore.GLocale.get(
                  new GCore.GLocaleKey('GDimensionProperties', 'text.transform-advanced')
                )
              ),
    ...
    _changeSideBarContinerZIndex(e) {
      gDesigner.isTouchEnabled() &&
        (e
      ...
      if (
        ...
        if (this._elements.length && this._elements.length === t.length)
          return (
            ...
            this._document
              .getEditor()
              .addEventListener(GTools.GEditor.EdGeometryChangeEvent, this._edGeometryChange, this),
      ...
      ((e.getActiveTool() && e.getActiveTool() instanceof GTools.GSelectTool) ||
        ...
        e.getActiveTool() instanceof GTools.GSelectTool &&
          e
            .getActiveTool()
            .setEditMode(
              e.getActiveTool().getEditMode() === GTools.GSelectTool.EditMode.Transform
        ...
        for (var r = 0; r < this._elements.length; ++r) {
          ...
          if (GTouchTool.hasMixin(GCore.GElement.Transform)) {
            ...
            if (t) {
              ...
              GDistributeAction &&
                GDistributeAction.getElement() &&
                (GAlignAction = GDistributeAction.getPEGeometryBBox());
            ...
            GAlignAction &&
              ...
              this._firstElementsBBox ||
                ...
                (_interopRequireDefault =
                  t && GDistributeAction
                    ? GDistributeAction.getRotationAngle()
                    : GTouchTool.getAngle())));
          }
        }
        this._elementsBBox ||
          ((this._elementsBBox = null), (this._firstElementsBBox = this._elementsBBox));
      }
          ...
          if (null !== t)
            switch (e) {
              ...
              case 'h':
                n = this._document
                  .getScene()
                  .pointToString(t, this._document.getScene().getOptimalDecimalsCount());
                break;
              case 'rotate':
    ...
    _updateToolbar() {
      (this._toolbar.find('[data-action]').each(
        ...
        this._toolbar.find('.touchDistribute>input').each(
          function (e, t) {
            $(t).prop('disabled', !gDesigner.canExecuteAction('arrange.distribute.horizontal'));
          }.bind(this)
        ),
      ...
      if (this._document) {
        ...
        if (
          ...
          var GDistributeAction = function (t, _interopRequireDefault, GTools) {
              ...
              if ('y' === e) return new GCore.GTransform().translated(0, require - t.getY());
              if ('rotate' === e) {
                  ...
                  if (
                    ...
                    GAlignAction
                      ? (GAlignAction._setTransform(n),
                        GAlignAction.applyTransform(t, GTouchTool, _interopRequireDefault))
                ...
                if (v)
                  (y = GDistributeAction(
                    ...
                    GSnapUnitAction(
                      ...
                      y,
                      h,
                      barrel_panels.getEdTransformSettings()
                    );
              }
          } finally {
    ...
    _showAnchor() {
      for (
        var exports = this._elements, module = true, require = 0;
    ...
    _defineAnchorButtonState(e, t) {
      (null !== e &&
        ($(this._panel)
          .find('.vacr-middle')
          .addClass(e === GCore.GElement.Anchor.AnchorType.Middle ? 'g-active' : ''),
        $(this._panel)
          .find('.vacr-start')
          .addClass(
        ...
        $(this._panel)
          .find('.vacr-middle')
          .removeClass(e !== GCore.GElement.Anchor.AnchorType.Middle ? 'g-active' : ''),
        $(this._panel)
          .find('.vacr-start')
          .removeClass(
            e !== GCore.GElement.Anchor.AnchorType.Start &&
        ...
        null !== t &&
          ($(this._panel)
            .find('.hacr-middle')
            .addClass(t === GCore.GElement.Anchor.AnchorType.Middle ? 'g-active' : ''),
          $(this._panel)
            .find('.hacr-start')
            .addClass(
          ...
          $(this._panel)
            .find('.hacr-middle')
            .removeClass(t !== GCore.GElement.Anchor.AnchorType.Middle ? 'g-active' : ''),
          $(this._panel)
            .find('.hacr-start')
            .removeClass(
              t !== GCore.GElement.Anchor.AnchorType.Start &&
      ...
      if (this._document) {
        ...
        try {
          ...
          require.commitTransaction(
            GCore.GLocale.get(new GCore.GLocaleKey('GDimensionProperties', 'action.change-anchor'))
          );
        }
    ...
    static _keepRatioName = 'designer.settings.dimension.preserveratio';
