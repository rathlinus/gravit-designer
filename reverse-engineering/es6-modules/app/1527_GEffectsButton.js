...
function (exports, module, require) {
  ...
  class a {
    constructor(e, t, n, a, r, s, l) {
      ...
      .gPro({ pro: r })
      .append(
      $('<span></span>').addClass('g-effects-button-icon').append($('<i></i>').addClass(t))
      )
      ...
      function () {
      let e =
      (n && GCore.GLocale.getValue((s && s.i18n) || n, 'name', 'unknown', 0)) || 'unkn';
      (r
      ...
      c +
      ((n && GCore.GLocale.getValue((s && s.i18n) || n, 'name', 'unknown', 0)) ||
      'unkn')
      )
      )
      )
