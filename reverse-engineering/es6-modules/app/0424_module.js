...
function (exports, module, require) {
  ...
  var core_export = require(25) /* core_export */,
    ...
    ae = function (e) {
      for (var module = 0, require = 128; require > 0 && 0 != (e & require); require >>= 1)
        module++;
      return module;
    },
    re = function (e) {
    ...
    se = function (e) {
      for (
        var module = (e = X(e, ne, ' ')).length, require = '', core_export = 0;
        core_export < module;
      ) {
    ...
    parseObject: function (e) {
      ...
      if (DataModule_423)
        for (
          ...
          Y(hasOwnProperty_wrapper, {
            key: requireObjectCoercible(r.value),
            value: requireObjectCoercible(uncurryThis.value),
          });
        }
      else
        for (var defineBuiltIn in e)
          _(e, defineBuiltIn) &&
            Y(hasOwnProperty_wrapper, {
              key: defineBuiltIn,
              value: requireObjectCoercible(e[defineBuiltIn]),
            });
    },
    parseQuery: function (e) {
      if (e)
        for (
          var module, require, core_export = this.entries, globalThis = Z(e, '&'), a = 0;
          a < globalThis.length;
        )
          (module = globalThis[a++]).length &&
            ((require = Z(module, '=')),
            Y(core_export, { key: se(Q(require)), value: se(q(require, '=')) }));
    },
    serialize: function () {
      for (
        var exports, module = this.entries, require = [], core_export = 0;
        core_export < module.length;
      )
      ...
      fe,
      {
        ...
        delete: function (e) {
          for (
            ...
            if (uncurryThis.key !== globalThis || (undefined !== r && uncurryThis.value !== r))
              isCallable++;
        ...
        get: function (e) {
          ...
          for (
            var require = requireObjectCoercible(e), core_export = 0;
            core_export < t.length;
            core_export++
          )
        ...
        getAll: function (e) {
          ...
          D(arguments.length, 1);
          for (
            var require = requireObjectCoercible(e), core_export = [], globalThis = 0;
            globalThis < t.length;
            globalThis++
          )
        ...
        has: function (e) {
          for (
            ...
            if (isCallable.key === core_export && (undefined === a || isCallable.value === a))
              return true;
          }
          return false;
        },
        set: function (e, t) {
          ...
          for (
            var core_export,
              globalThis = n.entries,
              a = false,
              r = requireObjectCoercible(e),
              isCallable = requireObjectCoercible(t),
              uncurryThis = 0;
            ...
            (core_export = globalThis[uncurryThis]).key === r &&
              (a
                ? J(globalThis, uncurryThis--, 1)
                : ((a = true), (core_export.value = isCallable)));
