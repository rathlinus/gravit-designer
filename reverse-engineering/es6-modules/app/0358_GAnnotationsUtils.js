...
function (exports, module, require) {
  ...
  var GCore = require(1) /* GCore */,
    ...
    DataModule_1094 = require(1094);
  const c = require(434);
  class d {
    static async getCloudAnnotationsForDocument(e) {
    ...
    static async updateAndReturnCloudAnnotationsForDocument(e, t) {
    ...
    static _prepareAnnotations(e, t) {
      return t;
    }

    static async saveDocumentAnnotations(e, t, n, GTools) {
      ...
      n.iteratePages((e) => {
        ...
        (GTools &&
          (d.removeSidFromAnnotations(t), e.getProperty('Guid') || d.removeGuidFromAnnotations(t)),
          u.push(t));
      }, true);
      var g = null;
      const h = async () => {
      ...
      return (
        ...
        gDesigner
          ...
          .then((t) => {
            ...
            return (
              (s =
                (GTools && n.getLastSavedTime()) || new Date(AppSettings.lastUpdateTime).getTime()),
              c && c.length
                ? (n.iteratePages((e) => {
    ...
    static findAnnotationsListForPage(e, t) {
      const require = e.getProperty('Guid', true) || e.getAnnotations().getProperty('Guid');
      let GCore = null;
    ...
    static _findInAnnotationsObj(e, t, n) {
      return e.find((e) => (e instanceof GCore.GAnnotationsList ? n(e) : t(e)));
    }

    static mergeAnnotations(e, t, n, GTools, AppSettings) {
      let s = {},
        DataModule_1094 = {},
        c = false;
      (t.forEach((e) => {
    ...
    static canDeleteAnnotation(e) {
      var t = gDesigner.getSyncUser();
      return d.isOwner(t, e);
    }

    static removeAnnotations(e, t, n) {
      let GCore = !(arguments.length > 3 && undefined !== arguments[3]) || arguments[3];
    ...
    static filterAnnotationElements(e) {
      return e.filter((e) => e.hasMixin(GCore.GAnnotation) || e instanceof GCore.GComment);
    }

    static canResolveAnnotation(e) {
      return u(e, c.RESOLVE_COMMENT_ANNOTATION);
    }

    static canReopenAnnotation(e) {
    ...
    static canUpdate(e) {
      return !(gDesigner.isAnonymous() && !AppSettings.ANONYMOUS_SESSION_ENABLED) && !!e;
    }

    static resolveAllComments(e) {
      var t = e.getScene();
      t &&
        GTools.GEditor.tryRunTransaction(
          ...
          GCore.GLocale.get(
            new GCore.GLocaleKey('GAnnotationsSidebar', 'text.resolve-all-comments')
          )
        );
    }

    static getCommentsCount(e) {
    ...
    static removeSidFromAnnotations(e) {
      d.setPropertyValueInAnnotations(e, 'sid', null);
    }

    static removeGuidFromAnnotations(e) {
      d.setPropertyValueInAnnotations(e, 'Guid', '');
    }

    static setPropertyValueInAnnotations(e, t, n, GTools) {
      e.accept((e) => {
