        ...
        gDesigner.getUser().then((e) => {
          if (e) this._logged(e);
            ...
            (module.addClass('container').appendTo(this._dialog),
              ...
              $('<span/>')
                .addClass('title')
                .text(GCore.GLocale.get(new GCore.GLocaleKey('GLoginPanel', 'text.title')))
                .appendTo(module),
              $('<span/>')
                .addClass('subtitle')
                .text(GCore.GLocale.get(new GCore.GLocaleKey('GLoginPanel', 'text.subtitle')))
                .appendTo(module));
            var require = $('<div/>');
            ...
            var _interopRequireDefault = (e, t) => {
              ...
              (_interopRequireDefault.on('click', t),
                _interopRequireDefault
                  .addClass(e)
                  .text(GCore.GLocale.get(new GCore.GLocaleKey('GLoginPanel', 'text.' + e)))
                  .appendTo(require));
            };
