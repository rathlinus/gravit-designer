...
function (exports, module, require) {
  ...
  function s(e, t) {
    if (e.isMaster()) {
      ...
      if (a.length) {
        if (require.scene) {
          var r = d.call(this, e);
          if (r && (r.removeEventListener(GCore.GSymbol.AfterThumbnailUpdate, l), !t)) {
  ...
  function l(e) {
    ...
    if (n && t.getPaintBBox()) {
      ...
      if (($(u).css({ width: c, height: d, margin: '5px' }), t.hasFlag(GCore.GNode.Flag.Selected)))
        ...
        r
          ...
          .on('dragstart', function (n) {
            ($(this).addClass('g-dragging'),
              ...
              n.originalEvent.dataTransfer.setData(GCore.GNode.MIME_TYPE, GCore.GNode.serialize(e)),
              (t.dragNode = e),
              setTimeout(
                function () {
          ...
          .on('click', function (n) {
            ...
            GCore &&
              (GCore.getScene() ? t.options.clickCallback(GCore) : r.toggleClass('g-highlighted'));
          })
  ...
  function f() {
    ...
    for (
      var exports = $(this).find('.symbol-image'), module = 0;
        ...
        $('<div>')
          ...
          .append(
            $('<div></div>')
              ...
              .text(
                GCore.GLocale.get(
                  new GCore.GLocaleKey('GCreateSymbolAction', 'common.nosymbolsdefined')
                )
              )
          )
          .append(
            $('<span></span>').text(
              GCore.GLocale.get(
                new GCore.GLocaleKey('GCreateSymbolAction', 'common.nosymbolsdefined-info')
              )
            )
          )
      )
