...
function (exports, module, require) {
  ...
  class l extends GElementAction {
    ...
    execute() {
      ...
      if (n)
        for (
          ...
          CollaborationMergeUtils < n.length;
        ...
        if (!d.isLocked() && GEditor.validateInsertion(d)) {
          ...
          try {
            ...
            for (GElementAction = 0; GElementAction < MenuItemBuilder.length; ++GElementAction)
              l.add(MenuItemBuilder[GElementAction].getParent());
            (0, CollaborationMergeUtils.blockChanges)(require, l, p, GEditor);
            for (GElementAction = 0; GElementAction < MenuItemBuilder.length; ++GElementAction) {
              var g;
              ((g = MenuItemBuilder[GElementAction]).getParent().removeChild(g),
                GEditor.appendChild(g));
            }
          } finally {
    ...
    _convertToImage(e) {
      var t, n;
      (e instanceof GCore.GImage || (t = GCore.GPaintCanvas.getScreenDPI() * GCore.GLength.DPI),
        e instanceof GCore.GElement && (n = e.getScene()),
        e instanceof GCore.GImage ||
          (t = Math.max(t || GCore.GLength.DPI, (n && n.getProperty('dpi')) || GCore.GLength.DPI)));
      ...
      var GElementAction = e.getPaintBBox().getSide(GCore.GRect.Side.TOP_LEFT),
        l = new GCore.GTransform()
          .scaled(MenuItemBuilder, MenuItemBuilder)
          .translated(GElementAction.getX(), GElementAction.getY());
      return (
    ...
    static ID = 'modify.path2bmp';

    static TITLE = new GCore.GLocaleKey('GConvertToImageAction', 'title');
