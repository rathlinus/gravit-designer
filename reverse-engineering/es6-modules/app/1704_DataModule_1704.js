...
function (exports, module, require) {
  ...
  var GCore = require(1) /* GCore */,
    i = {
      value: function (e) {
        const module = $(this);
        return arguments.length > 0 ? (module.prop('checked', !!e), this) : i.isChecked.call(this);
      },
      unmount() {
        const exports = $(this);
  ...
  $.fn.gCheckboxSlider = function (e) {
    return i[e]
      ...
      : 'object' != typeof e && e
        ? void $.error('Method ' + e + ' does not exist on jQuery.gCheckboxSlider')
