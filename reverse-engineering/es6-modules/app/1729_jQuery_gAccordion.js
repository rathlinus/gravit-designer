        ...
        return this.each(function () {
          ...
          if (!$(this).hasClass('accordion')) {
            var r = $('<span></span>').addClass(
                $(this).hasClass('collapsed') ? 'gravit-icon-right' : 'gravit-icon-down'
              ),
              s = $('<button></button>')
                ...
                .on(
                  ...
                  function () {
                    ...
                    (o(this, e),
                      i && gDesigner.stats(''.concat(i, '_toggle_page'), e ? 'Collapse' : 'Expand'),
                      $(this).trigger('change'));
                  }.bind(this)
                )
                .append(r),
            ...
            if (t) {
              ...
              (n ? $(s).insertBefore(c) : ($(s).insertAfter(c), $(l).insertAfter(s)),
                c
                  .on('click', function () {
                    s.trigger('click');
                  })
