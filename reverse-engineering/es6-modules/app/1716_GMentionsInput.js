...
function (exports, module, require) {
  ...
  var DataModule_883 = _interopRequireDefault(require(883) /* DataModule_883 */),
    ...
    f = {
      ...
      templates: {
        ...
        mentionItemHighlight: '<strong><span id="<%=id%>"><%=value%></span></strong>',
      },
    },
    m = 0,
    y = function (e) {
    ...
    S = function (e) {
      ...
      function R() {
        ...
        (P(),
          (t = I()),
          (E = (E = E.filter((e) => e.value && t.includes(e.value))).filter((e) => e)));
      ...
      function N(e) {
        if (
          ...
          e.keyCode === c || e.keyCode === u || e.keyCode === g || e.keyCode === h)
        )
          return (
            setTimeout(D, 1),
            void (navigator.userAgent.indexOf('MSIE 9') > -1 && setTimeout(P, 1))
          );
        if (e.keyCode !== r) {
              ...
              if (((l = t.getUserNameInitials()), t.avatar))
                if ('assets/icon/notification-icon.svg' === t.avatar) {
                  ...
                  ((t =
                    ...
                    (s = $(
                      x(e.templates.autocompleteListItemAvatar, [{ key: '<%=avatar%>', value: t }])
                    )));
                } else
      ...
      return (
        (e = $.extend(true, {}, f, e)),
        {
          ...
          val: function (e) {
            $.isFunction(e) && e.call(this, E.length ? t.data('messageText') : I());
          },
          reset: function () {
            V();
          },
  ...
  $.fn.mentionsInput = function (e, t) {
    ...
    return (
      ...
      this.each(function () {
        var _interopRequireDefault =
          $.data(this, 'mentionsInput') || $.data(this, 'mentionsInput', new S(t));
