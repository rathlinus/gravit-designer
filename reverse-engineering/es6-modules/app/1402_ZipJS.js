  ...
  !(function (e) {
    ...
    function c(t) {
      ...
      ((o.size = 0),
        (o.init = function (e) {
          ...
          ((n = t.indexOf(',') + 1), (o.size = Math.floor(0.75 * (i - n))), e());
        }),
    ...
    function y(t, n, o, i, r, s, l, c, d, u, p) {
      e.zip.useWebWorkers && l
        ? f(t, { sn: n, codecClass: 'NOOP', crcType: 'input' }, o, i, r, s, d, c, u, p)
    ...
    function v(e) {
      ...
      for (t = 0; t < e.length; t++)
        o += (n = 255 & e.charCodeAt(t)) > 127 ? i[n - 128] : String.fromCharCode(n);
      return o;
    }
    function _(e) {
          ...
          ? ((o || 8 != (8 & e.bitFlag)) &&
            ...
            4294967295 !== e.compressedSize && 4294967295 !== e.uncompressedSize
              ? ((e.filenameLength = t.view.getUint16(n + 22, true)),
                (e.extraFieldLength = t.view.getUint16(n + 24, true)))
              ...
              ? (w(d, v, 4, false, a),
                ...
                o.init(function () {
                  0 === d.compressionMethod
                    ? y(d._worker, s++, t, o, h, d.compressedSize, c, u, l, p, g)
                    : (function (t, n, o, i, a, r, s, l, c, d, u) {
                        ...
                        e.zip.useWebWorkers
                          ...
                          : m(new e.zip.Inflater(), o, i, a, r, p, c, l, d, u);
                      })(d._worker, s++, t, o, h, d.compressedSize, c, u, l, p, g);
                }, g))
              : a(n);
          },
          p
              ...
              t.readUint8Array(
                ...
                function (t) {
                  for (var n = t.length - 22; n >= 0; n--)
                    if (80 === t[n] && 75 === t[n + 1] && 5 === t[n + 2] && 6 === t[n + 3])
                ...
                : t.readUint8Array(
                    ...
                    function (t) {
                      var o,
                        ...
                        h = r(t.length, t);
                      for (o = 0; o < d; o++) {
                        if ((((s = new l())._worker = i), 1347092738 != h.view.getUint32(p)))
                          return void a(n);
                        (w(s, h, p + 6, true, a),
                          ...
                          (u = b(
                            h.array.subarray(
                              ...
                              p + 46 + s.filenameLength + s.extraFieldLength + s.commentLength
                            )
                          )),
                          (s.comment = 2048 == (2048 & s.bitFlag) ? _(u) : v(u)),
                          g.push(s),
                          (p += 46 + s.filenameLength + s.extraFieldLength + s.commentLength));
                      }
                      e(g);
      ...
      var p = {
        add: function (n, p, g, h, v) {
          ...
          function E(e, n) {
            ...
            ((l += e || 0),
              ...
              undefined !== n && (_.view.setUint32(10, n, true), o.view.setUint32(4, n, true)),
              p &&
                ...
                : ((b = S(x(n))),
                  ...
                  (function (e) {
                    ...
                    ((w = v.lastModDate || new Date()),
                      ...
                      _.view.setUint16(
                        6,
                        (((w.getHours() << 6) | w.getMinutes()) << 5) | (w.getSeconds() / 2),
                        true
                      ),
                      _.view.setUint16(
                        8,
                      ...
                      ? i || 0 === v.level
                        ...
                        : (function (t, n, o, i, a, r, s, l, c) {
                            e.zip.useWebWorkers
                              ...
                              : m(new e.zip.Deflater(), o, i, 0, o.size, 'input', s, r, l, c);
        ...
        close: function (e) {
          ...
          var n,
            ...
            c = 0,
            u = 0;
          for (o = 0; o < s.length; o++) c += 46 + (i = a[s[o]]).filename.length + i.comment.length;
    ...
    ((i.prototype.append = function (e) {
      for (var t = 0 | this.crc, n = this.table, o = 0, i = 0 | e.length; o < i; o++)
        t = (t >>> 8) ^ n[255 & (t ^ e[o])];
      this.crc = t;
    }),
      ...
      if (null === e.zip.workerScripts || null === e.zip.workerScriptsPath) {
        ...
        if (e.zip.workerScripts) {
          if (((i = e.zip.workerScripts[t]), !Array.isArray(i)))
            return void o(new Error('zip.workerScripts.' + t + ' is not an array!'));
          ((a = i),
            (r = document.createElement('a')),
            (i = a.map(function (e) {
              return ((r.href = e), r.href);
            })));
        } else (i = A[t].slice(0))[0] = (e.zip.workerScriptsPath || '') + i[0];
        ...
        ((s.codecTime = s.crcTime = 0),
          ...
          s.addEventListener('message', function e(t) {
            ...
            'importScripts' === i.type &&
              (s.removeEventListener('message', e), s.removeEventListener('error', l), n(s));
          }),
          s.addEventListener('error', l));
      } else
        o(new Error('Either zip.workerScripts or zip.workerScriptsPath may be set, not both.'));
      function l(e) {
        (s.terminate(), o(e));
      }
    }
