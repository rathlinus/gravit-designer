...
function (exports, module, require) {
  ...
  (Object.defineProperty(module, '__esModule', { value: true }),
        ...
        buttons: [
          ...
          },
          {
            label: GCore.GLocale.get(
              new GCore.GLocaleKey('GSaveAction', 'has-new-version-when-save-reload')
            ),
            closeOnClick: true,
            onclick: () => {
          ...
          {
            label: GCore.GLocale.get(
              new GCore.GLocaleKey('GSaveAction', 'has-new-version-when-save-save')
            ),
            className: 'primary',
            closeOnClick: true,
        ...
        .SHA256(
          (function (e) {
            for (
              ...
              require.push(
                (module[_interopRequireDefault] << 24) |
                  (module[_interopRequireDefault + 1] << 16) |
                  (module[_interopRequireDefault + 2] << 8) |
                  module[_interopRequireDefault + 3]
              );
    ...
    (module.releaseChanges = function (e, t, n) {
      ...
      for (
        var _interopRequireDefault = arguments.length,
          GCore = new Array(_interopRequireDefault > 3 ? _interopRequireDefault - 3 : 0),
          GAnnotation = 3;
    ...
    (module.removeAllSuffixWhichLikeExtension = function (e, t) {
      ...
      for (; e.toLowerCase().endsWith(require); ) e = e.substr(0, e.lastIndexOf('.'));
      return e;
    }),
    ...
    (module.saveBBoxes = function (e) {
      ...
      for (
        var require = new Float64Array(4 * t.length), _interopRequireDefault = 0;
    ...
    (module.throttle = function (e, t) {
      ...
      return function () {
        const _interopRequireDefault = arguments;
        require ||
          (e.apply(this, _interopRequireDefault),
          (require = true),
          setTimeout(() => (require = false), t));
      };
    }),
  ...
  const g = s.enc.Latin1.parse(
    s.enc.Latin1.stringify(s.SHA256('#a09j!@10jas-109827s*%#1098XAapoc-9908#!123'))
  );
  function h(e, t) {
  ...
  function v(e, t, n) {
    ...
    if (e.hasMixin(GCore.GNode.Properties) !== t.hasMixin(GCore.GNode.Properties)) return true;
    if (e.hasMixin(GCore.GNode.Properties) && y(e, t, n)) return true;
    if (e.hasMixin(GCore.GElement.Stylable) !== t.hasMixin(GCore.GElement.Stylable)) return true;
    ...
    if (e.hasMixin(GCore.GNode.Container)) {
      ...
      for (let e = 0; e < _interopRequireDefault.length; e++)
        if (v(_interopRequireDefault[e], GCore[e], n)) return true;
    }
    return false;
  }
  function _(e, t) {
