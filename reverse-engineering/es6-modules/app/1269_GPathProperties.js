...
function (exports, module, require) {
  ...
  class c extends GProperties {
    ...
    init(e, t) {
        ...
        if ('tp' === e)
          return $('<select></select>')
            ...
            .append(
              $('<option></option>')
                .attr('value', '-')
                .text(GCore.GLocale.get(new GCore.GLocaleKey('GPathProperties', 'text.straight')))
            )
            .append(
              $('<option></option>')
                .attr('value', GCore.GPathBase.AnchorPoint.Type.Mirror)
                .text(GCore.GLocale.get(new GCore.GLocaleKey('GPathBase', 'anchor-point.mirror')))
            )
            .append(
              $('<option></option>')
                .attr('value', GCore.GPathBase.AnchorPoint.Type.Asymmetric)
                .text(
                  GCore.GLocale.get(new GCore.GLocaleKey('GPathBase', 'anchor-point.asymmetric'))
                )
            )
            .append(
              $('<option></option>')
                ...
                .text(
                  GCore.GLocale.get(new GCore.GLocaleKey('GPathBase', 'anchor-point.symmetric'))
                )
            )
            .append(
              $('<option></option>')
                ...
                .text(
                  GCore.GLocale.get(new GCore.GLocaleKey('GPathBase', 'anchor-point.connector'))
                )
            )
            ...
            .on('input', function () {
              ...
              t._panel
                ...
                .gInputBox(
                  ...
                  t._document
                    .getScene()
                    .pointToString(e, t._document.getScene().getOptimalDecimalsCount())
                );
            })
            .on('change', function () {
              var e = t._document.getScene().stringToPoint($(this).gInputSlider('value'));
      ...
      ($('<div></div>')
          ...
          columns: [
            {
              ...
              content: $('<label></label>')
                ...
                .append(
                  $('<span></span>').text(
                    GCore.GLocale.get(new GCore.GLocaleKey('GPathProperties', 'text.closed'))
                  )
                ),
            },
            {
        ...
        $('<div></div>')
          ...
          .attr('point-only', true)
          .gPropertyRow({
            label: GCore.GLocale.get(new GCore.GLocaleKey('GPathProperties', 'text.joint')),
            columns: [
              {
                width: '25%',
                padding: false,
                content: $('<button></button>')
                  ...
                  .attr(
                    'data-title',
                    GCore.GLocale.get(new GCore.GLocaleKey('GPathProperties', 'text.straight'))
                  )
              ...
              },
              {
                ...
                content: $('<button></button>')
                  ...
                  .attr(
                    'data-title',
                    GCore.GLocale.get(new GCore.GLocaleKey('GPathBase', 'anchor-point.mirror'))
                  )
              ...
              },
              {
                ...
                content: $('<button></button>')
                  .addClass('g-button')
                  .css({ borderRadius: '0px' })
                  .attr('data-node-type', GCore.GPathBase.AnchorPoint.Type.Asymmetric)
                  .attr(
                    'data-title',
                    GCore.GLocale.get(new GCore.GLocaleKey('GPathBase', 'anchor-point.asymmetric'))
                  )
              ...
              },
              {
                ...
                content: $('<button></button>')
                  ...
                  .attr('data-node-type', GCore.GPathBase.AnchorPoint.Type.Symmetric)
                  .attr(
                    'data-title',
                    GCore.GLocale.get(new GCore.GLocaleKey('GPathBase', 'anchor-point.symmetric'))
                  )
        ...
        $('<div></div>')
          ...
          .gPropertyRow({
            label: GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.corner')),
            columns: [
    ...
    assignNodeType() {
      ...
      gDesigner.stats('pathproperties_assign_nodetype', this._getStatsNodeType(exports));
      ...
      if (require) {
        ...
        try {
          ...
          ('-' === exports &&
            ...
            (GTools = [GCore.GPathBase.CornerType.Rounded, null, null, null, null, false])),
            this._points.forEach((n) => {
              if (
                ...
                if (
                  ...
                  if (
                    GProperties &&
                    GProperties.getProperty('tp') != GCore.GPathBase.AnchorPoint.Type.Connector
                  ) {
          ...
          require.commitTransaction(
            GCore.GLocale.get(
              new GCore.GLocaleKey('GPathProperties', 'action.modify-path-node-type')
            )
          );
        }
      }
    ...
    _afterFlagChange(e) {
      if (e.flag === GCore.GNode.Flag.Selected && e.node instanceof GCore.GPathBase.AnchorPoint) {
      ...
      if (e) {
        ...
        (this._panel
          ...
          .val(
            this._document
              .getScene()
              .pointToString(module.getX(), this._document.getScene().getOptimalDecimalsCount())
          ),
          this._panel
            ...
            .val(
              this._document
                .getScene()
                .pointToString(module.getY(), this._document.getScene().getOptimalDecimalsCount())
            ));
        var require = true,
        ...
        (this._panel.find('select[data-point-property="tp"]').val(r),
          ...
          this._panel
            ...
            .gCornerTypePicker('value', require ? GTools : GCore.GPathBase.CornerType.Rounded),
          this._panel
    ...
    _assignPathProperty(e, t) {
      this._assignPathProperties([e], [t]);
    }

    _assignPathProperties(e, t) {
      ...
      try {
        ...
        n.commitTransaction(
          GCore.GLocale.get(
            new GCore.GLocaleKey('GPathProperties', 'action.modify-path-properties')
          )
        );
      }
    }
    ...
    _assignPointProperty(e, t) {
      ...
      try {
        ...
        n.commitTransaction(
          GCore.GLocale.get(
            new GCore.GLocaleKey('GPathProperties', 'action.modify-point-properties')
          )
        );
      }
    }

    _assignPointProperties(e, t) {
