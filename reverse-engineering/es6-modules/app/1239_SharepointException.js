...
function (exports, module, require) {
  ...
  ((v.prototype.setTenantURL = function (e) {
    ...
    (v.prototype.getSanitizedFolderRelativePath = function (e) {
      ...
      return (
        this.RELATIVE_PATH &&
          (module = (0, CollaborationMergeUtils.trimStart)(module, this.RELATIVE_PATH)),
    ...
    (v.clearOldAccessTokens = function () {
      ...
      for (let require = 0; require < module; require++) {
        ...
        0 === t.indexOf(''.concat(v.ACCESS_TOKEN_PROP_NAME, '.')) && exports.push(t);
      }
    ...
    (v.isTokenValid = function (e, t) {
      ...
      return require
        ...
        : !(!e || !e.expires || e.expires <= Date.now() / 1e3) && !(!e.id || e.id !== t);
    }),
  ...
  ((v.SharepointException = _),
    ...
    (v.prototype._createQueryFilesURL = function (e) {
      const {
          folderRelativeUrl: module,
          orderBy: require,
          limit: _interopRequireDefault,
          skip: GCore,
        } = e,
    ...
    (v.prototype.checkInFile = function (e) {
      let module =
          arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : 'New Comment',
        require =
    ...
    (v.prototype.post = function (e, t) {
      ...
      return (
        (require =
          _interopRequireDefault && _interopRequireDefault.blobRequest ? new Blob([t]) : t),
    ...
    (v.prototype._query = function (e, t) {
      let require,
        _interopRequireDefault =
          arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : null,
        GCore = arguments.length > 3 && undefined !== arguments[3] ? arguments[3] : null;
      return (
        (require =
        ...
        if (401 === GError.status)
          ...
          if (
            ...
            return (0, DataModule_593.readResponseWithProgress)(
              ...
              _interopRequireDefault.progress,
              false
            ).then((e) => CloudException(e));
          if (_interopRequireDefault && _interopRequireDefault.rawResponse)
            return CloudException(GError);
          let e = {};
    ...
    (v.prototype._prepareRequestHeaders = function (e, t, n) {
      ...
      this._isBodyRequestRequired(e, t) &&
        ((_interopRequireDefault['Content-Type'] =
          (n && n.headers && n.headers['Content-Type']) || 'application/json;odata=verbose'),
    ...
    (v.prototype.connect = async function (e) {
      ...
      return MSTeamsAuthManager
        ? !e && GMicrosoftUser
          ...
          : (AppSettings.msTeamsMode
              ...
              : (require._connect = MSTeamsAuthManager.authenticate(_interopRequireDefault, {
                  clearCache: e,
                })),
            require._connect.then(
              (e) => (
                ...
                e.expires && e.token
                  ...
                  : 'string' == typeof e &&
                    ((require.TOKEN.expires = f.expires = Math.floor(Date.now() / 1e3) + 3600),
        ...
        : ((require._connect = new Promise((GCloudStorage, AppSettings) => {
            !(function t(GMicrosoftUser) {
              gContainer
                .getProperty(''.concat(v.ACCESS_TOKEN_PROP_NAME, '.').concat(require.SETTINGS_ID))
                .then((MSTeamsAuthManager) => {
                  if (MSTeamsAuthManager && !e && v.isTokenValid(MSTeamsAuthManager, v.getUserId()))
                    return (
                      (require.TOKEN = MSTeamsAuthManager),
                      GCloudStorage(),
                      void (require._connect = null)
                    );
                  $(window).on('message', b);
                  var m = new URL(''.concat(window.location.origin, '/sp.html'));
                  const y = require._popupToCenter(m.href, 'SharePointToken', 680, 460);
      ...
      function CollaborationMergeUtils(e) {
        let module = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : 0;
        setTimeout(() => {
          e.close();
        }, module);
      }
    ...
    (v.prototype.updateFileContent = function (e, t) {
      return this._putBlob(
        "/_api/web/GetFileByServerRelativeUrl('".concat(e.relativeUrl, "')/$value"),
        t
      );
    }),
    (v.prototype.updateItem = function (e, t) {
      const require = this.getSanitizedFolderRelativePath(e.relativeUrl);
      return this.post(
        "/_api/web/GetFolderByServerRelativeUrl('".concat(require, "')/ListItemAllFields"),
        t,
    ...
    (v.prototype.deleteItem = function (e) {
      ...
      return this.post("/_api/web/GetFolderByServerRelativeUrl('".concat(module, "')"), null, {
