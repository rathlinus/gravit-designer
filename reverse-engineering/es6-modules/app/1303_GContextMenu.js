...
function (exports, module, require) {
  ...
  class V {
    constructor(e) {
      ...
      var GCreateSymbolAction =
      GConvertToPathAction && GConvertToPathAction.previousEvent
      ? GConvertToPathAction.previousEvent
      : GConvertToPathAction,
      GDetachSymbolAction = gDesigner.getToolManager().getActiveTool(),
      GResetInstanceAction =
      (e.data && e.data.context) ||
      (GCreateSymbolAction && GCreateSymbolAction.data && GCreateSymbolAction.data.context);
      if (
      !GDetachSymbolAction ||
      !GDetachSymbolAction.catchesContextMenu(GResetInstanceAction == U.LayerPanel || false)
      ) {
      ...
      : GDetachSymbolAction instanceof GTools.GSelectTool &&
      GDetachSymbolAction.isCropContext()
      ? ((GDetachFromPathAction = n),
      gDesigner.stats('contextmenu_open_crop-menu'))
      : ((GDistributeAction = true),
      gDesigner.stats('contextmenu_open_context-menu'));
    ...
    _contextMenuClientPosition = null;
    _mouseEvent = null;
    _options = null;
    _contextMenuTouch = null;
    _contextMenuDesktop = null;
    ...
    _createContextMenu() {
      ...
      (n.setCaption(GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'text.arrange'))),
        n
          .getMenu()
          .createAddItem(
            gDesigner.getAction(
      ...
      (GMenuOpenEvent.setCaption(
        ...
        GMenuOpenEvent.getMenu().createAddItem(
          gDesigner.getAction(GAlignAction.ID + '.' + GTools.GEditor.ArrangeAlignType.AlignLeft)
        ),
        GMenuOpenEvent.getMenu().createAddItem(
          gDesigner.getAction(GAlignAction.ID + '.' + GTools.GEditor.ArrangeAlignType.AlignCenter)
        ),
        GMenuOpenEvent.getMenu().createAddItem(
          gDesigner.getAction(GAlignAction.ID + '.' + GTools.GEditor.ArrangeAlignType.AlignRight)
        ),
        GMenuOpenEvent.getMenu().createAddItem(
          gDesigner.getAction(
        ...
        GMenuOpenEvent.getMenu().createAddItem(
          gDesigner.getAction(GAlignAction.ID + '.' + GTools.GEditor.ArrangeAlignType.AlignTop)
        ),
        GMenuOpenEvent.getMenu().createAddItem(
          gDesigner.getAction(GAlignAction.ID + '.' + GTools.GEditor.ArrangeAlignType.AlignMiddle)
        ),
        GMenuOpenEvent.getMenu().createAddItem(
          gDesigner.getAction(GAlignAction.ID + '.' + GTools.GEditor.ArrangeAlignType.AlignBottom)
        ),
        GMenuOpenEvent.getMenu().createAddItem(
          gDesigner.getAction(
      ...
      (GCropAction.setCaption(
        ...
        GCropAction.getMenu().createAddItem(
      ...
      (GCancelCropAction.setCaption(
        ...
        GCancelCropAction.getMenu().createAddItem(
          gDesigner.getAction(GSelectByPaintLayerAction.getId(GSelectByPaintLayerAction.Type.Fill))
        ),
        GCancelCropAction.getMenu().createAddItem(
          gDesigner.getAction(
            GSelectByPaintLayerAction.getId(GSelectByPaintLayerAction.Type.Border)
          )
        ),
        GCancelCropAction.getMenu().createAddItem(
          gDesigner.getAction(
            GSelectByPaintLayerAction.getId(GSelectByPaintLayerAction.Type.FillAndBorder)
          )
        ),
        GCancelCropAction.getMenu().createAddDivider(),
        GCancelCropAction.getMenu().createAddItem(
          gDesigner.getAction(GSelectByBorderWidthAction.ID)
        ),
        GCancelCropAction.getMenu().createAddItem(
          gDesigner.getAction(GSelectByTransparencyAction.ID)
        ),
      ...
      return (
        ...
        GExportAction.addEventListener(
          ...
          function () {
            ...
            if (!(e && e.length > 0 && e[0] instanceof GCore.GPage) && e && e.length > 0) {
    ...
    _getHitsElments(e) {
      ...
      if (
        ...
        GAttachToPathAction &&
          GAttachToPathAction.length > 0 &&
          GAttachToPathAction[0] instanceof GCore.GPage)
      )
      ...
      if (GAttachToPathAction && GAttachToPathAction.length > 0)
        for (
          var GDetachSymbolAction = 0;
          GDetachSymbolAction < GAttachToPathAction.length;
          ++GDetachSymbolAction
        ) {
          for (
            var GResetInstanceAction = GAttachToPathAction[GDetachSymbolAction].element.getParent(),
              GDetachFromPathAction = false,
              GDistributeAction = 0;
            ...
            if (GAttachToPathAction[GDistributeAction].element === GResetInstanceAction) {
              ((GDetachFromPathAction = true),
                GCreateSymbolAction['temp-' + GDistributeAction]
                  ? GCreateSymbolAction['temp-' + GDistributeAction].push(
                      GAttachToPathAction[GDetachSymbolAction].element
                    )
                  : (GCreateSymbolAction['temp-' + GDistributeAction] = [
                      GAttachToPathAction[GDetachSymbolAction].element,
                    ]));
          ...
          GDetachFromPathAction ||
            GConvertToPathAction.push(GAttachToPathAction[GDetachSymbolAction]);
        }
      return {
        elementHits: GAttachToPathAction,
        filteredElementHits: GConvertToPathAction,
        submenus: GCreateSymbolAction,
      };
    }
    ...
    _createPageMenu() {
      var e = new GMenu(null, 'g-page-option-menu'),
        t = {
          ...
          DELETE: GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'page-panel.text.delete')),
          COPY: GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'page-panel.text.copy')),
          EXPORT: GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'page-panel.text.export')),
        },
    ...
    _createFillPropertyMenu() {
      var e = new GMenu(null, 'fill-context-menu'),
        t = null,
        n = {
          DELETE: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'fill-properties-panel.text.delete-fill')
          ),
          COPY: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'fill-properties-panel.text.copy-fill')
          ),
        },
    ...
    _createBorderPropertyMenu() {
      var e = new GMenu(null, 'border-context-menu'),
        t = null,
        n = {
          ADVANCED: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'border-properties-panel.text.advanced-settings')
          ),
          DELETE: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'border-properties-panel.text.delete-border')
          ),
          COPY: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'border-properties-panel.text.copy-border')
          ),
        },
    ...
    _createEffectPropertyMenu() {
      var e = new GMenu(null, 'effect-context-menu'),
        t = null,
        n = {
          COPY: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'effect-properties-panel.text.copy-effect')
          ),
          APPLY_TO_ELEMENT: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'effect-properties-panel.text.apply-to-element')
          ),
          APPLY_TO_FILL: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'effect-properties-panel.text.apply-to-fill')
          ),
          APPLY_TO_BORDER: GCore.GLocale.get(
            new GCore.GLocaleKey('GContextMenu', 'effect-properties-panel.text.apply-to-border')
          ),
        },
