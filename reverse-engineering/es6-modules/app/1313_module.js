...
function (exports, module, require) {
  ...
  class p extends GCore.GObject {
    ...
    _documentPasteEvent(e) {
      ...
      if (
        ...
        if (e.clipboardData && e.clipboardData.items && e.clipboardData.items.length) {
          for (
            var require = module.items, GTools = {}, GFontsProviderManager = 0;
            GFontsProviderManager < require.length;
          ...
          if (module.types && module.types.length) {
            ...
            for (
              ...
              GFontsProviderManager < c.length;
              GFontsProviderManager++
            ) {
              var d;
              if (
      ...
      for (
        ...
        if (e[GCore.GNode.MIME_TYPE]) {
          var g = GCore.GNode.deserialize(e[GCore.GNode.MIME_TYPE]),
            ...
            f = require.filterUnrestrictedCommercialFileElements(h ? g.getChildren() : g);
          if ((f && f.length > 0) || h) {
          ...
          if (e && e.length > 0 && e[0] instanceof GCore.GText && a.isInlineEditing()) {
            ...
            try {
              if (!this.executeCallback([P], true)) {
                ...
                (GTools.GElementEditor.getEditor(P).invalidateTextWidth(), this._centerToView());
              }
            } finally {
              return void (
                module &&
    ...
    _filterForInlineEditing(e) {
      return e ? e.filter((e) => !(e instanceof GCore.GCollaborativeTextAnnotation)) : null;
    }

    _filterForStyleExceptions(e) {
      for (
    ...
    _centerToView(e) {
      ...
      if (
        ((n = GFontsProviderManager.isFixedSized()
          ? GAnnotationsSidebar.getGeometryBBox()
          : GFontsProviderManager.getPaintBBox()),
        barrel_editor_actions)
      ) {
