  ...
  exports.exports = (function () {
      ...
      o = (function () {
        ...
        function t(e) {
          ...
          return {
            ...
            peek: function (e) {
              return (o || t(), undefined === e && (e = n.length - 1), n[e]);
            },
            pop: function () {
              return (o || t(), n.pop());
            },
        ...
        function o(e, t, n, o, i, a, r) {
          var s = this;
          ((s.r1 = e), (s.r2 = t), (s.g1 = n), (s.g2 = o), (s.b1 = i), (s.b2 = a), (s.histo = r));
        }
        function i() {
          ...
          (o.prototype = {
            ...
            contains: function (e) {
              var t = this,
                ...
                o = e[1] >> c,
                i = e[2] >> c;
              return n >= t.r1 && n <= t.r2 && o >= t.g1 && o <= t.g2 && i >= t.b1 && i <= t.b2;
            },
          }),
          (i.prototype = {
            push: function (e) {
            ...
            forcebw: function () {
              ...
              var o = e.length - 1,
                i = e[o].color;
              i[0] > 251 && i[1] > 251 && i[2] > 251 && (e[o].color = [255, 255, 255]);
            },
          }),
          {
    ...
    return (
      ...
      (e.prototype.getPalette = function (e, n, i) {
        ((undefined === n || n < 2 || n > 256) && (n = 10), (undefined === i || i < 1) && (i = 10));
        for (
          var a,
            r,
            s,
          ...
          ((r = d[(a = 4 * g) + 0]),
            (s = d[a + 1]),
            (l = d[a + 2]),
            d[a + 3] >= 125 && ((r > 250 && s > 250 && l > 250) || p.push([r, s, l])));
