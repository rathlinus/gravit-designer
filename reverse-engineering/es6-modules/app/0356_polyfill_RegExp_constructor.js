            ...
            DataModule_459 &&
              ((e = (uncurryThis = (function (e) {
                for (
                  ...
                  if ('\\' === (t = D(e, hasOwnProperty_wrapper)))
                    ...
                    switch (true) {
                      ...
                      case '(' === t:
                        if (
                          ((globalThis += t),
                          '?:' === k(e, hasOwnProperty_wrapper + 1, hasOwnProperty_wrapper + 3))
                        )
                          continue;
                        (P(O, k(e, hasOwnProperty_wrapper + 1)) &&
                          ((hasOwnProperty_wrapper += 2), (createProperty = true)),
                          d++);
                        continue;
                      case '>' === t && l:
