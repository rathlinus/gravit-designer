...
function (exports, module, require) {
  ...
  const Md5 = require(435) /* Md5 */,
    r = (module.syncImagesToCloud = async function (
      e,
      t,
      n,
        ...
        for (var p = 0; p < S; ++p) {
          ...
          if (E)
            ...
            for (var m = t, y = 0; y < n.length; ++y) {
              ...
              if ((v.url + '').startsWith(GDictionary.default.PROTOCOL) && v.url === _) {
                v.name && (m = v.name);
                break;
              }
            }
            ...
            w &&
              (_interopRequireDefault.headers = Object.assign(_interopRequireDefault.headers, {
                'Content-Type': w,
              }));
    ...
    s = (e, t, n) => {
      ...
      return (
        GDictionary && 'GET' !== _interopRequireDefault && (c.body = GDictionary),
        fetch(e, c).then((e) => e.json())
      );
    };
