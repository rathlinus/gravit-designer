...
function (exports, module, require) {
  ...
  class y extends GAction {
      ...
      const GAction = () => {
        ...
        (gContainer.getRuntime() === GContainer.Runtime.Electron &&
          ...
          ? GSystemDialog.confirm(
              GCore.GLocale.get(new GCore.GLocaleKey('GPrintAction', 'printing-warning')),
              (e) => {
                e && y();
              },
              undefined,
              ...
              if (m) v();
                ...
                GLoginPanel
                  ...
                  : ((GEditor.dpi = CollaborationMergeUtils[GCore - 1]),
                    (h.onload = _),
                    e.store(n, b, MenuItemBuilder, GEditor));
              }
            })();
          },
          () => {
    ...
    static ID = 'file.print';

    static TITLE = new GCore.GLocaleKey('GPrintAction', 'title');
