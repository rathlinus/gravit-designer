...
function (exports, module, require) {
  ...
  exports.exports = class {
                ...
                ? ((r._CURRENT_CATEGORY = _interopRequireDefault),
                  (n =
                    (r._CURRENT_ROOT_CATEGORY &&
                      (r._CURRENT_ROOT_CATEGORY.name || r._CURRENT_ROOT_CATEGORY.path)) ||
                    r._CURRENT_ROOT_CATEGORY ||
                    '') && (n += '-'),
                  (n +=
                    (r._CURRENT_CATEGORY &&
                      (r._CURRENT_CATEGORY.name || r._CURRENT_CATEGORY.path)) ||
                    r._CURRENT_CATEGORY ||
                    ''))
    ...
    _initMasonryLayoutColumns(e, t, n, _interopRequireDefault) {
      if (
        (_interopRequireDefault && e && (t = e.find('.column').children()).unwrap(), 0 === t.length)
      )
        return;
              ...
              if (e)
                ...
                try {
                  if (!h || h instanceof GCore.GImage) {
                    ...
                    ((m = GCore.GLocale.get(
                      new GCore.GLocaleKey('GFillPaintLayerProperties', 'action.change-properties')
                    )),
    ...
    _transformNode(e, t) {
      if (t && e.hasMixin(GCore.GElement.Transform)) {
        ...
        (require &&
          ((_interopRequireDefault += require.getWidth() / 2), (i += require.getHeight() / 2)),
          e.transform(
            new GCore.GTransform(1, 0, 0, 1, t.x - _interopRequireDefault, t.y - i),
            true
          ));
      }
    }
                  ...
                  .append(
                    $('<div/>')
                      ...
                      .append(
                        $('<span/>').text(
                          GCore.GLocale.get(
                            new GCore.GLocaleKey('GCommonNames', 'text.back-to-top')
                          )
                        )
                      )
        ...
        i = function (e) {
          ...
          (i.empty(),
            ...
            e &&
              ...
              _interopRequireDefault._loadAssets(
                i,
                e,
                _interopRequireDefault._updateUI.bind(_interopRequireDefault),
                true
              )));
        };
      (t
        ...
        .append(
          $('<input/>')
            ...
            .attr(
              'placeholder',
              GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'element.search')) + '...'
            )
    ...
    _loadMoreButton(e, t) {
      return $('<div/>')
        ...
        .append(
          $('<button/>')
            .addClass('load-more')
            .text(GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.library-load-more')))
            .on('click', () => {
              (this._loadAssets(
            ...
            var u = function (e) {
              ...
              (GCore.removeClass('first second third'),
                module
                  ...
                  : (GCore.addClass(e), GCore.css('display', ''), n.addClass('active')));
            };
    ...
    _onItemDragStartHandler(e, t, n) {
      ...
      if (e.path.startsWith('element.line.tile'))
        GCore =
          (i =
            r.getGeometryBBox() && r.isFixedSized() ? 0.4 * r.getGeometryBBox().getWidth() : 320) /
          10;
      else {
    ...
    _onItemDragEndHandler(e) {
      if (
        ($(this.dragPreview).remove(), Date.now() - this._clickCheckTime <= 200 || !this._dragMoved)
      )
        return (
      ...
      if (((this._dragMoved = false), this._dragging)) {
        ...
        if (gDesigner.positionIsOnCanvas(require, _interopRequireDefault)) {
          ...
          (Object.assign(GCore, e),
            ...
            (GCore.offsetX = e.offsetX + (this._dragOffset && this._dragOffset.x)),
            (GCore.offsetY = e.offsetY + (this._dragOffset && this._dragOffset.y)),
