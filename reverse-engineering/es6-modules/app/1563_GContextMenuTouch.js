  ...
  ((a.prototype._contextMenuContainerTouch = null),
    (a.prototype._createTouchContextMenu = function () {
      ...
      const require = gDesigner.getAction(GMergeMainAction.ID),
        GTools =
          require &&
          require.getSubActions().concat(gDesigner.getAction(GCreateNestedCompoundAction.ID));
      ($('<div/>')
          ...
          columns: [
            {
              content: this._createActionButtonWithMenu(
                ...
                GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'text.create-compound')),
                GTools
              ),
            },
          ],
            ...
            columns: [
              {
                content: this._createActionButtonWithMenu(
                  ...
                  GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'text.convert-to-path')),
                  [
            ...
            columns: [
              {
                content: this._createActionButtonWithMenu(
                  ...
                  GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'text.create-symbol')),
                  [
                      ...
                      click: (e) => {
                        ...
                        if (t) {
                          ...
                          if (GTools && GTools.length) {
                            var a = GTools.find(
                              (e) => e instanceof GCore.GSymbol && !e.isLocked() && !e.isMaster()
                            );
                            if (a) {
      ...
      var a = [
        {
          caption: GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'text.crop')),
          click: (e) => {
          ...
          update: (e) => {
            ...
            e.setCaption(
              GCore.GLocale.get(
                new GCore.GLocaleKey('GImageProperties', t ? 'action.no-crop' : 'action.crop')
              )
            );
          },
        },
        {
          caption: GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'text.original-size')),
          click: (e) => {
        ...
        {
          caption: GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'text.replace-image')),
          click: (e) => {
    ...
    (a.prototype._createActionButton = function (e) {
      ...
      e.action &&
        GConvertToPathAction.addClass('action')
      ...
      return (
        ...
        e.label && GCreateSymbolAction.append($('<span></span>').addClass('label').text(e.label)),
        e.isMenu &&
          GCreateSymbolAction.append(
            $('<span></span>').addClass('icon item-tail gravit-icon-chevron-left-small')
          ),
    ...
    (a.prototype._createActionButtonWithMenu = function (e, t, n) {
      ...
      GCore.append(this._createActionButton({ action: e, label: t, longButton: true }));
    ...
    (a.prototype._createSelectMenuButton = function () {
      ...
      return (
        e.append(
          this._createActionButton({
            label: GCore.GLocale.get(new GCore.GLocaleKey('GContextMenu', 'text.select')),
            click: (e) => {
