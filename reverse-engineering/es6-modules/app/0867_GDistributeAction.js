...
function (exports, module, require) {
  ...
  class l extends GAction {
    constructor(e) {
      ...
      new GCore.GLocaleKey('GDistributeAction', 'text.horizontal-tooltip-description')
      ),
      learnMore: '',
      }),
      ...
      description: GCore.GLocale.get(
      new GCore.GLocaleKey('GDistributeAction', 'text.vertical-tooltip-description')
      ),
      learnMore: '',
      }),
      },
      ...
      return (
        !!(e =
          ...
          (gDesigner.getActiveDocument()
            ...
            : null)) && (t ? e.length > 1 : n > 0 ? e.length >= 2 : e.length > 2)
      );
    }
    ...
    execute(e, t, n) {
      ...
      if (!t) for (let n = 0; n < e.length; ++n) t = t ? t.united(e[n].elbbox) : e[n].elbbox;
      if (t && !t.isEmpty())
