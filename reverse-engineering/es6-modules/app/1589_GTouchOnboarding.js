  ...
  exports.exports = new (class {
    ...
    _calculatePosition(e, t, n) {
      ...
      switch (i) {
        ...
        case GCore.GRect.Side.BOTTOM_CENTER: {
          const t = e.getSide(GCore.GRect.Side.CENTER).getX();
          return new GCore.GPoint(a.getX() - t + (n.offsetX || 0), a.getY() + (n.offsetY || 0));
        }
        ...
        case GCore.GRect.Side.RIGHT_CENTER: {
          const t = e.getSide(GCore.GRect.Side.CENTER).getY();
          return new GCore.GPoint(a.getX() + (n.offsetX || 0), a.getY() - t + (n.offsetY || 0));
        }
        default:
    ...
    _createTooltip(e) {
      const module = $('<div>')
        .addClass('content')
        .append(
          $('<span/>').text(GCore.GLocale.get(new GCore.GLocaleKey('GQuickHelpScreen', e.i18n)))
        );
      return $('<div/>')
