  ...
  class c extends GMainAction.default {
    ...
    isEnabled() {
      ...
      for (let exports = 0; exports < require.length; ++exports) {
        ...
        if (
          ((_interopRequireDefault = _interopRequireDefault.concat(c.getValidItems(t))),
      ...
      if (1 === _interopRequireDefault.length) {
        ...
        return e instanceof GCore.GCompoundShape || e.getParent() instanceof GCore.GCompoundShape;
      }
      return false;
    }
    getShortcutHint(e) {
