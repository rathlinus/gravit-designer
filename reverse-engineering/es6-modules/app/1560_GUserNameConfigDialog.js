  ...
  exports.exports = class {
    constructor(e, t) {
      ...
      ((this._firstName = e),
        ...
        (this._confirmBtn = $('<button/>')
          ...
          .text(GCore.GLocale.get(new GCore.GLocaleKey('GUserNameConfigDialog', 'text.ok')))
          .on('click', () => {
            ...
            $('<div/>')
              ...
              .append(
                $('<span/>')
                  ...
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GUserNameConfigDialog', 'text.dialog-title')
                    )
                  )
              )
          )
            ...
            $('<div/>')
              ...
              .append(
                $('<span/>')
                  ...
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GUserNameConfigDialog', 'text.name-usage-tips')
                    )
                  )
              )
          )
      ...
      return $('<div/>')
        ...
        .append(
          $('<div/>')
            ...
            .append(
              $('<span/>').text(
                GCore.GLocale.get(new GCore.GLocaleKey('GUserNameConfigDialog', 'text.first-name'))
              )
            )
            .append(
              $('<input/>')
        ...
        .append(
          $('<div/>')
            ...
            .append(
              $('<span/>').text(
                GCore.GLocale.get(new GCore.GLocaleKey('GUserNameConfigDialog', 'text.last-name'))
              )
            )
            .append(
              $('<input/>')
    ...
    async _updateUserName() {
      const exports = { name: this._firstName, last_name: this._lastName },
        module = new GUserModel.default(exports);
      (this._anonymous
    ...
    async _updateUserProperties(e) {
      ((GTools.GEditorOptions.userConfig = Object.assign({}, GTools.GEditorOptions.userConfig, {
