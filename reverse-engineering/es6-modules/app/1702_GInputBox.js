  ...
  var r = _interopRequireDefault(require(1278) /* module_1278 */),
    s = {
      value: function (e) {
        ...
        function _interopRequireDefault(e) {
          if (n) {
            ...
            'undefined' != typeof gDesigner &&
              ...
              (t = gDesigner.getActiveDocument().getScene().getProperty('ut'));
        ...
        function GEditor(e) {
          if (n) {
            ...
            ('number' != typeof r && 'number' != typeof s) ||
              (('number' == typeof GEditor && isFinite(GEditor)) || (t && n.options.allowEmptyValue)
                ? 'number' == typeof r && null !== GEditor && GEditor < r
                  ? (e = r.toString())
                  : 'number' == typeof s && null !== GEditor && GEditor > s && (e = s.toString())
                : (e = 'number' == typeof r ? r.toString() : s.toString()));
          }
          return e;
        }
        function r(e) {
          if (((e || 0 === e) && (e = (e = e.toString()).replace(',', '.')), n)) {
            if (
              ((e = GEditor(e)),
            ...
            'undefined' != typeof gDesigner &&
              gDesigner.getActiveDocument() &&
              (_interopRequireDefault = gDesigner.getActiveDocument().getScene().getProperty('ut'));
            var GCore =
              n.options && n.options.postfix !== _interopRequireDefault ? n.options.postfix : null;
            e && e.length && GCore && e.substr(e.length - GCore.length) !== GCore && (e += GCore);
          }
          var r = t[0];
        ...
        return (
          (s = GEditor(s)),
          (n && (n.options.allowEmptyValue || (s && null !== c && isFinite(c)))) || (s = '0'),
          s
        );
      },
      ...
      mousemoveIncrement: function (e, t, n, _interopRequireDefault) {
        ...
        if ('number' == typeof n && !isNaN(n) && r) {
          ...
          ('undefined' != typeof gDesigner &&
            ...
            c < 1 && 0 == d && (c = 1));
          var u = n + c;
          return (s.value.call(this, GCore.GUtil.formatNumber(u, d)), GEditor.change(), u);
        }
      },
      onFocusIn: function () {
        var e = $(this);
          ...
          var c = function (e) {
            ...
            d = function (e) {
              ($('body').css('pointer-events', ''),
                ...
                'undefined' != typeof gDesigner &&
                  gDesigner.isTouchDevice() &&
                  (l && l.css('overflow-y', 'auto'), t.is(':focus') || t.css('border', '')));
            };
          (t.on('touchmove', c), $('html').bind('mousemove', c), $('html').bind('mouseup', d));
        }
      },
            ...
            ((e = $.extend(
              ...
              e.created ||
                n
                  ...
                  .on('wheel', function (e) {
                    if (n.data('ginputbox').options.wheelIncrement && n.is(':focus')) {
                      e.preventDefault();
                      var _interopRequireDefault =
                  ...
                  .on('mouseenter', function (e) {
                    r.default.isEnabled() && (e.preventDefault(), s.onMouseEnter.call(t));
                  })
                  ...
                  .on('mousedown', function (e) {
                    r.default.isEnabled() &&
                      ...
                      $(this).parents('.properties-panel').addClass('noscroll'));
                  })
                  .on('mouseup', function (e) {
                    r.default.isEnabled() &&
                      1 === e.which &&
                      (s.leftMouseUp.call(t),
                      $(this).parents('.properties-panel').removeClass('noscroll'));
                  }));
          }),
          this
        );
