...
function (exports, module, require) {
  ...
  class b extends u {
    ...
    static async from(e, t, n, _interopRequireDefault, GCore) {
      let AppSettings = t;
      return (
        'string' == typeof t &&
        ...
        AppSettings
          ? new b.Item(
              ...
              n || AppSettings.name,
              AppSettings,
              _interopRequireDefault || AppSettings.version,
              null,
              GCore
            )
          : null
    ...
    static Item(e, t, n, _interopRequireDefault, GCore, AppSettings, GEvent_storageItem) {
      if (
        (u.Item.call(this, e),
        (this._filename = n),
        (this._id = t),
        ...
        (this._fileLastModifiedDate =
          ...
          new Date(_interopRequireDefault.updated || _interopRequireDefault.created)),
  ...
  (GCore.GObject.inheritAndMix(b.Item, u.Item, [DataModule_436]),
    ...
    b.Item.prototype.read = async function (e, t) {
      ...
      p.loadDesignData(this._id, true, this._versionId, this._token, this._file, this._isAutoSave)
        .then((t) => {
          e(t.data);
        })
        .catch(t);
    ...
    b.Item.prototype._performDefaultWrite = async function (
      e,
      t,
      n,
      _interopRequireDefault,
    ...
    b.Item.prototype._uploadBinary = async function (e) {
      ...
      if (GCore.status >= 400) {
        if (400 === GCore.status)
          throw new Error('Invalid response, probably corrupted upload: ' + GCore.status);
    ...
    b.Item.prototype._checkUserQuotaLimit = async function () {
      ...
      if (require > 0) {
        if ((await AppSettings.gApi.quota()) > require) {
          const e = new Error(
            GCore.GLocale.get(
              new GCore.GLocaleKey('GCommonNames', 'text.running-out-of-cloud-space')
            )
          );
          throw ((e.code = 507), e);
        }
    ...
    b.Item.prototype.hasUpdates = async function () {
      ...
      const module = exports.getModificationTime() || exports.updated || exports.created,
        require = this._file.getModificationTime() || this._file.updated || this._file.created;
      ((this._fileLastModifiedDate && !isNaN(this._fileLastModifiedDate.getTime())) ||
      ...
      return (
        (exports.autosave
          ? Math.max(new Date(module).getTime(), new Date(exports.autosave_updated).getTime())
    ...
    b.Item.prototype.getLatestFileInfo = async function () {
      const exports = await gDesigner.getCloudCommunicationManager().getFile(this._id);
