  ...
  exports.exports = class {
    ...
    stop() {
      (this._autostartScheduleId &&
        (clearTimeout(this._autostartScheduleId), delete this._autostartScheduleId),
        this._memoryCheckIntervalId &&
          (clearInterval(this._memoryCheckIntervalId), delete this._memoryCheckIntervalId),
    ...
    _openWarningDialog() {
      this._dialog ||
        ...
        (this._dialog = GSystemDialog.default.custom({
          ...
          closeable: false,
          icon: 'info',
          title: GCore.GLocale.get(new GCore.GLocaleKey('GMemoryManager', 'text.title')).replace(
            '%app',
            s
          ),
          subtitle: GCore.GLocale.get(new GCore.GLocaleKey('GMemoryManager', 'text.subtitle')),
          buttons: [
            {
