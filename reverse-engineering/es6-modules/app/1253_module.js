...
function (exports, module, require) {
  ...
  class u {
    static generateExportables(e, t, n) {
        ...
        if ('png' === DataModule_442 || 'jpg' === DataModule_442) {
          ...
          switch (DataModule_442) {
            case 'png':
              ...
              break;
            case 'jpg':
              ((u = GCore.GBitmap.ImageType.JPEG), (p = (e.jpegQuality || 100) / 100));
          }
          ...
          i.GSVGExport.export(
            l,
            {
              ...
              sceneBackground:
                !e.configuration || e.configuration.sceneBackground || !!e.backgroundColor,
    ...
    static generateExportName(e, t, n) {
      ...
      if (n) {
        ...
        (n.push({ name: i, format: e.format }),
          CollaborationMergeUtils.length &&
            (i += '(' + (CollaborationMergeUtils.length + 1) + ')'));
      }
      return (i += '.' + e.format);
    }

    static async exportToDirectory(e, t, n, i) {
      if (this._validateCommercialDocument())
    ...
    static export(e, t, n, i, CollaborationMergeUtils, AppSettings, DataModule_442, p, g, h) {
      if (this._validateCommercialDocument()) {
        var f = (e, t, n) => {
