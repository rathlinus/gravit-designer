  ...
  (GCore.GObject.inheritAndMix(b.Item, s.default.Item, [DataModule_436]),
    ...
    b.Item.prototype.read = function (e, t) {
      ...
      return function _interopRequireDefault() {
        let GCore = arguments.length > 0 && undefined !== arguments[0] && arguments[0];
    ...
    b.Item.prototype.getLatestFileVersion = async function () {
      ...
      return (
        (_interopRequireDefault._rawData = await exports.getFile(module)),
        _interopRequireDefault.setCloudClient(exports),
    ...
    b.Item.prototype.exists = async function () {
      const exports = this.getFile();
      return this._getClient().fileExists(exports.getNameWithExtension(), exports.getParent());
    },
    ...
    b.Item.prototype.write = async function (e, t, n, _interopRequireDefault, a) {
      ...
      try {
        ...
        (e.updateStatus(u.SaveFailed),
          SharepointException && SharepointException.rollback(),
          n && n(t));
      } finally {
        this._writing = false;
      }
    ...
    b.Item.prototype._createOrUpdateFile = async function (e) {
      ...
      (this._getSharepointId()
        ? ((module = await require.updateFileContentById(
            this._getSharepointId(),
            _interopRequireDefault
          )),
      ...
      try {
        ...
        if (t === SharepointException.default.FILE_STATUS.LOCKED)
          throw new GError.default(
            GCore.GLocale.get(
              new GCore.GLocaleKey('GSharePointStorage', 'text.error-failed-check-out-file')
            )
          );
    ...
    b.Item.prototype.isCheckedOutByMe = function () {
      return this.getFile().checkOutStatus === SharepointException.default.FILE_STATUS.LOCKED_BY_ME;
    },
    ...
    b.Item.prototype._getClient = function () {
      ...
      return (
        !exports &&
          module &&
          module.settings &&
          ((exports = SharepointException.default.getInstance(module.settings)),
    ...
    b.Item.prototype.getMyPermissionsList = async function () {
      const exports = this._getClient(),
        ...
        { High: require, Low: _interopRequireDefault } = await exports
          ...
          .catch(() => ({ High: 0, Low: 0 }));
      if (
        new l.default(require, _interopRequireDefault).hasPermission(
          l.default.Permissions.EditListItems
        )
      ) {
