...
function (exports, module, require) {
  ...
  const {
      ShareRoles: o,
      defaultUserSettings: {
        share: { defaults: { public: { role: i } = {}, private: { role: a } = {} } = {} } = {},
      } = {},
  ...
  class c {
    ...
    static makeFromShare(e) {
    const module = c._makeFromShareRole(e.getRole());
    return (
      module && (module.applyPermissions(new s(e.getPermissions())), module.lockPermissions()),
      module
    );
  }

    static makeFromShareRole(e) {
      const module = c._makeFromShareRole(e);
      return (module.lockPermissions(), module);
    }

    static _makeFromShareRole(e) {
      if (!e) return null;
      const {
          id: module,
          name: require,
