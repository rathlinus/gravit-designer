...
function (exports, module, require) {
  ...
  class _ extends GProperties {
    ...
    init(e, t) {
          ...
          return $('<div></div>')
            .append(
              $('<div/>')
                ...
                .on('change', function () {
                  const t = parseInt($(this).gInputSelect('value')) || GCore.GLength.DPI;
                  (gDesigner.stats('sceneproperties_change_canvas-dpi', t),
                    n._assignProperty(
                      e,
                      t,
                      GCore.GLocale.get(
                        new GCore.GLocaleKey('GSceneProperties', 'action.change-canvas-dpi')
                      )
                    ));
                })
                .gInputSelect({
            ...
            .on('change', function () {
              'gx' === e
                ...
                : 'gy' === e
                  ...
                  : 'gaw' === e &&
                    gDesigner.stats('sceneproperties_change_axono-grid-settings', 'size');
            ...
            .on('change', function () {
              ...
              null !== t && 'number' == typeof t
                ? ((t = GCore.GMath.normalizeAngleDegrees(t)),
                  ...
                  'ga2' == e &&
                    (t = (t = (t = t > 0 ? t - 360 : t) <= -180 ? t + 180 : t) <= -90 ? -89 : t),
        ...
        if (0 === e.indexOf('gm-')) {
          ...
          switch (a) {
            ...
            case GCore.GScene.GridMode.Axonometric:
              i = GCore.GLocale.get(new GCore.GLocaleKey('GSceneProperties', 'text.isometric'));
              break;
            default:
              i = GCore.GLocale.get(new GCore.GLocaleKey('GSceneProperties', 'text.off'));
          }
          return $('<label></label>')
            .append(
              $('<input>')
            ...
            .on('change', function () {
              (gDesigner.stats('sceneproperties_change_canvas-unit', $(this).val()),
                n._assignProperty(
                  ...
                  $(this).val(),
                  GCore.GLocale.get(
                    new GCore.GLocaleKey('GSceneProperties', 'action.change-canvas-unit')
                  )
                ));
            });
        if (0 === e.indexOf('sync-')) {
          i = GCore.GLocale.get(
            new GCore.GLocaleKey('GSceneProperties', 'text.' + e.substring('sync-'.length))
          );
          return $('<label></label>')
            .append(
              $('<input>')
                ...
                .on('change', function (e) {
                  ...
                  (gDesigner.stats('sceneproperties_toggle_sync', t ? 'enable' : 'disable'),
      ...
      if (
        ($('<label></label>')
          .text(GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.document')))
          .appendTo(t),
        $('<div></div>')
          .addClass('unit-row')
          .gPropertyRow({
                ...
                content: n(
                  ...
                  a.GRichTooltipConfig.from({
                    ...
                    description: GCore.GLocale.get(
                      new GCore.GLocaleKey('GSceneProperties', 'text.unit-tooltip-description')
                    ),
                    middle: false,
                  })
                ),
            ...
            columns: [
              {
                ...
                content: $('<span></span>').text(
                  GCore.GLocale.get(new GCore.GLocaleKey('GSceneProperties', 'text.color-mode'))
                ),
              },
              {
            ...
            columns: [
              {
                ...
                content: $(
                  '<span>' +
                    GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.grid')) +
                    '</span>'
                ),
              },
              {
                ...
                content: n(
                  ...
                  a.GRichTooltipConfig.from({
                    ...
                    description: GCore.GLocale.get(
                      new GCore.GLocaleKey('GSceneProperties', 'text.grid-tooltip-description-off')
                    ),
                    learnMore: '',
                  })
                ),
              },
              {
                ...
                content: n(
                  ...
                  a.GRichTooltipConfig.from({
                    ...
                    description: GCore.GLocale.get(
                      new GCore.GLocaleKey('GSceneProperties', 'text.grid-tooltip-description-on')
                    ),
                    learnMore: '',
                  })
                ),
        ...
        $('<div></div>')
          ...
          .gPropertyRow({
            ...
            columns: [
              ...
              {
                width: '33.3%',
                label: GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.angle')) + ' 1',
                content: n('ga1'),
              },
              {
                width: '33.3%',
                label: GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.angle')) + ' 2',
                content: n('ga2'),
              },
            ],
          })
        ...
        let t = $('<div></div>')
          ...
          .append(
            $('<button></button>')
              ...
              .text(GCore.GLocale.get(new GCore.GLocaleKey('GSceneProperties', 'sync.enable')))
              .on('click', () => {
            ...
            .append(
              $('<div></div>')
                          ...
                          (t.setProperty('cfs', n),
                            n &&
                              this._document.chooseLatestDocument(
                                ...
                                (e, n) => {
                                  if (e !== t || n) {
                                    var GCore = new GDocument(this._document.getStorageItem());
                                    (GCore.setScene(e),
                                      gDesigner.replaceDocument(this._document, GCore));
                                  } else
                ...
                .append(
                  $('<span></span>')
                    .addClass('label')
                    .text(GCore.GLocale.get(new GCore.GLocaleKey('GSceneProperties', 'sync.label')))
                )
    ...
    update(e, t) {
      return (
        ...
        !(
          !e ||
          (1 === t.length && t[0] instanceof GCore.GPage && (this._scene = t[0].getScene()),
          !this._scene)
        ) &&
          ((this._document = e),
          this._document
    ...
    _updateUI() {
      ...
      if (gDesigner.isTouchEnabled()) {
        ...
        (n.find('.dpi-text').length ||
          $('<span/>')
            .addClass('dpi-text')
            .text(GCore.GLocale.get(new GCore.GLocaleKey('GSceneProperties', 'text.dpi')))
            .insertAfter(n.find('input')),
          this._panel
            .find('.unit-title-column span')
            .text(
              GCore.GLocale.get(new GCore.GLocaleKey('GSceneProperties', 'text.unit-tooltip-title'))
            ));
      } else
        (module.find('.dpi-selector-column .g-input-select .dpi-text').remove(),
          ...
          this._panel
            .find('.unit-title-column span')
            .text(GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.unit'))));
    }
    ...
    _updateProperties() {
      ...
      this._panel
        ...
        .gInputSelect('value', this._scene.getProperty('dpi') || GCore.GLength.DPI);
      ...
      (this._panel.find('[data-property="dpi"]').find('[type="text"]').prop('disabled', t),
        ...
        this._panel
          ...
          .attr(
            ...
            t
              ? GCore.GLocale.get(
                  new GCore.GLocaleKey('GCommonNames', 'text.cant-change-cdr-limitations')
                )
              : ''
          ));
      ...
      (require && this._scene.setProperty('cm', require),
        ...
        this._panel
          ...
          .gInputBox(
            'value',
            e.pointToString(this._scene.getProperty('gx'), this._scene.getOptimalDecimalsCount())
          ));
      (this._panel
        .find('input[data-property="gy"]')
        .gInputBox(
          'value',
          e.pointToString(this._scene.getProperty('gy'), this._scene.getOptimalDecimalsCount())
        ),
        this._panel
          .find('input[data-property="gaw"]')
          .gInputBox(
            'value',
            e.pointToString(this._scene.getProperty('gaw'), this._scene.getOptimalDecimalsCount())
          ),
        this._panel
          .find('[type="text"][data-property="ga1"]')
          .gInputBox(
            'value',
            GCore.GUtil.formatNumber(GCore.GMath.toDegrees(this._scene.getProperty('ga1')), 1)
          ),
        this._panel
          .find('[type="text"][data-property="ga2"]')
          .gInputBox(
            'value',
            GCore.GUtil.formatNumber(GCore.GMath.toDegrees(this._scene.getProperty('ga2')), 1)
          ));
      ...
      if (
        ...
        var GGravitCloudAction = (function (e) {
          ...
          return e.getMonth() + 1 + '/' + e.getDate() + '/' + e.getFullYear() + '  ' + GCore;
