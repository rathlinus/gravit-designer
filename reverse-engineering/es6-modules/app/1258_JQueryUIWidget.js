        ...
        typeof (o = function (e) {
          ...
          return (
            (e.cleanData =
              ...
              function (n) {
                ...
                for (a = 0; null != (i = n[a]); a++)
                  try {
                    (o = e._data(i, 'events')) && o.remove && e(i).triggerHandler('remove');
                  } catch (e) {}
                t(n);
              })),
            ...
            (e.widget.extend = function (t) {
              for (var n, i, a = o.call(arguments, 1), r = 0, s = a.length; r < s; r++)
                for (n in a[r])
                  ((i = a[r][n]),
            ...
            (e.Widget.prototype = {
              ...
              option: function (t, n) {
                ...
                if ('string' == typeof t)
                  if (((r = {}), (o = t.split('.')), (t = o.shift()), o.length)) {
                    for (
                    ...
                    if (((t = o.pop()), 1 === arguments.length))
                      return undefined === i[t] ? null : i[t];
                    i[t] = n;
                  } else {
                    if (1 === arguments.length)
                      return undefined === this.options[t] ? null : this.options[t];
                    r[t] = n;
                  }
                ...
                ('boolean' != typeof t && ((o = n), (n = t), (t = false)),
                  ...
                  e.each(o, function (o, r) {
                    function s() {
                      if (
                        t ||
                        (true !== a.options.disabled && !e(this).hasClass('ui-state-disabled'))
                      )
              ...
              _trigger: function (t, n, o) {
                ...
                return (
                  ...
                  !(
                    (e.isFunction(r) && false === r.apply(this.element[0], [n].concat(o))) ||
