  ...
  var core_export = require(25) /* core_export */,
    ...
    m = function (e, t, n) {
      for (var core_export = -1, uncurryThis = n; ++core_export < 6; )
        ((uncurryThis += t * e[core_export]),
          (e[core_export] = uncurryThis % 1e7),
          (uncurryThis = u(uncurryThis / 1e7)));
    },
    y = function (e, t) {
      for (var require = 6, core_export = 0; --require >= 0; )
        ((core_export += e[require]),
          (e[require] = u(core_export / t)),
          (core_export = (core_export % t) * 1e7));
    },
    v = function (e) {
      for (var module = 6, require = ''; --module >= 0; )
        if ('' !== require || 0 === module || 0 !== e[module]) {
          ...
          require =
            '' === require ? core_export : require + p('0', 7 - core_export.length) + core_export;
        }
      return require;
    };
  core_export(
      ...
      toFixed: function (e) {
        ...
        if (
          ...
          if (
            ...
            for (m(u, 0, n), core_export = tryCall; core_export >= 7; )
              (m(u, 1e7, 0), (core_export -= 7));
