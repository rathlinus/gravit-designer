  ...
  class r extends GProperties {
    ...
    init(e, t) {
      ...
      var n = function (e) {
        ...
        try {
          ...
          n.commitTransaction(
            GCore.GLocale.get(new GCore.GLocaleKey('GBoolOpProperties', 'action.modify-merge-mode'))
          );
        }
      }.bind(this);
      ($('<div></div>')
        ...
        .gPropertyRow({
          label: GCore.GLocale.get(new GCore.GLocaleKey('GBoolOpProperties', 'text.boolean')),
          columns: [
            {
              width: '25%',
              content: $('<button></button>')
                ...
                .attr(
                  'data-title',
                  GCore.GLocale.get(new GCore.GLocaleKey('GBoolOpProperties', 'text.union'))
                )
            ...
            },
            {
              ...
              content: $('<button></button>')
                ...
                .attr(
                  'data-title',
                  GCore.GLocale.get(new GCore.GLocaleKey('GBoolOpProperties', 'text.subtract'))
                )
            ...
            },
            {
              ...
              content: $('<button></button>')
                ...
                .attr(
                  'data-title',
                  GCore.GLocale.get(new GCore.GLocaleKey('GBoolOpProperties', 'text.intersect'))
                )
            ...
            },
            {
              ...
              content: $('<button></button>')
                ...
                .attr(
                  'data-title',
                  GCore.GLocale.get(new GCore.GLocaleKey('GBoolOpProperties', 'text.difference'))
                )
    ...
    _updateProperties() {
      ...
      this._panel.find('button[data-op]').each(function (t, n) {
        var GCore = $(n);
        GCore.toggleClass('g-active', e.getProperty('bool') === parseInt(GCore.attr('data-op')));
      });
    }
