      ...
      if (
        ...
        const t = gDesigner.getActiveDocument(),
          ...
          GPanel = (e) => {
            e &&
              !e.isAnonymous() &&
              ((this._lastNotification = null), this._htmlElement.addClass('g-hide'));
          };
        let GView = n
          ? GCore.GLocale.get(
            ...
            $('<div/>')
              ...
              .append(
                $('<span/>')
                  ...
                  .text(
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GNotificationPanel', 'text.title-welcome')
                    ).replace('%app', i)
                  )
              )
              .append(
              ...
              .append(
                $('<span/>').html(
                  GView.replace('%signup', () =>
                    $('<span/>')
                      .attr('id', 'signup-link')
                      .addClass('link')
                      .text(
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GNotificationPanel', 'text.sign-up')
                        )
                      )
                      .prop('outerHTML')
                  ).replace('%signin', () =>
                    $('<span/>')
                      ...
                      .text(
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GNotificationPanel', 'text.sign-in')
                        )
                      )
                      .prop('outerHTML')
                  )
        ...
        e.builder instanceof d
          ...
          : this._updateContent(
              $('<div></div>').addClass('message').append(e.notification.message)
            );
