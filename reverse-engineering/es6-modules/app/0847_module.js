...
function (exports, module, require) {
  ...
  const s = require(1101) /* module_1101 */,
    l = (module.prepareCDRforSaving = async function (e, t, n, _interopRequireDefault, l) {
      ...
      const d = (n) => {
        if (
          (n.status !== r.default.Saving && e.removeEventListener(GDocumentStatusEvent.default, d),
            ...
            if (n.data && n.data instanceof s && n.data.errCode == s.Type.TooBigFileSize) {
              ...
              let n = new Error(
                this.getTitle() +
                  ': ' +
                  GCore.GLocale.get(
                    new GCore.GLocaleKey('GCommonNames', 'text.file-too-large-cannot-be-processed')
                  )
              );
              ((n.code = 507), t(n));
            }
