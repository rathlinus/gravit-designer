...
function (exports, module, require) {
  ...
  class x extends GSidebar {
    ...
    _layerToolbar = null;
    _exportToolbar = null;
    _outlineSidebarElement = null;
    _pageContainerMaxHeight = 500;
    _pageContainerMinHeight = 50;
    _pagePanel = null;
    _pageModeSwitch = null;
    _layerPanel = null;
    _exportPanel = null;
    _exportInstance = null;
    _pageMenuOptionButton = null;
    ...
    init(e) {
      ((this._htmlElement = e),
        ...
        (this._pageModeSwitch = $('<label></label>')
          ...
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.toggle-page-mode'))
          )
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GOutlineSidebar', 'text.multipage-tooltip-description')
              ),
              learnMore: '',
            })
          )),
        ...
        $('<button></button>')
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.delete-active-page'))
          )
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GOutlineSidebar', 'text.delete-page-tooltip-description')
              ),
              learnMore: '',
            })
          ),
        $('<button></button>')
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.create-new-page'))
          )
          .on(
            'click',
            function () {
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GOutlineSidebar', 'text.create-new-page-tooltip-description')
              ),
              learnMore: '',
            })
          ));
      ...
      (this._layerToolbar ||
        ((this._layerToolbar = $('<div></div>')
          ...
          .append(
            $('<label></label>')
              .css('flex-grow', '1')
              .text(GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'text.layers')))
          )
          .on('dragover', function (e) {
            (e.preventDefault(), e.stopPropagation());
          })
        ...
        $('<button></button>')
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.delete-layer-item'))
          )
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GOutlineSidebar', 'text.delete-layer-tooltip-description')
              ),
              learnMore: '',
            })
          ),
        $('<button></button>')
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.new-layer'))
          )
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GOutlineSidebar', 'text.new-layer-tooltip-description')
              ),
              learnMore: '',
            })
          )),
    ...
    _documentEvent(e) {
      ...
      e.type === GDocumentEvent.Type.Activated
        ? ((this._document = e.document),
          ...
          gDesigner
            .getToolManager()
            .addEventListener(GTools.GToolManager.ToolChangedEvent, this._updateExport, this),
          n.addEventListener(GTools.GEditor.SelectionChangedEvent, this._updateExport, this),
          ...
          t.addEventListener(GCore.GNode.AfterInsertEvent, this._afterInsert, this),
          this._updateExport())
        : e.type === GDocumentEvent.Type.Deactivated &&
          ...
          t.removeEventListener(GCore.GNode.AfterInsertEvent, this._afterInsert, this),
    ...
    _insertPage() {
      if (gDesigner.getApplicationManager().isEditingEnabled()) {
        ...
        (GTools.GEditor.tryRunTransaction(
          ...
          GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.insert-page'))
        ),
    ...
    sceneHasInfiniteCanvas() {
      var e = false;
      return (
        this._document.getScene().iteratePages((t) => (t.isFixedSized() || (e = true), !e), true),
        e
      );
    }

    _refreshPageModeSwitch(e) {
              ...
              function (t) {
                t &&
                  GTools.GEditor.tryRunTransaction(
                    ...
                    GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.delete-page'))
                  );
              },
              null,
              null,
    ...
    _refreshSelection() {
      var e = this._document.getEditor(),
        t = this._document.getScene(),
        n = this._document.getActiveWindow().getView().getViewConfiguration().multiPageView,
    ...
    _movePageTreeNodeCallback(e, t, n) {
      if (n && e && n.length) {
        ...
        (GTools.GEditor.tryRunTransaction(
          ...
          function () {
            ...
            (n.length > 1 && e.endUpdate(),
              ...
              _interopRequireDefault.isEvenOddMaster() &&
                _interopRequireDefault.reassignMasterPages());
          }.bind(this),
          GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.move-page'))
        ),
          this._pagePanel.gPagePanel('blockHandlers', false));
      }
    }

    _startPageDraggingCallback(e) {
    ...
    changeActivePage(e) {
      ...
      require &&
        ...
        GTools.GEditor.tryRunTransaction(
          require,
          () => {
            (require.setActivePage(e), this._navigateDrawingCenter(e), this._refreshSelection());
          },
          GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.change-active-page'))
        );
    }

    _clickPageTreeNodeCallback(e) {
      this.changeActivePage(e);
    }

    _navigateDrawingCenter(e) {
    ...
    _moveLayerTreeNodeCallback(e, t, n, _interopRequireDefault) {
      ...
      GTools.GEditor.tryRunTransaction(
        ...
        GCore.GLocale.get(new GCore.GLocaleKey('GOutlineSidebar', 'action.move-layer'))
      );
    }
    ...
    _moveLayers(e, t, n) {
      ...
      if (
        !(n = n.slice().filter((e) => GTools.GEditor.validateBlockInsertion(e.getParent(), e, t)))
          .length
      )
        return;
    ...
    _isDuplicateEffectCallback(e) {
      return e.altKey;
    }

    _duplicateLayerTreeNodeCallback(e, t, n) {
                    ...
                    null === GDocumentEvent ||
                      ...
                      p.transform(
                        new GCore.GTransform(
                          ...
                          0,
                          1,
                          GDocumentEvent - GFitAllAction,
                          GDocumentStatusEvent - GFitSelectionAction
                        ),
                        true
                      );
                  }
    ...
    _startLayerDraggingCallback(e) {
      ...
      if (e) {
        ...
        if (e.hasFlag(GCore.GNode.Flag.Selected)) {
          var _interopRequireDefault = require.getSelection();
          ((t = this._filterLayerDraggable(_interopRequireDefault)),
            (t = GCore.GNode.order(t, true)));
        } else (require.clearSelection(), t.push(e));
      }
      return t;
                  ...
                  GDocumentEvent = GDocumentEvent.filter(
                    function (t) {
                      ...
                      return _interopRequireDefault
                        ? GSidebar === _interopRequireDefault
                        : t !== GSidebar && t !== GSidebarContainer;
                    }.bind(this)
                  );
          ...
          if (_interopRequireDefault)
            if (r.GPlatform.modifiers.optionKey)
              module.hasSelection()
                ...
                : gDesigner.executeAction(GFitAllAction.ID, undefined, 'outlinesidebar');
            else if (e.hasMixin(GCore.GNode.Properties) && e.getProperty('collab')) {
    ...
    static TITLE = new GCore.GLocaleKey('GOutlineSidebar', 'title');

    static MULTIPAGE_MODE_ENABLED_OPTION_NAME = 'OutlineSidebar/Multipage_Mode';
