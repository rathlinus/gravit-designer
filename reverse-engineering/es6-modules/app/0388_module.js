  ...
  (GCore.GObject.inherit(r.Item, i.Item),
    ...
    r.Item.prototype.setFile = function (e) {
      if (!e)
        throw new Error(
          GCore.GLocale.get(
            new GCore.GLocaleKey('GExternalStorage', 'text.error-file-cant-be-null')
          )
        );
    ...
    r.Item.prototype.getFile = function () {
      ...
      return (
        !exports.settings && this._client && (exports.settings = this._client.getSettings()),
        exports
      );
    },
