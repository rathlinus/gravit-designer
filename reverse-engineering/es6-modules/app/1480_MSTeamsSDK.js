  ...
  (window,
    (exports.exports = (function (e) {
      ...
      function (e, t, n) {
          ...
          (t instanceof Function ? (n = t) : t instanceof Array && (o = t),
            ...
            a.GlobalVars.isFramelessWindow
              ? s.currentWindow &&
                ...
                s.currentWindow.nativeInterface.framelessPostMessage(JSON.stringify(e))
        ...
        function d(e) {
          ...
          e &&
                ...
                ((s.currentWindow &&
                  ...
                  !!(
                    ...
                    (a.GlobalVars.additionalValidOriginsRegexp &&
                      a.GlobalVars.additionalValidOriginsRegexp.test(t.toLowerCase()))
                  ))
              );
            })(
            ...
            ((function (e, t) {
              (a.GlobalVars.isFramelessWindow ||
              (s.parentWindow && !s.parentWindow.closed && e !== s.parentWindow)
                ? (s.childWindow && !s.childWindow.closed && e !== s.childWindow) ||
                  ...
                  'id' in e.data &&
                    ...
                    e && undefined !== n
                      ...
                      : c(t.func, t.args, function () {
                          for (var e, n = [], o = 0; o < arguments.length; o++) n[o] = arguments[o];
        ...
        function h(e) {
          for (var t = g(e), n = p(e); e && t && 0 < n.length; ) e.postMessage(n.shift(), t);
        }
        function f(e, t, n) {
          var o = s.childWindow;
          ((t = (function (e, t, n) {
        ...
        ((t.initializeCommunication = function (e, t) {
          ((l.messageListener = function (e) {
            ...
            (s.parentWindow || t) &&
              s.currentWindow.addEventListener('message', l.messageListener, false),
            s.parentWindow ||
              ((a.GlobalVars.isFramelessWindow = true), (window.onNativeMessage = u)));
          try {
      ...
      function (e, t, n) {
        ...
        function l(e) {
          return (
            undefined === e && (e = a.defaultSDKVersionForCompatCheck),
            (e = (0, s.compareSDKVersions)(r.GlobalVars.clientSupportedSDKVersion, e)),
            !isNaN(e) && 0 <= e
          );
        }
        function c() {
        ...
        ((t.ensureInitialized = function () {
          ...
          if (r.GlobalVars.frameContext && e && 0 < e.length) {
            ...
            if (!n)
              throw new Error(
                "This call is not allowed in the '" + r.GlobalVars.frameContext + "' context"
              );
          }
        }),
          ...
          (t.processAdditionalValidOrigins = function (e) {
            e = r.GlobalVars.additionalValidOrigins.concat(
              e.filter(function (e) {
                return 'string' == typeof e && a.userOriginUrlValidationRegExp.test(e);
              })
            );
            var t = {};
            ((e = e.filter(function (e) {
              ...
              0 < r.GlobalVars.additionalValidOrigins.length
                ? (r.GlobalVars.additionalValidOriginsRegexp = (0, s.generateRegExpFromUrls)(
      ...
      function (e, t, n) {
        ...
        function s(e) {
          (r.themeChangeHandler && r.themeChangeHandler(e),
            a.Communication.childWindow && (0, a.sendMessageEventToChild)('themeChange', [e]));
        }
        function l() {
          (r.backButtonPressHandler && r.backButtonPressHandler()) || (0, i.navigateBack)();
        }
        function c(e) {
        ...
        function d(e) {
          (r.loadHandler && r.loadHandler(e),
            a.Communication.childWindow && (0, a.sendMessageEventToChild)('load', [e]));
        }
        function u() {
          function e() {
        ...
        ((t.initializeHandlers = function () {
          ...
          (t.callHandler = function (e, t) {
            return (e = r.handlers[e]) ? [true, e.apply(this, t)] : [false, undefined];
          }),
          (t.registerHandler = function (e, t, n, i) {
            (undefined === n && (n = true),
              ...
              t
                ? ((r.handlers[e] = t),
                  n && (0, a.sendMessageToParent)('registerHandler', o([e], i, true)))
                : delete r.handlers[e]);
          }),
          ...
          (t.registerOnLoadHandler = function (e) {
            (r.loadHandler = e) && (0, a.sendMessageToParent)('registerHandler', ['load']);
          }),
      ...
      function (e, t, n) {
        ...
        (Object.defineProperty(t, '__esModule', { value: true }),
          ...
          (t.validOriginRegExp = (0, n.generateRegExpFromUrls)(t.validOrigins)),
      ...
      function (e, t, n) {
        ...
        ((t.generateRegExpFromUrls = function (e) {
          for (var t = '', n = 0; n < e.length; n++) t += (0 === n ? '' : '|') + i(e[n]);
          return new RegExp(t);
        }),
          ...
          (t.compareSDKVersions = function (e, t) {
            ...
            for (var a = 0; a < n.length; ++a)
              if (Number(n[a]) != Number(o[a])) return Number(n[a]) > Number(o[a]) ? 1 : -1;
            return 0;
          }),
      ...
      function (e, t, n) {
        'use strict';
        (Object.defineProperty(t, '__esModule', { value: true }),
          (t.ErrorCode = t.FileOpenPreference = undefined),
          (function (e) {
      ...
      function (e, t, n) {
        'use strict';
        (Object.defineProperty(t, '__esModule', { value: true }), (t.GlobalVars = undefined));
        var o = (function () {
          function e() {}
          return (
      ...
      function (e, t) {
        for (var require = [], o = 0; o < 256; ++o) require[o] = (o + 256).toString(16).substr(1);
      ...
      function (e, t, n) {
        ...
        !(function (e) {
          ...
          function l() {
            c();
            try {
              r.Communication.childWindow && r.Communication.childWindow.close();
            } finally {
              ((r.Communication.childWindow = null), (r.Communication.childOrigin = null));
            }
          }
          function c() {
          ...
          function d() {
            (c(),
              (n = r.Communication.currentWindow.setInterval(function () {
                if (!r.Communication.childWindow || r.Communication.childWindow.closed)
                  p('CancelledByUser');
                else {
                  var e = r.Communication.childOrigin;
                  try {
                    ((r.Communication.childOrigin = '*'), (0, r.sendMessageEventToChild)('ping'));
                  } finally {
          ...
          function g(e, t, n) {
            var o;
            e &&
              (((o = document.createElement('a')).href = decodeURIComponent(e)),
              o.host &&
                ...
                (t &&
                  ...
                  r.Communication.currentWindow.location.assign(h(o.href, 'authSuccess', ''))),
                t &&
                  'reason' === t &&
                  (n && (o.href = h(o.href, 'reason', n)),
                  r.Communication.currentWindow.location.assign(h(o.href, 'authFailure', '')))));
          }
          function h(e, t, n) {
            var o = e.indexOf('#'),
              i = (i = -1 === o ? '#' : e.substr(o)) + '&' + t + ('' !== n ? '=' + n : '');
          ...
          ((e.initialize = function () {
            ...
            (e.authenticate = function (e) {
              ...
              ((0, o.ensureInitialized)(
                ...
                i.GlobalVars.hostClientType === a.HostClientType.teamsRoomsWindows ||
                i.GlobalVars.hostClientType === a.HostClientType.teamsRoomsAndroid ||
                i.GlobalVars.hostClientType === a.HostClientType.teamsPhones ||
                i.GlobalVars.hostClientType === a.HostClientType.teamsDisplays
                  ...
                  : (function (e) {
                      ...
                      var n = t.width || 600,
                        o = t.height || 400,
                        i =
                          ((n = Math.min(n, r.Communication.currentWindow.outerWidth - 400)),
                          (o = Math.min(o, r.Communication.currentWindow.outerHeight - 200)),
                          document.createElement('a'));
                      i.href = t.url.replace('{oauthRedirectMethod}', 'web');
                      var a =
                        undefined !== r.Communication.currentWindow.screenLeft
                          ? r.Communication.currentWindow.screenLeft
                          : r.Communication.currentWindow.screenX;
                      ((e =
                        undefined !== r.Communication.currentWindow.screenTop
                          ? r.Communication.currentWindow.screenTop
                          : r.Communication.currentWindow.screenY),
                        (a += r.Communication.currentWindow.outerWidth / 2 - n / 2),
                        (e += r.Communication.currentWindow.outerHeight / 2 - o / 2),
                        (r.Communication.childWindow = r.Communication.currentWindow.open(
                          i.href,
                          '_blank',
                        ...
                        r.Communication.childWindow ? d() : p('FailedToOpenWindow'));
                    })(n));
            }),
            ...
            (e.getUser = function (e) {
              ((0, o.ensureInitialized)(),
                (0, r.sendMessageToParent)('authentication.getUser', function (t, n) {
                  t ? e.successCallback(n) : e.failureCallback(n);
                }));
            }),
            (e.notifySuccess = function (e, t) {
              (g(t, 'result', e),
                ...
                (0, r.sendMessageToParent)('authentication.authenticate.success', [e]),
                (0, r.waitForMessageQueue)(r.Communication.parentWindow, function () {
            ...
            (e.notifyFailure = function (e, t) {
              (g(t, 'reason', e),
                (0, o.ensureInitialized)(a.FrameContexts.authentication),
                (0, r.sendMessageToParent)('authentication.authenticate.failure', [e]),
                (0, r.waitForMessageQueue)(r.Communication.parentWindow, function () {
                  return setTimeout(function () {
                    return r.Communication.currentWindow.close();
                  }, 200);
      ...
      function (e, t, n) {
        ...
        !(function (e) {
          ...
          ((e.initialize = function () {
            ((0, s.registerHandler)('settings.save', l, false),
              (0, s.registerHandler)('settings.remove', d, false));
          }),
            ...
            (e.registerOnSaveHandler = function (e) {
              ((0, o.ensureInitialized)(i.FrameContexts.settings),
                (t = e) && (0, r.sendMessageToParent)('registerHandler', ['save']));
            }),
            (e.registerOnRemoveHandler = function (e) {
              ((0, o.ensureInitialized)(i.FrameContexts.remove, i.FrameContexts.settings),
                (n = e) && (0, r.sendMessageToParent)('registerHandler', ['remove']));
            }));
          var c = (function () {
            function e(e) {
      ...
      function (e, t, n) {
        ...
        ((t.initializePrivateApis = function () {}),
          (t.getUserJoinedTeams = function (e, t) {
            if (
              ...
              (l.GlobalVars.hostClientType === i.HostClientType.android ||
                l.GlobalVars.hostClientType === i.HostClientType.teamsRoomsAndroid ||
                l.GlobalVars.hostClientType === i.HostClientType.teamsPhones ||
                l.GlobalVars.hostClientType === i.HostClientType.teamsDisplays) &&
                !(0, o.isAPISupportedByPlatform)(d.getUserJoinedTeamsSupportedAndroidClientVersion))
            ) {
          ...
          (t.openFilePreview = function (e) {
            ((0, o.ensureInitialized)(i.FrameContexts.content, i.FrameContexts.task),
              (e = [
                e.entityId,
                e.title,
                e.description,
          ...
          (t.getChatMembers = function (e) {
            ((0, o.ensureInitialized)(), (0, r.sendMessageToParent)('getChatMembers', e));
          }),
          ...
          (t.registerUserSettingsChangeHandler = function (e, t) {
            ((0, o.ensureInitialized)(),
              (0, s.registerHandler)('userSettingsChange', t, true, [e]));
          }));
      },
      function (e, t, n) {
        'use strict';
        ...
        !(function (e) {
          ...
          function l(e) {
            (r && r(e)) ||
              ((0, o.ensureInitialized)(), (0, i.sendMessageToParent)('viewConfigItemPress', [e]));
          }
          function c(e) {
            (t && t(e)) ||
              ((0, o.ensureInitialized)(),
        ...
        ((n = (function () {
          ...
          return (
            ...
            (e.prototype.addEventListener = function (e, t) {
              'message' === e && (0, s.registerHandler)('messageForParent', t);
            }),
            e
          );
        })()),
          ...
          (n = (function () {
            ...
            return (
              ...
              (e.prototype.addEventListener = function (e, t) {
                'message' === e && (0, s.registerHandler)('messageForChild', t);
              }),
              e
            );
          })()),
        ...
        !(function (e) {
          ...
          ((e.File = t),
            (e.captureImage = function (e) {
              ...
              ((0, s.ensureInitialized)(l.FrameContexts.content, l.FrameContexts.task),
                a.GlobalVars.isFramelessWindow
                  ? (0, s.isAPISupportedByPlatform)(g.captureImageMobileSupportVersion)
                    ? (0, u.sendMessageToParent)('captureImage', e)
                    : e({ errorCode: r.ErrorCode.OLD_PLATFORM }, undefined)
                  : e({ errorCode: r.ErrorCode.NOT_SUPPORTED_ON_PLATFORM }, undefined));
            }));
          var n,
            o,
            h = (function (e) {
              ...
              return (
                ...
                (t.prototype.getMedia = function (e) {
                  ...
                  ((0, s.ensureInitialized)(l.FrameContexts.content, l.FrameContexts.task),
                    (0, s.isAPISupportedByPlatform)(g.mediaAPISupportVersion)
                      ? (0, d.validateGetMediaInputs)(this.mimeType, this.format, this.content)
                        ? (0, s.isAPISupportedByPlatform)(g.getMediaCallbackSupportVersion)
                      ...
                      (n && n.error
                        ...
                        : n && n.mediaChunk
                          ? n.mediaChunk.chunkSequence <= 0
                            ? ((o = (0, d.createFile)(t.assembleAttachment, t.mediaMimeType)),
                              e(n.error, o))
                            : ((n = (0, d.decodeAttachment)(n.mediaChunk, t.mediaMimeType)),
                ...
                (t.prototype.getMediaViaHandler = function (e) {
                  var t = (0, c.generateGUID)(),
                    ...
                    o = [t, this.content];
                  (this.content && e && (0, u.sendMessageToParent)('getMedia', o),
                    (0, p.registerHandler)('getMedia' + t, function (o) {
                      var i;
                      e &&
                        ((i = JSON.parse(o)).error
                          ? (e(i.error, null), (0, p.removeHandler)('getMedia' + t))
                          : i.mediaChunk
                            ? i.mediaChunk.chunkSequence <= 0
                              ? ((o = (0, d.createFile)(n.assembleAttachment, n.mediaMimeType)),
                                e(i.error, o),
                                (0, p.removeHandler)('getMedia' + t))
                              : ((i = (0, d.decodeAttachment)(i.mediaChunk, n.mediaMimeType)),
          ...
          ((e.Media = h),
                  ...
                  (e.prototype.notifyEventToHost = function (e, t) {
                    ...
                    n
                      ...
                      : ((e = {
                        ...
                        (0, u.sendMessageToParent)('media.controller', [e], function (e) {
                          t && t(e);
                        }));
                  }),
                ...
                (0, s.isAPISupportedByPlatform)(g.mediaAPISupportVersion)
                  ? (n = (0, d.isMediaCallSupportedOnMobile)(e))
                    ...
                    : (0, d.validateSelectMediaInputs)(e)
                      ? (0, u.sendMessageToParent)('selectMedia', [e], function (n, o, i) {
                          if (i)
                            (0, d.isVideoControllerRegistered)(e) &&
                              e.videoProps.videoController.notifyEventToApp(i);
                          else if (o) {
                            for (var a = [], r = 0, s = o; r < s.length; r++) {
                              var l = s[r];
                              a.push(new h(l));
                            }
                            t(n, a);
                      ...
                      : ((o = { errorCode: r.ErrorCode.INVALID_ARGUMENTS }), t(o, null))
                  : ((o = { errorCode: r.ErrorCode.OLD_PLATFORM }), t(o, null)));
            }),
            ...
            (e.scanBarCode = function (e, t) {
              ...
              ((0, s.ensureInitialized)(l.FrameContexts.content, l.FrameContexts.task),
                ...
                a.GlobalVars.hostClientType !== l.HostClientType.teamsRoomsWindows &&
                a.GlobalVars.hostClientType !== l.HostClientType.teamsRoomsAndroid &&
                a.GlobalVars.hostClientType !== l.HostClientType.teamsPhones &&
                a.GlobalVars.hostClientType !== l.HostClientType.teamsDisplays
                  ? (0, s.isAPISupportedByPlatform)(g.scanBarCodeAPIMobileSupportVersion)
                    ? (0, d.validateScanBarCodeInput)(t)
                      ? (0, u.sendMessageToParent)('media.scanBarCode', [t], e)
                      : e({ errorCode: r.ErrorCode.INVALID_ARGUMENTS }, null)
                    : e({ errorCode: r.ErrorCode.OLD_PLATFORM }, null)
                  : e({ errorCode: r.ErrorCode.NOT_SUPPORTED_ON_PLATFORM }, null));
            }));
        })(t.media || (t.media = {}));
      },
      function (e, t, n) {
        ...
        function r(e) {
          var t;
          return !(
            (null == e ? undefined : e.mediaType) != o.media.MediaType.Image ||
            null === (t = null == e ? undefined : e.imageProps) ||
            undefined === t ||
            !t.imageOutputFormats
          );
        }
        function s(e) {
          return !(!e || (e.mediaType != o.media.MediaType.VideoAndImage && !e.videoAndImageProps));
        }
        function l(e) {
          return !(
            !e ||
        ...
        ((t.createFile = function (e, t) {
          ...
          return (
            ...
            e.forEach(function (e) {
              e.sequence == o &&
                ((n = n ? new Blob([n, e.file], { type: t }) : new Blob([e.file], { type: t })),
                o++);
            }),
            n
          );
          ...
          (t.decodeAttachment = function (e, t) {
            ...
            for (var n = atob(e.chunk), o = new Array(n.length), i = 0; i < n.length; i++)
              o[i] = n.charCodeAt(i);
            var a = new Uint8Array(o);
            return ((t = new Blob([a], { type: t })), { sequence: e.chunkSequence, file: t });
          }),
          (t.isMediaCallSupportedOnMobile = function (e) {
            return s(e)
              ? (0, a.isApiSupportedOnMobile)(i.videoAndImageMediaAPISupportVersion)
              : l(e)
                ? (0, a.isApiSupportedOnMobile)(i.nonFullScreenVideoModeAPISupportVersion)
                : r(e)
                  ? (0, a.isApiSupportedOnMobile)(i.imageOutputFormatsAPISupportVersion)
                  : null;
          }),
          ...
          (t.validateGetMediaInputs = function (e, t, n) {
            return null != e && null != t && t == o.media.FileFormat.ID && null != n;
          }),
        ...
        !(function (e) {
          ((e.sendQuery = function (e, t, n) {
            ((0, i.ensureInitialized)(),
              (0, o.sendMessageToParent)('bot.executeQuery', [e], function (e, o) {
                (e ? t : n)(o);
              }));
          }),
            (e.getSupportedCommands = function (e, t) {
              ((0, i.ensureInitialized)(),
                (0, o.sendMessageToParent)('bot.getSupportedCommands', function (n, o) {
                  (n ? e : t)(o);
                }));
            }),
            (e.authenticate = function (e, t, n) {
              ((0, i.ensureInitialized)(),
                (0, o.sendMessageToParent)('bot.authenticate', [e], function (e, o) {
                  (e ? t : n)(o);
                }));
            }),
            (function (e) {
      ...
      function (e, t, n) {
        ...
        e.exports = function (e, t, n) {
          var c = (t && n) || 0,
            d = t || [],
            u = (e = e || {}).node || o,
            p = undefined !== e.clockseq ? e.clockseq : i;
          (null != u && null != p) ||
            ((h = a()),
            null == u && (u = o = [1 | h[0], h[1], h[2], h[3], h[4], h[5]]),
            null == p && (p = i = 16383 & ((h[6] << 8) | h[7])));
          var g = undefined !== e.msecs ? e.msecs : new Date().getTime(),
            h = ((n = undefined !== e.nsecs ? e.nsecs : l + 1), g - s + (n - l) / 1e4);
          if (
            (h < 0 && undefined === e.clockseq && (p = (p + 1) & 16383),
            1e4 <= (n = (h < 0 || s < g) && undefined === e.nsecs ? 0 : n))
          )
            throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          ((s = g),
            (i = p),
            (n = (1e4 * (268435455 & (g += 122192928e5)) + (l = n)) % 4294967296),
            (d[c++] = (n >>> 24) & 255),
            (d[c++] = (n >>> 16) & 255),
            (d[c++] = (n >>> 8) & 255),
            (d[c++] = 255 & n),
        ...
        !(function (e) {
          ((e.Messages = {
            ...
            (e.notifyFailure = function (t) {
              ((0, o.ensureInitialized)(),
                (0, a.sendMessageToParent)(e.Messages.Failure, [t.reason, t.message]));
            }),
            (e.notifyExpectedFailure = function (t) {
              ((0, o.ensureInitialized)(),
                (0, a.sendMessageToParent)(e.Messages.ExpectedFailure, [t.reason, t.message]));
            }));
      ...
      function (e, t, n) {
        ...
        function f(e, t) {
          (i.GlobalVars.initializeCalled ||
            ...
            (0, d.initializeCommunication)(function (e, t, n) {
              (undefined === n && (n = a.defaultSDKVersionForCompatCheck),
            ...
            e &&
              (i.GlobalVars.initializeCompleted ? e() : i.GlobalVars.initializeCallbacks.push(e)));
        }
        function m() {
          window.print();
        }
        ...
        function v(e) {
          ((0, o.ensureInitialized)(), h.registerHandler('fullScreenChange', e));
        }
        function _(e) {
        ...
        ((t.initialize = f),
          ...
          (t.getContext = function (e) {
            ((0, o.ensureInitialized)(),
              (0, d.sendMessageToParent)('getContext', function (t) {
                (t.frameContext || (t.frameContext = i.GlobalVars.frameContext), e(t));
              }));
          }),
          ...
          (t.getTabInstances = function (e, t) {
            ((0, o.ensureInitialized)(), (0, d.sendMessageToParent)('getTabInstances', [t], e));
          }),
          (t.getMruTabInstances = function (e, t) {
            ((0, o.ensureInitialized)(), (0, d.sendMessageToParent)('getMruTabInstances', [t], e));
          }),
      ...
      function (e, t, n) {
        ...
        ((t.returnFocus = function (e) {
          ((0, o.ensureInitialized)(), (0, r.sendMessageToParent)('returnFocus', [e]));
        }),
      ...
      function (e, t, n) {
        ...
        (Object.defineProperty(t, '__esModule', { value: true }), (t.tasks = undefined));
        var i = n(2) /* GNode */,
          ...
          ((e.startTask = function (e, t) {
            ...
            (e.submitTask = function (e, t) {
              ((0, s.ensureInitialized)(
                ...
                (0, r.sendMessageToParent)('tasks.completeTask', [e, Array.isArray(t) ? t : [t]]));
            }));
        })(t.tasks || (t.tasks = {}));
      },
      function (e, t, n) {
        ...
        !(function (e) {
          ((e.getLocation = function (e, t) {
            ...
            ((0, i.ensureInitialized)(a.FrameContexts.content, a.FrameContexts.task),
              (0, i.isAPISupportedByPlatform)(s.locationAPIsRequiredVersion)
                ? e
                  ? (0, r.sendMessageToParent)('location.getLocation', [e], t)
                  : t({ errorCode: o.ErrorCode.INVALID_ARGUMENTS }, undefined)
                : t({ errorCode: o.ErrorCode.OLD_PLATFORM }, undefined));
          }),
            (e.showLocation = function (e, t) {
              ...
              ((0, i.ensureInitialized)(a.FrameContexts.content, a.FrameContexts.task),
                (0, i.isAPISupportedByPlatform)(s.locationAPIsRequiredVersion)
                  ? e
                    ? (0, r.sendMessageToParent)('location.showLocation', [e], t)
                    : t({ errorCode: o.ErrorCode.INVALID_ARGUMENTS }, undefined)
                  : t({ errorCode: o.ErrorCode.OLD_PLATFORM }, undefined));
            }));
        ...
        !(function (e) {
          (!(function (e) {
            ...
            (e.getIncomingClientAudioState = function (e) {
              ...
              ((0, a.ensureInitialized)(r.FrameContexts.sidePanel, r.FrameContexts.meetingStage),
            ...
            (e.getAuthenticationTokenForAnonymousUser = function (e) {
              ...
              ((0, a.ensureInitialized)(r.FrameContexts.sidePanel, r.FrameContexts.meetingStage),
                (0, o.sendMessageToParent)('meeting.getAuthenticationTokenForAnonymousUser', e));
            }),
            ...
            (e.requestStartLiveStreaming = function (e, t, n) {
              ...
              ((0, a.ensureInitialized)(r.FrameContexts.sidePanel),
                (0, o.sendMessageToParent)('meeting.requestStartLiveStreaming', [t, n], e));
            }),
            (e.requestStopLiveStreaming = function (e) {
              if (!e) throw new Error('[request stop live streaming] Callback cannot be null');
              ((0, a.ensureInitialized)(r.FrameContexts.sidePanel),
                (0, o.sendMessageToParent)('meeting.requestStopLiveStreaming', e));
            }),
            ...
            (e.shareAppContentToStage = function (e, t) {
              ...
              ((0, a.ensureInitialized)(r.FrameContexts.sidePanel, r.FrameContexts.meetingStage),
                (0, o.sendMessageToParent)('meeting.shareAppContentToStage', [t], e));
            }),
            (e.getAppContentStageSharingCapabilities = function (e) {
              ...
              ((0, a.ensureInitialized)(r.FrameContexts.sidePanel, r.FrameContexts.meetingStage),
                (0, o.sendMessageToParent)('meeting.getAppContentStageSharingCapabilities', e));
            }),
            (e.stopSharingAppContentToStage = function (e) {
              if (!e)
                throw new Error('[stop sharing app content to stage] Callback cannot be null');
              ((0, a.ensureInitialized)(r.FrameContexts.sidePanel, r.FrameContexts.meetingStage),
                (0, o.sendMessageToParent)('meeting.stopSharingAppContentToStage', e));
            }),
            (e.getAppContentStageSharingState = function (e) {
              if (!e)
                throw new Error('[get app content stage sharing state] Callback cannot be null');
              ((0, a.ensureInitialized)(r.FrameContexts.sidePanel, r.FrameContexts.meetingStage),
                (0, o.sendMessageToParent)('meeting.getAppContentStageSharingState', e));
            }),
      ...
      function (e, t, n) {
        ...
        (t.monetization || (t.monetization = {})).openPurchaseExperience = function (e, t) {
          ...
          ((0, i.ensureInitialized)(a.FrameContexts.content),
            (0, o.sendMessageToParent)('monetization.openPurchaseExperience', [t], e));
        };
      },
      function (e, t, n) {
        'use strict';
        ...
        (t.people || (t.people = {})).selectPeople = function (e, t) {
          ...
          ((0, o.ensureInitialized)(
            ...
            (0, o.isAPISupportedByPlatform)(l.peoplePickerRequiredVersion)
              ...
              : e({ errorCode: a.ErrorCode.OLD_PLATFORM }, undefined));
        };
      },
      function (e, t, n) {
        'use strict';
          ...
          (!(function (e) {
            ...
            (e.registerForVideoFrame = function (e, s) {
              ((0, i.ensureInitialized)(a.FrameContexts.sidePanel),
                ...
                (0, o.sendMessageToParent)('video.registerForVideoFrame', [s]));
            }),
            (e.notifySelectedVideoEffectChanged = function (e, t) {
              ((0, i.ensureInitialized)(a.FrameContexts.sidePanel),
                (0, o.sendMessageToParent)('video.videoEffectChanged', [e, t]));
            }),
          ...
          ((e.SharingAPIMessages = {
            ...
            (e.shareWebContent = function (t, n) {
              (function (e, t) {
                ...
                (0, i.sendMessageToParent)(e.SharingAPIMessages.shareWebContent, [t], n));
            }));
        })(t.sharing || (t.sharing = {}));
      },
      function (e, t, n) {
      ...
      function (e, t, n) {
        'use strict';
        (Object.defineProperty(t, '__esModule', { value: true }),
          (t.UserSettingTypes = t.ViewerActionTypes = t.NotificationTypes = undefined),
          (function (e) {
          ...
          ((e.openConversation = function (e) {
            ((0, o.ensureInitialized)(i.FrameContexts.content),
              ...
              e.onStartConversation &&
                (0, r.registerHandler)('startConversation', function (t, n, o, i) {
              ...
              e.onCloseConversation &&
                (0, r.registerHandler)('closeConversation', function (t, n, o, i) {
        ...
        !(function (e) {
          (!(function (e) {
            ...
            (e.getPairedMeetingRoomInfo = function (e) {
              ((0, o.ensureInitialized)(),
                (0, i.sendMessageToParent)('meetingRoom.getPairedMeetingRoomInfo', e));
            }),
            (e.sendCommandToPairedMeetingRoom = function (e, t) {
              ...
              ((0, o.ensureInitialized)(),
                (0, i.sendMessageToParent)('meetingRoom.sendCommandToPairedMeetingRoom', [e], t));
            }),
            (e.registerMeetingRoomCapabilitiesUpdateHandler = function (e) {
              ...
              ((0, o.ensureInitialized)(),
                (0, a.registerHandler)('meetingRoom.meetingRoomCapabilitiesUpdate', function (t) {
            ...
            (e.registerMeetingRoomStatesUpdateHandler = function (e) {
              ...
              ((0, o.ensureInitialized)(),
                (0, a.registerHandler)('meetingRoom.meetingRoomStatesUpdate', function (t) {
                  ((0, o.ensureInitialized)(), e(t));
                }));
            }));
          ...
          (!(function (e) {
            ...
            (e.getCapableParticipants = function (e) {
              ...
              ((0, o.ensureInitialized)(i.FrameContexts.sidePanel),
                (0, a.sendMessageToParent)('remoteCamera.getCapableParticipants', e));
            }),
            (e.requestControl = function (e, t) {
              ...
              ((0, o.ensureInitialized)(i.FrameContexts.sidePanel),
                (0, a.sendMessageToParent)('remoteCamera.requestControl', [e], t));
            }),
            (e.sendControlCommand = function (e, t) {
              ...
              ((0, o.ensureInitialized)(i.FrameContexts.sidePanel),
                (0, a.sendMessageToParent)('remoteCamera.sendControlCommand', [e], t));
            }),
            (e.terminateSession = function (e) {
              if (!e) throw new Error('[remoteCamera.terminateSession] Callback cannot be null');
              ((0, o.ensureInitialized)(i.FrameContexts.sidePanel),
                (0, a.sendMessageToParent)('remoteCamera.terminateSession', e));
            }),
            (e.registerOnCapableParticipantsChangeHandler = function (e) {
              ...
              ((0, o.ensureInitialized)(i.FrameContexts.sidePanel),
                (0, r.registerHandler)('remoteCamera.capableParticipantsChange', e));
            }),
      ...
      function (e, t, n) {
        ...
        !(function (e) {
          (!(function (e) {
            ...
            ((e.SpecialDocumentLibraryType || (e.SpecialDocumentLibraryType = {})).ClassMaterials =
              'classMaterials'),
            ((e.DocumentLibraryAccessType || (e.DocumentLibraryAccessType = {})).Readonly =
              'readonly'),
            (function (e) {
            ...
            (e.getCloudStorageFolders = function (e, t) {
              ...
              (0, o.sendMessageToParent)('files.getCloudStorageFolders', [e], t);
            }),
            (e.addCloudStorageFolder = function (e, t) {
              ...
              (0, o.sendMessageToParent)('files.addCloudStorageFolder', [e], t);
            }),
            (e.deleteCloudStorageFolder = function (e, t, n) {
              ...
              (0, o.sendMessageToParent)('files.deleteCloudStorageFolder', [e, t], n);
            }),
            (e.getCloudStorageFolderContents = function (e, t, n) {
              if (((0, i.ensureInitialized)(a.FrameContexts.content), !e || !t))
                throw new Error(
              ...
              (0, o.sendMessageToParent)('files.getCloudStorageFolderContents', [e, t], n);
            }),
            ...
            (e.copyMoveFiles = function (e, t, n, r, s, l) {
              ...
              if (!l) throw new Error('[files.copyMoveFiles] callback cannot be null');
              (0, o.sendMessageToParent)('files.copyMoveFiles', [e, t, n, r, s], l);
            }),
      ...
      function (e, t, n) {
        ...
        (t.appEntity || (t.appEntity = {})).selectAppEntity = function (e, t, n, r) {
          ...
          (0, o.sendMessageToParent)('appEntity.selectAppEntity', [e, t, n], r);
        };
      },
      function (e, t, n) {
        'use strict';
