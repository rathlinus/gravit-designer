...
function (exports, module, require) {
  ...
  class a {
    constructor(e) {
      ((this._htmlElement = e),
      (this._collapseIcon = $('<span class="collapse-icon"><span></span><span></span></span>')));
    }
    ...
    init() {
      this._panels = [];
      var e = $('<div></div>').addClass('panels-tabs').appendTo(this._htmlElement),
        t = $('<div></div>').addClass('panels-frame').appendTo(this._htmlElement),
        n = function (n) {
          var a = $('<button></button>')
              .addClass('panel-tab')
              ...
              .on(
                ...
                function (e) {
                  (gDesigner.stats('panels_set_active'),
                    this.setActivePanel($(e.target).closest('button').attr('data-panel-id')));
                }.bind(this)
              )
    ...
    static CollapseMode = { None: 'none', Half: 'half', Full: 'full' };
