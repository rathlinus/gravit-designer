  ...
  class l extends GProperties {
      ...
      var n = this,
        GProperties = function (e) {
          ...
          if (
            ...
            var t = '';
            return (
              ('tl_sy' !== e && 'tr_sy' !== e && 'bl_sy' !== e && 'br_sy' !== e) ||
                (t = 'sy-input'),
              $('<input>')
        ...
        s = GCore.GLocale.get(
          new GCore.GLocaleKey('GRectangleProperties', 'text.uniform-corner-smoothness')
        ),
        l = GCore.GLocale.get(
          new GCore.GLocaleKey('GRectangleProperties', 'text.horizontal-corner-smoothness')
        ),
        c = GCore.GLocale.get(
          new GCore.GLocaleKey('GRectangleProperties', 'text.vertical-corner-smoothness')
        ),
        d = GCore.GLocale.get(new GCore.GLocaleKey('GRectangleProperties', 'text.corner-type'));
      ((this._advancedPanel = $('<div></div>')
        ...
        .append(
          $('<label></label>')
            ...
            .append(
              $('<span></span>').text(
                GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.autoscale-corners'))
              )
            )
        )
        .append(
          $('<label></label>')
            ...
            .append(
              $('<span></span>').text(
                GCore.GLocale.get(
                  new GCore.GLocaleKey('GRectangleProperties', 'text.uniform-corners')
                )
              )
            )
        )
    ...
    _assignProperties(e, t) {
      ...
      try {
        ...
        n.commitTransaction(
          GCore.GLocale.get(
            new GCore.GLocaleKey('GRectangleProperties', 'action.modify-rectangle-properties')
          )
        );
      }
    }
