  ...
  function i(e) {
    ...
    return (
      ((i = function (e) {
        ...
        throw: function (e) {
          var n = this.s.return;
          return undefined === n ? Promise.reject(e) : module(n.apply(this.s, arguments));
        },
      }),
      new i(e)
    );
  ...
  exports.exports = {
          ...
          if (i && i.length)
            for (var a = 0; a < i.length; a++) {
              for (
                var r = i[a], s = 2;
                module.find(
                  (e) => e.family === r.family && e.weight === r.weight && e.style === r.style
                );
              )
    ...
    getFontFamily: function (e, t) {
      ...
      if (
        ...
        let e = require.split(' ');
        for (; e.length > 0 && (e.pop(), (require = e.join(' ')), (GCore = t(require)), !GCore); );
      }
      return GCore;
    },
  };
