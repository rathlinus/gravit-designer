...
function (exports, module, require) {
  ...
  class p extends GSubAction.default {
    constructor(e) {
      (super(e),
        (this._title = new GCore.GLocaleKey('GMergeSubAction', 'title.'.concat(this._type))),
            ...
            if (!e.getPaintLayers().getFillLayers(true).length && e.getProperty('_fc')) {
              ...
              const t =
                'string' == typeof e.getProperty('_fc')
                  ...
                  : e.getProperty('_fc');
              require.getPaintLayers().appendChild(new GCore.GStylable.FillPaintLayer(t));
            }
          }
          GEditor.forEach((e) => {
            let t,
            ...
            for (
              !(
                ...
                (_interopRequireDefault instanceof GCore.GCompoundShape &&
                  this._type === p.Type.Union)
              ) && e.setProperty('bool', this._getBooleanOperationType()),
                _interopRequireDefault.removeChild(e);
              (_interopRequireDefault instanceof GCore.GGroup ||
                _interopRequireDefault instanceof GCore.GCompoundShape) &&
              !_interopRequireDefault.getFirstChild();
            )
              ((t = _interopRequireDefault),
                (_interopRequireDefault = _interopRequireDefault.getParent()),
