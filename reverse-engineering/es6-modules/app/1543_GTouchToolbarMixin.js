  ...
  exports.exports = function (e) {
    ((e.prototype._windowButton = null),
      ...
      (e.prototype._updateTouchUI = function () {
        (this._touchSection ||
          (this._touchSection = this._createTouchSection().prependTo(this._htmlElement)),
          this._windowButton ||
      ...
      (e.prototype._updateTouchPageButton = function () {
        this._pageButton &&
          (this._pageButton.gPageButton('reinit'), this._pageButton.addClass('dropdown'));
      }),
            ...
            getActiveItem: () => {
              var e = gDesigner.getWindows().getActiveWindow(),
                ...
                GFitSelectionAction =
                  GFitAllAction &&
                  gDesigner.getAction(
                    ''.concat(GMagnificationAction.ID, '.').concat(GFitAllAction)
                  ),
      ...
      (e.prototype._createWindowButton = function () {
        ...
        return this._createLabelButton({
          ...
          menu: () => {
            ...
            return module
              .getWindows()
              .reduce((e, n) => (this._createAndAppendWindowTabToMenu(module, e, n), e), e);
          },
      ...
      (e.prototype._updateActiveWindow = function () {
        if (gDesigner.isTouchEnabled() && this._windowButton)
          if (gDesigner.getApplicationManager().isDocumentTabManagementEnabled()) {
            const GFitAllAction =
              gDesigner.getWindows() && gDesigner.getWindows().getActiveWindow();
            if (GFitAllAction) {
              ...
              const GSaveAction = this._windowButton
                ...
                .toggleClass(
                  'syncing',
                  GFitSelectionAction && GFitSelectionAction.isSynchronizing()
                )
      ...
      (e.prototype._getWindowTitle = function (e) {
        ...
        return (
          e && ''.concat(e.getTitleWithExtension()).concat(module && module.isModified() ? '*' : '')
        );
      }));
  };
}
