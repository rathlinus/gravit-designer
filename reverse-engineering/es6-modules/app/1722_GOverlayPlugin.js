      ...
      if (i.length > 0)
        for (var require = i.length - 1; require >= 0; --require) {
          ...
          (a.parent().length > 0 &&
            ...
            (s = true),
            ($(r).index() < a.index() || s) && ((t = true), GEditor.gOverlay('close', e, require)));
        }
      return t;
    };
  ...
  var r = function (e) {
    ...
    s = {
      ...
      relayout: function () {
        ...
        (n.options.side
          ? (t.addClass(n.options.sideClazz),
            (u = v + n.options.offsetX) + l > r &&
              ((u = m - l - n.options.offsetX), t.addClass('g-overlay-left-side')),
            (p = g + n.options.offsetY) + c > s &&
              ((p = b - c - n.options.offsetY), t.addClass('g-overlay-valign-bottom')))
          : ((u =
        ...
        (w || i.css('top', p + 'px'),
          null === n.options.customRight ? i.css('left', u + 'px') : i.css('right', u + 'px'));
      },
      open: function (e, t, n) {
        var a = $(this);
        ...
        return (
          d && d.modal
            ? $('<div></div>').addClass('g-overlay-modal').append(p).appendTo(u)
            : p.appendTo(u),
      ...
      close: function (e, t) {
        ...
        if (i.length && i[t >= 0 ? t : i.length - 1] === this[0]) {
          ...
          var l;
          (GEditor.GPlatform.removeEventListener(GEditor.GModifiersChangedEvent, r, this[0]),
            a &&
              (a.target &&
