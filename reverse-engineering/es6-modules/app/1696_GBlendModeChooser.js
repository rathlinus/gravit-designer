  ...
  var i = {
    init: function (e) {
      ...
      const module = [
        ...
        {
          group: GCore.GLocale.getValue('GAppearanceProperties', 'text.darken-image'),
          options: [
            {
        ...
        {
          group: GCore.GLocale.getValue('GAppearanceProperties', 'text.lighten-image'),
          options: [
            {
        ...
        {
          group: GCore.GLocale.getValue('GAppearanceProperties', 'text.boost-contrast'),
          options: [
            {
        ...
        {
          group: GCore.GLocale.getValue('GAppearanceProperties', 'text.adjust-colors'),
          options: [
            {
        ...
        {
          group: GCore.GLocale.getValue('GAppearanceProperties', 'text.invert-colors'),
          options: [
            {
      ...
      return this.each(function () {
        ...
        for (let require = 0; require < module.length; ++require) {
          ...
          (i && ((GCore = $('<optgroup label="' + i + '"></optgroup>')), e.append(GCore)),
            a.forEach((e) => {
