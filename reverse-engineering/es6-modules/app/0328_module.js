    ...
    x = !tryCall(function () {
      ...
      if (!(g && g > 3)) {
        ...
        for (exports = 65; exports < 76; exports++) {
          ...
          for (core_export = 0; core_export < 47; core_export++)
            y.push({ k: module + core_export, v: require });
        }
        for (
          y.sort(function (e, t) {
            return t.v - e.v;
          ...
          ((module = y[core_export].k.charAt(0)),
            uncurryThis.charAt(uncurryThis.length - 1) !== module && (uncurryThis += module));
    ...
    { target: 'Array', proto: true, forced: b || !w || !C || !x },
    {
      sort: function (e) {
        ...
        var n,
          ...
          uncurryThis = [],
          tryCall = s(t);
        for (core_export = 0; core_export < tryCall; core_export++)
          core_export in t && _(uncurryThis, t[core_export]);
        for (
          u(
            uncurryThis,
            (function (e) {
