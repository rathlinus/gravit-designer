    ...
    var n = (function () {
      ...
      return (
        ...
        (e.prototype._touchmove = function (t) {
          if (this._shouldCancelPressHoldMove(t)) this._reset();
          else if (this._shouldHandleMove(t) || this._shouldHandlePressHoldMove(t)) {
            ...
            if (
              (!this._img &&
                ...
                e._ISPRESSHOLDMODE &&
                  (this._dispatchEvent(this._dragInitEvent || t, 'draginit', this._dragSource),
                  this._dragSource.classList.add('g-draggable'),
                  this._dragSource.parentElement &&
                    this._dragSource.parentElement.classList.add('g-draggable-parent'))),
              !this._img && this._dragSource && this._shouldStartDragging(t))
            )
              (t.cancelable && t.preventDefault(),
                this._dragSource.classList.remove('g-draggable'),
                this._dragSource.parentElement &&
                  this._dragSource.parentElement.classList.remove('g-draggable-parent'),
                this._dispatchEvent(t, 'dragstart', this._dragSource) ||
                  (this._createImage(t), this._dispatchEvent(t, 'dragenter', n)));
            if (this._img) {
        ...
        (e.prototype._shouldCancelPressHoldMove = function (t) {
          return (
            e._ISPRESSHOLDMODE && !this._isDragEnabled && this._getDelta(t) > e._PRESSHOLDMARGIN
          );
        }),
        (e.prototype._shouldStartDragging = function (t) {
          ...
          return (
            (n > e.DRAG_MOVE_THRESHOLD &&
              n <= e.DRAG_MOVE_LIMIT &&
              new Date().getTime() - this._startTouchTime >= e.DRAG_MOVE_DELAY) ||
        ...
        (e.prototype._reset = function () {
          (this._destroyImage(),
            this._dragSource &&
              ...
              this._dragSource.parentElement &&
                this._dragSource.parentElement.classList.remove('g-draggable-parent'),
              this._dragSource.removeEventListener('touchmove', this._touchmove),
              this._dragSource.removeEventListener('touchend', this._touchend),
              this._dragSource.removeEventListener('touchcancel', this._touchend)),
        ...
        (e.prototype._translate = function (e, t, n) {
          e.style.transform = 'translate3d('.concat(t, 'px, ').concat(n, 'px, 0px)');
        }),
        (e.prototype._createImage = function (t) {
          ...
          ((_interopRequireDefault.position = 'absolute'),
            ...
            this._imgCustom || (this._img.style.opacity = e._OPACITY.toString()),
            this._moveImage(t),
            document.body.appendChild(this._img));
        }),
        (e.prototype._updateImageOffset = function (e) {
          var t = (this._imgCustom || this._dragSource).getBoundingClientRect(),
            n = this._getPoint(e);
        ...
        (e.prototype._moveImage = function (e) {
          if (this._img) {
            ...
            this._translate(this._img, t.x - this._imgOffset.x, t.y - this._imgOffset.y);
          }
        }),
        (e.prototype._copyProps = function (e, t, n) {
          for (
            var _interopRequireDefault = 0;
            _interopRequireDefault < n.length;
            _interopRequireDefault++
          ) {
        ...
        (e.prototype._copyStyle = function (t, n) {
          ...
          for (
            var AppSettings = getComputedStyle(t), CollaborationMergeUtils = 0;
            CollaborationMergeUtils < AppSettings.length;
          ...
          for (
            ...
            CollaborationMergeUtils < t.children.length;
            CollaborationMergeUtils++
          )
            this._copyStyle(
              t.children[CollaborationMergeUtils],
              n.children[CollaborationMergeUtils]
            );
        }),
