  ...
  exports.exports = class {
    ...
    async checkForUpdates(e) {
      if (gDesigner.isOffline())
        return console.warn(this.toString() + ' Unable to check for updates - system is offline!');
      try {
    ...
    async start() {
      [GContainer.Runtime.Electron, GContainer.Runtime.Browser, GContainer.Runtime.PWA].includes(
        ...
        ? (this._isElectron() &&
            ((GElectronUpdateServiceClient = require(1677)) /* GElectronUpdateServiceClient */
              .on(l.UpdateDownloaded, this._handleDownloadComplete.bind(this)),
          ...
          (this._intervalPID = setTimeout(
            function () {
              ...
              (gContainer.setProperty('last_update_check', exports), this.checkForUpdates(true));
            }.bind(this),
          ...
          gContainer.getProperty('last_update_check').then((e) => {
            ...
            if (e) {
              ...
              (n < 0 || n >= GCore) &&
                (gContainer.setProperty('last_update_check', module), this.checkForUpdates(true));
