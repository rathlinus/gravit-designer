        ...
        this.each(function () {
          ...
          if (
            ...
            if (e.hasOwnProperty('icon'))
              ...
              'string' == typeof e.label ? o.text(e.label) : o.append(e.label);
            }
            e.click &&
              require
                .addClass('clickable')
          ...
          if (
            (e.columns.forEach(function (t) {
              var n = '<div></div>';
              t.content && $(t.content).is(':input') && (n = '<label></label>');
              var o = $(n).addClass('column');
              if (
                (t.hasOwnProperty('clazz') && o.addClass(t.clazz),
                'auto' === t.width ? o.addClass('auto-grow') : t.width && o.css('width', t.width),
                t.prefix)
              ) {
                var r = '',
                  s = null;
                ('string' == typeof t.prefix
                  ...
                  $('<div></div>').addClass('prefix').css('width', s).html(r).appendTo(o));
              }
              (t.content
                ? $('<div></div>').addClass('content').append(t.content).appendTo(o)
                : t.html
                  ? $(t.html).appendTo(o)
                  : o.html('&nbsp;'),
                (!t.content || (t.hasOwnProperty('padding') && false === t.padding)) &&
                ...
                e.hasOwnProperty('rawClick') && e.rawClick && o.on('click', e.rawClick),
            ...
            e.columns.forEach(function (e) {
              ...
              (e.label
                ...
                (!e.content || (e.hasOwnProperty('padding') && false === e.padding)) &&
