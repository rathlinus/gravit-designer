                ...
                if (
                  ...
                  (a = this._intersectsWithPointer(o)) &&
                    ...
                    !(
                      ...
                      this.placeholder[1 === a ? 'next' : 'prev']()[0] === i ||
                      e.contains(this.placeholder[0], i) ||
                      ('semi-dynamic' === this.options.type && e.contains(this.element[0], i))
                    ))
                ) {
                  if (
            ...
            cancel: function () {
              if (this.dragging) {
                ...
                for (var module = this.containers.length - 1; module >= 0; module--)
                  (this.containers[module]._trigger('deactivate', null, this._uiHash(this)),
                    this.containers[module].containerCache.over &&
                      (this.containers[module]._trigger('out', null, this._uiHash(this)),
            ...
            _getItemsAsjQuery: function (t) {
              ...
              if (l && t)
                for (n = l.length - 1; n >= 0; n--)
                  for (o = (i = e(l[n], this.document[0])).length - 1; o >= 0; o--)
            ...
            _refreshItems: function (t) {
              ...
              if (p && this.ready)
                for (n = p.length - 1; n >= 0; n--)
                  for (o = (i = e(p[n], this.document[0])).length - 1; o >= 0; o--)
                    (a = e.data(i[o], this.widgetFullName)) &&
                      a !== this &&
                      !a.options.disabled &&
                      (u.push([
              ...
              for (
                ...
                ((o = this.items[n]).instance !== this.currentContainer &&
                  ...
                  ((i = this.options.toleranceElement
                    ...
                    : o.item),
                  t || ((o.width = i.outerWidth()), (o.height = i.outerHeight())),
                  (a = i.offset()),
                  (o.left = a.left),
                  (o.top = a.top));
              ...
              ((o.placeholder && o.placeholder.constructor !== String) ||
                ...
                (o.placeholder = {
                  element: function () {
                    ...
                    return (
                      t
                        ._addClass(i, 'ui-sortable-placeholder', n || t.currentItem[0].className)
                      ...
                      'tbody' === o
                        ...
                        : 'tr' === o
                          ...
                          : 'img' === o && i.attr('src', t.currentItem.attr('src')),
              ...
              if (p)
                if (1 === this.containers.length)
                  ...
                  for (
                    i = 1e4,
                      a = null,
                      r = (d = p.floating || this._isFloating(this.currentItem)) ? 'left' : 'top',
                      s = d ? 'width' : 'height',
                      u = d ? 'pageX' : 'pageY',
                  ...
                  (a
                    ? this._rearrange(t, a, null, true)
                    : this._rearrange(t, null, this.containers[g].element, true),
            ...
            _createHelper: function (t) {
              ...
              return (
                o.parents('body').length ||
                  e(
                    'parent' !== n.appendTo ? n.appendTo : this.currentItem[0].parentNode
                  )[0].appendChild(o[0]),
                ...
                /^(document|window|parent)$/.test(i.containment) ||
                  ...
                  (this.containment = [
                    ...
                    n.top +
                      ...
                      this.margins.top,
                    n.left +
                      (o ? Math.max(t.scrollWidth, t.offsetWidth) : t.offsetWidth) -
                      (parseInt(e(t).css('borderLeftWidth'), 10) || 0) -
                      (parseInt(e(t).css('paddingRight'), 10) || 0) -
                      this.helperProportions.width -
                      this.margins.left,
                    n.top +
                      (o ? Math.max(t.scrollHeight, t.offsetHeight) : t.offsetHeight) -
                      (parseInt(e(t).css('borderTopWidth'), 10) || 0) -
              ...
              return (
                ...
                this.originalPosition &&
                  ...
                  i.grid &&
                    ((n =
                      this.originalPageY +
                      Math.round((r - this.originalPageY) / i.grid[1]) * i.grid[1]),
                    (r = this.containment
                    ...
                    (o =
                      this.originalPageX +
                      Math.round((a - this.originalPageX) / i.grid[0]) * i.grid[0]),
                    (a = this.containment
