...
function (exports, module, require) {
  ...
  exports.exports = new (class {
    constructor() {
      ((this._settings = Object.assign({}, AppSettings.defaultUserSettings.defaultUserSettings)),
          ...
          (gDesigner.pageTracking('/Upgrade'),
            gDesigner
              ...
              .then(async (e) => {
                gDesigner
                  .getAmplitudeHelper()
                  .logEvent(AppSettings.AmplitudeData.Events.ACCOUNT_TRIAL_EXPIRED_SCREEN, {
                    ...
                    ACCOUNT_EVER_SUBSCRIBED: await AppSettings.gApi.license.everSubscribed(),
                  });
              })
              .catch(() => null));
          break;
