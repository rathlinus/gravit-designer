      ...
      ((this.open = function (e, t, n, o, i) {
        ...
        (this.getAllResponseHeaders = function () {
          ...
          for (var t in s.headers)
            'set-cookie' !== t && 'set-cookie2' !== t && (e += t + ': ' + s.headers[t] + '\r\n');
          return e.substr(0, e.length - 2);
        }),
        (this.getRequestHeader = function (e) {
          return 'string' == typeof e && f[e.toLowerCase()] ? h[f[e.toLowerCase()]] : '';
        }),
        (this.send = function (n) {
          ...
          if (y) {
            if ('GET' !== u.method) throw new Error('XMLHttpRequest: Only GET method is supported');
            if (u.async)
              r.readFile(b.pathname, 'utf8', function (e, t) {
                e ? l.handleError(e) : ((l.status = 200), (l.responseText = t), w(l.DONE));
              });
            else
              try {
            ...
            if (((h.Host = p), (m && 443 === C) || 80 === C || (h.Host += ':' + b.port), u.user)) {
              undefined === u.password && (u.password = '');
            ...
            'GET' === u.method || 'HEAD' === u.method
              ? (n = null)
              : n
                ? ((h['Content-Length'] = e.isBuffer(n) ? n.length : e.byteLength(n)),
            ...
            if (((_ = false), u.async)) {
              ...
              for (
                var L =
                    ...
                    "');});" +
                    (n
                      ? "req.write('" + JSON.stringify(n).slice(1, -1).replace(/'/g, "\\'") + "');"
                      : '') +
                    'req.end();',
                  I = a(o.argv[0], ['-e', L]);
                r.existsSync(D);
