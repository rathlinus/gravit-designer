...
function (exports, module, require) {
  ...
  const {
    ...
    v = [
      ...
      {
        id: 'inspect',
        label: new GCore.GLocaleKey('GShareDialog', 'text.allow-to-inspect-label'),
  ...
  exports.exports = class {
      ...
      ((this._user = e),
        (this._dialog = $('<div/>')
            ...
            $('<div/>')
              ...
              .append(
                $('<div/>')
                  ...
                  .append(
                    $('<span/>').text(
                      GCore.GLocale.get(new GCore.GLocaleKey('GShareDialog', 'text.switch-on'))
                    )
                  )
                  .append(
                    $('<div/>')
          ...
          .append(
            $('<span/>')
              .addClass('subtitle')
              .text(GCore.GLocale.get(new GCore.GLocaleKey('GShareDialog', 'text.subtitle-on')))
          )
          .append(
            $('<div/>')
              .addClass('share-link')
                    ...
                    $('<label/>')
                      ...
                      .append(
                        $('<div/>')
                          ...
                          .append($('<span/>').addClass('subtitle').text(GCore.GLocale.get(i)))
                      )
                      .appendTo(d),
          ...
          .then(async (e) => {
            if (
              ...
              ((this._lastSharePermissions = e),
                await this._setSharePermissions(Object.assign(e, { access: true })));
            }
          })
          .catch(this._handleException)
          .finally(() => {
    ...
    _updateProperties() {
      ...
      (this._dialog.toggleClass('share-on', !!module),
        this._dialog
          ...
          .text(
            GCore.GLocale.get(
              new GCore.GLocaleKey('GShareDialog', 'text.subtitle-'.concat(module ? 'on' : 'off'))
            )
          ),
        this._dialog
          ...
          .text(
            GCore.GLocale.get(
              new GCore.GLocaleKey('GShareDialog', 'text.switch-'.concat(module ? 'on' : 'off'))
            )
          ),
        this._dialog.find('.share-switch input').prop('checked', module),
        this._dialog.find('#copy > .share-setting-input > input').prop('checked', require),
    ...
    _buildShareByInput(e) {
      if ('user' === e)
        return $('<div/>').css('display', 'none').addClass('share-emails').gShareUserInput();
    }
    _toggleLoading(e) {
