...
function (exports, module, require) {
  ...
  class g extends GAction {
                ...
                $('.g-export-dialog').length ||
                  (module.isNew()
                    ? GSystemDialog.confirm(
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GExportAction', 'text.save-before-export')
                        ),
                        (e) => {
                          e
    ...
    static ID = 'file.export';

    static TITLE = new GCore.GLocaleKey('GExportAction', 'title');

    static SHORTCUT = [GEditor.GKey.Constant.SHIFT, GEditor.GKey.Constant.META, 'E'];
