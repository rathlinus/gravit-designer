...
function (exports, module, require) {
  ...
  ((b.prototype.filesPanel = null),
    ...
    (b.prototype._factoryFolder = function (e, t) {
      ...
      var _interopRequireDefault = this.filesPanel.isItemSelected(e),
        ...
        s = new GCloudFolderItem(e, t, this.filesPanel.drive.isRootFolder(e))
          ...
          .onFolderStateClick(() => {
            GUserModel().then(() => {
              if ((s.toggleState(), !s.isRootFolder() && !GContainer && s.isStateOpen())) {
                var e = s.getChildren();
              ...
              .then((t) => {
                ...
                if (
                  (_interopRequireDefault &&
                    'id' in _interopRequireDefault &&
                    _interopRequireDefault.id === e.id) ||
      ...
      try {
        ...
        if (
          ...
          for (var require, _interopRequireDefault = [e], GCore = e, GEditor = false; !require; )
            if (
              (GCore = await GCloudFolderItem.getFolder(GCore.parent).catch(
                (t) => (
              ...
              if (
                ...
                _interopRequireDefault.length > AppSettings2.MAX_FOLDER_DEPTH_FOR_CLOUD)
              )
              ...
              if (GEditor) return Promise.reject(AppSettings.gApi.HTTP_STATUS_CODES.NOT_FOUND);
              require = true;
            }
          ...
          for (CloudException = GSystemDialog = GContainer.shift(); CloudException; ) {
            ...
            GUserModel
              ? (await GUserModel.refresh(),
                ...
                (CloudException = GContainer.shift())
                  ? (GSystemDialog = CloudException)
                  : module(GSystemDialog, GUserModel))
              : (CloudException = null);
          }
        }
    ...
    (b.prototype._registerDriveEvent = function () {
      gDesigner.addEventListener(CloudException.default.DriveEvent, this._handleDriveEvent, this);
    }),
    (b.prototype.initLayout = function (e) {
      ...
      var t = this;
      ('native' ===
        this.filesPanel.getCloudSettingsById(this.filesPanel.getCurrentDriveId()).type &&
        ...
        this.panel
          ...
          .toggleClass('g-cdgs', !this.filesPanel.getUISettings().dialogControls),
        this.panel
      ...
      const GEditor = (0, CollaborationMergeUtils.throttle)(
        this._loadFoldersOnDemand.bind(this),
        100
      );
      let GContainer = 0;
      var s = $('<div />')
      ...
      ($(this._rightSide).scroll(
        function (e) {
          ...
          Math.floor(t[0].scrollHeight - t.scrollTop()) === Math.floor(t.outerHeight()) &&
        ...
        $('<div />')
          ...
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'text.title-recent-files'))
          )
      ...
      const m = $('<div />')
        ...
        .attr(
          'data-title',
          GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'text.title-all-files'))
        )
        .hide()
        .appendTo(this._rightSide);
      (this.hasPermission(b.Permission.RecentFilesShowMore) &&
        m.append(
          $('<div />')
            ...
            .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanelViewBase', 'text.show-more')))
            .on('click', function () {
    ...
    (b.prototype._getGridData = function (e) {
      ...
      let GEditor = 1;
      _interopRequireDefault &&
        !isNaN(_interopRequireDefault) &&
        (GEditor = Math.floor(e.width() / _interopRequireDefault));
      return {
        total: require,
        totalRows:
          require % GEditor > 0 ? Math.floor(require / GEditor) + 1 : Math.floor(require / GEditor),
    ...
    (b.prototype.createTopBar = function (e) {
      ...
      var _interopRequireDefault = this.filesPanel.getCloudSettings(),
        GEditor = this.filesPanel.getCloudSettingsById(this.filesPanel.getCurrentDriveId()),
        GContainer = this,
        s = $('<div />')
            ...
            $('<div />')
              ...
              .append(
                $('<div />')
                  ...
                  .attr(
                    'data-title',
                    GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.maximize-window'))
                  )
                  .on('click', (e) => {
              ...
              .append(
                $('<div />')
                  ...
                  .attr(
                    'data-title',
                    GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.minimize-window'))
                  )
                  .css('display', 'none')
                  .on('click', (e) => {
      ...
      if (
        (module ? this.panel.find('.g-files-top-bar').replaceWith(s) : s.appendTo(this.panel),
        require)
      )
      ...
      var CloudException = $('<div />')
        ...
        .on('click', function () {
          (GContainer._cloudPane(this), gDesigner.stats('filespanel-view_open_cloud-pane'));
        })
        .appendTo(s);
      switch (GEditor.type) {
        case 'sharepoint':
          ...
          $('<div />')
            ...
            .append(
              $('<div />')
                ...
                .text(
                  GCore.GLocale.get(
                    new GCore.GLocaleKey('GFilesPanelViewBase', 'text.connect-cloud-drive')
                  )
                )
            )
            .on(
            ...
            .click(() => {
              (gDesigner.stats('filespanel-view_execute_action', module),
                _interopRequireDefault(this.filesPanel.getContextSource()).catch((e) => {
                  'string' == typeof e ? GSystemDialog.default.alert(e) : console.error(e);
                }));
            });
        }),
          ...
          $('<div/>')
            ...
            .append(
              $('<div/>')
                ...
                .text(
                  GCore.GLocale.get(
                    new GCore.GLocaleKey('GFilesPanelViewBase', 'text.refresh-drive-content')
                  )
                )
            )
        )
      ...
      try {
        var module = this.filesPanel.getCloudSettings(),
          require = $('<div/>')
            .addClass('cloud-pane')
            .on('click', () => {
              (gDesigner.stats('filespanel-view_close_cloud-pane'), require.gOverlay('close'));
            }),
              ...
              ((e) => {
                  ...
                  .on(
                    ...
                    async function () {
                      if (e.id !== this.filesPanel.getCurrentDriveId()) {
                        (gDesigner.stats('filespanel-view_open_cloud-drive', e.name),
                          this.toggleLoading(true));
                        try {
                ...
                if (
                  (CollaborationMergeUtils &&
                    AppSettings &&
                    module.append(
                      $('<div />').addClass('corporate-storage-list').addClass('arrow-open-right')
                    ),
                  e.deletable &&
                    module.append(
                      $('<div />')
                    ...
                    GEditor = [
                      {
                        ...
                        name: GCore.GLocale.get(
                          new GCore.GLocaleKey('GFilesPanelViewBase', 'text.my-drive')
                        ),
              ...
              $('<div />')
                ...
                .append(
                  $('<div />')
                    ...
                    .text(
                      GCore.GLocale.get(
                        new GCore.GLocaleKey('GFilesPanelViewBase', 'text.connect-new-cloud-drive')
                      )
                    )
                )
            )
        ...
        GSystemDialog.default.alert(
          GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.loading-failed'))
        );
      }
    }),
      ...
      if (e) {
        var require = $('<div />')
          ...
          .on('keypress', function (e) {
            13 === e.keyCode &&
              $(this).closest('.edit-account-dialog').find('.vendor-form-save').click();
          })
          .append(
            $('<div />')
          ...
          .append(
            $('<div />')
              ...
              .text(
                GCore.GLocale.get(
                  new GCore.GLocaleKey('GFilesPanelViewBase', 'text.edit-drive-title')
                )
              )
          )
          .append(
            $('<label />')
              .append(
                $('<div />').text(
                  GCore.GLocale.get(
                    new GCore.GLocaleKey('GFilesPanelViewBase', 'text.add-new-account-field-name')
                  )
                )
              )
              .append(
          ...
          .gDialog({
            ...
            buttons: [
              ...
              $('<button />')
                ...
                .text(
                  GCore.GLocale.get(
                    new GCore.GLocaleKey('GFilesPanelViewBase', 'text.button-add-cloud-drive-save')
                  )
                ),
            ],
          });
    ...
    (b.prototype._newCloudAccountDialog = async function () {
      ...
      if (
        (gDesigner.stats('filespanel-view_open_add-cloud-drive-account-dialog'), !(t.length < 1))
      ) {
        var require = $('<div />')
            .append(
              $('<div></div>')
                ...
                .on('click', () => {
                  (gDesigner.stats('filespanel-view_close_new-cloud-account-dialog'),
                    require.gDialog('close'));
                })
            )
            .append(
              $('<div />')
                ...
                .text(
                  GCore.GLocale.get(
                    new GCore.GLocaleKey('GFilesPanelViewBase', 'text.add-new-cloud-drive')
                  )
                )
            ),
              ...
              $('<div />')
                ...
                .append(
                  $('<div />')
                    ...
                    .text(
                      GCore.GLocale.get(
                        new GCore.GLocaleKey('GFilesPanelViewBase', 'text.connect-cloud-drive-text')
                      ).replace('%name', t.name)
                    )
                )
                .on('click', function () {
    ...
    (b.prototype._addCloudDriveDialog = function (e) {
      ...
      if (e) {
        if (
          (gDesigner.stats('filespanel-view_open_add-cloud-drive-account-form-dialog', e.type),
          'googledrive' === e.type)
        )
          return (function (e) {
            ...
            name: GCore.GLocale.get(
              new GCore.GLocaleKey('GFilesPanelViewBase', 'text.personal-google-drive')
            ),
          }).then(() => {
    ...
    (b.prototype._closeCorporateSubMenu = function () {
      this._corporateSubMenu &&
        (this._corporateSubMenu.gOverlay('close'), (this._corporateSubMenu = null));
    }),
      ...
      const _interopRequireDefault = () => {
        for (
          var _interopRequireDefault = $('<div/>')
              ...
              .on('click', () => {
                (gDesigner.stats('filespanel-view_close_corporate-storages-pane'),
          ...
          (function (e) {
            $('<div />')
              ...
              .append(
                $('<div />').addClass('icon-container').append($('<span />').addClass('icon'))
              )
              .append($('<div />').addClass('name').text(e.name))
              .appendTo(GCore)[0]
              .addEventListener(
                ...
                () => {
                  (_interopRequireDefault.gOverlay('close'),
                    gDesigner.stats('filespanel-view_select_corporate-storage'),
                    n(e));
                },
                true
              );
      ...
      (undefined !== this.filesPanel.drive.SORT_TYPES.UPDATED &&
        $('<div/>')
          ...
          .append(
            $('<span/>')
              .addClass('label')
              .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'text.updated')))
          )
          .on(
            'click',
            function () {
        ...
        undefined !== this.filesPanel.drive.SORT_TYPES.NAME &&
          $('<div/>')
            ...
            .append(
              $('<span/>')
                .addClass('label')
                .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'text.name')))
            )
            .on(
              'click',
              function () {
        ...
        undefined !== this.filesPanel.drive.SORT_TYPES.CREATED &&
          $('<div/>')
            ...
            .append(
              $('<span/>')
                .addClass('label')
                .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'text.created')))
            )
            .on(
              'click',
              function () {
        ...
        $('<div/>')
          ...
          .append(
            $('<span/>')
              .addClass('label')
              .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'text.ascending')))
          )
          .on(
            'click',
            function () {
        ...
        $('<div/>')
          ...
          .append(
            $('<span/>')
              .addClass('label')
              .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'text.descending')))
          )
          .on(
            'click',
            function () {
    ...
    (b.prototype._handleFilterItemClick = function (e, t, n) {
      ...
      (e
        ...
        0 !== this.filesPanel.getSelectedFilterForFileTypes().length
          ...
          : _interopRequireDefault.hasClass('g-check') &&
            _interopRequireDefault.removeClass('g-check'));
    }),
    (b.prototype._createFilterFileTypeOverlay = function (e) {
      ...
      return (
        ...
        $('<div/>')
          ...
          .append(
            $('<span>').text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.clear')))
          )
          .on(
            'click',
            function () {
    ...
    (b.prototype._updateFilterFileTypeStates = function () {
      ...
      this.filesPanel.getSelectedFilterForFileTypes().forEach((t) => {
        const require = this.filesPanel.getAvailableFileTypesFilter().find((e) => e.type === t);
        e.find('.sort-option.'.concat(require.id)).find('input[type=checkbox]')[0].checked = true;
      });
    }),
    ...
    (b.prototype.manageOpenFolder = function (e, t, n) {
      ...
      if (n && !n.isRootFolder()) {
        ...
        _interopRequireDefault &&
          ...
          _interopRequireDefault.forEach((e) => e.refresh());
      }
    }),
    ...
    (b.prototype.manageSelection = function (e, t) {
      if (
        ...
        e.hasClass('selected')
          ? (e.removeClass('selected'), this.filesPanel.removeFromSelection(t))
          : this._addToSelection(e);
      else if (this._isMultiSelectionEnabled() && GEditor.GPlatform.modifiers.shiftKey) {
        var require = $(e),
        ...
        if (!GContainer || !s) {
          ...
          if (
            ...
            for (
              ...
              CollaborationMergeUtils < CloudException.length;
              ++CollaborationMergeUtils
            ) {
    ...
    (b.prototype.renderNewFolderButton = function (e, t) {
      ...
      ($('<div/>')
        ...
        .append(
          $('<span/>')
            .addClass('label')
            .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.new-folder')))
        )
        .attr(
          'data-title',
          GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.new-folder-tooltip'))
        )
        .on('click', (e) => {
          e.stopPropagation();
    ...
    (b.prototype.renderSortButton = function (e) {
      var t = this,
        n = $('<div/>')
          ...
          .attr('data-title', GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.sort')))
          .on('click', function (e) {
    ...
    (b.prototype.renderToParentFolderButton = function (e) {
      $('<div/>')
        ...
        .attr(
          'data-title',
          GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.back-tooltip'))
        )
        .append($('<span/>').addClass('icon').addClass('gravit-icon-w-back'))
        .append(
          $('<span/>')
            .addClass('label')
            .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.back')))
        )
        .on(
          'click',
          function (e) {
    ...
    (b.prototype.renderToRootFolderButton = function (e) {
      $('<div/>')
        ...
        .attr(
          'data-title',
          GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.my-cloud-tooltip'))
        )
        .append($('<span/>').addClass('icon').addClass('gravit-icon-w-back'))
        .append(
          $('<span/>')
            .addClass('label')
            .text(GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.my-cloud')))
        )
        .on(
          'click',
          function (e) {
      ...
      $('<div />')
        ...
        .append(
          $('<div />')
            ...
            .attr(
              'data-title',
              GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.card-view-button'))
            )
        ...
        .append(
          $('<div />')
            ...
            .attr(
              'data-title',
              GCore.GLocale.get(new GCore.GLocaleKey('GFilesPanel', 'action.list-view-button'))
            )
