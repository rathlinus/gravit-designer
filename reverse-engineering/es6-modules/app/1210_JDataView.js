      ...
      exports.exports = (function (e) {
        ...
        function n(e, t) {
          return (
            'object' == typeof e &&
            null !== e &&
            (e.constructor === t || Object.prototype.toString.call(e) === '[object ' + t.name + ']')
          );
        }
        function o(e, t) {
        ...
        function a(e, o, r, s) {
          ...
          ((this.byteOffset = o = i(o, 0)),
            ...
            this._isDataView ? (this._view = new DataView(e, o, r)) : this._checkBounds(o, r, c),
        ...
        function r(e) {
          ...
          for (
            var n = new (d.ArrayBuffer ? Uint8Array : Array)(e.length), o = 0, i = e.length;
            i > o;
            o++
          )
        ...
        ((a.wrapBuffer = function (e) {
          switch (typeof e) {
            ...
            default:
              return (
                'length' in e &&
                  !((d.NodeBuffer && n(e, t)) || (d.ArrayBuffer && n(e, ArrayBuffer))) &&
                  (d.NodeBuffer
                    ? (e = new t(e))
                    : d.ArrayBuffer
                      ? n(e, ArrayBuffer) ||
          ...
          (a.Int64 = c),
          (c.prototype = 'create' in Object ? Object.create(l.prototype) : new l()),
          ...
          (c.fromNumber = function (e) {
            ...
            if (e >= 0) {
              ...
              ((t = o.lo), (n = o.hi));
            } else ((t = e - (n = Math.floor(e / s(32))) * s(32)), (n += s(32)));
            return new c(t, n);
          }));
        var h = (a.prototype = {
            compatibility: d,
            ...
            _action: function (e, t, n, o, a) {
              return this._engineAction(e, t, i(n, this._offset), i(o, this._littleEndian), a);
            },
            _dataViewAction: function (e, t, n, o, i) {
              return (
                (this._offset = n + g[e]),
                t ? this._view['get' + e](n, o) : this._view['set' + e](n, i, o)
              );
            },
            _arrayBufferAction: function (t, n, o, a, r) {
              var s,
                ...
                c = e[t + 'Array'];
              if (
                ((a = i(a, this._littleEndian)), 1 === l || ((this.byteOffset + o) % l == 0 && a))
              )
                return (
            ...
            _getBytes: function (e, t, n) {
              ...
              var a = this._isArrayBuffer
                ...
                : (this.buffer.slice || Array.prototype.slice).call(this.buffer, t, t + e);
            ...
            setString: function (e, t, n) {
              if (this._isNodeBuffer)
                return (
                  ...
                  void (this._offset = e + this.buffer.write(t, this.byteOffset + e, n || 'binary'))
                );
              var o;
            ...
            alignBy: function (e) {
              return (
                (this._bitOffset = 0),
                1 !== i(e, 1) ? this.skip(e - (this._offset % e || e)) : this._offset
              );
            },
            ...
            getUnsigned: function (e, t) {
              var n = this._getBitRangeData(e, t).wideValue >>> -this._bitOffset;
              return 32 > e ? n & ~(-1 << e) : n;
            },
            _setBinaryFloat: function (e, t, n, o, i) {
              ...
              for (var u = []; n >= 8; ) (u.push(r % 256), (r = Math.floor(r / 256)), (n -= 8));
              for (a = (a << n) | r, o += n; o >= 8; ) (u.push(255 & a), (a >>>= 8), (o -= 8));
            ...
            _setUint32: function (e, t, n) {
              this._setBytes(e, [255 & t, (t >>> 8) & 255, (t >>> 16) & 255, t >>> 24], n);
            },
        ...
        for (var m in ((h._nodeBufferAction = function (e, t, n, o, i) {
          this._offset = n + g[e];
          var a = f[e] + ('Int8' === e || 'Uint8' === e ? '' : o ? 'LE' : 'BE');
          return (
            (n += this.byteOffset),
