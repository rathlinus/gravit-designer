...
function (exports, module, require) {
  ...
  class s extends GProperties {
    ...
    init(e, t) {
              ...
              .on('change', function () {
                ...
                null !== t && 'number' == typeof t && t >= 0
                  ? n._assignProperty(
                      ...
                      t,
                      GCore.GLocale.get(
                        new GCore.GLocaleKey('GPolygonProperties', 'action.change-radius')
                      )
                    )
                  : n._updateProperties();
              })
          ...
          if ('ia' === e || 'oa' === e)
            return $('<input>')
              ...
              .on('change', function () {
                ...
                null !== t
                  ? ((t = GCore.GMath.normalizeAngleRadians(GCore.GMath.toRadians(t))),
                    n._assignProperty(
                      e,
                      GCore.GMath.PI2 - t,
                      GCore.GLocale.get(
                        new GCore.GLocaleKey('GPolygonProperties', 'action.change-angle')
                      )
                    ))
                  : n._updateProperties();
              })
                ...
                .on('input', function () {
                  ...
                  n._panel
                    ...
                    .val(
                      n._document
                        .getScene()
                        .pointToString(e, n._document.getScene().getOptimalDecimalsCount())
                    );
                })
                .on('change', function () {
                  (gDesigner.stats('polygonproperties_change_radius'),
      ...
      ($('<div></div>')
        .gPropertyRow({
          label: GCore.GLocale.get(new GCore.GLocaleKey('GPolygonProperties', 'text.points')),
          columns: [
            {
              width: 'auto',
              ...
              content: $('<div/>')
                ...
                .on('input', function () {
                  ...
                  (n._assignPoints(parseInt(e), true),
                    n._panel.find('input[type="text"][data-property="pts"]').val(e));
                })
              ...
              { width: '3px' },
              {
                ...
                content: $('<div></div>')
                  .attr(
                    'data-title',
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GCommonNames', 'text.advanced-settings')
                    )
                  )
                ...
                content: $('<label></label>')
                  ...
                  .append(
                    $(
                      '<span>' +
                        GCore.GLocale.get(
                          new GCore.GLocaleKey('GPolygonProperties', 'text.plain-edges')
                        ) +
                        '</span>'
                    )
                  ),
                      ...
                      .on(
                        ...
                        function (e) {
                          (gDesigner.stats(
                            ...
                            $(e.target).is(':checked') ? 'enabled' : 'disabled'
                          ),
                            this._assignProperty('csc', $(e.target).is(':checked')));
                        }.bind(this)
                      )
                  )
                  .append(
        ...
        $('<div></div>')
          ...
          .gPropertyRow({
            label: GCore.GLocale.get(new GCore.GLocaleKey('GPolygonProperties', 'text.corners')),
            columns: [
              {
                width: '50%',
                content: $('<div></div>')
              ...
              },
              {
                ...
                label: GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.inside')),
              },
            ],
          })
          .appendTo(this._advancedPanel),
    ...
    _updateProperties(e) {
      ...
      (this._panel.find('.g-input-slider[data-property="pts"]').gInputSlider('value', GProperties),
        this._panel.find('[type="text"][data-property="pts"]').gInputBox('value', GProperties),
        this._panel
      ...
      (this._panel
        ...
        this._panel
          ...
          .css(
            'display',
            this._advancedPanel.find('input[data-property="edges"]').prop('checked') ? 'none' : ''
          ));
    }

    _assignCornersRadius(e, t, n) {
      ...
      try {
        ...
        t ||
          this._document
            ...
            .commitTransaction(
              GCore.GLocale.get(
                new GCore.GLocaleKey('GPolygonProperties', 'action.change-polygon-size')
              )
            );
      }
    }
      ...
      try {
        ...
        t ||
          this._document
            ...
            .commitTransaction(
              GCore.GLocale.get(
                new GCore.GLocaleKey('GPolygonProperties', 'action.change-polygon-points')
              )
            );
      }
    }
