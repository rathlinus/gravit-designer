...
function (exports, module, require) {
  ...
  class l extends i {
          ...
          e[module].cachedPreview ||
            (e[module].addPreviewCallback = function (e) {
              ...
              ((t.innerHTML = this.displayname || this.family),
                ...
                (t.style.fontStyle = this.style === GCore.GFont.Style.Italic ? 'italic' : 'normal'),
    ...
    getTotalFonts(e) {
      return e ? this._fontList.filter(this._searchFilter(e)).length : this._totalFonts;
    }
    ...
    async _processResolveFont(e, t, n, GCore) {
    ...
    _createLocalFontList(e, t, n, GCore) {
      if (this._fontList && this._fontList.length > 0)
        return GCore.done(this._getFilteredFontsList.call(this, e, t, n), true, null);
    ...
    _getFilteredFontsList(e) {
      let module = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : 0,
        require = arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : 9999;
