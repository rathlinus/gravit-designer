...
function (exports, module, require) {
  ...
  class a extends GCore.GObject {
    constructor(e, t, n) {
      ...
      $('<button></button>')
      .addClass('highlight')
      .text(GCore.GLocale.get(new GCore.GLocaleKey('GChangePasswordPanel', 'text.assign')))
      .on('click', () => {
      ...
      GCore.GLocale.get(
      new GCore.GLocaleKey('GChangePasswordPanel', 'text.reset-password-done')
      ),
      'success'
      )
      )
      ...
      .appendTo(this._container),
      s(
      GCore.GLocale.get(new GCore.GLocaleKey('GChangePasswordPanel', 'text.new-password')),
      '',
      'new_password',
      'password',
      GCore.GLocale.get(
      new GCore.GLocaleKey('GChangePasswordPanel', 'text.placeholder-new-password')
      ),
      GCore.GLocale.get(new GCore.GLocaleKey('GChangePasswordPanel', 'text.new-password-tip'))
      ...
      s(
      GCore.GLocale.get(new GCore.GLocaleKey('GChangePasswordPanel', 'text.confirm-password')),
      '',
      'confirm_password',
      'password',
      GCore.GLocale.get(
      new GCore.GLocaleKey('GChangePasswordPanel', 'text.placeholder-confirm-password')
      )
      ).appendTo(u),
