...
function (exports, module, require) {
  ...
  !(function (i, a) {
    ...
    var r = 'model',
      ...
      y = function (e, t) {
        if ('string' == typeof e)
          return ((e = e.replace(/^\s\s*/, '')), undefined === t ? e : e.substring(0, 350));
      },
      v = function (e, t) {
                    ...
                    ? 2 === a.length
                      ...
                      : 3 === a.length
                        ? 'function' != typeof a[1] || (a[1].exec && a[1].test)
                          ? (this[a[0]] = s ? s.replace(a[1], a[2]) : undefined)
                          : (this[a[0]] = s ? a[1].call(this, s, a[2]) : undefined)
                        : 4 === a.length &&
                          (this[a[0]] = s ? a[3].call(this, s.replace(a[1], a[2])) : undefined)
                    : (this[a] = s || undefined));
          l += 2;
        }
      },
      ...
      C = function (e, t) {
        if (('object' == typeof e && ((t = e), (e = undefined)), !(this instanceof C)))
          return new C(e, t).getResult();
        var n =
            e ||
            (undefined !== i && i.navigator && i.navigator.userAgent ? i.navigator.userAgent : ''),
          o = t
            ? (function (e, t) {
                var n = {};
                for (var o in e)
        ...
        return (
          ...
          (this.getDevice = function () {
            var e = { vendor: undefined, model: undefined, type: undefined };
          ...
          (this.setUA = function (e) {
            return ((n = 'string' == typeof e && e.length > 350 ? y(e, 350) : e), this);
          }),
          this.setUA(n),
          this
        );
    ...
    ((C.VERSION = '0.7.33'),
      ...
      (C.ENGINE = C.OS = h([s, d])),
      undefined !== module
        ? (undefined !== exports && exports.exports && (module = exports.exports = C),
          (module.UAParser = C))
