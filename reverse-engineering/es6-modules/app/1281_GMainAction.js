...
function (exports, module, require) {
  ...
  class s extends GAction.default {
    constructor(e) {
      ...
      ((this._subActionIds = module.map((e) => GSubAction.default.getSubActionId(this.getId(), e))),
    ...
    _shortcutSubKeyHandler(e) {
      ...
      (this._resetShortcutSubKeyListener(),
        module &&
          ...
          (e.preventDefault(), e.stopPropagation(), this._executeFromShortcutSubKey(module)));
    }
