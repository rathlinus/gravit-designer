    ...
    !(function () {
      ...
      function m(e, t, n, o, i, a, r) {
        ...
        t.directory
          ...
          : t.getData(new zip.FileWriter(e, zip.getMimeType(t.name)), n, o, r);
      }
      function y(e) {
        ((e.entries = []), (e.root = new w(e)));
      }
      function v(e, t, n, o) {
        if (e.directory) return o ? new w(e.fs, t, n, e) : new b(e.fs, t, n, e);
      ...
      ((u.prototype = new a()),
        ...
        (_.prototype = {
          ...
          moveTo: function (e) {
            ...
            if (e.isDescendantOf(this)) throw 'Entry is a ancestor of target entry.';
            if (this != e) {
              if (e.getChildByName(this.name)) throw 'Entry filename already exists.';
        ...
        (t.getChildByName = function (e) {
          var t, n;
          for (t = 0; t < this.children.length; t++) if ((n = this.children[t]).name == e) return n;
        }),
        (C.prototype = {
          remove: function (e) {
