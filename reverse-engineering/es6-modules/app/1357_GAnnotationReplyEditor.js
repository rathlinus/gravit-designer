...
function (exports, module, require) {
  ...
  var GEditor = require(15) /* GEditor */,
    GCollaborationMentionsUtils = require(882);
  const GSystemDialog = require(44) /* GSystemDialog */,
    ...
    { getAnnotationType: p } = require(40);
  require(85) /* GContainer */;
  class g extends DataModule_1191 {
    constructor(e) {
      super();
      let {
      container: module,
    ...
    _init() {
      ...
      ((this._input = $('<textarea>')
        .attr(
          'placeholder',
          s.get(
            new l('GAnnotationPanel', c ? 'text.write-annotation-here' : 'text.write-reply-here')
          )
        )
        .attr('rows', 1)
        .attr('autofocus', g)
