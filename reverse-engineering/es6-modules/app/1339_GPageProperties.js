...
function (exports, module, require) {
  ...
  class _ extends GProperties {
    constructor() {
      super();
    }

    _panel = null;
    _canvasPropertiesRowInTouch = null;
    _canvasPropertiesRowInNormal = null;
    _hrAfterCanvasRow = null;
    _bleedRowInTouch = null;
    _bleedRowInNormal = null;
    _pageSizeRowInNormal = null;
    _hrAfterPageSizeRow = null;
    _toolbar = null;
    _document = null;
    _oldDocument = null;
    _pages = null;
    ...
    _ownChange = false;
    _chooserElem = null;
    _clipContentButton = null;
    _excludedPresets = [GPresets.TYPE.MERCH];
    ...
    _createInput(e) {
      ...
      if ('bck' === e)
        return $('<div></div>')
          ...
          .on('chooserclose', function (e, t, _interopRequireDefault) {
            if (gDesigner.getWorkspace().getStyleEdManager().getOverlayLock(_interopRequireDefault))
              t();
            else {
      ...
      if ('w' === e || 'h' === e) {
        var _interopRequireDefault = GCore.GLocale.get(
          new GCore.GLocaleKey('GCommonNames', 'property-'.concat(e.toLowerCase())),
          e
        );
        return $('<div>')
          .append(
          ...
          .gInputLabel({
            label: _interopRequireDefault,
            autoPadding: _interopRequireDefault.length > 1,
          });
      }
      if ('bl' === e)
        return $('<input>')
          ...
          .on('change', function () {
            ...
            null !== t && 'number' == typeof t && t >= 0
              ? n._assignProperty(
                  ...
                  t,
                  GCore.GLocale.get(
                    new GCore.GLocaleKey('GPageProperties', 'action.change-bleeding')
                  )
                )
              : n._updateProperties();
          })
      ...
      if ('mt' === e || 'mb' === e || 'ml' === e || 'mr' === e)
        return $('<input>')
          ...
          .on('change', function () {
            ...
            var t = n._document.getScene().stringToPoint($(this).gInputBox('value'));
            null !== t && 'number' == typeof t && t >= 0
              ? 'yes' === n._panel.find('[data-lock-margin]').attr('data-lock-margin')
                ? n._assignProperties(
                    ['mt', 'mb', 'ml', 'mr'],
                    [t, t, t, t],
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GPageProperties', 'action.change-margins')
                    )
                  )
                : n._assignProperty(
                    e,
                    t,
                    GCore.GLocale.get(
                      new GCore.GLocaleKey('GPageProperties', 'action.change-margin')
                    )
                  )
              : n._updateProperties();
          })
      ...
      if ('equal-margins' === e)
        return $('<span></span>')
          ...
          .on('click', function () {
            ...
            (gDesigner.stats('pageproperties_lock_margin', e.attr('data-lock-margin')),
          ...
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'action.equal-margin'))
          )
          .attr('data-lock-margin', 'yes');
      if ('master-page' === e)
        return $('<select></select>')
          ...
          .on('change', function () {
            (gDesigner.stats('pageproperties_change_canvas-opacity'),
              n._assignProperty(
                ...
                GCore.GLocale.get(
                  new GCore.GLocaleKey('GPageProperties', 'action.change-canvas-opacity')
                )
              ));
          })
          .gInputBox({
      ...
      if ('rotate-canvas' === e)
        return $('<button>')
          ...
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.rotate-canvas'))
          )
          ...
          .on('click', function () {
            ...
            e &&
              ...
              n._assignProperties(
                ...
                GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'action.change-size'))
              );
          });
      if ('trim-canvas' === e)
        return $('<button>')
          ...
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.size-trim'))
          )
          .append($('<span/>').addClass('gravit-icon-trim-canvas'))
          .on('click', function () {
            (gDesigner.stats('pageproperties_trim_page'),
              n._panel.find('select[data-property="preset-size"]').val('@trim'),
      ...
      if ('clip-content' === e) {
        this._clipContentButton = $('<button>')
          ...
          .attr(
            'data-title',
            GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.clip-content'))
          )
    ...
    _propertiesUpdateEventHandler(e) {
            ...
            columns: [
              {
                ...
                content: $(
                  '<span>' +
                    GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.page-size')) +
                    '</span>'
                ),
              },
            ...
            columns: [
              {
                ...
                content: $(
                  '<span>' +
                    GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.bleed')) +
                    '</span>'
                ),
              },
    ...
    init(e, t) {
      ...
      const require = l.GRichTooltipConfig.from({
        ...
        description: GCore.GLocale.get(
          new GCore.GLocaleKey('GPageProperties', 'text.margin-tooltip-description')
        ),
        learnMore: '',
      });
      ($('<div></div>')
          ...
          columns: [
            {
              ...
              content: $(
                '<span>' +
                  GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.margin')) +
                  '</span>'
            ...
            },
            {
              clazz: 'margin-input-column',
              labelClass: 'margin-input-labels',
              label: GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.right')),
              content: this._createInput('mr').gRichTooltip(require),
            },
            {
              clazz: 'margin-input-column',
              labelClass: 'margin-input-labels',
              label: GCore.GLocale.get(new GCore.GLocaleKey('GCommonNames', 'text.bottom')),
          ...
          columns: [
            {
              ...
              content: $(
                '<span>' +
                  GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.master')) +
                  '</span>'
              ),
            },
            {
              ...
              content: $('<div></div>')
                ...
                .gRichTooltip(
                  l.GRichTooltipConfig.from({
                    ...
                    description: GCore.GLocale.get(
                      new GCore.GLocaleKey('GPageProperties', 'text.master-tooltip-description')
                    ),
                    middle: false,
                    isPro:
        ...
        e
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GPageProperties', 'text.rotate-canvas-tooltip-description')
              ),
              learnMore: '',
            })
          ),
        e
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GPageProperties', 'text.trim-canvas-tooltip-description')
              ),
              learnMore: '',
            })
          ),
        e
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GPageProperties', 'text.clip-content-tooltip-description')
              ),
            })
          ),
        e
          ...
          .gRichTooltip(
            l.GRichTooltipConfig.from({
              ...
              description: GCore.GLocale.get(
                new GCore.GLocaleKey('GPageProperties', 'text.bleed-tooltip-description')
              ),
              middle: false,
              learnMore: '',
            })
    ...
    _assignMasterPage(e) {
      ...
      if (e) {
        ...
        try {
          ...
          n.commitTransaction(
            GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'action.assign-master-page'))
          );
        }
      } else {
        n.beginTransaction();
    ...
    _updatePresetSizes() {
      var e = (this._document || this._oldDocument).getScene().getProperty('ut'),
        ...
        n = $('<optgroup></optgroup>').attr(
          'label',
          GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.size-custom'))
        );
      ($('<option></option>')
        .attr('value', '@infinite')
        .text(GCore.GLocale.get(new GCore.GLocaleKey('GPageProperties', 'text.size-infinite')))
        .appendTo(n),
        t.append(n),
            ...
            if (t.unit === e) {
              ...
              if (CollaborationMergeUtils)
                ...
                $('<option></option>')
                  ...
                  .text(
                    ''.concat(t.name).concat(t.displaySize ? ' ' + t.width + 'x' + t.height : '')
                  )
                  .appendTo(_interopRequireDefault);
              GTools = true;
            }
    ...
    _updateProperties(e) {
      var t = this._document.getScene(),
        ...
        CollaborationMergeUtils = GCore.GLocale.get(
          new GCore.GLocaleKey('GCommonNames', 'text.page')
        );
      gDesigner.isTouchEnabled() &&
        (CollaborationMergeUtils = CollaborationMergeUtils.toUpperCase());
      ...
      if (
        ...
        GProperties.val(
          GProperties.find('option[value="' + GTouchTool + '"]').length ? GTouchTool : '@custom'
        );
      } else this._panel.find('select[data-property="preset-size"]').val('@infinite');
      (this._panel
        .find('input[data-property="w"]')
        .gInputBox('value', t.pointToString(n.getProperty('w'), t.getOptimalDecimalsCount())),
        this._panel
          .find('input[data-property="h"]')
          .gInputBox('value', t.pointToString(n.getProperty('h'), t.getOptimalDecimalsCount())),
        this._panel
          .find('input[data-property="mt"]')
          .gInputBox('value', t.pointToString(n.getProperty('mt'), t.getOptimalDecimalsCount())),
        this._panel
          .find('input[data-property="mb"]')
          .gInputBox('value', t.pointToString(n.getProperty('mb'), t.getOptimalDecimalsCount())),
        this._panel
          .find('input[data-property="ml"]')
          .gInputBox('value', t.pointToString(n.getProperty('ml'), t.getOptimalDecimalsCount())),
        this._panel
          .find('input[data-property="mr"]')
          .gInputBox('value', t.pointToString(n.getProperty('mr'), t.getOptimalDecimalsCount())));
      ...
      (this._pages.forEach(function (e) {
        ...
        e &&
          ...
          this._panel
            .find('[data-property="bck"]')
            .find('.preview')
            .trigger('click', null !== e.activeStopIdx ? e.activeStopIdx : null),
        this.updatePropertiesAvailability(n));
    }

    updatePropertiesAvailability(e) {
        ...
        (CollaborationMergeUtils.attr('disabled', l),
          ...
          this._manageClipButtonState(
            gDesigner.getWindows().getActiveWindow() &&
              ...
              gDesigner.getWindows().getActiveWindow().getView().getViewConfiguration()
                .paintMode === GCore.GScenePaintConfiguration.PaintMode.Output,
            n
          ),
    ...
    _assignProperties(e, t, n, _interopRequireDefault, GTools) {
      this._ownChange = true;
      ...
      try {
        ...
        (CollaborationMergeUtils.commitTransaction(n, _interopRequireDefault || null),
          (this._ownChange = false));
      }
    }
