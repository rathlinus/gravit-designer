...
function (e, t, i) {
      ...
      function h() {
        (o.Effect.call(this),
          ...
          (this._defaultBlending = void 0));
      }
      (r.inheritAndMix("GWebGLEffect", h, o.Effect, [n]),
        (h.prototype._useCroppedRendering = !1),
        ...
        (h.prototype.getShaderClass = function () {
          ...
          if (
            "function" !=
            typeof (e = i(817)("./" + this.$sh.toLowerCase().substr(1)))
          )
        ...
        (h.prototype.isAffectedByGLBug = function () {
          if (this._isAffectedByGLBug) return !0;
        ...
        (h.prototype.render = function (e, t, i, n, r, o, a) {
          ...
          if (this.$sh && !this.prepareShader()) return !1;
          var h = t || e;
          t && t.drawCanvas(e, 0, 0, 1, this._defaultBlending);
          var A = this.drawShader(h, this.$shp, n, 0, 0, r, o, a);
          return (
            this.$sh && l.DELETE_EFFECT_TEXTURES_AFTER_DRAW && this.destroy(),
            A
          );
        }),
