      ...
      e.exports = function (e) {
        ((e.Effects = function () {}),
          ...
          (e.Effects.prototype.getEffectsForLayer = function (t, i) {
            t = t || null;
            for (
              var n = null, r = [], o = [], a = [], s = this.getFirstChild();
              null !== s;
              s = s.getNext()
            )
            ...
            return (
              (r.length || o.length || a.length) && (n = r.concat(o).concat(a)),
              n
            );
          }),
          (e.Effects.prototype.insertChild = function (t, i) {
            if (
              t instanceof e.Effect &&
              t.getEffectType() === e.Effect.Type.PreEffect
            )
              for (
                var r = i || this.getLastChild();
                null !== r;
                r = r.getPrevious()
              )
          ...
          (e.Effects.prototype._handleChange = function (t, i) {
            ...
            (r &&
              r.hasMixin(e) &&
              ((t == n._Change.BeforeChildInsert ||
                t === n._Change.BeforeChildRemove) &&
                i instanceof e.Effect &&
                r._stylePrepareGeometryChange(i),
              (t == n._Change.AfterChildInsert ||
                t === n._Change.AfterChildRemove) &&
                i instanceof e.Effect &&
                r._styleFinishGeometryChange(i)),
          ...
          (e.Effects.prototype.getEffectsPadding = function (t, i, n) {
            ...
            if (
              ...
              return null;
            for (
              var a = [0, 0, 0, 0], s = [0, 0, 0, 0], l = null, h = 0;
              h < r.length;
              ++h
            ) {
              var A,
              ...
              if (
                (A =
                  h >= o
                    ? c.getAbsoluteEffectPadding(t)
                    : c.getEffectPadding(t))
              ) {
                switch (
                  (A instanceof Array || (A = [A, A, A, A]), c.getEffectType())
                ) {
                  case e.Effect.Type.PreEffect:
                  case e.Effect.Type.PostEffect:
                    s = [
                  ...
                  case e.Effect.Type.Filter:
                    (l &&
                      l.getEffectType() !== e.Effect.Type.Filter &&
                      l.getEffectType() !== e.Effect.Type.Multi &&
                      ((a = [
                        a[0] + s[0],
                        a[1] + s[1],
                        a[2] + s[2],
            ...
            return (
              l &&
                l.getEffectType() !== e.Effect.Type.Filter &&
                l.getEffectType() !== e.Effect.Type.Multi &&
                (a = [a[0] + s[0], a[1] + s[1], a[2] + s[2], a[3] + s[3]]),
              a
            );
          }),
          (e.Effects.prototype.resetMultireference = function () {
            (n.Multireference.prototype.resetMultireference.call(this),
              this.getParent() &&
                (this.getParent()._effId = this.getMultireferenceId()));
          }));
      };
    }