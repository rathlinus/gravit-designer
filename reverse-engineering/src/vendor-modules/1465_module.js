...
function (e, t, i) {
      ...
      function h(e, t) {
        ((this.canvas = e),
          ...
          (this._origin = new o(0, 0)),
          (this._scale = 1),
          (this._options = t || {}));
      }
      ((h.prototype._options = null),
        (h.prototype._duplicateLastPath = function () {
          this._svgs.length > 0 &&
            ((this._svg = this._svgs[this._svgs.length - 1]), this._push());
        }),
        (h.prototype._push = function () {
          "" != this._svg &&
            (this._svgs.push(this._svg),
            this._pushStyles(this._svgStyles),
            (this._svg = ""));
        }),
        ...
        (h.prototype._popStyles = function (e) {
          var t = e.pop();
          ((this._isStroke = t._isStroke),
            (this._isClear = t._isClear),
            (this._fillRule = t._fillRule),
            (this._transform = t._transform),
            (this._dashArray = t._dashArray),
            (this._dc_globalAlpha = t._dc_globalAlpha),
            (this._dc_globalCompositeOperation =
              t._dc_globalCompositeOperation),
        ...
        (h.prototype.moveTo = function (e, t) {
          Number.isNaN(e) ||
            Number.isNaN(t) ||
            (this._svg.length > 0 && (this._svg += " "),
            (this._svg += "M " + l.formatNumber(e) + " " + l.formatNumber(t)));
        }),
        (h.prototype.lineTo = function (e, t) {
          Number.isNaN(e) ||
            Number.isNaN(t) ||
            (this._svg.length > 0 && (this._svg += " "),
            (this._svg += "L " + l.formatNumber(e) + " " + l.formatNumber(t)));
        }),
        ...
        (h.prototype.fillRect = function (e, t, i, n) {
          ...
          if (((this._svg = ""), this.getTransform)) {
            var o = new a(e, t, i, n);
            ((e = (o = this.canvas._transform.mapRect(o)).getX()),
              (t = o.getY()),
              (i = o.getWidth()),
              (n = o.getHeight()));
          }
        ...
        (h.prototype.drawImage = function (e, t, i) {
          if (e._canvasContext)
            if (e._canvasContext instanceof h) {
              ...
              (0 != n._svg.length ||
                ("destination-out" != n.globalCompositeOperation &&
                  "destination-in" != n.globalCompositeOperation) ||
                n._duplicateLastPath(),
                this._svgs.push({
                  drawImage: e,
                  x: t,
                  y: i,
                }),
                (e._canvasContext.globalAlpha = this._dc_globalAlpha),
                (e._canvasContext.globalCompositeOperation =
                  this._dc_globalCompositeOperation),
                e._canvasContext._pushStyles(this._svgStyles));
            } else
