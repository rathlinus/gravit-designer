...
function (e, t, i) {
      ...
      function P(e) {
        (d.apply(
          ...
          this._viewConfiguration ||
            ((this._viewConfiguration = new r()),
            (this._viewConfiguration.enableFxCache =
              !w.WORKER_RENDERING_ENABLED)),
          P.options.panOrZoomOnWheel &&
            this.addEventListener(c.Wheel, this._wheelListener, this),
          this.addEventListener(c.Leave, this._leaveListener, this),
          this.addEventListener(c.Enter, this._enterListener, this),
          (this._dirtyElementList = new _()),
          (this._dirtySceneList = new _()),
          (this._elementCanvas = new f()),
          this._elementCanvas.setRenderAlgorithm(f.RenderAlgorithm.Pixelated),
          this._elementCanvas.setImageSmoothingQuality(f.SmoothingQuality.Low),
          (this._elementPaintContext = new y()),
          (this._elementPaintContext.configuration = this._viewConfiguration),
          (this._elementPaintContext.canvas = this._elementCanvas),
          (this._elementCanvas._canvasContext.canvas.style.position =
            "absolute"),
          (this._elementCanvas._canvasContext.canvas.style.left = "0px"),
          (this._elementCanvas._canvasContext.canvas.style.top = "0px"),
          this._htmlElement.insertBefore(
            this._elementCanvas._canvasContext.canvas,
            this._htmlElement.firstChild,
          ),
          w.DEBUG_AREAS !== w.DBG_AREAS_INFO.None &&
            ((this._debugCanvas = new f()),
            (this._debugCanvas._canvasContext.canvas.style.position =
              "absolute"),
            (this._debugCanvas._canvasContext.canvas.style.left = "0px"),
            (this._debugCanvas._canvasContext.canvas.style.top = "0px"),
            this._htmlElement.appendChild(
              this._debugCanvas._canvasContext.canvas,
            )),
          E.hardware !== E.Hardware.Desktop &&
            ((w.DELETE_EFFECT_TEXTURES_AFTER_DRAW = !0),
            (w.DELETE_BLEND_AND_GRADIENT_TEXTURES_AFTER_DRAW = !0)),
          (this._panHelperCanvas = new f()),
          this._panHelperCanvas.setRenderAlgorithm(f.RenderAlgorithm.Crisp),
          this._panHelperCanvas.setImageSmoothingQuality(
            f.SmoothingQuality.High,
          ),
          this._panHelperCanvas.prepare(),
          (this._sceneCanvas = new m(
            w.CANVAS_GRID_HORIZONTAL,
            w.CANVAS_GRID_VERTICAL,
          )),
          this._sceneCanvas.setRenderAlgorithm(f.RenderAlgorithm.Crisp),
          this._sceneCanvas.setImageSmoothingQuality(f.SmoothingQuality.High),
          (this._scenePaintContext = new y()),
          (this._scenePaintContext.configuration = this._viewConfiguration),
          (this._watermarkHelperCanvas = new f()),
          this._watermarkHelperCanvas.setRenderAlgorithm(
            f.RenderAlgorithm.Crisp,
          ),
          this._watermarkHelperCanvas.setImageSmoothingQuality(
            f.SmoothingQuality.High,
          ),
          this._watermarkHelperCanvas.prepare(),
          (this._inlineHintDiv = document.createElement("div")),
          (this._inlineHintDiv.className = "inline-hint"),
          (this._inlineHintDiv.style.position = "absolute"),
          (this._inlineHintDiv.style.display = "none"),
          this._htmlElement.appendChild(this._inlineHintDiv),
          (this._fakeTextDiv = document.createElement("div")),
          (this._fakeTextDiv.style.overflow = "hidden"),
          (this._fakeTextDiv.style.position = "absolute"),
          (this._fakeTextDiv.style.height = "0px"),
          (this._fakeTextDiv.style.display = "none"),
          (this._fakeTextBox = document.createElement("textarea")),
          this._fakeTextBox.setAttribute("autocorrect", "off"),
          this._fakeTextBox.setAttribute("autocapitalize", "off"),
          this._fakeTextBox.setAttribute("spellcheck", "false"),
          this._fakeTextBox.setAttribute("tabindex", "0"),
          (this._fakeTextBox.className = P.GRAVIT_IME),
          (this._fakeTextBox.style.position = "absolute"),
          (this._fakeTextBox.style.padding = "0px"),
          (this._fakeTextBox.style.width = "1000px"),
          (this._fakeTextBox.style.height = "1em"),
          (this._fakeTextBox.style.outline = "none"),
          ...
          e.addEventListener(
            s.RecordedTransactionStartedEvent,
            this._recordedTransactionStarted,
            this,
            void 0,
            void 0,
            !0,
          ...
          e.addEventListener(
            s.RecordedTransactionFinishedEvent,
      ...
      (b.init(w.ENABLE_RENDERER, w.ENABLE_DEBUG),
        ...
        (P.TRANSFORMEVENT = new P.TransformEvent()),
        (P.prototype._repaintRequestFrameId = null),
        (P.prototype._resizeRequestFrameId = null),
        (P.prototype._finishPanRequestFrameId = null),
        (P.prototype._scene = null),
        (P.prototype._dirtyElementList = null),
        (P.prototype._dirtySceneList = null),
        (P.prototype._elementCanvas = null),
        (P.prototype._debugCanvas = null),
        (P.prototype._elementPaintContext = null),
        (P.prototype._sceneCanvas = null),
        (P.prototype._panHelperCanvas = null),
        (P.prototype._watermarkHelperCanvas = null),
        (P.prototype._scenePaintContext = null),
        (P.prototype._horizontalRuler = null),
        (P.prototype._verticalRuler = null),
        (P.prototype._unitRuler = null),
        (P.prototype._inlineHintDiv = null),
        (P.prototype._fakeTextDiv = null),
        (P.prototype._fakeTextBox = null),
        (P.prototype._viewOffset = null),
        (P.prototype._viewMargin = null),
        (P.prototype._scrollX = 0),
        (P.prototype._scrollY = 0),
        ...
        (P.prototype._lastInvalidatedVtoWtransform = null),
        (P.prototype._panSubAreas = null),
        ...
        (P.prototype._zoomSteps = [
          0.12, 0.25, 0.5, 0.66, 1, 1.5, 2, 3, 4, 8, 16, 32, 64, 128,
        ]),
        ...
        (P.prototype.updateInlineHint = function (e, t, i) {
          if (e && t) {
            ((i = i || p.Side.CENTER),
              (e = e.replace(/\n/gi, "<br>")),
              (this._inlineHintDiv.innerHTML = e));
            var n = t.getX(),
              r = t.getY(),
              o = this._inlineHintDiv.offsetWidth,
              a = this._inlineHintDiv.offsetHeight,
              s = f.getScreenDPI();
            ...
            ((this._inlineHintDiv.style.left = n + "px"),
              (this._inlineHintDiv.style.top = r + "px"),
              (this._inlineHintDiv.style.display = ""));
          } else this._inlineHintDiv.style.display = "none";
        }),
        (P.prototype.setRulers = function (e) {
          e && !this._horizontalRuler
            ? ((this._horizontalRuler = new n(
                n.Orientation.Horizontal,
                this._scene,
              )),
              (this._verticalRuler = new n(
                n.Orientation.Vertical,
                this._scene,
              )),
              (this._unitRuler = new n(
                null,
                this._scene,
                void 0,
                !0,
              ...
              this._htmlElement.insertBefore(
                this._horizontalRuler._htmlElement,
                this._inlineHintDiv,
              ),
              this._htmlElement.insertBefore(
                this._verticalRuler._htmlElement,
                this._inlineHintDiv,
              ),
              this._htmlElement.insertBefore(
                this._unitRuler._htmlElement,
                this._inlineHintDiv,
              ),
              this._relayoutRulers(),
              this.addEventListener(c.Move, this._rulerMouseMoveListener, this))
            : !e &&
              this._horizontalRuler &&
              (this._htmlElement.removeChild(
                this._horizontalRuler._htmlElement,
              ),
              this._htmlElement.removeChild(this._verticalRuler._htmlElement),
              this._htmlElement.removeChild(this._unitRuler._htmlElement),
              this._horizontalRuler.release(),
              this._verticalRuler.release(),
              this._unitRuler.release(),
              (this._horizontalRuler = null),
              (this._verticalRuler = null),
              (this._unitRuler = null),
              this.removeEventListener(
                c.Move,
                this._rulerMouseMoveListener,
                this,
              ));
        }),
        (P.prototype.resize = function (e, t, i, n) {
          if (
            ((e = Math.round(e)),
            (t = Math.round(t)),
            e !== this._width || t !== this._height || i)
          ) {
            d.prototype.resize.call(this, e, t);
            var r = function () {
              ((this._inputHtmlElement.style.width =
                this._htmlElement.style.width),
                (this._inputHtmlElement.style.height =
                  this._htmlElement.style.height));
              var i = f.getScreenDPI();
              (this._elementCanvas.resize(e * i, t * i),
                (this._elementCanvas._canvasContext.canvas.style.width =
                  e + "px"),
                (this._elementCanvas._canvasContext.canvas.style.height =
                  t + "px"),
                w.DEBUG_AREAS !== w.DBG_AREAS_INFO.None &&
                  (this._debugCanvas.resize(e * i, t * i),
                  (this._debugCanvas._canvasContext.canvas.style.width =
                    e + "px"),
                  (this._debugCanvas._canvasContext.canvas.style.height =
                    t + "px")),
                this._sceneCanvas.resize(e * i, t * i),
                this._panHelperCanvas.resize(e * i, t * i),
                this._watermarkHelperCanvas.resize(e * i, t * i));
              var r = new p(0, 0, e * i, t * i),
                o = new p(0, 0, e * i, t * i);
            ...
            this._repaintRequestFrameId || this._finishPanRequestFrameId
              ? (this._resizeRequestFrameId &&
                  (g.cancelFrame(this._resizeRequestFrameId),
                  (this._resizeRequestFrameId = null)),
        ...
        (P.prototype._scheduleRendering = function (e, t, i) {
          var n = this,
            r = function () {
              x
                ? t
                  ? null !== n._resizeRequestFrameId &&
                    (n._resizeRequestFrameId = g.scheduleFrame(r))
                  : i
                    ? null !== n._finishPanRequestFrameId &&
                      (n._finishPanRequestFrameId = g.scheduleFrame(r))
                    : null !== n._repaintRequestFrameId &&
                      (n._repaintRequestFrameId = g.scheduleFrame(r))
                : (w.DEBUG_AREAS !== w.DBG_AREAS_INFO.None &&
                    void 0 !== typeof window &&
                    window.setTimeout(function () {
                      n._debugCanvas.clearRect(
                        0,
                        0,
                        n._debugCanvas.getWidth(),
                        n._debugCanvas.getHeight(),
                      );
                    }, 2e3),
                  e());
            };
        ...
        (P.prototype.setViewOffset = function (e) {
          if (((this._viewOffset = [0, 0, 0, 0]), e && e.length > 0)) {
        ...
        (P.prototype.setViewMargin = function (e) {
          if (((this._viewMargin = [0, 0, 0, 0]), e && e.length > 0))
            for (var t = 0; t < Math.min(4, e.length); ++t)
        ...
        (P.prototype.setLogicalPixels = function (e) {
          this._logicalPixels !== e &&
            ((this._logicalPixels = e), this._updateViewTransforms());
        }),
        (P.prototype.getWorldTransform = function (e) {
          if (e === this._scene) return this._worldToViewTransform;
          var t = e,
            i = this._worldToViewTransform;
          if (t) {
        ...
        (P.prototype.getViewTransform = function (e) {
          if (e === this._scene) return this._viewToWorldTransform;
          var t = e,
            i = this._viewToWorldTransform;
          if (t) {
            var n = t.getPosition(this._viewConfiguration.multiPageView);
        ...
        (P.prototype.getViewBox = function (e) {
          var t = this._viewOffset[0] + (e ? 0 : this._viewMargin[0]),
            i = this._viewOffset[1] + (e ? 0 : this._viewMargin[1]);
          return new p(
            t,
            i,
            this.getWidth() -
              (this._viewOffset[2] + (e ? 0 : this._viewMargin[2]) + t),
            this.getHeight() -
              (this._viewOffset[3] + (e ? 0 : this._viewMargin[3]) + i),
          );
        }),
        (P.prototype._getSceneRect = function () {
          return new p(
            0,
            0,
            this._sceneCanvas.getWidth(),
            this._sceneCanvas.getHeight(),
          );
        }),
        (P.prototype.transform = function (e, t, i) {
          ((this._zoom = i),
            this._correctScrollPosition(e, t),
            this._updateViewTransforms());
        }),
        (P.prototype.zoomAtCenter = function (e, t) {
          t = t || this._zoom;
          var i = f.getScreenDPI(),
            n = this.getViewBox().scaled(i, i).getSide(p.Side.CENTER),
            r = this.getWorldTransform().mapPoint(e),
            o = Math.min(
              P.options.maxZoomFactor,
              Math.max(t, P.options.minZoomFactor),
            );
          if (o != this._zoom || !A.equals(r, n)) {
            this._zoom = o;
            var a = this.getLogicalZoom(),
              s = new u()
        ...
        (P.prototype.zoomAt = function (e, t) {
          var i = f.getScreenDPI(),
            n = this.getViewBox().scaled(i, i).getSide(p.Side.CENTER),
            r = this.getViewTransform().mapPoint(n).subtract(e),
            o = t / this._zoom;
          this.zoomAtCenter(
            new A(e.getX() + r.getX() / o, e.getY() + r.getY() / o),
            t,
          );
        }),
        (P.prototype.zoomAll = function (e, t, i) {
          var n = e.getSide(p.Side.CENTER),
            r = e.getWidth(),
            o = e.getHeight(),
            a = this.getViewBox();
          ...
          if (t) {
            var l = this.getWorldTransform().mapRect(
                new p(n.getX() - r / 2, n.getY() - o / 2, r, o),
              ),
              h =
                this._zoom *
                Math.min(
                  1,
                  Math.max(
                    l.getWidth() / a.getWidth(),
                    l.getHeight() / a.getHeight(),
                  ),
                );
            ...
            this.zoomAtCenter(
              n,
              1 / Math.max(r / a.getWidth(), o / a.getHeight()),
            );
        }),
        (P.prototype.scrollBy = function (e, t) {
          return (0 != e && Math.abs(e) > 0.5) || (0 != t && Math.abs(t) > 0.5)
            ? (this._correctScrollPosition(
                this._scrollX + e,
                this._scrollY + t,
              ),
              this._updateViewTransforms(),
              new A(this._scrollDX, this._scrollDY))
            : null;
        }),
        (P.prototype.invalidateAndResetCache = function (e) {
          (e || (e = this._dirtySceneList.getArea()),
            e &&
              !e.isEmpty() &&
        ...
        (P.prototype.invalidate = function (e, t, i) {
          ...
          return e && n.dirty(e.getX(), e.getY(), e.getWidth(), e.getHeight())
            ? (t
                ? (w.DEBUG_AREAS & w.DBG_AREAS_INFO.Scene &&
                    this._debugCanvas.fillRect(
                      e.getX(),
                      e.getY(),
                      e.getWidth(),
                      e.getHeight(),
                  ...
                  null === i
                    ? (this._dirtyElementList.reset(),
                      (i = this._dirtyElementList.getArea()))
                    : void 0 === i && (i = e),
                  this._dirtyElementList.dirty(
                    i.getX(),
                    i.getY(),
                    i.getWidth(),
                    i.getHeight(),
              ...
              null == this._repaintRequestFrameId &&
                this._scheduleRendering(this._repaint.bind(this)),
              !0)
            : (null === this._repaintRequestFrameId &&
                ...
                (this._duringRecordedTransaction
                  ...
                  : this._scene.trigger(
                      new s.InvalidationFinishedEvent(
                        this._scene,
                        this._viewConfiguration,
                        !1,
                      ),
        ...
        (P.prototype.release = function () {
          (this.setRulers(!1),
            ...
            this._scene.__graphic_editor__ &&
              this._scene.__graphic_editor__.removeAllEventListeners(!0),
            ...
            this._panHelperCanvas.destroy(),
            this._watermarkHelperCanvas.destroy(),
            this._elementCanvas.destroy(),
            this._scenePaintContext.destroy(),
        ...
        (P.prototype._correctScrollPosition = function (e, t) {
          ...
          if (
            ...
            (this._scrollX = e),
            (this._scrollY = t),
            P.options.limitScrollingToView)
          ) {
                ...
                c = l(
                  ...
                  this._viewConfiguration.paintMode === r.PaintMode.Output
                    ? this._scene
                        ...
                        .getSide(p.Side.CENTER)
                    : this._scene
                        .getPaintBBox(this._viewConfiguration.multiPageView)
                        .getSide(p.Side.CENTER),
                ),
                d = s.getSide(p.Side.BOTTOM_RIGHT),
                g = this._scene && this._scene.getLastChild();
              g && !(g instanceof a);
            )
              g = g.getPrevious();
            if (!g) return;
            ...
            var _,
              ...
              w = l(
                d,
                (m = m.translated(C.getX(), C.getY()).expanded(0, b, 0, 0))
                  .getSide(p.Side.BOTTOM_RIGHT)
                  .add(new A(h, h)),
              ),
            ...
            if (this._viewConfiguration.paintMode === r.PaintMode.Output) {
              ...
              _ =
                (B = x && x.getGeometryBBox()) &&
                B.getSide(p.Side.TOP_LEFT).add(new A(-h, 0));
            } else
              _ = this._scene
                .getPaintBBox(this._viewConfiguration.multiPageView)
                .getSide(p.Side.TOP_LEFT)
                .add(new A(-h, 0));
            if (!_) return;
            var S = l(E, _);
            (n !== this._scrollY &&
              (B.getHeight() > s.getHeight()
                ? this._scrollY < 0
                  ? (this._scrollY = -S.getY())
                  : (this._scrollY = Math.min(-w.getY(), this._scrollY))
                : (this._scrollY = -c.getY())),
              i !== this._scrollX &&
                (B.getWidth() > s.getWidth()
                  ? i < this._scrollX
                    ? (this._scrollX = Math.min(-w.getX(), this._scrollX))
                    : (this._scrollX = Math.max(-S.getX(), this._scrollX))
                  : (this._scrollX = -c.getX())),
              (this._scrollDX = this._scrollX - i),
              (this._scrollDY = this._scrollY - n));
          }
        }),
        (P.prototype._paintScene = function (e, t, i) {
          (w.ENABLE_TIMING && console.time("Compositing time"),
            ...
            this._sceneCanvas.paintAndRender(
              ...
              new A(this._scrollX, this._scrollY),
              this.getLogicalZoom(),
              e,
              t,
              i,
        ...
        (P.prototype._paintElement = function (e, t, i, n) {
          ...
          w.DRAW_DURING_RENDERING || w.SHOW_LOWRES_GIMMICK
            ? this._sceneCanvas.drawTo(this._elementCanvas, r, n)
            : this._sceneCanvas.drawTo(this._elementCanvas, r);
        }),
        (P.prototype._finishPaint = function (e, t, i, n, r, o) {
          if (e) {
            var a;
            if (w.DRAW_DURING_RENDERING && !w.SHOW_LOWRES_GIMMICK && o) {
              var s = this._sceneCanvas.getSubCanvasContainingGraphic(o),
                l = s.canvas,
                h = new p(s.cx, s.cy, l.getWidth(), l.getHeight());
              if (!(a = e.intersect(h))) return;
            }
            try {
              (t &&
                this._viewConfiguration.watermark &&
                (this._elementCanvas.clearRect(
                  0,
                  0,
                  this._elementCanvas.getWidth(),
                  this._elementCanvas.getHeight(),
                ),
                this._elementCanvas.drawImage(
                  this._watermarkHelperCanvas,
                  0,
                  0,
                )),
                a
                  ? (this._elementCanvas.prepare(a.getDirtyRectangles()),
                    (this._elementPaintContext.dirtyMatcher = a))
                  : (this._elementCanvas.prepare(e.getDirtyRectangles()),
                    (this._elementPaintContext.dirtyMatcher = e)),
                this._paintElement(i, n, r, o));
            } catch (e) {
              console.error("Editor render error:" + e);
            } finally {
              (r && (this._elementPaintContext.dirtyMatcher = null),
                this._elementCanvas.finish(),
                this._paintWatermark());
            }
          }
        }),
        (P.prototype._paintWatermark = function () {
          if (this._viewConfiguration.watermark) {
            var e = this._elementCanvas.createTexture(
              this._viewConfiguration.watermark,
            );
            (this._watermarkHelperCanvas.clearRect(
              0,
              0,
              this._watermarkHelperCanvas.getWidth(),
              this._watermarkHelperCanvas.getHeight(),
            ),
              this._watermarkHelperCanvas.drawImage(this._elementCanvas, 0, 0),
        ...
        (P.prototype.getScreenBox = function () {
          ...
          if (!this._scene.isFixedSized()) {
            var t = f.getScreenDPI(),
              i = this.getViewBox().scaled(t, t),
              n = i.getWidth(),
              r = i.getHeight();
            ((i = i.expanded(n, r, n, r)),
              (e = this.getViewTransform(this._scene).mapRect(i)));
          }
          return e;
        }),
        (P.prototype._repaint = function () {
          try {
            var e = this._dirtyElementList.flush(),
              t = this._dirtySceneList.flush(),
              i = this.getWorldTransform(),
              n = this.getViewTransform();
            if (this._panSubAreas) {
              if (null !== e && null !== t) {
                this._lastInvalidatedVtoWtransform ||
                  ((this._lastInvalidatedVtoWtransform =
                    this._viewToWorldTransform),
                  (this._lastInvalidatedWtoVtransform =
                    this._worldToViewTransform));
                var r = this._worldToViewTransform
                    .mapRect(
                      this._lastInvalidatedVtoWtransform.mapRect(
                        this._dirtySceneList.getArea(),
                      ),
                    )
                    .intersected(this._dirtySceneList.getArea()),
                  o = this._lastInvalidatedWtoVtransform.mapRect(
                    this._viewToWorldTransform.mapRect(r),
                  );
                ((r = new p(
                  Math.round(r.getX()),
                  Math.round(r.getY()),
                ...
                ((r = r.intersected(a)),
                  ...
                  this._panHelperCanvas.clearRect(
                    0,
                    0,
                    this._panHelperCanvas.getWidth(),
                    this._panHelperCanvas.getHeight(),
                  ),
                  this._panHelperCanvas.drawImageFragment(
                    this._elementCanvas,
                    o.getX(),
                    o.getY(),
                    o.getX(),
                  ...
                  this._elementCanvas.drawImageFragment(
                    this._panHelperCanvas,
                    o.getX(),
                    o.getY(),
                    r.getX(),
                    r.getY(),
                  ...
                  this._sceneCanvas.moveContent(o, r),
                  (this._scenePaintContext.dirtyMatcher = t));
                var s = this._scenePaintContext.noWebGL;
                this._scenePaintContext.configuration.noWebGL = !(
                  !b.getRenderParameters().quickRender &&
                  !b.getRenderParameters().noWebGL
                );
                var l = this,
                  h = this._panSubAreas.slice(),
                  A = this._lastInvalidatedVtoWtransform,
                  c = this._worldToViewTransform;
                (l._cumulativeInvalidationArea
                  ? (l._cumulativeInvalidationArea =
                      l._cumulativeInvalidationArea
                        .map(function (e) {
                ...
                (r || w.DRAW_DURING_RENDERING || w.SHOW_LOWRES_GIMMICK) &&
                  ...
                  r &&
                    ...
                    !o &&
                      ...
                      ((l._cumulativeInvalidationArea = null),
                      (l._finishPanRequestFrameId = null))));
              });
            } else this._finishPaint(e, !0, i, n, !0);
            this._panSubAreas && (this._panSubAreas = null);
          } finally {
            ((this._repaintRequestFrameId = null),
              (this._lastInvalidatedWtoVtransform = this._worldToViewTransform),
              (this._lastInvalidatedVtoWtransform =
                this._viewToWorldTransform));
          }
        }),
        ...
        (P.prototype._updateViewTransforms = function (e, t) {
          ((this._scrollX = Math.round(this._scrollX)),
            ...
            this._isPanning &&
              ...
              this._dirtySceneList.translate(
                -this._scrollDX,
                -this._scrollDY,
              )));
          var i =
