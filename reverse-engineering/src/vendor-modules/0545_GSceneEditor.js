...
function (e, t, i) {
      ...
      (r.inherit(b, s),
        ...
        (b.prototype._tBoxMode = b.TBoxMode.NA),
        (b.prototype._tBoxFlags = 0),
        (b.prototype._tBoxData = null),
        (b.prototype._mouseInfo = null),
        (b.prototype._paintChildren = function (e, t, i) {
          if (this._editors)
            for (var n = 0; n < this._editors.length; ++n) {
              ...
              if (!i || i(r))
                if (r instanceof l) {
                  var o = r
                      .getElement()
                      .getPosition(t.configuration.multiPageView),
                    a = e.preMultiplied(new g(1, 0, 0, 1, o.getX(), o.getY()));
                  this._editors[n].paint(a, t);
                } else this._editors[n].paint(e, t);
            }
        }),
        (b.prototype.paint = function (e, t) {
          if ((s.prototype.paint.call(this, e, t), this._transformBox)) {
            var i = e.getScaleFactor(),
              n = t.canvas.getOrigin();
            if (t.configuration.multiPageView) {
              this._getGraphicEditor().getIndividualSelection();
              var r,
                o = this._element.getActivePage();
              (r = o ? o.getPosition(!0) : null) &&
                t.canvas.setOrigin(n.subtract(r.scale(i)));
            }
            if (
              (this._transformBox.paint(
                e,
                t,
                this.getTBoxMode() == b.TBoxMode.ROTATE,
              ),
              t.configuration.multiPageView && r && t.canvas.setOrigin(n),
              this._visuals)
            ) {
              for (var a, l = 0; l < this._visuals.length; ++l) {
                var h = (a = this._visuals[l])[0],
                  c = a[1],
                  p = 0;
        ...
        (b.prototype.getBBox = function (e) {
          ...
          if (this._transformBox) {
            ...
            if (i && !i.isEmpty()) {
              var n = A.annotationHandles.tranformBox,
                r = d.getAnnotationPaintMargin(n.size);
              ((i = (i = e ? e.mapRect(i) : i).expanded(r, r, r, r)),
                (t = t ? t.united(i) : i));
            }
          }
          return t;
        ...
        (b.prototype.setTransformBoxActive = function (e, t, i) {
          if (e || null === e) {
            if (
              (r = this._getGraphicEditor().getSelectionEditor()) &&
              !r.hasFlag(u.Flag.HideEditor)
            )
              r.setFlag(u.Flag.HideEditor);
            else if (!r) {
              if ((o = this._getGraphicEditor().getIndividualSelection()))
                for (var n = 0; n < o.length; ++n) {
                  (a = s.openEditor(o[n])).hasFlag(u.Flag.Outline) ||
                    a.setFlag(u.Flag.Outline);
                }
            }
            (this._transformBox ||
              ...
              this._getGraphicEditor().addEventListener(
            ...
            if (
              (this._transformBox &&
                ...
                this._getGraphicEditor().removeEventListener(
                  f.SelectionChangedEvent,
                  this._selectionChanged,
                  this,
                ),
              ...
              if ((o = this._getGraphicEditor().getIndividualSelection()))
                for (n = 0; n < o.length; ++n) {
                  var a;
                  (a = s.getEditor(o[n])) &&
                    a.hasFlag(u.Flag.Outline) &&
                    a.removeFlag(u.Flag.Outline);
                }
            }
          }
        }),
        ...
        (b.prototype.requestInvalidation = function (e) {
          ...
          if (i && i.length) {
            ...
            !r ||
              (y.isEqualEps(r.getX(), 0) && y.isEqualEps(r.getY(), 0)) ||
              (t = new g(1, 0, 0, 1, r.getX(), r.getY()));
          }
          (t &&
            (e
              ? (e.pageTransform = t)
            ...
            this._getGraphicEditor().requestInvalidation(this, e));
        }),
        ...
        (b.prototype.hideTransformBox = function () {
          (this._transformBox && this._transformBox.hide(),
            this.requestInvalidation());
        }),
        (b.prototype.showTransformBox = function () {
          (this._transformBox && this._transformBox.show(),
            this.requestInvalidation());
        }),
        (b.prototype.getTransformBoxCenter = function () {
          return this._transformBox
            ? new h(this._transformBox.cx, this._transformBox.cy)
            : null;
        }),
        (b.prototype._applyTBoxCenterTransform = function () {
          if (
            ...
            try {
              ...
              this._getGraphicEditor().commitTransaction(
                _.get(new v("GEditor", "action.move")),
              );
            }
            this.requestInvalidation();
          }
        ...
        (b.prototype.updateTBoxUnderMouse = function (e, t, i) {
          ...
          (this._tBoxData
            ? ((n = new u.PartInfo(
              ...
              o.isRotating(n.id) &&
                (n.data.rotationSegment = a
                  ? this._transformBox.getRotationSegment(
                      e,
                      t.preMultiplied(new g(1, 0, 0, 1, a.getX(), a.getY())),
                    )
                  : this._transformBox.getRotationSegment(e, t)))
            : (n = this.getTBoxPartInfoAt(
                e,
                t,
                A.pickDistance,
                i.getViewConfiguration().multiPageView,
              )),
            (this._mouseInfo &&
              this._mouseInfo.id == n.id &&
              this._mouseInfo.data == n.data) ||
          ...
          if (
            c &&
            !c.isEmpty() &&
            (a && (c = c.translated(-a.getX(), -a.getY())),
            this._tBoxMode == b.TBoxMode.PASSIVE &&
              this._mouseInfo.id == o.INSIDE)
          ) {
            h = t.mapRect(c);
          ...
          return (
            (d = d ? i.getViewTransform().mapRect(d) : null),
            (this._visualsArea || d) &&
              (this.requestInvalidation(),
              (this._visualsArea = d),
              this.requestInvalidation()),
        ...
        (b.prototype.startTBoxTransform = function (e) {
          e &&
            (this._visualsArea &&
              (this.requestInvalidation(), (this._visualsArea = null)),
            (this._tBoxData = new u.PartInfo(e.editor, e.id, e.data)),
            o.isSkewing(this._tBoxData.id)
              ? this._updateTBoxMode(b.TBoxMode.SKEW)
              : o.isRotating(this._tBoxData.id)
                ? this._updateTBoxMode(b.TBoxMode.ROTATE)
                : this._tBoxData.id >= 0 &&
                    this._tBoxData.id < o.Handles.ROTATION_CENTER
                  ? this._updateTBoxMode(b.TBoxMode.RESIZE)
                  : this._tBoxData.id == o.Handles.ROTATION_CENTER
                    ? this._updateTBoxMode(b.TBoxMode.CNTRMOVE)
                    : this._updateTBoxMode(b.TBoxMode.TBOXMOVE),
            this.hideTransformBox());
        }),
        (b.prototype.transformTBox = function (e, t, i, n, r, o, a) {
          if (
            this._tBoxMode != b.TBoxMode.PASSIVE &&
            this._tBoxMode != b.TBoxMode.NA
          ) {
            ...
            var h = this._transformBox.calculateTransformation(
              this._tBoxData,
              i,
              e,
              t,
            ...
            if (
              ...
              (this._transformBox.setCenterTransform(h),
                this.requestInvalidation());
            return h;
          }
          return null;
