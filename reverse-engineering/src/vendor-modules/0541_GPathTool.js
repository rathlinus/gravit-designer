...
function (e, t, i) {
      ...
      (s.inherit(T, f),
        ...
        (T.prototype._pathRef = null),
        (T.prototype._dpathRef = null),
        (T.prototype._newPoint = null),
        (T.prototype._editPt = null),
        ...
        (T.prototype._transactionType = T.Transaction.NoTransaction),
        (T.Mode = {
          Append: 0,
          Prepend: 1,
          Edit: 2,
        }),
        (T.prototype._mode = T.Mode.Append),
        (T.prototype._mDownTime = 0),
        Object.defineProperty(T, "DBLCLICKTM", {
          get: function () {
        ...
        (T.prototype.activate = function (e, t) {
          (f.prototype.activate.call(this, e, t),
            t ||
              (e.addEventListener(p.Down, this._mouseDown, this),
        ...
        (T.prototype.deactivate = function (e, t) {
          (this._pathEditor &&
            ...
            this._editor &&
              ...
              t ||
                this._lightDeactivationHandled ||
            ...
            (this._lightDeactivationHandled = t));
        }),
        ...
        (T.prototype._checkPathEditor = function () {
          ...
          e &&
            ((this._pathEditor = c.openEditor(e)),
            this._pathEditor.setFlag(v.Flag.Detail),
            this._pathEditor instanceof g
          ...
          if ((this._checkPathEditor(), this._pathEditor))
            if (this._compoundPathEditor)
              ...
              if (
                ...
                e == l.PointsSelectionType.No ||
                e == l.PointsSelectionType.Several ||
                e == l.PointsSelectionType.Middle
                  ? (this._mode = T.Mode.Edit)
                  : e == l.PointsSelectionType.Last
                    ? (this._mode = T.Mode.Append)
                    : e == l.PointsSelectionType.First &&
              ...
              ((this._mode = T.Mode.Append),
                (this._pathRef =
                  ...
                  this._pathEditor =
                    null));
          else ((this._mode = T.Mode.Append), (this._pathRef = null));
        }),
        ...
        (T.prototype._addPoint = function (e, t, i, n) {
          if (this._pathEditor && !i) {
            ...
            if (r) {
              ...
              ((o = r.inverted().mapPoint(o)),
                e.setProperties(["x", "y"], [o.getX(), o.getY()]));
            }
          }
          t
            ? this._pathEditor
              ...
              ? (this._pathEditor.requestInvalidation(),
                this._mode == T.Mode.Append
                  ? (this._dpathRef &&
                      ...
                      (this._dpathRef = null),
                      e.hasFlag(a.Flag.Selected) &&
                        e.removeFlag(a.Flag.Selected)),
                    this._pathEditor.releasePathPreview(),
                    this._pathEditor.requestInvalidation(),
                    this._startTransaction(T.Transaction.AppendPoint),
                    this._pathRef.getAnchorPoints().appendChild(e),
                    this._pathEditor.selectOnePoint(e),
                    this._pathEditor.setActiveExtendingMode(
                      x.ExtendingMode.End,
                    ))
        ...
        (T.prototype._createAndAppendPath = function (e) {
          ...
          i !== r &&
            ((t = this._view.getViewTransform(r).mapPoint(n)),
            e.setProperties(["x", "y"], [t.getX(), t.getY()]));
        ...
        (T.prototype._reset = function () {
          if (
            (this._compoundPathEditor
              ? this._compoundPathEditor.removeFlag(v.Flag.Detail)
              : this._pathEditor && this._pathEditor.removeFlag(v.Flag.Detail),
            (this._dpathRef = null),
            (this._pathRef = null),
        ...
        (T.prototype._keyDown = function (e) {
          (f.prototype._keyDown.call(this, e),
            e.key === _.Constant.ESC
              ? ((this._lastMouseEvent = null), this._escAction())
              : e.key === _.Constant.ENTER &&
        ...
        (T.prototype._constrainIfNeeded = function (e, t, i, r) {
          ...
          if (n.modifiers.shiftKey) {
            ...
            (r
              ...
              : i &&
                (this._mode == T.Mode.Append
                  ? (a = i.getAnchorPoints().getLastChild())
                  : this._mode == T.Mode.Prepend &&
                    (a = i.getAnchorPoints().getFirstChild())),
              a && (o = this._pathEditor.constrainPosition(e, t, a)));
          }
          return o;
        }),
            ...
            switch (this._transactionType) {
              case T.Transaction.AppendPoint:
                this._editor.commitTransaction(
                  P.get(new S("GPathTool", "action.append-point")),
                );
                break;
              case T.Transaction.InsertElement:
                this._editor.commitTransaction(
                  P.get(new S("GPathTool", "action.insert-elements")),
                );
                break;
              case T.Transaction.InsertPoint:
                this._editor.commitTransaction(
                  P.get(new S("GPathTool", "action.insert-point")),
                );
                break;
              case T.Transaction.MovePoint:
                this._editor.commitTransaction(
                  P.get(new S("GPathTool", "action.move-point")),
                );
                break;
              case T.Transaction.DeletePoint:
                this._editor.commitTransaction(
                  P.get(new S("GPathTool", "action.delete-point")),
                );
                break;
              case T.Transaction.ModifyPointProperties:
                this._editor.commitTransaction(
                  P.get(new S("GPathTool", "action.modify-point-properties")),
                );
                break;
              case T.Transaction.ModifyPathProperties:
                this._editor.commitTransaction(
                  P.get(new S("GPathTool", "action.modify-path-properties")),
                );
                break;
              case T.Transaction.JoinPaths:
                this._editor.commitTransaction(
                  P.get(new S("GPathTool", "action.join-paths")),
                );
            }
          } finally {
            this._transactionType = T.Transaction.NoTransaction;
        ...
        (T.prototype._isSegmentMiddle = function (e) {
          return (
            e.data.type == l.SegmentData.HitRes &&
        ...
        (T.prototype._mouseDownOnEdit = function (e, t) {
          ...
          if (
            this._pathEditor &&
            this._pathEditor.getElement().getWorkspace()
          ) {
            (this._pathEditor.requestInvalidation(),
              this._pathEditor.releasePathPreview(),
              this._pathEditor.requestInvalidation());
            ...
            if (
              (r &&
                ((this._pathEditor = r.editor),
                (this._pathRef = this._pathEditor.getPath())),
              r && r.id.type == l.PartType.Point)
            ) {
              var o = r.id.point;
              this._pathRef.getProperty("closed") ||
              o !== this._pathRef.getAnchorPoints().getLastChild()
                ? this._pathRef.getProperty("closed") ||
                  o !== this._pathRef.getAnchorPoints().getFirstChild()
                  ? ((this._refPt = o),
                    ...
                    (null !== this._refPt.getProperty("hrx") &&
                      ...
                      ? this._setCursorForPosition(h.PenModify)
                      : this._setCursorForPosition(h.PenMinus))
                  : ((this._mode = T.Mode.Prepend), this._makePointMajor(o))
                : ((this._mode = T.Mode.Append), this._makePointMajor(o));
            } else if (
              r &&
              r.id.type == l.PartType.Segment &&
              r.data.type == l.SegmentData.HitRes
            ) {
              if (
              ...
              if (
                (this._isSegmentMiddle(r)
                  ? this._setCursorForPosition(h.PenPlusMiddle)
                  : this._setCursorForPosition(h.PenPlus),
                this._startTransaction(T.Transaction.InsertPoint),
                (o = this._pathRef.insertHitPoint(r.data.hitRes)))
              ) {
                if (e.button == p.BUTTON_RIGHT && n.modifiers.optionKey)
                  o.getProperty("tp") == A.AnchorPoint.Type.Asymmetric &&
                    o.setProperty("tp", A.AnchorPoint.Type.Connector);
                (t && t(o),
                  this._makePointMajor(o),
                  (this._refPt = o),
                  (this._editPt = this._pathEditor.getPathPointPreview(o)),
                  this._pathEditor.requestInvalidation(),
                  (this._mode = T.Mode.Edit));
              } else
                (this._finishTransaction(),
          ...
          this._refPt &&
            ...
            null != this._refPt.getProperty("hry")
              ...
              : (this._pathRef.getAnchorPoints().getFirstChild() !=
                  this._pathRef.getAnchorPoints().getLastChild() &&
                  (this._transactionType == T.Transaction.NoTransaction
                    ? this._startTransaction(T.Transaction.DeletePoint)
                    : (this._transactionType = T.Transaction.DeletePoint),
                  this._pathRef.getAnchorPoints().removeChild(this._refPt)),
                this._setCursorForPosition(null, e)),
            (this._refPt = null),
            this._commitChanges());
        }),
