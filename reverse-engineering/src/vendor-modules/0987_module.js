...
function (e, t, i) {
          ...
          interpolate: function (e, t, i, n) {
            ...
            if (!n || n === this)
              return (
                ...
                (l = t.x - t.xo),
                (h = i.x - i.xo),
                0 === (A = (a = Math.abs(r)) + (s = Math.abs(o)))
                  ? void (e.x = e.xo + (l + h) / 2)
                  : void (e.x = e.xo + (l * s + h * a) / A)
              );
            ((r = n.distance(e, t, !0, !0)),
              (o = n.distance(e, i, !0, !0)),
              (l = n.distance(t, t, !1, !0)),
              (h = n.distance(i, i, !1, !0)),
              0 !== (A = (a = Math.abs(r)) + (s = Math.abs(o)))
                ? u.setRelative(e, e, (l * s + h * a) / A, n, !0)
                : u.setRelative(e, e, (l + h) / 2, n, !0));
          },
          normalSlope: Number.NEGATIVE_INFINITY,
          setRelative: function (e, t, i, n, r) {
            if (n && n !== this) {
              if (0 === n.normalSlope) throw new Error("Wrong slope in axis x");
              var o = r ? t.xo : t.x,
                a = r ? t.yo : t.y,
                s = o + i * n.x,
                l = a + i * n.y;
              e.x = s + (e.y - l) / n.normalSlope;
            } else e.x = (r ? t.xo : t.x) + i;
          },
          slope: 0,
          touch: function (e) {
            e.xTouched = !0;
        ...
        d = {
          ...
          interpolate: function (e, t, i, n) {
            ...
            ((r = n.distance(e, t, !0, !0)),
              ...
              (h = n.distance(i, i, !1, !0)),
              0 !== (A = (a = Math.abs(r)) + (s = Math.abs(o)))
                ? d.setRelative(e, e, (l * s + h * a) / A, n, !0)
                : d.setRelative(e, e, (l + h) / 2, n, !0));
          },
          normalSlope: 0,
          setRelative: function (e, t, i, n, r) {
            if (n && n !== this) {
      ...
      function f(e, t) {
        ...
        return (
          (t /= i),
          1 === (e /= i) && 0 === t ? u : 0 === e && 1 === t ? d : new g(e, t)
        );
      }
      ...
      (Object.freeze(u),
        Object.freeze(d),
        (g.prototype.distance = function (e, t, i, n) {
          return (
            this.x * u.distance(e, t, i, n) + this.y * d.distance(e, t, i, n)
          );
        }),
        (g.prototype.interpolate = function (e, t, i, n) {
          var r, o, a, s, l, h, A;
          ((a = n.distance(e, t, !0, !0)),
            (s = n.distance(e, i, !0, !0)),
            (r = n.distance(t, t, !1, !0)),
            (o = n.distance(i, i, !1, !0)),
            0 !== (A = (l = Math.abs(a)) + (h = Math.abs(s)))
              ? this.setRelative(e, e, (r * h + o * l) / A, n, !0)
              : this.setRelative(e, e, (r + o) / 2, n, !0));
        }),
      ...
      function b(e, i, n, r) {
        var o,
          ...
          l = e.points || [],
          h = l.length,
          A = (i.gZone = i.z0 = i.z1 = i.z2 = []),
          c = (i.contours = []);
        for (p = 0; p < h; p++)
          ((o = l[p]),
            (A[p] = new m(o.x * n, o.y * r, o.lastPointOfContour, o.onCurve)));
        for (p = 0; p < h; p++)
          ((o = A[p]),
            a || ((a = o), c.push(p)),
            o.lastPointOfContour
              ? ((o.nextPointOnContour = a),
                (a.prevPointOnContour = o),
                (a = void 0))
              : ((s = A[p + 1]),
                (o.nextPointOnContour = s),
                (s.prevPointOnContour = o)));
        if (!i.inhibitGridFit) {
          if (t.DEBUG) {
            console.log("PROCESSING GLYPH", i.stack);
            for (var p = 0; p < h; p++) console.log(p, A[p].x, A[p].y);
          }
          if (
            (A.push(new m(0, 0), new m(Math.round(e.advanceWidth * n), 0)),
            C(i),
            (A.length -= 2),
            t.DEBUG)
          )
          ...
          for (e.ip = 0; e.ip < o; e.ip++) {
            if (t.DEBUG && (e.step++, e.gZone))
              for (var a = 0; a < e.gZone.length; a++) {
                var s = e.gZone[a];
                (!(isNaN(s.x) || isNaN(s.y) || isNaN(s.xo) || isNaN(s.yo)) &&
                  isFinite(s.x) &&
                  isFinite(s.y) &&
                  isFinite(s.yo) &&
                  isFinite(s.xo)) ||
            ...
            if (!(r = n[i[e.ip]]))
              throw new Error(
                "unknown instruction: 0x" + Number(i[e.ip]).toString(16),
              );
            r(e);
          }
        }
      ...
      function w(e) {
        for (
          var t = (e.tZone = new Array(e.gZone ? e.gZone.length : 0)), i = 0;
          i < t.length;
          i++
        )
          t[i] = new m(0, 0);
      ...
      function E(e, t) {
        ...
        do {
          ...
          else if (t && 1 === o && 27 === i) break;
        } while (o > 0);
        e.ip = r;
      }

      function B(e, i) {
        (t.DEBUG && console.log(i.step, "SVTCA[" + e.axis + "]"),
          (i.fv = i.pv = i.dpv = e));
      }

      function x(e, i) {
        (t.DEBUG && console.log(i.step, "SPVTCA[" + e.axis + "]"),
          (i.pv = i.dpv = e));
      }
      ...
      function S(e, i) {
        var n,
          ...
          l = i.z2[a],
          h = i.z1[s];
        (t.DEBUG && console.log("SPVTL[" + e + "]", a, s),
          e
            ? ((n = l.y - h.y), (r = h.x - l.x))
            : ((n = h.x - l.x), (r = h.y - l.y)),
          (i.pv = i.dpv = f(n, r)));
      ...
      function T(e, i) {
        var n,
          ...
          l = i.z2[a],
          h = i.z1[s];
        (t.DEBUG && console.log("SFVTL[" + e + "]", a, s),
          e
            ? ((n = l.y - h.y), (r = h.x - l.x))
            : ((n = h.x - l.x), (r = h.y - l.y)),
          (i.fv = f(n, r)));
      ...
      function F(e, i) {
        var n = i.stack.pop(),
          r = i.z0[n],
          o = i.fv,
          a = i.microsoftWorkaround ? i.dpv : i.pv;
        ...
        try {
          ...
          if (i.microsoftWorkaround) throw t;
          ((i.microsoftWorkaround = !0),
            (s = (a = i.dpv).distance(r, y)),
            e && (s = i.round(s)),
            o.setRelative(r, y, s, i.dpv));
        }
        ...
        for (var l = 0; l < s; l++)
          ((n = a[l]),
            e.touched(n) ||
              ((r = n.prevTouched(e)) !== n &&
                (r === (o = n.nextTouched(e)) &&
                  e.setRelative(n, n, e.distance(r, r, !1, !0), e, !0),
                e.interpolate(n, r, o, e))));
      }
      ...
      function D(e, i) {
        for (
          ...
          (a.setRelative(c, c, p, s),
            a.touch(c),
            t.DEBUG &&
              console.log(
                i.step,
                (i.loop > 1 ? "loop " + (i.loop - l) + ": " : "") +
                  "SHP[" +
                  (e ? "rp1" : "rp2") +
                  "]",
                A,
      ...
      function G(e, i) {
        ...
        for (
          var c = h.distance(s, s, !1, !0), p = n.length - 2, u = 0;
          u < p;
          u++
        )
      ...
      function Q(e, i) {
        var n = i.stack,
          ...
          l = i.fv,
          h = i.pv;
        (l.setRelative(a, s, r, h),
          l.touch(a),
          t.DEBUG && console.log(i.step, "MSIRP[" + e + "]", r, o),
          (i.rp1 = i.rp0),
          (i.rp2 = o),
          e && (i.rp0 = o));
      }
      ...
      function M(e, i) {
        ...
        (e && (Math.abs(A - h) < i.cvCutIn && (A = h), (A = i.round(A))),
          s.setRelative(a, y, A || h, l),
          0 === i.zp0 && ((a.xo = a.x), (a.yo = a.y)),
          s.touch(a),
          (i.rp0 = i.rp1 = o));
      }
      ...
      function N(e, i) {
        var n = i.stack,
          r = n.pop(),
          o = i.z2[r];
        (t.DEBUG && console.log(i.step, "GC[" + e + "]", r),
          n.push(64 * i.dpv.distance(o, y, e, !1)));
      }
      ...
      function U(e, i) {
        var n = i.stack,
          ...
          a = i.z1[r],
          s = i.z0[o],
          l = i.dpv.distance(s, a, e, e);
        (t.DEBUG && console.log(i.step, "MD[" + e + "]", r, o, "->", l),
          i.stack.push(Math.round(64 * l)));
      }
      ...
      function V(e, i) {
        ...
        for (var c = 0; c < r; c++) {
          ...
          if (l + ((240 & u) >> 4) === s) {
            var d = (15 & u) - 8;
            (d >= 0 && d++,
              t.DEBUG && console.log(i.step, "DELTAPFIX", p, "by", d * h));
            var g = A[p];
      ...
      function O(e, i) {
        var n = i.stack,
          r = n.pop();
        (t.DEBUG && console.log(i.step, "ROUND[]"),
          n.push(64 * i.round(r / 64)));
      }
      ...
      function L(e, i) {
        ...
        for (var l = 0; l < r; l++) {
          ...
          if (a + ((240 & A) >> 4) === o) {
            ...
            c >= 0 && c++;
            var p = c * s;
            (t.DEBUG && console.log(i.step, "DELTACFIX", h, "by", p),
              (i.cvt[h] += p));
          }
        }
      }
      ...
      function Y(e, i) {
        var n,
          ...
          l = i.z2[a],
          h = i.z1[s];
        (t.DEBUG && console.log(i.step, "SDPVTL[" + e + "]", a, s),
          e
            ? ((n = l.y - h.y), (r = h.x - l.x))
            : ((n = h.x - l.x), (r = h.y - l.y)),
          (i.dpv = f(n, r)));
      ...
      function W(e, i, n, r, o, a) {
        var s,
          ...
          y = a.fv,
          _ = a.dpv;
        ((h = (l = s = _.distance(f, g, !0, !0)) >= 0 ? 1 : -1),
          (l = Math.abs(l)),
          e && ((A = a.cvt[p]), r && Math.abs(l - A) < a.cvCutIn && (l = A)),
          n && l < m && (l = m),
          r && (l = a.round(l)),
          y.setRelative(f, g, h * l, _),
          y.touch(f),
          t.DEBUG &&
            console.log(
              a.step,
      ...
      ((o.prototype.exec = function (e, i) {
        ...
        if (!(this._errorState > 2)) {
          ...
          if (!r || r.ppem !== i) {
            ...
            if (!o) {
              ((v.prototype = _),
                ((o = this._fpgmState = new v("fpgm", n.tables.fpgm)).funcs =
                  []),
                (o.font = n),
                t.DEBUG && (console.log("---EXEC FPGM---"), (o.step = -1)));
              try {
                C(o);
              } catch (e) {
                return (
            ...
            ((v.prototype = o),
              ((r = this._prepState = new v("prep", n.tables.prep)).ppem = i));
            var a = n.tables.cvt;
            if (a)
              for (
                var s = (r.cvt = new Array(a.length)),
                  l = i / n.unitsPerEm,
                  h = 0;
                h < a.length;
                h++
              ...
              return (function (e, i) {
                ...
                if (((v.prototype = i), l)) {
                  ...
                  for (var A = 0; A < l.length; A++) {
                    var c = l[A],
                      p = h.glyphs.get(c.glyphIndex);
                    ((o = new v("glyf", p.instructions)),
                      t.DEBUG &&
                        (console.log("---EXEC COMP " + A + "---"),
                        (o.step = -1)),
                      b(p, o, a, s));
                    for (
                      var u = Math.round(c.dx * a),
                        d = Math.round(c.dy * s),
                        g = o.gZone,
                        f = o.contours,
                        y = 0;
                    ...
                    var w = r.length;
                    r.push.apply(r, g);
                    for (var E = 0; E < f.length; E++) n.push(f[E] + w);
                  }
                  e.instructions &&
                    !o.inhibitGridFit &&
                    (((o = new v("glyf", e.instructions)).gZone =
                      o.z0 =
                      o.z1 =
                      o.z2 =
                        r),
                    ...
                    r.push(
                      new m(0, 0),
                      new m(Math.round(e.advanceWidth * a), 0),
                    ),
                    t.DEBUG &&
                      (console.log("---EXEC COMPOSITE---"), (o.step = -1)),
                    C(o),
                    (r.length -= 2));
                } else
                  ((o = new v("glyf", e.instructions)),
                    t.DEBUG && (console.log("---EXEC GLYPH---"), (o.step = -1)),
                    b(e, o, a, s),
                    (r = o.gZone));
                return r;
              })(e, r);
        ...
        (n = [
          ...
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "SPVFS[]", n, r),
              (e.pv = e.dpv = f(r, n)));
          },
          function (e) {
            var i = e.stack,
          ...
          function (e) {
            var i = e.stack,
              n = e.pv;
            (t.DEBUG && console.log(e.step, "GPV[]"),
              i.push(16384 * n.x),
              i.push(16384 * n.y));
          },
          function (e) {
            var i = e.stack,
              n = e.fv;
            (t.DEBUG && console.log(e.step, "GFV[]"),
              i.push(16384 * n.x),
              i.push(16384 * n.y));
          },
          function (e) {
          ...
          function (e) {
            ((e.rp0 = e.stack.pop()),
              t.DEBUG && console.log(e.step, "SRP0[]", e.rp0));
          },
          function (e) {
            ((e.rp1 = e.stack.pop()),
              t.DEBUG && console.log(e.step, "SRP1[]", e.rp1));
          },
          function (e) {
            ((e.rp2 = e.stack.pop()),
              t.DEBUG && console.log(e.step, "SRP2[]", e.rp2));
          },
          function (e) {
            var i = e.stack.pop();
            switch (
              (t.DEBUG && console.log(e.step, "SZP0[]", i), (e.zp0 = i), i)
            ) {
              case 0:
          ...
          function (e) {
            var i = e.stack.pop();
            switch (
              (t.DEBUG && console.log(e.step, "SZP1[]", i), (e.zp1 = i), i)
            ) {
              case 0:
          ...
          function (e) {
            var i = e.stack.pop();
            switch (
              (t.DEBUG && console.log(e.step, "SZP2[]", i), (e.zp2 = i), i)
            ) {
              case 0:
          ...
          function (e) {
            var i = e.stack.pop();
            switch (
              (t.DEBUG && console.log(e.step, "SZPS[]", i),
              (e.zp0 = e.zp1 = e.zp2 = i),
              i)
            ) {
              case 0:
          ...
          function (e) {
            ((e.loop = e.stack.pop()),
              t.DEBUG && console.log(e.step, "SLOOP[]", e.loop));
          },
          function (e) {
          ...
          function (e) {
            var i = e.stack.pop();
            (t.DEBUG && console.log(e.step, "SCVTCI[]", i),
              (e.cvCutIn = i / 64));
          },
          void 0,
          void 0,
          ...
          function (e) {
            var i = e.stack,
              n = i.pop();
            (t.DEBUG && console.log(e.step, "CINDEX[]", n),
              i.push(i[i.length - n]));
          },
          function (e) {
            var i = e.stack,
              n = i.pop();
            (t.DEBUG && console.log(e.step, "MINDEX[]", n),
              i.push(i.splice(i.length - n, 1)[0]));
          },
          void 0,
          void 0,
          void 0,
            ...
            for (var s = 0; s < r; s++)
              (C(e),
                t.DEBUG &&
                  console.log(
                    ++e.step,
                    s + 1 < r ? "next loopcall" : "done loopcall",
                    s,
                  ));
            ((e.ip = o), (e.prog = a));
          },
          function (e) {
            ...
            ((e.prog = e.funcs[i]),
              ...
              (e.ip = n),
              (e.prog = r),
              t.DEBUG && console.log(++e.step, "returning from", i));
          },
          function (e) {
          ...
          function (e) {
            for (
              var i = e.stack, n = e.loop, r = e.fv, o = i.pop() / 64, a = e.z2;
              n--;
            ) {
              var s = i.pop(),
                l = a[s];
          ...
          function (e) {
            for (
              var i = e.stack,
                ...
                o = e.loop,
                a = e.fv,
                s = e.microsoftWorkaround ? e.dpv : e.pv,
                l = e.z1;
              o--;
            ) {
              var h = i.pop(),
              ...
              try {
                ...
                if (e.microsoftWorkaround) throw t;
                ((e.microsoftWorkaround = !0),
                  (s = e.dpv),
                  a.setRelative(A, r, 0, s));
              }
              a.touch(A);
          ...
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "WCVTP", n, r),
              (e.cvt[r] = n / 64));
          },
          function (e) {
            var i = e.stack,
          ...
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "LT[]", n, r),
              i.push(r < n ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "LTEQ[]", n, r),
              i.push(r <= n ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "GT[]", n, r),
              i.push(r > n ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "GTEQ[]", n, r),
              i.push(r >= n ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "EQ[]", n, r),
              i.push(n === r ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "NEQ[]", n, r),
              i.push(n !== r ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
              n = i.pop();
            (t.DEBUG && console.log(e.step, "ODD[]", n),
              i.push(Math.trunc(n) % 2 ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
              n = i.pop();
            (t.DEBUG && console.log(e.step, "EVEN[]", n),
              i.push(Math.trunc(n) % 2 ? 0 : 1));
          },
          function (e) {
            var i = e.stack.pop();
            (t.DEBUG && console.log(e.step, "IF[]", i),
              i || (E(e, !0), t.DEBUG && console.log(e.step, "EIF[]")));
          },
          function (e) {
          ...
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "AND[]", n, r),
              i.push(n && r ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "OR[]", n, r),
              i.push(n || r ? 1 : 0));
          },
          function (e) {
            var i = e.stack,
          ...
          function (e) {
            var i = e.stack.pop();
            (t.DEBUG && console.log(e.step, "SDS[]", i),
              (e.deltaShift = Math.pow(0.5, i)));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
          ...
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "DIV[]", n, r),
              i.push((64 * r) / n));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "MUL[]", n, r),
              i.push((r * n) / 64));
          },
          function (e) {
            var i = e.stack,
          ...
          function (e) {
            var i = e.stack,
              n = i.pop();
            (t.DEBUG && console.log(e.step, "FLOOR[]", n),
              i.push(64 * Math.floor(n / 64)));
          },
          function (e) {
            var i = e.stack,
              n = i.pop();
            (t.DEBUG && console.log(e.step, "CEILING[]", n),
              i.push(64 * Math.ceil(n / 64)));
          },
          O.bind(void 0, 0),
          O.bind(void 0, 1),
          O.bind(void 0, 2),
          ...
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "WCVTF[]", n, r),
          ...
          function (e) {
            var i,
              n = e.stack.pop();
            switch (
              (t.DEBUG && console.log(e.step, "SROUND[]", n),
              (e.round = p),
              192 & n)
            ) {
              case 0:
          ...
          function (e) {
            var i,
              n = e.stack.pop();
            switch (
              (t.DEBUG && console.log(e.step, "S45ROUND[]", n),
              (e.round = p),
              192 & n)
            ) {
              case 0:
          ...
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = 0;
            (t.DEBUG && console.log(e.step, "GETINFO[]", n),
              1 & n && (r = 35),
              32 & n && (r |= 4096),
              i.push(r));
          },
          ...
          function (e) {
            var i = e.stack,
              ...
              r = i.pop(),
              o = i.pop();
            (t.DEBUG && console.log(e.step, "ROLL[]"),
              i.push(r),
              i.push(n),
              i.push(o));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "MAX[]", n, r),
              i.push(Math.max(r, n)));
          },
          function (e) {
            var i = e.stack,
              n = i.pop(),
              r = i.pop();
            (t.DEBUG && console.log(e.step, "MIN[]", n, r),
              i.push(Math.min(r, n)));
          },
          function (e) {
            var i = e.stack.pop();
