...
function (e, t, i) {
      ...
      function D(e) {
        ...
        var h,
          ...
          O = s.getTag(n, 0);
        if (
          O === String.fromCharCode(0, 1, 0, 0) ||
          "true" === O ||
          "typ1" === O
        )
          ((l.outlinesFormat = "truetype"),
            (V = I(n, (a = s.getUShort(n, 4)))));
        else if ("OTTO" === O)
        ...
        for (var Y = 0; Y < a; Y += 1) {
          ...
          switch (H.tag) {
            case "cmap":
              ((X = R(n, H)),
                (l.tables.cmap = c.parse(X.data, X.offset)),
                (l.encoding = new r.CmapEncoding(l.tables.cmap)));
              break;
            case "cvt ":
              ((X = R(n, H)),
                (U = new s.Parser(X.data, X.offset)),
                (l.tables.cvt = U.parseShortList(H.length / 2)));
              break;
            case "fvar":
              A = H;
              break;
            case "fpgm":
              ((X = R(n, H)),
                (U = new s.Parser(X.data, X.offset)),
                (l.tables.fpgm = U.parseByteList(H.length)));
              break;
            case "head":
              ((X = R(n, H)),
            ...
            case "maxp":
              ((X = R(n, H)),
                (l.tables.maxp = w.parse(X.data, X.offset)),
            ...
            case "post":
              ((X = R(n, H)),
                (l.tables.post = x.parse(X.data, X.offset)),
                (l.glyphNames = new r.GlyphNames(l.tables.post)));
              break;
            case "prep":
              ((X = R(n, H)),
                (U = new s.Parser(X.data, X.offset)),
                (l.tables.prep = U.parseByteList(H.length)));
              break;
            case "glyf":
              S = H;
              break;
        ...
        var W = R(n, M);
        if (
          ((l.tables.name = E.parse(W.data, W.offset, i)),
          (l.names = l.tables.name),
          S && Q)
        ) {
          var Z = 0 === t,
            z = R(n, Q),
        ...
        var K = R(n, k);
        if (
          (_.parse(K.data, K.offset, l.numberOfHMetrics, l.numGlyphs, l.glyphs),
          r.addGlyphNames(l),
          G)
        ) {
          var $ = R(n, G);
        ...
        if (N) {
          var ne = R(n, N);
          ((l.tables.meta = P.parse(ne.data, ne.offset)),
            (l.metas = l.tables.meta));
        }
        return l;
      }
      ((t._parse = s),
        ...
        (t.Glyph = a.Glyph),
        (t.Path = h.Path),
        (t.BoundingBox = l.BoundingBox),
        (t.parse = D),
        (t.parseTableEntries = function (e) {
          ...
          if ("OTTO" === i) return I(t, s.getUShort(t, 4));
          if ("wOFF" === i) {
            var n = s.getTag(t, 4);
