...
function (e, t, i) {
      ...
      function f(e) {
        var t = {};
        for (var i in e) t[e[i]] = parseInt(i);
        return t;
      }
      ...
      function y(e, t) {
        var i = (function (e, t) {
          ...
          e: for (var r = 0; r < n; r++)
            for (; r < n; r++) {
              for (var o = 0; o < i; o++) if (t[r + o] !== e[o]) continue e;
              return r;
            }
          return -1;
        })(e, t);
      ...
      ((t.parse = function (e, t, i) {
        for (
          ...
          var u,
            ...
            C = p(d, m, i),
            w = g(d, f, m);
          if (void 0 !== w && void 0 !== C)
            if (
              (u =
                "utf-16" === w
                  ? r.UTF16(e, A + b, v)
                  : r.MACSTRING(e, A + b, v, w))
            ) {
              var E = n[_];
              (void 0 === E && (E = n[_] = {}), (E[C] = u));
            }
        }
        ...
        (t.make = function (e, t) {
          ...
          for (var p in e) {
            var u = a[p];
            if ((void 0 === u && (u = p), (i = parseInt(u)), isNaN(i)))
              throw new Error(
                'Name table entry "' +
                  p +
          ...
          for (
            ...
            for (var E in w) {
              ...
              void 0 === I &&
                ((x = 0),
                (P = t.indexOf(E)) < 0 && ((P = t.length), t.push(E)),
                (S = 4),
                (I = o.UTF16(B)));
              var F = y(I, b);
