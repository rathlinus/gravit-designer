...
function (e, t, i) {
      ...
      ((p.Mode = {
        ...
        (p.prototype.add = function (e) {
          ...
          t
            ? t.origin.mapPoint(new s(0, 0)).getY() !==
                e.origin.mapPoint(new s(0, 0)).getY() &&
          ...
          r.each(
            ...
            function (t, i) {
              (new a(i.origin).write(e),
                e.writeln(),
                (this.font && this.font.equals(i.fontReference)) ||
                  i.fontReference.write(e),
                i.strokeColor &&
                  ((this.strokeColor &&
                    this.strokeColor.equals(i.strokeColor)) ||
                    (i.strokeColor.write(e), e.writeln())),
                i.fillColor &&
                  ((this.fillColor && this.fillColor.equals(i.fillColor)) ||
                    (i.fillColor.write(e), e.writeln())),
                this.charSpacing !== i.charSpacing &&
                  (e.write(l.normalizeNumber(i.charSpacing)),
                  e.writeSpace(),
                  e.writeln("Tc")),
                this.mode !== i.mode &&
                  (e.write(i.mode),
                  e.writeSpace(),
                  e.writeln("Tr"),
                  i.mode >= p.Mode.STROKE &&
                    (e.write(l.normalizeNumber(i.lineWidth)),
                    e.writeSpace(),
                    e.writeln("w"))),
