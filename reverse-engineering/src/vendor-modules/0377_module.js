...
function (e, t, i) {
      ...
      ((o.BYTE = function (e) {
        ...
        (o.CHARARRAY = function (e) {
          for (var t = [], i = 0; i < e.length; i += 1) t[i] = e.charCodeAt(i);
          return t;
        }),
        ...
        (o.REAL = function (e) {
          var t = e.toString(),
            i = /\.(\d*?)(?:9{5,20}|0{5,20})\d{0,2}(?:e(.+)|$)/.exec(t);
          if (i) {
          ...
          var l = [30];
          for (
            r = 0, o = (a += 1 & a.length ? "f" : "ff").length;
            r < o;
            r += 2
          )
      ...
      function u(e, t, i) {
        for (var n = 0, r = e.length, o = t; o < r && n < 64; ) {
          var a = e[o];
          if (!c(a)) break;
          if (0 === a && o + 1 < r && 0 === e[o + 1]) break;
          (++o, ++n);
        }
        i.push(n - 1);
        for (var s = t; s < o; ++s) i.push((e[s] + 256) & 255);
        return o;
      }
      ...
      ((o.MACSTRING = function (e, t) {
        var i = (function (e) {
          if (!h) for (var t in ((h = {}), l)) h[t] = new String(t);
          var i = h[e];
          if (void 0 !== i) {
            if (A) {
              var n = A.get(i);
        ...
        (o.INDEX = function (e) {
          ...
          var s = [],
            ...
            h = [void 0, o.BYTE, o.USHORT, o.UINT24, o.ULONG][l];
        ...
        (o.DICT = function (e) {
          for (
            var t = [], i = Object.keys(e), n = i.length, r = 0;
            r < n;
            r += 1
          ) {
            var a = parseInt(i[r], 0),
              s = e[a];
            t = (t = t.concat(o.OPERAND(s.value, s.type))).concat(
              o.OPERATOR(a),
            );
          }
          return t;
          ...
          if (Array.isArray(t))
            for (var r = 0; r < t.length; r += 1)
              (n.argument(
                ...
                (i = i.concat(o.OPERAND(e[r], t[r]))));
          else if ("SID" === t) i = i.concat(o.NUMBER(e));
          else if ("offset" === t) i = i.concat(o.NUMBER32(e));
          else if ("number" === t) i = i.concat(o.NUMBER(e));
          else {
      ...
      ((o.CHARSTRING = function (e) {
        ...
        (o.OBJECT = function (e) {
          var t = o[e.type];
          return (
            n.argument(void 0 !== t, "No encoding function for type " + e.type),
            t(e.value)
          );
        }),
        (a.OBJECT = function (e) {
          var t = a[e.type];
          return (
            n.argument(void 0 !== t, "No sizeOf function for type " + e.type),
            t(e.value)
          );
        }),
        (o.TABLE = function (e) {
          ...
          for (t = 0; t < r; t += 1) {
            ...
            var c = h(A);
            "TABLE" === l.type
              ? (s.push(i.length), (i = i.concat([0, 0])), a.push(c))
              : (i = i.concat(c));
          }
          for (t = 0; t < a.length; t += 1) {
            var p = s[t],
              u = i.length;
            (n.argument(u < 65536, "Table " + e.tableName + " too big."),
              (i[p] = u >> 8),
              (i[p + 1] = 255 & u),
              (i = i.concat(a[t])));
          }
