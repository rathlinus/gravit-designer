...
function (e, t, i) {
      ...
      function r(e) {
        n.call(
          ...
          "        uniform highp sampler2D texture;        uniform vec2 center;        uniform float strength;        uniform vec2 texSize;        varying highp vec2 texCoord;        uniform vec2 tileSize;        uniform vec2 offset;        " +
            n.randomShaderFunc +
            "        " +
            n.TOLOCAL +
