      ...
      (i(387),
        ...
        (B.prototype.deactivate = function (e, t) {
          (o.prototype.deactivate.call(this, e, t),
            this._pathUnderMouse &&
              (this._pathUnderMouse.removeFlag(r.Flag.Highlighted),
              (this._pathUnderMouse = null)));
        }),
        (B.prototype.getCursor = function () {
          return this._textUnderMouse
            ? A.Text
            : this._shape
              ? o.prototype.getCursor.call(this)
              : A.Cross;
        }),
          ...
          if ((t.getGuides().invalidate(), this._textUnderMouse))
            (this._manager.activateTool(_),
              this._textUnderMouse.hasFlag(r.Flag.Selected) ||
                ...
                _.prototype._mouseRelease.call(
                  this._manager.getActiveTool(),
                  e,
                )),
        ...
        (B.prototype._mouseMove = function (e) {
          if (
            (this._textUnderMouse &&
              ((this._textUnderMouse = null), this.updateCursor()),
            this._pathUnderMouse &&
              (this._pathUnderMouse.removeFlag(r.Flag.Highlighted),
              (this._pathUnderMouse = null)),
            !this._shape)
        ...
        (B.prototype._updateShape = function (e, t, i, n) {
          return (
            ...
            (n
              ? e.setProperty(
                  "trf",
                  new m(t.getWidth(), 0, 0, t.getHeight(), t.getX(), t.getY()),
                )
              : e.setProperty(
                  "trf",
                  new m(
        ...
        (B.prototype._insertShape = function (e, t) {
          ...
          if (t)
            e &&
              ((this._fakeShape = e),
              o.prototype._insertShape.call(this, e, !1, !0));
          else {
            if (this._fakeShape) {
        ...
        (B.prototype._createShapeManually = function (e) {
          ...
          (t.transformSourceBBox(i),
            t.setText(b.get(new C("GTextTool", "your-text-here")), 1, 1));
          try {
            if (
              (this._editor.beginTransaction(),
              this._insertText(t, !0),
              this._pathUnderMouse)
            ) {
              var r = null;
              if (this._pathUnderMouse instanceof y) r = this._pathUnderMouse;
              else if (
                (r = n.createPathFromVertexSource(
                  this._pathUnderMouse,
                )) instanceof s
              ) {
                ...
                ((o.$trf = null),
                  r.assignFrom(o),
                  o instanceof y &&
                    ((r.$evenodd = o.getProperty("evenodd")),
                    (r.$closed = o.getProperty("closed"))),
                  (o.$trf = a));
                var l = o.getParent(),
                  h = o.getNext(!0);
              ...
              if (r) {
                ...
                var u = this._view
                  ...
                  f = m
                    .getNativeRectTransformation(r.getGeometryBBox())
                    .getTranslation(),
