      ...
      (m.inheritAndMix(pe, R, [T, ce]),
        ...
        (pe._AreaSelector.prototype.paint = function (e) {
          ...
          if (t && (t.getWidth() || t.getHeight())) {
            ...
            ((n = n > 0 ? Math.ceil(n) - 1 : 0),
              (t = new a(
                Math.floor(t.getX()) + 0.5,
                Math.floor(t.getY()) + 0.5,
                n,
                i,
              )),
            ...
            switch (((this._editMode = e), this._editMode)) {
              case pe.EditMode.Edit:
                (this._editor.setSelectionDetail(!0),
                  this._editor.setPathResize(!1),
                  this._editor.setSelectionEdit(!0));
                break;
              case pe.EditMode.Transform:
                (this._openTransformBox(),
                  this._editor.setFullContentTransform(!0));
            }
        ...
        (pe.prototype.getCursor = function () {
          ...
          if (this._editorUnderMouseInfo) {
            var e = this._editorUnderMouseInfo.editor.getCursor(
        ...
        (pe.prototype._selectionChanged = function () {
          if (this._mode == pe._Mode.Transforming) {
            ...
            e && e.length
              ? this.setEditMode(pe.EditMode.Transform, !0)
              : this.setEditMode(pe.EditMode.Select);
          }
        }),
            ...
            if (h && h.isTransformBoxActive())
              (this._mode != pe._Mode.Transforming &&
                ...
                (this._editorMovePartInfo.id !== I.OUTSIDE &&
                  ...
                  ? this._editorMovePartInfo.id === I.FAR_OUTSIDE &&
                    this.setEditMode(pe.EditMode.Select)
                  : (this._updateMode(pe._Mode.MoveGuideLine),
                  ...
                  if (l || (!f.isPartSelected(m) && y)) {
                    ...
                    if (d.data && d.data.ownerEditor)
                      (l &&
                        y &&
                        f.isPartSelected(m) &&
                        (_ = d.data.ownerEditor.getOwnedPartsSelectionLength()),
                        ((y && 1 !== _) || (!y && l)) &&
                          d.data.ownerEditor.updateOwnedPartsSelection(l, [d]));
                    else if (
                      (l &&
                        y &&
                        f.isPartSelected(m) &&
                        (_ = f.getPartsSelectionLength()),
                      (y && 1 !== _) || (!y && l))
                    ) {
                      ...
                      (v &&
                        ...
                        (y =
                          ...
                          (e.button === s.BUTTON_RIGHT &&
                            ...
                            d.data.rightButton &&
                            d.data.rightButton.selectable))),
                        !this._editor.hasEventListeners(
                          Q.SelectionChangedEvent,
                        ) ||
        ...
        (pe.prototype._getSelectableForPosition = function (e, t, i) {
          ...
          var o,
            ...
            l = function (e) {
              return (
                !(e instanceof G || e instanceof p) && this._selectAcceptor(e)
              );
            }.bind(this),
            c = function (t) {
            ...
            if (this._clickGoDown) {
              ...
              if (_.hasFlag(n.Flag.Selected)) u = _;
                  ...
                  for (
                    ...
                    if (b.hasFlag(n.Flag.Selected)) u = _;
                      ...
                      !b.acceptChildren(
                        function (e) {
                          return !(
                            e instanceof h && e.hasFlag(n.Flag.Selected)
                          );
                        },
                        !1,
                        !1,
                ...
                for (b = _.getParent(); null != b && !u; b = b.getParent()) {
                  if (
                    (b.hasFlag(n.Flag.Selected) &&
                      ((i || t) && b instanceof h && (u = b),
                      t || i || (u = _)),
                    !u)
                  )
                    (!b.acceptChildren(
              ...
              ((r && r.length) ||
                (r = this._scene.hitTest(
                  ...
                  this._view
                    ...
                    .isElementAnnotationsVisible(),
                )),
              r)
            ) {
              for (var o = [], a = 0; a < r.length; ++a) {
                var s = null;
                (s = C.pageCollisionTransform
                  ? r[a].element
                  : r[a].element || r[a]).hasFlag(n.Flag.Selected) &&
        ...
        (pe.prototype._mouseRelease = function (e) {
          function t() {
              ...
              if (this._clickedElement) {
                if (
                  ...
                  (g.modifiers.shiftKey &&
                    ...
                    this._editor.getCurrentInlineEditorNode() &&
                    (i = !1),
                    this._updateSelectionWithElement(
                      i,
                      this._clickedElement,
                      !1,
                    ),
            ...
            if (
              ...
              try {
                ...
                this._editor.commitTransaction(
                  ae.get(new se("GSelectTool", "action.insert-path-point")),
                );
              }
              a &&
                (!g.modifiers.shiftKey &&
            ...
            ((this._editorMovePartInfo = null),
              ...
              this._mode != pe._Mode.Transforming &&
                (this._updateMode(null), this.updateCursor()),
              this._updateEditorUnderMouse(e.client),
              this._isDistanceHelperActivatedByClick() &&
                this._editor.getSelection() &&
                this._editor.getSelection().length &&
        ...
        (pe.prototype._updateSelectionWithElement = function (e, t, i) {
          var r;
          if (
            (t.hasFlag(n.Flag.Selected) || this.setEditMode(pe.EditMode.Select),
            e)
          ) {
            ((t.hasMixin(n.Container) ? t.getInternalSelectedNodes() : null) &&
              this._editor.clearInternalSelection(t),
              (r = []),
        ...
        (pe.prototype._mouseDragStart = function (e) {
          if (
            ...
            (this._mode != pe._Mode.Select &&
              ...
              this._mode != pe._Mode.Transforming) ||
              (this._editorMovePartInfo &&
                this._editorMovePartInfo.editor instanceof x) ||
              this.beginPan(),
            this._allowDistanceHelper &&
              this._editor.getDistanceHelper().isActivated() &&
              this._editor.getDistanceHelper().deactivateMeasurement(),
            ...
            if (this._releaseOnlySelection) {
              ...
              if ((o = this._editor.getSelection()) && o.length)
                for (var i = 0; i < o.length && !t; ++i) {
                  var r = o[i];
                  (r instanceof w || r instanceof E || r instanceof B) &&
                    (t = !0);
                }
              !this._clickedElement ||
          ...
          if (this._mode == pe._Mode.Move) {
            ...
            if (
              ...
              if (
                ...
                if (
                  (this._editorMovePartInfo.isolated &&
                    e.button === s.BUTTON_LEFT) ||
                  (e.button === s.BUTTON_RIGHT &&
                    this._editorMovePartInfo.data &&
                  ...
                  this._editorMovePartInfo =
                    this._editorMovePartInfo.editor.selectToolDragStartAction(
                      this._editorMovePartInfo,
                      e.button == s.BUTTON_RIGHT,
                    );
                  ...
                  for (i = 0; i < o.length; ++i) {
                    ...
                    if (a) {
                      var l = a.selectToolDragStartAction(
                        this._editorMovePartInfo,
                        e.button == s.BUTTON_RIGHT,
                      );
                      if (l) {
            ...
            h &&
              h.isTransformBoxActive() &&
              h.startTBoxTransform(this._editorMovePartInfo);
          } else
            this._mode === pe._Mode.MoveGuideLine &&
              this._view.startMoveGuideLine(
                this._guideLineUnderMouse.isVertical,
                this._guideLineUnderMouse.guideIndex,
              );
        }),
        (pe.prototype._mouseDrag = function (e) {
          if (
            ...
            if (this._areaSelector.hasSelectArea()) {
              ...
              (this.isPanning() &&
                (t = this._calculateInvalidationPanAreaForRect(t)),
                this.invalidateArea(t));
            ...
            if (this._mode == pe._Mode.Moving) {
              ...
              try {
                ...
                var a = !(
                    ...
                    !this._itemsToAddToImageMask.length
                  ),
                  l = !(
                ...
                if (
                  ...
                  if (
                    ...
                    if (p && p.length)
                      for (var u = 0; u < p.length; ++u) {
                        var d = p[u];
                        c = c.concat(
                          this._editor.getLinkedElementsInSelection(d, p),
                        );
                      }
                  }
                  ...
                  var f =
                    this._editorMovePartInfo.editor.getObjectNameModified();
                  (f || (f = ae.get(new se("GSelectTool", "text.element"))),
                    (i = ae
                      .get(new se("GSelectTool", "action.modify-element"))
                      .replace("%element", f)));
                } else
                  (this._editor.applySelectionTransform(
                    ...
                    (i = h
                      ? ae.get(
                          new se(
                            "GSelectTool",
                            "action.transform-clone-selection",
                          ),
                        )
                      : ae.get(
                          new se("GSelectTool", "action.transform-selection"),
                        )));
                if (a) {
                  ...
                  (this._editor.updateSelection(!1, y),
                    (i = "Create image mask"),
                    (this._itemsToAddToImageMask = null));
                } else if (l) {
                    ...
                    (E.forEach(
                      function (e) {
                        ...
                        if (b.getScene() && n !== b)
                          if (
                            (w &&
                              ((t = this._scene.getIndexOfChild(e)),
                              (i = this._scene.getIndexOfChild(b))),
                            w)
                          )
                            ...
                            if (e instanceof A && b instanceof A)
                              return void console.warn(
                                "tried to insert page into page, aborting",
                              );
                ...
                (this.updateInlineHint(null),
                  this._editor.commitTransaction(i, r));
              }
              ...
              if (
                ...
                (this._isDistanceHelperActivatedByClick() ||
                  this._processElementsUnderCollision(!1),
                  (this._selectionDone = !0));
              ...
              (x &&
                x.isTransformBoxActive() &&
                (x.applyTBoxTransform(), this.invalidateArea()),
                this.updateInlineHint(null));
            } else
              this._mode === pe._Mode.MoveGuideLine &&
                this._view.finishMoveGuideLine();
            t && t();
          }
          ((this._lastMouseEvent = e),
        ...
        (pe.prototype._processElementsUnderCollision = function (e) {
          var t,
            i = this._areaSelector.getCollisionArea(
              this._view.getViewTransform(this._view.getScene()),
            ),
        ...
        (pe.prototype._getCollisionFlags = function () {
          ...
          return (
            ((!g.modifiers.optionKey && !C.invertSelectionMode) ||
              (g.modifiers.optionKey && C.invertSelectionMode)) &&
        ...
        (pe.prototype._mouseDblClick = function (e) {
          this._lastMouseEvent = e;
          var t =
            null != this._mDownTime1 &&
            null != this._mDownTime2 &&
            this._mDownTime2 - this._mDownTime1 > pe.DBLCLICKTM;
          ...
          if (
            (this._clickedElement &&
              (i = this._editor.openInlineEditor(
                this._clickedElement,
                this._view,
                e.client,
              )),
            ...
            this._editorUnderMouseInfo.editor.hasFlag(u.Flag.Selected)
          ) {
            if (this._editorUnderMouseInfo.editor.canHandleDblClick()) {
              ...
              try {
                ...
                ((r =
                  this._editorUnderMouseInfo.editor.getObjectNameModified()) ||
        ...
        (pe.prototype.catchesContextMenu = function (e) {
          return (
            ...
            (this._editorUnderMouseInfo &&
              this._editorUnderMouseInfo.id != W.IMAGEINTERNAL_PART_ID)
          );
        }),
        ...
        (pe.prototype._handleInlineEditingStart = function () {
          for (
            var e = this._clickedElement.getParent(),
              t = this._editor.getSelection(),
              i = [this._clickedElement];
            e && t;
          ) {
        ...
        (pe.prototype._keyDown = function (e) {
          if (
            (R.prototype._keyDown.call(this, e),
            !this._editor.getCurrentInlineEditorNode())
          ) {
            if (
              (e.key !== S.Constant.X ||
                g.modifiers.metaKey ||
                this._disableBackgroundSelect(),
              e.key === S.Constant.UP ||
                e.key === S.Constant.DOWN ||
                e.key === S.Constant.LEFT ||
                e.key === S.Constant.RIGHT)
            ) {
              if (g.modifiers.spaceKey) return;
              if (
                this._editor.hasSelection() &&
                (!this._mode || this._mode === pe._Mode.Moving)
              ) {
                this._mode !== pe._Mode.Moving &&
                  this._updateMode(pe._Mode.Moving);
                var t = g.modifiers.shiftKey
                    ? C.cursorDistanceBig
                    : C.cursorDistanceSmall,
                  i = 0,
                  n = 0;
                switch (e.key) {
                  case S.Constant.UP:
                    g.modifiers.plusKey || g.modifiers.minusKey
                      ? (this._editorMovePartInfo ||
                          (this._editorMovePartInfo = new u.PartInfo(
                            this._editor,
                            H.RESIZE_HANDLE_PART_ID,
                            {
              ...
              if (r && r.length) {
                for (var o = !1, s = 0; s < r.length && !o; ++s) {
                  ...
                  h &&
                    ...
                    (e.preventDefault(),
                    e.stopPropagation(),
                    (o = this._editor.openInlineEditor(r[s], this._view)));
                }
          ...
          if (
            ...
            if (e.changed.escapeKey && g.modifiers.escapeKey) {
              ...
              (e.changed.shiftKey || e.changed.optionKey) &&
                ...
                this._areaSelector.hasSelectArea() &&
                (this._processElementsUnderCollision(!0),
                this.invalidateArea(this._areaSelector.getAreaPaintRect()));
          else
            (e.changed.shiftKey &&
              g.modifiers.shiftKey &&
        ...
        (pe.prototype._updateSelection = function (e, t) {
          (this.setEditMode(pe.EditMode.Select),
            this._editor.updateSelection(e, t),
            (this._elementMeasurementsToggle = !1));
        }),
        ...
        (pe.prototype._applyKeyTransformation = function () {
          this._keyDelta &&
            (this._editorMovePartInfo &&
            this._editorMovePartInfo.id === H.RESIZE_HANDLE_PART_ID
              ? (this._editor.applyResizeSelection(
                  this._editorMovePartInfo.id,
                  this._editorMovePartInfo.data,
                ),
                (this._editorMovePartInfo = null))
          ...
          if (this._mode == pe._Mode.Moving) {
            ...
            if (this._editorMovePartInfo && this._editorMovePartInfo.isolated) {
              ...
              if (
                ...
                for (
                  var i = this._editorMovePartInfo.editor.getElement(), r = 0;
                  r < t.length && i != t[r];
                  ++r
                );
              ...
              if (
                ...
                o =
                  !!this._editorMovePartInfo.data &&
                  -1 !== s.indexOf(this._editorMovePartInfo.data.side);
              }
              (this._editor
                .getGuides()
                .useExclusions(this._editor.getAlignExclusions(!1, t)),
                this._editor
                  .getGuides()
              ...
              var c = this._view
                .getViewTransform(this._view.getScene())
                .mapPoint(e);
              e = this._view
                .getViewTransform(this._view.getScene().getActivePage())
                .mapPoint(e);
              ...
              if (
                ...
                if (
                  ...
                  if ((t = this._editor.getSelection())) {
                    ...
                    this._editorMovePartInfo.data &&
                      ...
                      (i =
                        this._editorMovePartInfo.data.ownerEditor.getElement());
                  ...
                  if (
                    ...
                    var d = this._editorMovePartInfo.editor.getPointCoord(
                        this._editorMovePartInfo.id.apLeft,
                      ),
                      f = this._editorMovePartInfo.editor.getPointCoord(
                        this._editorMovePartInfo.id.apRight,
                      ),
                      m = a.fromPoints(d, f);
                    if (m) {
                    ...
                    e = this._editor
                      ...
                      .mapPoint(
                        ...
                        this._editor.hasSelectionDetail() ||
                          (this._editorMovePartInfo.editor instanceof N &&
                            this._editorMovePartInfo.editor
                              .getElement()
                              .isLine() &&
                            C.simpleLineMode)
                ...
                if (
                  ((p =
                    null !== p ? p : e.subtract(this._moveStartTransformed)),
                  (this._editorMovePartInfo.editor instanceof N &&
                    this._editorMovePartInfo.id.type == N.PartType.Point) ||
                    (this._editorMovePartInfo.editor instanceof Y &&
                      (this._editorMovePartInfo.id.type == Y.PartType.Point ||
                  ...
                  var v = this._editorMovePartInfo.editor.getPointCoord(
                    this._editorMovePartInfo.id.point,
                  );
                  p = e.subtract(v);
                }
              ...
              if (
                C.showTooltips &&
                (C.coordinatesTooltip || C.bboxPositionTooltip)
              ) {
                if (
                  ...
                  ((d = this._editorMovePartInfo.editor.getPointCoord(
                    this._editorMovePartInfo.id.apLeft,
                  )),
                    (f = this._editorMovePartInfo.editor.getPointCoord(
                      this._editorMovePartInfo.id.apRight,
                    ...
                    if (b) {
                      ...
                      if (w)
                        ((_ = (_ = w.getSide(a.Side.TOP_LEFT)).add(p)),
                          this._view.getViewConfiguration().multiPageView &&
                            (_ = _.subtract(
                              this._scene.getActivePage().getPosition(!0),
                            )),
                          (u = _));
                    }
                  }
                ...
                if (u) {
                  var E = this._scene.pointToString(
                      u.getX(),
                      C.tooltipDecimalPlaces,
                    ),
                    B = this._scene.pointToString(
                      u.getY(),
                      C.tooltipDecimalPlaces,
                    );
            ...
            if (
              ...
              if (this._view.getViewConfiguration().multiPageView && c) {
                var x = new a(c.getX(), c.getY(), 0, 0),
                  P = this._scene
                    .retrieveChildrenInPaintBBox(x, le.RETRIEVE_MODE_INTERSECT)
                    .filter(function (e) {
              ...
              ((this._itemsToAddToImageMask = []),
                ...
                this._cleanupTargetHighlights(
                  this._itemsToAddToPage,
                  this._scene.iteratePages.bind(this._scene),
                ),
            ...
            if (T && T.isTransformBoxActive() && this._moveStart) {
              var I = this._view.getViewTransform(
                  this._view.getScene().getActivePage(),
                ),
        ...
        (pe.prototype._gatherItemsForAdd = function (e, t, i, o, a) {
          ...
          for (
            ...
            if (
              ...
              ((u instanceof d && u.isMaster()) ||
                !u.hasMixin(n.Reference) ||
                !this._scene.hasLinks(u))
            ) {
              var g = O.getEditor(u),
                f = new ee(),
                m = g.getBBox(f),
        ...
        (pe.prototype._updateResizeHint = function (e) {
          ...
          if (this._moveCurrent && C.showTooltips) {
            if (
              e &&
              this._editorMovePartInfo &&
              this._editorMovePartInfo.editor instanceof H
            )
              if (this._editorMovePartInfo.id === H.RESIZE_HANDLE_PART_ID) {
                t = e.mapRect(this._editorMovePartInfo.editor.getBox());
                var r = this._editorMovePartInfo.editor.getBoxTransform(
                  this._view.getViewConfiguration().multiPageView,
                );
                (r && (t = r.mapRect(t)),
                  (i = this._editorMovePartInfo.data.side));
              } else
                this._editorMovePartInfo.id === H.ROTATION_HANDLE_PART_ID &&
                  ((n =
                    (180 * this._editorMovePartInfo.editor.getRotationAngle()) /
                    Math.PI),
                  (C.snapRotate || g.modifiers.shiftKey) &&
                    (n = Math.round(n)));
              ...
              s &&
                ...
                (s.getTBoxMode() === b.TBoxMode.RESIZE
                  ...
                  : s.getTBoxMode() === b.TBoxMode.ROTATE &&
                    ((n =
                      (180 * e.decomposed().rotate.getRotationFactor()) /
                      Math.PI),
                    (C.snapRotate || g.modifiers.shiftKey) &&
                      (n = Math.round(n))));
            }
            if (
              (C.angleTooltip || null === n) &&
              (C.sizeTooltip || !t) &&
              (null !== n || t)
            ) {
              ...
              if (1 === c.length && c[0] instanceof w && c[0].isLine() && t) {
                var p = this._scene.pointToString(
                  Math.sqrt(l * l + h * h),
                  C.tooltipDecimalPlaces,
                );
                ...
                this.updateInlineHint(
                  o.formatNumber(n, C.tooltipDecimalPlaces) + "°",
                  A,
                  a.Side.BOTTOM_LEFT,
                );
            }
        ...
        (pe.prototype._updateEditorUnderMouse = function (e) {
          ...
          var t = this._view.getScene()
              ...
              : null,
            i = this._view.getScene()
              ? this._view.getWorldTransform(this._view.getScene())
              : null;
          if (i && t) {
            var r = null;
            if (
            ...
            if (this._mode == pe._Mode.Transforming) {
              ...
              if (f && f.isTransformBoxActive()) {
                ...
                if (
                  ((this._editorUnderMouseInfo = m.partInfo),
                  m.newPInfo || r || (!r && this._guideLineUnderMouse))
                ) {
                  var y = m.partInfo.id;
                  (!r || (y != I.INSIDE && y != I.OUTSIDE && y != I.FAR_OUTSIDE)
                    ? (this._guideLineUnderMouse &&
                        (this._guideLineUnderMouse = null),
                      (r = null))
                    : ((this._guideLineUnderMouse = r),
                      (this._editorUnderMouseInfo = null)),
                    this.updateCursor());
                }
            ...
            if (!this._mode) {
              ...
              if (
                ...
                !v &&
                  this._editorUnderMouseInfo &&
                  ((this._editorUnderMouseInfo = null), this.updateCursor()),
                !v &&
                  r &&
                  ((this._guideLineUnderMouse = r), this.updateCursor()),
                !r &&
                  this._guideLineUnderMouse &&
                  ((this._guideLineUnderMouse = null), this.updateCursor()),
                !v && !r)
              ) {
                ...
                !E ||
                  ...
                  (this._elementUnderMouse = E),
                  C.highlightOnHover &&
                    this._elementUnderMouse.setFlag(n.Flag.Highlighted),
                  (b = !0),
                  this.updateCursor());
              }
              (!b &&
                ...
                this._allowDistanceHelper &&
                  ...
                  this._editor.getSelection() &&
                  this._editor.getSelection().length &&
                  C.distanceHelperBehaviour !==
                    pe._DistanceHelperBehaviour.Click &&
                  this._updateDistanceHelper());
            }
            var B = null;
            this._visuals = null;
            var x =
              ...
              P = X.options.zones && !x;
            if (
              ((!this._mode && !_) || this._mode == pe._Mode.Select) &&
              !x &&
              P
            ) {
              var S,
        ...
        (pe.prototype._updateDistanceHelper = function (e) {
          ...
          if (t) {
            var c = r,
              ...
              d =
                this._elementUnderMouse &&
                !this._elementUnderMouse.hasFlag(n.Flag.Selected);
            (p && d
              ? ((o = this._elementUnderMouse.getGeometryBBox()),
                (c = Q.getElementPage(this._elementUnderMouse)),
                (s = !0))
              : c &&
                ((o = c.getGeometryBBox()),
                c.getProperty("h") || c.getProperty("w") || (s = !0)),
              e &&
                d &&
                (this._elementMeasurementsToggle =
                  !this._elementMeasurementsToggle),
              o &&
                c == r &&
                this._editor.getDistanceHelper().refreshVisuals(t, o, a, s));
          }
        }),
        (pe.prototype._selectFilter = function (e) {
          return (
            ...
            !(
              e.hasMixin(Ae) &&
              !this._view.getViewConfiguration().isElementAnnotationsVisible(e)
            ) &&
        ...
        (pe.prototype._getSelectableElement = function (e, t) {
          for (var i = e; null !== i; i = i.getParent())
            if (
              (i instanceof h || i instanceof A) &&
              (t || !i.getParent() || !(i.getParent() instanceof h))
            )
              return i;
          return null;
        }),
