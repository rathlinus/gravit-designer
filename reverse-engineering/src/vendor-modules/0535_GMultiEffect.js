...
function (e, t, i) {
        ...
        ((this._fx = []),
          ...
          e.GeometryProperties && e.VisualProperties
            ...
            : e.VisualProperties
              ...
              : e.GeometryProperties &&
                this._setDefaultProperties(e.GeometryProperties));
      }
      (n.inherit("multiEffect", h, o.Effect),
        ...
        (h.equals = function (e, t) {
          if (e instanceof h && t instanceof h) {
            ...
            for (var i = 0; i < e._fx.length; i++)
              if (!a.equals(e._fx[i], t._fx[i])) return !1;
            return !0;
          }
          return !1;
        }),
        ...
        (h.prototype.getEffectType = function () {
          ...
          return this._fx.length
            ? this._fx[0].getEffectType()
            : o.Effect.Type.Filter;
        }),
