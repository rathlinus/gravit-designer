...
function (e, t, i) {
      ...
      (i(0).inherit(r, n),
        (r.prototype.render = function (e, t, i, n, r, o) {
          ...
          a = this.glEffect.swirlBBox
            ? 0.005 *
              e.radius *
              Math.max(
                this.glEffect.swirlBBox.getWidth(),
                this.glEffect.swirlBBox.getHeight(),
              )
            : 0.005 * e.radius * Math.max(r, o);
          var h = 0.01 * e.centerX * r,
            A = 0.01 * e.centerY * o,
            c = e.angle;
