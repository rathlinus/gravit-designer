...
function (e, t, i) {
      ...
      function f(e, t) {
        (t instanceof d.RendererCanvas
          ...
          this._canvasContext.hasOwnProperty("imageSmoothingQuality") &&
            (this._canvasContext.imageSmoothingQuality = "high"),
          (this._core = e),
          (this._fillTransform = new p()),
          (this._strokeTransform = new p()),
          (this._transform = new p()),
          this.clearVertices());
      }
      ((f.FLAGS_DRAWING = s.RENDERFLAG_FILL | s.RENDERFLAG_STROKE),
        (f.prototype._core = null),
        (f.prototype._defaultFill = null),
        (f.prototype._currentFont = null),
        (f.prototype._contextFont = null),
        ...
        (f.prototype._fillTransform = null),
        ...
        Object.defineProperties(f.prototype, {
          ...
          fillStyle: {
            get: function () {
              ...
              return (
                this._defaultFill &&
                  "transparent" !== this._defaultFill &&
                  (e = this._defaultFill),
                e
              );
            },
            set: function (e) {
              this._renderMode & s.RENDERFLAG_LOCKFILL ||
                (e instanceof o
                  ? (this._textFillStyle = e)
                  : ((this._canvasContext.fillStyle = e),
          ...
          strokeStyle: {
            ...
            set: function (e) {
              this._renderMode & s.RENDERFLAG_LOCKSTROKE ||
                (e instanceof o
                  ? (this._textStrokeStyle = e)
                  : ((this._canvasContext.strokeStyle = e),
          ...
          font: {
            ...
            set: function (e) {
              var t = r.parseFont(e),
                i = this._getFont(t.fontFamily, t.fontStyle, t.fontWeight);
              (i && (this._currentFont = i),
                (this._canvasContext.font = e),
                (this._contextFont = e));
            },
          },
          textBaseline: {
        ...
        (f.prototype.fillRect = function (e, t, i, n, r) {
          var o;
          (r &&
            ((o = this._canvasContext.fillStyle),
            (this._canvasContext.fillStyle = r)),
            this._canvasContext.setTransform.apply(
              this._canvasContext,
              this._transform.preMultiplied(this._fillTransform).getMatrix(),
            ),
            this._canvasContext.fillRect(e, t, i, n),
            this._canvasContext.setTransform.apply(
              this._canvasContext,
              this._transform.getMatrix(),
            ),
            r && (this._canvasContext.fillStyle = o));
        }),
        (f.prototype.strokeRect = function (e, t, i, n) {
          (this._canvasContext.setTransform.apply(
            ...
            this._canvasContext.strokeRect(e, t, i, n),
            this._canvasContext.setTransform.apply(
              this._canvasContext,
              this._transform.getMatrix(),
            ));
        ...
        (f.prototype.getCurrentFont = function () {
          var e = this.font,
            ...
            i = this._currentFont;
          return null === i &&
            null == (i = this._getFont(t.fontFamily, t.fontStyle, t.fontWeight))
            ? ((this._currentFont = this._core._fontManager.getDefaultFont()),
              this._currentFont)
            : t.fontFamily !== i.getFamily() ||
                t.fontWeight !== i.getWeight() ||
                t.fontStyle !== i.getStyle()
              ? null ===
                (i = this._getFont(t.fontFamily, t.fontStyle, t.fontWeight))
                ? this._currentFont
                : ((this._currentFont = i), i)
              : i;
        }),
        (f.prototype._getFont = function (e, t, i) {
          var n = this._core._fontManager,
            r = n.getFont(e, t, i),
            o = r;
          return (
            r || (r = n.getDefaultFont()),
            r &&
              !r.isResolved() &&
              (this._core.requireFont(r),
              (o = null),
              (r = n.getDefaultFont()).isResolved() ||
                this._core.requireFont(r)),
            o
          );
        }),
        ...
        (f.prototype.drawMarker = function (e, t, i) {
          if (this._renderMode & s.RENDERFLAG_VERTEX) {
            ...
            if (
              ...
              return;
            (this._renderMode & s.RENDERFLAG_FILL &&
              ...
              this._canvasContext.fill(
                this._renderMode & s.RENDERFLAG_EVENODDFILL
                  ? "evenodd"
                  : "nonzero",
              ),
              this._canvasContext.setTransform.apply(
              ...
              this._renderMode & s.RENDERFLAG_STROKE &&
                (this._canvasContext.setTransform.apply(
                  this._canvasContext,
                  this._transform
                    .preMultiplied(this._fillTransform)
                    .getMatrix(),
                ),
                ...
                this._renderMode & s.RENDERFLAG_INSIDEBRD
                  ? this.fillVertices(
                      "#000",
                      1,
                      a.CompositeOperator.DestinationIn,
                    )
                  : this._renderMode & s.RENDERFLAG_OUTSIDEBRD &&
                    this.fillVertices(
                      "#000",
                      1,
                      a.CompositeOperator.DestinationOut,
                    )),
              this._renderMode & s.RENDERFLAG_RENDERSTYLES &&
                (n && n.rewindVertices(0),
                this._sstack.push({
                  fill: this.fillStyle,
        ...
        (f.prototype.drawText = function (e, t, i, n, o) {
          if (this._renderMode & s.RENDERFLAG_VERTEX) {
            ...
            var A,
              p = null,
              u = r.parseFont(this.font).fontSize;
            !(this._renderMode & s.RENDERFLAG_NODRAW) &&
              this._renderMode & f.FLAGS_DRAWING &&
              this._canvasContext.beginPath();
            var d = {
            ...
            (this.textLocalizedForm && (d.language = this.textLocalizedForm),
              this.langScript &&
                "auto" !== this.langScript &&
                (d.script = this.langScript),
              this.textVariant && (d.variant = this.textVariant));
            for (
              var m = 0,
                y = {},
                _ = h.stringToGlyphs(e, t, i, u, d),
                v = _.length - 1,
                b = 0;
              b < v;
              b++
              ...
              var C = _[b],
                w =
                  (C.glyph.unicode || e.charCodeAt(b)) === c.NBSP.charCodeAt(0)
                    ? null
                    : h.getGlyphOutline(u, C.x, C.y, C.glyph);
              if (this._textTransformer && w) {
                ...
                ((y.next = _[b + 1].x - C.x),
                  ...
                  (y.xoff = C.xOff),
                  (w = this._textTransformer.transform(w, C.x, C.y, B, y)));
              }
              this._renderMode & f.FLAGS_DRAWING
                ? w && (m += this._putVertices(w))
                : this._renderMode & s.RENDERFLAG_RENDERSTYLES
                  ? (p || (p = new l()), w && p.appendVertices(w))
                  : w && this._vstack.appendVertices(w);
            }
            if (this.textUnderline || this.textStrikeout) {
              w = new l();
              var x = h.getStrikeoutWidth(u);
              if (
                (this.textUnderline && (w = this._makeRect(t, x + i, o, x, A)),
                this.textStrikeout)
              ) {
              ...
              this._renderMode & f.FLAGS_DRAWING
                ? (m += this._putVertices(w))
                : this._renderMode & s.RENDERFLAG_RENDERSTYLES
                  ? (p || (p = new l()), p.appendVertices(w))
                  : this._vstack.appendVertices(w);
            }
            if (this._renderMode & f.FLAGS_DRAWING && !m) return;
            if (this._renderMode & s.RENDERFLAG_NODRAW) return;
            var S = _[b - 1].text || e.charAt(b - 1) || null;
            if (S && this._renderMode & s.RENDERFLAG_FILL) {
              if (this._textFillStyle) {
                var T = this._textFillStyle,
                  I = h.getGlyphBoundingRect(u, S),
                  F = a.prototype.createPatternPaint.call(this, T, I);
                this._canvasContext.fillStyle = a.prototype._convertStyle.call(
                  this,
                  F.paint,
                );
              }
            ...
            if (
              (this._canvasContext.strokeText(e, t, i),
              this.textUnderline &&
                this._canvasContext.strokeRect(t, 1 + i, o, 1),
              this.textStrikeout &&
                this._canvasContext.strokeRect(t, 1 + i - n / 2, o, 1),
              this._renderMode &
                (s.RENDERFLAG_INSIDEBRD | s.RENDERFLAG_INSIDEBRD))
            ) {
              var D = this.globalCompositeOperation,
                k = this.globalAlpha,
                G = this._canvasContext.fillStyle;
              ((this.globalAlpha = 1),
                ...
                this.textUnderline &&
                  this._canvasContext.fillRect(t, 1 + i, o, 1),
                this.textStrikeout &&
                  this._canvasContext.fillRect(t, 1 + i - n / 2, o, 1),
                (this.globalCompositeOperation = D),
                (this.globalAlpha = k),
                (this._canvasContext.fillStyle = G));
            }
          } else
            (this._canvasContext.setTransform.apply(
              this._canvasContext,
              ...
              switch (r.command) {
                ...
                case n.Command.Curve:
                  var o = r.x,
                    a = r.y;
                  (e.readVertex(r) &&
                    this._canvasContext.quadraticCurveTo(r.x, r.y, o, a),
                    i++);
                  break;
                case n.Command.Curve2:
                  ...
                  if (e.readVertex(r)) {
                    var s = r.x,
                      l = r.y;
                    e.readVertex(r) &&
                      this._canvasContext.bezierCurveTo(s, l, r.x, r.y, o, a);
                  }
                  i++;
                  break;
        ...
        (f.prototype._makeRect = function (e, t, i, r, o) {
          ...
          return (
            o
              ? (a.addVertex(n.Command.Move, e, t),
                a.addVertex(n.Command.Line, e, t + r),
                a.addVertex(n.Command.Line, e + i, t + r),
                a.addVertex(n.Command.Line, e + i, t))
              : (a.addVertex(n.Command.Move, e, t),
                a.addVertex(n.Command.Line, e + i, t),
                a.addVertex(n.Command.Line, e + i, t + r),
                a.addVertex(n.Command.Line, e, t + r)),
            a.addVertex(n.Command.Close),
            a
          );
        }),
        (f.prototype.fillVertices = function (e, t, i) {
          var n = this.fillStyle,
            r = this.globalAlpha,
            o = this.globalCompositeOperation;
          ((this._canvasContext.fillStyle = e || n),
            (this.globalAlpha = t || r),
            (this.globalCompositeOperation = i || o),
            this._canvasContext.setTransform.apply(
              this._canvasContext,
              this._transform.preMultiplied(this._fillTransform).getMatrix(),
            ),
            ...
            (this._canvasContext.fillStyle = n),
        ...
        (f.prototype.setScale = function (e, t) {
          ...
          ((i[0] = e),
            (i[3] = t),
            this._canvasContext.setTransform.apply(this._canvasContext, i),
            (this._transform = new p(i[0], i[1], i[2], i[3], i[4], i[5])));
        }),
