      ...
      e.exports = function (e) {
        ((e.Layout = function () {}),
          ...
          (e.Layout.prototype._handleLayoutChange = function (t, i) {
            if (!this.isRecordedTransaction())
              if (
                ...
                (this._relayout && this._layoutTransform)
              )
                t === n._Change.Restore && (this._layoutTransform = null);
              else {
                var a,
                  s = i.properties.indexOf("trf"),
                  l = this.getProperty("trf"),
                  h = i.values[s];
                (h && (a = h.inverted()),
                  l && (a = a ? a.multiplied(l) : l),
                  (this._layoutTransform = a));
              }
          }),
          (e.Layout.prototype._layoutAnchorContents = function (t, i, n) {
            ...
            if (!n) {
              var a =
                  i.getWidth() > e.Transform.MinimalDimention
                    ? i.getWidth()
                    : e.Transform.MinimalDimention,
                s =
                  i.getHeight() > e.Transform.MinimalDimention
                    ? i.getHeight()
                    : e.Transform.MinimalDimention,
                l =
                  t.getWidth() > e.Transform.MinimalDimention
                    ? t.getWidth()
                    : e.Transform.MinimalDimention,
                h =
                  t.getHeight() > e.Transform.MinimalDimention
                    ? t.getHeight()
                    : e.Transform.MinimalDimention;
              o = new r()
