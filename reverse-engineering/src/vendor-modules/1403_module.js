...
function (e, t, i) {
      ...
      ((a.import = function (e, t, i, s, l, h, A) {
        ...
        if (e instanceof ArrayBuffer || e instanceof Uint8Array) {
          ...
          var u = "ps.worker.js" + ("?v=" + Math.random()),
            d = new o(p, s, i, l),
            g = null,
            f = null;
          try {
            ((function (e, t) {
              ...
              ((m = new URL(u, window.location.href).href),
              (y = "importScripts('" + m + "');"),
              (u = URL.createObjectURL(new Blob([y])))),
              (g = new Worker(u)),
              (d.worker = g),
              (g.onmessage = function (e) {
                ...
                if ("error" in t);
                  ...
                  var i = t.func;
                  if ("progress" == i && t.data && t.data.length) h(t.data[0]);
                    ...
                    if (("done" == i && h(100), "data" in t)) {
                      ...
                      ("result" in t &&
                        t.result &&
                        t.result.byteLength &&
                        t.result.byteLength > 4 &&
                        ((n[n.length] = new Int32Array(t.result, 0, 1)),
                        (n[n.length] = new Uint8Array(
                          t.result,
                          4,
                          t.result.byteLength - 4,
                        ))),
                        d.workerAPI[i].apply(d, n),
                        "error" == i && n == o.ErrorCodes.General
                          ? (null !== f && clearTimeout(f),
                            g.terminate(),
                            d.ready() || d.workerAPI.done.apply(d))
                          : d.ready() && null !== f && clearTimeout(f));
                    } else
                      g.postMessage({
                        error: -3,
              ...
              (f = setTimeout(function () {
                (g.terminate(),
                  d.ready() ||
                    (d.workerAPI.done.apply(d),
                    d.workerAPI.error.apply(d, [o.ErrorCodes.Timeout])));
              }, 3e5)));
          } catch (e) {
