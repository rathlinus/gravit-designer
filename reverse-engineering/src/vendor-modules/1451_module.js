              ...
              try {
                ...
                if (b) {
                  var C = t.createExecutor(0),
                    ...
                    P = function (e) {
                      var t = e.translated(p.getX(), p.getY()),
                        ...
                        o = r.export(n, h, null, null, null, null, !1, t);
                      o &&
                        o.getWidth() > 0 &&
                        o.getHeight() > 0 &&
                        w.push({
                    ...
                    S = function () {
                      ...
                      (w.forEach(function (e) {
                        ...
                        e.canvas
                          .getContext()
                          .replaceWithBitmap(t, i, null, null, !0),
                        A());
                    }.bind(this);
                  C.execute(b, P, S);
                } else {
                  ...
                  (I &&
                    ...
                    e.canvas
                      .getContext()
                      .replaceWithBitmap(I.getHTMLElement(), i, null, null, !0),
                    A());
                }
              } catch (e) {
                c(e);
