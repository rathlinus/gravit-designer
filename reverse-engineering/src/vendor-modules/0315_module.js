...
function (e, t, i) {
      ...
      function r(e) {
        (n.call(this, e, n.tilingAwareVertexSource, this._blurFinish),
          (this._bendAndBlur = new n(
            e,
            n.tilingAwareVertexSource,
            this._bendAndBlurSrc,
          )));
      }
      (i(0).inherit(r, n),
        (r.MAX_BLUR = 80),
        (r.MAX_BLUR2 = 40),
        (r.RADIUS_TO_BLUR = 2),
        (r.prototype._bendAndBlurSrc =
          "    varying highp vec2 texCoord;    varying vec2 localTexCoord;    uniform float sigma;    uniform float sigma2;    uniform float bend;    uniform float krycie;    uniform vec2  blurMultiplyVec;    uniform highp sampler2D texture;    uniform float padding;    uniform vec2 tileSize;    uniform vec2 offset;    uniform vec2 texSize;    const float blurPixels = " +
          r.MAX_BLUR.toFixed(1) +
        ...
        (r.prototype._blurFinish =
          "    varying highp vec2 texCoord;    varying vec2 localTexCoord;    uniform float sigma;    uniform float sigma2;    uniform float bend;    uniform float krycie;    uniform vec2  blurMultiplyVec;    uniform highp sampler2D texture;    uniform vec2 tileSize;    uniform vec2 offset;    uniform vec2 texSize;    const float blurPixels = " +
          r.MAX_BLUR.toFixed(1) +
          ";    const float pi = 3.14159265;\n" +
          n.TOLOCAL +
        ...
        (r.prototype.render = function (e, t, i, n, o, a) {
          ...
          var c = e.bend * t,
            p = A * r.MAX_BLUR2 * t,
            u = A * h,
            d = p + u + h * r.RADIUS_TO_BLUR,
            g = this.glEffect.texture;
          (this._bendAndBlur.simpleShader.call(
            this._bendAndBlur,
            {
              sigma: this._radiusToSigma(p),
              sigma2: this._radiusToSigma(u),
              blurMultiplyVec: [1 / o, 0],
              bend: c / a,
              krycie: e.cov,
              padding: d / o,
              tileSize: [s, l],
