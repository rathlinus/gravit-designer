...
function (e, t, i) {
      ...
      class s {
        ...
        constructor(e) {
          ...
          ((this._page = t),
            ...
            (this._title =
              ...
              o.getValue(
                "GOfferDialogV1",
                "text.offerdialog-v1-default-title",
              )),
        ...
        _initDialog() {
          this._ui.dialog = n("<div></div>").addClass(
            "g-cloud-ui-offer-dialog-v1",
          );
        }
        _initHeader() {
          const e = n("<header>").appendTo(this._ui.dialog);
          ((this._ui.title = n("<span>")
            .addClass("title g-cloud-ui-markable")
            .appendTo(e)),
            (Array.isArray(this._title) ? this._title : [this._title]).forEach(
              (e) => {
                (n("<label>").html(e).appendTo(this._ui.title),
                  n("<br>").appendTo(this._ui.title));
              },
            ));
        }
        _initMain() {
          ...
          if (this._content)
            switch (this._content.type) {
              case s.ContentType.Title:
                n("<span>")
                  .addClass("title no-bold")
                  .html(this._content.title)
                ...
                n("<div>")
                  ...
                  .append(
                    this._content.data.map((e) =>
                      n("<div>")
                        .addClass("topic")
                        .append(n("<span>").addClass("g-cloud-icon-v").text(e)),
                    ),
                  );
                break;
        ...
        _initWebContent() {
          const e = n("<div>")
            .addClass("content g-cloud-ui-loading")
            .appendTo(this._ui.main);
          n("<iframe>", {
            id: "GOfferDialogV1",
        ...
        _initFooter() {
          this._withFooter &&
            ...
            n("<span>")
              ...
              .append(
                n("<span>").text(
                  o.getValue("GServerTranslations", "NEED_HELP"),
                ),
              )
              .append(" ")
              .append(
        ...
        _initFooterInfo() {
          ...
          (n("<button>")
            ...
            .on("click", () => {
              (r("".concat(this._page || "offer", "_click_buybutton")),
                this._openPurchaseFlow && this._openPurchaseFlow());
            })
            .appendTo(e),
