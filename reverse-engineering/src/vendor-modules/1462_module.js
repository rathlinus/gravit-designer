...
function (e, t, i) {
      ...
      function r() {
        ((this.filters = []),
          (this.id = ""),
          (this.nextPrefixId = 100),
          (this.fill_opacity = 1),
          (this._height = "400%"),
          (this._width = "400%"),
          (this._x = "-200%"),
          (this._y = "-200%"),
          (this._filterUnits = r.FilterUnits.ObjectBoundingBox));
      }
      ((r.Type = {
        Series: "series",
        Parallel: "parallel",
      }),
        (r.prototype._filterUnits = null),
        (r.FilterUnits = {
        ...
        (r.prototype._createBaseFilterObject = function (e) {
          if (!e) throw "Invalid filter instance!";
          return {
            defs: [],
            filterInstance: e,
            addFilter: function () {
            ...
            overrideDefsSource: function (e, t) {
              this.defs.forEach(function (i) {
                (i.documentElement.getAttribute("in") === e &&
                  i.documentElement.setAttribute("in", t),
                  i.documentElement.getAttribute("in2") === e &&
                    i.documentElement.setAttribute("in2", t),
                  i.documentElement.getAttribute("in3") === e &&
                    i.documentElement.setAttribute("in3", t));
              });
            },
          };
        }),
        (r.prototype.createSeriesFilter = function (e) {
          var t = this,
            i = this._createBaseFilterObject(e);
          return (
            (i.addFilter = function (e, i, n, r) {
        ...
        (r.prototype.createParallelFilter = function (e) {
          var t = this,
            i = this._createBaseFilterObject(e);
          return (
            (i.prefix = "pf_" + this.nextPrefixId++ + "_"),
            (i.addFilter = function (e, i, r, o) {
              (0 != this.defs.length || i.in || (i.in = "SourceGraphic"),
                n.each(
                  i,
                  function (e, t) {
                    "SourceGraphic" != t &&
        ...
        (r.prototype._groupEqualFilters = function (e) {
          ...
          return (
            e.forEach(function (e) {
              (t[e.filterInstance] || (t[e.filterInstance] = []),
                t[e.filterInstance].push(e));
            }),
        ...
        (r.prototype._createParallelFilters = function (e, t, i) {
          if (i.length)
            if (i.length > 1) {
              var r = this._groupEqualFilters(i),
                ...
                a = function (i, r) {
                  if (
                    (n.each(i.defs, function (i, n) {
                      (t.appendChild(
                        e.ownerDocument.importNode(n.documentElement, !0),
                      ),
                        t.appendChild(o));
                    }),
                    r)
                  ) {
                    var a = t.ownerDocument.createElementNS(
                      "http://www.w3.org/2000/svg",
                      "feMergeNode",
                    );
                  ...
                  if (e.length > 1)
                    e.forEach(
                      function (e, t, i) {
                        ...
                        var n = i[t + 1];
                        (n &&
                          n.overrideDefsSource("SourceGraphic", e.getResult()),
                          a(e, !n));
                      }.bind(this),
                    );
                  else {
        ...
        (r.prototype._createSeriesFilters = function (e, t, i) {
          if (i.length) {
            if (i.length > 1) {
              ...
              (i[i.length - 2].setResult(r),
                (a = i[i.length - 1]).setSource(r));
            }
            var o,
              a,
              s = "SourceGraphic";
            if (
              (n.each(i, function (e, t) {
                0 == e
                  ? (s = t.getResult())
                  : t.overrideDefsSource("SourceGraphic", s);
              }),
              1 != this.fill_opacity)
            )
              (0 == i.length
                ? ((o = this.createSeriesFilter()), (a = null))
                : ((a = (o = i[i.length - 1]).defs[
                    o.defs.length - 1
                  ]).documentElement.setAttribute("result", "FilterOut"),
                  n.each(o.defs, function (e, t) {
                    "feBlend" === t.documentElement.tagName &&
                      "SourceGraphic" ===
                        t.documentElement.getAttribute("in") &&
                ...
                o.addFilter(
                  ...
                  null,
                  [
                    '<feFuncA xmlns="http://www.w3.org/2000/svg" type="table" tableValues="0 ' +
                      this.fill_opacity +
                      '"/>',
                  ],
                ),
        ...
        (r.prototype.toXml = function (e) {
          if (0 != this.filters.length || 0 != this.fill_opacity) {
            var t = e.ownerDocument.createElementNS(
              "http://www.w3.org/2000/svg",
              "filter",
            );
            (e.appendChild(t),
              this.id && t.setAttribute("id", this.id),
              t.setAttribute("x", this._x),
              t.setAttribute("y", this._y),
              t.setAttribute("width", this._width),
              t.setAttribute("height", this._height),
              t.setAttribute("filterUnits", this._filterUnits),
              t.setAttribute("color-interpolation-filters", "sRGB"));
            var i = this.filters.filter(function (e) {
                return e.getType() === r.Type.Parallel;
              }),
              n = this.filters.filter(function (e) {
                return e.getType() === r.Type.Series;
              });
            (this._createParallelFilters(e, t, i),
              this._createSeriesFilters(e, t, n));
          }
        }),
        (e.exports = r));
    }