      ...
      class o extends r {
        ...
        getPrivateShareList() {
          return this.user_accesses
            ? this.user_accesses.map((e) => new n(e))
            : [];
        }
        getInvitedShareList() {
          return this.invite_accesses
            ? this.invite_accesses.map((e) => new n(e))
            : [];
        }
        getPublicShare() {
          return this.link_accesses && this.link_accesses
            ? new n(this.link_accesses[0])
            : null;
        }
        getShareLink(e) {
          const t = {},
