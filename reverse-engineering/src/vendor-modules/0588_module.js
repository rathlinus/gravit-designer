...
function (e, t, i) {
      ...
      (n.inherit("GGLColorAdjustEffect", l, r),
        ...
        (l.prototype.isCacheable = function (e) {
          return (
            !(
              !this._lastCanvasScale || this._lastCanvasScale !== e.getScale()
            ) || ((this._lastCanvasScale = e.getScale()), !1)
          );
        }),
        (l.prototype._handleChange = function (e, t) {
          (e === n._Change.Store
            ? this.storeProperties(t.blob, l.MetaProperties)
            : e === n._Change.Restore &&
              this.restoreProperties(t.blob, l.MetaProperties),
        ...
        (l.prototype.applyNativeEffect = function (e, t, i, n) {
          var r = this.$shp.brightness,
            s = this.$shp.contrast,
            l = this.$shp.hue,
            h = this.$shp.saturation;
          (h > 0
            ? (h > 1 && (h = 1), (h = 1 + h / (1.001 - h)))
            : (h = 1 + a.clamp(-1, h, 0)),
            (r = a.clamp(-1, r, 1) + 1),
            (r *= r),
            s > 0
              ...
              : (s = 1 + a.clamp(-1, s, 0)),
            (l = Math.PI * a.clamp(-1, l, 1)),
            e.setFilter(o.Filter.Brightness, r),
            e.setFilter(o.Filter.Contrast, s),
            e.setFilter(o.Filter.HueRotate, l),
            e.setFilter(o.Filter.Saturate, h));
        }),
