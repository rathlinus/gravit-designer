...
function (e, t, n) {
      ...
      function s(e, t) {
        ((this.error = e || 1e-6),
          (this.tolerance = t || Math.sqrt(this.error + l)),
          (this.polys = []));
      }
      var l = 1e-9;
      ...
      ((s.prototype.polys = null),
        ...
        (s.prototype._fitCubic = function (e, t, i, n, a, s, l) {
          var h,
            ...
            f = e;
          if (l < 1) return -1;
          if ((u = i - t + 1) < 2) return 0;
          var m = new r(0, 0);
          if (2 == u) {
            var y =
              o.ptDist(f[i].getX(), f[i].getY(), f[t].getX(), f[t].getY()) / 3;
            return (
              ((h = new Array(4))[0] = f[t]),
              (h[3] = f[i]),
              (h[1] = r.equals(m, n)
                ...
                : h[0].add(n.scale(y))),
              (h[2] = r.equals(m, a)
                ? h[0].add(h[3].scale(2)).scale(1 / 3)
                : h[3].add(a.scale(y))),
              s.push(h),
              1
            );
          }
          if (!(A = this._chordLengthParameterize(f, t, i))) return 0;
          if (
            ((h = this._generateBezier_err(f, t, i, A, n, a)),
            (p = this._computeMaxError(f, t, i, h, A, g)),
            Math.abs(p) <= 1)
          )
            return (s.push(h), 1);
          if (0 <= p && p <= 3)
            for (d = 0; d < 4; d++) {
              if (
                ((h = this._generateBezier_err(f, t, i, A, n, a)),
                (c = this._reparameterize(f, t, i, A, h)),
                (p = this._computeMaxError(f, t, i, h, c, g)),
                Math.abs(p) <= 1)
              )
                return (s.push(h), 1);
              A = c;
          ...
          if (_)
            if (g[0] == t) {
              if (!r.equals(m, n)) return this._fitCubic(f, t, i, m, a, s, l);
              g[0] = g[0] + 1;
            } else if (g[0] == i) {
              if (!r.equals(m, a)) return this._fitCubic(f, t, i, n, m, s, l);
              g[0] = g[0] - 1;
            }
          if (1 < l) {
            var v, b;
            if (_) {
              if (!(t < g[0] && g[0] < i)) return -1;
              v = b = m;
            } else v = (b = this._computeCenterTangent(f, g[0])).scale(-1);
        ...
        (s.prototype._estimate_bi = function (e, t, i, n, o, a) {
          if (1 <= t && t <= 2) {
            for (
              var s = 3 - t, l = new r(0, 0), u = 0, d = a - o + 1, g = 0;
              g < d;
              ++g
            ) {
              var f = n[g],
        ...
        (s.prototype._darray_left_tangent = function (e, t, n, r) {
          var o = n - t + 1;
          for (i = 1; ; ) {
            var a = e[t + i].subtract(e[t]),
              s = a.dot(a);
            if (r < s) return a.scale(1 / Math.sqrt(s));
            if ((++i, i == o))
              return 0 == s
                ? this._computeLeftTangent(e, t)
                : a.scale(1 / Math.sqrt(s));
          }
        }),
        (s.prototype._darray_right_tangent = function (e, t, i, n) {
          for (var r = i - 1; ; r--) {
            var o = e[r].subtract(e[i]),
              a = o.dot(o);
            if (n < a) return o.scale(1 / Math.sqrt(a));
            if (r == t)
              return 0 == a
                ? this._computeRightTangent(e, i)
                : o.scale(1 / Math.sqrt(a));
          }
        }),
        (s.prototype._generateBezier_err = function (e, t, i, n, o, a) {
          var s = 0 == o.getX() && 0 == o.getY(),
            l = 0 == a.getX() && 0 == a.getY(),
            h = s ? this._darray_left_tangent(e, t, i, this.error) : o,
            A = l ? this._darray_right_tangent(e, t, i, this.error) : a,
        ...
        (s.prototype._generateBezier = function (e, t, i, n, r, a) {
              ...
              (y = e[t + s].subtract(
                e[t]
                  ...
                  .add(
                    e[t]
                      .scale(A(n[s]))
                      .add(e[i].scale(c(n[s])).add(e[i].scale(p(n[s])))),
                  ),
              )),
              (b[0] += C.dot(y)),
              (b[1] += w.dot(y)));
          ...
          if (
            ((u = v[0][0] * v[1][1] - v[1][0] * v[0][1]),
            (d = v[0][0] * b[1] - v[0][1] * b[0]),
          ...
          if (f < 1e-6 || m < 1e-6) {
            ...
            return (
              (_[0] = e[t]),
              (_[3] = e[i]),
              (_[1] = _[0].add(r.scale(x))),
              (_[2] = _[3].add(a.scale(x))),
              _
            );
          }
          return (
            (_[0] = e[t]),
            (_[3] = e[i]),
            (_[1] = _[0].add(r.scale(f))),
            (_[2] = _[3].add(a.scale(m))),
            _
          );
        }),
        ...
        (s.prototype._newtonRaphsonRootFind = function (e, t, i) {
          var n,
            ...
            h = new Array(3),
            A = new Array(2);
          ((o = this._evalBezier(3, e, i)),
            (h[0] = e[1].subtract(e[0]).scale(3)),
            (h[1] = e[2].subtract(e[1]).scale(3)),
            (h[2] = e[3].subtract(e[2]).scale(3)),
            (A[0] = h[1].subtract(h[0]).scale(2)),
            (A[1] = h[2].subtract(h[1]).scale(2)),
            (a = this._evalBezier(2, h, i)),
            (s = this._evalBezier(1, A, i)));
          var c = o.subtract(t);
          ((n = c.dot(a)),
            (l =
              (r = a.dot(a) + c.dot(s)) > 0
        ...
        (s.prototype._evalBezier = function (e, t, i) {
          var n, r, o;
          for (o = new Array(e + 1), n = 0; n <= e; n++) o[n] = t[n];
          for (n = 1; n <= e; n++)
            for (r = 0; r <= e - n; r++)
