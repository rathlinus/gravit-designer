...
function (e, t, i) {
      ...
      ((r.prototype.l = null),
        ...
        (r.prototype.r = null),
        (r.prototype.b = null),
        (r.prototype.united = function (e, t) {
          var i = this.l,
            r = this.l;
          ...
          var o = e.l,
            a = e.l;
          if ((e.w < 0 ? (o += e.w) : (a += e.w), t && o == a)) return this;
          var s = this.t,
            l = this.t;
          ...
          var h = e.t,
            A = e.t;
          if ((e.h < 0 ? (h += e.h) : (A += e.h), t && h == A)) return this;
          var c = new n();
          return (
            (c.l = Math.min(i, o)),
            (c.t = Math.min(s, h)),
            (c.w = Math.max(r, a) - c.l),
            (c.h = Math.max(l, A) - c.t),
            (c.r = c.l + c.w),
            (c.b = c.t + c.h),
            c
          );
        ...
        (r.prototype.equals = function (e) {
          return (
            this.l === e.l && this.t === e.t && this.w === e.w && this.h === e.h
          );
        }),
