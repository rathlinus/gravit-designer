...
function (e, t, i) {
      ...
      ((a.UNCHANGED = 1),
        ...
        (a.prototype.performCut = function (e, t, i, n, r, o, s) {
          var l = null,
            h = null;
          if (
            (r && (this.cutterSource = r),
            (n &&
              ((a.ALLOW_ODD_CLOSED && 0 === t.length) ||
                (!a.ALLOW_ODD_CLOSED && t.length % 2 != 0))) ||
              0 == i.length ||
              (!n && (0 === t.length || 0 === i.length)))
          )
            return a.UNCHANGED;
          ...
          var p = e,
            u = (this.cutterSource, []),
            d = this._breakApart(this.cutterSource, n, u),
            g = 0,
            f = u.length;
          if (0 === f || !d) return null;
          for (A = 0; A < f; A++) g += u[A].getCount();
          ...
          if (1 == m.length && !_) return a.UNCHANGED;
          if ((void 0 === o && (o = n), o)) {
            if (!this._fitVertices(m, u, s)) return null;
          } else if (!this._distributeSides(m, u)) return null;
          return m;
        }),
          ...
          if (e.rewindVertices(0))
            for (var l = new r(); e.readVertex(l); )
              switch (l.command) {
                ...
                default:
                  throw new Error(
                    "Unknown vertex command: " + l.command.toString(),
                  );
              }
          var h = 2;
          if (null !== i && null !== a) {
            var A = new n();
            (A.addVertex(r.Command.Move, i, o),
              A.addVertex(r.Command.Line, a, s),
              (h = this._getSide(A, t, null, 0)));
          }
          return h;
        }),
        ...
        (a.prototype._vertexHasIsect = function (e, t) {
          ...
          do {
            if (
              (e.x === t.x || o.isEqualEps(e.x, t.x, 0.05)) &&
              (e.y === t.y || o.isEqualEps(e.y, t.y, 0.05))
            )
              return !0;
          } while ((t = t.next));
          return !1;
          ...
          for (e.rewindVertices(0); a && e.readVertex(n); ) {
            switch ((1 === t && (i = []), n.command)) {
              case r.Command.Move:
                ...
                break;
              case r.Command.Line:
                (o && (i.push(o.x, o.y), i.push(n.x, n.y)),
                  (o = n),
                  (n = new r()));
                break;
              case r.Command.Curve:
                if (o) {
                  var s = new r();
                  e.readVertex(s) &&
                    (i.push(o.x, o.y), i.push(s.x, s.y), i.push(n.x, n.y));
                }
                ((o = n), (n = new r()));
                break;
              case r.Command.Curve2:
        ...
        (a.prototype._getSide = function (e, t, i, n, r) {
          var a,
            ...
            h = n >> 1,
            A = 1 & n,
            c = this._getSegment(e, n >> 1),
            p = this._getSegment(t, 1 & n);
          return 0 == c.length || 0 == p.length
            ? 2
            : (1 == h
                ? 4 == c.length
                  ? (a = [c[0], c[1], c[2], c[3]])
                  : 6 == c.length
                    ? (a = [c[2], c[3], c[4], c[5]])
                    : 8 == c.length && (a = [c[4], c[5], c[6], c[7]])
                : (a = [c[0], c[1], c[2], c[3]]),
              0 == A
                ? (4 == p.length || 6 == p.length || 8 == p.length) &&
                  (s = [p[2], p[3]])
                : 4 == p.length
                  ? (s = [p[0], p[1]])
                  : 6 == p.length
                    ? (s = [p[2], p[3]])
                    : 8 == p.length && (s = [p[4], p[5]]),
              0 ==
              (l = r
                ? o.segmentSide(a[2], a[3], a[0], a[1], s[0], s[1])
                : o.segmentSide(a[0], a[1], a[2], a[3], s[0], s[1]))
                ? 2
                : 1 == l
                  ? 0
                  : 1);
        ...
        (a.prototype._closePath = function (e) {
          if (0 === e.getCount()) return e;
          e.rewindVertices(e.getCount() - 1);
          var t = new r();
          return (
            e.readVertex(t),
            t.command !== r.Command.Close && e.addVertex(r.Command.Close, 0, 0),
            e
          );
        }),
        ...
        (a.prototype._correctMoveTo = function (e) {
          ...
          for (var a = new n(); e.readVertex(t); )
            ((t.command === r.Command.Move &&
              i &&
              o.isEqualEps(t.x, i.x) &&
              o.isEqualEps(t.y, i.y)) ||
              a.addVertex(t.command, t.x, t.y),
              (i = t),
              (t = new r()));
            ...
            switch (s.command) {
              ...
              case r.Command.Line:
                (A.addVertex(s.command, s.x, s.y),
                  ...
                  t && (a = this._vertexHasIsect(s, this.isectsCutter)),
                  (o || a) &&
                    ((A = new n()).addVertex(r.Command.Move, s.x, s.y),
                    i.push(A),
                    (c = !0)));
                break;
              case r.Command.Curve:
                ...
                e.readVertex(s) &&
                  ...
                  (o || a) &&
                    ((A = new n()),
                    i.push(A),
                    A.addVertex(r.Command.Move, p.x, p.y),
                    (c = !0)));
                break;
              case r.Command.Curve2:
                p = {
              ...
              default:
                throw new Error(
                  "Unknown vertex command: " + s.command.toString(),
                );
            }
          if (
            (i[0].getCount() || i.shift(), this.isClosed && !t && i.length > 1)
          ) {
            var u;
            u = i[0];
            var d = i[i.length - 1];
      ...
      var s = function (e, t) {
          return (
            e === t ||
            !(!o.isEqualEps(e.x, t.x, 0.05) || !o.isEqualEps(e.y, t.y, 0.05))
          );
        },
        l = function (e) {
          var t = e.getCount(),
            i = new r();
          return (
            e.rewindVertices(t - 1),
            e.readVertex(i),
            i.command === r.Command.Curve
              ? (e.rewindVertices(t - 2), e.readVertex(i))
              : i.command === r.Command.Curve2 &&
                (e.rewindVertices(t - 3), e.readVertex(i)),
            i
          );
        },
        h = function (e) {
      ...
      ((a.prototype._distributeSides = function (e, t) {
        for (
          var i, r = [[], [], []], o = e.length, a = t.length, A = o - 1;
          A >= 0;
          A--
        ) {
          var c = e[A],
          ...
          for (var d = a - 1; d >= 0; d--) {
            ...
            if (g.getCount()) {
              ...
              if (y && s(m, u)) {
                (r[this._getSide(g, c, null, 3)].push(n.clone(c, !0)),
                  (i = !0));
                break;
              }
              if (_ && s(f, p)) {
                (r[this._getSide(g, c, null, 0)].push(n.clone(c, !0)),
                  (i = !0));
                break;
              }
            }
        ...
        (a.prototype._fitVertices = function (e, t, i) {
          ...
          if (1 == c && A > 3) {
            ...
            a = [p];
            for (u = 2; u < A - 1; u += 2) a.push(n.clone(t[u]));
          } else c = 2;
          A = a.length;
                ...
                for (var T = b + 1; T < S; T++)
                  if (r[y][T] && r[y][b]) {
                    ...
                    if (s(I.startPoint, F.startPoint)) {
                      ...
                      (this._prependVertices(I.path, R),
                        (I.startPoint = F.endPoint),
                        (r[y][T] = null));
                    } else if (s(I.endPoint, F.endPoint)) {
                      if (!(R = n.clone(F.path, !0))) return !1;
                      (this._appendVertices(I.path, R),
                        (I.endPoint = F.startPoint),
                        (r[y][T] = null));
                    } else if (s(I.startPoint, F.endPoint)) {
                      if (!(R = n.clone(F.path, !1))) return !1;
                      (this._prependVertices(I.path, R),
                        (I.startPoint = F.startPoint),
                        (r[y][T] = null));
                    } else if (s(I.endPoint, F.startPoint)) {
                      if (!(R = n.clone(F.path, !1))) return !1;
                      (this._appendVertices(I.path, R),
                        (I.endPoint = F.endPoint),
                        (r[y][T] = null));
                    }
                  }
          }
          ...
          for (y = 0; y < 3; y++) {
            ...
            for (b = 0; b < S; b++)
              r[y][b] &&
                r[y][b].path &&
                r[y][b].path.getCount() > 2 &&
                (r[y][b].path.getCount(),
                D.push(this._closePath(r[y][b].path)));
            e.push(D);
          }
          for (u = e.length - 1; u >= 0; u--)
            for (b = e[u].length - 1; b >= 0; b--) this._correctMoveTo(e[u][b]);
          return !0;
        }),
        (e.exports = a));
    }