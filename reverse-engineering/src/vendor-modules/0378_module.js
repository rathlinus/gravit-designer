      ...
      ((i.prototype.setState = function (e, t) {
        ...
        (l.prototype.replaceRange = function (e, t, n, r) {
          ...
          if (!isNaN(e) && this.inboundIndex(e) && o) {
            var a = this.tokens.splice.apply(this.tokens, [e, t].concat(n));
            return (r || this.dispatch("replaceToken", [e, t, n]), [a, n]);
          }
          return {
        ...
        (l.prototype.setEndOffset = function (e, t) {
          var i = new n(this.getContext(t).openRange.startIndex, e, t),
            r = this.getContext(t).ranges;
          return (
            (i.rangeId = t + "." + r.length),
            r.push(i),
        ...
        (l.prototype.runContextCheck = function (e) {
          ...
          this.contextCheckers.forEach(function (r) {
            var o = r.contextName,
              a = i.getContext(o).openRange;
            if (
              (!a &&
                r.checkStart(e) &&
                ((a = new n(t, null, o)),
                (i.getContext(o).openRange = a),
                i.dispatch("contextStart", [o, t])),
              a && r.checkEnd(e))
            ) {
              var s = t - a.startIndex + 1,
                l = i.setEndOffset(s, o);
              i.dispatch("contextEnd", [o, l]);
            }
          });
        }),
