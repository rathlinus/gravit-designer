...
function (e, t, i) {
      ...
      function h(e, t, i, n, r) {
        ...
        ((this._scale = "number" == typeof t ? t : 1),
          (this._fx = "number" == typeof i ? i : 0.5),
      ...
      (r.inherit(h, n),
        ...
        (h.prototype._scale = null),
        (h.prototype._fx = null),
        (h.prototype._fy = null),
        (h.prototype.getStops = function () {
          return this._stops;
        }),
        (h.prototype.getAverageColor = function () {
          for (
            ...
            var s = e[a].opacity,
              l = e[a].color.toScreen();
            ((i += l[0]), (n += l[1]), (r += l[2]), (o += s));
          }
          return [(i /= t), (n /= t), (r /= t), (o /= t)];
        }),
