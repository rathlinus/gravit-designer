...
function (e, t, i) {
      ...
      (o.inheritAndMix("group", f, n, [
        ...
        (f.prototype._calculatePaintBBox = function (e, t) {
          ...
          return (
            (i = this.getProperty("frm")
              ...
              : n.prototype._calculatePaintBBox.call(this, e, t)),
        ...
        (f.prototype._calculateSourceBBox = function (e) {
          ...
          var i = this.getProperty("trf"),
            n = null;
          if (!i) return this.getGeometryBBox(e);
        ...
        (f.prototype._calculatePreTransformRect = function (e) {
          ...
          if (t) {
            var i = e.inverted(),
              n = this.getProperty("trf"),
              r = (i = n ? n.multiplied(i) : i).mapQuadrilateral(t);
            return h.fromPoints.apply(null, r);
          }
          for (
            var o = null, s = this.getFirstChild();
            null != s;
            s = s.getNext()
          )
            if (s instanceof a) {
        ...
        (f.prototype._paintStyleContent = function (e, t, i, n, r) {
          ...
          if (o && this.getFirstChild()) {
            var a = new c(o.getX(), o.getY(), o.getWidth(), o.getHeight()),
          ...
          if (
            (e == a._Change.ChildGeometryUpdate
              ? t &&
                t[0] &&
                t[0].getParent() === this &&
                (this._notifyChange(a._Change.PrepareGeometryUpdate), (i = !0))
              : e === o._Change.Store
                ...
                : e === o._Change.Restore &&
                  this.restoreProperties(
                    ...
                    function (e, t) {
                      return "trf" === e && t
                        ? l.deserialize(t).makeInvertible()
                        : "frm" === e && t
                          ? h.deserialize(t)
                          : t;
                    },
            ...
            e != a._Change.PrepareChildAnchoring ||
        ...
        (f.prototype.setFrame = function (e) {
          ...
          if (
            (null === t ||
              A.isEqualEps(t, 0, 1e-4) ||
              (i = new l().rotated(-t)),
            e && !this.getProperty("frm"))
          ) {
            var n = i ? this.getPreTransformRect(i) : this.getGeometryBBox();
            if (n) {
              this.setProperties(["frm", "trf"], [n, i]);
              for (var r = this.getFirstChild(); null != r; r = r.getNext())
                r.hasMixin(a.Anchor) &&
                  (r.getProperty("hacr") ||
                    r.setProperty(
                      "hacr",
                      r.oldHacr ? r.oldHacr : a.Anchor.AnchorType.Start,
                    ),
                  r.getProperty("vacr") ||
                    r.setProperty(
                      "vacr",
                      r.oldVacr ? r.oldVacr : a.Anchor.AnchorType.Start,
                    ));
            }
          } else if (!e && this.getProperty("frm")) {
            for (r = this.getFirstChild(); null != r; r = r.getNext())
              r.hasMixin(a.Anchor) &&
                (r.getProperty("hacr") || r.getProperty("vacr")) &&
                r.resetAnchorProperties();
            this.setProperties(["frm", "trf"], [null, i]);
          }
        }),
