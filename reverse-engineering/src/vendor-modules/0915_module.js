...
function (e, t, i) {
      ...
      function S() {
        for (var e in (o.call(this), P)) this._initDefault(e);
      }
      (r.inheritAndMix("styles", S, o, [r.Container, r.Store]),
          ...
          switch (e) {
            ...
            case "GRectangle":
              ...
              (i.setProperties(
                ...
                i
                  .getPaintLayers()
                  .appendChild(new s.FillPaintLayer(new c([235, 235, 235]))),
                this.appendChild(i));
              break;
            case "GPath":
              var r = new g();
              (r.setProperties(
                ...
                r
                  .getPaintLayers()
                  .appendChild(new s.FillPaintLayer(c.WHITE, 1, !1)),
            ...
            case "GPathsGraph":
              ...
              (T.setProperty("_blc", y.LineCap.Round),
                S.getPaintLayers().appendChild(
                  new s.FillPaintLayer(c.WHITE, 1, !1),
                ),
            ...
            case "GConnector":
              ...
              (I.setProperties(
                ...
                [
                  ...
                  !0,
                  a.getTypeId(m),
                  [s.PropertySet.Style, s.PropertySet.BorderPaintLayers],
                ],
              ),
            ...
            case "GHighlighterAnnotation":
              ...
              (Q.setProperties(
                ...
                (D = new s.BorderPaintLayer(
                  new c([248, 206, 28]),
                )).setProperties(["_bw"], [12]),
            ...
            case "GTextAnnotation":
              ...
              (V.setProperties(
                ...
                [
                  ...
                  !0,
                  a.getTypeId(_),
                  [s.PropertySet.Style, s.PropertySet.Text],
                  y.BlendMode.Multiply,
                  c.BLACK,
                ],
              ),
        ...
        (S.prototype._handleChange = function (e, t) {
          (e === r._Change.PrepareRestore && this.clearChildren(),
          ...
          for (var t = this.getFirstChild(); t; t = t.getNext()) {
            ...
            if (i)
              for (var n = i.getFirstChild(); n; n = n.getNext()) {
                var r = n.getProperty("_pt"),
                  o = p.convertColor(r, e);
