...
function (e, t, i) {
      ...
      ((r.ColorMap = function () {}),
        ...
        (r.ColorMap.prototype._itemsIdx = null),
        (r.ColorMap.prototype._colorMap = null),
        (r.ColorMap.prototype.initWhite = function (e) {
          this._itemsIdx = {};
          ...
          ((this._colorMap = new Array(Object.keys(r.ColorMap.Colors).length)),
            (this._colorMap[r.ColorMap.Colors.White] = e.slice()),
            (this._colorMap[r.ColorMap.Colors.Gray] = new Array(e.length)),
            (this._colorMap[r.ColorMap.Colors.Black] = new Array(e.length)));
        }),
        ...
        (r.ColorMap.prototype.setColor = function (e, t) {
          if (t >= r.ColorMap.Colors.White && t <= r.ColorMap.Colors.Black) {
            ...
            if (i && i.color !== t) {
              ...
              ((i.color = t),
                (this._colorMap[i.color][i.idx] = n[i.idx]),
                (n[i.idx] = null));
            }
          }
        }),
        ...
        (r.prototype._edges = {}),
        (r.prototype._anchors = {}),
        (r.prototype._data = null),
