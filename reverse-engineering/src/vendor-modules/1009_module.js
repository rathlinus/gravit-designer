...
function (e, t) {
      ...
      ((i.getCurve = function (e) {
        var t,
          ...
          o = [],
          a = [];
        for (i = 0; i < e.length; i++) ((t = e[i]), o.push(t[0]), a.push(t[1]));
      ...
      var n = (function () {
        function e(e, t) {
          ...
          for (
            ...
            ((r[a] = (t[a + 1] - t[a]) / (e[a + 1] - e[a])),
              a > 0 && (s[a] = (r[a - 1] + r[a]) / 2));
          for (
            s[0] = r[0], s[l - 1] = r[l - 2], A = [], a = 0, f = l - 1;
            0 <= f ? a < f : a > f;
            0 <= f ? (a += 1) : (a -= 1)
          )
            0 === r[a] && A.push(a);
          for (c = 0, u = A.length; c < u; c++) s[(a = A[c])] = s[a + 1] = 0;
          for (
            a = 0, m = l - 1;
            0 <= m ? a < m : a > m;
            0 <= m ? (a += 1) : (a -= 1)
            ...
            ((i[a] = s[a] / r[a]),
              (n[a] = s[a + 1] / r[a]),
              (o[a] = Math.pow(i[a], 2) + Math.pow(n[a], 2)),
              (h[a] = 3 / Math.sqrt(o[a])));
          for (
            A = [], a = 0, y = l - 1;
            0 <= y ? a < y : a > y;
        ...
        return (
          (e.prototype.interpolate = function (e) {
            ...
            for (
              o = h = this.x.length - 2;
              (h <= 0 ? o <= 0 : o >= 0) && !(this.x[o] <= e);
              h <= 0 ? (o += 1) : (o -= 1)
            );
            return (
              (t = this.x[o + 1] - this.x[o]),
              (a = (e - this.x[o]) / t),
              (s = Math.pow(a, 2)),
              (n = (l = Math.pow(a, 3)) - 2 * s + a),
              (i = -2 * l + 3 * s),
              (r = l - s),
              (2 * l - 3 * s + 1) * this.y[o] +
                n * t * this.m[o] +
