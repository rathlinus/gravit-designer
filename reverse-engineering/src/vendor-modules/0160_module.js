...
function (e, t, i) {
      ...
      function Q(e, t) {
        (u.call(this),
          ...
          (this._destroyables = []),
          (this._workspace = e),
          (this._dictionary = new b(this)),
          (this._symbolDictionary = new C(this)),
          (this._trfSettings = {
            borderScale: null,
            scaleCorners: null,
          }),
      ...
      (i(507),
        ...
        (Q.InvalidationFinishedEvent.prototype.toString = function () {
        ...
        (Q.prototype.setAnnotations = function (e) {
          ...
          for (var i = 0; i < t.length; i++) t[i].setAnnotations(e[i]);
        }),
        ...
        (Q.prototype.setCloudSynchronization = function (e) {
          this.setProperties(["cid", "cfs"], [e, !!e]);
        }),
        ...
        (Q.prototype.setCloudAnnotations = function (e) {
          e
            ? this.setProperties(["cid", "can"], [e, !0])
            : this.setProperties(["can"], [!1]);
        }),
        ...
        (Q.prototype.getLabelBBox = function (e) {
          var t = this.getGeometryBBox(),
            i = (this.$lbs + this.$lbp) * (e || 1) * S.getScreenDPI();
        ...
        (Q.prototype._recreateLinksLookup = function () {
          if (this.$_links && this.$__ids) {
            var e = {},
              t = function (i) {
                if (
                  i.hasMixin(r.Reference) &&
                  i.getOldReferenceId() &&
                  this.$_links.hasOwnProperty(i.getOldReferenceId())
                )
                  ((this.$_links[i._referenceId] =
                    this.$_links[i.getOldReferenceId()]),
                    delete this.$_links[i.getOldReferenceId()]);
                else if (i.$rtxt) {
                  var n = 0;
                  (this.acceptChildren(
                    function (t) {
                      if (
                        t.hasMixin(r.Reference) &&
                        (t.getOldReferenceId() || t._referenceId) &&
                        i.$rtxt.indexOf(
                          t.getOldReferenceId() || t._referenceId,
                        ) >= 0
                      ) {
                        ...
                        if (
                          ((this.$_links[t._referenceId] = (o || []).concat([
                            i.getSceneId(),
                          ])),
                ...
                i instanceof d &&
                  i.getAnchorPoints() &&
                  i.getAnchorPoints().accept(t);
              }.bind(this),
              i = this.getProperty("mpg");
            (i && i.accept(t),
              (i = this.getProperty("empg")) && i.accept(t),
              (i = this.getProperty("ompg")) && i.accept(t),
                  ...
                  if (A instanceof v) {
                    ...
                    for (var c = 0; c < a.length; c++) {
                      (_ = a[c]) instanceof u &&
                        _.hasProperty("sref") &&
                        _.getProperty("sref") &&
                        (A.getOldReferenceId() === _.getProperty("sref") &&
                          (_.$sref = A.getReferenceId()),
                        A.getReferenceId() === _.getProperty("sref") &&
                          (l.push(_),
                          h.push(_.getSceneId()),
                          _.hasEventListeners(f) &&
                            _.trigger(new f(A, _, !0))));
                    }
                  } else {
                    ...
                    if (m.length) {
                      ...
                      for (y = m.length - 1; y >= 0; y--) h.splice(m[y], 1);
                    }
                  }
                  (this._linksLookup || (this._linksLookup = {}),
                    (this._linksLookup[s] = l));
                } else
                  (console.warn("Invalid reference id."),
                    delete this.$_links[s]);
              }
            }
            for (var b in e) this._linksLookup[b] = e[b];
            if (
        ...
        (Q.prototype._unsetSceneNode = function (e) {
          if (
            !this.$rb &&
            ((e._scene = this), !this._isRestoring && e.hasMixin(r.Reference))
          ) {
            var t = function () {
              this.hasLinks(e) &&
                this.visitLinks(
            ...
            this._linksAreSane ? t() : this._pendingActions.push(t);
          }
        }),
        (Q.prototype.link = function (e, t) {
          if (!this._isRestoring && !this.$rb) {
            ...
            if ((this._refreshLinks(), this.isLinked(t, e)))
              this.setProperty(
                "_links",
                JSON.parse(JSON.stringify(this.$_links || {})),
              );
            else {
              i = "string" != typeof e ? e.getReferenceId() : e;
              var n = JSON.parse(JSON.stringify(this.$_links || {}));
              (this._linksLookup || (this._linksLookup = {}),
                n.hasOwnProperty(i) ||
                  ((n[i] = []), (this._linksLookup[i] = [])),
                n[i].push(t.getSceneId()),
                this.setProperty("_links", n),
                t instanceof g &&
                  (t._invalidatePaintBoxForChildUpdate(),
                  this._invalidateArea(null, t)));
            }
          }
        }),
        (Q.prototype.unlink = function (e, t) {
          if (!this._isRestoring && !this.$rb && e) {
            ...
            if (n.hasOwnProperty(i))
              (o = (r = n[i]).indexOf(t.getSceneId())) >= 0 &&
                (r.splice(o, 1), 0 === r.length && delete n[i], (a = !0));
            if (!a && this._temporarilyDisabledLinks)
              if (this._temporarilyDisabledLinks.hasOwnProperty(i))
                if ((r = n[i]))
                  (o = r.indexOf(t.getSceneId())) >= 0 &&
                    (r.splice(o, 1), 0 === r.length && delete n[i]);
        ...
        (Q.prototype.visitReferences = function (e, t) {
          if (this._linksAreSane) {
            if (this._linksLookup)
              if ("string" == typeof e)
                for (var i in this._linksLookup) {
                  this.$_links[i].indexOf(e) >= 0 &&
                    t(this._workspace.getReference(i));
                }
              else if (e)
                for (var i in this._linksLookup)
                  this._linkLookupHasSceneNode(i, e) &&
                    t(this._workspace.getReference(i));
          } else
        ...
        (Q.prototype.isLinked = function (e, t) {
          ...
          return (
            !!this.$_links.hasOwnProperty(n) &&
            !(this.$_links[n].indexOf(i) < 0)
          );
        }),
        ...
        (Q.prototype.hasLinks = function (e) {
          ...
          var t = null;
          return (
            (t = "string" == typeof e ? e : e.getReferenceId()),
            this.$_links.hasOwnProperty(t)
          );
        }),
        ...
        (Q.prototype.hasReferences = function (e) {
          if (!e) return !1;
          if ("string" == typeof e) {
            for (var t in this.$_links)
              if (this.$_links[t].indexOf(e) >= 0) return !0;
          } else if (this._linksLookup)
            for (var t in this.$_links)
              if (this._linkLookupHasSceneNode(t, e)) return !0;
          return !1;
        }),
        (Q.prototype.linkCount = function (e) {
          var t = null;
          if (!this._linksAreSane) return -1;
        ...
        (Q.prototype.refCount = function (e) {
          ...
          if (!this._linksAreSane) return -1;
          if ("string" == typeof e)
            for (var i in this.$_links) this.$_links[i].indexOf(e) >= 0 && t++;
          else if (e && this._linksLookup)
            for (var i in this.$_links)
              this._linkLookupHasSceneNode(i, e) >= 0 && t++;
          return t;
        }),
        ...
        (Q.prototype.endBlockReferenceChanges = function (e) {
          (this.setProperty("rb", !1),
            e ||
              (this._cleanupLinks(this.$_links),
              (this._temporarilyDisabledLinks = null)));
        }),
          ...
          for (var i in e) {
            ...
            if (n) {
              for (var r = e[i], o = r.length - 1; o >= 0; o--) {
                ...
                s || (t[i] || (t[i] = []), t[i].push(r[o]), r.splice(o, 1));
              }
              0 === r.length && delete e[i];
            } else ((t[i] = e[i]), delete e[i]);
          }
          return t;
        }),
        ...
        (Q.prototype.getOptimalDecimalsCount = function (e) {
          if (null !== Q.decimalsNum) return Q.decimalsNum;
          var t = 0;
          switch ((e = e || this.$ut)) {
            case A.Unit.IN:
              t = 4;
        ...
        (Q.prototype.getIncrementValue = function (e) {
          var t = 1;
          return (
            ((e = e || this.$ut) != A.Unit.IN && e != A.Unit.CM) || (t = 0.1),
            t
          );
        }),
        ...
        (Q.prototype.refreshPagesPositions = function () {
          try {
            ...
            for (var t = this.getFirstChild(); null !== t; t = t.getNext(), e++)
              ((t._paintBBox = null),
                (t._childrenPaintBBox = null),
                (t._geometryBBox = null),
                (t._preTransformRect = null),
                this._isRestoring || t.refreshPosition());
          } finally {
            this.endUpdate();
          }
        }),
        (Q.prototype.insertPage = function () {
          ...
          ((e = new g()),
            o &&
              [g.VisualProperties, g.GeometryProperties].forEach(function (e) {
                var t = Object.keys(e);
                ((i = i.concat(t)), (n = n.concat(o.getProperties(t))));
              }));
          var a = i.indexOf("off");
          return (
            -1 !== a && (i.splice(a, 1), n.splice(a, 1)),
            e.setProperties(i, n),
            this.appendChild(e),
            r && this.link(r, e),
            e
        ...
        (Q.prototype.getActivePage = function () {
          if (this._activePage && !this._activePage.hasFlag(r.Flag.Active))
            for (var e = this.getFirstChild(); null !== e; e = e.getNext())
              if (e instanceof g && e.hasFlag(r.Flag.Active)) {
                this._activePage = e;
                break;
              }
        ...
        (Q.prototype.setActivePage = function (e) {
          ...
          if (
            t !== e &&
            (t && (t.removeFlag(r.Flag.Active), t.setActiveLayer(null)),
            e && e instanceof g)
          ) {
            var i = t ? this.getIndexOfChild(t) : 0,
              n = this.getIndexOfChild(e);
            ((this._activePage = e),
              e.setFlag(r.Flag.Active),
              this.setProperty("pi", n),
              this._invalidateArea(this._getInvalidationArea([i, n]), null));
          }
        }),
        (Q.prototype.deleteActivePage = function () {
          var e = this.getActivePage();
          if (e) {
            var t = this.getSuccessorActivePage(e);
            t && (this.setActivePage(t), e.getParent().removeChild(e));
          }
        }),
        ...
        (Q.prototype.updateActivePageForElem = function (e) {
          if (e instanceof p) {
            ...
            t && !t.hasFlag(r.Flag.Active) && this.setActivePage(t);
          } else
            e instanceof g &&
              (e.hasFlag(r.Flag.Active) ||
                e.hasFlag(r.Flag.Selected) ||
        ...
        (Q.prototype.updateActiveLayerForElem = function (e) {
          ...
          for (var i = this.getFirstChild(); null !== i; i = i.getNext())
            i instanceof g && i !== t && i.setActiveLayer(null);
        }),
        ...
        (Q.prototype.getStyles = function () {
          ...
          this._styles ||
            ((this._styles = new a()), this.appendChild(this._styles));
        ...
        (Q.prototype._invalidateArea = function (e, t) {
          this.hasEventListeners(Q.InvalidationRequestEvent) &&
            this.trigger(new Q.InvalidationRequestEvent(e, t));
        }),
        (Q.prototype._finishPaint = function (e) {
          this.hasEventListeners(Q.InvalidationFinishedEvent) &&
            this.trigger(
              new Q.InvalidationFinishedEvent(this, e.configuration, !0),
            );
        }),
        (Q.prototype._paintChildren = function (e, t) {
          ...
          if (e.configuration.clipArea && e.canvas.hasClip()) {
            ...
            (e.canvas.clipRect(n.getX(), n.getY(), n.getWidth(), n.getHeight()),
              (i = !0));
          }
          ...
          if (e.configuration.multiPageView) {
            var A = this.retrieveChildrenInPaintBBox(
              e.dirtyMatcher.getDirtyArea(),
              2,
            );
            B.pagesCanOverlap &&
              (A = A.filter(function (e) {
                ...
                return e.hasFlag(r.Flag.Active) && !t.hasFlag(r.Flag.Active)
                  ? 1
                  : t.hasFlag(r.Flag.Active) && !e.hasFlag(r.Flag.Active)
                    ? -1
                    : e.getElementIndex() - t.getElementIndex();
              }));
            for (var c = 0; c < A.length; c++)
              ((node = A[c]),
                node instanceof g &&
                  ...
                  e.dirtyMatcher &&
                    ...
                    s
                      ? e.dirtyMatcher.transform(l.preMultiplied(s.inverted()))
                      : e.dirtyMatcher.transform(l),
                    (s = l)),
                  node.paint(e)));
          } else this.getActivePage().paint(e, t);
        ...
        (Q.prototype.hitTest = function (e, t, i, n, r, o, a, s, l, h, A, c) {
          ...
          if (!A && p)
            return c
              ...
              : u.prototype.hitTest.call(p, e, t, i, n, r, o, a, s, l, h);
          var d = this.getPaintBBox(A);
          if (!d || d.isEmpty()) return null;
          if (
            (t && (d = t.mapRect(d)),
            B.pagesCanOverlap && !d.expanded(o, o, o, o).containsPoint(e))
          )
            return null;
          if (!B.pagesCanOverlap && !d.containsPoint(e)) return null;
          var g = null,
            f = t ? t.inverted().mapPoint(e) : e,
            _ = new m(f.getX() - o / 2, f.getY() - o / 2, o, o),
            v = this.retrieveChildrenInPaintBBox(_, D.RETRIEVE_MODE_INTERSECT);
          ...
          if ((0 == v.length && (v = null), v)) {
            for (var C = 0; C < v.length; C++) {
              ...
              if (
                ((P = t
                  ? t.preMultiplied(new y(1, 0, 0, 1, x.getX(), x.getY()))
                  : new y(1, 0, 0, 1, x.getX(), x.getY())),
                c)
              )
        ...
        (Q.prototype.getCollisions = function (e, t, i, n, r, o, a) {
          var s = this.getActivePage(),
            l = [];
          if (a) return [];
          if (!o && s)
            return u.prototype.getCollisions.call(
              this.getActivePage(),
              e,
              t,
              i,
          ...
          if (o) {
            var h = t & u.CollisionFlag.PaintBBox,
              ...
              p = h
                ? this.retrieveChildrenInPaintBBox(c, A)
                : this.retrieveChildrenInGeometryBBox(c, A);
            p &&
              p.forEach(function (a) {
                var s = a.getPosition(o),
                  h = new y(1, 0, 0, 1, -s.getX(), -s.getY());
                l = l.concat(
                  u.prototype.getCollisions.call(a, new _(e, h), t, i, n, r),
                );
              });
          }
          return l;
        ...
        (Q.prototype.getGeometryBBox = function (e, t) {
          return t
            ? this.getChildrenGeometryBBox(e, t)
            : u.prototype.getGeometryBBox.call(this, e);
        }),
        (Q.prototype._calculateChildrenPaintBBox = function (e, t, i) {
          if (!i && !this.isVisible()) return null;
          for (
            var n = null, r = this.getFirstChild();
            null != r;
            r = r.getNext()
          )
            if (r instanceof g) {
        ...
        (Q.prototype.insertChild = function (e, t) {
          return e instanceof a
            ? (this._isRestoring &&
                (this._styles &&
                  this._styles.getParent() === this &&
                  (this.removeChild(this._styles), (this._styles = e)),
                e.repairSdf()),
              r.Container.prototype.insertChild.call(this, e, t))
            : e instanceof x
              ? r.Container.prototype.insertChild.call(this, e, t)
              : e instanceof g
                ? (r.Container.prototype.insertChild.call(this, e, t),
                  this.isEvenOddMaster()
                    ? this.reassignMasterPages()
                    : this.$mpg && this._fixSingleMpg(e, this.$mpg),
                  void (this.getActivePage() || this.setActivePage(e)))
                : (this._activePage ||
                    ((this._activePage = this.insertPage()),
                    this.isEvenOddMaster() && this.reassignMasterPages(),
                    this._activePage.setFlag(r.Flag.Active)),
                  t instanceof g && (t = null),
                  void this._activePage.insertChild(e, t));
        }),
        (Q.prototype.renameClone = function (e, t) {
          if (e instanceof g && t instanceof g) {
            var i,
              n = e.getProperty("name") || "",
              r = /\s([0-9]+)(?:\.([0-9]+))?(?:\.([0-9]+))?$/,
              o = n.match(r),
              a = [],
              s = n.slice(0, o ? o.index : n.length);
            a = o
              ? o[3]
                ? [parseInt(o[1]), parseInt(o[2]), parseInt(o[3]) + 1]
                : o[2]
                  ? [parseInt(o[1]), parseInt(o[2]), 1]
                  : [parseInt(o[1]), 1]
              : [1];
            (this.iteratePages(function (i) {
              if (i !== e && i !== t) {
                var n = i.$name || "",
                  o = n.match(r);
                n.slice(0, o ? o.index : n.length) === s &&
                  o &&
                  (1 === a.length
                    ? (a[0] = Math.max(a[0], parseInt(o[1]) + 1))
                    : 2 === a.length
                      ? a[0] !== parseInt(o[1]) ||
                        Number.isNaN(parseInt(o[2])) ||
                        (a[1] = Math.max(a[1], parseInt(o[2]) + 1))
                      : 3 === a.length &&
                        (a[0] !== parseInt(o[1]) ||
                          a[1] !== parseInt(o[2]) ||
        ...
        (Q.prototype.removeChild = function (e) {
          (r.Container.prototype.removeChild.call(this, e),
            e instanceof g &&
              this.isEvenOddMaster() &&
              this.reassignMasterPages());
        }),
        (Q.prototype.getProperty = function (e, t, i, n) {
          ...
          return Q.inheritedPageProps.indexOf(e) >= 0
            ? o.getProperty(e, t, i, n)
            : r.Properties.prototype.getProperty.call(this, e, t, i, n);
        }),
        ...
        (Q.prototype._fixSingleMpg = function (e, t) {
          if (!this.$rb && !this._isRestoring) {
            var i = e.getProperty("plkt");
            if (!(i && i & c.ProgramLck.NoEdit))
              (!!t && this.isLinked(e, t)) ||
        ...
        (Q.prototype._refreshLinks = function () {
          if (!this.$rb && this._linksLookup) {
            var e = this._temporarilyDisabledLinks;
            if (e)
              for (var t in e) {
                var i = this.$_links[t];
                if (i)
                ...
                else this.$_links[t] = e[t];
              }
            var n = null,
              r = this;
            for (var t in this.$_links) {
              var a = this._workspace.getReference(t),
                s = [],
                l = [],
                h = [];
              (this._linksLookup.hasOwnProperty(t) &&
                ((h = this._linksLookup[t]),
                (l = h.map(function (e) {
                  return e.getSceneId();
                }))),
                (s = this.$_links[t]).forEach(
                  function (e) {
                    if (l.indexOf(e) < 0) {
                      var t = c()[e];
                      t &&
                        a &&
                        t.hasEventListeners(f) &&
                        t.trigger(new f(a, t, !0));
                    }
                  }.bind(this),
                ),
                h.forEach(
            ...
            for (var t in this._linksLookup)
              if (this.$_links.hasOwnProperty(t)) {
                ((A = this._linksLookup[t]) && A.length) ||
                  delete this._linksLookup[t];
              } else {
                var A = this._linksLookup[t];
        ...
        (Q.prototype._checkLinksSanity = function () {
          ...
          for (var i in e) {
            ...
            if (n.length !== r.length)
              return (console.warn("Links: prop len != dyn len"), !1);
            for (
        ...
        (Q.prototype._handleChange = function (e, t) {
          if (e === r._Change.PrepareRestore) {
            (this._activePage &&
              (this.removeChild(this.getActivePage()),
              (this._activePage = null)),
              t.blob.hasOwnProperty("dictionary")
                ? this._dictionary.deserialize(t.blob.dictionary)
                : (this._pre310 = !0),
              this._symbolDictionary.deserialize(t.blob.symbolDictionary));
            var a = t.blob.cst;
            (a && a instanceof Array && (this.$cst = a),
              (this._isRestoring = !0));
            ...
            (this.storeProperties(
              ...
              function (e, n) {
                ...
                if ("lmd" === e)
                  return t.options && t.options.save
                    ? ((this.$lmd = isNaN(t.options.lastModifiedDate)
                        ? Date.now()
                        : t.options.lastModifiedDate),
                      this.$lmd)
                    : null;
                if ("cfs" === e || "cid" === e) {
                  ...
                  if (t.options && t.options.save)
                    return this._activePage
                      ? this.getIndexOfChild(this._activePage)
                      : 0;
                }
                return n;
              }.bind(this),
            ),
              this.storeProperties(t.blob, Q.GeometryProperties),
              this.storeProperties(t.blob, Q.VisualProperties, function (e, t) {
                return "lbc" === e && t ? n.serialize(t) : t;
              }),
              (t.blob.dictionary = this._dictionary.serialize()),
              (t.blob.symbolDictionary = this._symbolDictionary.serialize()),
              null != this.$mpg && (t.blob.mpg = r.serialize(this.$mpg)),
              null != this.$empg && (t.blob.empg = r.serialize(this.$empg)),
              null != this.$ompg && (t.blob.ompg = r.serialize(this.$ompg)));
            ...
            if (t.blob.hasOwnProperty("$")) {
              ...
              if (s.length)
                for (var h = 0; h < s.length; ++h) {
                  var A = s[h];
                  r._nameToNodeClassMap[A["@"]].toString() === g.toString() &&
                    (l = !0);
                }
              l ||
                (t.blob.hasOwnProperty("h") || (t.blob.h = 0),
                t.blob.hasOwnProperty("w") || (t.blob.w = 0));
            }
            (this.restoreProperties(t.blob, Q.MetaProperties),
              this.restoreProperties(t.blob, Q.GeometryProperties));
            var c = Q.inheritedPageProps.reduce(function (e, i) {
              return (t.blob.hasOwnProperty(i) && (e[i] = null), e);
            }, Q.VisualProperties);
            if (
              (this.restoreProperties(t.blob, c, function (e, t) {
                return ("bck" !== e && "lbc" !== e) || !t
                  ? t
                  : n.deserialize(t);
              }),
              t.blob.hasOwnProperty("mpg"))
            )
              (M = r.deserialize(t.blob.mpg)) &&
                M instanceof g &&
                this.setProperty("mpg", M);
            if (t.blob.hasOwnProperty("ompg"))
              (N = r.deserialize(t.blob.ompg)) &&
                N instanceof g &&
                this.setProperty("ompg", N);
            if (t.blob.hasOwnProperty("empg"))
              (U = r.deserialize(t.blob.empg)) &&
                U instanceof g &&
                this.setProperty("empg", U);
            ...
            if (d >= 0) {
              ...
              if (
                ((this.$lgm = f || this.$gm),
                f === Q.GridMode.Axonometric &&
                  this.$gm !== Q.GridMode.Axonometric)
              ) {
                var m = Q.AXONO_ANGLE1,
                  _ = Q.AXONO_ANGLE2,
                  v = Q.AXONO_GX,
                  b = t.properties.indexOf("ga1"),
                  C = t.properties.indexOf("ga2"),
                  w = t.properties.indexOf("gaw");
                (b < 0 && !this.$ga1
                  ? (t.properties.push("ga1"), t.values.push(Q.AXONO_ANGLE1))
                  : (m = t.values[b]),
                  C < 0 && !this.$ga2
                    ? (t.properties.push("ga2"), t.values.push(Q.AXONO_ANGLE2))
                    : (_ = t.values[C]),
                  !this.$gaw && w < 0
                    ? (t.properties.push("gaw"), t.values.push(Q.AXONO_GX))
                    : w >= 0 && (v = t.values[w]));
                var E = this._getAxonoGYVal(v, m, _),
                  x = t.properties.indexOf("gah");
                null !== E &&
                  (x < 0 && this.$gah !== E
                    ? (t.properties.push("gah"), t.values.push(E))
                    : x >= 0 &&
                      !T.isEqualEps(E, t.values[x], 1e-9) &&
                      (t.values[x] = E));
              } else
                f !== Q.GridMode.Axonometric &&
                  this.$gm === Q.GridMode.Axonometric &&
                  (this.$gy ||
                    (t.properties.push("gy"), t.values.push(this.$gx)));
            } else if (
              this.$gm === Q.GridMode.Axonometric &&
              (t.properties.indexOf("ga1") >= 0 ||
                t.properties.indexOf("ga2") >= 0 ||
                t.properties.indexOf("gaw") >= 0)
            ) {
              ((m =
                (b = t.properties.indexOf("ga1")) >= 0
                  ? t.values[b]
                  : this.$ga1),
                (_ =
                  (C = t.properties.indexOf("ga2")) >= 0
                    ? t.values[C]
                    : this.$ga2),
                (v =
                  (w = t.properties.indexOf("gaw")) >= 0
                    ? t.values[w]
                    : this.$gaw),
                (E = this._getAxonoGYVal(v, m, _)),
                (x = t.properties.indexOf("gah")));
              null !== E &&
                (x < 0 && this.$gah !== E
                  ? (t.properties.push("gah"), t.values.push(E))
            ...
            if (
              ...
              for (h = t.properties.length - 1; h >= 0; h--)
                P[h] >= 0 &&
                  ((S = S.concat(t.properties.splice(h, 1))),
                  (I = I.concat(t.values.splice(h, 1))));
              this.getActivePage() && this.getActivePage().setProperties(S, I);
            }
            if (
              ((R = t.properties.indexOf("_links")) >= 0 &&
                this.$rb &&
                (t.values.splice(R, 1), t.properties.splice(R, 1)),
              t.properties.indexOf("mpg") >= 0)
            )
            ...
            var F = t.properties.indexOf("ms"),
              R = t.properties.indexOf("_links");
            if (
              (F >= 0 &&
                (this.refreshPagesPositions(),
                mpIdx >= 0 &&
                  this._activePage &&
                  (this.getActivePage().removeFlag(r.Flag.Selected),
                  this.getActivePage().removeFlag(r.Flag.Highlighted),
                  this._invalidateArea(null, this.getActivePage()))),
              R >= 0 && this._checkSanityIfNecessary(),
              this._styles)
            )
              t.properties.indexOf("cm") >= 0 &&
                this._styles.setColorMode(
                  this.getProperty("cm") || G.ColorModes.RGB,
                );
          } else if (e === r._Change.BeforeChildRemove)
            this.isFixedSized() &&
              ((this._invalidateFrom = this.getIndexOfChild(t)),
              this._invalidateArea(
                this._getInvalidationArea(this._invalidateFrom),
                null,
              ));
          else if (
            ...
            t &&
              ...
              ((t[1] = !0),
              this._invalidateArea(
                t[2] || this._getInvalidationArea(this.getIndexOfChild(t[0])),
              ));
          else if (
            ...
            var M, N, U;
            ((M = this.getProperty("mpg")) &&
              M._setWorkspace(
                e === r._Change.WorkspaceDetach ? null : this._workspace,
              ),
              (N = this.getProperty("ompg")) &&
                N._setWorkspace(
                  e === r._Change.WorkspaceDetach ? null : this._workspace,
                ),
              (U = this.getProperty("empg")) &&
                U._setWorkspace(
                  e === r._Change.WorkspaceDetach ? null : this._workspace,
                ));
          }
          (this._handleGeometryChangeForProperties(e, t, Q.GeometryProperties),
            this._handleVisualChangeForProperties(e, t, Q.VisualProperties),
            u.prototype._handleChange.call(this, e, t));
        }),
        (Q.prototype._checkSanityIfNecessary = function () {
          if (
            !this._isRestoring &&
            !this.$rb &&
            (this._refreshLinks(), !this._callingPendingActions)
          ) {
        ...
        (Q.prototype.getSwatches = function () {
          ...
          this._swatches ||
            ((this._swatches = new x()), this.appendChild(this._swatches));
        ...
        (Q.prototype.addDestroyable = function (e) {
          e &&
            (e instanceof F
              ...
              : e instanceof F.RendererCanvas
                ? this._destroyables.push(e.parent)
                : e.hasMixin(I) && this._destroyables.push(e));
        }),
        ...
        (Q.prototype.decreaseReferenceCounter = function () {
          if (
            0 !== this._referenceCounter &&
            ((this._referenceCounter = this._referenceCounter - 1),
            0 === this._referenceCounter)
          ) {
