...
function (e, t, i) {
      ...
      function g() {
        (r.apply(this, arguments),
          this._node &&
            this._node instanceof o &&
            this._node.setProperty("sc", !0));
      }
      ...
      (n.inherit(g, r),
        (g.composeQuery = function (e) {
          ...
          var n = "normal",
            r = A.Weight.Regular;
          (t.test(e) && (n = t.exec(e).pop().toLowerCase()),
            i.test(e) && (r = i.exec(e).pop().toLowerCase()));
          var o;
          return {
            fontName: e,
            fontFamily: (function (e) {
              ...
              if (-1 !== t) {
                ...
                (A.Weight[i] || "normal" === i.toLowerCase()) &&
            ...
            fontStyle:
              ((o = n), "normal" === o ? A.Style.Normal : A.Style.Italic),
          };
        }),
          ...
          if (t) {
            ...
            n.width > this._getGeometryBBox().getWidth() &&
              this._node.transform(
                new p().translated(
                  this._getGeometryBBox().getWidth() / 2 - n.width / 2,
                  0,
                ),
              );
          }
        ...
        (g.prototype.parse = function () {
          ...
          if (this._data.style) {
            ...
            if (o && o.encodedAttributes) {
              if (o.encodedAttributes.NSColor)
                (h = l.from(o.encodedAttributes.NSColor._archive)) &&
                  (n = f(h.top()));
              ...
              if (o.encodedAttributes.MSAttributedStringFontAttribute)
                if (
                  (h = l.from(
                    o.encodedAttributes.MSAttributedStringFontAttribute
                      ._archive,
                  ))
                ) {
          ...
          if (
            this._data.attributedString &&
            this._data.attributedString.archivedAttributedString
          ) {
            var h;
            if (
              !(h = l.from(
                this._data.attributedString.archivedAttributedString._archive,
              ))
            )
              ...
              for (var _ = [], v = 0, b = 0; b < y.length; b += 2) {
                ...
                if (
                  (w &&
                    ...
                    w.NSParagraphStyle &&
                      (x = d(
                        w.NSParagraphStyle.NSAlignment || 0,
                        !0,
                      ).toLowerCase())),
                  E && B && x)
                ) {
                  var P = this._file.getFontSearch().getDefaultFont(),
                    S =
                      E.NSFontNameAttribute ||
                      E.NSCTFontUIUsageAttribute ||
                      P.family,
                    T = g.composeQuery(S),
                    I = {
                    ...
                    this._file.getFontSearch().queryFirst(
                      ...
                      function (i) {
                        ((t.fontFamily = i ? i.family : P.family),
                          ...
                          (t.fontStyle =
                            i && i.style !== A.Style.Normal
                              ? "italic"
                              : "normal"));
                        var n = function () {
                          ++v >= _.length &&
                            (this._node.setText(_), e.resolve());
                        }.bind(this);
                        this._file
                          .getFontSearch()
                          .getFont(
          ...
          (c &&
            ...
            i &&
              (F.push("_tfi", "_tff"),
              R.push(E.NSFontSizeAttribute, E.NSFontNameAttribute))),
            0 === this._data.textBehaviour &&
              (this._node._geometryBBox
                ? (F.push("ah"), R.push(!0))
                : (F.push("aw", "ah"), R.push(!0, !0))),
