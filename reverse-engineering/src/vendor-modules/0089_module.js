...
function (e, t, i) {
      ...
      ((a.prototype.parseByte = function () {
        ...
        (a.prototype.parseVersion = function (e) {
          var t = r(this.data, this.offset + this.relativeOffset),
            i = r(this.data, this.offset + this.relativeOffset + 2);
          return (
        ...
        (a.prototype.parseOffset16List = a.prototype.parseUShortList =
          function (e) {
        ...
        (a.prototype.parseList = function (e, t) {
          ...
          for (var i = new Array(e), n = 0; n < e; n++) i[n] = t.call(this);
          return i;
        }),
        ...
        (a.prototype.parsePointer = function (e) {
          ...
          if (t > 0) return new a(this.data, this.offset + t).parseStruct(e);
        }),
