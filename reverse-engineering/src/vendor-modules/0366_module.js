...
function (e, t, i) {
      ...
      (n.inheritAndMix("cmt", a, r, [n.Properties, n.Store]),
        (a.Type = {
          User: 0,
          Open: 1,
          Close: 2,
        ...
        (a.prototype._handleChange = function (e, t) {
          if (e === n._Change.Store)
            this.storeProperties(
              t.blob,
              a.MetaProperties,
              a.prototype.storeAction.bind(this, t),
            );
          else if (e === n._Change.Restore)
            this.restoreProperties(t.blob, a.MetaProperties);
          else if (e === n._Change.BeforePropertiesChange) {
            var i,
              r = t.properties.indexOf("uid"),
              s = t.properties.indexOf("read");
            if (r >= 0 && t.values[r])
              (i =
                s >= 0
                  ? t.values[s]
                  : (this.getProperty("read") || []).slice()) &&
                i.indexOf(t.values[r]) < 0 &&
                (i.push(t.values[r]),
                s < 0 &&
                  ((s = t.properties.length),
                  t.properties.push("read"),
                  t.values.push(i)));
            if (!t.custom && !this.isRestoring()) {
              var l = t.properties.indexOf("mtime");
              l < 0
                ? (t.properties.push("mtime"), t.values.push(o.now()))
                : this.recordedTransaction && (t.values[l] = o.now());
            }
          }
