      ...
      e.exports = function (e) {
        ...
        ((e.prototype.arc = function (t, i, n, r, o, a) {
          (this.__pushByte(e.arc),
            ...
            this.__pushFlt(r),
            this.__pushFlt(o),
            this.__pushByte(a ? 1 : 0),
            this.__call());
        }),
          (e.prototype.__pathStart = null),
          (e.prototype.__pathStartArr = new Float64Array(2)),
          (e.prototype.beginPath = function () {
            ((this.__pathStart = null),
              this.__pushByte(e.beginPath),
              this.__call());
          }),
          (e.prototype.bezierCurveTo = function (t, i, n, r, o, a) {
            (this.__pushByte(e.bezierCurveTo),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__pushFlt(n),
              this.__pushFlt(r),
          ...
          (e.prototype.clearRect = function (t, i, n, r) {
            (a("clearRect :", arguments),
              this.__pushByte(e.clearRect),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__pushFlt(n),
              this.__pushFlt(r),
          ...
          (e.prototype.clip = function (t) {
            (this.__pushByte(e.clip),
              void 0 !== t && this.__pushPtr(t),
              this.__call());
          }),
          (e.prototype.closePath = function (t) {
            (t || ("round" === this.$lineJoin && "round" === this.$lineCap)
              ? this.__pathStart
                ? this.lineTo(this.__pathStart[0], this.__pathStart[1])
                : this.lineTo(0, 0)
              : (this.__pushByte(e.closePath), this.__call()),
              (this.__pathStart = null));
          }),
          ...
          (e.LinearGradient.prototype._render = function () {
            ...
            for (
              var t = e.getFlt(this.ctx),
                i = e.getFlt(this.ctx),
                n = e.getFlt(this.ctx),
                r = e.getFlt(this.ctx),
                o = e
                  .getPtr(this.ctx)
                  .$realCtx.createLinearGradient(t, i, n, r);
              this.ctx.__execPtr < this.ctx.__len;
            ) {
              var a = e.getFlt(this.ctx),
                s = e.getPtr(this.ctx);
              o.addColorStop(a, s);
            }
            return o;
          ...
          (e.RadialGradient.prototype._render = function () {
            ...
            for (
              var t = e.getFlt(this.ctx),
                ...
                s = e
                  .getPtr(this.ctx)
                  .$realCtx.createRadialGradient(t, i, n, r, o, a);
              this.ctx.__execPtr < this.ctx.__len;
            ) {
              var l = e.getFlt(this.ctx),
                h = e.getPtr(this.ctx);
              s.addColorStop(l, h);
            }
            return s;
          ...
          (e.Pattern.prototype._render = function (t, i, n) {
            e.resetExec(this.ctx);
            var r = e.getPtr(this.ctx),
              o = e.getPtr(this.ctx),
              a = e.getPtr(this.ctx);
            r.$type === e.INSTANCE_RENDERERCANVAS &&
              (r = t.render(r.parent, i, null, n));
            var s = void 0;
          ...
          (e.Pattern.prototype._dumpCode = function (t, n, r, o, a) {
            ...
            if (l.$type === e.INSTANCE_RENDERERCANVAS)
              ((A += r.dumpCode(l.parent, !1, null)),
                (l = l.renderingName || l.renderedName));
            else if (
              s &&
              ...
              if (l instanceof HTMLImageElement || l instanceof Image) {
                ...
                ((p.width = l.naturalWidth),
                  (p.height = l.naturalHeight),
          ...
          e.Renderable.inherit(e.ImageDataUint8Array, e.Renderable),
          (e.ImageDataUint8Array.prototype.parentImgData = null),
          (e.ImageDataUint8Array.prototype._render = function () {
          ...
          e.Renderable.inherit(e.ImageDataArray, e.Renderable),
          (e.ImageDataArray.prototype.parentImgData = null),
          (e.ImageDataArray.prototype.$data = null),
          Object.defineProperties(e.ImageDataArray.prototype, {
            uint8Array: {
              get: function () {
                return (
                  this.$data ||
                    (this.$data = new e.ImageDataUint8Array(
                      this.ctx,
                      this.parentImgData,
                    )),
                  this.$data
          ...
          (e.ImageData = function (t, i, n, r, o) {
            ...
            if (o < 1) throw new Error("GRendererCtx: Empty imagedata");
            ((this.sx = i), (this.sy = n), (this.sw = r), (this.sh = o));
          }),
          e.Renderable.inherit(e.ImageData, e.Renderable),
          (e.ImageData.prototype.sx = 0),
          (e.ImageData.prototype.sy = 0),
          (e.ImageData.prototype.sw = 0),
          (e.ImageData.prototype.sh = 0),
          (e.ImageData.prototype.$data = null),
          Object.defineProperties(e.ImageData.prototype, {
            data: {
              get: function () {
                return (
                  this.$data ||
                    (this.$data = new e.ImageDataArray(this.ctx, this)),
                  this.$data
                );
              },
            },
          }),
          (e.ImageData.prototype.imgCtx = null),
          (e.ImageData.prototype._render = function () {
            var t = this.ctx.$realCtx.getImageData(
              this.sx,
              this.sy,
              this.sw,
              this.sh,
            ...
            if (this.imgCtx)
              for (
                e.resetExec(this.imgCtx);
                this.imgCtx.__execPtr < this.imgCtx.__len;
              ) {
                var i = e.getPtr(this.imgCtx),
                  n = e.getFlt(this.imgCtx),
                  r = e.getFlt(this.imgCtx),
                  o = e.getPtr(this.imgCtx);
                i(t.data, n, r, o);
              }
            return t;
          }),
          (e.ImageData.prototype.runModifier = function (i, n, r, o) {
            n < 1 ||
              r < 1 ||
              (this.imgCtx || (this.imgCtx = new e(t)),
              this.imgCtx.__pushPtrT(i),
              this.imgCtx.__pushFltT(n),
              this.imgCtx.__pushFltT(r),
              this.imgCtx.__pushPtrT(o));
          }),
          (e.ImageData.prototype._dumpCode = function (t, i) {
            ...
            return (
              this.imgCtx &&
                (e.resetExec(this.ctx),
                this.imgCtx.__execPtr < this.imgCtx.__len &&
                  (n += "// some modifier executed on data.\n")),
              n
            );
          }),
          ...
          (e.prototype.createPattern = function (t, i) {
            ...
            return (
              t.$type === e.INSTANCE_RENDERERCANVAS &&
                t.parent !== this &&
                (t.parent._flush(this), t.parent.__finish(this)),
              n
            );
          }),
          ...
          (e.prototype.drawImage = function (t, i, n, r, o, a, s, l, h) {
            (this.__pushByte(e.drawImage),
              this.__pushPtr(t),
              this.__pushFlt(i),
              this.__pushFlt(n),
              void 0 !== r && (this.__pushPtr(r), this.__pushPtr(o)),
              void 0 !== a &&
                (this.__pushPtr(a),
                this.__pushPtr(s),
                this.__pushPtr(l),
          ...
          (e.prototype.fill = function (t) {
            ((this.__pathStart = null),
              this.__pushByte(e.fill),
              this.__pushPtr(t),
              this.__call());
          }),
          (e.prototype.fillRect = function (t, i, n, r) {
            (this.__pushByte(e.fillRect),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__pushFlt(n),
              this.__pushFlt(r),
          ...
          (e.prototype.getImageData = function (t, i, r, o) {
            return (
              n ||
                ((n = !0),
                console.warn("Warning: using slow function getImageData")),
              r < 1 || o < 1 ? null : new e.ImageData(this, t, i, r, o)
            );
          }),
          (e.prototype.flushCanvas = function () {
            (r ||
              ((r = !0), console.warn("Warning: using slow flush function")),
          ...
          (e.prototype.putImageData = function (t, i, n) {
            (this.__pushByte(e.putImageData),
              this.__pushPtr(t),
              this.__pushFlt(i),
              this.__pushFlt(n),
              this.__call());
          ...
          (e.prototype.moveTo = function (t, i) {
            (this.__pathStart ||
              ((this.__pathStart = this.__pathStartArr),
              (this.__pathStart[0] = t),
              (this.__pathStart[1] = i)),
              this.__pushByte(e.moveTo),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__call());
          }),
          (e.prototype.quadraticCurveTo = function (t, i, n, r) {
            (this.__pushByte(e.quadraticCurveTo),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__pushFlt(n),
              this.__pushFlt(r),
          ...
          (e.prototype.save = function () {
            ...
            (this.$restoreCount++,
              (this.$maxRestoreCount = this.$restoreCount));
          }),
          (e.prototype.scale = function (t, i) {
            (a("scale:", arguments),
              this.__pushByte(e.scale),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__call());
          }),
          (e.prototype.setLineDash = function (t) {
            (this.__pushByte(e.setLineDash),
              this.__pushPtr(t),
              this.__call(),
              (this.$lineDash = t));
          }),
          (e.prototype.setTransform = function (t, i, n, r, o, a) {
            (this.__pushByte(e.setTransform),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__pushFlt(n),
              this.__pushFlt(r),
          ...
          (e.prototype.stroke = function () {
            ((this.__pathStart = null),
              this.__pushByte(e.stroke),
              this.__call());
          }),
          (e.prototype.strokeRect = function (t, i, n, r) {
            (this.__pushByte(e.strokeRect),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__pushFlt(n),
              this.__pushFlt(r),
          ...
          (e.prototype.translate = function (t, i) {
            (this.__pushByte(e.translate),
              this.__pushFlt(t),
              this.__pushFlt(i),
              this.__call());
          }),
          (e.prototype.$realCtx = null),
          (e.prototype.$fillStyle = "#000"),
          (e.prototype.$filter = "none"),
          (e.prototype.$globalAlpha = 1),
          (e.prototype.$globalCompositeOperation = "source-over"),
          (e.prototype.$lineDashOffset = 0),
          (e.prototype.$lineWidth = 1),
          (e.prototype.$lineCap = "butt"),
          (e.prototype.$lineJoin = "miter"),
          ...
          (e.prototype.$savedProperties = null),
          (e.prototype.$restoreCount = 0),
          (e.prototype.$maxRestoreCount = 0),
          (e.prototype.$shadowColor = "rgba(0, 0, 0, 0)"),
          (e.prototype.$shadowOffsetX = 0),
          (e.prototype.$shadowOffsetY = 0),
          (e.prototype.$shadowBlur = 0));
        var o = [
          "lighter",
          "xor",
          "copy",
        ...
        (Object.defineProperties(e.prototype, {
          fillStyle: {
            ...
            set: function (t) {
              (a("setting fillStyle:", t),
                (this.$fillStyle = t),
                this.__pushByte(e.fillStyle),
                this.__pushPtr(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          globalAlpha: {
            ...
            set: function (t) {
              (a("setting globalAlpha:", t),
                (this.$globalAlpha = t),
                this.__pushByte(e.globalAlpha),
                this.__pushFlt(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          globalCompositeOperation: {
            ...
            set: function (t) {
              (a("setting globalCompositeOperation:", t),
                o.indexOf(t) < 0 ||
                  ((this.$globalCompositeOperation = t),
                  this.__pushByte(e.globalCompositeOperation),
                  this.__pushPtr(t),
                  this.__mov()));
            },
            enumerable: !0,
          ...
          lineDashOffset: {
            ...
            set: function (t) {
              ((this.$lineDashOffset = t),
                this.__pushByte(e.lineDashOffset),
                this.__pushFlt(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          lineWidth: {
            ...
            set: function (t) {
              (a("setting lineWidth:", t),
                (this.$lineWidth = t),
                this.__pushByte(e.lineWidth),
                this.__pushFlt(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          textBaseline: {
            ...
            set: function (t) {
              ((this.$textBaseline = t),
                this.__pushByte(e.textBaseline),
                this.__pushPtr(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          textAlign: {
            ...
            set: function (t) {
              (a("setting textAlign:", t),
                (this.$textAlign = t),
                this.__pushByte(e.textAlign),
                this.__pushPtr(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          imageSmoothingEnabled: {
            ...
            set: function (t) {
              (a("setting imageSmoothingEnabled: ", t),
                (this.$imageSmoothingEnabled = t),
                this.__pushByte(e.imageSmoothingEnabled),
                this.__pushPtr(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          imageSmoothingQuality: {
            ...
            set: function (t) {
              (a("setting imageSmoothQuality:", t),
                (this.$imageSmoothingQuality = t),
                this.__pushByte(e.imageSmoothingQuality),
                this.__pushPtr(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          shadowBlur: {
            ...
            set: function (t) {
              (a("setting shadowBlur:", t),
                (this.$shadowBlur = t),
                this.__pushByte(e.shadowBlur),
                this.__pushFlt(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          shadowColor: {
            ...
            set: function (t) {
              (a("setting shadowColor:", t),
                (this.$shadowColor = t),
                this.__pushByte(e.shadowColor),
                this.__pushPtr(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          shadowOffsetX: {
            ...
            set: function (t) {
              (a("setting shadowOffsetX:", t),
                (this.$shadowOffsetX = t),
                this.__pushByte(e.shadowOffsetX),
                this.__pushFlt(t),
                this.__mov());
            },
            enumerable: !0,
          ...
          shadowOffsetY: {
            ...
            set: function (t) {
              (a("setting shadowOffsetY:", t),
                (this.$shadowOffsetY = t),
                this.__pushByte(e.shadowOffsetY),
                this.__pushFlt(t),
                this.__mov());
            },
            enumerable: !0,
