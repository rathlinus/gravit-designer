...
function (e, t, i) {
      ...
      var l = o.cwrap("hb_buffer_create", "number"),
        h = o.cwrap("hb_buffer_add_utf8", null, [
          "number",
          "string",
          "number",
          "number",
        ...
        A = o.cwrap("hb_buffer_guess_segment_properties", "number", ["number"]),
        c = o.cwrap("hb_shape", null, ["number", "number", "number", "number"]),
        p = o.cwrap("hb_buffer_destroy", null, ["number"]),
        u = o.cwrap("hb_buffer_get_language", "number", ["number"]),
        d = o.cwrap("hb_buffer_set_language", null, ["number", "number"]),
        g = o.cwrap("hb_language_to_string", "string", ["number"]),
        f = o.cwrap("hb_language_from_string", "number", ["string", "number"]),
        m = o.cwrap("hb_buffer_get_direction", "number", ["number"]),
        y = o.cwrap("hb_buffer_set_direction", null, ["number", "number"]),
        _ = o.cwrap("hb_direction_to_string", "string", ["number"]),
        v = o.cwrap("hb_direction_from_string", "number", ["string", "number"]),
        b = o.cwrap("hb_buffer_reverse", null, ["number"]),
        C = o.cwrap("hb_buffer_get_script", "number", ["number"]),
        w = o.cwrap("hb_buffer_set_script", null, ["number", "number"]),
        E = o.cwrap("hb_script_get_horizontal_direction", "number", ["number"]),
        B = o.cwrap("hb_font_set_scale", null, ["number", "number", "number"]),
      ...
      ((s.createFontFromArrayBuffer = function (e) {
        ...
        var t = new Uint8Array(e),
          i = o._malloc(t.length * t.BYTES_PER_ELEMENT);
        o.HEAPU8.set(t, i);
        var n = o._hb_blob_create(i, t.length, 1, 0, 0),
          r = o._hb_face_create(n, 0),
          a = o._hb_font_create(r);
        return new s.Font(a);
      }),
        ...
        (s.Buffer = function (e) {
          ((this._text = e),
            (this._hbBuffer = l()),
            h(this._hbBuffer, this._text, -1, 0, -1),
            A(this._hbBuffer));
        }),
        (s.Buffer.prototype._text = null),
        (s.Buffer.prototype._hbBuffer = null),
        (s.Buffer.prototype.getLanguage = function () {
          if (!this._text)
        ...
        (s.Buffer.prototype.getScript = function () {
          ...
          if (e === s.SCRIPTS.INVALID) {
            var t = this._text.codePointAt(0);
            if (t >= 65280 && t <= 65519) return s.SCRIPTS.KATAKANA;
          }
          return e;
        }),
        (s.Buffer.prototype.setScript = function (e) {
          if ("number" != typeof e)
            throw new Error(
              "Script must be a 32bit integer from GHarfBuzz.SCRIPTS array",
            );
        ...
        (s.Font = function (e) {
          if ("number" != typeof e) throw new Error("Invalid font provided");
          this._font = e;
        }),
        (s.Font.prototype._font = null),
        (s.Font.prototype._stylisticSet = null),
        (s.Font.prototype.setScale = function (e) {
          B(this._font, e, e);
        }),
        (s.Font.prototype.setVariations = function (e) {
          for (
            var t = Object.keys(e),
              i = Object.values(e),
              n = o._malloc(8 * e.length),
              r = 0;
            r < t.length;
            r++
          ) {
            var s = a.apply(null, t[r].split("")),
              l = i[r];
            (o.setValue(n + 8 * r, s, "i32"),
              o.setValue(n + 8 * r + 4, l, "float"));
          }
          x(this._font, n, t.length);
        }),
        ...
        (s.Font.prototype.getGlyphs = function (e) {
          ...
          for (
            var i = o._hb_buffer_get_length(e._hbBuffer),
              n = o._hb_buffer_get_glyph_infos(e._hbBuffer, 0),
              r = o._hb_buffer_get_glyph_positions(e._hbBuffer, 0),
              a = [],
              l = 0;
            l < i;
            l++
          ) {
            var h = o.HEAPU32[n / 4 + 5 * l + 0],
              A = o.HEAPU32[n / 4 + 5 * l + 1],
              p = o.HEAPU32[n / 4 + 5 * l + 2],
              u = o.HEAP32[r / 4 + 5 * l + 0],
              d = o.HEAP32[r / 4 + 5 * l + 1],
              g = o.HEAP32[r / 4 + 5 * l + 2],
              f = o.HEAP32[r / 4 + 5 * l + 3];
            a.push({
              codepoint: h,
              mask: A,
              cluster: p,
