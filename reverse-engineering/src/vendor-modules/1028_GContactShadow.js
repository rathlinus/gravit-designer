      ...
      (o.inherit("contactShadowEffect", g, a.Effect),
        ...
        (g.equals = function (e, t) {
          return (
            ...
            e.arePropertiesEqual(
              t,
              Object.keys(g.GeometryProperties).concat(
                Object.keys(g.VisualProperties),
              ),
            )
          );
        }),
        ...
        (g.prototype.getEffectPadding = function (e) {
          ...
          (e && (this._savedBBox = e),
            t &&
              (this._savedBBox &&
                (this._savedBBox = this._savedBBox.expanded(
                  t[0],
                  t[1],
                  t[2],
                  t[3],
              ...
              (this._padding = t[3])));
          var i = this._savedBBox
            ? this._getIsometricTransform().mapRect(this._savedBBox).getHeight()
            : 0;
          return [
            this.$r,
            this.$r - i - this.$o,
        ...
        (g.prototype.render = function (e, t, i, n, o, a) {
          if (this.$pat && this.$opc > 0) {
            ...
            var u = t.getOffset(),
              ...
              g = (this._padding || 0) * n,
              f =
                this._getIsometricTransform()
                  .mapRect(this._savedBBox)
                  .getHeight() * n,
              m = this.$r * n,
              y = this.$o * n,
              _ = u.getX(),
              ...
              b = new s()
                .translated(_, v)
                .preMultiplied(this._getIsometricTransform()),
              C = t.setTransform(t.getTransform(!0).preMultiplied(b));
            (t.drawImage(e, 0, 0, 1, this.$opc),
              t.setScale(p),
              t.setTransform(C));
            var w = this.$pat;
            if (!(w instanceof r))
              if (w instanceof h) {
                var E = w.getStops();
                w =
                  E && E[0] && E[0].color && E[0].color instanceof r
                    ? E[0].color
                    : l.BLACK;
              } else w = l.BLACK;
            var B = new h([
            ...
            m > 0 &&
              ((this._blur.$r = this.$r),
              this._blur.render(t, null, null, n, o, a));
          }
        }),
