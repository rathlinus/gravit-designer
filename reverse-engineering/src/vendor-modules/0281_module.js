...
function (e, t, i) {
      ...
      (r.inherit(l, n),
        ...
        (l.ResolveFontEvent.prototype.weight = null),
        (l.ResolveFontEvent.prototype.resolved = null),
        (l.ResolveFontEvent.prototype.failed = null),
        (l.ResolveFontEvent.prototype.toString = function () {
        ...
        (l.QueryFontFamilyEvent.prototype.toString = function () {
          return "[Event GFontManager.QueryFontFamilyEvent]";
        }),
        (l.prototype._defaultFont = null),
        (l.prototype._defaultStyles = null),
        (l.prototype._defaultWeights = null),
        (l.prototype._fonts = null),
          ...
          return r && r.isResolved()
            ...
            : this.hasEventListeners(l.ResolveFontEvent)
              ? (r || ((r = new s(e, t, i)), this._fonts.push(r)),
                r.setFailed(!1),
                this.trigger(
                  new l.ResolveFontEvent(
                    e,
                    t,
                    i,
                    this._resolvedFont.bind(this),
                    this._unresolvedFont.bind(this, r),
                    n,
                  ),
                ),
                this._getFont(e, t, i))
        ...
        (l.prototype.queryFontFamily = function (e) {
          if (this.hasEventListeners(l.QueryFontFamilyEvent)) {
            ...
            return (
              this.trigger(
                new l.QueryFontFamilyEvent(e, function (e) {
                  t = e;
                }),
              ),
              t
        ...
        (l.prototype._unresolvedFont = function (e) {
          (e.setFailed(!0),
            this.hasEventListeners(l.FontUnavailableEvent) &&
              this.trigger(new l.FontUnavailableEvent(e)));
        }),
            ...
            for (var t = 0; t < this._fonts.length; ++t)
              if (o.equals(this._fonts[t], e) && !this._fonts[t].isResolved()) {
                ((this._fonts[t] = e),
                  ...
                  this.hasEventListeners(l.FontAvailableEvent) &&
                    this.trigger(new l.FontAvailableEvent(e)));
                break;
              }
        }),
        (e.exports = l));
