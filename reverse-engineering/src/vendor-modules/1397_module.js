...
function (e, t, i) {
      ...
      (l.inherit(p, r),
        ...
        (p.prototype.paintInlineImageXObject = function (e) {
          ...
          var r,
            o,
            a = n.mozCurrentTransformInverse,
            l = a[0],
            p = a[1],
            u = Math.max(Math.sqrt(l * l + p * p), 1),
            d = a[2],
            g = a[3],
            f = Math.max(Math.sqrt(d * d + g * g), 1);
          if (e instanceof HTMLElement || !e.data) r = e;
          else {
            ...
            (!(function (e, t) {
              if ("undefined" != typeof ImageData && t instanceof ImageData)
                ...
                var i,
                  ...
                  d = (l - u) / 16,
                  g = 0 === u ? d : d + 1,
                  f = e.createImageData(p, 16),
                  m = 0,
                  y = t.data,
                  _ = f.data;
                if (t.kind === h) {
                  var v = y.byteLength,
                    b = new Uint32Array(_.buffer, 0, _.byteLength >> 2),
                    C = b.length,
                    w = (p + 7) >> 3,
                    E = 4294967295,
                    B = s.littleEndian ? 4278190080 : 255;
                  for (n = 0; n < g; n++) {
                  ...
                  for (r = 0, a = 16 * p * 4, n = 0; n < d; n++)
                    (_.set(y.subarray(m, m + a)),
                      (m += a),
                      e.putImageData(f, 0, r),
                      (r += 16));
                  n < g &&
                    ((a = p * u * 4),
                    _.set(y.subarray(m, m + a)),
          ...
          for (
            var _ = t, v = i, b = "prescale1";
            (u > 2 && _ > 1) || (f > 2 && v > 1);
          ) {
            var C = _,
              w = v;
            (u > 2 && _ > 1 && (u /= _ / (C = Math.ceil(_ / 2))),
              f > 2 && v > 1 && (f /= v / (w = Math.ceil(v / 2))),
              (y = (o = this.cachedCanvases.getCanvas(b, C, w))
                .context).clearRect(0, 0, C, w),
              y.drawImage(r, 0, 0, _, v, 0, 0, C, w),
              (r = o.canvas),
              (_ = C),
              (v = w),
              (b = "prescale1" === b ? "prescale2" : "prescale1"));
          }
