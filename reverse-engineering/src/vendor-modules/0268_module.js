...
function (e, t, i) {
      ...
      (o.inherit("connector", p, n),
        (p.prototype._srcPath = null),
        (p.prototype._dstPath = null),
        (p.prototype.connect = function (e, t) {
          ((this._srcPath = e),
            (this._dstPath = t),
            this._scene.link(this._anchorPoints.getFirstChild(), this._srcPath),
            this._scene.link(this._anchorPoints.getLastChild(), this._dstPath),
            this._relayoutConnectors());
        }),
        ...
        (p.prototype.relayout = function () {
          if (
            this._anchorPoints &&
            this._anchorPoints.getFirstChild() &&
            this._anchorPoints.getLastChild()
          ) {
            if (!this._srcPath || !this._dstPath) return null;
            var e = this._srcPath.getGeometryBBox(),
              t = this._dstPath.getGeometryBBox();
            if (!e || !t) return null;
            var i,
              n,
              r,
            ...
            a.forEach(function (e) {
              s.forEach(function (t) {
                var o = e.pt,
                  a = t.pt,
                  s = h.ptDist(o.getX(), o.getY(), a.getX(), a.getY());
                (!i || s < i) && ((i = s), (n = e), (r = t));
              });
            });
            var A = n.pt,
            ...
            (this._anchorPoints
              .getFirstChild()
              .setProperties(["x", "y"], [A.getX(), A.getY()]),
              this._anchorPoints
                .getLastChild()
                .setProperties(["x", "y"], [c.getX(), c.getY()]));
          }
        }),
          ...
          var e = function (e, t) {
              ...
              return (
                this._scene.visitReferences(
                  e,
                  function (e) {
                    e instanceof s.AnchorPoint &&
                      "connector" === o.getName(e.getPath()) &&
                      t === e.getPath().getDstPath() &&
                      i.push(e.getPath());
                  }.bind(this),
                ),
                i
            ...
            t = e(this._srcPath, this._dstPath)
              .concat(e(this._dstPath, this._srcPath))
        ...
        (p.prototype.attachPath = function (e, t) {
          e === this._anchorPoints.getFirstChild()
            ? (this._srcPath = t)
            : (this._dstPath = t);
        }),
        ...
        (p.prototype.transformAnchors = function (e) {
          ...
          for (
            ...
            t.transferProperties(t._getTransformedCopy(e), [
              s.AnchorPoint.GeometryProperties,
            ]);
