...
function (e, t, i) {
      ...
      (n.inheritAndMix("image", x, p, [B]),
        ...
        (x.NO_IMAGE_WIDTH = 100),
        (x.NO_IMAGE_HEIGHT = 100),
        (x.NO_IMAGE_BACKGROUND = new a([240, 240, 240])),
        (x.NO_IMAGE_ERROR_STROKE = new a([255, 0, 0])),
        ...
        (x.prototype.getImageCanvas = function () {
          if (!this._imageCanvas && this._image) {
            ...
            return (
              (e.width = this._image.naturalWidth),
              (e.height = this._image.naturalHeight),
        ...
        (x.prototype.validateInsertion = function (e, t) {
          return (
            "imagegrid.images" === n.getName(e) ||
            p.prototype.validateInsertion.call(this, e, t)
          );
        }),
        (x.prototype._calculateGeometryBBox = function (e) {
          ...
          if (this.$dblMode) {
            ...
            (this.$itrf && (n = this.$itrf.mapRect(n)),
              n && t && (t = t.united(n)));
          }
          return t;
        }),
        ...
        (x.prototype.preTransformImage = function (e) {
          this.$dblMode &&
            ...
            this.setProperties(
              ["itrf"],
              [this.$itrf ? e.multiplied(this.$itrf) : e],
            );
        }),
        (x.prototype.transform = function (e, t, i) {
          this.$dblMode
            ? p.prototype.transform.call(this, e, t)
            : e &&
              !e.isIdentity() &&
              ...
              d.Transform.prototype.transform.call(this, e, t, i),
              this._relayoutNow &&
        ...
        (x.prototype.assignPreTransformFrom = function (e, t) {
          if (t instanceof x) {
            var i = t.getTransform() || new g(),
              n = t.getImageTransform() || new g();
            this.setProperties(
              ["trf", "itrf"],
              [e.multiplied(i), e.multiplied(n)],
            );
        ...
        (x.prototype.preTransform = function (e, t, i) {
          if (this.$dblMode) p.prototype.preTransform.call(this, e, !1);
            ...
            (this.transformStyledCorners(this, n),
              ...
              d.Transform.prototype.preTransform.call(this, e, t, i),
              this._relayoutNow &&
                (this._layoutAnchorContents(null, null, this._layoutTransform),
                (this._layoutTransform = null),
                (this._relayoutNow = !1)));
        ...
        (x.prototype.setBounds = function (e, t, i, n) {
          if (!this.$dblMode) {
            var r =
                i > d.Transform.MinimalDimention
                  ? i
                  : d.Transform.MinimalDimention,
              o =
                n > d.Transform.MinimalDimention
                  ? n
                  : d.Transform.MinimalDimention,
              a = this.getGeometryBBox(),
              s = a.getWidth(),
              l = a.getHeight(),
              h = s > 0 ? r / s : 0,
              A = l > 0 ? o / l : 0,
              c = new g()
                .translated(-a.getX(), -a.getY())
                .scaled(h, A)
                .translated(e, t);
            c.isIdentity() ||
              this.setProperties(
        ...
        (x.prototype.setTransform = function (e) {
          this.setProperties(["trf", "itrf"], [e, e]);
        }),
        (x.prototype._detailHitTest = function (e, t, i, n) {
          var r = null;
          if (this._imageCanvas) {
            var o = new g();
            (this.$itrf && (o = o.multiplied(this.$itrf)),
              t && (o = o.multiplied(t)));
            ...
            for (
              var h,
                A,
                c,
                u = 1 + 2 * (i = Math.floor(i + 0.5 * t.getScaleFactor())),
                d = this._imageCanvas
                  .getContext("2d")
                  .getImageData(s - i, l - i, u, u),
                f = d ? d.data : [0, 0, 0],
                y = Number.MAX_VALUE,
                _ = NaN,
                v = 3;
              ...
              0 !== f[v] &&
                (h =
                  ...
                  (i - (c = (v >> 2) / u)) * (i - c)) < y &&
                ((y = h), (_ = v));
            if (Math.sqrt(y) > i) return null;
            r = f.slice(_ - 3, _ + 1);
          } else
            this._status === x.ImageStatus.Loaded &&
              this._image &&
              (r = [0, 0, 0, 255]);
          var b = p.prototype._detailHitTest.call(
            this,
            e,
            t,
            i,
          ...
          (e === n._Change.Store
            ? (this.storeProperties(
              ...
              this.storeProperties(t.blob, x.MetaProperties, function (e, i) {
                return ("tmpUrl" !== e && "storedUrl" !== e) || !t.options.save
                  ? i
                  : null;
              }),
              this.storeProperties(
            ...
            : e == n._Change.BeforePropertiesChange
              ? t.properties.indexOf("url") >= 0 &&
                this._scene &&
                this._scene.getDictionary().removeEntry(this.$url)
              : e == n._Change.AfterPropertiesChange
                ? (t.properties.indexOf("tmpUrl") >= 0 &&
                    this._updateTemporaryImage(),
                  t.properties.indexOf("url") >= 0 &&
                    !this._updatingUrl &&
                    ((this._updatingUrl = !0),
                    (this.$storedUrl = null),
                ...
                : (e !== r._Change.SceneAttached &&
                    e !== n._Change.WorkspaceAttached) ||
                  ((this._updatingUrl = !0),
                  this._updateUrl(),
                  this._scene && this._scene.addDestroyable(this),
                  this._workspace &&
                    this._scene &&
                    this._status === x.ImageStatus.Delayed &&
                    this._updateImage(),
                  (this._updatingUrl = !1)),
            ...
            e === n._Change.Restore &&
              (this.restoreProperties(t.blob, x.VisualProperties),
              ...
              !this.$trf ||
                ...
                this.$pw ||
                this.$ph ||
                this.setProperties(["itrf"], [this.$trf]),
              (this._updatingUrl = !0),
              this._updateUrl(),
              this._updateImage(),
              (this._updatingUrl = !1)));
        ...
        (x.prototype._updateUrl = function () {
          if (this._scene) {
            ...
            if (
              ...
              i &&
                (null === e &&
                  (this._status !== x.ImageStatus.Loaded || this._imageCanvas
                    ? ((this._imageCanvas = null),
                      (this._imageCanvasOffscreen = null))
                    : ((this._image = null),
                      (this._imageCanvasOffscreen = null))),
                this.setProperty("url", i.getUrl()));
            }
          }
        }),
        (x.prototype._paintFillLayers = function (e, t, i) {
          (this.$ipfc &&
            ...
            this._paintImageCanvas(e, e.canvas, null, null),
            y.each(
              i,
              function (i, n) {
        ...
        (x.prototype._paintStyleSeparate = function (e, t, i, n, r, o) {
          this._status !== x.ImageStatus.Loaded ||
          (!this._imageCanvas && !this._image) ||
          this.hasStyleFill() ||
          this.hasStyleBorder() ||
          o
            ? l.prototype._paintStyleSeparate.call(this, e, t, i, n, r)
            : this._paintCompositedWithBackground(
                e.canvas,
                this._paintImageCanvas.bind(this, e),
              );
        }),
        (x.prototype._getProperImageCanvas = function (e) {
          if (E.isMultiThreaded(e.canvas.parent)) {
            ...
            if (this._imageCanvas && E.isMultiThreaded(this._imageCanvas))
              return (
                (this._imageCanvasOffscreen = this._imageCanvas),
                this._imageCanvas
              );
            var t,
              i,
              n = this._imageCanvas || this._image;
            this._imageCanvas
              ? ((t = this._imageCanvas.width), (i = this._imageCanvas.height))
              : ((t = this._image.naturalWidth),
                (i = this._image.naturalHeight));
        ...
        (x.prototype._paintImageCanvas = function (e, t, i, n) {
          if (
            this._imageCanvas ||
            (this._status === x.ImageStatus.Loaded && this._image)
          ) {
            var r = !1,
              o = null;
            t.hasClip() &&
            (this.$dblMode ||
              (this.$uf &&
                (this.$tl_ct !== f.CornerType.Rounded || 0 === this.$tl_sx)))
              ? (t.putVertices(this), t.clipVertices(), (r = !0))
              : (o = e.pushCanvas(
                  e.canvas.createCanvas(
            ...
            (t.fillRect(
              ...
              this.$pw ? this.$pw : this.getWidth(),
              this.$ph ? this.$ph : this.getHeight(),
              x.NO_IMAGE_BACKGROUND,
            ),
              this._status === x.ImageStatus.Error &&
                (t.strokeLine(
                  this.$px,
                  this.$py,
                  this.$pw ? this.$pw : this.getWidth(),
        ...
        (x.prototype.isReady = function () {
          return (
            (this._image || this._imageCanvas) &&
            this._status === x.ImageStatus.Loaded
          );
        }),
        (x.prototype.getWidth = function () {
          return this._status === x.ImageStatus.Loaded &&
            (this._image || this._imageCanvas)
            ? this._imageCanvas
        ...
        (x.prototype._updateTemporaryImage = function () {
          if (this.$tmpUrl && this._status !== x.ImageStatus.Loaded) {
            ...
            ((e.width = this.getWidth()),
              ...
              this.$tmpUrl && this.$tmpUrl.match(/^(http|https|\/\/)/)
              ...
              (e.onload = function () {
                this._status !== x.ImageStatus.Loaded &&
                  0 !== e.naturalWidth &&
                  0 !== e.naturalHeight &&
                  (this._notifyChange(d._Change.PrepareGeometryUpdate),
                  this._initImageCanvas(e),
                  this._updateImageRect(0, 0, e.naturalWidth, e.naturalHeight),
        ...
        (x.prototype._updateImage = function () {
          ((this._sourceBBox = null),
            this._workspace && this._scene && this.$url
              ? (this._setStatus(x.ImageStatus.Resolving),
                this._workspace.resolveUrl(
                  this.$url,
                  this._resolvedImage.bind(this),
                  this.getScene(),
                ))
              : this._setStatus(x.ImageStatus.Delayed));
        }),
        (x.prototype.forceImageUpdate = function () {
          this.$url &&
            0 === this.$url.indexOf("data:") &&
            (this._setStatus(x.ImageStatus.Resolving),
            this._resolvedImage(this.$url));
        }),
        ...
        (x.prototype._getType = function (e) {
          for (
            var t = new Uint8ClampedArray(e),
              i = Object.keys(x.Type).map(function (e) {
                return x.Type[e];
              }),
              n = 0;
            n < i.length;
            ...
            var r = x._BOM[i[n]],
              o = Array.from(t.slice(0, r.length));
            if (y.equals(o, r)) return i[n];
          }
        }),
        (x.prototype._resolvedImage = function (e) {
          var t = this._getDictImageEntry();
          if (t && t.cachedCanvas) this._updatedImage(t.cachedCanvas);
          else if (e)
            if (this._image && this._image.url === e) this._updatedImage();
            else {
              ...
              if (n && e.length > w.maxImgDataUrlLength)
                ...
                ((this.$storedUrl = e),
                this._setStatus(x.ImageStatus.Loading),
                n)
              ) {
                var r,
                  o,
                  a = e.substring(n.pop().length),
                  s = 0;
                for (var l in x._BOM) {
                  var h = x._BOM[l];
          ...
          else this._setStatus(x.ImageStatus.Error);
        }),
        (x.prototype._updatedImage = function (e) {
          ...
          if (
            ...
            r && r.cachedCanvas
              ? ((t = (n = r.cachedCanvas).width), (i = n.height))
              : ((t = this._image.naturalWidth),
                (i = this._image.naturalHeight));
          }
          if (!n || (n !== this._imageCanvas && n !== this._image)) {
            if (
              ...
              0 !== t &&
                0 !== i &&
                t <= w.absoluteMaxImgLinearDimension &&
                i <= w.absoluteMaxImgLinearDimension &&
                t * i <= w.absoluteMaxImgAreaDots)
            ) {
              if (
                (this.setProperties(
                  ["ih", "iw", "pw", "ph"],
                  [i, t, this.$pw ? this.$pw : t, this.$ph ? this.$ph : i],
                ),
                this._initImageCanvas(n || this._image),
                this.$pw &&
                  this.$ph &&
                  !this.$itrf &&
                  (!c.isEqualEps(this.$pw, t) ||
                    !c.isEqualEps(this.$ph, i) ||
                    !c.isEqualEps(this.$px, 0) ||
                    !c.isEqualEps(this.$py, 0)))
              ) {
                var o =
                    this.$pw > d.Transform.MinimalDimention
                      ? this.$pw
                      : d.Transform.MinimalDimention,
                  a =
                    this.$ph > d.Transform.MinimalDimention
                      ? this.$ph
                      : d.Transform.MinimalDimention,
                  s = t > 0 ? o / t : 0,
                  l = i > 0 ? a / i : 0,
                  h = new g().scaled(s, l).translated(this.$px, this.$py);
                h.isIdentity() || this.setProperties(["itrf"], [h]);
              }
              (this._updateImageRect(this.$px, this.$py, this.$pw, this.$ph),
                n || this._checkColorProfile(this._image.src),
                this._setStatus(x.ImageStatus.Loaded),
                this._imageCanvas && this.destroyImage());
            } else (this._setStatus(x.ImageStatus.Error), this.destroyImage());
            this._notifyChange(d._Change.FinishGeometryUpdate);
          }
        }),
        (x.prototype._checkColorProfile = function (e, t) {
          if (this._type === x.Type.JPEG && this._imageCanvas) {
            var n = function (e) {
              var t = this._imageCanvas.getContext("2d"),
                i = t.createImageData(
                  this._imageCanvas.width,
                  this._imageCanvas.height,
                );
            ...
            if (r && r.getColorSpace() === v.ColorSpace.CMYK) {
              ...
              s.setCMYKProfile(
                ...
                function () {
                  try {
                    (n(_.decodeCMYK(r)),
                      this._setConvertStatus(x.ConvertStatus.Converted));
                  } catch (e) {
                    this._setConvertStatus(x.ConvertStatus.Failed);
                  }
                }.bind(this),
              );
            } else this._setConvertStatus(x.ConvertStatus.None);
          }
        }),
        (x.prototype._setStatus = function (e) {
          e !== this._status &&
            ((this._status = e),
            this._canEventBeSent(x.StatusEvent) &&
              this._sendEvent(new x.StatusEvent(this, this._status)));
        }),
        (x.prototype._setConvertStatus = function (e) {
          e !== this._convertStatus &&
            ((this._convertStatus = e),
            this._canEventBeSent(x.ConvertStatusEvent) &&
              this._sendEvent(
                new x.ConvertStatusEvent(this, this._convertStatus),
              ));
        }),
        ...
        (x.prototype.destroy = function () {
          (this.destroyImage(),
            ...
            (this.$tmpUrl = null),
            this._imageCanvasOffscreen &&
              (E.destroy(this._imageCanvasOffscreen),
              (this._imageCanvasOffscreen = null)),
            (this._imageCanvas = null));
        }),
        ...
        (x.prototype._getDictImageEntry = function () {
          if (this._scene && this.$url) {
            ...
            if (e) return e.getEntry(this.$url);
          }
          return null;
        }),
        (x.prototype._initImageCanvas = function (e) {
          if (
            ...
            if (e === this._imageCanvas) return;
            ((this._imageCanvas = e), (this._imageCanvasOffscreen = null));
          } else {
            (this._imageCanvas ||
              (this._imageCanvas = document.createElement("canvas")),
              (this._imageCanvas.width = e.width),
              (this._imageCanvas.height = e.height));
            var t = this._getDictImageEntry();
            if (t) {
              if (
                ...
                return (
                  (this._imageCanvas = null),
                  (this._imageCanvasOffscreen = null),
                  (this._image = t.cachedCanvas),
                  void this._resetFxCacheAndState()
                );
              if (
                !this._scene
                  .getDictionary()
                  .setCachedCanvas(t, this._imageCanvas)
              )
                return (
                  this._scene.getDictionary().setCachedCanvas(t, e),
                  (this._imageCanvas = null),
                  (this._imageCanvasOffscreen = null),
                  (this._image = e),
                  void this._resetFxCacheAndState()
        ...
        (x.prototype._updateImageRect = function (e, t, i, n) {
          ((this._x = e),
            ...
            (this._w = i),
            (this._h = n),
            this.isRecordedTransaction() || this._invalidatePath());
        }),
        (x.prototype.toFit = function (e) {
          ...
          if (
            ...
            i &&
            ((i *= n =
              this.getTransform() ? this.getTransform().getScaleFactor() : 1),
            (t *= n) > e.getWidth() || i > e.getHeight())
          ) {
