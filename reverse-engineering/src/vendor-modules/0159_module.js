      ...
      (r.inheritAndMix("layer", g, s, [
        ...
        (g.prototype.transform = function (e, t, i) {
          if (e && !e.isIdentity()) {
            ...
            ((this._relayoutNow = !1),
              n &&
                ((this._relayoutNow = !this._relayout), (this._relayout = !0)),
              this.beginUpdate());
            try {
              if (n) {
              ...
              (n && this.dependentUpdate && !t) ||
                h.Transform.prototype._transformChildren.call(this, e, t, i);
            } finally {
              this.endUpdate();
            }
            if (n && this._relayoutNow) {
              var o = this.getProperty("frm");
              (this._layoutAnchorContents(o, n, null),
                (this._relayoutNow = !1));
            }
          }
        }),
        ...
        (g.prototype._calculatePaintBBox = function (e, t) {
          var i;
          return (
            (i = this.getProperty("frm")
              ? this.getGeometryBBox(t)
              : s.prototype._calculatePaintBBox.call(this, e, t)),
            this.getEffects() ? this.getEffects().getEffectsBBox(i, null, i) : i
          );
        }),
        (g.prototype._calculatePreTransformRect = function (e) {
          if (!e || !e.invertible()) return this.getGeometryBBox();
          var t = this.getProperty("frm");
          if (t) {
        ...
        (g.prototype._preparePaint = function (e) {
          return (
            ...
            (e.configuration.paintMode !== l.PaintMode.Outline &&
              this.$otl &&
              e.outlineColors.push(this.$cls),
            !0)
          );
        }),
        ...
        (g.prototype._paintStyleContent = function (e, t, i, n, r) {
          ...
          if (a && this.getFirstChild()) {
            ...
            if (e.canvas.hasClip()) {
              var l = this._createStyleCanvas(e, this.getGeometryBBox()),
                h = e.pushCanvas(l);
              try {
              ...
              h = e.pushCanvas(
                this._createStyleCanvas(e, this.getGeometryBBox()),
              );
              try {
                (this._paintChildren(e),
                  void 0 !== e.canvas.putVertices(s) &&
                    e.canvas.fillVertices(
                      o.BLACK,
                      1,
                      u.CompositeOperator.DestinationIn,
                    ),
                  h.drawCanvas(e.canvas),
                  e.canvas.finish());
              } finally {
                e.popCanvas();
              }
            }
          } else this._paintChildren(e);
        }),
        ...
        (g.prototype._handleChange = function (e, t) {
          ...
          if (
            ...
            e != h._Change.PrepareChildAnchoring ||
              this.getProperty("frm") ||
              this.setFrame(!0);
        }),
              ...
              for (var i = this.getFirstChild(); null != i; i = i.getNext())
                i.hasMixin(h.Anchor) &&
                  (i.getProperty("hacr") ||
                    i.setProperty(
                      "hacr",
                      i.oldHacr ? i.oldHacr : h.Anchor.AnchorType.Start,
                    ),
                  i.getProperty("vacr") ||
                    i.setProperty(
                      "vacr",
                      i.oldVacr ? i.oldVacr : h.Anchor.AnchorType.Start,
                    ));
            }
          } else if (!e && this.getProperty("frm")) {
            for (i = this.getFirstChild(); null != i; i = i.getNext())
              i.hasMixin(h.Anchor) &&
                (i.getProperty("hacr") || i.getProperty("vacr")) &&
                i.resetAnchorProperties();
            this.setProperties(["frm"], [null]);
          }
        }),
        (g.prototype._handleAnchorChange = function (e, t) {
          if (
            (h.Anchor.prototype._handleAnchorChange.call(this, e, t),
            e === r._Change.AfterPropertiesChange &&
              !this.isRecordedTransaction() &&
              t.properties.indexOf("frm") >= 0 &&
              (this.getProperty("hacr") || this.getProperty("vacr")) &&
              !this.isRestoring())
          )
            if (this.dependentUpdate) {
              if (!this._noAnchoringPropsUpdate) {
                var i = t.properties.indexOf("frm"),
                  n = this.getProperty("frm"),
                  o = t.values[i],
                  a =
                    o.getWidth() > h.Transform.MinimalDimention
                      ? o.getWidth()
                      : h.Transform.MinimalDimention,
                  s =
                    o.getHeight() > h.Transform.MinimalDimention
                      ? o.getHeight()
                      : h.Transform.MinimalDimention,
                  l =
                    n.getWidth() > h.Transform.MinimalDimention
                      ? n.getWidth()
                      : h.Transform.MinimalDimention,
                  A =
                    n.getHeight() > h.Transform.MinimalDimention
                      ? n.getHeight()
                      : h.Transform.MinimalDimention,
                  c = new p()
              ...
              var g = this.getProperty("hacr"),
                f = this.getProperty("vacr");
              (this.resetAnchorProperties(),
                this.setProperties(["hacr", "vacr"], [g, f]));
            }
        }),
        (e.exports = g));
    }