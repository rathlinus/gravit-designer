...
function (e, t, n) {
      ...
      function m(e) {
        ...
        ((this._images = new m.Images()),
          this._images._setParent(this),
          this._setDefaultProperties(t));
      }
      (o.inherit("imagegrid", m, r),
        (m.prototype._images = null),
        (m.prototype._gridMeasure = null),
        (m.prototype._vertexSource = null),
        (m.GeometryProperties = {
          grid: null,
        }),
        (m.VisualProperties = {
          im: null,
          ...
          if (i)
            switch (e) {
              ...
              case o._Change.AfterChildInsert:
                (i.rewindVertices(0),
                  i._notifyChange(a._Change.FinishGeometryUpdate));
                break;
        ...
        (m.prototype._images = null),
        (m.prototype._prepareVertices = function () {
          var e,
            t,
            i,
            n = new h(),
          ...
          this._gridMeasure = this._iterateGrid(function (e, t, i, r) {
            (n.addVertex(d.Command.Move, e, t),
              n.addVertex(d.Command.Line, e + i, t),
              n.addVertex(d.Command.Line, e + i, t + r),
              n.addVertex(d.Command.Line, e, t + r),
              n.addVertex(d.Command.Close));
          });
          this.$mg;
          return (
            (l = this._gridMeasure.getX()),
            (c = this._gridMeasure.getY()),
            (e = new A(1 / c, 0, 0, 1 / l, 0, 0)),
            (i = this.$trf || new A()),
            (t = i.preMultiplied(e)),
            ...
            this._iterateGrid(function (e, i, n, a, s) {
              ...
              if (h && !h.isEmpty()) {
                ...
                var y = new A((u = f >= m ? g : d), 0, 0, u, e + c, i + p),
                  _ = new A(d, 0, 0, g, e, i),
                  v = y.multiplied(t);
                (l.setProperty("itrf", v),
                  l.setProperty("trf", _.multiplied(t)));
              }
            }),
            this._images._endBlockChanges([a._Change.ChildGeometryUpdate]),
            new s(n, t)
          );
        }),
        (m.prototype.rewindVertices = function () {
          return (
            this._vertexSource ||
              (this._vertexSource = this._prepareVertices()),
        ...
        (m.prototype.getWorldToBoxTransform = function () {
          var e,
            t = this.$trf || new A();
          if (!t.invertible()) return null;
          e = t.inverted();
          var i = this.$grid;
          if (!i) return null;
          if (!i.length || !i[0] || !i[0].length) return null;
          var n = this._gridMeasure.getX(),
            r = this._gridMeasure.getY(),
            o = new A(n, 0, 0, r, 0, 0);
        ...
        (m.prototype.addImage = function (e, t) {
          if (this.$grid) {
            ...
            if (i) {
              var n,
                r = (t = i.mapRect(t)).getSide(l.Side.CENTER),
                o = r.getX(),
                a = r.getY(),
                s = Number.MAX_VALUE,
                h = -1;
              if (
                (this._iterateGrid(function (e, t, i, r, l) {
                  var A = e + i / 2,
                    c = t + r / 2,
                    p = f.ptSqrDist(A, c, o, a);
        ...
        (m.prototype._handleChange = function (e, t) {
          if (e) {
            if (e == o._Change.Store)
              (this.storeProperties(t.blob, m.GeometryProperties),
              ...
              (this.restoreProperties(t.blob, m.GeometryProperties),
              ...
              e === o._Change.ParentAttached ||
              e === o._Change.ParentDetach
            )
              this.$im &&
                (this._images._detachFromParent(this),
                e === o._Change.ParentAttached &&
                  this._images._attachToParent(this));
            else if (
              e === o._Change.WorkspaceAttached ||
              e === o._Change.WorkspaceDetach
            ) {
              if (this._images) {
                this._images._setWorkspace(
                  e === o._Change.WorkspaceDetach ? null : this._workspace,
                );
                for (
                  var i = this._images.getFirstChild();
                  null != i;
                  i = i.getNext()
                )
                  i._setWorkspace(
              ...
              e === g._Change.SceneAttached ||
              e === g._Change.SceneDetached
            ) {
              if (this._images) {
                this._images._setScene(
                  e === g._Change.SceneDetached ? null : this._scene,
                );
                for (
                  i = this._images.getFirstChild();
                  null != i;
                  i = i.getNext()
                )
                  i._setScene(
              ...
              try {
                for (
                  this._images._beginBlockChanges([
        ...
        (m.prototype.getSubnodeIds = function (e) {
          (r.prototype.getSubnodeIds.call(this, e),
            this._images &&
              (e[this._images.getMultireferenceId()] &&
                this._images.resetMultireference(),
              (e[this._images.getMultireferenceId()] = this._images),
              this._images.getSubnodeIds(e)));
        }),
