...
function (e, t, i) {
      ...
      ((a.UNSUBSCRIBE = 1638),
        ...
        (a.parseFont = function (e) {
          var t,
            i = n.defaultFormatting.fontFamily,
            a = null,
            s = n.defaultFormatting.strikeout,
            l = n.defaultFormatting.fontStyle,
            h = n.defaultFormatting.fontWeight,
            A = "normal",
            c = "normal",
            p = e.split(/\s+/);
          e: for (; (t = p.shift()); )
