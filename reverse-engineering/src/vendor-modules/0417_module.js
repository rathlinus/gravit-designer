...
function (e, t, i) {
      ...
      if (
        ...
        Object({
          ...
          (!window.hasOwnProperty("URLSearchParams") ||
      ...
      const T = (e, t, i) => {
          ...
          let o;
          if (
            (r.searchParams.get("lang") ||
              (r.searchParams.append("lang", n.getLanguage()), (e = r.href)),
            i)
          ) {
          ...
          return fetch(e, {
            method: t.method || "GET",
            body:
              (window.File && t.body instanceof window.File) ||
              (window.FormData && t.body instanceof window.FormData)
                ? t.body
      ...
      ((n.managementUrl = "https://cloud-management.corel.com"),
        ...
        (n.subscription = {}),
        (n.subscription.getNextBillingDate = () =>
          b("/subscription/nextbillingdate")),
        ...
        (n.isEnabledSubscriptions = () =>
          b("/subscription/test").then((e) => 1 == e.status)),
        ...
        (n.checkout = function (e, t) {
          ...
          if (t instanceof HTMLElement) {
            let n = document.createElement("iframe"),
              { events: r } = i;
            (r &&
              Object.keys(r).forEach((e) => n.addEventListener(e, r[e], !1)),
              t.appendChild(n),
        ...
        (n.hasPurchasedProduct = (e) =>
          C("/purchase/product/" + e).then(
            (e) => 204 !== e.status && e.status < 400,
          )),
        (n.getProviderContentDetails = (e) =>
          b("/store/v1/content/details/".concat(e))),
        (n.getProviderContentFile = (e) =>
          b("/store/v1/content/file/".concat(e))),
        (n.getProviderExternalAsset = (e) =>
          b("/provider/v1/asset/".concat(e))),
        (n.software = {
          getRelease: function () {
            let e =
              arguments.length > 0 && void 0 !== arguments[0]
        ...
        (n.isNewsletterRequired = () =>
          b("/newsletter/required").then((e) => 1 == e.result)),
        (n.getUser = (e, t) =>
          b("/user".concat(e ? "/" + e : "", "?public=").concat(t ? 1 : 0))),
        (n.updateUser = (e) =>
          w("/user", {
            method: "PUT",
            body: e,
        ...
        (n.getExternalFile = (e) =>
          b("/file/external/".concat(e)).then((e) => new o(e))),
        (n.annotations = {}),
        (n.annotations.getHistory = (e) =>
          b("/file/" + e + "/annotations/history")),
        (n.annotations.getDesignHistory = (e) =>
          b("/file/" + e + "/annotations/history/design")),
        ...
        (n.getSharingStatistics = () =>
          b("/sharing/statistics").then((e) => new r(e))),
        (n.share = {}),
              ...
              window.addEventListener("message", function i(n) {
                ...
                if (r) {
                  if (
                    n.source != p &&
                    !p &&
                    n.origin.indexOf("chrome-extension:") < 0
                  )
                    return (
                      console.warn(
                        "Token was rejected because there is an invalid source",
                        n.source,
                      ),
                      t()
                    );
        ...
        (n.signin = (e) =>
          T(n.url + "/signin", {
            ...
            (e) => (v || (R.gApiToken = e.headers.get("Authorization")), I(e)),
          )),
        (n.signup = (e) =>
          T(n.url + "/signup", {
            method: "POST",
        ...
        (n.getLinkLearnMorePro = function () {
          ...
          return (
            location.origin &&
              0 === location.origin.indexOf("chrome") &&
              (t = "chrome"),
            Object.assign(e, {
              platform: t,
            }),
      ...
      ((n.setOAuthFactory = (e) => {
        ...
        (n.getAutoSave = (e, t) =>
          b(
            "/file/"
              .concat(e, "/autosave")
              .concat(t ? "/version/".concat(t) : ""),
          )),
        (n.getAutoSaveThumbnail = (e, t) =>
          b(
            "/file/"
              .concat(e, "/autosave/thumbnail")
              .concat(t ? "/version/".concat(t) : ""),
          )),
        ...
        (n.isExternalFile = u),
        (n.getRichTooltipVideoURL = (e) =>
          "".concat(n.url, "/rich-tooltip-video/").concat(e)),
        (n.fetchTranslationsURL = (e, t) =>
          b("/i18n-url/".concat(e, "/").concat(t))),
        (n.cloudServices = {
          googleDrive: {
            getAccessToken: () => b("/cloudservices/googledrive/access"),
            getClientConfiguration: () =>
              b("/cloudservices/googledrive/configuration"),
            openFilePicker: (e) => {
              const t =
                  null != window.screenLeft ? window.screenLeft : screen.left,
                ...
                o =
                  ...
                  i,
                a = ""
                  .concat(n.url, "/googleapi/picker/")
                  .concat(encodeURIComponent(e), "?lang=")
                  .concat(n.getLanguage()),
                s = window.open(
                  a,
                  "Google Picker",
                  "scrollbars=yes, width=1024, height=768, top=" +
                    o +
                    ", left=" +
                    r,
                );
          ...
          googleAPI: {
            ...
            getRefreshToken: (e) =>
              b("/googleapi/token?refresh_token=".concat(e)),
            getTokenInfo: (e) =>
              T(
            ...
            revokeToken: (e) =>
              T(
                "https://accounts.google.com/o/oauth2/revoke?token=".concat(e),
                {
                  method: "GET",
                  headers: {
