...
function (e, t, i) {
      ...
      function g() {
        (o.call(this),
          this._setDefaultProperties(g.VisualProperties),
          (this._paintSharp = !0),
          (this.$evenodd = !0));
      }
      (r.inherit("Compound Shape", g, o),
        ...
        (g.prototype._prepareVertices = function () {
          ...
          for (
            var t =
                this.$trf && !this.$trf.isIdentity() && this.$trf.invertible()
                  ? this.$trf.inverted()
                  : null,
              i = [new l(e, t)],
              r = [],
              ...
              if (a !== e) {
                if (a.$bool) {
                  if (i.length) {
                    ...
                    h.initializeSources(i[0], s[0])
                      ? (i = h.clipOp(a.$bool) || i)
                      : (r = r.concat(s));
                  }
                } else ((a.$bool = 0), (r = r.concat(s)));
                !this._blockIntersector &&
                  new Date().getTime() - o > 1e4 &&
                  (console.warn(
                    "Compound shape computed too long. Falling back to less accurate algorithm.",
                  ),
        ...
        (g.prototype._handleChange = function (e, t) {
          if (
            ...
            if (
              (t.properties.indexOf("vis") >= 0 &&
                this._beginBlockChanges([p._Change.ChildGeometryUpdate]),
              t.properties.indexOf("trf") >= 0 && this._vertexSource)
            ) {
              var i = this.$trf;
              this._vertexSource instanceof l
                ? this._vertexSource.setTransform(i)
                : this._vertexSource &&
                  (this._vertexSource = new l(this._vertexSource, i));
            }
          } else
            e === p._Change.PrepareGeometryUpdate
              ? t || this._requestInvalidation()
                  ...
                  : e === p._Change.ChildGeometryUpdate
                    ...
                    : e === r._Change.Store
                      ...
                      : e === r._Change.Restore
                        ...
                        : e === r._Change.PrepareRestore &&
                          (this._blockVertexComputation = !0);
          if (
            (e && o.prototype._handleChange.call(this, e, t),
            e === r._Change.Restore)
          )
            ((this._blockVertexComputation = !1),
              t.blob &&
                !t.blob.hasOwnProperty("evenodd") &&
                this.rewindVertices());
          else if (e == r._Change.AfterPropertiesChange) {
            t.properties.indexOf("vis") >= 0 &&
        ...
        (g.prototype._styleFinishGeometryChange = function (e) {
          if ((this._notifyChange(p._Change.FinishGeometryUpdate, 1), e))
            e instanceof a.Effect
              ? this._resetFxCacheAndState(e)
              : this._resetFxCacheAndState();
              ...
              for (
                ...
                if ((A = o.getChildByIndex(s)))
                  if (l.constructor.equals(A, l)) {
                    ...
                    (l.constructor.GeometryProperties &&
                      h.push(l.constructor.GeometryProperties),
                      l.constructor.VisualProperties &&
                        h.push(l.constructor.VisualProperties),
                      h &&
        ...
        (g.prototype._stylePropertiesUpdated = function (e, t) {
          if (this._mainShape()) {
            for (
              var i = this.getProperties(e), n = [], o = [], a = 0;
              a < e.length;
              a++
            )
        ...
        (g.prototype._mergeBoxes = function () {
          if (!this._mainShape()) return null;
          var e;
          e =
            this._mainShape() instanceof g
              ? this._mainShape()._mergeBoxes()
              : this._mainShape().getGeometryBBox() ||
                this._mainShape()._calculateGeometryBBox();
          for (
            var t = null, i = this.getFirstChild().getNext();
            null !== i;
            i = i.getNext()
          ) {
            i.$bool === n.AND &&
              (r =
                i instanceof g
                  ? i._mergeBoxes()
                  : i.getGeometryBBox() || i._calculateGeometryBBox()) &&
              (t
                ? (t = t.united(e.intersected(r)))
                : e && (t = e.intersected(r)));
          }
          for (
            i = this.getFirstChild().getNext();
            null !== i;
            i = i.getNext()
          ) {
            switch (i.$bool) {
            ...
            i.$bool === n.SUB &&
              (r =
                i instanceof g
                  ? i._mergeBoxes()
                  : i.getGeometryBBox() || i._calculateGeometryBBox()) &&
              (t ? (t = t.subtracted(r)) : e && (t = e.subtracted(r)));
          }
          return (t || (t = e), t);
        }),
        ...
        (g.prototype.getCenter = function (e) {
          var t = this.getGeometryBBox(),
            i = t ? t.getSide(h.Side.CENTER) : null;
          return (
            i &&
              !e &&
              this.$trf &&
              this.$trf.invertible() &&
              (i = this.$trf.inverted().mapPoint(i)),
            i
          );
        }),
