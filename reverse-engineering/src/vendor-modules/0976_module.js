...
function (e, t, i) {
      ...
      e.exports = class {
        constructor(e) {
          ...
          ((a =
            a ||
            o.getValue("GOfferDialogV1", "text.offerdialog-v1-default-title")),
            (this._dialog = n("<div></div>").addClass(
          ...
          ((this._title = n("<span></span>")
            .addClass("title g-cloud-ui-markable")
            .appendTo(c)),
            Array.isArray(a) || (a = [a]),
            a.forEach((e) => {
              (n("<label></label>").html(e).appendTo(this._title),
                n("<br>").appendTo(this._title));
            }));
                ...
                .append(
                  i.data.map((e) =>
                    n("<div></div>")
                      .addClass("topic")
                      .append(
                        n("<span></span>").addClass("g-cloud-icon-v").text(e),
                      ),
                  ),
                ));
          } else
            "string" == typeof i &&
              n("<span></span>").addClass("title no-bold").html(i).appendTo(p);
          n("<div></div>")
            .addClass("banner")
            .append(
              n("<span></span>").text(
                o.getValue("GOfferDialogV1", "text.upgrade-tip"),
              ),
            )
            .appendTo(this._dialog);
