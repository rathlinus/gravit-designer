...
function (e, t, i) {
      ...
      (a.inheritAndMix(V, a, [o]),
        ...
        (V.prototype.indexOf = function (e) {
          return this._typeIdToIndexMap.hasOwnProperty(a.getTypeId(e))
            ? this._typeIdToIndexMap[a.getTypeId(e)]
            : -1;
        }),
        ...
        (V.prototype.activateTool = function (e, t, i) {
          if (!this._temporaryActiveTool || i) {
            if (this._temporaryActiveTool) {
              ...
              this._activeTool.isDeactivatable() &&
                ((this._temporaryActiveTool = null),
                (this._tempActivationTime = null));
            }
            ...
            if (this._activateTool(e, null, i))
              return (
                ...
                this._tempActivationTime ||
                  (this._tempActivationTime = new Date().getTime()),
                !0
              );
          }
          return !1;
        ...
        (V.prototype.tempToolKeyRelease = function (e, t) {
          return (
            !!(
              e &&
              this.getTool(e) == this._activeTool &&
        ...
        (V.prototype.activateOldPathTool = function () {
          ...
          e && (e instanceof b || e instanceof A)
            ? this.activateTool(e)
            : this.activateTool(b);
        }),
        (V.prototype._activateTool = function (e, t, i) {
          return (
            ...
            e != this._activeTool &&
              ...
              (this._activeTool = e),
              t &&
                this._activeTool.setIcon instanceof Function &&
                this._activeTool.setIcon(t),
              this._addActiveToolToView(),
              this.hasEventListeners(V.ToolChangedEvent) &&
                this.trigger(new V.ToolChangedEvent(this._oldTool, e, i)),
              !0)
          );
        }),
