...
function (e, t, i) {
      ...
      ((a.prototype.bindConstructorValues = function (e) {
        ...
        (a.prototype.getPath = function (e, t, i, n, r) {
          ...
          if (
            (n.hinting &&
              r &&
              r.hinting &&
              (s = this.path && r.hinting.exec(this, i)),
            s)
          )
            ((a = r.hinting.getCommands(s)),
              (e = Math.round(e)),
              (t = Math.round(t)),
              (l = h = 1));
          else {
          ...
          for (var p = 0; p < a.length; p += 1) {
            var u = a[p];
            "M" === u.type
              ? A.moveTo(e + u.x * l, t + -u.y * h)
              : "L" === u.type
                ? A.lineTo(e + u.x * l, t + -u.y * h)
                : "Q" === u.type
                  ? A.quadraticCurveTo(
                      e + u.x1 * l,
                      t + -u.y1 * h,
        ...
        (a.prototype.getMetrics = function () {
          for (
            var e = this.path.commands, t = [], i = [], n = 0;
            n < e.length;
            n += 1
          ) {
            var r = e[n];
            ("Z" !== r.type && (t.push(r.x), i.push(r.y)),
              ("Q" !== r.type && "C" !== r.type) ||
                (t.push(r.x1), i.push(r.y1)),
              "C" === r.type && (t.push(r.x2), i.push(r.y2)));
          }
          var o = {
        ...
        (a.prototype.drawPoints = function (e, t, i, n) {
          function r(t, i, n, r) {
            ...
            for (var a = 0; a < t.length; a += 1)
              (e.moveTo(i + t[a].x * r, n + t[a].y * r),
                e.arc(i + t[a].x * r, n + t[a].y * r, 2, 0, o, !1));
            (e.closePath(), e.fill());
          }
          ((t = void 0 !== t ? t : 0),
            (i = void 0 !== i ? i : 0),
        ...
        (a.prototype.drawMetrics = function (e, t, i, n) {
          ...
          ((t = void 0 !== t ? t : 0),
            ...
            (e.lineWidth = 1),
            (e.strokeStyle = "black"),
            r.line(e, t, -1e4, t, 1e4),
            r.line(e, -1e4, i, 1e4, i));
          var a = this.xMin || 0,
            s = this.yMin || 0,
            l = this.xMax || 0,
            h = this.yMax || 0,
            A = this.advanceWidth || 0;
          ((e.strokeStyle = "blue"),
            r.line(e, t + a * o, -1e4, t + a * o, 1e4),
            r.line(e, t + l * o, -1e4, t + l * o, 1e4),
            r.line(e, -1e4, i + -s * o, 1e4, i + -s * o),
            r.line(e, -1e4, i + -h * o, 1e4, i + -h * o),
            (e.strokeStyle = "green"),
            r.line(e, t + A * o, -1e4, t + A * o, 1e4));
        }),
        (t.Glyph = a));
