      ...
      e.exports = function (e) {
        ((e.Effect = function () {
          ...
          (e.Effect.prototype.assignFrom = function (t) {
            ...
            (i.length && this.transferProperties(t, i),
          ...
          (e.Effect.prototype.isAffectedByChildren = function () {
            ...
            return (
              !!e &&
              (e instanceof Array
                ? Math.max.apply(this, this.getEffectPadding()) > 0
                : e)
            );
          }),
          ...
          (e.Effect.prototype._handleGeometryChangeForProperties = function (
            e,
            t,
            i,
          ) {
            if (
              ...
              o.containsObjectKey(t.properties, i)
            ) {
          ...
          (e.Effect.prototype._handleVisualChangeForProperties = function (
            e,
            t,
            i,
          ) {
