...
function (e, t, i) {
      ...
      function A() {
        (o.Effect.call(this),
          this._setDefaultProperties(A.GeometryProperties),
          s.getGLContext() && (this._glblur = new a()));
      }
      (r.inherit("blurEffect", A, o.Effect),
        ...
        (A.equals = function (e, t) {
          return (
            e instanceof A &&
            t instanceof A &&
            e.arePropertiesEqual(t, Object.keys(A.GeometryProperties))
          );
        }),
