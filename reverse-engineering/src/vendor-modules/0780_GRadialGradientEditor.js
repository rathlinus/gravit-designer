/**
 * chunk.vendor.js Module #780
 * Type: class
 * Name: GRadialGradientEditor
 */
      ...
      (r.inherit(v, c),
        ...
        (v.prototype.paint = function (e, t) {
          ...
          if (i && n && 4 == n.length) {
            ...
            ((s = new p()).addVertex(A.Command.Move, n[1].getX(), n[1].getY()),
              s.addVertex(A.Command.Line, n[0].getX(), n[0].getY()),
              s.addVertex(A.Command.Line, n[2].getX(), n[2].getY()),
              t.canvas.putVertices(s),
              t.canvas.strokeVertices(t.selectionOutlineColor, h.outlineWidth));
            var s,
              l = n[3],
              u = this._xLeading ? n[1] : n[2];
            ((l = c.alignHandlePoint(l, a.outlineWidth)),
              (u = c.alignHandlePoint(u, a.outlineWidth)),
              (s = new p()).addVertex(A.Command.Move, l.getX(), l.getY()),
              s.addVertex(A.Command.Line, u.getX(), u.getY()),
              t.canvas.putVertices(s),
              t.canvas.strokeVertices(
                new o(o.parseCSSColor(a.lineShadowColor)),
                a.outlineWidth + 2 * _.getScreenDPI(),
                null,
                null,
                null,
                null,
            ...
            ((d.length && 0 == d[0].position) || this._paintCross(l, t),
              (d.length && 1 == d[d.length - 1].position) ||
                this._paintCross(u, t),
              m.paintAnnotation(
                t,
                null,
        ...
        (v.prototype.getPartInfoAt = function (e, t, i, n) {
          ...
          if (o && 4 == o.length) {
            var a = this._xLeading ? o[2] : o[1],
              s = this._xLeading ? o[1] : o[2],
                  ...
                  : d.sqrSegmentDist(
                    ...
                    ? (r = new f.PartInfo(
                        ...
                        v.MOVE_HANDLE_PART_ID,
                        {
                          ...
                          origTransformInv:
                            this._getCompositeTransform(!0).inverted(),
                        },
                        !0,
                        !1,
                      ))
        ...
        (v.prototype.updatePartSelection = function (e, t, i) {
          ...
          if (n && n === v.EXTRA_HANDLE_PART_ID) {
            ...
            (o && o.length && 1 == o[o.length - 1].position
              ? ((r = new f.PartInfo(
                  this,
                  {
                    type: c.STOP_HANDLE_PART_ID,
            ...
            r = c.prototype.updatePartSelection.call(
              this,
              !1,
              n ? [n] : null,
              i,
        ...
        (v.prototype.movePart = function (e, t, i, n, r, o, a) {
          ...
          var s = i,
            ...
            A = this._getPivotPoints();
          if (
            (e &&
              e.type === c.STOP_HANDLE_PART_ID &&
              0 == e.idx &&
              h.length &&
              0 == h[0].position) ||
            e === v.START_HANDLE_PART_ID
          ) {
            ...
            if (
              ...
              if (
                ((s = G.mapPoint(s)),
                !d.isEqualEps(s.getX(), this._gradient._cx) ||
                  !d.isEqualEps(s.getY(), this._gradient._cy))
              ) {
                var g = d.ptSqrDist(
                    s.getX(),
                    s.getY(),
            ...
            if ((G = this._getCompositeTransform(!0).inverted())) {
              ...
              var _ = new l(
                ...
                C = s.getY() - this._gradient._cy;
              d.isEqualEps(C, 0) && (C = d.defaultEps);
              var w = (s.getX() - _.getX()) / C,
                E = new u()
                  .translated(-this._gradient._cx, -this._gradient._cy)
                  .scaled(1, b)
                  .multiplied(new u(1, 0, w, 1, 0, 0))
                  .translated(this._gradient._cx, this._gradient._cy);
              (this._gradient._transform &&
                (E = E.multiplied(this._gradient._transform)),
                E.inverted() &&
            ...
            if ((G = this._getCompositeTransform(!0).inverted())) {
              ...
              var B =
                (Q = s.getX() - this._gradient._cx) / this._gradient._scale;
              d.isEqualEps(Q, 0) && (Q = d.defaultEps);
              var x = (s.getY() - _.getY()) / Q;
              E = new u()
                .translated(-this._gradient._cx, -this._gradient._cy)
                .scaled(B, 1)
                .multiplied(new u(1, x, 0, 1, 0, 0))
                .translated(this._gradient._cx, this._gradient._cy);
              (this._gradient._transform &&
                (E = E.multiplied(this._gradient._transform)),
                E.inverted() &&
            ...
            var P = A[3],
              S = this._xLeading ? A[1] : A[2],
              T = n ? n.inverted() : null;
            if (
              (T && ((P = T.mapPoint(P)), (S = T.mapPoint(S))),
              (s = d.getVectorProjection(
                P.getX(),
                P.getY(),
                S.getX(),
                S.getY(),
              ...
              var I = new l(this._gradient._fx, this._gradient._fy),
                ...
                R = d.ptDist(s.getX(), s.getY(), I.getX(), I.getY()),
                D = d.ptDist(F.getX(), F.getY(), I.getX(), I.getY()),
                k = D ? R / D : 0;
              (d.isEqualEps(k, 1, c.DEFAULT_EPS)
                ? (k = 1)
                : d.isEqualEps(k, 0, c.DEFAULT_EPS) && (k = 0),
                (h[e.idx].position = k),
                this._synchIdx(e),
                this._propHolder.setProperty(
                  this._propName,
