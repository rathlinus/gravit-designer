        ...
        (u.prototype.parse = function () {
          if (this._node) {
            (s.prototype.parse.apply(this, arguments),
              (this._parent &&
                this._parent instanceof p.getClassFromName("shapeGroup") &&
                this._parent.hasClippingMask()) ||
                this._node.setProperty("vis", this._data.isVisible),
              this._node.setProperty("lkt", this._data.isLocked),
            ...
            (e &&
              (this._node.hasMixin(r) &&
                ...
                (this._node.setProperty(
                  "_sbl",
                  void 0 !== e.contextSettings.blendMode
                    ? u.BlendMode[e.contextSettings.blendMode]
                    : o.BlendMode.Normal,
                ),
                this._node.setProperty(
                  "_stop",
                  void 0 !== e.contextSettings.opacity
                    ? e.contextSettings.opacity
                    : 1,
                )),
              e.colorControls && new c(e.colorControls).applyTo(this._node),
              e.blur && new A(e.blur).applyTo(this._node),
              e.innerShadows &&
                e.innerShadows.forEach(
                  function (e) {
              ...
              this._sendEvent(new u.ProcessEvent(u.Process.AfterParse, this)));
          }
        }),
        (u.prototype._postAppendTo = function () {
          (s.prototype._postAppendTo.apply(this, arguments),
            this._sendEvent(
              new u.ProcessEvent(u.Process.ParentAttached, this),
            ));
        }),
        (u.prototype._sendEvent = function (e) {
          this._file &&
            this._file.canEventBeSent(e.constructor) &&
