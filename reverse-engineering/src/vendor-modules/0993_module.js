...
function (e, t, i) {
      ...
      function A(e, t, i) {
        ((this.lookups = e),
          (this.subtable = i),
          (this.lookupTable = t),
          i.hasOwnProperty("coverage") && (this.coverage = new l(i.coverage)),
          i.hasOwnProperty("inputCoverage") &&
            (this.inputCoverage = i.inputCoverage.map(function (e) {
              return new l(e);
            })),
          i.hasOwnProperty("backtrackCoverage") &&
            (this.backtrackCoverage = i.backtrackCoverage.map(function (e) {
              return new l(e);
            })),
          i.hasOwnProperty("lookaheadCoverage") &&
            (this.lookaheadCoverage = i.lookaheadCoverage.map(function (e) {
              return new l(e);
            })),
          i.hasOwnProperty("ligatureSets") &&
            (this.ligatureSets = new h(i.ligatureSets)));
      }

      function c(e, t) {
        ((this.index = e),
          (this.subtables = t[e].subtables.map(function (i) {
      ...
      function g(e) {
        ...
        for (var a = e.lookahead.slice(o); a.length && r(a[0].char); )
          a.shift();
        var s = new n(a, 0),
          l = d(this.lookaheadCoverage, s),
          h = [].concat(e.backtrack);
        for (h.reverse(); h.length && r(h[0].char); ) h.shift();
        if (h.length < this.backtrackCoverage.length) return [];
        var A = new n(h, 0),
          p = d(this.backtrackCoverage, A),
          u = [];
        if (
          i.length === this.inputCoverage.length &&
          l.length === this.lookaheadCoverage.length &&
          p.length === this.backtrackCoverage.length
        )
          for (var g = this.subtable.lookupRecords, f = 0; f < g.length; f++)
            for (var m = g[f], y = 0; y < i.length; y++) {
              var _ = new n([e.get(y)], 0),
                v = new c(m.lookupListIndex, this.lookups).lookup(_);
              u = u.concat(v);
            }
        return u;
      }
      ...
      ((h.prototype.lookup = function (e, t) {
        for (
          ...
          var a = i[r],
            s = e.lookahead.map(function (e) {
              return e.activeState.value;
            });
          if (("rtl" === o && s.reverse(), n(a.components, s))) return a;
        }
        return null;
      }),
        ...
        (a.prototype.getScriptFeaturesIndexes = function (e) {
          ...
          for (
            var t = this.font.tables.gsub.scripts, i = 0;
            i < t.length;
            i++
          ) {
            var n = t[i];
            if (n.tag === e) return n.script.defaultLangSys.featureIndexes;
        ...
        (a.prototype.mapTagsToFeatures = function (e, t) {
          for (var i = {}, n = 0; n < e.length; n++) {
            var r = e[n].feature,
              o = e[n].tag,
              a = new p(this.font.tables.gsub.lookups, r.lookupListIndexes);
            i[o] = new s(o, r, a, t);
          }
