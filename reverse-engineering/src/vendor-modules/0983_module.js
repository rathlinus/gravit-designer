...
function (e, t, i) {
      ...
      function v(e) {
        ...
        for (
          var o = [], a = [], s = t.sizeOf() + _().sizeOf() * t.numTables;
          s % 4 != 0;
        )
          ((s += 1),
            a.push({
        ...
        for (var l = 0; l < e.length; l += 1) {
          ...
          var A = h.sizeOf(),
            c = _(h.tableName, y(h.encode()), s, A);
          for (
            o.push({
      ...
      ((t.computeCheckSum = y),
        ...
        (t.fontToTable = function (e) {
          for (
            ...
            if (".notdef" !== F.name) {
              ...
              (i.push(k.xMin),
                ...
                r.push(k.xMax),
                m.push(k.yMax),
                w.push(k.leftSideBearing),
                E.push(k.rightSideBearing),
                _.push(F.advanceWidth));
            }
          }
          var G = {
          ...
          var Q = s.make({
            ...
            V = h.make(e.glyphs),
            O = o.make(e.glyphs),
            L = e.getEnglishName("fontFamily"),
            Y = e.getEnglishName("fontSubfamily"),
            X = L + " " + Y,
            H = e.getEnglishName("postScriptName");
          H || (H = L.replace(/\s/g, "") + "-" + Y);
          var W = {};
          for (var Z in e.names) W[Z] = e.names[Z];
          (W.uniqueID ||
            (W.uniqueID = {
              en: e.getEnglishName("manufacturer") + ":" + X,
            }),
            W.postScriptName ||
              (W.postScriptName = {
                en: H,
          ...
          var z = [],
            ...
            $ =
              e.metas && Object.keys(e.metas).length > 0
                ? f.make(e.metas)
                : void 0,
            ee = [Q, M, N, U, j, O, q, K, V];
          (J && ee.push(J),
            e.tables.gsub && ee.push(g.make(e.tables.gsub)),
            $ && ee.push($));
          var te = v(ee),
            ie = y(te.encode()),
            ne = te.fields,
