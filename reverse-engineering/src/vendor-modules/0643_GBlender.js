...
function (e, t, i) {
      ...
      (s.inheritAndMix(p, s, [r, c]),
        ...
        Object.defineProperty(p.prototype, "globalCompositeOperation", {
          set: function (e) {
        ...
        (p.prototype._globalCompositeOperation = null),
        (p.prototype.getShaderClass = function () {
          return n;
        }),
        (p.prototype._isCustomOperation = function () {
          return (
            ...
            this.globalCompositeOperation !==
              this._ctx.globalCompositeOperation) &&
            "over" !== this._ctx.globalCompositeOperation
          );
        }),
          ...
          if (!(h < 3)) {
            ...
            if (this._isCustomOperation()) {
              ...
              if (this._paintCanvas._areas && this._paintCanvas._areas.length) {
                for (
                  var A = this._paintCanvas._areas.slice(), c = A[0], p = 1;
                  p < A.length;
                  p++
                )
                  c = c.united(A[p]);
          ...
          if (!(s <= 0 || l <= 0 || n <= 0 || r <= 0))
            try {
              if (n === e.width && r === e.height && 0 === t && 0 === i)
                return s === e.width && l === e.height
                  ? void this._ctx.drawImage(e, o, a)
                  : void this._ctx.drawImage(e, o, a, s, l);
        ...
        (p.prototype.stroke = function () {
          if (this._isCustomOperation()) {
            ...
            if (this._paintCanvas._areas && this._paintCanvas._areas.length) {
              for (
                var e = this._paintCanvas._areas.slice(), t = e[0], i = 1;
                i < e.length;
                i++
              )
                t = t.united(e[i]);
              (this._prepareBackground(t),
                this._ctx.stroke(),
                this._renderWithBlend(t, null, !0));
            } else
              (this._prepareBackground(),
                this._ctx.stroke(),
                this._renderWithBlend(null, null, !0));
        ...
        (p.prototype.strokeRect = function (e, t, i, n) {
          if (this._isCustomOperation()) {
            ...
            if (this._paintCanvas._areas && this._paintCanvas._areas.length) {
              for (
                var r = this._paintCanvas._areas.slice(), o = r[0], a = 1;
                a < r.length;
                a++
              )
                o = o.united(r[a]);
              (this._prepareBackground(o),
                this._ctx.strokeRect(e, t, i, n),
                this._renderWithBlend(o, null, !0));
            } else
              (this._prepareBackground(),
                this._ctx.strokeRect(e, t, i, n),
                this._renderWithBlend(null, null, !0));
        ...
        (p.prototype.fill = function (e) {
          if (this._isCustomOperation()) {
            ...
            if (this._paintCanvas._areas && this._paintCanvas._areas.length) {
              for (
                var t = this._paintCanvas._areas.slice(), i = t[0], n = 1;
                n < t.length;
                n++
              )
                i = i.united(t[n]);
              (this._prepareBackground(i),
                this._ctx.fill(e),
                this._renderWithBlend(i, null, !0));
            } else
              (this._prepareBackground(),
                this._ctx.fill(e),
                this._renderWithBlend(null, null, !0));
        ...
        (p.prototype._prepareBackground = function (e, t) {
          ...
          (e
            ...
            : ((i = 0),
              (n = 0),
              (r = this._paintCanvas.getWidth()),
              (s = this._paintCanvas.getHeight())),
            t
              ? ((h = t.getWidth()),
                (A = t.getHeight()),
                (c = t.getX()),
          ...
          (this._paintCanvas.setTransform(null),
            this._paintCanvas.setOrigin(new l(0, 0)),
            this._paintCanvas.setScale(1));
          var f = o.getGLContext();
          (f.canvas.width === h && f.canvas.height === A) ||
            ((f.canvas.width = h), (f.canvas.height = A));
          var m = o.createTexture(this._ctx.canvas, i, n, r, s);
          (t &&
            ((this.isInitialized() &&
              h === this.texture.width &&
              A === this.texture.height) ||
              this._initialize.call(this, h, A)),
            m.use(),
            t
              ? this.texture.drawTo(function () {
                  a.getDefaultShader().drawRect(
                    i - c,
                    n - p,
                    i - c + r,
                    n - p + s,
              ...
              : this.draw(m),
            m.destroy(),
            this._paintCanvas.clearRect(i, n, r, s),
            this._paintCanvas.setTransform(u),
            this._paintCanvas.setOrigin(d),
            this._paintCanvas.setScale(g));
        }),
        (p.prototype._renderWithBlend = function (e, t, i) {
          ...
          if (
            ...
            ((n._canvasContext.globalCompositeOperation =
              ...
              n.setOrigin(a),
              n.setScale(s),
              A.DELETE_BLEND_AND_GRADIENT_TEXTURES_AFTER_DRAW &&
                this.destroy());
          }
        }),
