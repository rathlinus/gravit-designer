...
function (e, t, i) {
      ...
      (r.inherit("ellipse", l, a),
        ...
        (l.prototype._calculateSourceBBox = function (e) {
          return o.isEqualEps(this.$sa, this.$ea)
            ? new n(-1, -1, 2, 2)
            : a.prototype._calculateSourceBBox.call(this, e);
        }),
        (l.prototype._invalidatePath = function () {
          ...
          try {
            var t;
            for (
              e.clearChildren(), t = Math.PI / 2;
              t <= this.$sa || o.isEqualEps(t, this.$sa);
              t += Math.PI / 2
            );
            var i = o.isEqualEps(this.$sa, this.$ea)
              ? this.$sa + o.PI2
              : this.$ea;
            i < this.$sa && (i += o.PI2);
            ...
            if (
              (o.isEqualEps(c, this.$sa) && i > p) ||
              (o.isEqualEps(p, this.$sa) && i > p + o.PIHALF)
            )
              (r.setProperties(
                ["x", "y", "tp", "ah"],
                [
              ...
              ((_ = new a.AnchorPoint()).setProperties(
                ["x", "y", "tp", "ah"],
                [Math.cos(c), Math.sin(c), a.AnchorPoint.Type.Symmetric, !0],
              ),
                u.appendChild(_),
                (_ = new a.AnchorPoint()).setProperties(
                  ["x", "y", "tp", "ah"],
                  [Math.cos(p), Math.sin(p), a.AnchorPoint.Type.Symmetric, !0],
                ),
                u.appendChild(_),
                (_ = new a.AnchorPoint()).setProperties(
                  ["x", "y", "tp", "ah"],
              ...
              (i <= p && (g = (i - c) / o.PIHALF),
                ...
                r.setProperties(
                  ["x", "y", "hrx", "hry", "tp", "ah"],
                  [f[0], m[0], f[1], m[1], a.AnchorPoint.Type.Asymmetric, !1],
                ),
                (s = !0),
                e.appendChild(r),
                i <= p &&
                  ((r = new a.AnchorPoint()).setProperties(
                    ["hlx", "hly", "x", "y", "tp", "ah"],
                    [f[2], m[2], f[3], m[3], a.AnchorPoint.Type.Asymmetric, !1],
                  ),
                  e.appendChild(r),
                  (A = !0)));
            }
            if (A) this.setProperty("closed", !0);
            else {
              for (; t < i && !o.isEqualEps(t, i); t += Math.PI / 2)
                ((r = new a.AnchorPoint()).setProperties(
                  ["x", "y", "tp", "ah"],
                  [Math.cos(t), Math.sin(t), a.AnchorPoint.Type.Symmetric, !0],
                ),
                  e.appendChild(r));
              if (!n && o.isEqualEps(t, i))
                ((r = new a.AnchorPoint()).setProperties(
                  ["x", "y", "tp", "ah"],
                  [Math.cos(i), Math.sin(i), a.AnchorPoint.Type.Symmetric, !0],
                ),
                  e.appendChild(r));
              else {
                ((c = Math.floor(i / o.PIHALF) * o.PIHALF),
                  (p = (Math.floor(i / o.PIHALF) + 1) * o.PIHALF));
                var y, _;
              ...
              (w && e.removeChild(w),
                s &&
                  (e
                    .getFirstChild()
                    .getNext()
                    .setProperties(["hlx", "hly"], [f[2], m[2]]),
                  n &&
                    (e
                      .getFirstChild()
                      .setProperties(
                        ["hlx", "hly", "tp"],
                        [b[2], C[2], a.AnchorPoint.Type.Symmetric],
                      ),
                    e
                      .getLastChild()
                      .setProperties(["hrx", "hry"], [b[1], C[1]]))),
                h &&
                  e
                    .getLastChild()
                    .getPrevious()
            ...
            n ||
              (e
                ...
                .setProperties(
                  ["tp", "hlx", "hly"],
                  [a.AnchorPoint.Type.Asymmetric, null, null],
                ),
              e
                .getLastChild()
                .setProperties(
              ...
              this.$etp == l.Type.Pie
                ...
                : this.$etp == l.Type.Arc && this.setProperty("closed", !1));
          } finally {
