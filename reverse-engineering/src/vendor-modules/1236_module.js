...
function (e, t, i) {
      ...
      ((o.createMask = function (e, t, i, o, a) {
        var s = "_mask_" + n.uuid(),
          l = e.createSvgElement("mask");
        if (
          (l.setAttribute("id", s),
          l.appendChild(t),
          i.parentNode.insertBefore(l, i),
          i.setAttribute("mask", r.createIdUrl(s)),
          o)
        ) {
          ...
          var h,
            ...
            c,
            p,
            u = e.createSvgElement("rect");
          (e.globalOffset.x || e.globalOffset.y
            ? ((h = -e.globalOffset.x + ""),
              (A = -e.globalOffset.y + ""),
              (c = "100%"),
              (p = "100%"))
            : ((h = "-200%"), (A = "-200%"), (c = "400%"), (p = "400%")),
            u.setAttribute("x", h),
            u.setAttribute("y", A),
            u.setAttribute("width", c),
            u.setAttribute("height", p),
            u.setAttribute("style", "fill:white;"),
            l.insertBefore(u, t),
            l.setAttribute("x", "-200%"),
            l.setAttribute("y", "-200%"),
        ...
        (o.createMaskDefinition = function (e, t, i, r) {
          var o = "_mask_" + n.uuid(),
            a = e.createElementNS("http://www.w3.org/2000/svg", "mask");
          a.setAttribute("id", o);
          var s = i.parentNode;
          if (
            (s.removeChild(i),
            n.each(s.childNodes, function (e, t) {
        ...
        (o.createMaskDefinitionFromShape = function (e, t, i) {
          ...
          return (
            ...
            i
              ? r.replaceFillAndStroke(l, "white", "white")
              : r.replaceFillAndStroke(l, "white", "black"),
            s
          );
        }),
        (o.createClipPath = function (e, t) {
          var i = t.ownerDocument,
            r = "_mask_" + n.uuid(),
            o = i.createElementNS("http://www.w3.org/2000/svg", "mask");
          (o.setAttribute("id", r),
            n.each(t.childNodes, function (e, t) {
              if ("path" === t.tagName) {
                ...
                (n &&
                  ((n = (n = n.replace(/fill:[^;]+/, "fill:white")).replace(
                    /stroke:[^;]+/,
                    "stroke:white",
                  )),
