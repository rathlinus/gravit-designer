        ...
        ((e.PaintLayers = function () {}),
          ...
          (e.PaintLayers.prototype.hasSeparateFillLayer = function () {
            for (var e = this.getFillLayers(!0), t = 0; t < e.length; t++)
              if (e[t].isSeparateLayer()) return !0;
            return !1;
          }),
                  ...
                  for (var s in a)
                    if (i.blob.hasOwnProperty(s)) {
                      ...
                      try {
                        ...
                        (l || this.appendChild((l = new a.$class())),
                          l._beginBlockChanges([
          ...
          (e.PaintLayers.prototype.resetMultireference = function () {
            (n.Multireference.prototype.resetMultireference.call(this),
              this.getParent() &&
                (this.getParent()._layId = this.getMultireferenceId()));
          }));
      };
    }