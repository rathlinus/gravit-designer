...
function (e, t, i) {
      ...
      ((a.Flag = {
        ...
        (a.IgnoredProperties = ["plkt", "lkt", "rtxt"]),
        (a.prototype.addComment = function (e, t, i, r, a, s) {
          var l = new n(),
            h = this.getNextAnnotationSequence();
          return (
            l.setProperties(
              [
                "text",
        ...
        (a.prototype.getNextAnnotationSequence = function () {
          ...
          return (
            this.getLastChild() &&
              (e = this.getLastChild().getProperty("seq") + 1),
            e
          );
        }),
        ...
        (a.prototype.initializeAnnotation = function () {
          (this.addEventListener(
            r.BeforePropertiesChangeEvent,
            this.handleBeforePropertiesChangeEvent,
            this,
          ),
            this._setDefaultProperties(a.MetaProperties));
        }),
        (a.prototype.handleBeforePropertiesChangeEvent = function (e) {
          e.node !== this &&
            (e.custom ||
              e.temporary ||
              this.isPropertiesIgnorable(e.properties) ||
              this.isRestoring() ||
              e.node.isRestoring() ||
              ((e.properties.indexOf("mtime") < 0 ||
                this.recordedTransaction ||
                e.node.recordedTransaction) &&
                this.setProperty("mtime", o.now())));
        }),
        (a.prototype.handleBeforePropertiesChange = function (e) {
          if (
            ...
            if (!this.isRestoring()) {
              var t = e.properties.indexOf("mtime");
              t < 0
                ? (e.properties.push("mtime"), e.values.push(o.now()))
                : this.recordedTransaction && (e.values[t] = o.now());
            }
        ...
        (a.prototype.updateReadUnreadStatus = function (e) {
          var t,
            i = e.properties.indexOf("uid"),
            n = e.properties.indexOf("read");
          i >= 0 &&
            e.values[i] &&
            (t =
              n >= 0
                ? e.values[n]
                : (this.getProperty("read") || []).slice()) &&
            t.indexOf(e.values[i]) < 0 &&
            (t.push(e.values[i]),
            n < 0 &&
              ((n = e.properties.length),
              e.properties.push("read"),
              e.values.push(t)));
          return e;
        }),
