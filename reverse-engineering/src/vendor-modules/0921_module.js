...
function (e, t, i) {
      ...
      function a(e, t, i, n, o) {
        ((this.uuid = r.uuid()),
          ...
          (this._children = []),
          (this._parent = t),
          (this._left = "number" == typeof i ? i : Number.MAX_VALUE),
      ...
      (n.inherit(a, o),
        ...
        (a.prototype._left = void 0),
        (a.prototype._top = void 0),
        ...
        (a.prototype.finalize = function (e, t, i) {
          ...
          (this._children.forEach(function (e) {
            ((n = Math.min(n, e.ordinal)),
              (r = Math.max(r, e.ordinal + e.length)),
              (o = Math.max(o, h(e, "actualWidth"))),
              (a = Math.max(a, h(e, "ascent"))),
              (s = Math.max(s, h(e, "descent"))),
              (l = Math.min(l, h(e, "baseline"))));
          }),
            i && (o += i),
            ...
            Object.defineProperty(this, "ascent", {
              value: a,
            }),
