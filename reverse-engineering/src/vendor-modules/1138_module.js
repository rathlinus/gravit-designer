          ...
          switch (l) {
            case 0:
              return (function () {
                switch (h) {
                  ...
                  default:
                    throw new Error(
                      "Unhandled simple type 0x" + l.toString(16),
                    );
                }
              })();
            case 1:
            ...
            case 3:
              return (function () {
                3 != h &&
                  console.error(
                    "Unknown date type :" + h + ". Parsing anyway...",
                  );
            ...
            case 4:
              return (function () {
                var e = 1,
                  i = h;
                if (15 == h) {
                  var n = t.getUint8(o + 1),
                    a = (240 & n) / 16;
                  1 != a &&
                    console.error("0x4: UNEXPECTED LENGTH-INT TYPE! " + a);
                  var s = 15 & n,
                    l = Math.pow(2, s);
            ...
            case 10:
              return (function () {
                var i = h,
                  n = 1;
                if (15 == h) {
                  var s = t.getUint8(o + 1),
                    l = (240 & s) / 16;
                  1 != l &&
                    console.error("0xa: UNEXPECTED LENGTH-INT TYPE! " + l);
                  var A = 15 & s,
                    c = Math.pow(2, A);
              ...
              return (function () {
                ...
                if (15 == h) {
                  var s = t.getUint8(o + 1),
                    l = (240 & s) / 16;
                  1 != l &&
                    console.error("0xD: UNEXPECTED LENGTH-INT TYPE! " + l);
                  var A = 15 & s,
                    c = Math.pow(2, A);
                  ((n = 2 + c), (i = r(t.slice(o + 2, o + 2 + c))));
                }
