...
function (e, t, i) {
      ...
      function c() {
        (s.call(this),
          this._setDefaultProperties(c.GeometryProperties),
          (this.$uid = new o()),
          (this._outEdges = []),
          (this._inEdges = []));
      }
      ...
      ((c.GeometryProperties = {
        ...
        (c.OrderedEdge = function (e, t, i) {
          ((this.type = t),
            (this.idx = i),
            (this._angle =
              t === c.EdgeType.Out ? e.getStartAngle() : e.getEndAngle()));
        }),
        (c.OrderedEdge.prototype.type = null),
        (c.OrderedEdge.prototype.idx = null),
        (c.OrderedEdge.prototype._angle = null),
        (c.OrderedEdge.prototype.getAngle = function () {
          return this._angle;
        }),
        (c.prototype._orderedEdges = null),
        ...
        (c.prototype.addOutEdge = function (e) {
          ...
          var t = new c.OrderedEdge(
            e,
            c.EdgeType.Out,
            this._outEdges.length - 1,
          );
        ...
        (c.prototype.removeEdge = function (e) {
          for (var t = !1, i = 0; i < this._outEdges.length && !t; ++i)
            this._outEdges[i].getId().isEqual(e.getId()) &&
              (this._outEdges.splice(i, 1), (t = !0));
          for (i = 0; i < this._inEdges.length && !t; ++i)
            this._inEdges[i].getId().isEqual(e.getId()) &&
              (this._inEdges.splice(i, 1), (t = !0));
          this.orderEdges();
        }),
        (c.prototype.removeOutEdge = function (e) {
          for (var t = !1, i = 0; i < this._outEdges.length && !t; ++i)
            this._outEdges[i].getId().isEqual(e.getId()) &&
              (this._outEdges.splice(i, 1), this.orderEdges(), (t = !0));
        }),
        (c.prototype.removeInEdge = function (e) {
          for (var t = !1, i = 0; i < this._inEdges.length && !t; ++i)
            this._inEdges[i].getId().isEqual(e.getId()) &&
              (this._inEdges.splice(i, 1), this.orderEdges(), (t = !0));
        }),
        (c.prototype.orderEdges = function () {
          var e;
          this._orderedEdges = null;
          for (var t = 0; t < this._outEdges.length; ++t)
            ((e = new c.OrderedEdge(this._outEdges[t], c.EdgeType.Out, t)),
              this._insertOrdered(e));
          for (t = 0; t < this._inEdges.length; ++t)
            ((e = new c.OrderedEdge(this._inEdges[t], c.EdgeType.In, t)),
              this._insertOrdered(e));
        }),
            ...
            if (this._orderedEdges.length > 1)
              for (var n = null, r = 0; r < this._orderedEdges.length; ++r) {
                if ((n = this._orderedEdges[r]).type == t)
                  if (
                    (t == c.EdgeType.Out ? this._outEdges : this._inEdges)[
                      n.idx
                    ] == e
                  ) {
                    var o =
                        r + 1 < this._orderedEdges.length
                          ? this._orderedEdges[r + 1]
                          : this._orderedEdges[0],
                      s =
                        o.type == c.EdgeType.Out
                          ? this._outEdges
                          : this._inEdges;
                    if (i) {
                      var l = n.getAngle(),
                    ...
                    return {
                      ...
                      type: o.type,
                      insidePt:
                        i && l != h ? new a(this.$x + u, this.$y - d) : null,
                    };
                  }
              }
        ...
        (c.prototype.deserialize = function (e) {
          (e.length > 0 && "string" == typeof e[0] && (this.$uid = new o(e[0])),
            e.length >= 3 && ((this.$x = e[1]), (this.$y = e[2])));
        }),
        (c.prototype._paintBorder = function (e, t, i, n, o) {
          if (
            this._orderedEdges &&
            this._orderedEdges.length &&
            1 != this._orderedEdges.length
          ) {
            for (
              var a = function (e) {
                  return (
                    (o &&
                      e.getProperty("cSt", !1, null, !0) &&
                      e.hasSameStyle(o)) ||
                    (!o &&
                      !e.getProperty("cSt", !1, null, !0) &&
                      e.hasStyleBorder())
                ...
                s = 0,
                p = 0;
              p < this._orderedEdges.length;
              ++p
            ) {
              a(
                (m = this._orderedEdges[p]).type == c.EdgeType.Out
                  ? this._outEdges[m.idx]
                  : this._inEdges[m.idx],
              ) && ++s;
            }
            if (!(s < 2)) {
              var u = this._orderedEdges.length - 1,
                d = this._orderedEdges[u],
                g =
                  d.type == c.EdgeType.Out
                    ? this._outEdges[d.idx]
                    : this._inEdges[d.idx],
                f = u;
              if (!a(g))
                for (u = 0; u < this._orderedEdges.length - 1 && !a(g); ++u)
                  ((g =
                    (d = this._orderedEdges[u]).type == c.EdgeType.Out
                      ? this._outEdges[d.idx]
                      : this._inEdges[d.idx]),
                    (f = u));
              if (a(g))
                for (
                  p = f == this._orderedEdges.length - 1 ? 0 : f + 1;
                  p < this._orderedEdges.length;
                  ++p
                ) {
                  var m,
                  ...
                  if (a(y)) {
                    ...
                    if ((_ > v && (v += A.PI2), v - _ > Math.PI || 2 == s)) {
                      var b =
                          d.type == c.EdgeType.Out
                            ? g.getFirstSegment(!0, 0.01)
                            : g.getLastSegment(null, 0.01),
                        C = (
                          m.type == c.EdgeType.Out
                            ? y.getFirstSegment(null, 0.01)
                            : y.getLastSegment(!0, 0.01)
                        )
                          .getAnchorPoints()
                          .getFirstChild();
                      b.getAnchorPoints()
                        ...
                        .setProperties(
                          ["hrx", "hry"],
                          [C.getProperty("hrx"), C.getProperty("hry")],
                        );
                      for (var w = C.getNext(); null != w; w = w.getNext()) {
                        var E = new h.AnchorPoint();
                        (E.deserialize(w.serialize()),
                          b.getAnchorPoints().appendChild(E));
                      }
                      (g.getProperty("_bw") > y.getProperty("_bw")
                        ? b.assignStyleFrom(y)
                        : b.assignStyleFrom(g),
                        t && b.setProperty("trf", t),
                        (b._scene = i),
                        n &&
                          void 0 !== e.canvas.putVertices(b) &&
