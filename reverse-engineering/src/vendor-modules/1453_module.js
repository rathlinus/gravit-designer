...
function (e, t, i) {
      ...
      ((p.prototype._shape = null),
        (p.prototype.paint = function (e, t, i, n, r) {
          if (this._shape.hasStyleBorder()) {
            ...
            if (s && r.$_ba !== A.BorderAlignment.Inside) {
              var l = r.$_bw;
              if (
                (r.$_ba === A.BorderAlignment.Center && (l *= 0.5),
                this._shape.$trf)
              )
            ...
            h &&
              ...
              r.$_ba === A.BorderAlignment.Inside
                ...
                : r.$_ba === A.BorderAlignment.Outside &&
                  this._makeOutsideBorder(e),
              i && this._paintBorderMarkers(e, h, r));
          }
        }),
        (p.prototype._paintBorderMarkers = function (e, t, i) {
          var n = this._shape.getHeadMarkerVertices(i),
            r = this._shape.getTailMarkerVertices(i);
        ...
        (p.prototype._paintBorderMarker = function (e, t, i, n, r) {
          ...
          (s &&
            s.invertible() &&
            (l = o.setTransform(o.getTransform(!0).multiplied(s))),
            r || !1 === a
              ? o.strokeVertices(i.paint, n.$_bw)
              : o.fillVertices(i.paint),
            l && o.setTransform(l));
        }),
        ...
        (p.prototype._makeOutsideBorder = function (e) {
          ...
          if (!(i instanceof h && i.isLine())) {
            ...
            (f.setGStateResource(n.createSMaskGStateResource(g)),
              f.add(p),
              f.add(c),
              A.add(f));
          }
        ...
        (p.prototype._stroke = function (e, t, i) {
          ...
          (s &&
            s.invertible() &&
            (a = o.setTransform(o.getTransform(!0).multiplied(s))),
            o.strokeVertices(
              i.paint,
              n,
              t.$_bds,
        ...
        (p.prototype._getBorderTransform = function (e, t) {
          ...
          return (
            t.transform &&
              t.transform.isValid() &&
              ((i = t.transform),
              this._shape.$trf && (i = i.multiplied(this._shape.$trf)),
              e.$_px && !e.$_px.isIdentity() && (i = i.preMultiplied(e.$_px))),
            i
          );
        }),
        (e.exports = p));
