      ...
      ((d.FontManagerProxy = function (e) {
        ((this._fontManager = e),
          this._fontManager.addEventListener(
            a.FontAvailableEvent,
            this._fontEvent,
            this,
          ),
          this._fontManager.addEventListener(
            a.FontUnavailableEvent,
            this._fontEvent,
            this,
          ),
        ...
        (d.FontManagerProxy.prototype._fontManager = null),
        (d.FontManagerProxy.prototype._unresolvedFonts = null),
        (d.FontManagerProxy.prototype._resolvedFonts = null),
        (d.FontManagerProxy.prototype._promise = null),
        (d.FontManagerProxy.prototype._promiseCapability = null),
        (d.FontManagerProxy.prototype.getFont = function (e, t, i) {
          var n = this._fontManager.getFont(e, t, i);
          n.isResolved() ||
            this._unresolvedFonts.some(function (n) {
              return (
                n.getFamily() === e && n.getStyle() === t && n.getWeight() === i
              );
            }) ||
        ...
        (d.FontManagerProxy.prototype._checkUnresolvedFonts = function () {
          this._resolvedFonts.length >= this._unresolvedFonts.length &&
            this._promiseCapability.resolve();
        }),
        ...
        (d.import = function (e, t, i, a, u, g) {
          ...
          if (g)
            ...
            var m = new d.FontManagerProxy(i),
              y = function () {
            ...
            A.getDocument(_).then(function (e) {
              var i = [],
                ...
                d = t.startPage || 1,
                g = d,
                f = t.endPage || t.startPage || e.numPages,
                _ = f - g;
              !(function t() {
                var g = new r();
                (A.push(g),
                  u && _ > 1 && u(d, _),
                  e.getPage(d).then(function (r) {
                    var _ = r.getViewport({
                        scale: 1,
                      }),
                      v = new h(_.width, _.height);
                    g.setProperties(
                      ["w", "h", "bck"],
                      [_.width, _.height, o.WHITE],
                    );
                    var b = new l(g, v, m),
                      C = {
                        canvasContext: b,
