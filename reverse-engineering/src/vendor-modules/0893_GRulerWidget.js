...
function (e, t, i) {
      ...
      function h(e, t, i, r, o) {
        ...
        ((this._htmlElement.style.position = "absolute"),
          ...
          (this._htmlElement.className = "g-ruler-widget " + a),
          r
            ? (this._createUnitRuler(o), this._updateUnitRuler(o))
            : ((this._orientation = e || h.Orientation.Horizontal),
              (this._canvas = document.createElement("canvas")),
              (this._canvas.style.position = "absolute"),
              (this._canvas.style.left = "0px"),
              (this._canvas.style.top = "0px"),
              (this._canvas.style.imageRendering = "pixelated"),
              "pixelated" !== this._canvas.style.imageRendering &&
                (this._canvas.style.imageRendering = "nearest-neighbor"),
              (this._context = this._canvas.getContext("2d")),
              this._htmlElement.appendChild(this._canvas),
              (this._mouseMarker = document.createElement("div")),
              (this._mouseMarker.style.position = "absolute"),
              (this._mouseMarker.className = "mouse-marker"),
              (this._mouseMarker.style.background = "black"),
              this._orientation === h.Orientation.Horizontal
                ? ((this._mouseMarker.style.top = "0px"),
                  (this._mouseMarker.style.height = "19px"),
                  (this._mouseMarker.style.width = "1px"),
                  (this._mouseMarker.style.left = "-1px"))
                : ((this._mouseMarker.style.left = "0px"),
                  (this._mouseMarker.style.width = "19px"),
                  (this._mouseMarker.style.height = "1px"),
      ...
      (r.inherit(h, l),
        ...
        (h.prototype._orientation = null),
        (h.prototype._canvas = null),
        (h.prototype._context = null),
        (h.prototype._mouseMarker = null),
        (h.prototype._offset = 0),
        (h.prototype._scale = 1),
        (h.prototype._isUnitRuler = null),
        (h.prototype._verticalWidth = null),
        (h.prototype.setMousePosition = function (e) {
          this._orientation === h.Orientation.Horizontal
            ? (this._mouseMarker.style.left = e + "px")
            : (this._mouseMarker.style.top = e + "px");
        }),
