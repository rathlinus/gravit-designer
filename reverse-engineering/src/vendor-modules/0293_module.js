...
function (e, t, i) {
      ...
      ((d.OPERATIONFLAG_STROKE = 2),
        ...
        (d.Fill.prototype._path = null),
        (d.Fill.prototype._lineWidth = null),
        Object.defineProperties(d.Fill.prototype, {
          fillStyle: {
            get: function () {
        ...
        (d.Fill.prototype.write = function (e) {
          ...
          if (this._workaroundStroke) {
            var i = new d.Stroke();
            ((i.lineWidth = this._lineWidth),
              (i.strokeStyle = this._fillStyle),
              t.add(i),
              t.add(this._path));
          }
          (t.add(this._fillStyle),
            t.add("evenodd" === this._rule ? h.f$ : h.f),
            t.write(e));
        }),
        (d.Stroke = function () {}),
        ...
        (d.Stroke.prototype._lineCap = null),
        (d.Stroke.prototype._lineJoin = null),
        (d.Stroke.prototype._miterLimit = null),
        Object.defineProperties(d.Stroke.prototype, {
          miterlimit: {
            get: function () {
        ...
        (d.Stroke.prototype.write = function (e) {
          var t = new a();
          (this._lineWidth && t.add(new u(this._lineWidth)),
            this._lineDash && t.add(this._lineDash),
            this._lineCap && t.add(this._lineCap),
            this._lineJoin && t.add(this._lineJoin),
            this._strokeStyle && t.add(this._strokeStyle),
            this._miterLimit && t.add(this._miterLimit + " M"),
            t.add(h.S),
            this._lineDash && t.add(new n()),
            this._lineCap && t.add(new A()),
            this._lineJoin && t.add(new c()),
            t.write(e));
        }),
        ...
        (d.prototype.accept = function (e) {
          for (
            var t = this.pdfObjects.slice(), i = 0;
            i < t.length && !1 !== e(t[i], i);
            i++
          );
        }),
        ...
        (d.prototype.add = function (e, t) {
          if (Array.isArray(e)) {
            ...
            var n = new l(e);
            (null != t
              ? this.pdfObjects.splice(t, 0, n)
              : this.pdfObjects.push(n),
              (this.lastObject = e));
          }
        }),
        ...
        (d.prototype.write = function (e) {
          this.pdfObjects.length &&
            (e.writeln("q"),
            this._clip && (this._clip.write(e), e.writeln()),
            o.each(this.pdfObjects, function (t, i) {
