...
function (e, t, i) {
      ...
      (n.inherit(A, s),
        ...
        (A.prototype._shapes = []),
        (A.prototype._id = null),
        (A.prototype._symbolId = null),
        (A.prototype._parent = null),
        (A.prototype.isEvenOdd = function () {
          return (
            void 0 === this._data.windingRule ||
            this._data.windingRule === A.WindingRule.EvenOdd
          );
        }),
        ...
        (A.prototype.parse = function (e, t) {
          this._shapes = [];
          var i = this._data;
          ((this._id = i.do_objectID),
            (this._symbolId = i.symbolID),
          ...
          this._shapes.length
            ? t
              ? t.execute(this._shapes, n, this._postParse.bind(this))
              : (this._shapes.forEach(n), this._postParse())
            : this._postParse();
        }),
        ...
        (A.prototype._getGeometryBBox = function () {
          var e;
          return (
            this.visitReferences(function (t) {
              if (t.frame) {
        ...
        (A.prototype._getTransform = function () {
          var e = 1,
            t = 1,
            i = -(this._data.rotation || 0);
          (this._data.isFlippedHorizontal && (e = -1),
            this._data.isFlippedVertical && (t = -1));
          var n = new r().rotated(a.toRadians(i)).scaled(e, t),
            s = this._getGeometryBBox(),
            l = s.getSide(o.Side.CENTER);
          return r
            .getNativeRectTransformation(s)
            .translated(-l.getX(), -l.getY())
            .multiplied(n)
            .translated(l.getX(), l.getY());
        }),
        (A.prototype._getTransformation = function () {
          var e = this._getTransform().decomposed(),
            t = this._getGeometryBBox().getSide(o.Side.CENTER),
            i = e.scale.scaled(
              1 / Math.abs(e.scale._sx),
              1 / Math.abs(e.scale._sy),
            );
          return new r()
            .translated(-t.getX(), -t.getY())
            .multiplied(e.skew.multiplied(e.rotate).multiplied(i))
            .translated(t.getX(), t.getY());
        }),
        ...
        (A.prototype.clone = function () {
          ...
          ((e._id = this._id),
            (e._symbolId = this._symbolId),
            (e._parent = this._parent));
          var t = [];
          return (
            this._shapes.forEach(function (e) {
              t.push(e.clone());
            }),
            (e._shapes = t),
            e
        ...
        (A.prototype.appendTo = function (e, t) {
          ...
          t
            ? t.execute(this._shapes, i, this._postAppendTo.bind(this))
