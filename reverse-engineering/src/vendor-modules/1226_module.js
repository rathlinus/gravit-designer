      ...
      (o.inherit(f, l),
        ...
        (f.prototype.load = function (e) {
          ...
          if (t instanceof r) {
            ...
            if (t instanceof n) i = new h(e);
              ...
              if (!(t instanceof g))
                return void console.log(
                  "WARN: Unsupported gradient pattern: " + t,
                );
              i = new A(e);
            }
            ...
            ((this._pattern = new u(m, this._operation)),
              (this._operator = "scn"));
          } else {
          ...
          this._operation & d.OPERATIONFLAG_STROKE &&
            (this._operator = this._operator.toUpperCase());
        }),
