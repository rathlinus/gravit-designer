...
function (e, t, i) {
      ...
      (C.inheritAndMix(E, C, [w]),
        ...
        (E.prototype._fontManager = null),
        (E.prototype._doc = null),
        (E.prototype._changeLock = 0),
        (E.prototype._changeParam = 0),
        (E.prototype._canvas = null),
        (E.prototype._fillCanvas = null),
        (E.prototype._strokeCanvas = null),
        (E.prototype._ctx = null),
        (E.prototype._maxWidth = 0),
        (E.prototype._width = 1),
        (E.prototype._height = 1),
        (E.prototype._deferredSettings = null),
        (E.prototype._verticalShift = 0),
        ...
        (E.prototype.initialize = function (e, t, i, n) {
          E.textMeter ||
            ((r.fontManager = i), (c.fontManager = i), (E.textMeter = r));
          var a = i.getDefaultFont();
          if (!a)
            throw new Error(
              "GTLCore: Cannot instantiate - default font unavailable",
            );
          ...
          if (
            ...
            (this._width = e || 1),
            (this._height = t || 1),
            (this._ctx = new u(this, s)),
            (this._maxWidth = 4096),
            (this._fontManager = i || null),
            (this._fontCallback = n),
            this._deferredSettings)
          ) {
            var l = this._deferredSettings;
            (l.hasOwnProperty(text) && this.setText(l.text),
              l.hasOwnProperty(width) && this.setWidth(l.width),
              l.hasOwnProperty(height) && this.setHeight(l.height),
              l.hasOwnProperty(select) &&
                this.select(l.select.start, l.select, end),
              l.hasOwnProperty(selectAll) && this.selectAll(),
              l.hasOwnProperty(wrap) && this.setWrap(l.wrap),
              l.hasOwnProperty(path) &&
                this.setPath(
                  l.path.path,
                  l.path.direction,
                  l.path.side,
              ...
              l.hasOwnProperty(direction) &&
                this.setDirection(l.direction.direction));
          }
        }),
        (E.prototype.destroy = function () {
          (v.destroy(this._canvas),
            v.destroy(this._fillCanvas),
            v.destroy(this._strokeCanvas));
        }),
        (E.prototype._initializeDefaults = function (e) {
          if (!l.defaultFormatting.fontFamily) {
            ...
            (Number.isNaN(i)
              ? (l.defaultFormatting.fontWeight = t["font-weight"])
              : (l.defaultFormatting.fontWeight = i),
            ...
            var o =
              n._fc && n._fc instanceof A ? n._fc.toScreenCSS() : "transparent";
            switch (
              ((l.defaultFormatting.fontColor = o),
              (l.defaultFormatting.charSpacing = n._tcs),
              (l.defaultFormatting.wordSpacing = n._tws),
        ...
        (E.prototype.setWidth = function (e) {
          this.isInitialized()
            ? ((this._width = e),
              e == E.AUTO
                ? this._doc.width(this.getActualWidth() || this._maxWidth)
                : this._doc.width(e))
            : this._setDeferred("width", e);
        }),
          ...
          if (this.isInitialized()) {
            if (this._textTransformer)
              if (this._textTransformer.getType() === g.TYPE) {
                if (e !== f.LTR) {
                  var t = new f(this, {
                    direction: parseInt(e),
                  });
                  (this._textTransformer.prepend(t),
                    (this._textTransformer = t),
                    (this._ctx.textTransformer = this._textTransformer));
                }
              } else
                this._textTransformer.getType() === f.TYPE &&
                  (e === f.LTR
                    ? ((this._textTransformer = this._textTransformer.remove()),
                      (this._ctx.textTransformer = this._textTransformer))
                    : this._textTransformer.setDirection(e));
            else
              e !== f.LTR &&
                ((this._textTransformer = new f(this, {
                  direction: parseInt(e),
                })),
                (this._ctx.textTransformer = this._textTransformer));
            this._calculateRenderBounds();
          } else
            this._setDeferred("direction", {
              direction: e,
            });
        }),
        ...
        (E.prototype.getTransformer = function (e) {
          return e
            ? this._textTransformer
              ? this._textTransformer.get(e)
              : null
            : this._textTransformer
              ? this._textTransformer.getFirst()
              : null;
        }),
        ...
        (E.prototype.getLeftPadding = function () {
          ...
          if (this.hasPathTransformer()) return this._padding || 0;
          if (!this._doc.frame) return null;
          var e = this._padding || 0,
            t = this._doc.frame.leftPadding() || 0;
        ...
        (E.prototype.getRightPadding = function () {
          ...
          if (!this._doc.frame) return null;
          var e = this._padding || 0,
            t = this._doc.frame.rightPadding() || 0;
          return (t > 0 && (e += Math.abs(t)), e);
        }),
        (E.prototype.getWidth = function () {
          return this.isInitialized()
            ? this.hasPathTransformer()
              ? this._renderBounds.getWidth()
              : this._width == E.AUTO
                ? this.getActualWidth()
                : this._width
            : 0;
        ...
        (E.prototype.getLength = function () {
          return this.isInitialized()
            ? this._doc.frame
              ? this._doc.frame.length
              : 0
            : this._deferredSettings && this._deferredSettings.text
              ? this._deferredSettings.text.length - 1
              : 0;
        }),
        ...
        (E.prototype.getSelection = function () {
          return this.isInitialized()
            ? this._doc.selection
            : this._deferredSettings && this._deferredSettings.select
              ? this._deferredSettings.select
              : null;
        }),
            ...
            var i = [],
              n = function (e, i) {
                switch (e.type) {
                  ...
                  default:
                    throw new Error(
                      "Gravit Text Layout Error: unknown node type",
                    );
                }
              };
            return (
                  ...
                  if (this._textTransformer) {
                    var r = function (e) {
                      var n = e.bounds(!1, !0),
                        ...
                        s =
                          this._textTransformer.getMatrix(
                            n.l,
                            isNaN(e.baseline) ? 0 : e.baseline,
                            o,
                          ) || new y(),
                        l = new y(1, 0, 0, 1, -a.getX(), -a.getY());
                      ((t = s.multiplied(l)),
                        i.push({
                          box: r,
                          transform: t,
        ...
        (E.prototype.select = function (e, t) {
          return this.isInitialized()
            ? this._doc.select(e, t)
            : (this._setDeferred("selectAll", null),
              this._setDeferred("select", {
                start: e,
                end: t,
              }),
              null);
        ...
        (E.prototype.selectAll = function () {
          return this.isInitialized()
            ? this.select(0, this.getLength() - 1)
            : (this._setDeferred("select", null),
              void this._setDeferred("selectAll"));
        }),
        (E.prototype.selectionChanged = function (e, t) {
          if (!this.isInitialized()) throw new Error(E.INITIALIZATION_ERROR);
          return (
            t && this._doc.selectionChanged.clearHandlers(),
            this._doc.selectionChanged(e)
          );
        }),
        (E.prototype.contentChanged = function (e, t) {
          if (!this.isInitialized()) throw new Error(E.INITIALIZATION_ERROR);
          var i = this._changeParam;
          (t && this._doc.contentChanged.clearHandlers(),
            this._doc.contentChanged(
              function (t) {
                var n;
                return (
                  this._changeLock || (n = e(i)),
                  (this._wasEdited = !0),
                  n
                );
              }.bind(this),
        ...
        (E.prototype.getLines = function () {
          var e = [],
            t = function (i) {
              ("line" === i.type && e.push(i),
                "function" == typeof i.children && i.children().forEach(t));
            };
          return (
            this._checkFrame() &&
              this._doc.frame.lines &&
              this._doc.frame.lines.forEach(t),
            e
          );
        }),
        ...
        (E.prototype._calculateRenderBounds = function () {
          if (!this.isInitialized()) return new d(0, 0);
          var e,
            t = new m();
          return (
            this.renderVertices(t),
            (e = _.calculateBounds(t)),
            (this._renderBounds = e || new d(0, 0)),
            this._renderBounds
          );
        }),
        (E.prototype.render = function (e, t, i, n) {
          if (!this.isInitialized()) throw new Error(E.INITIALIZATION_ERROR);
          var r = Math.max(this.getLeftPadding(), this.getRightPadding()),
            o = this._padding || 0,
            l = this.getWidth() + 2 * r,
            A = this.getHeight() + 2 * o,
            c = 0,
            u = 0,
            g = 1,
            f = l,
          ...
          if (this.hasPathTransformer()) {
            ...
            ((c = -y.getX()),
              (u = -y.getY()),
              (f = y.getWidth() + Math.max(2 * r, 2 * o)),
              (m = y.getHeight() + Math.max(2 * r, 2 * o)),
              (this._renderBounds = y),
              (l = this.getActualWidth()),
              (A = this.getActualHeight()));
          } else this._renderBounds = new d(0, 0, l, A);
          (this._ctx.renderMode(0),
            t || (t = 1),
            n & p.RENDERFLAG_SCALEBITMAP && (g *= t));
          var _ = Math.ceil(g * f),
            b = Math.ceil(g * m),
            C = !1,
            w = this.getCanvas();
          (w.width !== _ &&
            ((w.width = _ <= 0 ? 1 : _),
            v.isRenderPhase() || (this._canvas.width = w.width),
            (C = !0)),
            w.height !== b &&
              ((w.height = b <= 0 ? 1 : b),
              v.isRenderPhase() || (this._canvas.height = w.height),
              (C = !0)),
            C ||
              (this._ctx.setTranslate(0, 0), this._ctx.clearRect(0, 0, f, m)),
            i.shapePaint
              ? (n & p.RENDERFLAG_STROKE &&
                  ((n |= p.RENDERFLAG_LOCKSTROKE),
                  (this._ctx.strokeStyle = s.prototype._convertStyle.call(
                    this,
                    i.shapePaint,
                  ))),
                n & p.RENDERFLAG_FILL &&
                  (this._ctx.defaultFill = s.prototype._convertStyle.call(
                    this,
                    i.shapePaint,
                  )))
              : n & p.RENDERFLAG_FILL &&
                (this._ctx.defaultFill = "transparent"),
            (this._ctx.globalAlpha =
              "number" == typeof i.opacity ? i.opacity : 1),
            (this._ctx.globalCompositeOperation =
              s.CompositeOperator.SourceOver),
            n & p.RENDERFLAG_STROKE &&
              ("number" == typeof i.strokeWidth
                ? (this._ctx.lineWidth = i.strokeWidth)
                : (this._ctx.lineWidth = 1),
              (this._ctx.lineCap = i.lineCap || "butt"),
              (this._ctx.lineJoin = i.lineJoin || "miter"),
              (this._ctx.miterLimit =
                "number" == typeof i.miterLimit ? i.miterLimit : 10),
            ...
            i.strokeAlign === a.BorderAlignment.Inside
              ...
              : i.strokeAlign === a.BorderAlignment.Outside &&
                (n |= p.RENDERFLAG_OUTSIDEBRD),
          ...
          (i.valign &&
            ...
            ("m" == i.valign
              ? (B =
                  (A - (this._doc.frame ? this._doc.frame.bounds().h : 0)) / 2)
              : "b" == i.valign &&
                (B = A - (this._doc.frame ? this._doc.frame.bounds().h : 0))),
            (this._verticalShift = -B),
            this._ctx.setTranslate(
              c * g + this.getLeftPadding() * t,
              g * (B + u) + o * t,
            ),
            this._ctx.setScale(g, g));
          var x = this._ctx.getFillTransform(),
            P = this._ctx.globalAlpha;
          (i.paintTransform && this._ctx.appendFillTransform(i.paintTransform),
            n & p.RENDERFLAG_NODRAW &&
              n & p.RENDERFLAG_STROKE &&
              this._ctx._canvasContext.beginPath(),
            this._doc.draw(
              this._ctx,
              new h(
                0,
                Math.max(0, this._verticalShift),
                l,
                A + Math.max(0, this._verticalShift),
              ),
            ),
            n & p.RENDERFLAG_NODRAW &&
              n & p.RENDERFLAG_STROKE &&
              (this._ctx.strokeVertices(),
              n & p.RENDERFLAG_INSIDEBRD
            ...
            i.paintTransform &&
              ...
              n & p.RENDERFLAG_STROKE &&
                ((this._ctx.globalAlpha = P),
                (this._ctx.globalCompositeOperation =
                  s.CompositeOperator.SourceOver))),
            e &&
              n & p.RENDERFLAG_DRAWSELECTION &&
              this._doc.drawSelection(this._ctx, e || !1));
          var S = function (e, t) {
            e.width * e.height != 0 &&
              ((t.width = e.width),
              (t.height = e.height),
              (t.globalCompositeOperation = s.CompositeOperator.Copy),
          ...
          if (n & p.RENDERFLAG_FILL) {
            ...
            (!v.isRenderPhase() &&
              w.width * w.height > 0 &&
              ((this._fillCanvas.width = w.width),
              (this._fillCanvas.height = w.height)),
              S(w, this.getCanvas(p.RENDERFLAG_FILL)));
          }
          n & p.RENDERFLAG_STROKE &&
            (n & p.RENDERFLAG_FILL
              ? (v.destroy(this._strokeCanvas),
                (this._strokeCanvas = this._fillCanvas))
              : ((this._strokeCanvas &&
                  this._fillCanvas !== this._strokeCanvas) ||
                  (this._strokeCanvas = v.getRenderer(
                    !0,
                    void 0,
                    void 0,
                    !0,
                ...
                !v.isRenderPhase() &&
                  w.width * w.height > 0 &&
                  ((this._strokeCanvas.width = w.width),
                  (this._strokeCanvas.height = w.height)),
        ...
        (E.prototype.renderVertices = function (e) {
          if (!this.isInitialized()) throw new Error(E.INITIALIZATION_ERROR);
          (this._ctx.renderMode(p.RENDERFLAG_VERTEX),
            this._ctx.clearVertices(),
            this.hasPathTransformer()
              ? this._doc.draw(
                  this._ctx,
                  new h(
                    ...
                    Math.max(0, this._verticalShift),
                    this.getActualWidth(),
                    this.getActualHeight() + Math.max(0, this._verticalShift),
                  ),
                )
              : this._doc.draw(
                  this._ctx,
                  new h(
                    ...
                    Math.max(0, this._verticalShift),
                    this.getWidth(),
                    this.getHeight() + Math.max(0, this._verticalShift),
                  ),
                ),
            this._ctx.addVertices(e));
        }),
        (E.prototype.renderVerticesWithStyle = function (e) {
          if (!this.isInitialized()) throw new Error(E.INITIALIZATION_ERROR);
          (this._ctx.renderMode(
            p.RENDERFLAG_VERTEX | p.RENDERFLAG_RENDERSTYLES,
          ),
            this._ctx.clearVertices(),
            this.hasPathTransformer()
              ? this._doc.draw(
          ...
          return e & p.RENDERFLAG_STROKE
            ? v.isRenderPhase()
              ...
              : this._strokeCanvas instanceof b.RendererCanvas
                ? ((i = this._strokeCanvas.$realCanvas) ||
                    (i = this._strokeCanvas.__realCanvas),
                  i)
                : this._strokeCanvas
            : e & p.RENDERFLAG_FILL
              ? v.isRenderPhase()
                ...
                : this._fillCanvas instanceof b.RendererCanvas
                  ? ((i = this._fillCanvas.$realCanvas) ||
                      (i = this._fillCanvas.__realCanvas),
                    i)
                  : this._fillCanvas
              : v.isRenderPhase()
                ? this._canvas
                : this._canvas instanceof b.RendererCanvas
                  ? ((i = this._canvas.$realCanvas) ||
                      (i = this._canvas.__realCanvas),
                    i)
                  : this._canvas;
        }),
        ...
        (E.prototype._setDeferred = function (e, t) {
          (this._deferredSettings || (this._deferredSettings = {}),
            (this._deferredSettings.name = t));
        }),
