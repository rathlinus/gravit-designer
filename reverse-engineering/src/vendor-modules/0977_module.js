...
function (e, t, i) {
      ...
      const n = i(170),
        ...
        C = (i(430), /xmas/),
        w = (e) => {
          32 === (e.which || e.keyCode) &&
            (e.preventDefault(), o(e.target).click());
        },
        E = (e) => {
          try {
        ...
        return (
          o("<span></span>")
            ...
            .on("click", (e) => {
              o(e.target)
                .closest("span")
                .toggleClass("g-cloud-icon-display g-cloud-icon-hide")
                .hasClass("g-cloud-icon-hide")
      ...
      function P(e) {
        ...
        if (m.searchParams) {
          ((u = m.searchParams.get("webUrl")),
            (d = m.searchParams.get("appUrl")));
          ...
          for (
            var y, v = /[?&]([^=#]+)=([^&#]*)/g, C = {};
            (y = v.exec(window.location.href));
          )
            C[y[1]] = y[2];
          ((u = C.webUrl),
            (d = C.appUrl),
            (g = C.newUser && "false" != C.newUser),
            (f = !C.closeable || "false" != C.closeable));
        }
        if (u)
          try {
            u = window.atob(u);
        ...
        ((this._title = o("<span></span>")
          ...
          .append(
            o("<label></label>").text(
              n.get(new r("GLoginDialog", "text.title-discontinued")),
            ),
          )
          .appendTo(w)),
          (this._container = o("<div></div>")
            .addClass("container")
            .appendTo(this._dialog)),
            ...
            .append(
              o("<span></span>").html(
                n
                  ...
                  .replace(
                    "%support-link",
                    '<span class="support-link">'.concat(_(), "</span>"),
                  ),
              ),
            )),
      ...
      ((P.Forms = {
        ...
        (P.prototype._isNewPurchaseFlow = function () {
          return (
            !!this._flow &&
            ("purchase_flow_new" === this._flow || "purchase" === this._flow)
          );
        }),
          ...
          ((this._coupon = t ? t[0].slice("_gcoupon=".length) : null),
            this._coupon &&
              ...
              this._title
                ...
                .append(
                  o("<label></label>").text(
                    n.get(new r("GLoginDialog", "text.title-xmas-title")),
                  ),
                )
                .append(o("<br>"))
                .append(
                  o("<label></label>").text(
                    n.get(new r("GLoginDialog", "text.title-xmas-subtitle")),
                  ),
                ),
            this._buildForm().appendTo(this._container),
            this._isNewPurchaseFlow() ||
              this._buildProInfo().appendTo(this._container),
            o("<span></span>")
              .addClass("version")
              .html(this._getFormattedVersion())
              .appendTo(this._dialog),
            ...
            e
              ...
              .append(
                o("<div></div>")
                  .addClass("g-cloud-ui-login-dialog")
                  .append(this._dialog),
              )
              .append(this._modal)
        ...
        (P.prototype._getFormattedVersion = function () {
          ...
          return (
            n
              .get(new r("GLoginDialog", "text.version"))
              .replace("%version", this._version) + t
          );
        }),
                  ...
                  .append(
                    o("<span></span>")
                      ...
                      .on(
                        ...
                        function () {
                          let e = this._getStatMappedForm();
                          (a("login-signup_".concat(e, "_help"), null, !0),
                            this._helpTip.toggleClass("visible"));
                        }.bind(this),
                      ),
                  )
        ...
        (P.prototype._onResetPasswordSubmit = async function (e, t) {
          ...
          A.isAvailable() &&
            grecaptcha.reset(this._resetPasswordRecaptchaWidget);
        }),
        (P.prototype._buildResetPassword = function () {
          let e = o("<div></div>")
              ...
              .attr(
                "data-title",
                n.get(new r("GLoginDialog", "text.forgot-password")),
              ),
          ...
          return (
            ...
            o("<button></button>")
              ...
              .append(
                o("<span></span>").text(
                  n.get(new r("GLoginDialog", "text.reset-password-send")),
                ),
              )
              .appendTo(t),
            ...
            o("<footer></footer>")
              .append(
                o("<span></span>")
                  ...
                  .keydown(w)
                  .on("click", () => {
                    (a("login-signup_forgot-password_back-to-login", null, !0),
                      this._activatePanel(P.Forms.SignIn));
                  }),
              )
              .appendTo(e),
        ...
        (P.prototype._buildSignup = function () {
          let e = o("<div></div>")
            ...
            .attr(
              "data-title",
              n
                .get(new r("GLoginDialog", "text.title-create-account"))
          ...
          o("<div></div>")
            ...
            .append(
              o("<span></span>").text(
                n.get(new r("GLoginDialog", "text.sign-up-already")),
              ),
            )
            .append(
              o("<span></span>")
                ...
                .keydown(w)
                .on("click enter", () => {
                  (a("login-signup_create-account_back-to-login", null, !0),
                    this._activatePanel(P.Forms.SignIn));
                }),
            )
            .appendTo(e);
                ...
                this._gApi
                  ...
                  .catch((e) => {
                    (this._toggleLoading(!1),
                      this._handleError(e),
                      i && grecaptcha.reset(this._recaptchaWidget));
                  }));
            };
          t.on(
            "submit",
          ...
          if (
            ...
            o("<div></div>")
              ...
              .append(
                o("<div></div>")
                  ...
                  .append(
                    o("<label></label>").text(
                      n.get(new r("GLoginDialog", "text.first-name")),
                    ),
                  )
                  .append(
                    o("<input>")
              ...
              .append(
                o("<div></div>")
                  ...
                  .append(
                    o("<label></label>").text(
                      n.get(new r("GLoginDialog", "text.last-name")),
                    ),
                  )
                  .append(
                    o("<input>")
            ...
            o("<label></label>")
              ...
              .append(
                o("<span></span>").text(
                  n.get(new r("GLoginDialog", "text.sign-up-password")),
                ),
              )
              .append(
                o("<span></span>").text(
            ...
            o("<label></label>")
              ...
              .append(
                o("<span></span>")
                      ...
                      n
                        ...
                        .replace(
                          ...
                          o("<span/>")
                            ...
                            .attr("tabindex", 0)
                            .text(
                              n.get(new r("GLoginDialog", "text.terms-use")),
                            )
                            .prop("outerHTML"),
                        )
                        .replace(
                  ...
                  .append(
                    o("<span></span>").text(
                      n.get(new r("GLoginDialog", "text.privacy-statement")),
                    ),
                  )
                  .append(
                    o("<span></span>")
                      ...
                      .text(
                        n.get(
                          new r("GLoginDialog", "text.privacy-statement-link"),
                        ),
                      )
                      .keydown(w)
                      .on(
              ...
              .on(
                ...
                () => (
                  ...
                  this._impl.openExternalLink({
                    dialog: this,
                    link: b(
                      "https://www.corel.com/terms/",
                      this._getUTMCampaignParams(),
                    ),
                  }),
                  !1
                ),
            ...
            o("<label></label>")
              ...
              .append(
                o("<span></span>").text(
                  n.get(new r("GLoginDialog", "text.info-privacy-statement")),
                ),
              )
              .appendTo(t),
            o("<label></label>")
              ...
              .on("change", (e) => {
                a(
                  ...
                  o(e.target).is(":checked"),
                  !0,
                );
              })
              .append(
                o("<span></span>").text(
                  n.get(new r("GLoginDialog", "text.newsletter")),
                ),
              )
              .appendTo(t),
            i)
              ...
              o("<span></span>").text(
                this._isNewPurchaseFlow()
                  ? ((e) => {
                      ...
                      return (
                        n.get(
                          new r("GLoginDialog", "text.continue-to-".concat(e)),
            ...
            o("<div></div>")
              ...
              .append(
                this._createFacebookButton(
                  new r("GLoginDialog", "text.sign-facebook"),
                ),
              )
              .append(
                this._createGoogleButton(
                  new r("GLoginDialog", "text.sign-google"),
                ),
              )
              .appendTo(e),
            o("<div></div>").addClass("spacer").appendTo(e));
          ...
          return (
            o("<span></span>")
              ...
              .html(
                n
                  .getValue("GLoginDialog", "text.create-account-info")
                  .replace("%privacy-link", d),
              )
              .appendTo(g)
              .find("a")
              .on("click", (e) => {
        ...
        (P.prototype._createGoogleButton = function (e) {
          return o("<button></button>")
            ...
            .append(
              o("<span></span>")
                .addClass("icon")
                .addClass("g-cloud-icon-google"),
            )
            .append(o("<span></span>").addClass("txt").text(n.get(e)))
            .on("click", () => {
              let e = this._getStatMappedForm();
              (a("login-signup_".concat(e, "_login-google"), null, !0),
                this._oauth("google"));
            });
        }),
        (P.prototype._createFacebookButton = function (e) {
          return o("<button></button>")
            ...
            .append(
              o("<span></span>")
                .addClass("icon")
                .addClass("g-cloud-icon-facebook"),
            )
            .append(o("<span></span>").addClass("txt").text(n.get(e)))
            .on("click", () => {
              let e = this._getStatMappedForm();
              (a("login-signup_".concat(e, "_login-facebook"), null, !0),
        ...
        (P.prototype._buildThanks = function (e) {
          ...
          o("<header></header>")
            .append(
              o("<span></span>").html(
                n.get(new r("GLoginDialog", "text.account-created")),
              ),
            )
            .appendTo(i);
          ...
          return (
            this._title
              ...
              .append(
                o("<label></label>").text(
                  n.get(
                    new r("GLoginDialog", "text.title-title-account-created"),
                  ),
                ),
              ),
            e.trial_created ||
              ...
              this._gApi.license
                .activateTrial()
                .then(() => {
                  (e.email_verified || this._shouldBypassEmailVerification()) &&
                    this.close();
                })
                ...
                .html(
                  n
                    .get(
                      new r(
                        "GLoginDialog",
                        "text.confirmation-account-created",
                      ),
                    )
                ...
                .html(
                  n
                    .get(
                      new r(
                        "GLoginDialog",
                        "text.confirmation-account-created-subtitle",
                      ),
                    )
                    .replace("%days", window.__TRIAL_DAYS__ || 15),
                )
              ...
              o("<footer></footer>")
                .append(
                  o("<span></span>")
                    ...
                    .text(
                      n.get(
                        new r("GLoginDialog", "text.email-not-received-part-1"),
                      ),
                    ),
                )
                .append(
                  o("<span></span>")
                    ...
                    .text(
                      n.get(
                        new r("GLoginDialog", "text.email-not-received-part-2"),
                      ),
                    )
                    .keydown(w)
                    .on("click", async () => {
                      (a(
                        "login-signup_account-created_send-activation-email",
                        null,
                        !0,
                      ),
                        i.css("min-height", ""),
                      ...
                      try {
                        ...
                        this._gApi
                          ...
                          .then((e) => {
                            (this._showMessage(e && e.message, "info"),
                              i.css("min-height", "446px"));
                          })
                          .catch((e) => this._handleError(e));
                      } finally {
                        this._toggleLoading(!1);
        ...
        (P.prototype._buildSignin = function () {
          let e = o("<div></div>")
              ...
              .attr(
                "data-title",
                n.get(new r("GLoginDialog", "text.sign-in-title")),
              ),
            t = o("<form></form>").appendTo(e);
          (o("<div></div>")
            .html(
              "<p>⚠︎ ".concat(
                n.get(new r("GLoginDialog", "text.title-discontinued-notice")),
                "</p>",
              ),
            )
            .css("color", "#e3006e")
            .appendTo(t),
            t.on("submit", (e) => {
              (a("login-signup_login_login", null, !0),
                this._showMessage(),
                e.preventDefault());
              const t = o(e.target),
            ...
            o("<label></label>")
              ...
              .appendTo(t),
            x(
              new r("GLoginDialog", "text.placeholder-sign-in-password"),
            ).appendTo(t),
            o("<div></div>")
              ...
              .append(
                o("<button></button>")
                  ...
                  .append(
                    o("<span></span>").text(
                      n.get(new r("GLoginDialog", "text.sign-in-button")),
                    ),
                  ),
              )
              .appendTo(t),
            o("<div></div>")
              ...
              .keydown(w)
              .on("click", () => {
                (a("login-signup_login_forgot-password", null, !0),
                  this._activatePanel(P.Forms.ResetPassword));
              })
              .appendTo(t),
            o("<div></div>")
              .addClass("column-layout separator")
        ...
        (P.prototype._buildProInfo = function () {
          const e = [
              {
                title: n.get(
                  new r("GLoginDialog", "text.title-discontinued-eol-date"),
                ),
                content: n
                  .get(
                    new r(
                      "GLoginDialog",
                      "text.title-discontinued-eol-date-details",
                    ),
                  )
              ...
              },
              {
                title: n.get(
                  new r(
                    "GLoginDialog",
                    "text.title-discontinued-avoid-losing-work",
                  ),
                ),
                content: n.get(
                  new r(
                    "GLoginDialog",
                    "text.title-discontinued-avoid-losing-work-details",
                  ),
                ),
                action: {
                  text: n.get(
                    new r(
                      "GLoginDialog",
                      "text.title-discontinued-export-your-files",
                    ),
                  ),
                  link: f,
                },
              },
              {
                title: n.get(
                  new r(
                    "GLoginDialog",
                    "text.title-discontinued-sign-up-closed",
                  ),
                ),
                content: n
                  .get(
                    new r(
                      "GLoginDialog",
                      "text.title-discontinued-sign-up-closed-details",
                    ),
                  )
                ...
                action: {
                  text: n.get(
                    new r(
                      "GLoginDialog",
                      "text.title-discontinued-sign-up-closed-learn-more",
                    ),
                  ),
                  link: m,
                },
          ...
          if (i) {
            (a.html(n.get(new r("GLoginDialog", "text.xmas-header"))),
              s.append(
                o("<header></header>").text(
                  n.get(new r("GLoginDialog", "text.xmas-header-2")),
                ),
              ),
              s.append(
                t.map((e, t) =>
              ...
              this._gApi
                ...
                .then((t) => {
                  ...
                  i &&
                    o &&
                    (l =
                      5 * parseInt(Math.floor((100 * (1 - i / o)) / 5)) + "%");
                  const h = {
                    style: "currency",
                    currency: s,
                  };
                  ...
                  const A = i
                    ? i.toLocaleString(
                        a || n.getLocaleLanguageTag(navigator.language),
                        h,
                      )
                    : "";
                  A &&
                    ...
                    e.html(
                      n
                        .get(new r("GLoginDialog", "text.xmas-discount"))
                        .replace("%discount", l)
                        .replace("%price", A),
                    );
                }));
            ...
            (a.html(
              n.get(new r("GLoginDialog", "text.title-discontinued-thanks")),
            ),
              s.append(
                e.map((e) => {
        ...
        (P.prototype._activatePanel = function (e) {
          ((this._activePanel = e),
            this._showMessage(),
            this._dialog.find(".panel.g-active").removeClass("g-active"));
          let t = this._dialog
            .find(".panel#" + e)
            .addClass("g-active")
            .attr("data-title");
        ...
        (P.prototype._postLogin = async function (e) {
          try {
            ...
            (e.new &&
              ...
              this._toggleLoading(!0));
            const { flags: { welcomeMessage: t } = {} } = await this._gApi
              .getUserSettings()
              .catch(() => Object.create({}));
            if (
              !t &&
              ...
              !(
                this._isNewPurchaseFlow() ||
                (e.trial_created && e.email_verified)
              ))
            )
              return (
                this._buildThanks(e).insertBefore(
        ...
        (P.prototype._toggleLoading = function (e) {
          (this._formContent.toggleClass("g-cloud-ui-loading", e),
            this._welcomeback &&
              this._welcomeback.toggleClass("g-cloud-ui-loading", e));
        }),
                    ...
                    o("<span/>")
                      ...
                      .text(
                        n.get(
                          new r(
                            "GLoginDialog",
                            "text.email-not-received-part-2",
                          ),
                        ),
                      )
                      .on("click", async () => {
        ...
        (P.prototype._getUTMCampaignParams = function () {
          return this._getOptions(
            s.buildStoreCampaignParams(s.StoreCampaign.WelcomeScreen),
          );
        }),
