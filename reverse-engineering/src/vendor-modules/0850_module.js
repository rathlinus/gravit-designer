...
function (e, t) {
      ...
      ((i.prototype._bytePosition = 0),
        (i.prototype._buffer = null),
        (i.prototype.getBytePosition = function () {
          return this._bytePosition;
        }),
        (i.prototype.writeByte = function (e) {
          (this._ensureCapacity(this._bytePosition + 1),
            this._buffer.set([e], this._bytePosition++));
        }),
        (i.prototype.writeWord = function (e) {
          (this.writeByte((e >> 8) & 255), this.writeByte(255 & e));
        }),
        (i.prototype.writeArray = function (e) {
          (this._ensureCapacity(this._bytePosition + e.length),
            this._buffer.set(e, this._bytePosition),
            (this._bytePosition += e.length));
        }),
