/**
 * chunk.vendor.js Module #139
 * Type: class
 * Name: GTexturePattern
 */
...
function (e, t, i) {
      ...
      ((d.UpdateEvent = function (e) {
        ...
        (d.ScaleSettings = {
          fill: function (e) {
            (e.setRepeatMode(d.RepeatMode.None),
              e.setSizeMode(d.SizeMode.Cover),
              e.setPosition(d.PositionMode.Center));
          },
          fit: function (e) {
            (e.setRepeatMode(d.RepeatMode.None),
              e.setSizeMode(d.SizeMode.Contain),
              e.setPosition(d.PositionMode.Center));
          },
          stretch: function (e) {
            (e.setRepeatMode(d.RepeatMode.None),
              e.setSizeMode(d.SizeMode.Percent),
              e.setPosition(d.PositionMode.Center),
              e.setWidth(100),
              e.setHeight(100));
          },
          tile: function (e) {
            (e.setRepeatMode(d.RepeatMode.Both),
              e.setSizeMode(d.SizeMode.Auto),
              e.setPosition(d.PositionMode.Auto));
          },
        }),
        n.inheritAndMix("T", d, n, [A]),
        (d.prototype._transform = void 0),
        (d.prototype._url = null),
        (d.prototype._image = null),
        (d.prototype._node = null),
        (d.prototype._repeatMode = d.RepeatMode.None),
        (d.prototype._sizeMode = d.SizeMode.Auto),
        (d.prototype._scaleMode = d.ScaleMode.Tile),
        (d.prototype._width = null),
        ...
        (d.equals = function (e, t) {
          ...
          return (
            ...
            !(
              !i ||
              ((e._transform || e._transform !== t._transform) &&
                !r.equals(e._transform, t._transform)) ||
              (e._node && e._node !== t._node)
            )
          );
        }),
        ...
        (d.prototype.setTexture = function (e) {
          (this._url &&
            this._scene &&
            c.isDictionary(this._url) &&
            this._scene.getDictionary().removeEntry(this._url),
            e &&
              ((this._invalidate = !0),
              this._cachedBitmap &&
                !this._cloned &&
                this._scene &&
                this._cachedBitmap._canvasContext instanceof p &&
                this._scene.addDestroyable(this._cachedBitmap._canvasContext),
              (this._cachedBitmap = null),
              "string" == typeof e
                ? o.equals(e, this._url) ||
                  ((this._url = e),
                  (this._node = null),
                  this._initializeImage())
                : e instanceof HTMLCanvasElement ||
                    e instanceof p.RendererCanvas ||
                    e instanceof u.RendererCanvas
                  ? ((this._node = null),
                    (this._url = null),
                    this._initializeImage(e))
                  : ((this._url = null),
                    (this._image = null),
                    (this._node = e.clone()))));
        }),
        (d.prototype.getTexture = function () {
          ...
          if (
            ...
            t.hasMixin(l.Container) &&
              t.acceptChildren(function (e) {
                "image" === l.getName(e) && i.push(e);
              }),
            i.length)
          ) {
            var n = l._nameToNodeClassMap.image,
              o = l._nameToNodeClassMap.scene,
              a = new h(),
              A = new o(a);
            if (
              (A.addEventListener(
                n.StatusEvent,
                function (e) {
                  (e.status !== n.ImageStatus.Loaded &&
                    e.status !== n.ImageStatus.Error) ||
                    (i.pop(),
                    i.length ||
                      ((this._invalidate = !1),
              ...
              var c = t.getPaintBBox(),
                u = new s(c.getWidth(), c.getHeight());
              return (
                u
                  .getHTMLElement()
                  .getContext("2d")
                  .drawImage(
                    this._cachedBitmap.getHTMLElement(),
                    0,
                    0,
                    u.getWidth(),
                    u.getHeight(),
        ...
        (d.prototype.setScene = function (e) {
          if (((this._scene = e), this._scene && this._url)) {
            ...
            if (
              ((!t || (this._storedUrl && t !== this._storedUrl)) &&
                (this._url = this._storedUrl),
              !this._url || !this._initializeImage())
            ) {
              var n = i(14).createChessboard(8, "#fcc", "#cfc"),
                r = new s(n);
              ((this._url = r.toImageDataUrl(s.ImageType.PNG)),
                d.ScaleSettings.tile(this),
                this._initializeImage());
            }
          }
        }),
        ...
        (d.prototype.getTextureBBox = function () {
          return this._image
            ? new a(0, 0, this._image.width, this._image.height)
            : this._node
              ? this._node.getPaintBBox()
              : null;
        }),
        ...
        (d.prototype._serializeToBlob = function (e) {
          var t = {};
          return (
            this._transform && (t.t = r.serialize(this._transform)),
            (t.u = this._url),
            (t.r = this._repeatMode),
            (t.s = this._sizeMode),
            (t.w = this._width),
            (t.h = this._height),
            (t.p = this._position),
            (t.m = this._mask),
            (t.a = this._angle),
            (t.sm = this._scaleMode),
            (t.ts = this._tileSize),
            this._node && (t.n = l.serialize(this._node)),
            (e && e.save) || (t.surl = this._storedUrl),
            t
          );
        }),
        (d.prototype._deserializeFromBlob = function (e) {
          ((this._transform = e.hasOwnProperty("t")
            ...
            : null),
            (this._url = e.u),
            (this._repeatMode = e.r),
            (this._sizeMode = e.s || d.SizeMode.Auto),
            (this._width = e.w),
            (this._height = e.h),
            (this._position = e.p || d.PositionMode.Auto),
            (this._mask = e.m),
            (this._angle = e.a || 0),
            (this._scaleMode = e.sm || d.ScaleMode.Tile),
            (this._tileSize = e.ts || 1),
            e.n && (this._node = l.deserialize(e.n)),
            (this._storedUrl = e.surl),
            this._initializeImage());
        }),
        ...
        (d.prototype.createTextureTransform = function (e, t, i) {
          var n = new r();
          if (!e || e.isEmpty()) return n;
          var o = this.getTextureBBox();
          if (!o || o.isEmpty()) return n;
          var s = t.mapRect(e);
          ...
          var l = o.getWidth(),
            ...
            c = 1;
          switch (
            (this.getScaleMode() == d.ScaleMode.Tile &&
              (A = c = this.getTileSize()),
            this.getSizeMode())
          ) {
            case d.SizeMode.Contain:
              A = c = Math.min(
                s.getWidth() / o.getWidth(),
            ...
            case d.SizeMode.Percent:
              ((A = ((this.getWidth() / 100) * s.getWidth()) / o.getWidth()),
                (c =
                  ((this.getHeight() / 100) * s.getHeight()) / o.getHeight()));
              break;
            case d.SizeMode.Length:
              ((A = this.getWidth() / o.getWidth()),
                (c = this.getHeight() / o.getHeight()));
          }
          var p = function (e, t) {
            if (1 !== e) {
          ...
          ((A = p(A, o.getWidth())),
            ...
            (A === this._scaleX && c === this._scaleY) ||
              (this._invalidate = !0),
            (this._scaleX = A),
            (this._scaleY = c));
          var u = t.decomposed(),
            g = this._getRotatedTransform(t) || new r();
          if (!g.isIdentity()) {
            var f = u.translate
                .multiplied(g)
                .decomposed()
                .translate.inverted()
                .getTranslation(),
              m = g.multiplied(u.translate).translated(f.getX(), f.getY());
          ...
          switch (this.getPosition()) {
            ...
            case d.PositionMode.Top:
              n = n.translated(
                s.getSide(a.Side.CENTER).getX() - l / 2,
                s.getY(),
              );
              break;
            case d.PositionMode.Left:
              n = n.translated(
                s.getX(),
                s.getSide(a.Side.CENTER).getY() - h / 2,
              );
              break;
            case d.PositionMode.Bottom:
              n = n.translated(
                s.getSide(a.Side.CENTER).getX() - l / 2,
                s.getSide(a.Side.BOTTOM_LEFT).getY() - h,
              );
              break;
            case d.PositionMode.Right:
              n = n.translated(
                s.getSide(a.Side.TOP_RIGHT).getX() - l,
                s.getSide(a.Side.CENTER).getY() - h / 2,
              );
              break;
          ...
          return n
            .translated(-y.getX(), -y.getY())
            .multiplied(g)
            .rotated(this.getAngle())
            .translated(y.getX(), y.getY())
            .multiplied(t.inverted());
        }),
