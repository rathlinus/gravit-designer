      ...
      (h.inherit(g, u),
        ...
        (g.prototype._mouseDown = function (e) {
          ...
          (this._editor.getGuides().beginMap(this._editor.getMappingScopes()),
            (t = this._editor
              .getGuides()
              .mapPoint(t, d.DetailMap.Mode.DetailOnFilterOn)),
        ...
        (g.prototype._doTheClip = function () {
          ...
          if (this._closeIfNeeded())
            ...
            (n.setProperties(["x", "y"], [i.$x, i.$y]),
              t.appendChild(n),
              e.correctClosedAttribute());
          }
          var h = this._startingSelection;
          if (h) {
            for (
              var p = [], u = [], d = new o(), g = !1, f = 0;
              f < h.length;
              f++
            )
              if (h[f].hasMixin(a)) {
                for (
                  var m = o.redistributeVertexSource(h[f]),
                    y = m.containers.length,
                    _ = [],
                    v = 0;
                  v < y;
                  v++
                  ...
                  for (var b = m.containers[v], C = 0; C < b.length; C++) {
                    ...
                    if (
                      ...
                      for (; w.readVertex(B); );
                      (B.command === c.Command.Close ||
                        (B.x === E.x && B.y === E.y)) &&
                        (_.push(w),
                        (x = !0),
                        d.intersect(e, w, !1, !0, null, m.polys[v][C]) &&
                          (g = !0));
                    }
                    x || u.push(w);
                  }
            ...
            if (p.length) {
              ...
              (!g && this._willMerge
                ...
                (P = (P = this._willMerge
                  ? this._doTheMerge(S, [e])
                  : this._doTheSub(S, [e])).concat(u)));
              ...
              (I && this._newPath.getParent().insertChild(I, this._newPath),
                ...
                I &&
                  ((this._newPath = I), this._editor.updateSelection(!1, [I])));
