      ...
      (function (t) {
        ...
        ((N.MAXLENGTH = 8192),
          ...
          (N._deserializeContent = function (e, t) {
            if ("fontColor" === e) {
              if ("transparent" === t) return _.BLACK;
              if ("string" == typeof t) return n.deserialize(t) || t;
              if ("object" == typeof t)
          ...
          (N.prototype._pendingAttachedPath = null),
          ...
          (N.prototype.__deserializedBackupPaths = null),
          Object.defineProperty(N.prototype, "_deserializedBackupPaths", {
            get: function () {
              if (this.__deserializedBackupPaths)
                return this.__deserializedBackupPaths;
              if (this._serializedBackupPaths) {
                var e,
                  t = this._serializedBackupPaths;
                try {
                  ((e = "string" == typeof t ? JSON.parse(t) : t),
                    (this.__deserializedBackupPaths = e.map(function (e) {
            ...
            set: function (e) {
              ((this._serializedBackupPaths = "dummy"),
                (this.__deserializedBackupPaths = e));
            },
          }),
          ...
          (N.prototype.contentChangedHandler = function (e, t) {
            ...
            i
              ? (i.contentChanged(e, t), (this._contentChangedHandler = null))
              : (this._contentChangedHandler = {
                  handler: e,
                  removeSub: t,
                });
          }),
          ...
          (N.prototype.attachPath = function (e) {
            ...
            if (this.isRecordedTransaction())
              ((t = this.getProperty("atPath")),
                this._attachPath(e, t ? r.deserialize(t) : null));
            else {
              if (((this._atPath = e), e)) {
                var i = e.cloneAnchorPoints(),
                  n =
                    e instanceof F || e.getProperty("closed")
                      ? new F(
                          e.getProperty("closed"),
                          e.getProperty("evenodd"),
                          i,
                        )
                      : new I(e.getProperty("evenodd"), i);
          ...
          (N.prototype._trySetPath = function (e, t, i, n, r, o) {
            ...
            if (s && e) {
              ...
              (s.setPath(
                e,
                this._correctDirOnPath(t),
                this._correctSideOnPath(i),
          ...
          (N.prototype._correctDirOnPath = function (e) {
            var t = e || this.$tpthd;
            if (this.$dir === g.LTR) return t;
            if (this.$trf) {
              var i = this.$trf.decomposed();
              i &&
                i.scale.getMatrix()[0] < 0 &&
                (t =
                  t === d.DIRECTION_INWARDS
                    ? d.DIRECTION_OUTWARDS
                    : d.DIRECTION_INWARDS);
            }
            return t;
          ...
          (N.prototype._correctSideOnPath = function (e) {
            ...
            if (this.$trf) {
              ...
              i &&
                i.scale.getMatrix()[0] < 0 &&
                (t = t === d.OUTSIDE ? d.INSIDE : d.OUTSIDE);
            }
            return t;
          }),
          (N.prototype._attachPath = function (e, t) {
            ...
            if (i) {
              ...
              (i.setPath(
                t,
                this._correctDirOnPath(),
                this._correctSideOnPath(),
                t
                  ? this.$tptho
                    ? this.$tptho - n / 2 + 0.5
                    : -n / 2 + 0.5
                ...
                t &&
                  (this.hasPathAttached() ||
                    ...
                    (this._oldTrf = this.getProperty("trf"))),
                (this._attachedPath = e));
            } else this._pendingAttachedPath = e;
          }),
          ...
          (N.prototype._calculateSourceBBox = function (e) {
            if (this.isFakeText()) {
              for (
                var t = this.getProperty("trf"),
                  i = this._deserializedBackupPaths.length
                    ? this._deserializedBackupPaths[0].getPreTransformRect(t)
                    : null,
                  n = 1;
                n < this._deserializedBackupPaths.length;
                n++
              ) {
          ...
          (N.prototype._calculateGeometryBBox = function (e) {
            if (this.isFakeText()) {
              for (
                var t = this._deserializedBackupPaths.length
                    ? this._deserializedBackupPaths[0].getGeometryBBox(e)
                    : null,
                  i = 1;
                i < this._deserializedBackupPaths.length;
                i++
                ...
                t = t.united(
                  this._deserializedBackupPaths[i].getGeometryBBox(e),
                );
              return t;
            }
            var n = new C(),
            ...
            if (this._runsDirty || !r.getCanvas()) {
              ...
              (r.setWidth(this.$aw ? f.AUTO : this._getWidth() - 2 * N.HMARGIN),
                r.setHeight(
                  this.$ah ? f.AUTO : this._getHeight() - 2 * N.VMARGIN,
                ),
                (-1 === this.$w || this.hasPathAttached()) &&
                  (this.$w = r.getWidth() + 2 * N.HMARGIN),
                (-1 === this.$h || this.hasPathAttached()) &&
                  (this.$h = r.getHeight() + 2 * N.VMARGIN));
            }
            if (e) {
              if (r.constructor === f) {
              ...
              if (this.hasPathAttached()) {
                ...
                var l = r.getHeight();
                ((l = l > 0 ? l : this._getHeight() - 2 * N.VMARGIN),
                  (n = new C(0, 0, s, l)));
              } else {
                var h = r.getRealBounds();
                n = new C(h.l, h.t, h.w, h.h);
              }
            } else n = new C(0, 0, this._getWidth(), this._getHeight());
            ...
            if (i) {
              ...
              if (n) {
                var r = Math.max(
                  ...
                  o = 2 * n.getTopPadding();
                if (
                  ((i = i.expanded(r, o, r + this._calculateBBoxSpacing(), o)),
                  this.hasStyleBorder() || this._hasStyleBorderPadding)
                ) {
                  var a = 0;
                  (this.getPaintLayers()
                    .getBorderLayers(!0)
                    ...
                    a && n.setPadding(a),
                    this.hasStyleBorder()
                      ? (this._hasStyleBorderPadding = !0)
                      : (this._hasStyleBorderPadding = !1));
                }
              }
            }
            return i;
          ...
          (N.prototype._styleFinishGeometryChange = function (e) {
            ((this._runsDirty = !0),
              b.prototype._styleFinishGeometryChange.call(this, e));
          }),
          (N.prototype._checkHasEmbeddedAndResetFakeText = function () {
            if (((this._hasEmbeddedFonts = !1), this._workspace))
              try {
                var e =
                  (this.$content &&
                    JSON.parse(this.$content, N._deserializeContent)) ||
                  this.getContent();
                if (e) {
                  var t = !0;
                  return (
                    (e = this._fixText(e)).forEach(
                      function (e) {
                        var i = this._workspace
                          .getFontManager()
                          .getFont(
                            this._getGravitValue("fontFamily", e.fontFamily),
                            this._getGravitValue("fontStyle", e.fontStyle),
                            this._getGravitValue("fontWeight", e.fontWeight),
                          );
                        ((i && i.isResolved()) || (t = !1),
                          i && i.isEmbedded() && (this._hasEmbeddedFonts = !0));
                      }.bind(this),
                    ),
                    void (
                      t &&
                      !this._hasEmbeddedFonts &&
                      (this._serializedBackupPaths = null)
                    )
                  );
                }
              } catch (e) {
          ...
          (N.prototype.setText = function (e, t, i) {
            ...
            if (
              ((e = this._shorten(e)),
              M.OperatingSystem.Windows && (e = a.replaceMicrosoftLineFeed(e)),
              r)
            ) {
              (t && (n = r.getDocumentRange().plainText()),
                i && r.lockChangeEvents(1));
              if (this._workspace) {
                if (e instanceof Array) {
                  for (var o, s, l, h, A = !0, c = 0; c < e.length; c++)
                    ((s = this._getGravitValue(
                      "fontFamily",
                      e[c].fontFamily || u.defaultFormatting.fontFamily,
                    )),
                      (l = this._getGravitValue(
                        "fontStyle",
                        e[c].fontStyle || u.defaultFormatting.fontStyle,
                      )),
                      (h = this._getGravitValue(
                        "fontWeight",
                        e[c].fontWeight || u.defaultFormatting.fontWeight,
                      )),
                      ((o = this._workspace
                        .getFontManager()
                        .getFont(s, l, h)) &&
              ...
              if (
                ...
                this._startText ||
                  (this._startText = p
                    ? JSON.stringify(r.getRichContent(), N._serializeContent)
                    : e),
                !p)
              )
                return;
              if (
                ((this._setTextWhenAvailable = !1), (this._tempText = null), t)
              ) {
                var d, g, f;
                ((d = (f = r.getDocumentRange().plainText()).length),
                  (g = n.length));
                var m,
                  y,
                  _,
                  v = Math.min(d, g);
                for (c = 0; c < v && n.charAt(c) == f.charAt(c); ) c++;
                for (
                  m = c, c = 0;
                  c < v && n.charAt(g - c - 1) == f.charAt(d - c - 1);
                )
                  c++;
                ((_ = d - c) - (y = m) <= 1 && (d < g ? (_ = y) : (y = _)),
                  r.select(y, _));
              }
            } else this._tempText = e;
          }),
          (N.prototype.getPlainText = function () {
            ...
            return (
              t
                ? (e = t.getDocumentRange().plainText()) ||
                  (e = this._startText)
                : this._tempText && (e = this._tempText),
              e
            );
          }),
          (N.prototype.getStylePropertySets = function () {
            return b.prototype.getStylePropertySets
              .call(this)
              .concat(p.PropertySet.Text, p.PropertySet.Paragraph);
          }),
          ...
          (N.prototype.getTextShapes = function () {
            if (this.isFakeText()) return this._deserializedBackupPaths;
            var e = this.getTLCore();
            if (!e) return [];
            if (!I || !c.createPathFromVertexSource) return [];
            (e.setWidth(this.$aw ? f.AUTO : this._getWidth() - 2 * N.HMARGIN),
              e.setHeight(
                this.$ah ? f.AUTO : this._getHeight() - 2 * N.VMARGIN,
              ));
            var t = [],
              i = [],
              n = e.getDocumentRange().getFormatting().fontColor;
            if (n && "transparent" !== n) {
              ...
              for (var r = t.length - 2; r >= 0; r--) {
                ...
                o.fill == a.fill &&
                  o.stroke == a.stroke &&
                  o.textFill == a.textFill &&
                  o.textStroke == a.textStroke &&
                  (t.splice(r, 1),
                  o.vertices &&
                    a.vertices &&
                    a.vertices.appendVertices(o.vertices));
              }
              m = this.$trf || new B();
              (g = e.getRenderBounds()) ||
                (g = new C(0, 0, e.getWidth(), e.getHeight()));
              y = new l(0, 0);
              (this.$va &&
                !this.hasPathAttached() &&
                ("m" == this.$va
                  ? (y = new l(0, (e.getHeight() - e.getActualHeight()) / 2))
                  : "b" == this.$va &&
                    (y = new l(0, e.getHeight() - e.getActualHeight()))),
                (this.$trf = null));
                ...
                if (h.vertices && h.vertices.getCount())
                  if (
                    ((h.vertices = new x(
                      h.vertices,
                      new B()
                        .translated(-g.getX() + y.getX(), -g.getY() + y.getY())
                        .multiplied(m),
                    )),
                    ...
                    if (
                      (s.assignFrom(this),
                      s.setProperty("evenodd", this._isEvenOddFill()),
                      h.textFill)
                    )
                      this.getPaintLayers().getFillLayers(!1).length ||
                        ...
                        s
                          .getPaintLayers()
                          .appendChild(new p.FillPaintLayer(h.textFill)));
                    else if (
                      "string" == typeof h.fill ||
                      h.fill instanceof String
                    ) {
                      if (!this.getPaintLayers().getFillLayers(!1).length)
                        (A = _.parseCSSColor(h.fill)) &&
                          ...
                          s
                            .getPaintLayers()
                            .appendChild(
                              new p.FillPaintLayer(new _(A.slice(0, 3)), A[3]),
                            ));
                    }
                    if (
                      (h.textStroke ||
                        "string" == typeof h.stroke ||
                        h.stroke instanceof String) &&
                      !this.getPaintLayers().getBorderLayers(!0).length
                    ) {
                      var A,
                        u = null,
                        d = 1;
                      if (h.textStroke) u = h.textStroke;
                      else
                        (A = _.parseCSSColor(h.stroke)) &&
                          A[3] > 0 &&
                          ((u = new _(A.slice(0, 3))), (d = A[3]));
                      u &&
                        (s.getPaintLayers().clearBorderLayers(),
                        s
                          .getPaintLayers()
                          .appendChild(new p.BorderPaintLayer(u, d)));
                    }
                    i.push(s);
                  }
              }
          ...
          (N.prototype.readVertex = function (e, t) {
            if (this.isFakeText())
              return (
                !!this.hasVertexForRead() &&
                this._deserializedBackupPaths[this._vertexIterator].readVertex(
                  e,
                )
              );
            var i = this._vertexContainer.readVertex(e);
            if (
              ((e.x || 0 === e.x) && t && (e.x += N.HMARGIN / t),
              (i && e.command !== S.Command.Close && this.$trf) ||
                (this.hasPathAttached() &&
                  this._tlCore &&
                  this._tlCore.isInitialized()))
            ) {
              var n;
              if (this.hasPathAttached()) {
                var r = this._tlCore.getRenderBounds();
                n = new B(1, 0, 0, 1, -r.getX(), -r.getY()).multiplied(
                  this.$trf || new B(),
                );
              } else n = this.$trf;
              n.map(e);
          ...
          (N.prototype.hasVertexForRead = function () {
            return this.isFakeText()
              ? this._deserializedBackupPaths[this._vertexIterator] &&
                  this._deserializedBackupPaths[
                    this._vertexIterator
                  ].hasVertexForRead()
              : this._vertexContainer.hasVertexForRead();
          }),
          (N.prototype.repaint = function (e) {
            (void 0 !== e && (this._isEdited = e),
          ...
          (N.prototype.setBounds = function (e, t, i, n) {
            if (!this.hasPathAttached()) {
              var r = this.$trf,
                o = new B()
                  .scaled(i / this._getWidth(), n / this._getHeight())
                  .translated(e, t);
              if (r) {
                var a = r.inverted();
                a && (o = o.multiplied(a));
          ...
          (N.prototype.transformSourceBBox = function (e, t, i, n, r) {
            if (e) {
              ...
              var o = e.getMatrix(),
                a = this.$trf,
                s = a ? a.getTranslation() : new l(0, 0),
                h = this._getWidth(),
                A = this._getHeight(),
                c = new C(s.getX(), s.getY(), t ? 1 : h, i ? 1 : A),
                p = e.mapQuadrilateral(c),
                u = Math.max(1, Math.abs(p[0].getX() - p[1].getX())),
                d = Math.max(1, Math.abs(p[0].getY() - p[3].getY())),
                g = this.getProperty("aw"),
                f = this.getProperty("ah");
              g && n && !R.isEqualEps(this._getWidth(), u, 1e-9)
                ? ((g = !1),
                  this.getProperty("vacr") == E.Anchor.AnchorType.Stretch &&
                    (f = !1))
                : f &&
                  r &&
                  !R.isEqualEps(this._getHeight(), d, 1e-9) &&
                  (f = !1);
          ...
          (N.prototype._detailHitTest = function (e, t, i, n) {
            ...
            var r;
            if (
              (this.isFakeText() || (r = this.getTLCore()),
              N.HITTEST_TEXT && r && r.getCanvas())
            ) {
              var o = new B();
              (this.$trf && (o = o.multiplied(this.$trf)),
                t && (o = o.multiplied(t)));
              var a = o.inverted().mapPoint(e),
                s = a.getX(),
                l = a.getY();
              if (!isFinite(s) || !isFinite(l)) return null;
              var h = 1 + 2 * (i = Math.floor(i + 0.5 * t.getScaleFactor())),
                A = r.getCanvas(y.RENDERFLAG_FILL),
                c = r.getCanvas(y.RENDERFLAG_STROKE),
                p = [];
              ...
              for (var u = 0; u < p.length; u++)
                for (
                  var d,
                    g,
                    f,
                    m = p[u].getContext("2d").getImageData(s - i, l - i, h, h),
                    _ = m ? m.data : [0, 0, 0],
                    v = Number.MAX_VALUE,
                    C = NaN,
                    w = 3;
                  ...
                  0 !== _[w] &&
                    (d =
                      ...
                      (i - (f = (w >> 2) / h)) * (i - f)) < v &&
                    ((v = d), (C = w));
              return Math.sqrt(v) > i
                ? null
                : new P(this, {
                    pixel: _.slice(C - 3, C + 1),
                  });
            }
            if (N.HITTEST_BOX) {
              o = new B();
              (this.$trf && (o = o.multiplied(this.$trf)),
                t && (o = o.multiplied(t)));
              var E = o.inverted().mapPoint(e),
                x = this.getSourceBBox();
          ...
          (N.prototype.getTLCore = function () {
            if (
              (this._tlCore || (this._tlCore = new f()),
              !this._workspace && !this._tlCore.isInitialized())
            )
            ...
            if (!this._tlCore.isInitialized()) {
              ...
              if (!e.isResolved()) return (this._requireResolvedFont(e), null);
              (this._tlCore.initialize(
                this.$w,
                this.$h,
                ...
                this._tlCore.setWrap(!this.$aw));
              for (
                var t,
                  i,
                  n = this._tlCore.getDocumentRange(),
                  r = this.getStylePropertySets(),
                  o = r.length - 1;
                o >= 0;
                o--
              ) {
                ...
                if (a.geometryProperties)
                  for (var s in a.geometryProperties)
                    ((t = N.PropertyMapping[s]),
                      (i = this._getGTLValue(s, a.geometryProperties[s])),
                      t && n.setFormatting(t, i));
                if (a.visualProperties)
                  for (var s in a.visualProperties)
                    ((t = N.PropertyMapping[s]),
                      (i = this._getGTLValue(s, a.visualProperties[s])),
                      t && n.setFormatting(t, i));
              }
              if (
                (this._contentChangedHandler &&
                  (this._tlCore.contentChanged(
                    this._contentChangedHandler.handler,
                    this._contentChangedHandler.removeSub,
                  ),
                ...
                if (
                  ...
                  (l.every(function (e, t) {
                    return (
                      !(
                        !e.toRange &&
                        ((c = !0), (u = t), e.props.hasOwnProperty("content"))
                      ) || ((c = !1), !1)
                    );
                  }),
                    c &&
                      (l[u].props.push("content"),
                      l[u].values.push(
                        JSON.stringify(h, N._serializeContent),
                      )));
                }
            ...
            if (this._pendingProperties) {
              ...
              (d.forEach(function (e) {
                e.toRange
                  ? ((m.props = m.props.concat(e.props)),
                    (m.values = m.values.concat(e.values)))
                  : ((g.props = g.props.concat(e.props)),
                    (g.values = g.values.concat(e.values)));
              }),
                m.props.length &&
                  this.setProperties(m.props, m.values, !1, !1, !1, !0, !0),
                g.props.length &&
                  this.setProperties(g.props, g.values, !1, !1, !1, !1, !0),
                (this._pendingAttachedPath = A));
            }
          ...
          (N.prototype._getWidth = function () {
            if (!this.$aw) return this.$w;
            var e = this.getTLCore();
            return e
              ? e.getWidth() - this._calculateBBoxSpacing() + 2 * N.HMARGIN
              : this.$w;
          }),
          (N.prototype._getHeight = function () {
            ...
            if (!this.$ah) {
              if (this._legacyHeight && !this._fontsToResolve) {
                ...
                ((this.$h = Math.max(t, this.$h)),
                  (this._legacyHeight = !1),
                  (this._repairedHeight = !0));
              }
              return this.$h;
            }
            ...
            if (n) {
              switch (n) {
                ...
                case "fontFamily":
                  ...
                  break;
                case "fontColor":
                  if ("transparent" == i) r = _.BLACK;
                  else if ("string" == typeof i) {
                    var s;
                    r =
                      (s = _.RGBREGEX.exec(i)) && 5 == s.length && 0 == s[4]
                        ? null
                        : _.fromCSSColor(i);
                  } else r = i || _.fromCSSColor(u.defaultFormatting[n]);
                  break;
                case "fontWeight":
                  var l;
                ...
                case "paragraphSpacing":
                  r =
                    i || !Number.isNaN(i) ? i : u.defaultFormatting[n] || null;
                  break;
                default:
          ...
          (N.prototype._getGTLValue = function (e, t) {
            var i = t,
              r = e,
              o = null;
            if (!N.PropertyMapping[r]) return null;
            switch (r) {
              case "_tfw":
              ...
              case "_pai":
                i instanceof String || "string" == typeof i
                  ? (o = i)
                  : ((o = parseFloat(i)), Number.isNaN(o) && (o = i));
                break;
              case "_tff":
                o = i;
                break;
          ...
          (N.prototype.getProperty = function (e, t, i, n, r) {
            var o;
            if (r) {
              if (!(o = this.getTLCore())) return;
              if (
                (A =
                  "_pal" === e || "_plh" === e || "_pas" === e || "_pai" === e
                    ? o.selectedParagraphRange()
                    : o.selectedRange()).start === A.end
              )
                for (var a in ((c = A.getFormatting()),
                A.doc.nextInsertFormatting))
                  c[a] = A.doc.nextInsertFormatting[a];
              else c = A.getFormatting();
              var s = c[(l = N.PropertyMapping[e])];
              return (h = this._getGravitValue(l, s));
            }
            var l = N.PropertyMapping[e],
              h = null;
          ...
          (N.prototype.setProperties = function (e, t, i, n, o, s, l, h) {
            ...
            if (!c)
              return (
                this._pendingProperties || (this._pendingProperties = []),
                this._pendingProperties.push({
                  props: e,
                  values: t,
                  rng: s,
                }),
                void (
                  s ||
                  l ||
                  b.prototype.setProperties.call(this, e, t, i, n, o)
                )
              );
            (c.lockChangeEvents(1),
              (A = s ? c.selectedRange() : c.getDocumentRange()));
            var p = null,
              u = null,
              f = null,
              m = null,
            ...
            for (J = 0; J < e.length; J++) {
              ...
              if ("content" == V) ((m = t[J] || this._startText), (y = !0));
                ...
                "trf" != V || o
                  ? "dir" === V
                    ? t[J] !== c.getDirection() &&
                      ((Q = t[J]), this.hasPathAttached() && (U = !0))
                    : this.hasPathAttached() &&
                      0 === V.indexOf("tpth") &&
                      ((U = !0),
                      (this._runsDirty = !0),
                ...
                (R = !0),
                (G = t[J]),
                (k = this._atPath ? this._atPath : null),
                G && !k)
              )
                D = r.deserialize(G);
              else if (k) {
                ...
                (D =
                  k instanceof F || k.getProperty("closed")
                    ? new F(
                        k.getProperty("closed"),
                        k.getProperty("evenodd"),
                        O,
                      )
                    : new I(k.getProperty("evenodd"), O)) && D.assignFrom(k);
              }
            }
            for (J = 0; J < e.length; J++) {
              ...
              (L && (y = !0),
                "fontWeight" == L
                  ? (Y instanceof Array &&
                      (Y =
                        1 !== Y.length || Y[0] instanceof Array ? null : Y[0]),
                    (u = ~~Y))
                  : "fontStyle" == L
                    ? (Y instanceof Array &&
                        (Y =
                          1 !== Y.length || Y[0] instanceof Array
                            ? null
                            : Y[0]),
                      (f = Y))
                    : "fontFamily" == L
            ...
            if (u || p || f) {
              var H,
                ...
                z = function (e, t) {
                  ...
                  if (t) n.push(t);
                    ...
                    (i = this.getProperty(e, !1, null, !1, this._isEdited))
                  )
                    n.push(i);
                  else if (null === i) {
                    i = A.save();
              ...
              ((W = z("_tff", p)),
                ...
                (Z = z("_tfs", f)),
                this._isEdited ||
                  (1 === W.length && (_.push("_tff"), C.push(W[0])),
                  1 === Z.length && (_.push("_tfs"), C.push(Z[0])),
                  1 === H.length && (_.push("_tfw"), C.push(H[0]))));
              var j = [];
              if (m)
                JSON.parse(m, N._deserializeContent).forEach(
                  function (e) {
                    if (e.fontFamily) {
                      var t = this._getGravitValue("fontFamily", e.fontFamily),
                        i = this._getGravitValue("fontStyle", e.fontStyle),
                        n = this._getGravitValue("fontWeight", e.fontWeight),
                        r = this._workspace.getFontManager().getFont(t, i, n);
                      r.isResolved() ||
                        (j.indexOf(r) < 0 && j.push(r),
                        this._requireResolvedFont(r));
                    }
                  }.bind(this),
                );
              for (var J = 0; J < W.length; J++)
                for (var q = 0; q < Z.length; q++)
                  for (var K = 0; K < H.length; K++) {
                    (X = this._workspace
                      .getFontManager()
                      .getFont(W[J], Z[q], H[K])).isResolved() ||
                      (j.indexOf(X) < 0 && j.push(X),
                      this._requireResolvedFont(X));
                  }
              var $ = {
                  fontFamily: p,
                  fontStyle: f,
                ...
                ee = function (e, t) {
                  for (
                    ...
                    if (
                      ...
                      var f = this._shorten(
                          JSON.parse(e.content, N._deserializeContent),
                        ),
                        m = {};
                      m.fontFamily = p;
                      var y = {};
                      ((y.fontFamily = u),
                        (y.fontWeight = g),
                        (y.fontStyle = d),
                        this._replaceFF(f, m, y),
                        (e.content = JSON.stringify(f, N._serializeContent)),
                        this.$_tff === p && (this.$_tff = u));
                    }
                    ...
                    (_ && _.isResolved()) ||
                      (_ &&
                        !_.isResolved() &&
                        p !== u &&
                        ((j[l] = _), this._requireResolvedFont(_)),
                      (i = !1));
                  }
                  if (!i) return !1;
                  if (e.content) {
                    ...
                    (n && (b.push("fontFamily"), C.push(n)),
                      ...
                      r &&
                        (b.push("fontStyle"),
                        C.push(r === v.Style.Normal ? "normal" : "italic")),
                      b.length &&
                        (o && c.lockChangeEvents(1),
                        A.setFormatting(b, C),
                        o && c.lockChangeEvents(0)));
                  }
                  return i;
                };
              j.length
            ...
            if (Q >= 0) {
              ...
              ((M = (M || new B()).preMultiplied(
                (re || new B()).multiplied(ne.inverted()),
              )),
                (ie = !0));
            }
            if ((c.lockChangeEvents(0), !l)) {
              ...
              if (
                (y &&
                  (oe.push("content"),
                  ae.push(
                    m || JSON.stringify(this.getContent(), N._serializeContent),
                  ),
                  (ie = !0),
                ...
                if (M && this.isFakeText()) {
                  var le = (
                    (this.getProperty("trf") || new B()).inverted() || new B()
                  ).multiplied(M);
                ...
                if (U) {
                  if (!R && this._attachedPath) {
                    ...
                    (D =
                      this._attachedPath instanceof F ||
                      this._attachedPath.getProperty("closed")
                        ? new F(
                            this._attachedPath.getProperty("closed"),
                            this._attachedPath.getProperty("evenodd"),
                            O,
                          )
                        : new I(
                            this._attachedPath.getProperty("evenodd"),
                            O,
                          )) && D.assignFrom(this._attachedPath);
                  }
                  if (
                    (w ||
                      ((w = !0),
                    ...
                    (D.setProperty(
                      "trf",
                      he ? he.multiplied(M.inverted()) : M.inverted(),
                    ),
                      (G = r.serialize(D)));
                ...
                if (
                  (ie && se
                    ...
                    : R &&
                      !D &&
                      ((ie = !0),
                      (M = this._oldTrf ? this._oldTrf : null),
                      (this._oldTrf = null),
                      (n = !0)),
                  ie)
                ) {
          ...
          (N.prototype._checkPartialCollision = function (e, t, i, n, r, o) {
            return E.prototype._checkPartialCollision.call(
              this,
              e,
              t,
              i,
          ...
          (N.prototype._shorten = function (e) {
            if (
              "string" == typeof (e = this._fixText(e)) ||
              e instanceof String
            )
          ...
          (N.prototype.isFakeText = function () {
            return (
              (this._fontsToResolve || this._hasEmbeddedFonts) &&
              this._isVirgin &&
              ((this._serializedBackupPaths &&
                !!this._serializedBackupPaths.length) ||
                (this._deserializedBackupPaths &&
                  !!this._deserializedBackupPaths.length))
            );
          }),
            ...
            if (e) {
              ...
              if (this._deferredRangeSetters) {
                for (var n = this._deferredRangeSetters.length - 1; n >= 0; --n)
                  this._deferredRangeSetters[n].func.call(
                    this,
                    this._deferredRangeSetters[n].vars,
                    e,
                  ) && (this._deferredRangeSetters.splice(n, 1), (i = !0));
                0 == this._deferredRangeSetters.length &&
                  (this._deferredRangeSetters = null);
              }
              if (this._fontsToResolve)
                for (var r = this._fontsToResolve.length - 1; r >= 0; --r) {
                  ...
                  if (e instanceof v || o in e) {
                    ...
                    (h &&
                      (this._fontsToResolve.splice(r, 1),
                      h.isResolved() || this._requireResolvedFont(h)),
                      0 === this._fontsToResolve.length &&
                        ((this._fontsToResolve = null),
              ...
              if (
                ...
                (A.forEach(
                      ...
                      if (
                        ...
                        if (o)
                          ((t.fontFamily = o.getFamily()),
                            (t.fontStyle = this._getGTLValue(
                              "_tfs",
                              o.getStyle(),
                            )),
                            (t.fontWeight = o.getWeight()),
                            o.isResolved() ||
                              (this._requireResolvedFont(o), (c = !1)));
                        else {
                  ...
                  e instanceof v
                    ? ((this.$_tff = e.getFamily()),
                      (this.$_tfs = e.getWeight()),
                      (this.$_tfs = e.getStyle()))
                    : e[this.$_tff] && (this.$_tff = e[this.$_tff]),
                  c
                    ? (this.setProperty(
                        "content",
                        JSON.stringify(A, N._serializeContent),
                      ),
                      this.repaint())
                    : this._workspace.getFontManager().getDefaultFont() &&
                      ((this.$content = JSON.stringify(A, N._serializeContent)),
                      (this._setTextWhenAvailable = !0)));
              }
            }
          }),
          (N.prototype._fixFontAttributes = function (e) {
            if (e.ct && (e._tff || e._tfs || e._tfw)) {
              ...
              var t = !1;
              ("function" == typeof gdb_loaddesign && (t = !0),
                (e._tfs = e._tfs || null),
                (e._tfw = e._tfw || null));
              for (var i = 0; i < e.ct.length; i++) {
                ...
                if (
                  (e._tff &&
                    this._getGravitValue("fontFamily", n.fontFamily) !==
                      e._tff &&
                    (t && console.warn("invalid tff"), delete e._tff),
                  e._tfw &&
                    this._getGravitValue("fontWeight", n.fontWeight) !==
                      e._tfw &&
                    (t && console.warn("invalid tfw"), delete e._tfw),
                  e._tfs &&
                    this._getGravitValue("fontStyle", n.fontStyle) !== e._tfs &&
                    (t && console.warn("invalid tfs"), delete e._tfs),
                  !(e._tff || e._tfs || e._tfw))
                )
                  break;
              }
              (null === e._tff && delete e._tff,
                null === e._tfs && delete e._tfs,
                null === e._tfw && delete e._tfw);
            } else (delete e._tff, delete e._tfs, delete e._tfw);
          }),
          (N.prototype._handleChange = function (e, t) {
            if (e === r._Change.Store) {
              ...
              (n && !this._tempText
                ? this._isEdited && t.options && !1 === t.options.save
                  ...
                  : this.isFakeText()
                    ? (t.blob.ct = JSON.parse(
                        this.getProperty("content"),
                        N._deserializeContent,
                      ))
                    : (t.blob.ct = n.getRichContent())
                : (t.blob.ct = this._tempText),
                (i = t.blob.ct),
                !this.isFakeText() &&
                  (i instanceof String || "string" == typeof i) &&
                  (i = [
                ...
                this.hasPathAttached() || (t.blob["#"] = a.uuid()),
                this.storeProperties(
                  ...
                  function (e, t) {
                    return "ttrf" === e && t
                      ? B.serialize(t)
                      : "content" === e && i
                        ? JSON.stringify(i, N._serializeContent)
                        : t;
                  },
                ),
                this._fixFontAttributes(t.blob),
                this.storeProperties(
                  t.blob,
                  N.MetaProperties,
                  function (e, t) {
                    if ("_bkpPath" === e) {
                      if (N.dontStorePaths) return null;
                      var i = null;
                      try {
                        if (this.isFakeText())
                          this._deserializedBackupPaths &&
                            (i = this._deserializedBackupPaths.map(
                              function (e) {
                                return r.store(e);
                              },
                            ));
              ...
              if (t.blob.blx && t.blob.trx) {
                var o = t.blob,
                  s = [],
                  l = [];
                (["aw", "ah"].forEach(function (e) {
                  o.hasOwnProperty(e) && (s.push(e), l.push(o[e]));
                }),
                  s.push("w"),
                  l.push(Math.abs(o.trx - o.tlx)),
                  s.push("h"),
                  l.push(Math.abs(o.try - o.bry)));
                var h,
                  A = o.tlx,
                  c = o.tly,
                  u = new B();
                (t.blob.hasOwnProperty("ttrf")
                  ? (h = B.deserialize(t.blob.ttrf).makeInvertible())
                  : t.blob.hasOwnProperty("trf") && (h = t.blob.trf),
                  (u = u.translated(A, c)),
                  h || (h = new B()),
                  (t.blob.trf = B.serialize(h.preMultiplied(u))));
                ...
                (d(o, g, null, !0),
                  g.length &&
                    (s.push("content"),
                    l.push(JSON.stringify(g, N._serializeContent))),
                  this.setProperties(s, l));
              } else {
                if (
                  (!t.blob.hasOwnProperty("_fpt") ||
                    (t.blob._fpt && "C#[0,0,0]" !== t.blob._fpt) ||
                    (t.blob.hasOwnProperty("_fvs") && !t.blob._fvs) ||
                    delete t.blob._fpt,
                  this._fixFontAttributes(t.blob),
                  t.blob.content)
                ) {
                  var f = JSON.parse(t.blob.content, N._deserializeContent);
                  (this._fixFontFamily(f),
                    (t.blob.content = JSON.stringify(f, N._serializeContent)));
                }
              ...
              e === r._Change.WorkspaceDetach
            )
              (e === r._Change.WorkspaceAttached &&
                this._workspace &&
                (this._waitForWorkspace ||
                  (this.hasPathAttached() && this._attachedPath.getScene())) &&
              ...
              var m = this.getScene();
              (this._addedDestroyable ||
                (m.addDestroyable(this._tlCore), (this._addedDestroyable = !0)),
                this.getParent()._notifyChange(E._Change.ChildVisualUpdate, [
                  this,
                ]),
                !m._pre310 ||
              ...
              if (
                ((I >= 0 || F >= 0) &&
                  this.getParent() &&
                  this.getParent().hasMixin(E.Layout) &&
                  !this.isRestoring() &&
                  this.isRecordedTransaction(),
                y >= 0 && C < 0)
              )
              ...
              if (x >= 0 && !(P >= 0)) {
                var R = this.$trf ? this.$trf.getMatrix() : null,
                  k = t.values[x] ? t.values[x].getMatrix() : null;
                R && k && R !== k
                  ? (R[0] !== k[0] ||
                      R[1] !== k[1] ||
                      R[2] !== k[2] ||
              ...
              S
                ? (t.properties.splice(y, 1),
                  ...
                  T &&
                    (y < _ && _--,
                    t.properties.splice(_, 1),
                    t.values.splice(_, 1)))
                : T && (t.properties.splice(_, 1), t.values.splice(_, 1));
            } else if (e == r._Change.AfterPropertiesChange) {
              var G = t.properties.indexOf("atPath");
              if (G >= 0) {
                var Q = t.values[G],
                  M = this.getProperty("atPath");
                if (null !== Q || null !== M) {
                  var U = this._atPath ? this._atPath : null,
                    V = null;
                  (M && !U
                    ? this._scene &&
                      this._scene.hasLinks(this) &&
                      this._scene.visitLinks(this, function (e) {
                        U = e;
                      })
                    : U && !M && (U = null),
                    M && (V = r.deserialize(M)),
                    this._attachPath(U, V));
                }
              } else if (
                t.properties.indexOf("tptho") >= 0 ||
                t.properties.indexOf("tpthd") >= 0 ||
                t.properties.indexOf("tpths") >= 0 ||
                t.properties.indexOf("tpthl") >= 0
              )
                if (this._attachedPath && this.$atPath) {
                  V = r.deserialize(this.$atPath);
                  this._attachPath(this._attachedPath, V);
                } else this._attachPath(null, null);
              else
                t.properties.indexOf("content") >= 0 &&
                  (this._checkHasEmbeddedAndResetFakeText(),
                  (this.$aw && this.$ah) || this._resetFxCacheAndState());
            }
            (this._handleGeometryChangeForProperties(
              ...
              this._handleGeometryChangeForProperties(
                e,
                t,
                a.extend({}, p.AllGeometryProperties),
              ),
              b.prototype._handleChange.call(this, e, t));
          }),
          (N.prototype._fixFontFamilyName = function (e) {
            e.fontFamily &&
              (e.fontFamily = v.getFontFamilyCorrected(e.fontFamily));
          }),
          (N.prototype._fixFontFamily = function (e) {
            if (e instanceof Array)
              for (var t = 0; t < e.length; ++t) this._fixFontFamilyName(e[t]);
            else e && this._fixFontFamilyName(e);
          }),
          (N.prototype._paint = function (e) {
            this.isFakeText()
              ? a.each(this._deserializedBackupPaths, function (t, i) {
          ...
          (N.prototype.setTransform = function (e) {
            (b.prototype.setTransform.call(this, e),
              this.isFakeText() &&
                a.each(this._deserializedBackupPaths, function (t, i) {
                  i.setTransform(e);
                }));
            ...
            try {
              if (e && !e.isIdentity()) {
                ...
                if (!n) {
                  var r = e,
                    o = this.$trf,
                    s = r.noSkewDecomposed();
                  if (s) {
                    var l = o ? o.multiplied(s.rotation) : s.rotation,
                      h = this.getSourceBBox(),
                      A = l.mapPoint(h.getSide(C.Side.CENTER)),
                      c = l.mapQuadrilateral(h),
                      p = c[0],
                      u = c[3],
                      d = c[2],
                      g = p.subtract(u),
                      f = d.subtract(u),
                      m = g.getX() * f.getY() - g.getY() * f.getX();
                    if (
                      R.isEqualEps(m, 0) ||
                      (R.isEqualEps(f.getX(), 0) &&
                        R.isEqualEps(f.getY(), 0)) ||
                      ...
                      var y,
                        ...
                        v,
                        b,
                        w = s.scalation.getMatrix(),
                        x = w[0],
                        P = w[3];
                      if (
                        (R.isEqualEps(f.getY(), 0)
                          ? ((_ = 0), (y = 1 / f.getX()))
                          : (y = (-(_ = f.getY() / m) * g.getY()) / f.getY()),
                        R.isEqualEps(f.getX(), 0)
                          ? ((b = 0), (v = 1 / f.getY()))
                        ...
                        var S = y / (y + _),
                          ...
                          I = v / (v + b),
                          F = b / (v + b),
                          D = h.getSide(C.Side.CENTER);
                        r = new B(1, 0, 0, 1, -D.getX(), -D.getY())
                          .multiplied(new B(S * x + T, 0, 0, T * x + S, 0, 0))
                          .multiplied(new B(I * P + F, 0, 0, F * P + I, 0, 0))
                          .multiplied(new B(1, 0, 0, 1, D.getX(), D.getY()));
                        var k = o ? o.inverted() : null;
                        (k && (r = r.multiplied(o)),
                          (A = s.scalation.mapPoint(A)),
                          (r = r
                            .multiplied(s.rotation)
                            .multiplied(s.scalation)
                            .multiplied(new B(1, 0, 0, 1, -A.getX(), -A.getY()))
                            .multiplied(s.scalation.inverted())
                            .multiplied(new B(1, 0, 0, 1, A.getX(), A.getY()))
                            .multiplied(s.rotationBack)
                            .multiplied(s.translation)),
                          k && (r = r.multiplied(k)));
                      }
                    }
                  } else n = !0;
                ...
                if (n)
                  ...
                  if (this.getProperty("hacr")) {
                    ...
                    ((Q = Q ? Q.multiplied(G) : G),
                      this.setProperty("hstrf", Q));
                  }
                  if (this.getProperty("vacr")) {
                    var M = this.getProperty("vstrf");
                    ((M = M ? M.multiplied(G) : G),
                      this.setProperty("vstrf", M));
                  }
          ...
          (N.prototype._paintTextFill = function (e, i) {
            ...
            if (n) {
              ...
              p.prototype.hasStyleFill.call(this) &&
                (r = this.createShapePaint(e, i.$_pt, a));
              var s = this._createStyleCanvas(
                  e,
                  this.getPaintBBox(!1, null, o),
                ),
                h = e.pushCanvas(s),
                A = s.getScale() * (this.$trf ? this.$trf.getScaleFactor() : 1);
              try {
                var c = n.getCanvas(y.RENDERFLAG_FILL),
                  u =
                    !!c &&
                    (!(c instanceof k.RendererCanvas) ||
                      (c instanceof k.RendererCanvas && c.isRendered()));
                if (
                  1 * A !== this._lastResolutionFill ||
                  this._runsDirty ||
                  !u ||
                  (this._lastFillPaintLayer !== i &&
                    ((i && i.hasStyle()) ||
                      (this._lastFillPaintLayer &&
                        this._lastFillPaintLayer.hasStyle())))
                ) {
                  if (r && r.transform) {
                    if (
                      i.$_pt &&
                      ...
                      var d = a ? B.getNativeRectTransformation(a) : new B(),
                        g = i.$_pt.getTransform(),
                        f = g.getTranslation(),
                        _ = A,
                        v = a ? a.getWidth() : 1,
                        b = a ? a.getHeight() : 1,
                        C = g
                          .multiplied(
                            new B(_, 0, 0, _, -_ * f.getX(), -_ * f.getY()),
                          )
                          .multiplied(d)
                          .multiplied(
                            new B(
                  ...
                  (n.render(
                    ...
                    y.RENDERFLAG_FILL |
                      y.RENDERFLAG_VERTEX |
                      y.RENDERFLAG_SCALEBITMAP,
                  ),
                    (c = n.getCanvas(y.RENDERFLAG_FILL)),
                    (this._lastResolutionFill = 1 * A),
                    (this._lastFillPaintLayer = i));
                }
                var E,
                  x = s.getTransform(!0),
                  ...
                  S = new B(P, 0, 0, P, 0, 0);
                ((E = (E = this.$trf
                  ? x.preMultiplied(this.$trf)
                  : new (Function.prototype.bind.apply(
                      B,
                      [null].concat(x.getMatrix()),
                    ))()).preMultiplied(S)),
                  s.setTransform(E));
                var T = s.getTranslateCorrection(
                  new l(0, 0),
                ...
                if (c && c.width * c.height > 0)
                  try {
                    (s.drawImage(
                      ...
                      s.setTransform(x),
                      c instanceof k.RendererCanvas ||
                        (M.hardware === M.Hardware.Desktop &&
                          ((void 0 !== t &&
                            t.release &&
                            "node" === t.release.name) ||
                            h.getBitmap().getPixelValue(0, 0))),
                      h.drawCanvas(s, 0, 0, 1, i.getBlendingForContext(e)));
                  } catch (e) {}
              } catch (e) {
                console.warn("ERROR during text rendering:" + e.message);
              } finally {
            ...
            if (n) {
              ...
              if (!r && this.hasStyleBorder()) {
                var o = e.isIncludingInvisible(),
                  ...
                  h = e.pushCanvas(s),
                  A =
                    s.getScale() * (this.$trf ? this.$trf.getScaleFactor() : 1);
                if (a && this.$_ba !== p.BorderAlignment.Inside) {
                  var c = i.$_bw;
                  if (
                    (i.$_ba === p.BorderAlignment.Center && (c *= 0.5),
                    this.$trf)
                  )
                    ((c /= this.$trf.getScaleFactor()),
                ...
                if (u && u.paint) {
                  ...
                  var d = i.$_bw,
                    g = null;
                  try {
                    var f = n.getCanvas(y.RENDERFLAG_STROKE),
                      _ =
                        !(f instanceof k.RendererCanvas) ||
                        (f instanceof k.RendererCanvas && f.isRendered());
                    if (
                      1 * A !== this._lastResolutionBorder ||
                      this._runsDirty ||
                      !_ ||
                      (this._lastBorderPaintLayer !== i &&
                        ((i && i.hasStyle()) ||
                          (this._lastBorderPaintLayer &&
                            this._lastBorderPaintLayer.hasStyle())))
                    ) {
                      if (
                        (i.$_ba !== p.BorderAlignment.Center && (d *= 2),
                        u.transform && u.transform.isValid())
                      ) {
                        if (
                          i.$_pt &&
                          i.$_pt instanceof m &&
                          ...
                          var v = a
                              ? B.getNativeRectTransformation(a)
                              : new B(),
                            ...
                            S = b
                              .multiplied(
                                new B(w, 0, 0, w, -w * C.getX(), -w * C.getY()),
                              )
                              .multiplied(v)
                              .multiplied(
                                new B(
                        ...
                        i.$_px &&
                          !i.$_px.isIdentity() &&
                          (u.transform = u.transform.preMultiplied(i.$_px));
                        var T = this.getSourceBBox(o),
                          I = this.getStyleBorderPadding(i);
                        (I && (T = T.expanded(I, I, I, I)),
                          (d /= u.transform.getScaleFactor()),
                          (g = T));
                      }
                      var F = {
                        shapePaint: u.paint,
                      ...
                      (n.render(
                        ...
                        (f = n.getCanvas(y.RENDERFLAG_STROKE)),
                        (this._lastResolutionBorder = 1 * A),
                        (this._lastBorderPaintLayer = i));
                    }
                    var R,
                      D = s.getTransform(!0),
                      ...
                      Q = new B(G, 0, 0, G, 0, 0);
                    ((R = (R = this.$trf
                      ? D.preMultiplied(this.$trf)
                      : new (Function.prototype.bind.apply(
                          B,
                          [null].concat(D.getMatrix()),
                        ))()).preMultiplied(Q)),
                      s.setTransform(R));
                    var M = s.getTranslateCorrection(
                      new l(0, 0),
                      s.getTransform().getTranslation(),
                    );
                ...
                var U = e.canvas.resetTransform(),
                  V = new x(this, U);
                (e.canvas.putVertices(V),
          ...
          (N.prototype.createShapePaint = function (e, t, i) {
            if (t instanceof s) {
              ...
              var r = n.getOrigin(),
                o = n.getScale(),
                a = new B(),
                l = this.$trf ? this.$trf.getScaleFactor() : 1;
              if (
                ((a = (a = a.scaled(1 / o, 1 / o)).translated(
                  r.getX() * l,
                  r.getY() * l,
                )),
                this.$trf && this.$trf.invertible())
              ) {
                var A = this.$trf.inverted(),
                  c = A.getTranslation();
                a = (a = (a = (a = a.multiplied(A)).translated(
                  -c.getX(),
                  -c.getY(),
                )).translated(c.getX() * o * l, c.getY() * o * l)).translated(
                  -N.HMARGIN,
                  -N.VMARGIN,
                );
              }
          ...
          (N.prototype._requireResolvedFont = function (e) {
            if (this._fontsToResolve)
              for (var t = 0; t < this._fontsToResolve.length; ++t)
                if (v.equals(this._fontsToResolve[t], e)) return;
                  ...
                  for (var n = this._fontsToResolve.length - 1; n >= 0; --n)
                    if (
                      (v.equals(this._fontsToResolve[n], e.font) ||
                        (this._fontsToResolve[n] === N.DEFAULTFONT &&
                          v.equals(e.font, i))) &&
                      ...
                      for (
                        var r = this._deferredRangeSetters.length - 1;
                        r >= 0;
                        --r
                      )
                        this._deferredRangeSetters[r].func.call(
                          this,
                          this._deferredRangeSetters[r].vars,
                        ) && this._deferredRangeSetters.splice(r, 1);
                t &&
            ...
            if (
              ...
              if (e) {
                ...
                if (t) {
                  ...
                  if (
                    i &&
                    (!this._lastActualBounds ||
                      this._lastActualBounds.b !== i.b)
                  ) {
                    this._lastActualBounds = i;
                    var n,
                      r,
                      o =
                        this.getProperty("_tfi") ||
                        u.defaultFormatting.fontSize,
                      a = t.getHeight() / i.b;
                    a > 1
                      ? ((n = Math.max(6, Math.floor(o))),
                        (r = Math.min(72, Math.ceil(o * a) + 5)))
                      : ((n = Math.max(6, Math.floor(o * a) - 5)),
                        (r = Math.ceil(o)));
                    for (var s = o, l = 0, h = (r - n) / 0.1; l <= h; ) {
                      var A = Math.ceil(l + (h - l) / 2),
                        c = n + 0.1 * A,
                        p = e.cloneDocument();
