...
function (e, t, i) {
      ...
      ((c.codeFactory = function (e, t, i) {
        ...
        (c.InlineNode = function (e, t, i, n, r, o) {
          e && e.draw && e.measure
            ? ((this.inline = e),
              ...
              (this.length = n),
              (this.formatting = r),
              (this.measured = e.measure(r)),
              (this._spacing = o || 0))
            : console.warn(
                "There is a bug somewhere, inline should not be null",
              );
        }),
        ...
        (c.InlineNode.prototype._spacing = 0),
        (c.InlineNode.prototype.ordinal = null),
        (c.InlineNode.prototype.length = null),
        (c.InlineNode.prototype.formatting = null),
        (c.InlineNode.prototype.measured = null),
        (c.InlineNode.prototype.parent = function () {
          return this._parent;
        }),
        ...
        (c.InlineNode.prototype.bounds = function (e) {
          if (e && this.inline) {
            if (this.inline._bbox)
              return new r(
                this.left,
                this.baseline + this.inline._bbox.getY(),
                this.measured.width,
                this.inline._bbox.getHeight(),
              );
            if (
              !(
                Number.isNaN(this.measured.minX) ||
                Number.isNaN(this.measured.maxX) ||
                Number.isNaN(this.measured.minY) ||
                Number.isNaN(this.measured.maxY)
              )
            )
              return new r(
                this.left + this.measured.minX,
                this.baseline + this.measured.minY,
                this.measured.maxX - this.measured.minX,
                this.measured.maxY - this.measured.minY,
              );
          }
          return (
            this._bounds ||
            new r(
              ...
              this.measured.width + this._spacing,
        ...
        (c.ListStart.prototype.obj = null),
        (c.ListStart.prototype.data = null),
        (c.ListStart.prototype.allCodes = null),
        (c.ListStart.prototype.block = function (e, t, i, n, r, s, l) {
          var p,
            u,
            d,
            g,
            ...
            _ = 0,
            v = 10,
            b = isNaN(s.listDepth) ? 0 : s.listDepth,
            C = function (r) {
              var s =
                "number" != typeof r.fontSize || isNaN(r.fontSize)
                  ? 20
                  : r.fontSize;
              ((_ = ((25 * s) / 20) * (b + 1)),
                (v = (10 * s) / 20),
                (p = new o("item", y, void 0, void 0, b)));
              var A = f[f.length - 1] || y.uuid,
                C = m[A] || {
                  children: [],
                  uuid: A,
                };
              (C.children.push(p.uuid),
                (m[A] = C),
                (m[p.uuid] = {
                  uuid: p.uuid,
                  parent: A,
              ...
              for (var w = [], E = m[p.uuid]; C; )
                (w.unshift(C.children.indexOf(E.uuid)),
                  (E = C),
                  (C = m[C.parent || ""]));
              var B =
                this.allCodes(
          ...
          return (
            ...
            function (r) {
              if (
                  ...
                  ? u.frame(function (o) {
                      ...
                      if (h)
                        ...
                        var m = e + _ + v + d.measured.width,
                          ...
                          C = r.lineSpacing();
                        ((f = "number" == typeof C ? b.h * C : parseFloat(C)),
                          (c = b.l));
                      }
                      ...
                      t +=
                        "number" == typeof w
                          ? f * w
                          : Math.max(parseFloat(w), 0);
                      var E = c - v - d.measured.width;
                      (d.position(E, g),
                        (t += f),
                        p.children().push(d),
                        h && p.children().push(o),
                        p.finalize(null, null, _ + v + d.measured.width),
                        y.children().push(p),
                        (u = d = null));
                    }, r)
                  : n++,
                ...
                var o = r.code();
                if (o) {
                  if (o.$ == h.List.Close) return (y.finalize(), y);
                  if (o.$ == h.List.Item) {
                    var a = b;
                    if (a != (b = r.listDepth()))
                      if (b > a) f.push(p.uuid);
                      else for (; f.length > b; ) f.pop();
                    C(r.codeFormatting());
                  }
                }
              }
              ...
              if (o)
                switch (o.$) {
                  ...
                  case h.List.Item:
                    if (0 === t)
                      return (
                        e.spliceWordsWithRuns(r, 1, [
                          l.derive(n.codeFormatting(), {
                            text: {
                              $: h.List.Open,
                            },
                          }),
