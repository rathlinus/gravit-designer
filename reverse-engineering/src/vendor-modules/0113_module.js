...
function (e, t, i) {
      ...
      (n.inherit("compoundpath", g, o),
        ...
        (g.Paths.prototype.serialize = function () {
          var e;
          e = this._multiReferenceId ? ["&", this._multiReferenceId] : [];
          ...
          if (i) {
            switch (e) {
              ...
              case n._Change.AfterChildInsert:
                if (
                  (i.rewindVertices(0),
                  i._notifyChange(l._Change.FinishGeometryUpdate),
                  e == n._Change.AfterChildInsert)
                )
                  t.setFlag(i._flags);
                break;
            ...
            l.Accelerated.prototype._handleChildrenStructureChange.call(
              this,
              e,
              t,
            );
        ...
        (g.prototype.readVertex = function (e) {
          return (
            ...
            (!!this._currentPath.readVertex(e) ||
              ...
              this._currentPath && this._currentPath.readVertex(e)))
          );
        }),
        ...
        (g.prototype.getSubnodeIds = function (e) {
          (o.prototype.getSubnodeIds.call(this, e),
            this._paths &&
              (e[this._paths.getMultireferenceId()] &&
                this._paths.resetMultireference(),
              (e[this._paths.getMultireferenceId()] = this._paths),
              this._paths.getSubnodeIds(e)));
        }),
        (g.prototype._getVertexHitCandidates = function (e, t, i) {
          var n = t ? t.inverted().mapPoint(e) : e,
            r = new d(n.getX() - i / 2, n.getY() - i / 2, i, i);
          return (
            this._paths.retrieveChildrenInPaintBBox(
              r,
              u.RETRIEVE_MODE_INTERSECT,
            ) || []
          );
        }),
        ...
        (g.prototype._referenceEvent = function (e) {
          if (e.target === this) {
            var t = e.linked;
            e.reference instanceof c.AnchorPoint &&
              "connector" === n.getName(e.reference.getPath()) &&
              (e.reference.getPath().attachPath(e.reference, t ? this : null),
              o.prototype._referenceEvent.call(this, e));
          }
        }),
        (g.prototype._handleReferencesOnSceneAttach = function () {
          (o.prototype._handleReferencesOnSceneAttach.call(
            this,
        ...
        (g.prototype._handleVisualChangeForProperties = function (e, t, i) {
          (e == n._Change.AfterPropertiesChange &&
            ...
            o.prototype._handleVisualChangeForProperties.call(this, e, t, i));
        }),
        (g.prototype._handleChange = function (e, t) {
          if (
            ...
            if (
              ...
              (t.blob.paths = this._paths.serialize()),
              this._scene)
            ) {
              var i = [];
              (this._scene.visitReferences(this, function (e) {
                e instanceof c.AnchorPoint &&
                  "connector" === n.getName(e.getPath()) &&
                  i.push(e.serialize());
              }),
                (t.blob.refanchors = i));
            }
            ...
            (this.restoreProperties(t.blob, g.MetaProperties),
              ...
              t.blob.hasOwnProperty("paths") &&
                this._paths.deserialize(t.blob.paths),
              (this._referencedNodes = []),
            ...
            e === n._Change.WorkspaceDetach
          ) {
            if (this._paths) {
              this._paths._setWorkspace(
                e === n._Change.WorkspaceDetach ? null : this._workspace,
              );
              for (
                var r = this._paths.getFirstChild();
                null != r;
                r = r.getNext()
              )
                r._setWorkspace(
            ...
            e === h._Change.SceneDetached
          ) {
            if (this._paths) {
              this._paths._setScene(
                e === h._Change.SceneDetached ? null : this._scene,
              );
          ...
          if (
            ...
            e !== l._Change.FinishGeometryUpdate ||
        ...
        (g.prototype.assignFrom = function (e) {
          (e instanceof g && this.transferProperties(e, [g.VisualProperties]),
            o.prototype.assignFrom.call(this, e));
        }),
        (g.prototype.transform = function (e, t, i) {
          this.beginUpdate();
          try {
            if (
              (o.prototype.transform.call(this, e, t, i), e && !e.isIdentity())
            )
              for (
                var r = this._paths.getFirstChild();
                null != r;
        ...
        (g.prototype._checkPartialCollision = function (e, t, i, n, r, a) {
          var s = r & l.CollisionFlag.CollisionInfo,
            h = r & l.CollisionFlag.FullyContained;
          if (s && h)
            return o.prototype._checkPartialCollision.call(
              this,
              e,
              t,
              i,
          ...
          if (e.intersectsRect(t, n)) {
            var A = 0 != (r & l.CollisionFlag.PaintBBox),
              c = h
                ? u.RETRIEVE_MODE_FULLYCONTAINED
                : u.RETRIEVE_MODE_INTERSECT,
              p = A
                ? this._paths.retrieveChildrenInPaintBBox(e, c)
                : this._paths.retrieveChildrenInGeometryBBox(e, c);
            if (p) {
              var d = 0;
              if (s);
                ...
                for (m = 0; m < p.length && !f; m++) {
                  ...
                  p[m]._checkPartialCollision(
                    e,
                    y,
                    i,
                    n,
                    r | l.CollisionFlag.CollisionInfo,
                    function (e) {
                      (g.push(e), (f = f || e.intersects));
                    },
                  );
                }
                if (f) return void a(this);
                for (m = 0; m < g.length; m++)
                  if (!g[m].containsArea) return void a(this);
              } else {
        ...
        (g.prototype.findPivots = function (e, t) {
          if (t) {
            var i = this._paths.retrieveChildrenInGeometryBBox(
              t,
              u.RETRIEVE_MODE_INTERSECT,
            );
            return i && i.length
          ...
          for (
            var n = null, r = this._paths.getFirstChild();
            null != r;
            r = r.getNext()
          ) {
        ...
        (g.prototype._calculateGeometryBBox = function (e) {
          for (
            var t = null, i = this._paths.getFirstChild();
            null != i;
            i = i.getNext()
          ) {
            var n = i.getGeometryBBox(e);
            n &&
              (n.getWidth() > 0 || n.getHeight() > 0) &&
              (t = t ? t.united(n) : n);
          }
          return t || null;
        }),
