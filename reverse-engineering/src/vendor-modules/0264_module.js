...
function (e, t, n) {
      ...
      ((d.PolyLineExtended = function () {
        ...
        (d.PolyLineExtended.prototype.x = 0),
        (d.PolyLineExtended.prototype.cy1 = void 0),
        (d.PolyLineExtended.prototype.cx1 = void 0),
        (d.PolyLineExtended.prototype.cy2 = void 0),
        (d.PolyLineExtended.prototype.cx2 = void 0),
        ...
        (d.PolyLineExtended.generateCorresponding = function (e) {
          for (var t = 0; t < e.length; t++) {
            var i = e[t];
            if (
              ((i.polySeg0.corresponding = i.polySeg1),
              (i.polySeg1.corresponding = i.polySeg0),
              null == i.polySeg1.corresponding)
            )
              return null;
            if (null == i.polySeg0.corresponding) return null;
          }
        }),
        ...
        (d.PolyLineExtended.fromPolyLine = function (e, t, i) {
          for (var n, r, o, a = null, s = null, h = e.point; e.point; ) {
            if (
              !e.next.point &&
              l.isEqualEps(e.point.getX(), h.getX()) &&
              l.isEqualEps(e.point.getY(), h.getY())
            ) {
              null !== a && a === e && (s.nextCurve = n);
              break;
            }
            if (
              ((r = new d.PolyLineExtended()),
              n ? ((r.prev = o), (o.next = r)) : (n = r),
              (r.x = u(e.point.getX())),
              (r.y = u(e.point.getY())),
              null !== a && a === e && (s.nextCurve = r),
              e.nextCurve &&
                ((a = e.nextCurve),
                (s = r),
                (r.cx1 = e.cp1.getX()),
                (r.cy1 = e.cp1.getY()),
                e.cp2 && ((r.cx2 = e.cp2.getX()), (r.cy2 = e.cp2.getY()))),
              (r.isLast = e.isLast),
              (r.isIsect = e.isIsect),
              r.isIsect)
            ) {
          ...
          return n
            ? ((r.next = n),
              (n.prev = r),
              null === a || a.point || (s.nextCurve = n),
              n)
            : null;
        }),
        (d.PolyLineExtended.prototype.colinear = function (e, t, i, n, r, o) {
          var a = n || this.prev.currCurve || this.prev,
            s = r || this.nextCurve || this.next,
            A = o || this;
          ...
          function d(t, i, n, r) {
            if (4 === n.length) {
              var o = l.getCubicCurveAtT(n[0], n[3], n[1], n[2], 0.25),
                a = l.getCubicCurveAtT(r[0], r[3], r[1], r[2], 0.25),
                s = l.getCubicCurveAtT(n[0], n[3], n[1], n[2], 0.75),
                A = l.getCubicCurveAtT(r[0], r[3], r[1], r[2], 0.75);
              if (void 0 !== t.cx2) {
                if (
                  h._hitTestCurve2(
                    t.x,
              ...
              ((o = l.getCurveAtT(n[0], n[2], n[1], 0.5)),
                (a = l.getCurveAtT(r[0], r[2], r[1], 0.5)));
              if (void 0 !== t.cx2) {
                if (
                  h._hitTestCurve2(
                    t.x,
        ...
        (d.PolyLineExtended.prototype._connect = function (e, t) {
          (e.currCurve && (e.currCurve.prevCurve = this),
            t
              ? (e.currCurve && (e.currCurve.prevCurve = this.currCurve),
                (e.prev = t),
                (t.next = e),
                (this.currCurve.nextCurve = e))
              : (e.currCurve && (e.currCurve.prevCurve = this),
                (this.next = e),
                (e.prev = this)));
        }),
          ...
          if (i.isLast) {
            ...
            do {
              if (!i.isIsect && e.isInside(i, t)) {
                for (
                  var u = i.prev.currCurve || i.prev, g = null;
                  !u.isLast && u !== i;
                ) {
            ...
            if (!(h <= 1) && p !== h) {
              if (r) {
                do {
                  if (!i.isIsect && !e.isInside(i, t)) {
                    for (
                      u = i.prev.currCurve || i.prev, g = null;
                      !u.isLast && u !== i;
                    ) {
                      if (!u.isIsect && e.isInside(u, t)) {
                        g = u;
              ...
              for (var f = 0; f < s.length; f++) {
                ...
                ((l = m[0]), (i = m[1]));
                g = m[2];
                var y = i.nextCurve || i.next,
                  _ = g.nextCurve || g.next,
        ...
        (d.PolyLineExtended.prototype._stitch = function () {
          ...
          var a,
            s,
            l = t.length;
          if ((1 === l && 0 === i.length) || 0 === l) return r;
          for (var h = 0; h < l; h++) {
            a = t[h];
            for (var A = h; A < l; A++) {
              if (
                ((s = t[(h + A + 1) % l]),
                a[0].x === s[0].x && a[0].y === s[0].y)
              ) {
                (a[0]._reverseLoop(), n.push([a[1], a[0]]));
                break;
              }
              ...
              if (
                (a[1].x === s[1].x && a[1].y === s[1].y) ||
                (a[1].x === s[0].x && a[1].y === s[0].y)
              ) {
                n.push(a);
                break;
              }
          ...
          var c = [];
          for (h = 0; h < l; h++) c.push(n[h][1]._lastCurvePt());
          for (h = 0; h < l; h++) {
            var p = n[h][1],
              u = n[(h + 1) % l][0];
            (p.x === u.x && p.y === u.y && (p.isLast = !1),
              p._connect(u, c[h]));
          }
          ...
          if (this.next != this) {
            ...
            do {
              if (
                ...
                (l = u.cy2),
                void 0 !== t && void 0 !== i
                  ? ((u.cx1 = i), (u.cx2 = t), (u.cy1 = r), (u.cy2 = n))
                  : ((u.cx1 = t),
                    (u.cx2 = void 0),
                    (u.cy1 = n),
                    (u.cy2 = void 0)),
        ...
        (d.PolyLineExtended.prototype._equalsEps = function (e, t, i) {
          ...
          if ((t || ((n = e), (e = this)), n.currCurve)) {
            if (
              l.isEqualEps(n.x, n.next.x, i) &&
              l.isEqualEps(n.y, n.next.y, i)
            ) {
              var r = e.prev;
              if (
                (((r.currCurve && r.currCurve.isLast) || r.isLast) &&
                  (r = e._lastInLoop()).nextCurve &&
                  (r = r.nextCurve.prev),
                !r.currCurve)
              )
                return !0;
        ...
        (d.PolyLineExtended.disableBadIntersections = function (e, t, i, n, r) {
          ...
          for (var h = n; h <= r; h++) {
            ...
            for (o = 0; o < A.length; o++) {
              var c,
                ...
                _ = null,
                v = [k],
                b = d.PolyLineExtended._getPrevDifferentPoint(k),
                C = d.PolyLineExtended._getNextDifferentPoint(k, v),
                w = v[0];
              (b &&
                (b.currCurve
                  ? void 0 === b.currCurve.cx2
                    ? ((c = 0.5),
                      (f = new Float64Array(3)),
                      (m = new Float64Array(3)),
                      l.getCtrlPtsQuadratic(b.currCurve.x, k.x, b.cx1, 0, c, f),
                      (p.x = u(f[2])),
                      l.getCtrlPtsQuadratic(b.currCurve.y, k.y, b.cy1, 0, c, m),
                      (p.y = u(m[2])))
                    : ((c = 0.5),
                      (f = new Float64Array(4)),
                      (m = new Float64Array(4)),
                      l.getCtrlPts(b.currCurve.x, k.x, b.cx1, b.cx2, 0, c, f),
                      (p.x = u(f[3])),
                      l.getCtrlPts(b.currCurve.y, k.y, b.cy1, b.cy2, 0, c, m),
                      (p.y = u(m[3])))
                  : ((c = 0.5),
                    (p.x = u(k.x + c * (b.x - k.x))),
                    (p.y = u(k.y + c * (b.y - k.y))))),
                C &&
                  (w.currCurve
                    ? ((c = 0.5),
                      void 0 === w.currCurve.cx2
                        ? ((y = new Float64Array(3)),
                          (_ = new Float64Array(3)),
                          l.getCtrlPtsQuadratic(
                            w.currCurve.x,
                            C.x,
                            w.currCurve.cx1,
                            0,
              ...
              for (var E, B = a[(h + 1) % 2], x = [], P = 0; P < B.length; P++)
                (o === P ||
                  (l.isEqualEps(B[P].x, k.x, 1e-10) &&
                    l.isEqualEps(B[P].y, k.y, 1e-10))) &&
                  x.push(B[P]);
              t >= 0 && ((E = t), (t = -10));
              for (P = 0; P < x.length; P++) {
                var S = x[P],
                  T = d.PolyLineExtended._getPrevDifferentPoint(S),
                  I = d.PolyLineExtended._getNextDifferentPoint(S, v),
                  F = v[0];
                (k.prevInside >= 0 &&
                  (T && b
                    ? S.colinear(p, f, m, T, I, F)
                      ...
                      : 0 === k.prevInside &&
                        (k.prevInside =
                          S.isInsideBezier(p, d.PIP_CHECK_ODDEVEN, !0) > 0
                            ? 1
                            : 0)
                    : (k.prevInside = t)),
                  k.nextInside >= 0 &&
                    (I && C
                      ? S.colinear(g, y, _, T, I, F)
                        ...
                        : 0 === k.nextInside &&
                          (k.nextInside =
                            S.isInsideBezier(g, d.PIP_CHECK_ODDEVEN, !0) > 0
                              ? 1
                              : 0)
                      : (k.nextInside = t)));
              }
              -10 === t &&
                ((t = E),
                -10 === k.prevInside && (k.prevInside = E),
                -10 === k.nextInside && (k.nextInside = E));
            }
          }
          var R,
            D = [[], []];
          for (h = n; h <= r; h++) {
            var k,
              G = (k = a[h][0])._firstInLoop(),
              Q = [];
            k = G;
            do {
              (k.isIsect
                ? Q.push(k)
                : k.isLast && Q.length && (D[h].push(Q), (Q = [])),
                (k = k.next));
            } while (k !== G);
          ...
          for (h = n; h <= r; h++) {
              ...
              for (var N = 0; N < M.length; N++) {
                ...
                if (
                  (H.nextInside < 0 &&
                    ((o = 0),
                    ((H = U[0]).nextInside =
                      t === d.AUTO ? d.OUTSIDE : d.INSIDE),
                    (U[1 % V].prevInside = H.nextInside)),
                  H.nextInside >= 0)
                ) {
                  var O = H.nextInside;
                  if (t === d.AUTO)
                    for (P = 1; P < V; P++) {
                      ((H = U[(P + o) % V]).prevInside < 0
                        ? (H.prevInside = O)
                        : (O = H.prevInside),
                        H.nextInside < 0
                          ? (H.nextInside = O)
                    ...
                    for (P = 1; P < V; P++) {
                      if (
                        (((H = U[(P + o) % V]).prevInside >= 0 ||
                          H.nextInside >= 0) &&
                          (L = 0),
                        H.prevInside >= 0 && H.nextInside >= 0)
                      )
                        if (h > 0) {
                          var Y =
                            H.corresponding.prevInside >= 0 &&
                            H.corresponding.prevInside ===
                              H.corresponding.nextInside;
                          Y !== (H.prevInside === H.nextInside)
                            ? Y
                              ? ((H.prevInside = O), (H.nextInside = O))
                              : ((H.prevInside = O),
                                (O ^= 1),
                                (H.nextInside = O))
                            : (O = H.nextInside);
                        ...
                        H.corresponding.prevInside ===
                          H.corresponding.nextInside
                          ? ((H.prevInside = O), (H.nextInside = O))
                          : ((H.prevInside = O), (O ^= 1), (H.nextInside = O));
                      else if (H.prevInside < 0 && H.nextInside >= 0)
                        h > 0 &&
                        H.corresponding.prevInside ===
                          H.corresponding.nextInside
                          ? ((H.prevInside = O), (H.nextInside = O))
                          : ((H.prevInside = 1 ^ H.nextInside),
                            O !== H.prevInside && (H.prevInside = O),
                            (O = H.nextInside));
                      else if (H.prevInside < 0 && H.nextInside < 0)
                        if (h > 0)
                          H.corresponding.prevInside ===
                          H.corresponding.nextInside
                            ? (H.prevInside = H.nextInside = O)
                            : ((H.prevInside = O),
                              (O ^= 1),
                              (H.nextInside = O));
                        else {
                          ...
                          0 === L
                            ? ((H.prevInside = O), (O ^= 1), (H.nextInside = O))
                            : X !== H &&
                                (X.prevInside >= 0 || X.nextInside >= 0) &&
                                L > 0
                              ? ((H.prevInside = O),
                                X.prevInside >= 0
                                  ? ((H.nextInside = X.prevInside),
                                    (O = H.nextInside))
                                  : ((O ^= 1), (H.nextInside = O)))
                              : X !== H && X.nextInside >= 0 && X.prevInside < 0
                                ? ((H.prevInside = O),
                                  O === X.nextInside && (O ^= 1),
                                  (H.nextInside = O))
                                : (H.prevInside = H.nextInside = O),
                  ...
                  if (
                    ((H = U[o]).prevInside < 0 && (H.prevInside = O),
                    (O = H.prevInside),
                    t !== d.AUTO_MAX_PASSTHROUGH)
                  )
                    for (P = 1; P < V; P++) {
                      ((H = U[(o - P + V) % V]).nextInside != O &&
                        (H.nextInside = O),
                        (O = H.prevInside));
                    }
                }
            ...
            for (R = 0, V = 0, o = 0; o < M.length; o++)
              for (N = M[o], P = 0; P < N.length; P++) {
                var H;
                (V++,
                  (H = N[P]).prevInside === H.nextInside &&
                    ((H.isIsect = !1), (H.corresponding.isIsect = !1), R++));
              }
            if (R === V) return !1;
          }
          return !0;
        ...
        (d.PolyLineExtended.removeDuplicates = function (e, t) {
          for (
            var i = e, n = i.next, r = n.next, o = i.nextCurve ? i : null;
            n !== i;
          ) {
            if (
              !n.isLast &&
              l.isEqualEps(n.x, r.x, 1e-10) &&
              l.isEqualEps(n.y, r.y, 1e-10)
            ) {
              if (
                (o && o.nextCurve === n && (o.nextCurve = r),
                n.nextCurve &&
                  n.nextCurve !== r &&
                  !r.nextCurve &&
                  ((r.nextCurve = n.nextCurve),
                  (r.cx1 = n.cx1),
                  (r.cy1 = n.cy1),
                  (r.cx2 = n.cx2),
                  (r.cy2 = n.cy2),
                ...
                if (
                  ((r.isIsect = !0),
                  (r.corresponding = n.corresponding),
                  (r.isectPoly = n.isectPoly),
                  0 == t)
                ) {
                  if (n.isectPoly.polySeg0 !== n) return null;
                  r.isectPoly.polySeg0 = r;
                } else {
                  if (n.isectPoly.polySeg1 !== n) return null;
          ...
          if (l.isEqualEps(i.x, r.x, 1e-10) && l.isEqualEps(i.y, r.y, 1e-10)) {
            if (
              (o &&
                o.nextCurve === r &&
                ((o.nextCurve = null),
                (o.cx1 = o.cx2 = o.cy1 = o.cy2 = void 0)),
              r.nextCurve &&
                r.nextCurve !== i &&
                ((i.nextCurve = r.nextCurve),
                (i.cx1 = r.cx1),
                (i.cy1 = r.cy1),
                (i.cx2 = r.cx2),
                (i.cy2 = r.cy2)),
              ...
              if (
                ((i.isIsect = !0),
                (i.corresponding = r.corresponding),
                (i.isectPoly = r.isectPoly),
                0 == t)
              ) {
                if (r.isectPoly.polySeg0 !== r) return null;
                n.isectPoly.polySeg0 = i;
              } else {
                if (r.isectPoly.polySeg1 !== r) return null;
        ...
        (d.PolyLineExtended.prototype.getPoints = function (e) {
          ...
          if (e) {
            ...
            do {
              void 0 !== i.cx1 && void 0 !== i.cx2
                ? (t.addVertex(a.Command.Curve2, i.nextCurve.x, i.nextCurve.y),
                  t.addVertex(a.Command.Curve2, i.cx1, i.cy1),
                  t.addVertex(a.Command.Curve2, i.cx2, i.cy2),
                  (i = i.nextCurve))
                : void 0 !== i.cx1
                  ? (t.addVertex(a.Command.Curve, i.nextCurve.x, i.nextCurve.y),
                    t.addVertex(a.Command.Curve, i.cx1, i.cy1),
                    (i = i.nextCurve))
                  : void 0 !== i.cx2
                    ? (t.addVertex(
                        a.Command.Curve,
                      ...
                      t.addVertex(a.Command.Curve, i.cx2, i.cy2),
                      (i = i.nextCurve))
                    : i.isLast
                      ? ((i = i.next), t.addVertex(a.Command.Move, i.x, i.y))
                      : ((i = i.next), t.addVertex(a.Command.Line, i.x, i.y));
            } while (i && i !== n);
          } else
            do {
              void 0 !== i.cx1 && void 0 !== i.cx2
                ? (t.addVertex(a.Command.Curve2, i.next.x, i.next.y),
                  t.addVertex(a.Command.Curve2, i.cx1, i.cy1),
                  t.addVertex(a.Command.Curve2, i.cx2, i.cy2),
                  (i = i.next))
                : void 0 !== i.cx1
                  ? (t.addVertex(a.Command.Curve, i.next.x, i.next.y),
                    t.addVertex(a.Command.Curve, i.cx1, i.cy1),
                    (i = i.next))
                  : void 0 !== i.cx2
                    ? (t.addVertex(a.Command.Curve, i.next.x, i.next.y),
                    ...
                    : (i = i.next) &&
                      (i.prev.isLast
                        ? t.addVertex(a.Command.Move, i.x, i.y)
                        : t.addVertex(a.Command.Line, i.x, i.y));
            } while (i && i !== this);
        ...
        (d.PolyLineExtended.prototype.getSimplePolyLines = function () {
          ...
          do {
            a.nextCurve
              ? ((e = a.cx1), (i = a.cx2), (t = a.cy1), (n = a.cy2))
              : (e = i = t = n = void 0);
            var s = r.appendPoint(a.x, a.y, e, t, i, n);
            ((s.index = a.index),
              (s.corresponding = a.corresponding),
              (s.prevInside = a.prevInside),
              (s.nextInside = a.nextInside),
              a.isLast && (o.push(r), (r = new d.PolyLineExtended())),
              (a = a.nextCurve || a.next || this));
          } while (a !== this);
          return (r.next && !o.length && o.push(r), o);
        }),
        (d.PolyLineExtended.prototype.appendPoint = function (
          e,
          t,
          i,
          n,
          ...
          if (null == this.prev)
            return (
              (this.x = e),
              (this.y = t),
              void 0 !== i && ((this.cx1 = i), (this.cy1 = n)),
              void 0 !== r && ((this.cx2 = r), (this.cy2 = o)),
              (this.next = this),
              (this.prev = this),
              this
            );
          var a = this.prev,
            s = new d.PolyLineExtended();
          return (
            (s.x = e),
            (s.y = t),
            void 0 !== i && ((s.cx1 = i), (s.cy1 = n)),
            void 0 !== r && ((s.cx2 = r), (s.cy2 = o)),
            (this.prev = s),
            (s.next = this),
            (s.prev = a),
            (a.next = s),
        ...
        (d.PolyLineExtended.prototype.visit = function () {
          ((this.visited = !0),
            null === this.corresponding ||
              this.corresponding.visited ||
              this.corresponding.visit());
        }),
        (d.PolyLineExtended.prototype.isInside = function (e, t) {
          return t === d.PIP_CHECK_ODDEVEN
            ? this.getOddEven(e)
            : this.getWinding(e);
        }),
        (d.PolyLineExtended.prototype.isInsideBezier = function (e, t, i) {
          ...
          if (l) return this._isInsideBezier(e, t, i);
          if (i && t === d.PIP_CHECK_ODDEVEN) return this.getOddEven(e);
          do {
            (r.y <= s
              ? a.y > s && this.isLeft(r, a, e) > 0 && ++n
              : a.y <= s && this.isLeft(r, a, e) < 0 && --n,
              (r = r.next),
              (a = i && r.isLast ? r._firstInLoop() : r.next || o));
          } while (r !== o);
          ...
          do {
            ...
            if (
              ...
              ((s = n.x + (2 / 3) * (c - n.x)),
                ...
                (h = o.x + (2 / 3) * (c - o.x)),
                (A = o.y + (2 / 3) * (p - o.y)));
            } else ((h = n.cx2), (A = n.cy2));
            ((a += this._windingAngle(e, n.x, n.y, s, l, h, A, o.x, o.y)),
              (n = n.next),
              (o = i && n.isLast ? n._firstInLoop() : n.next || r));
          } while (n !== r);
          return t === d.PIP_CHECK_ODDEVEN
            ? Math.floor(Math.abs(a) / (2 * Math.PI - 1e-10)) % 2
            : Math.abs(a) > 2 * Math.PI - 1e-10
              ? 1
              : 0;
        }),
        (d.PolyLineExtended.prototype._windingAngle = function (
          e,
          t,
          i,
          n,
          ...
          if (c < 1e-10 * 1e-10) return 0;
          var p = l.ptSqrDist(e.x, e.y, h, A);
          if (p < 1e-10 * 1e-10) return 0;
          var u = l.ptDist(t, i, n, r),
            d = l.ptDist(n, r, a, s),
            g = l.ptDist(a, s, h, A);
          if (
            ((c = Math.sqrt(c)), (p = Math.sqrt(p)), u + d + g > Math.max(c, p))
          ) {
            var f = new Float64Array(4),
              ...
              _ = new Float64Array(4);
            return (
              l.getCtrlPtsCasteljau(t, n, a, h, 0.5, null, f, y),
              l.getCtrlPtsCasteljau(i, r, s, A, 0.5, null, m, _),
              this._windingAngle(
                e,
                f[0],
                m[0],
        ...
        (d.PolyLineExtended.prototype.hasPoint = function (e) {
          ...
          do {
            if (
              l.sqrSegmentDist(t.x, t.y, t.next.x, t.next.y, i, n) <
              1e-10 * 1e-10
            )
              return !0;
        ...
        (d.PolyLineExtended.prototype.getOddEven = function (e) {
          ...
          do {
            (((t.y < a && r.y >= a) || (r.y < a && t.y >= a)) &&
              (t.x <= o || r.x <= o) &&
              (i ^= t.x + ((a - t.y) / (r.y - t.y)) * (r.x - t.x) < o),
              (r = (t = t.next).isLast ? t._firstInLoop() : t.next || n));
          } while (t !== n);
          return i ? 1 : 0;
        }),
        ...
        (d.PolyLineExtended.prototype.getWinding = function (e) {
          ...
          do {
            (i.y <= o
              ? r.y > o && this.isLeft(i, r, e) > 0 && ++t
              : r.y <= o && this.isLeft(i, r, e) < 0 && --t,
              (r = (i = i.next).isLast ? i._firstInLoop() : i.next || n));
          } while (i !== n);
          return Math.abs(t);
        }),
              ...
              switch (t.command) {
                case a.Command.Move:
                  o
                    ? i > 0 &&
                      (((o = new a()).x = t.x),
                      (o.y = t.y),
                      r.addVertex(-1, t.x, t.y))
                    : (((o = new a()).x = t.x),
                      (o.y = t.y),
                      (r = new s()).addVertex(a.Command.Move, t.x, t.y));
                  break;
                case a.Command.Line:
                  (((l = new a()).x = t.x),
                    (l.y = t.y),
                    r.addVertex(a.Command.Line, t.x, t.y));
                  break;
                case a.Command.Curve:
                  (((l = new a()).x = t.x),
                    (l.y = t.y),
                    r.addVertex(a.Command.Curve, t.x, t.y),
                    h.readVertex(t),
                    r.addVertex(a.Command.Curve, t.x, t.y));
                  break;
                case a.Command.Curve2:
                  (((l = new a()).x = t.x),
                    (l.y = t.y),
                    r.addVertex(a.Command.Curve2, t.x, t.y),
                    h.readVertex(t),
                    r.addVertex(a.Command.Curve2, t.x, t.y),
                    h.readVertex(t),
                    r.addVertex(a.Command.Curve2, t.x, t.y));
                ...
                case a.Command.Close:
                  n < e.length - 1 &&
                    l.x !== o.x &&
                    l.y !== o.y &&
                    r.addVertex(a.Command.Line, o.x, o.y);
              }
          }
        }),
        (d.OR = 1),
        ...
        (d.AND = 3),
        (d.SUB = 4),
        (d.PIP_CHECK_ODDEVEN = 1),
        (d.PIP_CHECK_WINDING = 0),
        (d.AUTO_MAX_PASSTHROUGH = -2),
        (d.AUTO = -1),
        (d.OUTSIDE = 0),
        (d.INSIDE = 1),
        (d.prototype.common_segments_policy = null),
        ...
        (d.prototype.initializeSources = function (e, t) {
          ...
          var n = this._intersector.getFirstPoly(),
            r = this._intersector.getSecondPoly(),
            o = n.markIndices();
          (r.markIndices(o),
            i.sort(function (e, t) {
          ...
          for (var a = i.length - 1; a > 0; a--) {
            ...
            if (
              s === h ||
              (l.isEqualEps(s.getX(), h.getX(), 1e-10) &&
                l.isEqualEps(s.getY(), h.getY(), 1e-10))
            ) {
              var A = i[a].polySeg0.index,
                c = i[a].polySeg1.index,
                p = i[a - 1].polySeg0.index,
                u = i[a - 1].polySeg1.index;
              A === p && c === u && i.splice(a, 1);
            }
          }
          if (
            (this._intersector.addIntersectionsToPolygon(i),
            (this.sourceHead = d.PolyLineExtended.fromPolyLine(n, i, 0)),
            (this.clipHead = d.PolyLineExtended.fromPolyLine(r, i, 1)),
            !this.sourceHead || !this.clipHead)
          )
            return !1;
          if (
            ((this.sourceHead = d.PolyLineExtended.generatePrevCurveCurrCurve(
              this.sourceHead,
            )),
            (this.clipHead = d.PolyLineExtended.generatePrevCurveCurrCurve(
              this.clipHead,
            )),
            !this.sourceHead || !this.clipHead)
          )
          ...
          if (
            d.PolyLineExtended.disableBadIntersections(
              i,
              this.common_segments_policy,
              this.pip_check_policy,
              0,
              1,
            )
          ) {
          ...
          return (
            ...
            ((this._intersectsArray = this.getIntersectionArray(
              this.sourceHead,
              this.clipHead,
            )),
            (this._initialized = !0),
          ...
          if (e) {
            ...
            if (a.currCurve && a.currCurve !== a) n = !1;
              ...
              do {
                ...
                if (
                  e.currCurve &&
                  (!e.currCurve.nextCurve || !e.currCurve.prevCurve)
                ) {
                  (0, (n = !1));
                  break;
                }
        ...
        (d.prototype.getIntersectionArray = function (e, t) {
          ...
          do {
            if (o.isIsect) {
              r = o.corresponding;
              var a = o.currCurve ? o.currCurve.index : o.index,
                s = r.currCurve ? r.currCurve.index : r.index,
                l = i[a];
              l || (l = i[a] = []);
              var h = i[s];
              (h || (h = i[s] = []),
        ...
        (d.prototype.unvisit = function (e) {
          ...
          do {
            (t.isIsect &&
              t.visited &&
              ((t.visited = !1),
              t.corresponding && (t.corresponding.visited = !1)),
              (t = t.next));
          } while (t !== e);
          this._lastUnprocessed = null;
        }),
        ...
        (d.prototype.xor = function () {
          ...
          var i = new d(
              this.pip_check_policy,
              this.common_segments_policy,
              this._useIntersector,
              this._blockIntersector,
            ),
            n = e.length > 1 ? s.mergeVertexSources(e) : e[0],
            r = t.length > 1 ? s.mergeVertexSources(t, null) : t[0];
          return n
            ? r
              ? i.initializeSources(n, r)
                ? i.diff()
                : null
              : [n]
            : [];
        ...
        (d.prototype.determineInside = function (e, t, i, n, r) {
          ...
          do {
            if (!e.corresponding && !t.hasPoint(e))
              return (
                (i[0] = e),
                t.isInside(e, this.pip_check_policy) > 0 ? 1 : 0
              );
            e = e.nextCurve || e.next;
          } while (e !== o);
          if (r)
            do {
              if (e.corresponding) return ((i[0] = e), e.prevInside ? 1 : 0);
              e = e.nextCurve || e.next;
            } while (e !== o);
          return ((i[0] = o), -1);
        }),
        (d.prototype.clip = function (e, t) {
          ...
          var i = this.sourceHead,
            n = this.clipHead,
            r = !e && t,
            o = !e && !t,
            a = i.getSimplePolyLines(),
            l = n.getSimplePolyLines(),
            h = this._mergeNonIntersecting(a, l, o, r),
            A = [],
            c = [];
          ...
          ((this._lastUnprocessed = null),
            ...
            (this.didNotClip = !1));
          for (
            var g, f, m, y, _, v, b, C = [], w = [], E = !0;
            this.hasUnprocessed(i);
          ) {
            ...
            do {
              if (
                ...
                do {
                  if (
                    (B.nextCurve
                      ? ((g = B.cx1), (m = B.cx2), (f = B.cy1), (y = B.cy2))
                      : (g = m = f = y = void 0),
                    c.indexOf(B.index) < 0 &&
                      x.appendPoint(B.x, B.y, g, f, m, y),
                    w.indexOf(B.index) < 0 && w.push(B.index),
                    B.isLast)
                  ) {
                    if (B.visited) {
                ...
                do {
                  ...
                  (c.indexOf(B.index) < 0 && x.appendPoint(_, v, m, y, g, f),
                    w.indexOf(B.index) < 0 && w.push(B.index));
                } while (!B.isIsect);
        ...
        (d.prototype._mergeNonIntersecting = function (e, t, i, n) {
          ...
          (e.forEach(function (e) {
            ((e.fromSource = 1),
              (e.isHole = a(0, r, e)),
              (e.isIntersecting = s[e.index] || null));
          }),
          ...
          for (
            var l = e.concat(t), h = new Array(l.length), A = 0;
            A < l.length;
            A++
          ) {
          ...
          (d.forEach(function (e) {
            ...
            g.forEach(function (e) {
              var t = (function (e) {
                for (
                  var t = [], i = Number.POSITIVE_INFINITY, n = 0;
                  n < p.length;
                  n++
                ) {
                  var r = p[n];
                  ...
                  ((function (e) {
                    ...
                    (t.length &&
                      ...
                      e.children.forEach(function (i) {
                        (i.parents.splice(i.parents.indexOf(e), 1),
                          t.forEach(function (e) {
                            (i.parents.indexOf(e) < 0 && i.parents.push(e),
                              e.children.push(i));
                          }));
                      }),
                      (e.children = null),
                  ...
                  return (
                    ...
                    !(
                      ...
                      !e.parents.some(function (t) {
                        return (
                          t.item && !t.isHole && e.fromSource !== t.fromSource
                        );
                      })
                    ) ||
                    !(
                ...
                ? function (e) {
                    ...
                    if (
                      e.parents.some(function (i) {
                        return (
                          !(!i.isHole || e.fromSource === i.fromSource) &&
                          ((t = i.fromSource), !0)
                        );
                      })
                    ) {
                      for (var i = 0; i < e.children.length; i++)
                        e.children[i].fromSource === t &&
                          (e.children[i].fromSource = -1);
                      return !0;
                    }
                    return !(
                      !e.isHole ||
                    ...
                    if (!(e.fromSource < 0)) {
                      ...
                      if (!e.isHole)
                        for (var t = 0; t < e.children.length; t++)
                          if (
                            !e.children[t].isHole &&
                            e.children[t].fromSource !== e.fromSource
                          )
                            return ((e.children[t].fromSource = -1), !0);
                      return (
                        !!e.parents.some(function (t) {
                          return (
                            t.isRoot ||
                            (t.isHole && e.fromSource !== t.fromSource)
                          );
                        }) ||
                        !(
                          !e.isHole ||
            ...
            if (!t.corresponding) {
              var n = t,
                ...
                o = function (e, t, i, n, r) {
                  return (
                    l.isEqualEps(e[t], e[i], 1e-10) &&
                    l.isEqualEps(e[n], e[r], 1e-10)
                  );
                },
                a = function (e, t) {
                  return (
                    !!(
                      (function (e, t) {
                        return (
                          l.isEqualEps(e.x, t.x, 1e-10) &&
                          l.isEqualEps(e.y, t.y, 1e-10)
                        );
                      })(e, t) &&
                      ((void 0 === e.cx1 && void 0 === e.cy1) ||
                        o(e, "x", "cx1", "y", "cy1")) &&
                      ((void 0 === e.cx2 && void 0 === e.cy2) ||
                        o(e, "x", "cx2", "y", "cy2"))
                    ) &&
                    (!t.corresponding || t)
                  );
          ...
          if (t)
            for (r = 0; r < e.length; r++)
              for (var o = e[r], a = 0; a < r; a++) {
                var s,
                  h = e[a];
                if (
                  (A = this._intersectsArray[o.index]) &&
                  A.indexOf(h.index) >= 0
                );
                else
                  (((void 0 === (s = t[a][r]) && i(o, h)) ||
                    (void 0 !== s && s)) &&
                    n[r].push(h),
                    ((void 0 === (s = t[r][a]) && i(h, o)) ||
                      (void 0 !== s && s)) &&
                      n[a].push(o));
              }
          else
            for (r = 0; r < e.length; r++)
              for (o = e[r], a = 0; a < r; a++) {
                ...
                ((A = this._intersectsArray[o.index]) &&
                  A.indexOf(h.index) >= 0) ||
                  (i(o, h) ? n[r].push(h) : i(h, o) && n[a].push(o));
              }
          return (
            e.sort(function (e, t) {
