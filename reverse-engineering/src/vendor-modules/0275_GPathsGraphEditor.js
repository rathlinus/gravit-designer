/**
 * chunk.vendor.js Module #275
 * Type: class
 * Name: GPathsGraphEditor
 */
...
function (e, t, i) {
      ...
      (h.inherit(F, A),
          ...
          if (this._startAnchor) {
            ...
            (this._closePBEditor(!0),
              ...
              this._element.addGraphLine(
                t,
                new d.GraphPosition(
                  d.GraphPosition.PosType.Anchor,
                  new d.GraphPosition.AnchorSpec(this._startAnchor),
                ),
                e
                  ? new d.GraphPosition(
                      d.GraphPosition.PosType.Anchor,
                      new d.GraphPosition.AnchorSpec(e),
                    )
                  : null,
                null,
                !0,
        ...
        (F.prototype.setEditMode = function (e, t) {
          (this._editMode !== e || t) &&
            ((this._editMode = e),
            this._partSelection && this._ensureConsistentSelection());
        }),
        ...
        (F.prototype.initialSetup = function (e) {
          if (
            (A.prototype.initialSetup.call(this, e), !(e && e instanceof d))
          ) {
            var t = this.getElement().getPaintLayers().getBorderLayers().pop();
            t && t.setProperty("_blc", E.LineCap.Round);
          }
        }),
        (F.prototype.getBBoxMargin = function () {
          ...
          return this._showAnnotations()
            ? Math.max(
                B.getAnnotationPaintMargin(s.annotationHandles.path.node.size),
                e,
              )
            : e;
        }),
        (F.prototype.getCustomBBox = function (e, t) {
          ...
          if (this._showAnnotations() && !this.hasFlag(b.Flag.ResizeAll))
            for (var h = r.getAnchors().getFirstChild(); h; h = h.getNext()) {
              ...
              l(
                B.getAnnotationBBox(
                  e,
                  c,
                  s.annotationHandles.path.graph.size,
                  !0,
                ),
              );
            }
            ...
            !(
              ...
              (this.hasFlag(b.Flag.ResizeAll) && this.hasFlag(a.Flag.Selected))
            )
          )
        ...
        (F.prototype.getBBox = function (e) {
          ...
          if (
            ...
            var i = this._transform ? this._transform.multiplied(e) : e,
              n =
            ...
            if (
              (this._constrainPair &&
                n(
                  B.getAnnotationBBox(
                    ...
                    s.annotationHandles.path.constrain.size,
                    !0,
                  ),
                ),
              this._pbEditor)
              ...
              this._showAnnotations() &&
                !this.hasFlag(b.Flag.ResizeAll) &&
                this._iteratePoints(
                  this._pbEditor.getPaintElement(),
                  r,
                  function (e) {
                    (e.leftHandlePosition &&
                      n(
                        B.getAnnotationBBox(
                          i,
                          e.leftHandlePosition,
                          s.annotationHandles.path.control.size,
                          !0,
                        ),
                      ),
                      ...
                      n(
                        B.getAnnotationBBox(
                          i,
                          e.position,
                          s.annotationHandles.path.node.size,
                          !0,
                        ),
                      ));
                  }.bind(this),
              ...
              o && ((o = i.mapRect(o)), (t = t ? t.united(o) : o));
              var l = this.getBBoxMargin();
              t = t.expanded(l, l, l, l);
            } else n(A.prototype.getBBox.call(this, e));
          }
          return t;
        }),
        (F.prototype.getElementSelectionBBox = function () {
          ...
          if (this._partSelection && this._partSelection.length)
            for (var t = 0; t < this._partSelection.length; ++t) {
              ...
              if (i.type == F.PartType.Point || i.type == F.PartType.Anchor) {
                var n = this.getPointCoord(i.point),
                  r = new I(n.getX(), n.getY(), 0, 0);
                e = e ? e.united(r) : r;
              } else if (i.type == F.PartType.Segment) {
                ((n = this.getPointCoord(i.apLeft)),
                  (r = new I(n.getX(), n.getY(), 0, 0)));
                ((e = e ? e.united(r) : r),
                  (n = this.getPointCoord(i.apRight)),
                  (r = new I(n.getX(), n.getY(), 0, 0)),
                  (e = e.united(r)));
              }
            }
            ...
            switch ((this.requestInvalidation(), e.type)) {
              ...
              case F.PartType.Segment:
                if (t.type == F.SegmentData.Handles) {
                  var l = this.getPathPointPreview(e.apLeft),
                    h = this.getPathPointPreview(e.apRight),
                    A = n.mapPoint(i),
                    c = new o(t.hitRes.x, t.hitRes.y),
                    p = this._element.getTransform();
                  p && (c = p.mapPoint(c));
                  var u = A.subtract(c),
                    d =
                      (new o(l.getProperty("x"), l.getProperty("y")),
                      new o(h.getProperty("x"), h.getProperty("y")),
                      new g().translated(u.getX() * t.cL, u.getY() * t.cL));
        ...
        (F.prototype._applyPartMove = function (e, t, i, n) {
          (e === b.RESIZE_HANDLE_PART_ID || e === b.ROTATION_HANDLE_PART_ID
            ...
            : (e.type != F.PartType.LeftHandle &&
                e.type != F.PartType.RightHandle &&
                e.type != F.PartType.Segment) ||
        ...
        (F.prototype.edTransform = function (e, t, i, r) {
          if (
            ...
            if (
              ((this._transformSubType = null),
              this.requestInvalidation(),
              this._selectionMode == F.SelectionMode.Edge)
            ) {
              ...
              for (
                var o = function (t) {
                  ...
                  a = 0;
                a < this._partSelection.length;
                ++a
              ) {
                var s = this._partSelection[a];
                s.type === F.PartType.Point
                  ? o(s.point)
                  : s.type === F.PartType.Segment &&
                    t &&
                    this._partIdAreEqual(s, t) &&
                    ((this._transformSubType = i.type),
                    i.type == F.SegmentData.HitRes &&
                      (o(s.apLeft), o(s.apRight)));
              }
            }
            if (this._selectionMode == F.SelectionMode.Anchors) {
              ...
              if (
                ((l = l ? l.multiplied(e).multiplied(l.inverted()) : e),
                !this._moveEdgesLinks)
              ) {
                ((this._moveEdgesLinks = Object.create(null)),
                  (this._updateFirstPtELinks = Object.create(null)),
                  (this._updateLastPtELinks = Object.create(null)));
                for (a = 0; a < this._partSelection.length; ++a) {
                  for (
                    var h = this._partSelection[a].point,
                      A = h.getInEdges(),
                      c = 0;
                    c < A.length;
                    ++c
                  ) {
                    (d = A[c]).getSource().hasFlag(n.Flag.Selected)
                      ? this._moveEdgesLinks[d.getId()] ||
                        (this._moveEdgesLinks[d.getId()] = d)
                      : (this._updateLastPtELinks[d.getId()] = d);
                  }
                  var p = h.getOutEdges();
                  for (c = 0; c < p.length; ++c) {
                    (d = p[c]).getDestination().hasFlag(n.Flag.Selected)
                      ? this._moveEdgesLinks[d.getId()] ||
                        (this._moveEdgesLinks[d.getId()] = d)
                      : (this._updateFirstPtELinks[d.getId()] = d);
                  }
                }
              }
              ...
              if (u.length)
                for (a = 0; a < u.length; ++a) {
                  var d,
                    g = u[a],
                    m = this._elementPreview.getEdges().getById(g);
                  if ((d = this._element.getEdges().getById(g)) && m) {
                    for (
                      var y = d.getPathBase(),
                        _ = new f(),
                        v = y.getAnchorPoints().getFirstChild();
                      null != v;
                      v = v.getNext()
                    )
              ...
              for (a = 0; a < this._partSelection.length; ++a) {
                var w = this._elementPreview
                  .getAnchors()
                  .getById(this._partSelection[a].point.getId());
                for (A = w.getInEdges(), c = 0; c < A.length; ++c) {
                  ...
                  var E = this._element
                      ...
                      .getPathBase(),
                    B =
                      ((v = y.getAnchorPoints().getLastChild()),
                      E.getAnchorPoints()
                        .getLastChild()
                        ._getTransformedCopy(l));
                  v.setProperties(
                    ["x", "y", "hlx", "hly"],
                    [
                      B.getProperty("x"),
                ...
                ((x = l.mapPoint(x)),
                  w.setProperties(["x", "y"], [x.getX(), x.getY()]));
              }
            }
            this.requestInvalidation();
          } else C.prototype.edTransform.call(this, e, t, i, r);
        }),
        (F.prototype.resetTransform = function () {
          (this.releasePreview(),
            this._selectionMode == F.SelectionMode.Anchors &&
              ((this._moveEdgesLinks = null),
              (this._updateFirstPtELinks = null),
              (this._updateLastPtELinks = null)),
            (this._transformSubType = null),
            C.prototype.resetTransform.call(this));
        }),
        ...
        (F.prototype._applyTransform = function (e, t, i, n) {
          if (
            ...
            (e._beginBlockEvents([p.GeometryChangeEvent]),
            ...
            (this.requestInvalidation(),
              this.resetTransform(),
              this.updatePartSelection(!1, r));
          } else if (e instanceof f)
            (this._transform &&
              !this._transform.isIdentity() &&
              C.prototype._applyTransform.call(this, e),
              this.resetTransform());
          else {
            if (
              this._partSelection &&
              ...
              if (this._selectionMode == F.SelectionMode.Edge)
                for (o = 0; o < this._partSelection.length; ++o) {
                  var s;
                  if (
                    (s = this._partSelection[o]).type == F.PartType.Segment ||
                    s.type == F.PartType.Point
                  ) {
                    a = [s];
                    break;
          ...
          if (e.id.type == F.PartType.Segment)
            if (t) {
              ...
              if (p && u) {
                (this.requestInvalidation(),
                  this._pbEditor ||
                    this._initPBEditor(e.id.edge.getPathBase()));
                var d = this._pbEditor.getPathBasePreview(),
                  g = this.getPathPointPreview(p),
                  m = this.getPathPointPreview(u);
                if (g && m)
                  if (w.isEqualEps(c.slope, 0, 0.001))
                    ...
                    var y,
                      ...
                      B = c;
                    if (
                      (null !== p.getProperty("hrx") &&
                        null !== p.getProperty("hry")) ||
                      (null !== u.getProperty("hlx") &&
                        null !== u.getProperty("hly"))
                    )
                      if (
                        null === p.getProperty("hrx") ||
                        null === p.getProperty("hry")
                      ) {
                        var x = m.getProperty("hlx"),
                          P = m.getProperty("hly");
                        ((H = v + (2 / 3) * (x - v)),
                          (W = b + (2 / 3) * (P - b)),
                          (y = C + (2 / 3) * (x - C)),
                    ...
                    ((i = new a.PartInfo(
                      ...
                      (this._transformSubType = i.data.type));
                  }
                else i = null;
              }
            }
            ...
            var O = e.id.point,
              L = (F.PartType.Point, O.getProperty("tp"));
            if (
              (O.hasFlag(n.Flag.Selected) || this.selectOnePoint(O),
              !f.isCornerType(L))
            ) {
              (this.requestInvalidation(),
                this._createPathPreviewIfNecessary(O));
                ...
                if (((r = !0), (l = !1), T.modifiers.optionKey)) {
                  ...
                  (null === H || null === W
                    ? ((X = F.PartType.RightHandle),
                      Y.setProperties(
                        ["ah", "hrx", "hry"],
                        [!1, O.getProperty("x"), O.getProperty("y")],
                      ))
                  ...
                  if (L != f.AnchorPoint.Type.Connector)
                    ...
                    j && !f.isCornerType(j.getProperty("tp"))
                      ? ((X = F.PartType.LeftHandle),
                        Y.setProperties(["ah", "hlx", "hly"], [!1, Z, z]))
                      : ((X = F.PartType.RightHandle),
                        Y.setProperties(["ah", "hrx", "hry"], [!1, Z, z]));
                  }
                  i = new a.PartInfo(
                    this,
                    {
        ...
        (F.prototype.handleDblClick = function (e, t) {
          if (
            e &&
            e.type == F.PartType.Point &&
            this.hasFlag(a.Flag.Detail) &&
            !this._editMode
          ) {
            this.requestInvalidation();
            var i = this.getPathPointPreview(e.point);
            if (i)
              return (
                e.point.getProperty("tp") === f.AnchorPoint.Type.Asymmetric
                  ? (i.setProperties(
                      ["tp", "ah"],
                      [f.AnchorPoint.Type.Symmetric, !0],
                    ),
                    i.setProperties(["ah"], [!1]))
                  : i.setProperties(
                      ["tp", "ah"],
                      [f.AnchorPoint.Type.Asymmetric, !1],
                    ),
                this._partsGeometryChanged([e]),
                this.requestInvalidation(),
                !0
        ...
        (F.prototype.getStylableParts = function () {
          if (
            ...
            !this.hasFlag(b.Flag.ResizeAll) &&
            (this._selectionMode == F.SelectionMode.Edge ||
              this._selectionMode == F.SelectionMode.Facets)
          ) {
            for (var e = [], t = 0; t < this._partSelection.length; ++t) {
              var i =
                this._selectionMode == F.SelectionMode.Edge
                  ? this._partSelection[t].edge
                  : this._partSelection[t].facet;
              if (i)
                if (this._selectionMode == F.SelectionMode.Facets)
                  for (
                    var n = i.getDirectedEdges().getFirstChild();
                    null != n;
                    n = n.getNext()
                  ) {
                    var r = n.getEdge();
        ...
        (F.prototype._detach = function () {
          this.requestInvalidation();
          for (
            var e = this._element.getAnchors().getFirstChild();
            null != e;
            e = e.getNext()
          )
        ...
        (F.prototype.hitAnchorPoint = function (e, t, i, n) {
          if (e) {
            ...
            return (
              ...
              B.getAnnotationBBox(
                r,
                new o(e.getProperty("x"), e.getProperty("y")),
                s.annotationHandles.path.node.size,
              )
                .expanded(n, n, n, n)
                .containsPoint(t)
        ...
        (F.prototype._getPartInfoAt = function (e, t, i) {
          if (this._showAnnotations() && !this.hasFlag(b.Flag.ResizeAll)) {
            var r = this.getGraphPaintElement(),
              o = r.getTransform(),
              h = function (i, n) {
                return (
                  !!i &&
                  B.getAnnotationBBox(t, o ? o.mapPoint(i) : i, n)
                    .expanded(
                      s.annotPickDistance,
                      s.annotPickDistance,
                      s.annotPickDistance,
                ...
                if (
                  ...
                  return (
                    (d = new a.PartInfo(
                      ...
                      {
                        apSelected: e.anchorPoint.hasFlag(n.Flag.Selected),
                      },
                      i,
                      r,
                    )),
            ...
            for (c = r.getEdges().getFirstChild(); c; c = c.getNext()) {
              ...
              if (
                ...
                var g = _.data,
                  f = u.getAnchorPoints().getChildByIndex(g.segment - 1),
                  m = f ? u.getAnchorPoints().getNextPoint(f) : null;
                return new a.PartInfo(
                  this,
                  {
                    type: F.PartType.Segment,
          ...
          if (this.hasFlag(b.Flag.ResizeAll)) {
            ...
            if (
              v &&
              (v.id == b.RESIZE_HANDLE_PART_ID ||
                v.id == b.ROTATION_HANDLE_PART_ID)
            )
              return v;
          }
          return null;
        ...
        (F.prototype.findPivots = function (e, t) {
          var i = v.prototype.findPivots.call(this),
            n = this._element.getTransform();
          if (this._pathBaseInEdit && this._startAnchor) {
            ...
            if (r)
              for (r = r.getNext(); r; r = r.getNext()) {
                var a = new o(r.getProperty("x"), r.getProperty("y")),
                  s = {
        ...
        (F.prototype.splitEdge = function (e, t) {
          ...
          if (e && e.editor == this)
            if (
              e.id.type == F.PartType.Segment ||
              e.id.type == F.PartType.Point
            ) {
              var n = [],
                r = [];
              if (e.id.type == F.PartType.Segment)
                r.push(
                  new y.SplitPoint(
                    e.data.hitRes.segment - 1,
                    e.data.hitRes.slope,
                    new o(e.data.hitRes.x, e.data.hitRes.y),
                  ),
                );
              else {
                for (
                ...
                r.push(
                  new y.SplitPoint(
                    ...
                    0,
                    new o(
                      e.id.point.getProperty("x"),
                      e.id.point.getProperty("y"),
                    ),
                  ),
                );
              }
        ...
        (F.prototype._postPaint = function (e, t) {
          if (this._constrainPair && !this._constrainPainted) {
            var i = s.annotationHandles.path.constrain;
            (t.canvas.strokeLine(
          ...
          if (this._showAnnotations() && !this.hasFlag(b.Flag.ResizeAll))
            for (
              var r = (h = this.getGraphPaintElement()).getTransform(),
                o =
                  ((i = s.annotationHandles.path.graph),
                  h.getAnchors().getFirstChild());
              o;
              o = o.getNext()
            ) {
            ...
            !this.hasFlag(a.Flag.HideEditor) &&
            !this.hasFlag(a.Flag.Outline) &&
            this._element.hasFlag(n.Flag.Highlighted) &&
            (!this.hasFlag(b.Flag.ResizeAll) || !this.hasFlag(a.Flag.Selected))
          ) {
            var h;
            for (
              r = (h = this.getGraphPaintElement()).getTransform(),
                i = s.annotationHandles.path.graph,
                o = h.getAnchors().getFirstChild();
              o;
              o = o.getNext()
            )
          ...
          if (this._pathBaseInEdit && this._pbEditor) {
            ...
            this._selectionMode != F.SelectionMode.Edge ||
              this.hasFlag(a.Flag.Highlighted) ||
              this.setColor(t.selectionSecondOutlineColor);
        ...
        (F.prototype._partIdAreEqual = function (e, t) {
          var i = e.type === t.type;
          return (
            !i || (e.type != F.PartType.Point && e.type != F.PartType.Anchor)
              ? i && e.type == F.PartType.Segment
                ? (i = e.apLeft === t.apLeft && e.apRight == t.apRight)
                : i && F.PartType.Facet && (i = e.facet == t.facet)
              : (i = e.point === t.point),
            i
          );
        }),
        (F.prototype._updatePartSelection = function (e) {
          if (!this.hasFlag(b.Flag.ResizeAll)) {
            ...
            var t = this._selectionMode,
              i = F.SelectionMode.None;
            e = e ? e.slice() : null;
            if (((i = this._filterForSelMode(e)), !this._startAnchor)) {
              var r = this._partSelection,
                o = this._pathBaseInEdit ? this._pathBaseInEdit : null;
              if (
                ...
                for (var a = 0; a < r.length; ++a) {
                  ...
                  l ||
                    (s.point
                      ? (s.point.removeFlag(n.Flag.Selected),
                        s.type == F.PartType.Point && this._closePBEditor(!1))
                      : s.type == F.PartType.Segment
                        ...
                        : s.type == F.PartType.Facet &&
                          s.facet.removeFlag(n.Flag.Selected));
                }
              if (e && e.length)
                switch (this._selectionMode) {
                  ...
                  case F.SelectionMode.Edge:
                    var A = e[0].edge;
                    (A.setFlag(n.Flag.Selected),
                      this._initPBEditor(A.getPathBase()));
                    break;
            ...
            if (
              this._startAnchor ||
              (this._selectionMode == F.SelectionMode.Edge &&
                t == F.SelectionMode.Edge &&
                this._pathBaseInEdit &&
                o == this._pathBaseInEdit &&
                !this._editMode)
            ) {
                ...
                for (a = 0; a < r.length; ++a) {
                  ...
                  l ||
                    (s.point
                      ? s.point.removeFlag(n.Flag.Selected)
                      : s.type == F.PartType.Segment &&
                        (s.apLeft.removeFlag(n.Flag.Selected),
                        s.apRight.removeFlag(n.Flag.Selected)));
                }
              if (c)
                for (a = 0; a < c.length; ++a) {
                  (s = c[a]).point
                    ? s.point.setFlag(n.Flag.Selected)
                    : s.type == F.PartType.Segment &&
                      (s.apLeft.setFlag(n.Flag.Selected),
                      s.apRight.setFlag(n.Flag.Selected));
                }
            }
            this.requestInvalidation();
          }
            ...
            for (var n = !1, r = 0; r < e.length && !n; ++r)
              switch (e[r].type) {
                ...
                case F.PartType.Segment:
                  ((t = F.SelectionMode.Edge),
                    this._editMode &&
                      e[r].type == F.PartType.Point &&
                      (e[r].type = F.PartType.Segment),
                    (i = e[r].type));
                  break;
                case F.PartType.Facet:
                  t == F.SelectionMode.None &&
                    ((t = F.SelectionMode.Facets), (i = F.PartType.Facet));
              }
            if (i)
        ...
        (F.prototype._paintOutline = function (e, t, i, r, o) {
          var l = this.getPaintElement(),
            h = this._element.getTransform();
          if (l instanceof d)
          ...
          if (this._highlightPart && !i) {
            var u = null;
            if (
              (this._highlightPart.edge
                ? this._highlightPart.edge.hasFlag(n.Flag.Selected)
                  ? (this._highlightPart = null)
                  : (u = this._highlightPart.edge.getPathBase())
                : this._highlightPart.facet &&
                  (this._highlightPart.facet.hasFlag(n.Flag.Selected)
                    ? (this._highlightPart = null)
                    : (u = this._highlightPart.facet.getPath())),
              u)
            ) {
          ...
          if (l instanceof d) {
                ...
                if (f)
                  if ((u = f.getPath())) {
                    ...
                    (m = new c(p)) &&
                      (t.canvas.putVertices(m, !1),
                      t.canvas.strokeVertices(
                        r || t.selectionSecondOutlineColor,
                        s.outlineWidth,
                      ));
                  }
              }
            ...
            (r ||
              this._selectionMode != F.SelectionMode.Edge ||
              (y = t.selectionSecondOutlineColor),
              this._pbEditor._paintOutline(h ? h.multiplied(e) : e, t, i, y));
          }
        }),
        (F.prototype._iteratePoints = function (e, t, i) {
          var r = e.getAnchorPoints(),
            a = e.getTransform();
          if (a) t = t ? a.multiplied(t) : a;
          for (var l = r.getFirstChild(); null != l; l = l.getNext()) {
            var h,
              A = r.getPreviousPoint(l),
              c = r.getNextPoint(l),
              p = l.getProperty("tp"),
              u = new o(l.getProperty("x"), l.getProperty("y")),
              d = {
                type: p,
                anchorPoint: l,
                position: u,
            ...
            if (
              ((p !== f.AnchorPoint.Type.Asymmetric &&
                p !== f.AnchorPoint.Type.Symmetric &&
                p !== f.AnchorPoint.Type.Mirror &&
                p !== f.AnchorPoint.Type.Connector) ||
                ((d.annotation = s.annotationHandles.path.node.smoothType),
                !0 === l.getProperty("ah") &&
                  (d.annotation = s.annotationHandles.path.node.autoType)),
            ...
            if (l.hasFlag(n.Flag.Selected) || (c && c.hasFlag(n.Flag.Selected)))
              null !==
                ...
                null !== h.getY() &&
                (d.rightHandlePosition = h);
            if (
              (t &&
                ((d.position = t.mapPoint(d.position)),
                d.leftHandlePosition &&
                  (d.leftHandlePosition = t.mapPoint(d.leftHandlePosition)),
                d.rightHandlePosition &&
                  (d.rightHandlePosition = t.mapPoint(d.rightHandlePosition))),
              !0 === i(d))
            )
              break;
          }
            ...
            if (this._partSelection.length > 1)
              ...
              e =
                t === this._element.getAnchorPoints().getLastChild()
                  ? F.PointsSelectionType.Last
                  : t === this._element.getAnchorPoints().getFirstChild()
                    ? F.PointsSelectionType.First
                    : F.PointsSelectionType.Middle;
            }
          return e;
        }),
        ...
        (F.prototype.updatePartSelectionUnderCollision = function (e, t, i) {
          ...
          for (var l = r.getFirstChild(); null != l; l = l.getNext()) {
            !i &&
              ...
              l.removeFlag(n.Flag.Highlighted);
            var h = l.getPoint();
            ((h = o ? o.mapPoint(h) : h),
              !x.hitTest(h.getX(), h.getY(), t, 0, !0) ||
              (!i && e && l.hasFlag(n.Flag.Selected))
                ? !i ||
                  !l.hasFlag(n.Flag.Highlighted) ||
          ...
          if (
            (a.length &&
              !this._element.hasFlag(n.Flag.Selected) &&
              (i
                ? this._element.hasFlag(n.Flag.Highlighted) ||
                  this._element.setFlag(n.Flag.Highlighted)
                : this._element.setFlag(n.Flag.Selected)),
            i)
          ) {
            if (e && this._partSelection && this._partSelection.length)
              for (var A = 0; A < this._partSelection.length; ++A) {
                (c = this._partSelection[A]).type != F.PartType.Anchor ||
                  c.point.hasFlag(n.Flag.Highlighted) ||
                  c.point.setFlag(n.Flag.Highlighted);
              }
            if (a.length)
              for (A = 0; A < a.length; ++A) {
                (c = a[A]).type != F.PartType.Anchor ||
                  c.point.hasFlag(n.Flag.Highlighted) ||
                  c.point.setFlag(n.Flag.Highlighted);
              }
            if (s.length)
              for (A = 0; A < s.length; ++A) {
                var c;
                (c = s[A]).type == F.PartType.Anchor &&
                  c.point.hasFlag(n.Flag.Highlighted) &&
                  c.point.removeFlag(n.Flag.Highlighted);
              }
            this.requestInvalidation();
          } else
            (this._element.hasFlag(n.Flag.Highlighted) &&
              this._element.removeFlag(n.Flag.Highlighted),
        ...
        (F.prototype.isDeletePartsAllowed = function () {
          ...
          if (
            ...
            if (this._selectionMode == F.SelectionMode.Edge) e = !0;
              ...
              if (t) {
                for (
                  var n = 0, r = this._element.getAnchors().getFirstChild();
                  null != r;
                  r = r.getNext(), ++n
                );
                n > t && (e = !0);
            ...
            if (
              ...
              try {
                ...
                for (var e = 0; e < this._partSelection.length; ++e) {
                  ...
                  if (
                    t.type == F.PartType.Segment ||
                    t.type == F.PartType.Point
                  ) {
              ...
              try {
                this._element.prepareFacetsUpdate();
                for (e = 0; e < this._partSelection.length; ++e)
                  this._partSelection[e].type == F.PartType.Anchor &&
                    this._element.removeAnchor(this._partSelection[e].point);
                this._partSelection = null;
              } finally {
                this._element.finishFacetsUpdate();
              }
          ...
          if (
            ...
            for (var r = 0; r < this._partSelection.length; ++r)
              if (this._partSelection[r].type === F.PartType.Anchor) {
                ...
                for (
                  var l = this._elementPreview
                      .getAnchors()
                      .getById(this._partSelection[r].point.getId()),
                    h = this._partSelection[r].point,
                    A = h.getInEdges(),
                    c = 0;
                  c < A.length;
                  ++c
                ...
                l && l.setProperties(["x", "y"], [s.getX(), s.getY()]);
              }
            this.applyTransform();
          }
        }),
        ...
        (F.prototype._createPathPreviewIfNecessary = function (e) {
          return (
            this._elementPreview ||
              this._setElementPreview(this._element.clone()),
            this._elementPreview
          );
        }),
        (F.prototype.releasePreview = function () {
          (this._setElementPreview(null),
            (this._constrainPair = null),
            this._pbEditor && this._pbEditor.releasePathBasePreview());
        }),
        ...
        (F.prototype.movePoint = function (e, t, i, n) {
          var r = this.getTransformFromNative(i),
            ...
            s = a.mapPoint(t);
          if (e.getProperty("ah"))
            e.setProperties(["x", "y"], [s.getX(), s.getY()]);
          else {
            var l = n || e,
              h = l.getProperty("hlx"),
              A = l.getProperty("hly"),
            ...
            if ((null != h && null != A) || (null != c && null != p)) {
              var u,
                d = r.mapPoint(new o(l.getProperty("x"), l.getProperty("y"))),
                g = t.getX() - d.getX(),
                f = t.getY() - d.getY();
              if (null != h && null != A)
                ((h = (u = a.mapPoint(
                  r.mapPoint(new o(h, A)).translated(g, f),
                )).getX()),
                  (A = u.getY()));
              if (null != c && null != p)
                ((c = (u = a.mapPoint(
                  r.mapPoint(new o(c, p)).translated(g, f),
                )).getX()),
                  (p = u.getY()));
            }
            e.setProperties(
              ["x", "y", "hlx", "hly", "hrx", "hry"],
              [s.getX(), s.getY(), h, A, c, p],
            );
          }
        }),
        ...
        (F.prototype.highlightPart = function (e, t) {
          this.hasFlag(b.Flag.ResizeAll) ||
            (((e.type != F.PartType.Segment && e.type != F.PartType.Point) ||
              e.edge.hasFlag(n.Flag.Selected)) &&
              (e.type != F.PartType.Anchor ||
                e.point.hasFlag(n.Flag.Selected)) &&
              (e.type != F.PartType.Facet ||
                e.facet.hasFlag(n.Flag.Selected))) ||
            ((this._highlightPart = e), this.requestInvalidation());
        }),
        (F.prototype._movePreviewPointCoordinates = function (
          e,
          t,
          i,
          n,
          ...
          l = r.mapPoint(l);
          var A = this._element.getTransform(),
            c = new o(e.getProperty(t), e.getProperty(i));
          (A && (c = A.mapPoint(c)),
            this._transformPreviewPointCoordinates(
              e,
              t,
              i,
              new g(1, 0, 0, 1, l.getX() - c.getX(), l.getY() - c.getY()),
            ));
        }),
        (F.prototype._transformPreviewPointCoordinates = function (
          e,
          t,
          i,
          n,
          ...
          var a = this._element.getTransform(),
            s = this.getPathPointPreview(e);
          if (s) {
            if (r) var l = r;
            else l = new o(e.getProperty(t), e.getProperty(i));
            var h = n;
        ...
        (F.prototype._assignPreviewPointPropertiesToSourcePoint = function (
          e,
          t,
        ) {
        ...
        (F.prototype._transferPreviewProperties = function (e, t) {
          if (t instanceof f) {
            var i = this._pathBaseInEdit.getAnchorPoints().getIndexOfChild(e),
        ...
        (F.prototype._geometryChange = function (e) {
          e.type == p.GeometryChangeEvent.Type.Before &&
          e.element == this._element
            ...
            : e.type == p.GeometryChangeEvent.Type.After &&
              ...
              ((this._elementPreview || this._pbEditor) &&
                ...
                this._pbEditor &&
                  (this._closePBEditor(!0),
                  this.setActiveExtendingMode(C.ExtendingMode.Off))),
              this.requestInvalidation());
        }),
          ...
          if (!e.temporary && e.node instanceof u.PaintLayer) {
            ...
            if (t)
              for (var i = 0; i < t.length; i++)
                if (t[i] === e.node.getOwnerStylable()) {
                  t[i].setProperty(
                    "cSt",
                    !!t[i].getPaintLayers().getBorderLayers().length,
                  );
                  break;
                }
          }
        ...
        (F.prototype._partsGeometryChanged = function (e) {
          ...
          try {
            ...
            var t = new r(),
              i = function (e, i, n) {
                var r = !1,
                  o = [];
                if (
                  (e._splitPathLineAtSelfIntersections(n, o), 1 == o.length)
                ) {
                  for (
                    var s = 0,
                      l = n.getAnchorPoints().getFirstChild().getNext();
                    null != l;
                    l = l.getNext(), ++s
                  );
                  for (
                    var h = e.getEdges().getFirstChild();
                    null != h && !a;
                    h = h.getNext()
                  )
                    if (i != h.getId()) {
            ...
            if (
              this._selectionMode == F.SelectionMode.Edge ||
              (1 == e.length &&
                e[0].type == F.PartType.Segment &&
                this._transformSubType == F.SegmentData.Handles)
            )
              for (var n = 0; n < e.length; ++n) {
                var o = e[n];
                if (
                  (o.type == F.PartType.LeftHandle ||
                    o.type == F.PartType.RightHandle ||
                  ...
                  if (
                    ...
                    o.type == F.PartType.Point &&
                      (s.getPathBase().getAnchorPoints().getFirstChild() ==
                      o.point
                        ? ((l = !1), (a = !0))
                        : s.getPathBase().getAnchorPoints().getLastChild() ==
                            o.point && ((h = !1), (a = !0)));
                  var c = this._pbEditor.getPaintElement();
                  ...
                  if (a) {
                    ...
                    if (l) {
                      var y = s.getSource();
                      g = new d.GraphPosition(
                        d.GraphPosition.PosType.Anchor,
                        new d.GraphPosition.AnchorSpec(y),
                      );
                    }
                    if (h) {
                      var _ = s.getDestination();
                      m = new d.GraphPosition(
                        d.GraphPosition.PosType.Anchor,
                        new d.GraphPosition.AnchorSpec(_),
                      );
                    }
              ...
              for (n = 0; n < e.length; ++n) {
                var P = e[n].point,
                  S = v.getAnchors().getById(P.getId());
                (n != e.length - 1 ||
                  x.length ||
                  this._element._endBlockEvents([p.GeometryChangeEvent]),
                  S &&
                    P.setProperties(
                      ["x", "y"],
                      [S.getProperty("x"), S.getProperty("y")],
                    ));
              }
