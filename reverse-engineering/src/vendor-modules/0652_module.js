...
function (e, t, i) {
      ...
      function f() {
        ((this._width = 0),
          ...
          (this.codes = function (e, t) {
            return (
              h.codeFactory(e, t, this.codes) ||
              this.customCodes(e, t, this.codes)
            );
          }.bind(this)),
          (this.selectionChanged = n.event()),
          (this.contentChanged = n.event()),
          (this.editFilters = [h.editFilter]),
          this.load([]));
      }
      ...
      (r.inherit(f, d),
        ...
        (f.prototype.contentChanged = null),
        (f.prototype.editFilters = null),
        (f.prototype.nextInsertFormatting = {}),
        (f.prototype.emptyFormatting = null),
        (f.prototype._nextSelection = null),
        (f.prototype.words = null),
        ...
        (f.prototype.makeEditCommand = function (e, t, i) {
          var n = this.selection.start,
            r = this.selection.end;
          return function (o) {
            this._wordOrdinals = [];
            var a = Array.prototype.splice.apply(this.words, [e, t].concat(i));
            (o(this.makeEditCommand(this, e, i.length, a)),
              (this._nextSelection = {
                start: n,
                end: r,
              }));
        ...
        (f.prototype.layout = function () {
          ...
          try {
            var e = new l(
              ...
              void 0,
              this._noWrap,
              this._lastSpacingPadding,
            );
            ((this.frame = p.create(this.words).per(e.frame, e).first()),
              (this._lastSpacingPadding =
                this.frame && this.frame.getBBoxSpacing()));
          } catch (e) {
            console.error(e);
          }
          if (this.frame) {
            ...
            (console.error(
              "A bug somewhere has produced an invalid state - rolling back",
            ),
              this.performUndo());
        }),
        ...
        (f.prototype.lineRange = function (e, t) {
          if (!this.frame) return this.range(0, 0);
          ...
          for (var n = 0, r = 0, o = 0; o < i.length; o++) {
            ...
            (l <= e && e <= h && (n = l),
              l <= t &&
                t <= h &&
                (r = h + (s.word ? s.word.text.length : s.length)));
          }
                ...
                ((t = i[i.length - 1]) ||
                  ...
                  (t && t.code) ||
                    (y(e) &&
                      !m(e) &&
                      ((t = i.pop()),
                      n.push(this.range(t.start, a + e.length)))));
              a += e.length;
            }.bind(this),
          );
          var s = function (e) {
            ...
            l = this.byOrdinal(r);
          (l && l.block && r > 0 && r--,
            (l = this.byOrdinal(o)) && l.block && o > 0 && o--);
          var h = s(r),
            A = s(o);
          ((r = h ? h.start : 0),
            (o = A ? A.end : this.frame ? this.frame.length : 0),
        ...
        (f.prototype.paragraphRange = function (e, t) {
          var i,
            n = this.wordContainingOrdinal(e);
          if (((e = 0), n))
            for (i = n.index; i > 0; i--)
          ...
          if (((t = this.frame ? this.frame.length - 1 : 0), r))
            if (y(r.word) && !m(r.word)) t = this.wordOrdinal(r.index);
            else
        ...
        (f.prototype.insert = function (e, t) {
          (("string" == typeof e || e instanceof String) &&
            (e = n.deCRLFify(e)),
            this.select(
              this.selection.end + this.selectedRange().setText(e),
              null,
              t,
            ));
        }),
        ...
        (f.prototype.applyInsertFormatting = function (e) {
          ...
          } else t = this.nextInsertFormatting;
          var n = Object.keys(t);
          n.length &&
          ...
          if (e < this.words.length) {
            ...
            if (t < e + 1)
              for (
                var i =
                    t > 0
                      ? this._wordOrdinals[t - 1] + this.words[t - 1].length
                      : 0,
                  n = t;
                n <= e;
                n++
        ...
        (f.prototype.runs = function (e, t) {
          var i = this.wordContainingOrdinal(Math.max(0, t.start)),
            n = this.wordContainingOrdinal(
              Math.min(t.end, this.frame ? this.frame.length - 1 : 0),
            );
          if (i.index === n.index)
            i.word.runs(e, {
              start: i.offset,
            ...
            for (var r = i.index + 1; r < n.index; r++) this.words[r].runs(e);
            n.word.runs(e, {
              end: n.offset,
            });
          }
        ...
        (f.prototype.checkSanity = function (e, t, i) {
          try {
            var n = new f();
            return (
              n.load(this.documentRange().save()),
              n.splice(e, t, i),
              !!n.frame
            );
          } catch (e) {
            console.warn(
              "Document sanity - A bug somewhere would produce an invalid state",
              e,
            );
          }
          return !1;
        ...
        (f.prototype.clone = function () {
          ...
          return (
            ...
            e.load(this.documentRange().save()),
            e
          );
        }),
        ...
        (f.prototype.splice = function (e, t, i) {
          ...
          var o,
            a,
            s = this.wordContainingOrdinal(e),
            l = this.wordContainingOrdinal(t);
          if (!s || !l) return 0;
          if (e === s.ordinal)
            ...
            o = p
              ...
              .per(s.word.runs, s.word)
              .all();
          t === l.ordinal
            ? t === (this.frame ? this.frame.length - 1 : 0) || y(l.word)
              ? ((a = []), l.index--)
              : (a = p.create({}).per(l.word.runs, l.word).all())
            : (a = p
                .create({
                  start: l.offset,
                })
                .per(l.word.runs, l.word)
                .all());
          var A = this.frame ? this.frame.length : 0,
            u = p.create(o).concat(i).concat(a).per(c.consolidate()).all();
          if (
            0 === e &&
            t >= this.frame.length - 1 &&
            this.frame.length > 1 &&
            0 === u.length
          ) {
            ...
            for (var g in ((this.emptyFormatting = null), d))
              "text" !== g &&
                (this.emptyFormatting || (this.emptyFormatting = {}),
                (this.emptyFormatting[g] = d[g]));
          }
          return (
            this.spliceWordsWithRuns(s.index, l.index - s.index + 1, u),
            this.frame ? this.frame.length - A : 0
          );
        }),
        ...
        (f.prototype.width = function (e) {
          if (0 === arguments.length) return this._width;
        ...
        (f.prototype.toggleCaret = function () {
          ...
          return (
            this.selection.start === this.selection.end &&
              (this.selectionJustChanged
                ? (this.selectionJustChanged = !1)
        ...
        (f.prototype.getCaretCoords = function (e) {
          ...
          if (i) {
            ...
            if (i.block && e > 0)
              if (n.newLine) {
                var r = n.bounds(),
                  o = n.parent().parent().bounds();
                t = new a(o.l, o.b, 1, r.h);
              } else ((t = n.bounds()), (t = new a(t.r, t.t, 1, t.h)));
            else {
              var s = (t = i.bounds()).l,
                l = t.t,
                h = t.h;
              if (i.newLine && n.newLine) {
                var A =
                  this.nextInsertFormatting.align ||
                  this.selectedRange().getFormatting().align;
                "center" === A
                  ? (s = this.frame.bounds().center().x)
                  : "right" === A && (s = this.frame.bounds().r);
              }
              if (
                (n.endOfList && e === this.frame.length - 1
                  ? ((l = (t = n.bounds()).t + t.h), (h = t.h))
                  : "document" === n.type && i.block && 0 === e
                    ? ((l = (t = i.bounds()).t - t.h), (s = 0), (h = t.h))
                    : i.endOfList &&
                      1 === i.length &&
                      "inline" === n.type &&
                      (h = n.h),
        ...
        (f.prototype.byCoordinate = function (e, t) {
          ...
          e < 0 && (e = 0);
          for (
            var i = this.frame.byCoordinate(e, t).ordinal,
              n = this.getCaretCoords(i);
            n.b <= t && i < this.frame.length - 1;
          )
            (i++, (n = this.getCaretCoords(i)));
          for (; n.t >= t && i > 0; ) (i--, (n = this.getCaretCoords(i)));
        ...
        (f.prototype.select = function (e, t, i) {
          this.frame &&
            ...
            (this.selection.end = Math.min(
              "number" == typeof t ? t : this.selection.start,
              this.frame.length - 1,
            )),
        ...
        (f.prototype.performUndo = function (e) {
          var t = e ? this.redo : this.undo,
            i = e ? this.undo : this.redo,
            n = t.pop();
          n &&
            (n(function (e) {
              i.push(e);
        ...
        (f.prototype.transaction = function (e) {
          if (this._currentTransaction) e(this._currentTransaction);
          else {
