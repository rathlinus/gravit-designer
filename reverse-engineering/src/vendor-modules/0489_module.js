...
function (e, t, i) {
      ...
      function r(e) {
        n.call(
          ...
          e,
          null,
          "        uniform highp sampler2D texture;        uniform float power;        varying highp vec2 texCoord;        void main() {            vec4 color = texture2D(texture, texCoord);            color = pow(color, vec4(power));            gl_FragColor = vec4(color);        }    ",
        );
        var t =
          "        uniform highp sampler2D texture0;        uniform highp sampler2D texture1;        uniform vec2 delta0;        uniform vec2 delta1;        uniform float power;        varying highp vec2 texCoord;        " +
          n.randomShaderFunc +
      ...
      (i(0).inherit(r, n),
        ...
        (r.prototype.lensBlur2 = null),
        (r.prototype.render = function (e, t) {
          for (
            var i = e.radius * t, r = e.brightness, o = e.angle, a = [], s = 0;
            s < 3;
            s++
          ) {
            var l = o + (s * Math.PI * 2) / 3;
            a.push([
              (i * Math.sin(l)) / this.glEffect.width,
              (i * Math.cos(l)) / this.glEffect.height,
            ]);
          }
          ...
          (this.simpleShader.call(this, {
            ...
            this.lensBlur0.simpleShader.call(
              this.lensBlur0,
              {
                delta0: a[0],
              },
            ...
            this.lensBlur1.simpleShader.call(
              this.lensBlur1,
              {
                delta0: a[1],
                delta1: a[2],
            ...
            this.lensBlur0.simpleShader.call(this.lensBlur0, {
              delta0: a[1],
            }),
            this.glEffect.extraTexture.use(1),
            this.lensBlur2.simpleShader.call(this.lensBlur2, {
              power: 1 / h,
              delta0: a[2],
            }));
        }),
        (r.prototype.destroy = function () {
          (this.lensBlurPrePass && this.lensBlurPrePass.destroy(),
            this.lensBlur0 && this.lensBlur0.destroy(),
            this.lensBlur1 && this.lensBlur1.destroy(),
