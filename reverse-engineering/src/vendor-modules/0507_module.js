...
function (e, t, i) {
      ...
      var d = function () {
        ...
        _ = function (e) {
          ...
          return (
            t &&
              ((e.escaped = s.escapeRegExp(e.value)),
              (e.pattern = new RegExp(t(e.value, e.escaped, e)))),
            e
          );
        },
        v = function (e, t) {
      ...
      h.compute = function (e) {
        ...
        if (
          ...
          if (r || 1 != A.length)
            ...
            ((o = u(o, y, c)),
              (r = function (e) {
                for (
                  var t, i = e.getNodesByName(l || "*"), n = [], r = 0;
                  (t = i[r]);
                  r++
                )
                  y(t, A[0]) && n.push(t);
        ...
        for (t = 0; (i = e.properties[t]); t++) n = u(n, v, _(i));
        return (
          (e.simple = !n)
            ? (e.matchAux = d)
            : ((e.matchAux = n), (o = u(o, n))),
          (e.match = o || d),
          (e.combine = s.combinators[e.combinator || " "]),
          (e.search = r),
          e
        );
      };
      var b = (s.combinators = {
          " ": function (e, t, i, n, r, o) {
            var a = i.search(t);
            if (o && i.simple) return s.toArray(a);
          ...
          "~": function (e, t, i, n, r) {
            for (; (t = t.getNext()) && r(t); ) i.match(t, n) && e.push(t);
            return e;
          },
          "<": function (e, t, i, r, o) {
          ...
          "^": function (e, t, i, n, r) {
            return (
              (t = t.getFirstChild()) &&
                (r(t) && i.match(t, n)
                  ? e.push(t)
                  : (e = s.combinators["+"](e, t, i, t, n))),
              e
            );
          },
          "++": function (e, t, i, n, r) {
            for (; (t = t.getNext()); ) r(t) && this.match(t, n) && e.push(t);
            return e;
          },
          "--": function (e, t, i, n, r) {
            for (; (t = t.getPrevious()); )
        ...
        C = (s.pseudos = {
          ...
          "nth-child": function (e, t, i) {
            ...
            if ("n" != n.special) return C[n.special](e, n.a, i);
      ...
      for (
        var P = ["parse", "queryAll", "querySingle", "match", "filter"], S = 0;
        P[S];
        S++
      )
        s.generise(P[S]);
      (s.recompile(),
        (r.prototype.queryCount = function (e) {
