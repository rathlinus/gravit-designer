...
function (e, t, i) {
      ...
      function d(e) {
        ((this.words = []),
          ...
          (this.startPoint = new l(0, 0)),
          (this.endPoint = new l(0, 0)),
      ...
      function f(e, t) {
        return !(
          !r.equals(e, t) &&
          ("__pdfimportgradtype__" in e || "__pdfimportgradtype__" in t)
        );
      }
      (n.inherit(p, c),
        ...
        (u.prototype.canMerge = function (e) {
          return (
            f(this.defaultFill, e.defaultFill) &&
            r.equals(this.defaultBorder, e.defaultBorder)
          );
        }),
        ...
        (u.prototype.getGeometryBBox = function () {
          var e = this.getFirstLine(),
            t = e.startPoint,
            i = e.endPoint;
          return (
            r.each(this.lines, function (e, n) {
            ...
            new h(
              ...
              t.getY(),
              i.getX() - t.getX(),
              this.lines.length > 1 ? i.getY() - t.getY() : e.ascent,
            )
          );
        }),
        ...
        (u.prototype.toGText = function () {
          ...
          var t = this.getGeometryBBox(),
            i = this.getFirstLine(),
            n = i.transform.getTranslation(),
            r = i.transform
              .translated(-n.getX(), -n.getY())
              .translated(t.getX(), t.getY())
              .preMultiplied(new o().translated(0, -i.ascent)),
            l = i.getFirstWord(),
            h = l.fontColor,
            c = l.fontColor || s.BLACK;
          "__pdfimportgradtype__" in c &&
            (this.acceptLines(function (e) {
              e.acceptWords(function (e) {
                delete e.fontColor;
              });
            }),
            (h = c.createGPattern(null, t)));
          var p = l.borderWidth || 1,
            u = l.borderColor;
          (u && "__pdfimportgradtype__" in u && (u = u.createGPattern(null, t)),
            (this.defaultFill = c),
            (this.defaultBorder = u));
        ...
        (d.prototype.startPoint = null),
        (d.prototype.endPoint = null),
        (d.prototype.transform = null),
        (d.prototype.defaultFontSize = null),
        (d.prototype.width = null),
        (d.prototype.ascent = null),
        (d.prototype.descent = null),
        (d.prototype.isBreakLine = function () {
        ...
        (d.prototype.add = function (e) {
          (this.getLastWord() ||
            ...
            (this.endPoint = e.endPoint.translated(0, e.ascent)),
            (this.transform = e.transform),
            (this.defaultFontSize = e.fontSize)),
            this.words.push(e),
            (this.ascent = Math.max(this.ascent, e.ascent)),
            (this.descent = Math.max(
              Math.abs(this.descent),
              Math.abs(e.descent),
            )),
            e.transform.getRotationFactor() <= 0
              ? ((this.endPoint = l.max(this.endPoint, e.endPoint)),
                (this.startPoint = l.min(this.startPoint, e.startPoint)))
              : ((this.endPoint = l.min(this.endPoint, e.endPoint)),
                (this.startPoint = l.max(this.startPoint, e.startPoint))));
        }),
        ...
        (d.prototype.toString = function () {
          var e = [];
          return (
            this.acceptWords(function (t) {
              e.push(t.text);
            }),
            e.join("")
          );
        }),
        (g.prototype.word = null),
        ...
        (g.prototype.isSameTransformation = function (e) {
          return c.Transform.sameTransformation(
            this.word.transform,
            e.word.transform,
          );
        }),
        (g.prototype.isSameLine = function (e) {
          var t = this.word.transform
              .rotated(this.word.transform.getRotationFactor())
              .mapPoint(new l(this.word.x, this.word.y))
              .getY(),
            i = e.word.transform
              .rotated(e.word.transform.getRotationFactor())
              .mapPoint(new l(e.word.x, e.word.y))
              .getY();
          return (
            (t = parseFloat(t.toFixed(4))) === (i = parseFloat(i.toFixed(4)))
          );
        }),
        (g.prototype.canMergeColor = function (e) {
          return (
            f(this.word.fontColor, e.word.fontColor) &&
            r.equals(this.word.borderColor, e.word.borderColor)
          );
        }),
        ...
        (g.prototype.splice = function (e, t) {
          ...
          return (
            (this.text =
              e < 0
                ? this.text.substring(0, this.length() + e)
                : this.text.substring(e, t)),
            i
          );
        }),
        ...
        (p.prototype.createTexts = function (e) {
          for (var t, i, n = []; e.length; ) {
            var r,
              o = e.shift();
            if ((t || ((t = new u()), n.push(t)), i)) {
              r = i.getLastWord();
              var a = new g(o),
                s = new g(r);
              if (
                a.isSameLine(s) &&
                a.isSameTransformation(s) &&
                a.canMergeColor(s) &&
                a.getHStartPoint() > s.getHStartPoint()
              ) {
                ...
                if (l > 0)
                  if (((l *= s.fontSizeScale), s.length() > 1)) {
                    if (s.slice(-1).charSpacing >= 0) {
                      var h = s.splice(-1);
                      ((h.charSpacing = l), i.add(h.word));
                    }
                  } else s.charSpacing >= 0 && (s.charSpacing = l);
              } else ((i = new d()), (t = new u()).add(i), n.push(t));
            } else ((i = new d()), t.add(i));
            i.add(o);
          }
          return n;
        }),
        (p.prototype.mergeTexts = function (e, t) {
          var i = !1,
            ...
            r = t.$trf;
          if (
            c.Transform.sameTransformation(n, r) &&
            e._$itext.canMerge(t._$itext)
          ) {
            var o = this._mergeHorizontalTexts(e, t),
              a = this._mergeVerticalTexts(e, t);
            i = o || a;
          }
          return (
            this._applyAlignmentsAndIdentations(e),
            i || this._applyAlignmentsAndIdentations(t),
            i
          );
        }),
          ...
          (t.acceptLines(function (e) {
            if (!e.isBreakLine() && e.startPoint.getX() != i.getX()) {
              var t = i.getSide(h.Side.TOP_RIGHT).getX() - e.endPoint.getX(),
                ...
                a = e.getFirstWord();
              if (
                (Math.abs(t - o) <= 2 && ((a.align = "center"), (n = !0)),
                !a.align)
              ) {
                var s = r.extend({}, a);
                ((s.text = " "),
