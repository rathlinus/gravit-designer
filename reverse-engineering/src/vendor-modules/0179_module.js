...
function (e, t, i) {
      ...
      ((A.makeClockWise = function (e) {
        var t = null;
        if (e instanceof a) (e.isClockWise() || e.reverseOrder(), (t = e));
        else if (e instanceof n) {
          for (var i = e.getPaths().getFirstChild(); i; )
            (A.makeClockWise(i), (i = i.getNext()));
          t = e;
        } else e.hasMixin(l) && (t = h.makeClockWise(e));
        return t;
      }),
        (A.createPathFromVertexSource = function (e, t, i, l) {
          ...
          for (
            e.rewindVertices(0),
              e.readVertex(c),
              c.command === o.Command.Move
                ? (u &&
                    d &&
                    d.getFirstChild() != d.getLastChild() &&
                    (u.correctClosedAttribute(), p.push(u), i && (A(u), A(d))),
                  (d = (u = new r()).getAnchorPoints()),
                  i && (h(u), h(d)),
          ...
          if (
            (u &&
              d &&
              d.getFirstChild() != d.getLastChild() &&
              (l || u.correctClosedAttribute(), p.push(u)),
            i &&
