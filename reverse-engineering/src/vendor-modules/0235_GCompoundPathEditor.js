/**
 * chunk.vendor.js Module #235
 * Type: class
 * Name: GCompoundPathEditor
 */
...
function (e, t, i) {
      ...
      (r.inherit(g, a),
        ...
        (g.prototype._applyTransform = function (e, t, i, n) {
          var r =
            !this.hasPathPartSelection() || this.hasFlag(l.Flag.ResizeAll);
          (e.beginUpdate(),
            ...
            r
              ...
              : this._iterateChildPathsEditors(
                  function (e) {
                    e.canApplyTransform() &&
                      e.applyTransform(e._element, !1, null, n);
                  }.bind(this),
                ),
        ...
        (g.prototype.getBBox = function (e) {
          ...
          if (
            ((this.hasFlag(p.Flag.Selected) ||
              this.hasFlag(p.Flag.Highlighted)) &&
              this._iterateChildPathsEditors(
                function (i) {
                  var n = i.getBBox(e);
                  n && (t = t ? t.united(n) : n);
        ...
        (g.prototype.getElementSelectionBBox = function () {
          ...
          return (
            this._iterateChildPathsEditors(
              function (t) {
                var i = null;
                (t.getPartsSelectionLength() &&
                  (i = t.getElementSelectionBBox()),
                  i && (e = e ? e.united(i) : i));
              }.bind(this),
            ),
        ...
        (g.prototype.getPartInfoAt = function (e, t, i, n) {
          ...
          return r
            ? (r.data || (r.data = {}), (r.data.ownerEditor = this), r)
            : null;
        }),
        (g.prototype._getPartInfoAt = function (e, t, i) {
          if (!this.hasFlag(l.Flag.ResizeAll))
            for (
              var n = null, r = this._element.getPaths().getFirstChild();
              null != r;
              r = r.getNext()
            ) {
              var o = s.openEditor(r);
              if (
                (o.removeFlag(l.Flag.ResizeAll),
                o.setCatchHandle(!1),
                (n = o._getPartInfoAt(e, t, i)))
              )
                return (
                  n.data || (n.data = {}),
                  (n.data.ownerEditor = this),
                  n
                );
            }
        ...
        (g.prototype._paintChildren = function (e, t, i) {
          this._editors &&
            this._editors.length <= d.maxNumberOfEditorsToDraw &&
            a.prototype._paintChildren.call(this, e, t, i);
        }),
        (g.prototype.updateOwnedPartsSelection = function (e, t) {
          if (t && t.length) {
            for (var i = null, n = 0; n < t.length; ++n) {
              var r = t[n];
              r.data.ownerEditor === this &&
                (e ? r.editor.updatePartSelection(e, [r.id]) : (i = r));
            }
            i &&
              (this.updatePartSelection(!1),
              i.editor.updatePartSelection(!1, [i.id]));
          }
        }),
        ...
        (g.prototype.updatePartSelectionUnderCollision = function (e, t, i) {
          for (
            var n = !1, r = this._element.getPaths().getFirstChild();
            null != r;
            r = r.getNext()
          ) {
            var o = s.openEditor(r);
            (o.removeFlag(l.Flag.ResizeAll),
              o.setCatchHandle(!1),
              o.updatePartSelectionUnderCollision(e, t, i) && (n = !0));
          }
          return n;
        }),
        (g.prototype.isDeletePartsAllowed = function () {
          ...
          if (this.hasFlag(p.Flag.Selected) && this._editors) {
            ...
            (this._iterateChildPathsEditors(
              function (n) {
                (e = e || n.isDeletePartsAllowed()) ||
                  (n.hasAllPointsSelected() ? (i = !0) : (t = !1));
              }.bind(this),
            ),
              e || !i || t || (e = !0));
          }
          ...
          if (this.hasFlag(p.Flag.Selected) && this._editors) {
            ...
            if (
              ...
              for (var t = this._element, i = 0; i < e.length; ++i) {
                ...
                var r = e[i].getPath();
                (r.hasFlag(n.Flag.Selected) && r.removeFlag(n.Flag.Selected),
                  t.getPaths().removeChild(r));
              }
              if (
                this._element.getPaths().getFirstChild() ==
                this._element.getPaths().getLastChild()
              ) {
        ...
        (g.prototype._iterateChildPathsEditors = function (e) {
          if (
            ...
            for (
              var t = !1, i = this._element.getPaths().getFirstChild();
              null != i && !t;
              i = i.getNext()
            ) {
              var n = s.getEditor(i);
