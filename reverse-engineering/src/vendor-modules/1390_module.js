      ...
      ((A.import = function (e, t, i, c) {
        try {
          ...
          if (
            ...
            4 === y.length &&
              ((d = parseFloat(y[2]) - parseFloat(y[0])),
              (g = parseFloat(y[3]) - parseFloat(y[1])),
              NaN !== d &&
                NaN !== g &&
                d >= 0 &&
                g >= 0 &&
                f.ViewPort.SetCurrent(d, g));
          }
          var _ = null;
          if (
            !t.forceBaseSize &&
            m.style("width").hasValue() &&
            m.style("height").hasValue()
          ) {
            var v = m.style("width").toPixels("x"),
          ...
          if (
            (w.getFirstChild() || (w = null),
            !t.target && w && !(w instanceof l))
          ) {
