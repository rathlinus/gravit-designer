...
function (e, t, i) {
      ...
      !(function (r) {
        ...
        function c(e, t) {
          var i, n, r;
          if (!A.test(t)) throw Error(s + "number");
          for (
          ...
          if (t < 1)
            ((n =
              ...
              (0 === t &&
                ((1 === i && r[0] >= 5) ||
                  (2 === i &&
                    (r[0] > 5 || (5 === r[0] && (n || void 0 !== r[1]))))))),
              (r.length = 1),
              n ? ((e.e = e.e - t + 1), (r[0] = 1)) : (r[0] = e.e = 0));
          else if (t < r.length) {
            if (
              ((n =
                (1 === i && r[t] >= 5) ||
        ...
        ((h.abs = function () {
          ...
          (h.div = function (e) {
            var t = this,
              ...
              o = t.s == e.s ? 1 : -1,
              a = i.DP;
            if (a !== ~~a || a < 0 || a > 1e6) throw Error(l);
            ...
            var s,
              ...
              b = 0,
              C = a + (_.e = t.e - e.e) + 1;
            for (_.s = o, o = C < 0 ? 0 : C, d.unshift(0); y++ < s; ) m.push(0);
            do {
              for (A = 0; A < 10; A++) {
                if (s != (y = m.length)) c = s > y ? 1 : -1;
                else
                  for (u = -1, c = 0; ++u < s; )
                    if (r[u] != m[u]) {
                      c = r[u] > m[u] ? 1 : -1;
              ...
              ((v[b++] = c ? A : ++A),
                m[0] && c ? (m[y] = n[g] || 0) : (m = [n[g]]));
            } while ((g++ < f || void 0 !== m[0]) && o--);
            return (
              v[0] || 1 == b || (v.shift(), _.e--, C--),
              b > C && p(_, C, i.RM, void 0 !== m[0]),
              _
            );
          }),
          (h.eq = function (e) {
          ...
          (h.minus = h.sub =
            function (e) {
              ...
              if (!h[0] || !c[0])
                return (
                  c[0] ? (e.s = -l) : h[0] ? (e = new a(o)) : (e.s = 1),
                  e
                );
              if ((s = A - p)) {
                for (
                  (r = s < 0) ? ((s = -s), (n = h)) : ((p = A), (n = c)),
                    n.reverse(),
                    l = s;
                  l--;
                )
                ...
                for (
                  i = ((r = h.length < c.length) ? h : c).length, s = l = 0;
                  l < i;
                  l++
                )
                  if (h[l] != c[l]) {
              ...
              if (
                (r && ((n = h), (h = c), (c = n), (e.s = -e.s)),
                (l = (i = c.length) - (t = h.length)) > 0)
              )
                for (; l--; ) h[t++] = 0;
              for (l = t; i > s; ) {
                if (h[--i] < c[i]) {
          ...
          (h.plus = h.add =
            function (e) {
              ...
              for (
                s.length - h.length < 0 && ((n = h), (h = s), (s = n)),
                  t = h.length,
                  i = 0;
                t;
                s[t] %= 10
          ...
          (h.toFixed = function (e, t) {
            ...
            if (void 0 !== e) {
              if (e !== ~~e || e < 0 || e > 1e6) throw Error(l);
              for (
                e = e + (i = p(new i.constructor(i), e + i.e + 1, t)).e + 1;
                i.c.length < e;
              )
                i.c.push(0);
            }
          ...
          (h.toPrecision = function (e, t) {
            ...
            if (void 0 !== e) {
              if (e !== ~~e || e < 1 || e > 1e6) throw Error(s + "precision");
              for (i = p(new n(i), e, t); i.c.length < e; ) i.c.push(0);
            }
          ...
          ((o = (function e() {
            function t(i) {
              var n = this;
              if (!(n instanceof t))
                return void 0 === i && 0 === arguments.length ? e() : new t(i);
              if (i instanceof t)
