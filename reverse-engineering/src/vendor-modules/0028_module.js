      ...
      (i(900)(p),
        ...
        (p.prototype.getPaintLayers = function () {
          return this.getStylePropertySets().indexOf(
            ...
            this.getStylePropertySets().indexOf(
              p.PropertySet.FillPaintLayers,
            ) >= 0
            ? (this._paintLayers ||
        ...
        (p.prototype.assignStyleFrom = function (e, t) {
          ...
          if (o.length) {
            ...
            if (h || A) {
              ...
              try {
                for (
                  var g = [], f = c.getFirstChild();
                  null !== f;
                  f = f.getNext()
                )
                  ((f instanceof p.FillPaintLayer && h) ||
                    (f instanceof p.BorderPaintLayer && A)) &&
                    (d || (this._stylePrepareGeometryChange(!0), (d = !0)),
                    g.push(f));
                for (a = 0; a < g.length; a++) c.removeChild(g[a]);
                if (u)
                  for (var m = u.getFirstChild(); null !== m; m = m.getNext())
                    ((m instanceof p.FillPaintLayer && h) ||
                      (m instanceof p.BorderPaintLayer && A)) &&
                      (d || (this._stylePrepareGeometryChange(!0), (d = !0)),
                      c.appendChild(m.clone()));
              } finally {
                (t &&
                  c._endBlockChanges([
                    n._Change.BeforeChildRemove,
            ...
            if (o.indexOf(p.PropertySet.Effects) >= 0) {
              ...
              try {
                for (; y.getFirstChild(); )
                  (v || (this._stylePrepareGeometryChange(!0), (v = !0)),
                    y.removeChild(y.getFirstChild()));
                if (_)
                  for (var b = _.getFirstChild(); null !== b; b = b.getNext())
                    (v || (this._stylePrepareGeometryChange(!0), (v = !0)),
                      y.appendChild(b.clone()));
              } finally {
                (t &&
                  y._endBlockChanges([
                    n._Change.BeforeChildRemove,
            ...
            for (var C = [], w = 0; w < o.length; ++w) {
              var E = p.PropertySetInfo[o[w]],
                B = [];
              (E.visualProperties &&
                (B = B.concat(Object.keys(E.visualProperties))),
                E.geometryProperties &&
                  (B = B.concat(Object.keys(E.geometryProperties))));
        ...
        (p.prototype.getStyleLayers = function () {
          ...
          return (
            (t || i) &&
              ((n = []),
              t && n.push(p.StyleLayer.Fill),
              i && n.push(p.StyleLayer.Border)),
            n
          );
        }),
        (p.prototype.getStyleBorderPadding = function (e) {
          return e.$_ba === p.BorderAlignment.Center
            ? e.$_bw / 2
            : e.$_ba === p.BorderAlignment.Outside
              ? e.$_bw
              : 0;
        }),
        (p.prototype._setStyleDefaultProperties = function () {
          for (
            var e = this.getStylePropertySets(), t = !1, i = 0;
            i < e.length;
            ++i
          ) {
            var n = p.PropertySetInfo[e[i]];
            (n.visualProperties &&
              this._setDefaultProperties(n.visualProperties),
              n.geometryProperties &&
                this._setDefaultProperties(n.geometryProperties),
              e[i] === p.PropertySet.Effects
                ? (this._effId = A.uuid())
                : (e[i] !== p.PropertySet.FillPaintLayers &&
                    e[i] !== p.PropertySet.BorderPaintLayers) ||
                  t ||
          ...
          if (
            ...
            !o && i
              ...
              : o &&
                ...
                this._stylePropertiesUpdated(a, s));
          } else if (e === n._Change.Store)
            for (
              var A = this.getStylePropertySets(), c = !1, u = 0;
              u < A.length;
              ++u
            ) {
              if ((g = A[u]) === p.PropertySet.Effects)
                ...
                g === p.PropertySet.FillPaintLayers ||
                g === p.PropertySet.BorderPaintLayers
              )
                !c &&
                this._paintLayers &&
                null !== this._paintLayers.getFirstChild()
                  ? ((t.blob._layers = n.store(this._paintLayers, t.options)),
                    (c = !0))
            ...
            for (u = 0; u < A.length; ++u) {
              ...
              if ((g = A[u]) === p.PropertySet.Effects)
                t.blob._eff
                  ? ((this._effects = n.restore(t.blob._eff)),
                    this._effects._setParent(this))
                ...
                !d && t.blob._layers
                  ? ((this._paintLayers = n.restore(t.blob._layers)),
                    this._paintLayers._setParent(this),
                    (d = !0))
                  : !d &&
                    t.blob._layId &&
                    ((this._layId = t.blob._layId), (d = !0));
              else {
                var f;
                ((f = p.PropertySetInfo[g]).visualProperties &&
        ...
        (p.prototype.equalsStyle = function (e) {
          if (e) {
            var t = function (t) {
              ...
              for (; null !== n && null !== r; ) {
                ...
                if (null !== n && null !== r) {
                  ...
                  for (
                    n = n.getNext(), r = r.getNext();
                    null !== n && !(n instanceof t);
                  )
                    n = n.getNext();
            ...
            if (e.getProperty("ps").indexOf(p.PropertySet.Style) >= 0) {
              ...
              ((l = p.PropertySetInfo[p.PropertySet.Style]).visualProperties &&
                ...
                l.geometryProperties &&
                  (i = i.concat(Object.keys(l.geometryProperties))));
              var n = !0;
              if (
                (i.forEach(
                  function (t) {
                    "_sdf" !== t &&
                      (n = n && this.getProperty(t) === e.getProperty(t));
                  }.bind(this),
                ),
                !n)
              )
            ...
            if (
              e.getProperty("ps").indexOf(p.PropertySet.FillPaintLayers) >= 0 &&
              !t(p.FillPaintLayer)
            )
              return !1;
            if (
              e.getProperty("ps").indexOf(p.PropertySet.BorderPaintLayers) >=
                0 &&
              !t(p.BorderPaintLayer)
            )
              return !1;
            ...
            if (e.getProperty("ps").indexOf(p.PropertySet.Text) >= 0) {
              n = !0;
              for (
                var a = [p.PropertySet.Text, p.PropertySet.Paragraph],
                  s = ((i = []), 0);
                s < a.length;
                ++s
              ) {
                var l;
                ((l = p.PropertySetInfo[a[s]]).visualProperties &&
                  (i = i.concat(Object.keys(l.visualProperties))),
                  l.geometryProperties &&
                    (i = i.concat(Object.keys(l.geometryProperties))));
              }
