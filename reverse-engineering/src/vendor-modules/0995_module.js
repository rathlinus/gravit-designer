...
function (e, t, i) {
      ...
      ((s[1] = function () {
        ...
        (s[2] = function () {
          ...
          var i = this.parsePointer(a.coverage),
            r = this.parseUShort(),
            o = this.parseUShort();
          if (1 === t)
            return {
          ...
          if (2 === t) {
            var s = this.parsePointer(a.classDef),
              l = this.parsePointer(a.classDef),
              h = this.parseUShort(),
              A = this.parseUShort();
            return {
              posFormat: t,
      ...
      ((t.parse = function (e, t) {
        ...
        return (
          n.argument(
            1 === r || 1.1 === r,
            "Unsupported GPOS table version " + r,
          ),
          1 === r
            ? {
                version: r,
