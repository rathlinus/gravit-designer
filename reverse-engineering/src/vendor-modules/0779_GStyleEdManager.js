/**
 * chunk.vendor.js Module #779
 * Type: class
 * Name: GStyleEdManager
 */
...
function (e, t, i) {
      ...
      (l.inheritAndMix(v, l, [s]),
        ...
        (v.PREPARE_MODIFIED_EVENT = new v.EditorEvent(
          v.EditorEventType.PrepareModifiedEvent,
          null,
        )),
        ...
        (v.prototype.getEditor = function (e) {
          var t = this._typeIdToIndexMap.hasOwnProperty(l.getTypeId(e))
            ? this._typeIdToIndexMap[l.getTypeId(e)]
            : -1;
            ...
            if ((e instanceof u || (e = this.getEditor(e)), e)) {
              ...
              if (
                ...
                return (
                  (this._activeEditor = e),
                  i &&
                    this.hasEventListeners(v.EditorChangedEvent) &&
                    this.trigger(new v.EditorChangedEvent(i, e)),
                  !0
                );
        ...
        (v.prototype._afterPropertiesChange = function (e) {
          if (!this._editorUpdateBlocker) {
            var t = e.node.getPatternPropNames
              ? e.node.getPatternPropNames()
              : null;
            if (t && t.length)
              for (var i = 0; i < e.properties.length; ++i) {
                var n = e.properties[i];
                if (t.indexOf(n) >= 0)
                  return void this.updateEditor(
                    e.node,
                    e.properties[i],
                    e.temporary,
                  );
