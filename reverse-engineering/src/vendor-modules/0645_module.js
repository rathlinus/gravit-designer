...
function (e, t, i) {
      ...
      function o(e) {
        ((this._events = []),
          e &&
            (e.addEventListener(
              e.constructor.ToolChangedEvent,
              this._toolChanged,
              this,
            ),
            (this._toolMgr = e)));
      ...
      ((o.RecordItem = function (e, t, i, n) {
        ((this.type = e),
          (this.event = t),
          (this.eventClass = i),
          (this.targetIsWidget = n));
      }),
        (o.RecordItem.prototype.type = null),
        (o.RecordItem.prototype.event = null),
        (o.RecordItem.prototype.eventClass = null),
        (o.RecordItem.prototype.serialize = function () {
          var e = {
            type: this.type,
          };
          switch (this.type) {
            case o.RecordItemType.DOM:
              var t = this.event;
              e.eventClass = this.eventClass.prototype
                .toString()
                .match(/^\[[a-zA-Z\s\.]+/)[0];
              ((e.event = {}),
                [
              ...
              ((a.event = e.event),
                (a.event.preventDefault =
                  ...
                  a.event.stopImmediatePropagation =
                    function () {}),
                e.targetIsWidget && (a.event.target = i._htmlElement),
                (a.targetIsWidget = e.targetIsWidget));
              break;
            case o.RecordItemType.TOOL:
              var A,
                c = e.event.next,
              ...
              a.event = new t.constructor.ToolChangedEvent(
                null,
                A,
                e.event.light,
              );
        ...
        (o.prototype.record = function (e, t, i) {
          this._isPlaying ||
            (this._isRecording &&
              this._events.push(
                new o.RecordItem(o.RecordItemType.DOM, e, t, i),
              ));
        }),
        (o.prototype.play = function (e, t, i) {
          ...
          for (this._isPlaying = !0; n._head < n._events.length; ) {
            ...
            switch (r.type) {
              ...
              case o.RecordItemType.TOOL:
                n._toolMgr &&
                  n._toolMgr.activateTool(r.event.newTool, null, !0);
            }
        ...
        (o.prototype._toolChanged = function (e) {
          this._isRecording &&
            (this._isPlaying ||
              this._events.push(new o.RecordItem(o.RecordItemType.TOOL, e)));
        }),
