...
function (e, t, i) {
      ...
      (o.inherit("rectangle", h, a),
        ...
        (h.VisualProperties = {}),
        (h.getGeometryPropertiesSidePrefix = function (e) {
          switch (e) {
        ...
        (h.prototype.iterateSegments = function (e, t) {
          for (var i = t ? this.$trf : null, o = 0; o < h.SIDES.length; ++o) {
            var a = h.SIDES[o],
              s = h.getGeometryPropertiesSidePrefix(a),
              l = null;
            switch (a) {
              case r.Side.TOP_LEFT:
        ...
        (h.prototype.getPointsMinDistance = function () {
          var e = new n(this._x, this._y),
            t = new n(this._x + this._w, this._y),
            i = new n(this._x, this._y + this._h);
          return (
            this.$trf &&
              ((e = this.$trf.mapPoint(e)),
              (t = this.$trf.mapPoint(t)),
              (i = this.$trf.mapPoint(i))),
            Math.min(
              s.ptDist(e.getX(), e.getY(), t.getX(), t.getY()),
              s.ptDist(e.getX(), e.getY(), i.getX(), i.getY()),
            )
          );
        }),
        ...
        (h.prototype._handleChange = function (e, t) {
          if (e === o._Change.Store)
            if (this.$uf)
              ((t.blob.uf = !0),
                (t.blob.ct = this.$tl_ct),
                (t.blob.sl = this.$tl_sx));
            else {
              t.blob.uf = !1;
              for (var i = 0; i < h.SIDES.length; ++i) {
                var n = h.SIDES[i],
                  r = h.getGeometryPropertiesSidePrefix(n);
                ((t.blob[r + "uf"] = this["$" + r + "_uf"]),
                  (t.blob[r + "ct"] = this["$" + r + "_ct"]),
                  (t.blob[r + "sl"] = [
                    this["$" + r + "_sx"],
                    this["$" + r + "_sy"],
                  ]));
            ...
            if (!0 !== t.blob.uf && !1 !== t.blob.uf)
              ...
              for (i = 0; i < h.SIDES.length; ++i) {
                n = h.SIDES[i];
                ((this[
                  "$" + (r = h.getGeometryPropertiesSidePrefix(n)) + "_uf"
                ] = t.blob.uf ? t.blob.uf : t.blob[r + "uf"]),
                  (this["$" + r + "_ct"] = t.blob.uf
                    ? t.blob.ct
                    : t.blob[r + "ct"]),
                  (this["$" + r + "_sx"] = t.blob.uf
                    ? t.blob.sl
                    : t.blob[r + "sl"][0]),
                  (this["$" + r + "_sy"] = t.blob.uf
                    ? t.blob.sl
                    : t.blob[r + "sl"][1]));
              }
            }
        ...
        (h.prototype.assignFrom = function (e) {
          (e instanceof h && this.transferProperties(e, [h.GeometryProperties]),
        ...
        (h.prototype._transformStyledCorners = function (e, t) {
          ...
          if (!s.isEqualEps(i, 1) || !s.isEqualEps(n, 1)) {
            for (var a = [], l = [], A = 0; A < h.SIDES.length; ++A) {
              var c = h.SIDES[A],
                p = h.getGeometryPropertiesSidePrefix(c),
                u = p + "_sx";
              (a.push(u),
                l.push(this.getProperty(u) * i),
                (u = p + "_sy"),
                a.push(u),
                l.push(this.getProperty(u) * n));
            }
            e.setProperties(a, l);
          }
        }),
