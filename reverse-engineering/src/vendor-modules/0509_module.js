...
function (e, t) {
      ...
      ((i.create = o),
        ...
        (i.prototype.into = function (e, t) {
          if (!Array.isArray(e)) throw new Error("into expects an array");
          return (
            (t = (function (e) {
        ...
        (i.prototype.monitor = function (e) {
          var t = 0,
            ...
            o = e.limit;
          return (
            "number" != typeof o && (o = Number.MAX_VALUE),
            o < 1
              ? this
        ...
        (i.prototype.first = function () {
          ...
          return (this.monitor(e).submit(), e.count > 0 ? e.first : void 0);
        }),
        (i.prototype.last = function () {
          var e = {};
          return (this.monitor(e).submit(), e.count > 0 ? e.last : void 0);
        }),
