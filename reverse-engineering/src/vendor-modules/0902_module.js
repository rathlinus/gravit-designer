...
function (e, t, i) {
      ...
      e.exports = function (e) {
        ((e.BorderPaintLayer = function (t, i, n, r) {
          ...
          r.inheritAndMix("borderPaintLayer", e.BorderPaintLayer, e.PaintLayer),
          (e.BorderPaintLayer.VisualProperties = {
            _bds: null,
          }),
          (e.BorderPaintLayer.MetaProperties = {
          ...
          (e.BorderPaintLayer.prototype.assignFrom = function (t) {
            (t instanceof e.BorderPaintLayer &&
          ...
          (e.BorderPaintLayer.prototype._handleChange = function (t, i) {
            if (t == r._Change.Restore) {
              ...
              ("_bmo" in i.blob &&
                ((i.blob._btmo = i.blob._bmo), (i.blob._bhmo = i.blob._bmo)),
                "_bmi" in i.blob &&
                  ((i.blob._btmi = i.blob._bmi ? 1 : 0),
                  (i.blob._bhmi = i.blob._bmi ? 1 : 0)),
                "_btmi" in i.blob &&
                  "boolean" == typeof i.blob._btmi &&
                  (i.blob._btmi = i.blob._btmi ? 1 : 0),
                "_bhmi" in i.blob &&
                  "boolean" == typeof i.blob._bhmi &&
                  (i.blob._bhmi = i.blob._bhmi ? 1 : 0),
              ...
              (this.storeProperties(
                ...
                this.storeProperties(i.blob, e.BorderPaintLayer.MetaProperties),
                this.storeProperties(
                  i.blob,
                  e.BorderPaintLayer.GeometryProperties,
                  function (e, t) {
                    return ("_bhm" === e || "_btm" === e) && t && t instanceof n
                      ? n.serialize(t)
                      : t;
                  },
                ));
              ...
              if ((u = this.getScene())) {
                ...
                this.$_pt &&
                  this.$_pt.hasMixin(a) &&
                  u.addDestroyableIfAbsent(this.$_pt);
              }
            } else if (t === r._Change.WorkspaceAttached) {
              (u = this.getScene()) &&
                this.$_pt &&
                this.$_pt.hasMixin(a) &&
                u.addDestroyable(this.$_pt);
