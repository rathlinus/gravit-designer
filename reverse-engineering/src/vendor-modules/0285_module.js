...
function (e, t, i) {
      ...
      (n.inheritAndMix("anc", A, r, [o]),
        ...
        (A.prototype.hitTest = function (e, t, i, n, r, o, a, s, l, h) {
          ...
          if (
            (t && (A = t.mapRect(A)), !A.expanded(o, o, o, o).containsPoint(e))
          )
            return null;
          var c = null;
          if ((i && 1 == i(this)) || !i) {
        ...
        (A.prototype._handleChange = function (e, t) {
          if (e === n._Change.Store) {
            ...
            if (this.recordedTransaction || t.options.recordedTransaction) {
              for (
                var a = Object.keys(o.MetaProperties),
        ...
        (A.prototype.initDefaultForLimitedRestore = function () {
          ...
          (e.getPaintLayers().appendChild(t),
            ...
            e.getAnchorPoints().deserialize([
              ["AABAQQAAgEA=", "#", "0PjaYCOSKsZ9lCT9XOAgGmMJ8veAWfQo"],
              [
                "AACAQAAAgEA=",
                "#",
              ...
              ["AABAQAAAoEA=", "#", "YYq8Hz0AMzof2UImOgNuY1Zr7vM46gey"],
              [
                "AABAQAAAIEE=",
                "#",
              ...
              ["AACAQAAAMEE=", "#", "bf2r8e2nsAKfH7wxLed5xFtDlZIMhV7p"],
              ["AACgQAAAMEE=", "#", "IxkJ1dZbYiQcHYajF0yD4PXFKYDoahXW"],
              ["AACgQAAAUEE=", "#", "cVEjEe2LXioWCTVXNZDoEJh02KKpyRza"],
              ["EFj1QAAAMEE=", "#", "lClGLXYj5pesu92S34xzXcOzTgtCoPKn"],
              [
                "AABAQQAAMEE=",
                "#",
              ...
              ["AABQQQAAIEE=", "#", "XHM0QcKkXpyGPMNBv4sTsdCtaILW36OK"],
              [
                "AABQQQAAoEA=",
                "#",
        ...
        (A.prototype.initSizeAndPosition = function () {
          var e = new h(
            ...
            t = this.getProperty("trf");
          t && t.invertible()
            ? this.transform(t.invert().multiplied(e))
            : t || this.transform(e);
        }),
