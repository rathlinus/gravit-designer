      ...
      (a.inheritAndMix(y, o, [m]),
        (y.prototype.activate = function (e, t) {
          (o.prototype.activate.call(this, e, t),
            t ||
              ...
              e.addEventListener(l.Move, this._mouseMove, this)));
        }),
        (y.prototype.deactivate = function (e, t) {
          (this._checkMode(),
            ...
            e.removeEventListener(l.DragEnd, this._mouseDragEnd, this));
        }),
        ...
        (y.prototype._mouseDown = function (e) {
          ...
          if (t - this._mDownTime < o.DBLCLICKTM)
            "edit" == A.selectDoubleClickBehavior
            ...
            if (
              ...
              if (this._mode != o.Mode.Edit)
                if (
                  (this._renewPreviewLink(), this._newPoint && this._pathEditor)
                ) {
                  if (
                    (this._updatePoint(e.client), this._mode == o.Mode.Append)
                  ) {
                    var a = this._editPt.getPrevious();
                    a &&
                      (a.removeFlag(r.Flag.Selected),
                      this._editPt.setFlag(r.Flag.Selected));
                  } else {
                    var s = this._editPt.getNext();
                    s &&
                      (s.removeFlag(r.Flag.Selected),
                      this._editPt.setFlag(r.Flag.Selected));
                  }
                  ...
                  (this._editor
                    ...
                    (h = this._editor
                      .getGuides()
                      .mapPoint(h, n.DetailMap.Mode.DetailOnFilterOn)),
                    this._editor.getGuides().finishMap(),
                    (i = this._constructNewPoint(e, h)),
                    e.button == l.BUTTON_RIGHT &&
                      (d.modifiers.optionKey
          ...
          if (
            ...
            this._mode == o.Mode.Append
              ...
              : ((e = this._dpathRef.getAnchorPoints().getFirstChild()),
                (i = this._pathRef.getAnchorPoints().getFirstChild()),
                (t = this._dpathRef.getAnchorPoints().getLastChild()));
            var n = new h(e.getProperty("x"), e.getProperty("y")),
              a = this._pathRef.getTransform();
            if (
              ((n = a ? a.mapPoint(n) : n),
              t &&
              ...
              (i.setProperty("ah", !1),
                i.setProperties(["hrx", "hry"], [null, null]),
                (this._newPoint = !1));
            else if (
              i &&
              ...
              (i.setProperty("ah", !1),
                i.setProperties(["hlx", "hly"], [null, null]),
                (this._newPoint = !1));
            else {
        ...
        (y.prototype._mouseMove = function (e) {
          if (!(new Date().getTime() - this._mDownTime < o.DBLCLICKTM))
            if (
              ...
              if (this._released)
                if (
                  (this.isPanning()
                    ? this.panView(
                        e.client,
                        new h(A.autoPanStep, A.autoPanStep),
                        new h(40, 40),
                      )
                    : this.beginPan(),
                  (this._lastMouseEvent = e),
                  ...
                  if (
                    ...
                    d.modifiers.shiftKey && this._highlightMiddle(e.client),
                    this._cursor == s.PenStart)
                  ) {
                    var i = this._view
                      .getViewTransform(this._view.getScene().getActivePage())
                      .mapPoint(e.client);
                  ...
                  if (this._editPt) {
                    ...
                    (this._mode == o.Mode.Append
                      ...
                      this._pathEditor.hitAnchorPoint(
                        ...
                        ? this._setCursorForPosition(s.PenEnd)
                        : this._pathEditor.hitAnchorPoint(
                              c,
                              r,
                              this._view.getWorldTransform(
                          ...
                          ? this._setCursorForPosition(s.PenModify)
                          : this._hitSideConnectPoints(
                                this._view.getViewTransform().mapPoint(r),
                              )
                            ? this._setCursorForPosition(s.PenEnd)
                            : this._setCursorForPosition(s.Pen));
                  } else {
                    i = this._view
                      .getViewTransform(this._view.getScene().getActivePage())
                      .mapPoint(r);
              ...
              else e.button == l.BUTTON_RIGHT && this._mouseDrag(e);
            }
        }),
        (y.prototype._updateHandles = function (e) {
          var t,
            ...
            n,
            r,
            a = this._editPt.getProperty("tp"),
            s = this._editPt.getProperty("x"),
            l = this._editPt.getProperty("y");
          if (
            this._pathEditor.hitAnchorPoint(
              this._editPt,
              e,
            ...
            this._mode != o.Mode.Edit
              ? this._mode == o.Mode.Append
                ? null !== this._editPt.getProperty("hlx") &&
                  ...
                  ? this._editPt.setProperties(
                      ["tp", "hrx", "hry"],
                      [u.AnchorPoint.Type.Symmetric, null, null],
                    )
                  : this._editPt.setProperties(
                      ["tp", "hrx", "hry"],
                      [u.AnchorPoint.Type.Asymmetric, null, null],
                    )
                : null !== this._editPt.getProperty("hrx") &&
                    null !== this._editPt.getProperty("hry")
                  ? this._editPt.setProperties(
                      ["tp", "hlx", "hly"],
                      [u.AnchorPoint.Type.Symmetric, null, null],
                    )
              ...
              : d.modifiers.optionKey
                ...
                : this._editPt.setProperties(
                    ["tp", "hlx", "hly", "hrx", "hry"],
                    [u.AnchorPoint.Type.Asymmetric, null, null, null, null],
                  );
          else {
            var h = this._pathEditor
            ...
            if (
              ...
              !d.modifiers.optionKey ||
              !this._firstAlt ||
              a == u.AnchorPoint.Type.Connector ||
              ...
              if (a != u.AnchorPoint.Type.Connector) {
                ...
                if (d.modifiers.optionKey)
                  this._mode == o.Mode.Prepend
                    ? this._editPt.setProperties(
                        ["tp", "hlx", "hly"],
                        [u.AnchorPoint.Type.Asymmetric, A, c],
                      )
                    : this._editPt.setProperties(
                        ["tp", "hrx", "hry"],
                        [u.AnchorPoint.Type.Asymmetric, A, c],
                  ...
                  var g = u.AnchorPoint.Type.Symmetric,
                    f =
                      (null == this._editPt.getPrevious() &&
                        null != this._editPt.getNext()) ||
                      (null != this._editPt.getPrevious() &&
                ...
                this._mode == o.Mode.Append ||
                (this._mode == o.Mode.Edit && d.modifiers.optionKey)
              ) {
                ((t = null), (i = null));
                var v = this._editPt.getPrevious();
                if (v) {
                  var b = v.getProperty("x"),
                    C = v.getProperty("y"),
                    w = Math.sqrt(p.ptSqrDist(s, l, b, C));
                  if (p.isEqualEps(w, 0)) ((n = h.getX()), (r = h.getY()));
                  else {
                    var E = (s - b) / w,
                      B = (l - C) / w;
                    (T = p.vDotProduct(E, B, h.getX() - s, h.getY() - l)) > 0
                      ? ((n = s + E * T), (r = l + B * T))
                      : ((n = null), (r = null));
                  }
                ...
                if (x) {
                  var P = x.getProperty("x"),
                    S = x.getProperty("y");
                  w = Math.sqrt(p.ptSqrDist(s, l, P, S));
                  if (p.isEqualEps(w, 0)) ((t = h.getX()), (i = h.getY()));
                  else {
                    var T;
                    ((E = (s - P) / w), (B = (l - S) / w));
                    (T = p.vDotProduct(E, B, h.getX() - s, h.getY() - l)) > 0
              ...
              ((r = null != D ? D + F : h.getY()),
                ...
                this._editPt.setProperties(
                  ["tp", "hrx", "hry"],
                  [u.AnchorPoint.Type.Asymmetric, n, r],
                ));
            }
          }
          this._pathEditor.requestInvalidation();
        ...
        (y.prototype._mouseDrag = function (e) {
          (this.isPanning() && this.panView(e.client, e.clientDelta),
            ...
            !this._released &&
              this._editPt &&
              ((this._lastMouseEvent = e),
              this._setCursorForPosition(s.PenDrag),
              this._dragStartPt ||
          ...
          if (!this._released)
            try {
              if (
                    ...
                    ? (this._updatePointProperties(e.client),
                      this._transactionType == o.Transaction.NoTransaction &&
                        this._startTransaction(
                          o.Transaction.ModifyPointProperties,
                        ),
                ...
                if (
                  (this._dragStarted &&
                    (i = this._updatePointProperties(e.client)),
                  this._dpathRef.getProperty("closed"))
                )
                  (this._refPt &&
                    ...
                    g.each(
                      this._pathRef.getPaintLayers().getFillLayers(),
                      function (e, t) {
                        t.setProperty("_vs", !0);
                      },
                    ),
