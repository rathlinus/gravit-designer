      ...
      (n.inheritAndMix(m, r, [r.Map]),
        ...
        (m.prototype.map = function (e, t, i, n, r, s) {
          var l,
            ...
            y = null,
            _ = null,
            v = i ? m.GUIDE_MARGIN : 0,
            b = ((n = r ? n / r : n), null),
            C = null,
            w = null,
            E = this._scene.getActivePage(),
            B = new o(e, t),
            x = B;
          this._guides.isMultiPageEnabled()
            ? (E &&
                ((A = E.getPosition(!0)),
                s ? (B = B.subtract(A)) : (x = B.add(A))),
                ...
                function (e) {
                  ...
                  return t
                    ? (t = t.translated(i.getX(), i.getY())).containsPoint(x)
                      ? ((b = e),
                        (C = A ? t.translated(-A.getX(), -A.getY()) : t),
                        (w = i),
                        !1)
                      : void 0
                    : ((b = e), (C = null), (w = i), !1);
          ...
          var P = function (e) {
            if (this._exclusions && this._exclusions.length)
              for (var t = 0; t < this._exclusions.length; ++t)
                if (this._exclusions[t] == e) return;
            var i = e.getGeometryBBox();
            if (i && !i.isEmpty()) {
              var r = i.getSide(a.Side.TOP_LEFT).add(w),
                s = i.getSide(a.Side.BOTTOM_RIGHT).add(w),
                m = i.getSide(a.Side.CENTER).add(w);
              A &&
                ((r = r.subtract(A)), (s = s.subtract(A)), (m = m.subtract(A)));
              var _ = [r, s, m],
                b = !1;
              for (t = 0; t < _.length && !b; ++t)
                (C && !C.containsPoint(_[t], !0)) || (b = !0);
              if (!b) return;
              for (t = 0; t < _.length; ++t) {
                ...
                ((!C ||
                  ...
                  ((l = Math.abs(B.getX() - E.getX())),
                  (null === p && l <= n) ||
                  (null !== p && l < Math.abs(B.getX() - p))
                    ? ((p = E.getX()),
                      (f = l),
                      (d = {
                        bounds: [[r.getY(), s.getY()]],
                    ...
                    : null !== p &&
                      c.isEqualEps(l, Math.abs(B.getX() - p)) &&
                      ((p = E.getX()),
                      (f = l),
                      d.bounds.push([r.getY(), s.getY()]),
                      B.getY() <= r.getY()
                        ? d.line[1].getY() < s.getY() + v &&
                          (d.line[1] = new o(p, s.getY() + v))
                        : r.getY() < B.getY() && B.getY() < s.getY()
                          ? (d.line[1].getY() < s.getY() + v &&
                              (d.line[1] = new o(p, s.getY() + v)),
                            d.line[0].getY() > r.getY() - v &&
                              (d.line[0] = new o(p, r.getY() - v)))
                          : d.line[0].getY() > r.getY() - v &&
                            (d.line[0] = new o(p, r.getY() - v)))),
                  (!C ||
                    (C.getY() <= E.getY() &&
                      C.getY() + C.getHeight() >= E.getY())) &&
                    ((l = Math.abs(B.getY() - E.getY())),
                    (null === u && l <= n) ||
                    (null !== u && l < Math.abs(B.getY() - u))
                      ? ((u = E.getY()),
                        (y = l),
                        (g = {
                          bounds: [[r.getX(), s.getX()]],
                      ...
                      : null !== u &&
                        c.isEqualEps(l, Math.abs(B.getY() - u)) &&
                        ((u = E.getY()),
                        (y = l),
                        g.bounds.push([r.getX(), s.getX()]),
                        B.getX() <= r.getX()
                          ? g.line[1].getX() < s.getX() + v &&
                            (g.line[1] = new o(s.getX() + v, u))
                          : r.getX() < B.getX() && B.getX() < s.getX()
                            ? (g.line[1].getX() < s.getX() + v &&
                                (g.line[1] = new o(s.getX() + v, u)),
                              g.line[0].getX() > r.getX() - v &&
                                (g.line[0] = new o(r.getX() - v, u)))
                            : g.line[0].getX() > r.getX() - v &&
                              (g.line[0] = new o(r.getX() - v, u)))));
              }
            }
          ...
          if (b) {
            this._scoped &&
              b != this._snapMainPage &&
              this._setEffectiveScope(b);
            var S = B.subtract(w);
        ...
        (m.prototype.useExclusions = function (e) {
          if (e && e.length) {
            ...
            for (var i = 0; i < e.length; ++i)
              ((t = e[i]) instanceof s || t instanceof d) &&
        ...
        (m.prototype.checkDistanceGuidesMapping = function (
          e,
          t,
          i,
          n,
          ...
          var b = function (e, i, n) {
            if (this._exclusions && this._exclusions.length)
              for (var r = 0; r < this._exclusions.length; ++r)
                if (this._exclusions[r] == e) return;
          ...
          (this._scoped &&
            m != this._snapMainPage &&
            this._setEffectiveScope(m),
            this._applySnappingToPivots(g, t, m, b));
          var C = function (e) {
              for (
                var t, i = !1, n = [], r = [], o = null, a = 0;
                a < e.length && !i;
                ++a
              ) {
                ((t = e[a]),
            ...
            w = function (e, i) {
              ...
              for (var h = null, A = 0; A < o.length; ++A) {
                ...
                if (
                  (i
                    ? ((n = f.getXYOffset(c, !1, !0).y),
                      (r = f.getXYOffset(p, !1, !0).y))
                    : ((n = f.getXYOffset(c, !0, !1).x),
                      (r = f.getXYOffset(p, !0, !1).x)),
                  n && r)
                ) {
                  ...
                  if (u <= t && (!h || u < h.absDelta))
                    h = {
                      absDelta: u,
                      delta:
                        (Math.abs(o[A].offsJfromI) >= Math.abs(n) && n > 0) ||
                        (Math.abs(o[A].offsJfromI) < Math.abs(n) && n < 0)
                          ? -u
                          : u,
                      bbox1: c,
                  ...
                  if (
                    (u = Math.abs(Math.abs(r) - Math.abs(o[A].offsJfromI))) <=
                      t &&
                    (!h || u < h.absDelta)
                  )
                    h = {
                      absDelta: u,
                      delta:
                        (Math.abs(o[A].offsJfromI) >= Math.abs(r) && r > 0) ||
                        (Math.abs(o[A].offsJfromI) < Math.abs(r) && r < 0)
                          ? -u
                          : u,
                      bbox1: c,
                  ...
                  if (
                    (u = Math.abs(Math.abs(n) - Math.abs(r)) / 2) <= t &&
                    (!h || u < h.absDelta)
                  )
                    h = {
                      absDelta: u,
                      delta:
                        (Math.abs(n) >= Math.abs(r) && n < 0 && r > 0) ||
                        (Math.abs(n) <= Math.abs(r) && n > 0 && r < 0)
                          ? -u
                          : u,
                      bbox1: c,
          ...
          if (u || d)
            if (
              u &&
              (!d ||
                u.absDeltaX < d.absDeltaY ||
                (u.absDeltaX == d.absDeltaY && u.absDeltaY <= d.absDeltaX))
            ) {
              ...
              if (
                ((r[0] = u.deltaX),
                (r[1] = u.deltaY),
                (p = this.getDistGuides(u.bbox1, u.bbox2, D, !0)))
              )
              ...
              if (
                ((r[0] = d.deltaX),
                (r[1] = d.deltaY),
                (p = this.getDistGuides(d.bbox1, d.bbox2, D, !1)))
              )
                for (v = 0; v < p.length; ++v)
                  s.push({
                    guide: p[v],
        ...
        (m.prototype.getDistGuides = function (e, t, i, n) {
          var r,
            ...
            u = [];
          n
            ? ((o = (r = e.getY()) + e.getHeight()),
              (l = (s = t.getY()) + t.getHeight()),
              (p = i.getY()),
              i.getHeight())
            : ((o = (r = e.getX()) + e.getWidth()),
              (l = (s = t.getX()) + t.getWidth()),
              (p = i.getX()),
              i.getWidth());
          var d = [];
          o < s && o < p
            ? (d.push(e),
              l < p ? (d.push(t), d.push(i)) : (d.push(i), d.push(t)))
            : l < r && l < p
              ? (d.push(t),
                o < p ? (d.push(e), d.push(i)) : (d.push(i), d.push(e)))
              : (d.push(i),
                o < s ? (d.push(e), d.push(t)) : (d.push(t), d.push(e)));
          for (var g = 0; g < d.length - 1; ++g) {
            var f = d[g],
              ...
              _ = [];
            n
              ? (y.push(f.getSide(a.Side.BOTTOM_LEFT)),
                y.push(f.getSide(a.Side.BOTTOM_CENTER)),
                y.push(f.getSide(a.Side.BOTTOM_RIGHT)),
                _.push(m.getSide(a.Side.TOP_LEFT)),
                _.push(m.getSide(a.Side.TOP_CENTER)),
                _.push(m.getSide(a.Side.TOP_RIGHT)))
              : (y.push(f.getSide(a.Side.TOP_RIGHT)),
                y.push(f.getSide(a.Side.RIGHT_CENTER)),
                y.push(f.getSide(a.Side.BOTTOM_RIGHT)),
                _.push(m.getSide(a.Side.TOP_LEFT)),
            ...
            for (var v = !0, b = 0; b < y.length; ++b)
              for (var C = y[b], w = 0; w < _.length; ++w) {
                var E = _[w];
                if (
                  (n && c.isEqualEps(C.getX(), E.getX())) ||
                  (!n && c.isEqualEps(C.getY(), E.getY()))
                ) {
                  var B = {
                    line: [C, E],
                  };
                  (v
                    ? (n
                        ? ((B.orient = h.Orientation.V),
                          (B.valueSegments = [
                            {
                              bounds: [C.getY(), E.getY()],
                            },
                          ]))
                        : ((B.orient = h.Orientation.H),
                          (B.valueSegments = [
                            {
                    ...
                    : ((B.freeSegments = B.freeSegments ? B.freeSegments : []),
                      ...
                      n
                        ? ((B.orient = h.Orientation.V),
                          B.freeSegments.push([C.getY(), E.getY()]))
                        : ((B.orient = h.Orientation.H),
                          B.freeSegments.push([C.getX(), E.getX()]))),
                    u.push(B));
                }
              }
          }
        ...
        (m.prototype.setScope = function (e) {
          if (e && e.length) {
            this._snapElems = [];
            for (
              var t = null, i = !1, n = this._scene.getActivePage(), r = 0;
              r < e.length;
              ++r
            ) {
              var o = e[r];
