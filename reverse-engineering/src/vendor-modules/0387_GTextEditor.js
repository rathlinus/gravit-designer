...
function (e, t, i) {
      ...
      (a.inherit(k, u),
          ...
          if (t === d.DropType.FontFamily) {
            ...
            if (o) {
              ...
              try {
                ...
                o.commitTransaction(
                  F.get(new R("GTextEditor", "action.drop-font")),
                );
              }
            }
            return !0;
            ...
            if (i && !r && s) {
              ...
              ("fontWeight" === s
                ? ((l = this.getProperty("_tfs")),
                  (c =
                    (A = h =
                      parseInt(p) == S.Weight.Bold
                        ? S.Weight.Regular
                        : S.Weight.Bold) === S.Weight.Normal ||
                    void 0 === g ||
                    g.filter(function (e) {
                    ...
                    a.commitTransaction(
                      F.get(
                        new R("GTextEditor", "action.modify-text-properties"),
                      ),
                    )))
                : "fontStyle" === s &&
                  ...
                  (c =
                    (A = l =
                      "italic" == p ? S.Style.Normal : S.Style.Italic) ===
                      S.Style.Normal ||
                    void 0 === g ||
                    g.filter(function (e) {
                      return e.style === l && e.weight === h;
                  ...
                  if (
                    ...
                    try {
                      ...
                      (!e &&
                        o &&
                        o.commitTransaction(
                          F.get(new R("GTextEditor", "action.edit-text")),
                        ),
                        o &&
                          this.isInlineEdit() &&
                          setTimeout(
          ...
          if (this._element.hasPathAttached()) {
            ...
            if (
              E.getAnnotationBBox(
                null,
                n,
                m.annotationHandles.textOnPath.size,
                !1,
              )
                .expanded(
                  m.annotPickDistance,
          ...
          if (!this._elementPreview && !this.getElement().hasPathAttached()) {
            ...
            e &&
              (this._setElementPreview(
                new C(e.getX(), e.getY(), e.getWidth(), e.getHeight()),
              ),
        ...
        (k.prototype.canApplyTransform = function () {
          ...
          return (
            this._elementPreview || u.prototype.canApplyTransform.call(this)
          );
        }),
        (k.prototype._applyTransform = function (e, t, i, n) {
          ((this._fullContentsTransform = e.getProperty("sc")),
            u.prototype._applyTransform.call(
              this,
              e.hasPathAttached() ? e._attachedPath : e,
              t,
              i,
              n,
            ));
        ...
        (k.prototype.resetTransform = function () {
          ((this._fullContentsTransform = !1),
            u.prototype.resetTransform.call(this));
        }),
        (k.prototype.edTransform = function (e, t, i, n) {
          ((this._fullContentsTransform =
            (n && !!n.fullContentsTransform) ||
            this.getElement().getProperty("sc")),
            y.prototype.edTransform.call(this, e, t, i, n));
        }),
        (k.prototype.getPEGeometryBBox = function () {
          var e = null;
          if (
            this.hasFlag(w.Flag.Selected) ||
            this.hasFlag(w.Flag.Highlighted) ||
            this.hasFlag(w.Flag.Outline)
          ) {
            var t = this.getElement();
            e = t.getSourceBBox();
            ...
            (this._preTransform && (n = this._preTransform),
              ...
              this._transform &&
                (n = n ? n.multiplied(this._transform) : this._transform),
              e && n && (e = n.mapRect(e)));
          }
          return e;
        }),
              ...
              if (
                ...
                (this._element.beginUpdate(),
                  ...
                  void 0 !== o
                    ...
                    : void 0 !== a &&
                      this._element.setProperties(["content"], [a]),
                  this._preTransform &&
                    !this._preTransform.isIdentity() &&
                    B.Transform.prototype.preTransform.call(
                      this._element,
                      this._preTransform,
                      !1,
                      n,
                ...
                (this._element &&
                  ...
                  u.prototype._applyTransform.call(
                    this,
                    this._element,
                    e === y.ROTATION_HANDLE_PART_ID,
                    n,
                    i,
                  ));
            } else this.resetTransform();
          else
            e === k.DISTANCE_HANDLER_ID &&
              (this._element.setProperty("tpthl", this._element.$tpthl),
            ...
            (e instanceof g
              ...
              : (e instanceof String || "string" == typeof e) &&
                (D.OperatingSystem.Windows &&
                  (e = h.replaceMicrosoftLineFeed(e)),
                (t = e)),
            !t)
          )
            return !1;
        ...
        (k.prototype.handleKeyDown = function (e) {
          return (
            !!this.isInlineEdit() && this._inlineEditor.handleDomKeyDown(e)
          );
        }),
        ...
        (k.prototype.getBBox = function (e) {
          if (
            ...
            (this.hasFlag(w.Flag.Selected) || this.hasFlag(w.Flag.Highlighted))
          ) {
            var t = e;
        ...
        (k.prototype.getBBoxMargin = function () {
          ...
          if (this.getElement().hasPathAttached()) {
            var t = this.isInlineEdit() && this._inlineEditor.getCaretBox(),
              i = this.hasFlag(w.Flag.Selected)
                ? E.getAnnotationPaintMargin(
                    m.annotationHandles.textOnPath.size,
                  )
                : 0;
            return (
              t && (i = Math.max(t.box.getWidth(), t.box.getHeight())),
              Math.max(i, e)
            );
          }
          return e;
          ...
          this._iterateResizeHandles(
            function (n, r, o) {
              ...
              (m.annotationHandles.text.showAutoSize &&
                ((r === _.Side.RIGHT_CENTER &&
                  this._element.getProperty("aw")) ||
                  (r === _.Side.BOTTOM_CENTER &&
                    this._element.getProperty("ah"))) &&
                (a = !a),
                r === _.Side.BOTTOM_RIGHT && this._element.getProperty("sc")
                  ? E.paintAnnotation(
                      ...
                      a,
                      i.size,
                      m.annotationHandles.text.blResizeColor,
                      s.WHITE,
                    )
                  : E.paintAnnotation(
                      t,
        ...
        (k.prototype._showResizeHandles = function () {
          return (
            !this.getElement().hasPathAttached() &&
            u.prototype._showResizeHandles.call(this)
          );
        }),
        (k.prototype._drawBBox = function (e, t, i, n, r, o, a) {
          ...
          (s &&
            ...
            (p = s.map(function (e) {
              return new f(
                Math.floor(e.getX()) + 0.5,
                Math.floor(e.getY()) + 0.5,
              );
            })),
            p &&
              (e.canvas.putVertices(p, !0),
              2 == p.length
                ? e.canvas.strokeVertices(
                    n,
                    Math.sqrt(h.getScaleFactor()) || 1,
                    null,
                    null,
                    null,
                    null,
            ...
            if (r) {
              for (
                var o = r.mapQuadrilateral(n),
                  a = (p = b.getTurnAngle(o[0], o[1], o[1], o[2]) <= 0)
                    ? [o[0], o[1]]
                    : [o[1], o[0]],
                  s = p ? [o[3], o[2]] : [o[2], o[3]],
                  l = null,
                ...
                if ((r = e[h].transform)) {
                  ...
                  c
                    ? (a.pop(), p ? a.push(c, l[1]) : a.push(c, l[0]))
                    : p
                      ? a.push(l[0], l[1])
                      : a.push(l[1], l[0]);
                  var u = null,
        ...
        (k.prototype._paintOutline = function (e, t, i, n, r) {
          if (!this.getElement().hasPathAttached()) {
            ...
            (this.isInlineEdit() &&
              (o =
                !this.getElement().getProperty("ah") ||
                !this.getElement().getProperty("aw")),
          ...
          if (
            ...
            this.isInlineEdit() &&
              ((a = this._inlineEditor.getCaretBox()),
              (h = this._inlineEditor.getSelectionBoxes())),
            a)
          ) {
            for (
              var u = this.getElement(),
                ...
                f =
                  (g && g.getProperty("GGLBrightnessContrastEffect&shp")) ||
                  null,
            ...
            (m &&
              ((hsv = l.rgbToHSV(s.parseCSSColor(S))),
              (hsv[2] += m),
              (S = l.rgbToHtmlHex(l.hsvToRGB(hsv)))),
        ...
        (k.prototype._paintResizeBoxOutline = function (e, t, i, n, r) {
          if (!this._fullContentsTransform && this._transform) {
            ...
            o.bbox &&
              this._paintTransformedQuadrilateral(o.trf, o.bbox, t, n, r);
        ...
        (k.prototype._triggerSelectionChanged = function () {
          ...
          e &&
            ...
            e.trigger(
              new n.InlineEditorEvent(
                this,
                n.InlineEditorEvent.Type.SelectionChanged,
              ),
            );
        }),
        (k.prototype._triggerTextEdited = function (e) {
          ...
          t &&
            ...
            t.trigger(
              new n.InlineEditorEvent(
                this,
                n.InlineEditorEvent.Type.TextEdited,
                e,
              ),
            );
        }),
