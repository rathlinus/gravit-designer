...
function (e, t, i) {
      ...
      function a(e, t) {
        ...
        if (n > 0) return t > (i = e[n - 1]).end ? 0 : i;
      }
      ...
      ((s.prototype = {
        ...
        getFeatureTable: function (e, t, i, r) {
          ...
          if (o) {
            for (
              var a,
                s = o.featureIndexes,
                l = this.font.tables[this.tableName].features,
                h = 0;
              h < s.length;
              h++
            )
              if ((a = l[s[h]]).tag === i) return a.feature;
            if (r) {
              var A = l.length;
              return (
                n.assert(
        ...
        getLookupTables: function (e, t, i, n, r) {
          var o = this.getFeatureTable(e, t, i, r),
            a = [];
          if (o) {
            for (
              var s,
                l = o.lookupListIndexes,
                h = this.font.tables[this.tableName].lookups,
                A = 0;
              A < l.length;
              A++
            )
