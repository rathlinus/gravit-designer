      ...
      e.exports = function (e) {
        ((e.Transform = function () {}),
          ...
          (e.Transform.prototype.setBounds = function (t, i, n, o) {
            var a =
                n > e.Transform.MinimalDimention
                  ? n
                  : e.Transform.MinimalDimention,
              s =
                o > e.Transform.MinimalDimention
                  ? o
                  : e.Transform.MinimalDimention,
          ...
          (e.Transform.prototype.preTransform = function (e, t, i) {
            if (this.isTransformChildren(e, t)) {
              var n = this.getProperty("trf"),
                r =
                  n && n.invertible()
                    ? n.inverted().multiplied(e).multiplied(n)
                    : e;
          ...
          (e.Transform.prototype.isTransformChildren = function (e, t) {
            ...
            return (
              t ||
              n ||
              ((void 0 === n || null == n) && this.getProperty("scc", !1, !0))
            );
          }),
