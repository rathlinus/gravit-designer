...
function (e, t, i) {
      ...
      e.exports = function (e) {
        ((e.FillPaintLayer = function (t, i, n, r) {
          ...
          n.inheritAndMix("fillPaintLayer", e.FillPaintLayer, e.PaintLayer),
          (e.FillPaintLayer.prototype._handleChange = function (t, i) {
            if (t == n._Change.Restore) {
              var a = {};
              ((a.blob = r.extend({}, i.blob)), (i = a));
              for (
                var s = ["_fpt", "_fvs", "_fop", "_fpx"], l = 0;
                l < s.length;
                l++
              ) {
                var h = s[l],
              ...
              if ((p = this.getScene())) {
                ...
                this.$_pt &&
                  this.$_pt.hasMixin(o) &&
                  p.addDestroyableIfAbsent(this.$_pt);
              }
            } else if (t === n._Change.WorkspaceAttached) {
              (p = this.getScene()) &&
                this.$_pt &&
                this.$_pt.hasMixin(o) &&
                p.addDestroyable(this.$_pt);
