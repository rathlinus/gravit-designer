...
function (e, t, i) {
      ...
      function c(e, t) {
        ...
        ("number" == typeof e
          ...
          : e instanceof Image || e instanceof HTMLImageElement
            ? ((i = e.naturalWidth), (r = e.naturalHeight), (a = e))
            : !(e instanceof c) &&
                e._canvasContext instanceof CanvasRenderingContext2D
              ? (o = e._canvasContext.canvas)
              : e instanceof c ||
                  !(
                    e._canvasContext instanceof l ||
                    e._canvasContext instanceof h
                  )
          ...
          o
            ? (this._canvas = o)
            : ((this._canvas = A.getRenderer().canvas),
      ...
      ((c.ImageType = {
        ...
        (c.prototype._offset = null),
        (c.prototype._dpi = o.DPI),
        (c.prototype._canvas = null),
        (c.prototype._canvasContext = null),
        (c.prototype.setDPI = function (e) {
          this._dpi = e || o.DPI;
        }),
        ...
        (c.prototype.getHTMLElement = function (e) {
          return e &&
            (this._canvas instanceof l.RendererCanvas ||
              this._canvas instanceof h.RendererCanvas)
            ? this._canvas.$realCanvas
            : this._canvas;
        }),
        (c.prototype.toImageDataUrl = function (e, t) {
          ...
          return (
            t && (i = i.concat(t)),
            this._canvas.toDataURL.apply(this._canvas, i)
          );
        }),
        (c.prototype.toImageBlob = function (e, t, i, n) {
          ...
          -1 === r.indexOf(e) &&
            (/jpeg/i.test(e) || /jpg/i.test(e)
              ? (e = c.ImageType.JPEG)
              : /png/i.test(e) && (e = c.ImageType.PNG));
          var l = [t, e];
          if ((i && (l = l.concat(i)), !this._canvas)) return null;
          if ("function" == typeof this._canvas.toBlob) {
            ...
            return (
              i && (h = h.concat(i)),
              this._canvas.toBlob.apply(this._canvas, h)
            );
          }
          return null;
        }),
        (c.prototype.toImageBuffer = function (e, t, i, n) {
          this.toImageBlob.call(
            this,
            e,
            function (e) {
        ...
        (c.prototype.clone = function (e) {
          if (
            (e =
              e || new r(0, 0, this.getWidth(), this.getHeight())).getWidth() <
              1 ||
            e.getHeight() < 1
          )
            return null;
          var t = new c(e.getWidth(), e.getHeight()),
            i = this._canvasContext.getImageData(
              e.getX(),
              e.getY(),
              e.getWidth(),
              e.getHeight(),
        ...
        (c.prototype.resize = function (e, t, i) {
          if (
            ((e = e || 0), (t = t || 0), (i = i || r.Side.TOP_LEFT), e || t)
          ) {
            var n = e - this.getWidth(),
              o = t - this.getHeight(),
              a = 0,
              s = 0,
              l = 0,
            ...
            var A = this._canvasContext.getImageData(
              0,
              0,
              this.getWidth(),
              this.getHeight(),
            );
            ((this._canvas.width = this.getWidth() - a + l),
              (this._canvas.height = this.getHeight() - s + h),
              ...
              this._canvasContext.putImageData(A, -a, -s));
          }
        }),
        (c.prototype.crop = function (e, t, i, r) {
          ((e = e || 0), (t = t || 0), (i = i || 0), (r = r || 0));
          var o = this.getWidth() - i,
            a = this.getHeight() - r;
          if (o > 0 && a > 0) {
            var s = this._canvasContext.getImageData(e, t, o, a);
            ((this._canvas.width = o),
              (this._canvas.height = a),
              this._canvasContext.clearRect(0, 0, o, a),
              this._canvasContext.putImageData(s, 0, 0),
              (this._offset = new n(e, t)));
          }
        }),
        (c.prototype.trim = function () {
          for (
            var e,
              t = this._canvasContext.getImageData(
                0,
                0,
                this.getWidth(),
                this.getHeight(),
            ...
            0 !== t.data[s + 3] &&
              ...
              (a = ~~(s / 4 / r)),
              null === n.top && (n.top = a),
              (null === n.left || e < n.left) && (n.left = e),
              (null === n.right || n.right < e) && (n.right = e),
              (null === n.bottom || n.bottom < a) && (n.bottom = a));
          ((n.bottom += 1),
            (n.right += 1),
            this.crop(
              n.left,
        ...
        (c.prototype.getPixelValue = function (e, t) {
          return (
            (e = Math.max(0, Math.min(e, this.getWidth()))),
            (t = Math.max(0, Math.min(t, this.getHeight()))),
            this._canvasContext.getImageData(e, t, 1, 1).data
          );
        }),
