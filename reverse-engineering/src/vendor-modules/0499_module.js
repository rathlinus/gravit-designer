...
function (e, t, i) {
      ...
      function r(e) {
        n.call(
          ...
          e,
          null,
          "        uniform highp sampler2D texture;        uniform float sigma;        uniform float radius;        uniform vec2 delta;        uniform vec2 dimensions;        varying highp vec2 texCoord;        const float numSamples = 30.0;        const float step       = 1.0/numSamples;        const float pi = 3.14159265;        " +
            n.randomShaderFunc +
      ...
      (i(0).inherit(r, n),
        (r.prototype.render = function (e, t) {
          var i = e.radius * t;
          if (!isNaN(i) && 0 != i) {
            var n = this.glEffect.width,
              r = this.glEffect.height;
