/**
 * chunk.vendor.js Module #753
 * Type: class
 * Name: GPathsGraphTool
 */
...
function (e, t, i) {
      ...
      (l.inherit(B, m),
        ...
        (B.prototype._newPoint = null),
        (B.prototype._editPt = null),
        ...
        (B.prototype._transactionType = B.Transaction.NoTransaction),
        (B.Mode = {
          Append: 0,
          Edit: 1,
        }),
        (B.prototype._mode = B.Mode.Append),
        (B.prototype._mDownTime = 0),
        Object.defineProperty(B, "DBLCLICKTM", {
          get: function () {
        ...
        (B.prototype.activate = function (e, t) {
          (m.prototype.activate.call(this, e, t),
            t ||
              (e.addEventListener(u.Down, this._mouseDown, this),
              e.addEventListener(u.Release, this._mouseRelease, this),
              e.addEventListener(y.Down, this._keyDown, this),
              e.addEventListener(u.Drag, this._mouseDrag, this),
              e.addEventListener(u.Move, this._mouseMove, this),
        ...
        (B.prototype.deactivate = function (e, t) {
          (this._checkMode(),
            ...
            this._editor &&
              ...
              t || this._editor.setPathResize(!0)),
            ...
            e.removeEventListener(y.Down, this._keyDown),
            e.removeEventListener(u.Drag, this._mouseDrag),
            e.removeEventListener(u.Move, this._mouseMove),
        ...
        (B.prototype._checkPathsGraphEditor = function () {
          var e = this._editor.getSelection(),
            t = null;
          (e && 1 == e.length && e[0] instanceof _ && (t = e[0]),
            t &&
              ((this._graphEditor = p.openEditor(t)),
              this._graphEditor.setFlag(b.Flag.Detail),
              this._graphEditor.removeFlag(f.Flag.ResizeAll),
              this._pathBaseRef ||
                (this._pathBaseRef = this._graphEditor.getPathBaseInEdit())));
        }),
            ...
            this._graphEditor
              ? this._graphEditor.getGraph().getWorkspace()
                ? ((this._graphRef = this._graphEditor.getGraph()),
                  this._graphEditor.getActiveExtendingMode()
                    ? (this._mode = B.Mode.Append)
                    : (this._mode = B.Mode.Edit))
                : ((this._mode = B.Mode.Append),
                  (this._graphRef = null),
                  (this._graphEditor = null))
              : ((this._mode = B.Mode.Append), (this._graphRef = null)));
        }),
        (B.prototype._renewPreviewLink = function () {
          if (this._graphEditor) {
            ...
            if (this._editPt) {
              ...
              (this._mode == B.Mode.Append &&
                e &&
                (t = e.getAnchorPoints().getLastChild()),
                this._editPt != t &&
        ...
        (B.prototype._addPoint = function (e, t, i, n) {
          ...
          if (t)
            if (this._graphEditor) {
              if (
                ...
                if (this._dpathRef)
                  ...
                  (l.setProperty("fpt", null),
                    l.getAnchorPoints().appendChild(e),
                    l.setFlag(s.Flag.Selected),
                    (this._pathBaseRef = l));
                  var h = new o();
                  (h.setProperties(
                    ["x", "y"],
                    ...
                    this._graphEditor.getElement().addAnchor(h),
                    this._finishTransaction(),
                    this._graphEditor.setOutgoingPathBase(h, this._pathBaseRef),
                    this._graphEditor.selectOnePoint(e),
                    this._checkMode(),
                    this._renewPreviewLink());
                }
                (this._dpathRef &&
                  ((this._editPt = this._dpathRef
                    .getAnchorPoints()
                    .getLastChild()),
                  this._graphEditor.setActiveExtendingMode(
                    E.ExtendingMode.End,
                  )),
                  this._graphEditor.requestInvalidation());
              }
              ...
              if (
                (this._createPathsGraph(e),
                !this._graphEditor || !this._pathBaseRef)
              )
                return;
              (this._graphEditor.selectOnePoint(e),
                this._checkMode(),
                ...
                (this._editPt = this._dpathRef
                  ...
                  .getLastChild()),
                this._graphEditor.requestInvalidation(),
                this._graphEditor.setActiveExtendingMode(E.ExtendingMode.End));
            }
          else
            this._graphEditor &&
              (this._graphEditor.requestInvalidation(),
              this._mode == B.Mode.Append &&
                (this._dpathRef &&
                  ...
                  (this._dpathRef = null),
                  e.hasFlag(s.Flag.Selected) && e.removeFlag(s.Flag.Selected)),
                this._graphEditor.releasePreview(),
                this._graphEditor.requestInvalidation(),
                this._pathBaseRef.getAnchorPoints().appendChild(e),
                this._graphEditor.selectOnePoint(e),
                this._graphEditor.setActiveExtendingMode(E.ExtendingMode.End),
                this._graphEditor.requestInvalidation()));
        }),
        ...
        (B.prototype._createPathsGraph = function (e) {
          var t = new v();
          (t.setProperty("fpt", null),
            t.getAnchorPoints().appendChild(e),
            t.setFlag(s.Flag.Selected),
            (this._pathBaseRef = t),
          ...
          (n.setProperties(
            ...
            this._checkPathsGraphEditor(),
            this._graphEditor &&
              this._graphEditor.setOutgoingPathBase(n, this._pathBaseRef));
        }),
        (B.prototype._mouseDown = function (e) {
          ...
          if (t - this._mDownTime < B.DBLCLICKTM)
            ...
            if (
              ...
              this._mode == B.Mode.Edit && this._mouseDownOnEdit(e),
              this._mode == B.Mode.Append)
            )
              if (
                (this._renewPreviewLink(), this._newPoint && this._graphEditor)
              ) {
                this._firstAlt &&
                  this._editPt.setProperties(
                    ["ah", "tp"],
                    [!0, v.AnchorPoint.Type.Symmetric],
                  );
                ...
                if (r)
                  if (
                    ...
                    var o = this._mouseDownPartInfo.id.point.getPoint(),
                      l = this._graphRef.getTransform();
                    (l && (o = l.mapPoint(o)),
                  ...
                  } else this._updatePoint(e.client);
                else this._updatePoint(e.client);
                var A = this._editPt.getPrevious();
                (A &&
                  (A.removeFlag(s.Flag.Selected),
                  this._editPt.setFlag(s.Flag.Selected)),
                  this._graphEditor.requestInvalidation());
                ...
                (this._editor
                  ...
                  (o = this._editor
                    .getGuides()
                    .mapPoint(o, a.DetailMap.Mode.DetailOnFilterOn)),
        ...
        (B.prototype._constructNewPoint = function (e, t) {
          ...
          return (
            ...
            n.modifiers.optionKey &&
              i.setProperties(["ah", "tp"], [!0, v.AnchorPoint.Type.Symmetric]),
            i
          );
        }),
        ...
        (B.prototype._mouseMove = function (e) {
          if (
            !(new Date().getTime() - this._mDownTime < B.DBLCLICKTM) &&
            this._released
          ) {
            var t;
            if (
              ...
              if (!this._newPoint && this._graphEditor) {
                ...
                (this._editor
                  ...
                  (n = this._editor
                    .getGuides()
                    .mapPoint(n, a.DetailMap.Mode.DetailOnFilterOn)),
                  this._editor.getGuides().finishMap(),
                  (i = this._view
                  ...
                  this._editor
                    ...
                    .mapPoint(
                      this._view
                        .getViewTransform(this._view.getScene().getActivePage())
                        .mapPoint(t),
                      a.DetailMap.Mode.DetailOnFilterOn,
                    ),
                )),
              this._editor.getGuides().finishMap(),
              this._graphEditor.movePoint(
        ...
        (B.prototype._updateHandles = function (e) {
          var t,
            i,
            r = this._editPt.getProperty("tp"),
            o = this._editPt.getProperty("x"),
            a = this._editPt.getProperty("y");
          if (
            ...
            r == v.AnchorPoint.Type.Symmetric
              ? this._editPt.setProperties(
                  ["tp", "hlx", "hly", "hrx", "hry"],
                  [v.AnchorPoint.Type.Asymmetric, null, null, null, null],
                )
              : this._editPt.setProperties(["hrx", "hry"], [null, null]);
          else {
            var s = this._graphEditor
            ...
            if (
              ...
              if (n.modifiers.optionKey)
                this._editPt.setProperties(
                  ["tp", "hrx", "hry"],
                  [v.AnchorPoint.Type.Asymmetric, l, h],
                );
              else {
                var A = v.AnchorPoint.Type.Symmetric,
                  c =
                    (null == this._editPt.getPrevious() &&
                      null != this._editPt.getNext()) ||
                    (null != this._editPt.getPrevious() &&
                ...
                if (this._mode != B.Mode.Edit && !this._newPoint && c)
                  this._editPt.setProperties(["tp", "hrx", "hry"], [A, l, h]);
                else {
                  var p = o + o - l,
                    u = a + a - h;
                  this._editPt.setProperties(
              ...
              ((i = null != m ? m + g : s.getY()),
                ...
                this._editPt.setProperties(
                  ["tp", "hrx", "hry"],
                  [v.AnchorPoint.Type.Asymmetric, t, i],
                ));
            }
          }
          this._graphEditor.requestInvalidation();
        ...
        (B.prototype._mouseDrag = function (e) {
          !this._released &&
            ...
            this._dragStartPt ||
              ...
              this._editPt.setProperties(
                ["ah", "tp"],
                [!1, v.AnchorPoint.Type.Symmetric],
              ),
              this._editPt.getPrevious() &&
                this._editPt.getPrevious().setProperty("ah", !1)),
            (this._dragStarted = !0),
        ...
        (B.prototype._mouseRelease = function (e) {
          if (
            (this._graphEditor && this._graphEditor.allowRemoval(),
            this._editor.getGuides().invalidate(),
            !this._released)
          )
            try {
        ...
        (B.prototype._reset = function () {
          (this._graphEditor && this._graphEditor.removeFlag(b.Flag.Detail),
            (this._dpathRef = null),
            (this._graphRef = null),
            (this._graphEditor = null),
            (this._newPoint = !1),
        ...
        (B.prototype._keyDown = function (e) {
          (m.prototype._keyDown.call(this, e),
            e.key === g.Constant.ESC
              ? ((this._lastMouseEvent = null), this._escAction())
              : e.key === g.Constant.ENTER &&
          ...
          if (n.modifiers.shiftKey) {
            ...
            (r
              ...
              : i &&
                (a =
                  this._mode == B.Mode.Append
                    ? i.getAnchorPoints().getLastChild()
                    : i.getAnchorPoints().getFirstChild()),
              a && (o = this._graphEditor.constrainPosition(e, t, a)));
          }
          return o;
        }),
        (B.prototype._makePointMajor = function (e) {
          (this._graphEditor.selectOnePoint(e),
            ...
            this._graphEditor.releasePreview(),
            this._graphEditor.requestInvalidation(),
            (this._dpathRef = this._graphEditor.getPathBasePreview(e)));
        }),
            ...
            switch (this._transactionType) {
              case B.Transaction.AppendPoint:
                this._editor.commitTransaction(
                  C.get(new w("GPathsGraphTool", "action.append-point")),
                );
                break;
              case B.Transaction.InsertElement:
                this._editor.commitTransaction(
                  C.get(new w("GPathsGraphTool", "action.insert-elements")),
                );
                break;
              case B.Transaction.InsertPoint:
                this._editor.commitTransaction(
                  C.get(new w("GPathsGraphTool", "action.insert-point")),
                );
                break;
              case B.Transaction.MovePoint:
                this._editor.commitTransaction(
                  C.get(new w("GPathsGraphTool", "action.move-point")),
                );
                break;
              case B.Transaction.DeletePoint:
                this._editor.commitTransaction(
                  C.get(new w("GPathsGraphTool", "action.delete-point")),
                );
                break;
              case B.Transaction.ModifyPointProperties:
                this._editor.commitTransaction(
                  C.get(
                    new w("GPathsGraphTool", "action.modify-point-properties"),
                  ),
                );
                break;
              case B.Transaction.ModifyPathProperties:
                this._editor.commitTransaction(
                  C.get(
                    new w("GPathsGraphTool", "action.modify-path-properties"),
                  ),
                );
            }
          } finally {
        ...
        (B.prototype._isSegmentMiddle = function (e) {
          return (
            e.data.type == c.SegmentData.HitRes &&
            e.data.hitRes.outline &&
            0.5 === e.data.hitRes.slope
          );
        }),
        (B.prototype._mouseDownOnEdit = function (e, t) {
          ...
          if (this._graphEditor.getElement().getWorkspace()) {
            (this._graphEditor.requestInvalidation(),
              ...
              this._graphEditor.requestInvalidation());
            var n = null,
              r = this._getPartInfo(i);
            if (
              (r &&
                ((this._graphEditor = r.editor),
                (this._graphRef = this._graphEditor.getGraph()),
                r.id.type == c.PartType.Anchor
                  ? (n = r.id.point)
                  : (this._transactionType == B.Transaction.NoTransaction &&
                      this._startTransaction(B.Transaction.InsertPoint),
                    (n = this._graphEditor.splitEdge(r)),
                    this._finishTransaction())),
              n)
            ) {
              var o = n.getPoint(),
                a = this._constructNewPoint(e, o);
              ((this._pathBaseRef = new v()),
                this._pathBaseRef.setProperty("fpt", null),
                this._pathBaseRef.getAnchorPoints().appendChild(a),
                this._pathBaseRef.setFlag(s.Flag.Selected),
                this._graphEditor.setOutgoingPathBase(n, this._pathBaseRef),
                this._graphEditor.setActiveExtendingMode(E.ExtendingMode.End),
                this._graphEditor.selectOnePoint(a),
                this._renewPreviewLink(),
                (this._mode = B.Mode.Append),
                (this._editPt = this._dpathRef
                  .getAnchorPoints()
