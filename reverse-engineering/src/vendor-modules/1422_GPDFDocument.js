      ...
      var n = i(1423),
        ...
        u = function (e) {
          ((this.compress = e.compress),
            ...
            (this._downsampleImages = !!e.downsampleImages),
            (this.colorSpace = e.colorSpace),
            (this.header = new s(e.version)),
            (this.body = new n(this, e.user, e.title)),
            (this._promises = []),
            (this._executors = []),
            ...
            (this._promise = new p(
              function (e, t) {
                ((this._promiseCapability.resolve = e),
                  (this._promiseCapability.reject = t));
              }.bind(this),
            )));
        };
      ((u.prototype._workers = null),
        (u.prototype._jobs = null),
        ...
        (u.prototype.beginJob = function (e) {
          ...
          return (
            this._jobs.length || this._resetPromise(),
            this._jobs.push(t),
            t
          );
        }),
        (u.prototype.endJob = function (e) {
          if (((this._lastJob = e), e._status !== u.Job.Status.FAILED)) {
            ...
            !this._jobs.length &&
              this._tasksAreSubmitted &&
              this._promiseCapability.resolve();
          } else this._promiseCapability.reject(e._error);
        }),
        ...
        (u.prototype.abort = function (e) {
          ((this._abort = !0),
            ...
            this._executors &&
              this._executors.forEach(function (e) {
                e.abort();
              }),
            this._promises &&
        ...
        (u.prototype.ready = function () {
          return (
            (this._tasksAreSubmitted = !0),
            this._jobs.length || this._promiseCapability.resolve(),
            this._promise
          );
        }),
        ...
        ((u.Job = function (e, t) {
          ((this._name = e),
            (this._doc = t),
            (this._id = A.uuid()),
            (this._status = u.Job.Status.RUNNING));
        }).Status = {
          IDLE: 0,
          RUNNING: 1,
          COMPLETED: 2,
        ...
        (u.Job.prototype._name = null),
        (u.Job.prototype._doc = null),
        (u.Job.prototype._status = u.Job.Status.IDLE),
        (u.Job.prototype._error = null),
        (u.Job.prototype.failed = function (e) {
          this._updateStatus(u.Job.Status.FAILED) &&
            ((this._error = e), this._doc.endJob(this));
        }),
