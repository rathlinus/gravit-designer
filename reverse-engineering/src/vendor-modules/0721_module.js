      ...
      ((o[5] = function () {
        ...
        (o[7] = function () {
          ...
          var t = this.parseUShort(),
            i = new r(this.data, this.offset + this.parseULong());
          return {
            substFormat: 1,
            lookupType: t,
      ...
      ((l[1] = function (e) {
          ...
          return (
            ...
            new a.Table(
              ...
              [
                ...
                a.tableList("altSet", e.alternateSets, function (e) {
                  return new a.Table(
                    "alternateSetTable",
                    a.ushortList("alternate", e),
                  );
                }),
              ),
            )
          ...
          return (
            ...
            new a.Table(
              ...
              [
                ...
                a.tableList("ligSet", e.ligatureSets, function (e) {
                  return new a.Table(
                    "ligatureSetTable",
                    a.tableList("ligature", e, function (e) {
                      return new a.Table(
                        "ligatureTable",
                        [
                          {
        ...
        (t.parse = function (e, t) {
          var i = new r(e, (t = t || 0)),
            a = i.parseVersion(1);
          return (
            n.argument(1 === a || 1.1 === a, "Unsupported GSUB table version."),
            1 === a
              ? {
                  version: a,
