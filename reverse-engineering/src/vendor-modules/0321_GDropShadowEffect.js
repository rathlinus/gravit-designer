/**
 * chunk.vendor.js Module #321
 * Type: class
 * Name: GDropShadowEffect
 */
...
function (e, t, i) {
      ...
      function p() {
        (o.Effect.call(this),
          this._setDefaultProperties(p.GeometryProperties, p.VisualProperties),
          (this._blur = new A()));
      }
      (r.inherit("dropShadowEffect", p, o.Effect),
        ...
        (p.equals = function (e, t) {
          return (
            ...
            e.arePropertiesEqual(
              t,
              Object.keys(p.GeometryProperties).concat(
                Object.keys(p.VisualProperties),
              ),
            )
          );
        }),
        ...
        (p.prototype.getEffectPadding = function () {
          ...
          return [e - this.$x, e - this.$y, e + this.$x, e + this.$y];
        }),
        ...
        (p.prototype.applyNativeEffect = function (e, t, i, n) {
          var r = this.$x * n,
            o = this.$y * n,
            a = this.$r * n;
          t.setFilter(l.Filter.DropShadow, [r, o, a, this.$pat, this.$opc]);
        }),
        ...
        (p.prototype.render = function (e, t, i, n, r, o) {
          if (this.$pat && this.$opc > 0)
            if (this.canApplyNativeEffect())
              (this.applyNativeEffect(e, t, i, n),
                t.drawCanvas(e, 0, 0, 1, l.CompositeOperator.Copy),
                this.removeNativeEffect(e, t));
            else {
              var a = this.$x * n,
                s = this.$y * n,
                A = this.$r * n,
              ...
              if (p)
                if (p.transform) {
                  var u = t.setTransform(
                    t.getTransform(!0).preMultiplied(p.transform),
                  );
                  (t.fillRect(0, 0, 1, 1, p.paint, this.$opc),
                    t.setTransform(u));
                } else
                  t.fillRect(
                    c.getX(),
              ...
              (t.drawCanvas(e, a, s, 1, l.CompositeOperator.DestinationIn),
                ...
                t.drawCanvas(e, 0, 0, 1, l.CompositeOperator.DestinationOut));
            }
        }),
