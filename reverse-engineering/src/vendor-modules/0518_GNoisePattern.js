...
function (e, t, i) {
      ...
      function c(e) {
        (a.call(this),
          a.ScaleSettings.stretch(this),
          (this._node = new s()),
          this._node.transform(new h().scaled(5, 5)),
          this._node.getEffects().appendChild(new l()),
          this.setType(c.Type.Original),
          this.setAmount(e));
      }
      (n.inherit("N", c, a),
        (c.Type = {
        ...
        (c.prototype._type = c.Type.Original),
        (c.prototype._amount = 1),
        (c.equals = function (e, t) {
          return (
            (!e && e === t) ||
            (a.equals(e, t) && e._amount === t._amount && e._type === t._type)
          );
        }),
        (c.prototype.setType = function (e) {
          switch (
            ((this._type = e), this._node.getPaintLayers().clearFillLayers(), e)
          ) {
            case c.Type.Original:
              this._node
                .getPaintLayers()
                .appendChild(new A.FillPaintLayer(new o()));
              break;
            case c.Type.Black:
            case c.Type.Color:
              this._node
                .getPaintLayers()
                .appendChild(new A.FillPaintLayer(r.WHITE));
              break;
            case c.Type.White:
              this._node
                .getPaintLayers()
                .appendChild(new A.FillPaintLayer(r.BLACK));
          }
          this._node
            .getEffects()
            .getFirstChild()
        ...
        (c.prototype.getTexture = function (e, t) {
          ...
          if (
            (i.transform(new h().scaled(this._scaleX, this._scaleY), !0),
            this._type === c.Type.Original)
          ) {
