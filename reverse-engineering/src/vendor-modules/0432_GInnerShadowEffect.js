/**
 * chunk.vendor.js Module #432
 * Type: class
 * Name: GInnerShadowEffect
 */
...
function (e, t, i) {
      ...
      function c() {
        (o.Effect.call(this),
          this._setDefaultProperties(c.GeometryProperties, c.VisualProperties),
          (this._blur = new h()));
      }
      (r.inherit("innerShadowEffect", c, o.Effect),
        ...
        (c.equals = function (e, t) {
          return (
            ...
            e.arePropertiesEqual(
              t,
              Object.keys(c.GeometryProperties).concat(
                Object.keys(c.VisualProperties),
              ),
            )
          );
        }),
        ...
        (c.prototype.render = function (e, t, i, n, r, o) {
          if (this.$pat && this.$opc > 0 && this.$r >= 0) {
            ...
            if (h)
              if (h.transform) {
                var A = t.setTransform(
                  t.getTransform(!0).preMultiplied(h.transform),
                );
            ...
            (t.drawCanvas(e, c, p, 1, s.CompositeOperator.DestinationOut),
              u > 0 &&
                ...
                !s.hasFilters() &&
                  this._blur._glblur &&
                  (this._blur._glblur._isAffectedByGLBug = !0),
                (this._blur.$r = this.$r),
                this._blur.render(t, null, null, n, r, o),
                s.enableFilters()),
              t.drawCanvas(e, 0, 0, 1, s.CompositeOperator.DestinationIn));
          }
        }),
